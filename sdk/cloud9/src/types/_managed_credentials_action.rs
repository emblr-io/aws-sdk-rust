...
impl ::std::convert::From<&str> for ManagedCredentialsAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ManagedCredentialsAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ManagedCredentialsAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ManagedCredentialsAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ManagedCredentialsAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
