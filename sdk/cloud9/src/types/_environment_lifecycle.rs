...
pub struct EnvironmentLifecycle {
    ...
    /// <ul>
    /// <li>
    /// <p><code>CREATING</code>: The environment is in the process of being created.</p></li>
    /// <li>
    /// <p><code>CREATED</code>: The environment was successfully created.</p></li>
    /// <li>
    /// <p><code>CREATE_FAILED</code>: The environment failed to be created.</p></li>
    /// <li>
    /// <p><code>DELETING</code>: The environment is in the process of being deleted.</p></li>
    /// <li>
    /// <p><code>DELETE_FAILED</code>: The environment failed to delete.</p></li>
    /// </ul>
