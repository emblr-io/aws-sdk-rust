...
/// For example, the [`CreateEnvironmentEC2`](crate::operation::create_environment_ec2) operation has
/// a [`Client::create_environment_ec2`], function which returns a builder for that operation.
