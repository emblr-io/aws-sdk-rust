...
impl ::std::convert::From<&str> for ApplicationRestoreType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationRestoreType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationRestoreType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationRestoreType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationRestoreType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
