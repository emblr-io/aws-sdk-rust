...
impl ::std::convert::From<&str> for MetricsLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MetricsLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MetricsLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MetricsLevel::from(s))
    }
}
impl MetricsLevel {
...
impl ::std::convert::AsRef<str> for MetricsLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
