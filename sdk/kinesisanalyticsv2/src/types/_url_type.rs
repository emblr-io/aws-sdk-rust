...
impl ::std::convert::From<&str> for UrlType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UrlType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UrlType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UrlType::from(s))
    }
}
impl UrlType {
...
impl ::std::convert::AsRef<str> for UrlType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
