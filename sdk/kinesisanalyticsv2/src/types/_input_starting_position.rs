...
impl ::std::convert::From<&str> for InputStartingPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InputStartingPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InputStartingPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InputStartingPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InputStartingPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
