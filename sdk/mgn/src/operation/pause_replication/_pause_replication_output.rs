...
pub struct PauseReplicationOutput {
...
impl ::std::fmt::Debug for PauseReplicationOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("PauseReplicationOutput");
...
impl ::aws_types::request_id::RequestId for PauseReplicationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PauseReplicationOutput {
    /// Creates a new builder-style object to manufacture [`PauseReplicationOutput`](crate::operation::pause_replication::PauseReplicationOutput).
    pub fn builder() -> crate::operation::pause_replication::builders::PauseReplicationOutputBuilder {
        crate::operation::pause_replication::builders::PauseReplicationOutputBuilder::default()
    }
}
...
impl PauseReplicationOutputBuilder {
    /// <p>Source server ID.</p>
    ...
    /// Consumes the builder and constructs a [`PauseReplicationOutput`](crate::operation::pause_replication::PauseReplicationOutput).
    pub fn build(self) -> crate::operation::pause_replication::PauseReplicationOutput {
...
impl ::std::fmt::Debug for PauseReplicationOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("PauseReplicationOutputBuilder");
        formatter.field("source_server_id", &self.source_server_id);
        formatter.field("arn", &self.arn);
        formatter.field("is_archived", &self.is_archived);
        formatter.field("tags", &"*** Sensitive Data Redacted ***");
