...
impl ArchiveWaveOutput {
    /// Creates a new builder-style object to manufacture [`ArchiveWaveOutput`](crate::operation::archive_wave::ArchiveWaveOutput).
    pub fn builder() -> crate::operation::archive_wave::builders::ArchiveWaveOutputBuilder {
        crate::operation::archive_wave::builders::ArchiveWaveOutputBuilder::default()
    }
}

/// A builder for [`ArchiveWaveOutput`](crate::operation::archive_wave::ArchiveWaveOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct ArchiveWaveOutputBuilder {
...
impl ArchiveWaveOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ArchiveWaveOutput`](crate::operation::archive_wave::ArchiveWaveOutput).
    pub fn build(self) -> crate::operation::archive_wave::ArchiveWaveOutput {
...
impl ::std::fmt::Debug for ArchiveWaveOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ArchiveWaveOutputBuilder");
        formatter.field("wave_id", &self.wave_id);
        formatter.field("arn", &self.arn);
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
