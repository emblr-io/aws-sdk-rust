...
impl FinalizeCutoverOutput {
    /// Creates a new builder-style object to manufacture [`FinalizeCutoverOutput`](crate::operation::finalize_cutover::FinalizeCutoverOutput).
    pub fn builder() -> crate::operation::finalize_cutover::builders::FinalizeCutoverOutputBuilder {
        crate::operation::finalize_cutover::builders::FinalizeCutoverOutputBuilder::default()
    }
}
...
impl FinalizeCutoverOutputBuilder {
    /// <p>Source server ID.</p>
    ...
    /// Consumes the builder and constructs a [`FinalizeCutoverOutput`](crate::operation::finalize_cutover::FinalizeCutoverOutput).
    pub fn build(self) -> crate::operation::finalize_cutover::FinalizeCutoverOutput {
...
impl ::std::fmt::Debug for FinalizeCutoverOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("FinalizeCutoverOutputBuilder");
        formatter.field("source_server_id", &self.source_server_id);
        formatter.field("arn", &self.arn);
        formatter.field("is_archived", &self.is_archived);
        formatter.field("tags", &"*** Sensitive Data Redacted ***");
