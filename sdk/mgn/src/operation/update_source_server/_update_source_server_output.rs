...
pub struct UpdateSourceServerOutput {
...
impl ::std::fmt::Debug for UpdateSourceServerOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateSourceServerOutput");
...
impl UpdateSourceServerOutput {
    /// Creates a new builder-style object to manufacture [`UpdateSourceServerOutput`](crate::operation::update_source_server::UpdateSourceServerOutput).
    pub fn builder() -> crate::operation::update_source_server::builders::UpdateSourceServerOutputBuilder {
        crate::operation::update_source_server::builders::UpdateSourceServerOutputBuilder::default()
    }
}
...
impl UpdateSourceServerOutputBuilder {
    /// <p>Source server ID.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateSourceServerOutput`](crate::operation::update_source_server::UpdateSourceServerOutput).
    pub fn build(self) -> crate::operation::update_source_server::UpdateSourceServerOutput {
...
impl ::std::fmt::Debug for UpdateSourceServerOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateSourceServerOutputBuilder");
        formatter.field("source_server_id", &self.source_server_id);
        formatter.field("arn", &self.arn);
        formatter.field("is_archived", &self.is_archived);
        formatter.field("tags", &"*** Sensitive Data Redacted ***");
