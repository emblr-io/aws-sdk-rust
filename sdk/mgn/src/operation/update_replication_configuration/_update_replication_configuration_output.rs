...
impl ::aws_types::request_id::RequestId for UpdateReplicationConfigurationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateReplicationConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`UpdateReplicationConfigurationOutput`](crate::operation::update_replication_configuration::UpdateReplicationConfigurationOutput).
    pub fn builder() -> crate::operation::update_replication_configuration::builders::UpdateReplicationConfigurationOutputBuilder {
        crate::operation::update_replication_configuration::builders::UpdateReplicationConfigurationOutputBuilder::default()
    }
}
...
impl UpdateReplicationConfigurationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateReplicationConfigurationOutput`](crate::operation::update_replication_configuration::UpdateReplicationConfigurationOutput).
    pub fn build(self) -> crate::operation::update_replication_configuration::UpdateReplicationConfigurationOutput {
...
impl ::std::fmt::Debug for UpdateReplicationConfigurationOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateReplicationConfigurationOutputBuilder");
        formatter.field("source_server_id", &self.source_server_id);
        formatter.field("name", &self.name);
        formatter.field("staging_area_subnet_id", &self.staging_area_subnet_id);
        formatter.field("associate_default_security_group", &self.associate_default_security_group);
