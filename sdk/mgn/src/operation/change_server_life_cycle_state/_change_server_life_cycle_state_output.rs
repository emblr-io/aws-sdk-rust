...
impl ::aws_types::request_id::RequestId for ChangeServerLifeCycleStateOutput {
...
/// A builder for [`ChangeServerLifeCycleStateOutput`](crate::operation::change_server_life_cycle_state::ChangeServerLifeCycleStateOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct ChangeServerLifeCycleStateOutputBuilder {
...
impl ::std::fmt::Debug for ChangeServerLifeCycleStateOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ChangeServerLifeCycleStateOutputBuilder");
        formatter.field("source_server_id", &self.source_server_id);
        formatter.field("arn", &self.arn);
        formatter.field("is_archived", &self.is_archived);
        formatter.field("tags", &"*** Sensitive Data Redacted ***");
