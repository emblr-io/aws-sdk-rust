...
pub struct ResumeReplicationOutput {
...
impl ::std::fmt::Debug for ResumeReplicationOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ResumeReplicationOutput");
...
impl ResumeReplicationOutput {
    /// Creates a new builder-style object to manufacture [`ResumeReplicationOutput`](crate::operation::resume_replication::ResumeReplicationOutput).
    pub fn builder() -> crate::operation::resume_replication::builders::ResumeReplicationOutputBuilder {
        crate::operation::resume_replication::builders::ResumeReplicationOutputBuilder::default()
    }
}

/// A builder for [`ResumeReplicationOutput`](crate::operation::resume_replication::ResumeReplicationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct ResumeReplicationOutputBuilder {
...
impl ResumeReplicationOutputBuilder {
    /// <p>Source server ID.</p>
    ...
    /// Consumes the builder and constructs a [`ResumeReplicationOutput`](crate::operation::resume_replication::ResumeReplicationOutput).
    pub fn build(self) -> crate::operation::resume_replication::ResumeReplicationOutput {
...
impl ::std::fmt::Debug for ResumeReplicationOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ResumeReplicationOutputBuilder");
        formatter.field("source_server_id", &self.source_server_id);
        formatter.field("arn", &self.arn);
        formatter.field("is_archived", &self.is_archived);
        formatter.field("tags", &"*** Sensitive Data Redacted ***");
