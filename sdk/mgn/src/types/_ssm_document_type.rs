...
impl ::std::convert::From<&str> for SsmDocumentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SsmDocumentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SsmDocumentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SsmDocumentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SsmDocumentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
