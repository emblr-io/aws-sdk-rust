...
impl ::std::convert::From<&str> for WaveHealthStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WaveHealthStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WaveHealthStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WaveHealthStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WaveHealthStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
