...
impl ::std::convert::From<&str> for WaveProgressStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WaveProgressStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WaveProgressStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WaveProgressStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WaveProgressStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
