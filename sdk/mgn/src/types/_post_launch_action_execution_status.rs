...
impl ::std::convert::From<&str> for PostLaunchActionExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PostLaunchActionExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PostLaunchActionExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PostLaunchActionExecutionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PostLaunchActionExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
