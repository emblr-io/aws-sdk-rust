...
impl ::std::convert::From<&str> for ApplicationHealthStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationHealthStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationHealthStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationHealthStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationHealthStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
