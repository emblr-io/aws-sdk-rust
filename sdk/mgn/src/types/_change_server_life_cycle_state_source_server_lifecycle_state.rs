...
impl ::std::convert::From<&str> for ChangeServerLifeCycleStateSourceServerLifecycleState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChangeServerLifeCycleStateSourceServerLifecycleState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::convert::AsRef<str> for ChangeServerLifeCycleStateSourceServerLifecycleState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
