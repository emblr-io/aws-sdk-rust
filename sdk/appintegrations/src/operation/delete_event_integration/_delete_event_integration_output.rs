...
impl ::aws_types::request_id::RequestId for DeleteEventIntegrationOutput {
...
impl DeleteEventIntegrationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteEventIntegrationOutput`](crate::operation::delete_event_integration::DeleteEventIntegrationOutput).
    pub fn build(self) -> crate::operation::delete_event_integration::DeleteEventIntegrationOutput {
