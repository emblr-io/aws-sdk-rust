...
impl ::aws_types::request_id::RequestId for CreateDataIntegrationOutput {
...
impl CreateDataIntegrationOutputBuilder {
    /// <p>The Amazon Resource Name (ARN)</p>
    ...
    /// Consumes the builder and constructs a [`CreateDataIntegrationOutput`](crate::operation::create_data_integration::CreateDataIntegrationOutput).
    pub fn build(self) -> crate::operation::create_data_integration::CreateDataIntegrationOutput {
