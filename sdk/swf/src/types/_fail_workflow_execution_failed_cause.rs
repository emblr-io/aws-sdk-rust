...
impl ::std::convert::From<&str> for FailWorkflowExecutionFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailWorkflowExecutionFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailWorkflowExecutionFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailWorkflowExecutionFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FailWorkflowExecutionFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
