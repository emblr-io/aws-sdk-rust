...
impl ::std::fmt::Display for EventType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EventType::ActivityTaskCancelRequested => write!(f, "ActivityTaskCancelRequested"),
            EventType::ActivityTaskCanceled => write!(f, "ActivityTaskCanceled"),
            EventType::ActivityTaskCompleted => write!(f, "ActivityTaskCompleted"),
            EventType::ActivityTaskFailed => write!(f, "ActivityTaskFailed"),
            EventType::ActivityTaskScheduled => write!(f, "ActivityTaskScheduled"),
            EventType::ActivityTaskStarted => write!(f, "ActivityTaskStarted"),
            EventType::ActivityTaskTimedOut => write!(f, "ActivityTaskTimedOut"),
            EventType::CancelTimerFailed => write!(f, "CancelTimerFailed"),
            EventType::CancelWorkflowExecutionFailed => write!(f, "CancelWorkflowExecutionFailed"),
            EventType::ChildWorkflowExecutionCanceled => write!(f, "ChildWorkflowExecutionCanceled"),
            EventType::ChildWorkflowExecutionCompleted => write!(f, "ChildWorkflowExecutionCompleted"),
            EventType::ChildWorkflowExecutionFailed => write!(f, "ChildWorkflowExecutionFailed"),
            EventType::ChildWorkflowExecutionStarted => write!(f, "ChildWorkflowExecutionStarted"),
            EventType::ChildWorkflowExecutionTerminated => write!(f, "ChildWorkflowExecutionTerminated"),
            EventType::ChildWorkflowExecutionTimedOut => write!(f, "ChildWorkflowExecutionTimedOut"),
            EventType::CompleteWorkflowExecutionFailed => write!(f, "CompleteWorkflowExecutionFailed"),
            EventType::ContinueAsNewWorkflowExecutionFailed => write!(f, "ContinueAsNewWorkflowExecutionFailed"),
            EventType::DecisionTaskCompleted => write!(f, "DecisionTaskCompleted"),
            EventType::DecisionTaskScheduled => write!(f, "DecisionTaskScheduled"),
            EventType::DecisionTaskStarted => write!(f, "DecisionTaskStarted"),
            EventType::DecisionTaskTimedOut => write!(f, "DecisionTaskTimedOut"),
            EventType::ExternalWorkflowExecutionCancelRequested => write!(f, "ExternalWorkflowExecutionCancelRequested"),
            EventType::ExternalWorkflowExecutionSignaled => write!(f, "ExternalWorkflowExecutionSignaled"),
            EventType::FailWorkflowExecutionFailed => write!(f, "FailWorkflowExecutionFailed"),
            EventType::LambdaFunctionCompleted => write!(f, "LambdaFunctionCompleted"),
            EventType::LambdaFunctionFailed => write!(f, "LambdaFunctionFailed"),
            EventType::LambdaFunctionScheduled => write!(f, "LambdaFunctionScheduled"),
            EventType::LambdaFunctionStarted => write!(f, "LambdaFunctionStarted"),
            EventType::LambdaFunctionTimedOut => write!(f, "LambdaFunctionTimedOut"),
            EventType::MarkerRecorded => write!(f, "MarkerRecorded"),
            EventType::RecordMarkerFailed => write!(f, "RecordMarkerFailed"),
            EventType::RequestCancelActivityTaskFailed => write!(f, "RequestCancelActivityTaskFailed"),
            EventType::RequestCancelExternalWorkflowExecutionFailed => write!(f, "RequestCancelExternalWorkflowExecutionFailed"),
            EventType::RequestCancelExternalWorkflowExecutionInitiated => write!(f, "RequestCancelExternalWorkflowExecutionInitiated"),
            EventType::ScheduleActivityTaskFailed => write!(f, "ScheduleActivityTaskFailed"),
            EventType::ScheduleLambdaFunctionFailed => write!(f, "ScheduleLambdaFunctionFailed"),
            EventType::SignalExternalWorkflowExecutionFailed => write!(f, "SignalExternalWorkflowExecutionFailed"),
            EventType::SignalExternalWorkflowExecutionInitiated => write!(f, "SignalExternalWorkflowExecutionInitiated"),
            EventType::StartChildWorkflowExecutionFailed => write!(f, "StartChildWorkflowExecutionFailed"),
            EventType::StartChildWorkflowExecutionInitiated => write!(f, "StartChildWorkflowExecutionInitiated"),
            EventType::StartLambdaFunctionFailed => write!(f, "StartLambdaFunctionFailed"),
            EventType::StartTimerFailed => write!(f, "StartTimerFailed"),
            EventType::TimerCanceled => write!(f, "TimerCanceled"),
            EventType::TimerFired => write!(f, "TimerFired"),
            EventType::TimerStarted => write!(f, "TimerStarted"),
            EventType::WorkflowExecutionCancelRequested => write!(f, "WorkflowExecutionCancelRequested"),
            EventType::WorkflowExecutionCanceled => write!(f, "WorkflowExecutionCanceled"),
            EventType::WorkflowExecutionCompleted => write!(f, "WorkflowExecutionCompleted"),
            EventType::WorkflowExecutionContinuedAsNew => write!(f, "WorkflowExecutionContinuedAsNew"),
            EventType::WorkflowExecutionFailed => write!(f, "WorkflowExecutionFailed"),
            EventType::WorkflowExecutionSignaled => write!(f, "WorkflowExecutionSignaled"),
