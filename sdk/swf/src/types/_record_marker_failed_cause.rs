...
impl ::std::convert::From<&str> for RecordMarkerFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordMarkerFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordMarkerFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordMarkerFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecordMarkerFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
