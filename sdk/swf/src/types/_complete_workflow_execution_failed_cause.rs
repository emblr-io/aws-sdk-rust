...
impl ::std::convert::From<&str> for CompleteWorkflowExecutionFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CompleteWorkflowExecutionFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CompleteWorkflowExecutionFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CompleteWorkflowExecutionFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CompleteWorkflowExecutionFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CompleteWorkflowExecutionFailedCause {
