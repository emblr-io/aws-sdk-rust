...
impl ::std::convert::From<&str> for WorkflowExecutionCancelRequestedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkflowExecutionCancelRequestedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkflowExecutionCancelRequestedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkflowExecutionCancelRequestedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkflowExecutionCancelRequestedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
