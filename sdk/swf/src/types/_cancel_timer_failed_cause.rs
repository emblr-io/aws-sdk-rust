...
impl ::std::convert::From<&str> for CancelTimerFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CancelTimerFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CancelTimerFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CancelTimerFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CancelTimerFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
