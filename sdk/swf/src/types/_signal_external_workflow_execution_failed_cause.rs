...
impl ::std::convert::From<&str> for SignalExternalWorkflowExecutionFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                SignalExternalWorkflowExecutionFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for SignalExternalWorkflowExecutionFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SignalExternalWorkflowExecutionFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SignalExternalWorkflowExecutionFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
