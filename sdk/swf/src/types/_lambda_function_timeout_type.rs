...
impl ::std::convert::From<&str> for LambdaFunctionTimeoutType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LambdaFunctionTimeoutType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LambdaFunctionTimeoutType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LambdaFunctionTimeoutType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LambdaFunctionTimeoutType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
