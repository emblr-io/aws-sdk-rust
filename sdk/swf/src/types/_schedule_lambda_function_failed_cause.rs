...
impl ::std::convert::From<&str> for ScheduleLambdaFunctionFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScheduleLambdaFunctionFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScheduleLambdaFunctionFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScheduleLambdaFunctionFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScheduleLambdaFunctionFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
