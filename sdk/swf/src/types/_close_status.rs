...
impl ::std::convert::From<&str> for CloseStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CloseStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CloseStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CloseStatus::from(s))
    }
}
impl CloseStatus {
...
impl ::std::convert::AsRef<str> for CloseStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
