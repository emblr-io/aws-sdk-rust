...
impl ::std::convert::From<&str> for ChildPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChildPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChildPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChildPolicy::from(s))
    }
}
impl ChildPolicy {
...
impl ::std::convert::AsRef<str> for ChildPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
