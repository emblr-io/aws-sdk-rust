...
impl ::std::convert::From<&str> for WorkflowExecutionTimeoutType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkflowExecutionTimeoutType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkflowExecutionTimeoutType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkflowExecutionTimeoutType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkflowExecutionTimeoutType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for WorkflowExecutionTimeoutType {
