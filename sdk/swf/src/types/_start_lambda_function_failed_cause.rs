...
impl ::std::convert::From<&str> for StartLambdaFunctionFailedCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StartLambdaFunctionFailedCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StartLambdaFunctionFailedCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StartLambdaFunctionFailedCause::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StartLambdaFunctionFailedCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for StartLambdaFunctionFailedCause {
