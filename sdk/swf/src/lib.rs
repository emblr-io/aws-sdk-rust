...
//! offered by Amazon Simple Workflow Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Simple Workflow Service.
...
/// For example, the [`CountClosedWorkflowExecutions`](crate::operation::count_closed_workflow_executions) operation has
...
/// Configuration for Amazon Simple Workflow Service.
pub mod config;
