...
impl ::aws_types::request_id::RequestId for ListOpenWorkflowExecutionsOutput {
...
impl ListOpenWorkflowExecutionsOutputBuilder {
    ...
    /// - [`execution_infos`](crate::operation::list_open_workflow_executions::builders::ListOpenWorkflowExecutionsOutputBuilder::execution_infos)
    pub fn build(
        self,
    ) -> ::std::result::Result<
