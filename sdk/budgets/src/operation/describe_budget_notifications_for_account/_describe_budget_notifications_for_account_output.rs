...
impl ::aws_types::request_id::RequestId for DescribeBudgetNotificationsForAccountOutput {
...
impl DescribeBudgetNotificationsForAccountOutputBuilder {
    ...
    pub fn set_budget_notifications_for_account(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::BudgetNotificationsForAccount>>,
    ) -> Self {
