...
impl ::std::convert::From<&str> for NotificationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotificationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotificationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotificationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NotificationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
