...
impl ::std::convert::From<&str> for BudgetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BudgetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BudgetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BudgetType::from(s))
    }
}
impl BudgetType {
...
impl ::std::convert::AsRef<str> for BudgetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
