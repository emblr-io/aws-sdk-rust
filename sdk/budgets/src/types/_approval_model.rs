...
impl ::std::convert::From<&str> for ApprovalModel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApprovalModel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApprovalModel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApprovalModel::from(s))
    }
}
impl ApprovalModel {
...
impl ::std::convert::AsRef<str> for ApprovalModel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
