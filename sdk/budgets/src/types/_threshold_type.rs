...
impl ::std::convert::From<&str> for ThresholdType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThresholdType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThresholdType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThresholdType::from(s))
    }
}
impl ThresholdType {
...
impl ::std::convert::AsRef<str> for ThresholdType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
