...
impl ::std::convert::From<&str> for AutoAdjustType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoAdjustType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoAdjustType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoAdjustType::from(s))
    }
}
impl AutoAdjustType {
...
impl ::std::convert::AsRef<str> for AutoAdjustType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
