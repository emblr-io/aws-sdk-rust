...
impl ::std::convert::From<&str> for ActionSubType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionSubType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionSubType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionSubType::from(s))
    }
}
impl ActionSubType {
...
impl ::std::convert::AsRef<str> for ActionSubType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
