...
//! offered by AWS Shield. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`AssociateDRTLogBucket`](crate::operation::associate_drt_log_bucket) operation has
/// a [`Client::associate_drt_log_bucket`], function which returns a builder for that operation.
