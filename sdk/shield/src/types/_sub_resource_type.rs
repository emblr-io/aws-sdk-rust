...
impl ::std::convert::From<&str> for SubResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SubResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SubResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
