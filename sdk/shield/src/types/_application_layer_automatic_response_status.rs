...
impl ::std::convert::From<&str> for ApplicationLayerAutomaticResponseStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationLayerAutomaticResponseStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationLayerAutomaticResponseStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationLayerAutomaticResponseStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationLayerAutomaticResponseStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
