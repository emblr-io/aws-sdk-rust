...
impl ::std::convert::From<&str> for AutoRenew {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoRenew::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoRenew {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoRenew::from(s))
    }
}
impl AutoRenew {
...
impl ::std::convert::AsRef<str> for AutoRenew {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AutoRenew {
