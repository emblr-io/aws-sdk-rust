...
impl ::aws_types::request_id::RequestId for CreateProtectionGroupOutput {
...
impl CreateProtectionGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateProtectionGroupOutput`](crate::operation::create_protection_group::CreateProtectionGroupOutput).
    pub fn build(self) -> crate::operation::create_protection_group::CreateProtectionGroupOutput {
