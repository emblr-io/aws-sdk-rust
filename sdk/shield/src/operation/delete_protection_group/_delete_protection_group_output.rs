...
impl ::aws_types::request_id::RequestId for DeleteProtectionGroupOutput {
...
impl DeleteProtectionGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteProtectionGroupOutput`](crate::operation::delete_protection_group::DeleteProtectionGroupOutput).
    pub fn build(self) -> crate::operation::delete_protection_group::DeleteProtectionGroupOutput {
        crate::operation::delete_protection_group::DeleteProtectionGroupOutput {
