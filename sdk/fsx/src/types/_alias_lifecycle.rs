...
impl ::std::convert::From<&str> for AliasLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AliasLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AliasLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AliasLifecycle::from(s))
    }
}
impl AliasLifecycle {
...
impl ::std::convert::AsRef<str> for AliasLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
