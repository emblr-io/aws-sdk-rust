...
impl ::std::convert::From<&str> for TieringPolicyName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TieringPolicyName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TieringPolicyName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TieringPolicyName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TieringPolicyName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
