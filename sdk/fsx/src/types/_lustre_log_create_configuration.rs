...
pub struct LustreLogCreateConfiguration {
    ...
    /// <ul>
    /// <li>
    /// <p><code>WARN_ONLY</code> - only warning events are logged.</p></li>
    /// <li>
    /// <p><code>ERROR_ONLY</code> - only error events are logged.</p></li>
    /// <li>
    /// <p><code>WARN_ERROR</code> - both warning events and error events are logged.</p></li>
    /// <li>
    /// <p><code>DISABLED</code> - logging of data repository events is turned off.</p></li>
    /// </ul>
    ...
    /// <ul>
    /// <li>
    /// <p>The destination ARN that you provide must be in the same Amazon Web Services partition, Amazon Web Services Region, and Amazon Web Services account as your Amazon FSx file system.</p></li>
    /// <li>
    /// <p>The name of the Amazon CloudWatch Logs log group must begin with the <code>/aws/fsx</code> prefix.</p></li>
    /// <li>
    /// <p>If you do not provide a destination, Amazon FSx will create and use a log stream in the CloudWatch Logs <code>/aws/fsx/lustre</code> log group (for Amazon FSx for Lustre) or <code>/aws/fsx/filecache</code> (for Amazon File Cache).</p></li>
    /// <li>
    /// <p>If <code>Destination</code> is provided and the resource does not exist, the request will fail with a <code>BadRequest</code> error.</p></li>
    /// <li>
    /// <p>If <code>Level</code> is set to <code>DISABLED</code>, you cannot specify a destination in <code>Destination</code>.</p></li>
    /// </ul>
