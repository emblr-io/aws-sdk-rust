...
impl ::std::convert::From<&str> for SnapshotLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnapshotLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnapshotLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnapshotLifecycle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SnapshotLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
