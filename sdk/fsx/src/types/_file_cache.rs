...
impl FileCache {
    /// Creates a new builder-style object to manufacture [`FileCache`](crate::types::FileCache).
    pub fn builder() -> crate::types::builders::FileCacheBuilder {
        crate::types::builders::FileCacheBuilder::default()
    }
}
