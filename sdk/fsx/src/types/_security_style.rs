...
impl ::std::convert::From<&str> for SecurityStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SecurityStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SecurityStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SecurityStyle::from(s))
    }
}
impl SecurityStyle {
...
impl ::std::convert::AsRef<str> for SecurityStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
