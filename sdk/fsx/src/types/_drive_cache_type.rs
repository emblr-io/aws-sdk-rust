...
impl ::std::convert::From<&str> for DriveCacheType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DriveCacheType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DriveCacheType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DriveCacheType::from(s))
    }
}
impl DriveCacheType {
...
impl ::std::convert::AsRef<str> for DriveCacheType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
