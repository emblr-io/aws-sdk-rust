...
impl ::std::convert::From<&str> for FileCacheType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FileCacheType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FileCacheType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FileCacheType::from(s))
    }
}
impl FileCacheType {
...
impl ::std::convert::AsRef<str> for FileCacheType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
