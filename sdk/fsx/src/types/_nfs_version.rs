...
impl ::std::convert::From<&str> for NfsVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NfsVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NfsVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NfsVersion::from(s))
    }
}
impl NfsVersion {
...
impl ::std::convert::AsRef<str> for NfsVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
