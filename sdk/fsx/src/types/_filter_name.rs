...
impl ::std::convert::From<&str> for FilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterName::from(s))
    }
}
impl FilterName {
...
impl ::std::convert::AsRef<str> for FilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
