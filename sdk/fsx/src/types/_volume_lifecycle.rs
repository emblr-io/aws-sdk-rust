...
impl ::std::convert::From<&str> for VolumeLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VolumeLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VolumeLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VolumeLifecycle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VolumeLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
