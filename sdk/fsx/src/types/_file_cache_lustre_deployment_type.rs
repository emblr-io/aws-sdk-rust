...
impl ::std::convert::From<&str> for FileCacheLustreDeploymentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FileCacheLustreDeploymentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FileCacheLustreDeploymentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FileCacheLustreDeploymentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FileCacheLustreDeploymentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FileCacheLustreDeploymentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FileCacheLustreDeploymentType::Cache1 => write!(f, "CACHE_1"),
            FileCacheLustreDeploymentType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
