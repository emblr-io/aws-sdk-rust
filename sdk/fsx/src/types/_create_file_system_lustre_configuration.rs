...
pub struct CreateFileSystemLustreConfiguration {
    ...
    /// <ul>
    /// <li>
    /// <p><code>NONE</code> - (Default) AutoImport is off. Amazon FSx only updates file and directory listings from the linked S3 bucket when the file system is created. FSx does not update file and directory listings for any new or changed objects after choosing this option.</p></li>
    /// <li>
    ...
    /// <ul>
    /// <li>
    /// <p>For <code>PERSISTENT_1</code> SSD storage: 50, 100, 200 MB/s/TiB.</p></li>
    /// <li>
    /// <p>For <code>PERSISTENT_1</code> HDD storage: 12, 40 MB/s/TiB.</p></li>
    /// <li>
    /// <p>For <code>PERSISTENT_2</code> SSD storage: 125, 250, 500, 1000 MB/s/TiB.</p></li>
    /// </ul>
    ...
    /// <ul>
    /// <li>
    /// <p><code>NONE</code> - (Default) Data compression is turned off when the file system is created.</p></li>
    /// <li>
    ...
    pub metadata_configuration: ::std::option::Option<crate::types::CreateFileSystemLustreMetadataConfiguration>,
...
impl CreateFileSystemLustreConfiguration {
    ...
    /// <p>The Lustre metadata performance configuration for the creation of an FSx for Lustre file system using a <code>PERSISTENT_2</code> deployment type.</p>
    pub fn metadata_configuration(&self) -> ::std::option::Option<&crate::types::CreateFileSystemLustreMetadataConfiguration> {
...
impl CreateFileSystemLustreConfigurationBuilder {
    ...
    pub fn drive_cache_type(mut self, input: crate::types::DriveCacheType) -> Self {
        self.drive_cache_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The type of drive cache used by <code>PERSISTENT_1</code> file systems that are provisioned with HDD storage devices. This parameter is required when storage type is HDD. Set this property to <code>READ</code> to improve the performance for frequently accessed files by caching up to 20% of the total storage capacity of the file system.</p>
    /// <p>This parameter is required when <code>StorageType</code> is set to <code>HDD</code>.</p>
    ...
    /// <p>The type of drive cache used by <code>PERSISTENT_1</code> file systems that are provisioned with HDD storage devices. This parameter is required when storage type is HDD. Set this property to <code>READ</code> to improve the performance for frequently accessed files by caching up to 20% of the total storage capacity of the file system.</p>
    /// <p>This parameter is required when <code>StorageType</code> is set to <code>HDD</code>.</p>
    pub fn get_drive_cache_type(&self) -> &::std::option::Option<crate::types::DriveCacheType> {
    ...
    /// <p>The Lustre metadata performance configuration for the creation of an FSx for Lustre file system using a <code>PERSISTENT_2</code> deployment type.</p>
    pub fn metadata_configuration(mut self, input: crate::types::CreateFileSystemLustreMetadataConfiguration) -> Self {
        self.metadata_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The Lustre metadata performance configuration for the creation of an FSx for Lustre file system using a <code>PERSISTENT_2</code> deployment type.</p>
    pub fn set_metadata_configuration(mut self, input: ::std::option::Option<crate::types::CreateFileSystemLustreMetadataConfiguration>) -> Self {
        self.metadata_configuration = input;
        self
    }
    /// <p>The Lustre metadata performance configuration for the creation of an FSx for Lustre file system using a <code>PERSISTENT_2</code> deployment type.</p>
    pub fn get_metadata_configuration(&self) -> &::std::option::Option<crate::types::CreateFileSystemLustreMetadataConfiguration> {
