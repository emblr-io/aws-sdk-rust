...
impl ::std::convert::From<&str> for DataCompressionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataCompressionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataCompressionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataCompressionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataCompressionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
