...
impl ::std::convert::From<&str> for InputOntapVolumeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InputOntapVolumeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InputOntapVolumeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InputOntapVolumeType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InputOntapVolumeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
