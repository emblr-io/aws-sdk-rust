...
impl ::std::convert::From<&str> for VolumeFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VolumeFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VolumeFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VolumeFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VolumeFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
