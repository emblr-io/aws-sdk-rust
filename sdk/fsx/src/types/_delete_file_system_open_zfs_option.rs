...
impl ::std::convert::From<&str> for DeleteFileSystemOpenZfsOption {
    fn from(s: &str) -> Self {
        match s {
            "DELETE_CHILD_VOLUMES_AND_SNAPSHOTS" => DeleteFileSystemOpenZfsOption::DeleteChildVolumesAndSnapshots,
            other => DeleteFileSystemOpenZfsOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeleteFileSystemOpenZfsOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeleteFileSystemOpenZfsOption::from(s))
    }
}
impl DeleteFileSystemOpenZfsOption {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DeleteFileSystemOpenZfsOption::DeleteChildVolumesAndSnapshots => "DELETE_CHILD_VOLUMES_AND_SNAPSHOTS",
...
impl ::std::convert::AsRef<str> for DeleteFileSystemOpenZfsOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DeleteFileSystemOpenZfsOption {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DeleteFileSystemOpenZfsOption::DeleteChildVolumesAndSnapshots => write!(f, "DELETE_CHILD_VOLUMES_AND_SNAPSHOTS"),
            DeleteFileSystemOpenZfsOption::Unknown(value) => write!(f, "{}", value),
        }
    }
}
