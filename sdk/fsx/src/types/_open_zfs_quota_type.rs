...
impl ::std::convert::From<&str> for OpenZfsQuotaType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OpenZfsQuotaType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OpenZfsQuotaType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OpenZfsQuotaType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OpenZfsQuotaType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
