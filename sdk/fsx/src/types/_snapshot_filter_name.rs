...
impl ::std::convert::From<&str> for SnapshotFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnapshotFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnapshotFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnapshotFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SnapshotFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
