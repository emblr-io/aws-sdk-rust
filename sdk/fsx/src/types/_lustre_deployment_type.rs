...
impl ::std::convert::From<&str> for LustreDeploymentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LustreDeploymentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LustreDeploymentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LustreDeploymentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LustreDeploymentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
