...
impl ::std::convert::From<&str> for ReportScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportScope::from(s))
    }
}
impl ReportScope {
...
impl ::std::convert::AsRef<str> for ReportScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
