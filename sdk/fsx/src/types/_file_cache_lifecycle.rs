...
impl ::std::convert::From<&str> for FileCacheLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FileCacheLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FileCacheLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FileCacheLifecycle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FileCacheLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
