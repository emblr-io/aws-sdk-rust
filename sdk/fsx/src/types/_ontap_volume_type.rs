...
impl ::std::convert::From<&str> for OntapVolumeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OntapVolumeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OntapVolumeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OntapVolumeType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OntapVolumeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OntapVolumeType {
