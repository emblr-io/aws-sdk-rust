...
pub struct AutoExportPolicy {
    ...
    /// <ul>
    /// <li>
    /// <p><code>NEW</code> - New files and directories are automatically exported to the data repository as they are added to the file system.</p></li>
    /// <li>
    /// <p><code>CHANGED</code> - Changes to files and directories on the file system are automatically exported to the data repository.</p></li>
    /// <li>
