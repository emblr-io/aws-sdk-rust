...
///     AssociationType::ReservationTimeWindowArn => { /* ... */ },
...
impl ::std::convert::From<&str> for AssociationType {
    fn from(s: &str) -> Self {
        match s {
            "RESERVATION_TIME_WINDOW_ARN" => AssociationType::ReservationTimeWindowArn,
            other => AssociationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssociationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssociationType::from(s))
    }
}
impl AssociationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AssociationType::ReservationTimeWindowArn => "RESERVATION_TIME_WINDOW_ARN",
...
impl ::std::convert::AsRef<str> for AssociationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AssociationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AssociationType::ReservationTimeWindowArn => write!(f, "RESERVATION_TIME_WINDOW_ARN"),
