...
impl ::std::convert::From<&str> for ReachabilityStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReachabilityStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReachabilityStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReachabilityStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReachabilityStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
