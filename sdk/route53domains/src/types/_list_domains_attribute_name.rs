...
impl ::std::convert::From<&str> for ListDomainsAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListDomainsAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListDomainsAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListDomainsAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListDomainsAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
