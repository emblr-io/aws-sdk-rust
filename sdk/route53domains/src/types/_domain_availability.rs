...
impl ::std::convert::From<&str> for DomainAvailability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DomainAvailability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DomainAvailability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DomainAvailability::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DomainAvailability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
