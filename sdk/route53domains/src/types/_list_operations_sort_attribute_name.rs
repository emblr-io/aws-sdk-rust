...
impl ::std::convert::From<&str> for ListOperationsSortAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListOperationsSortAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListOperationsSortAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListOperationsSortAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListOperationsSortAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
