...
impl ::std::convert::From<&str> for StatusFlag {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatusFlag::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatusFlag {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatusFlag::from(s))
    }
}
impl StatusFlag {
...
impl ::std::convert::AsRef<str> for StatusFlag {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
