...
//! aws-sdk-codegurusecurity = "0.0.0-local"
...
//! offered by Amazon CodeGuru Security. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CodeGuru Security.
...
/// For example, the [`CreateScan`](crate::operation::create_scan) operation has
/// a [`Client::create_scan`], function which returns a builder for that operation.
...
/// Configuration for Amazon CodeGuru Security.
pub mod config;
