...
///     ErrorCode::InvalidFindingId => { /* ... */ },
///     ErrorCode::InvalidScanName => { /* ... */ },
...
impl ::std::convert::From<&str> for ErrorCode {
    fn from(s: &str) -> Self {
        match s {
            "DUPLICATE_IDENTIFIER" => ErrorCode::DuplicateIdentifier,
            "INTERNAL_ERROR" => ErrorCode::InternalError,
            "INVALID_FINDING_ID" => ErrorCode::InvalidFindingId,
            "INVALID_SCAN_NAME" => ErrorCode::InvalidScanName,
            "ITEM_DOES_NOT_EXIST" => ErrorCode::ItemDoesNotExist,
...
impl ErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ErrorCode::InvalidFindingId => "INVALID_FINDING_ID",
            ErrorCode::InvalidScanName => "INVALID_SCAN_NAME",
            ErrorCode::ItemDoesNotExist => "ITEM_DOES_NOT_EXIST",
