...
impl ::std::convert::From<&str> for FieldNameString {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FieldNameString::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FieldNameString {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FieldNameString::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FieldNameString {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
