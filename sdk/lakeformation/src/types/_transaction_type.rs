...
impl ::std::convert::From<&str> for TransactionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransactionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransactionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransactionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransactionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
