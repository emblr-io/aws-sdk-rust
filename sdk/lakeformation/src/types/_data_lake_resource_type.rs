...
impl ::std::convert::From<&str> for DataLakeResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataLakeResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataLakeResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataLakeResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataLakeResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
