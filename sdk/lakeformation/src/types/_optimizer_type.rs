...
impl ::std::convert::From<&str> for OptimizerType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OptimizerType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OptimizerType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OptimizerType::from(s))
    }
}
impl OptimizerType {
...
impl ::std::convert::AsRef<str> for OptimizerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
