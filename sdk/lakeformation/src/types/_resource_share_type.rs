...
impl ::std::convert::From<&str> for ResourceShareType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceShareType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceShareType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceShareType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceShareType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
