...
impl ::std::convert::From<&str> for TransactionStatusFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransactionStatusFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransactionStatusFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransactionStatusFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransactionStatusFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
