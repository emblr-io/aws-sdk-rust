...
//! aws-sdk-lakeformation = "0.0.0-local"
...
//! offered by AWS Lake Formation. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Lake Formation.
...
/// For example, the [`AddLFTagsToResource`](crate::operation::add_lf_tags_to_resource) operation has
/// a [`Client::add_lf_tags_to_resource`], function which returns a builder for that operation.
...
/// Configuration for AWS Lake Formation.
pub mod config;
