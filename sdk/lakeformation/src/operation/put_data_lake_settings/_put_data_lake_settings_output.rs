...
impl ::aws_types::request_id::RequestId for PutDataLakeSettingsOutput {
...
impl PutDataLakeSettingsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutDataLakeSettingsOutput`](crate::operation::put_data_lake_settings::PutDataLakeSettingsOutput).
    pub fn build(self) -> crate::operation::put_data_lake_settings::PutDataLakeSettingsOutput {
