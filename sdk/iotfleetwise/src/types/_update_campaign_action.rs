...
impl ::std::convert::From<&str> for UpdateCampaignAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateCampaignAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpdateCampaignAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpdateCampaignAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UpdateCampaignAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
