...
impl ::std::convert::From<&str> for DiagnosticsMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DiagnosticsMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DiagnosticsMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DiagnosticsMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DiagnosticsMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
