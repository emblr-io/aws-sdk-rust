...
impl ::std::convert::From<&str> for UpdateMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpdateMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpdateMode::from(s))
    }
}
impl UpdateMode {
...
impl ::std::convert::AsRef<str> for UpdateMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
