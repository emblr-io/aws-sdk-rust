...
impl ::std::convert::From<&str> for NodeDataEncoding {
    fn from(s: &str) -> Self {
        match s {
            "BINARY" => NodeDataEncoding::Binary,
            "TYPED" => NodeDataEncoding::Typed,
            other => NodeDataEncoding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeDataEncoding {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeDataEncoding::from(s))
    }
}
impl NodeDataEncoding {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            NodeDataEncoding::Binary => "BINARY",
            NodeDataEncoding::Typed => "TYPED",
            NodeDataEncoding::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for NodeDataEncoding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
