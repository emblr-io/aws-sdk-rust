...
impl ::std::convert::From<&str> for VehicleAssociationBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VehicleAssociationBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VehicleAssociationBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VehicleAssociationBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VehicleAssociationBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
