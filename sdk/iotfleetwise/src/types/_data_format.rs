...
impl ::std::convert::From<&str> for DataFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataFormat::from(s))
    }
}
impl DataFormat {
...
impl ::std::convert::AsRef<str> for DataFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
