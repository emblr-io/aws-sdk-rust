...
impl ::std::convert::From<&str> for TriggerMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TriggerMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TriggerMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TriggerMode::from(s))
    }
}
impl TriggerMode {
...
impl ::std::convert::AsRef<str> for TriggerMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
