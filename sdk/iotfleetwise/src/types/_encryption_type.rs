...
///     EncryptionType::FleetwiseDefaultEncryption => { /* ... */ },
...
impl ::std::convert::From<&str> for EncryptionType {
    fn from(s: &str) -> Self {
        match s {
            "FLEETWISE_DEFAULT_ENCRYPTION" => EncryptionType::FleetwiseDefaultEncryption,
...
impl EncryptionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EncryptionType::FleetwiseDefaultEncryption => "FLEETWISE_DEFAULT_ENCRYPTION",
...
impl ::std::fmt::Display for EncryptionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EncryptionType::FleetwiseDefaultEncryption => write!(f, "FLEETWISE_DEFAULT_ENCRYPTION"),
