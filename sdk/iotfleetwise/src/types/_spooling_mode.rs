...
impl ::std::convert::From<&str> for SpoolingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpoolingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpoolingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpoolingMode::from(s))
    }
}
impl SpoolingMode {
...
impl ::std::convert::AsRef<str> for SpoolingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
