...
impl CustomStruct {
    /// Creates a new builder-style object to manufacture [`CustomStruct`](crate::types::CustomStruct).
    pub fn builder() -> crate::types::builders::CustomStructBuilder {
        crate::types::builders::CustomStructBuilder::default()
    }
}

/// A builder for [`CustomStruct`](crate::types::CustomStruct).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CustomStructBuilder {
...
impl CustomStructBuilder {
    ...
    /// Consumes the builder and constructs a [`CustomStruct`](crate::types::CustomStruct).
    /// This method will fail if any of the following fields are not set:
    /// - [`fully_qualified_name`](crate::types::builders::CustomStructBuilder::fully_qualified_name)
    pub fn build(self) -> ::std::result::Result<crate::types::CustomStruct, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::CustomStruct {
            fully_qualified_name: self.fully_qualified_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "fully_qualified_name",
                    "fully_qualified_name was not specified but it is required when building CustomStruct",
                )
            })?,
