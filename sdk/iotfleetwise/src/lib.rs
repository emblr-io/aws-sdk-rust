...
//! offered by AWS IoT FleetWise. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT FleetWise.
...
/// Configuration for AWS IoT FleetWise.
pub mod config;
