...
//! offered by Amazon Elastic Kubernetes Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Elastic Kubernetes Service.
...
/// Configuration for Amazon Elastic Kubernetes Service.
pub mod config;
