...
impl ::std::convert::From<&str> for AccessScopeType {
    fn from(s: &str) -> Self {
        match s {
            "cluster" => AccessScopeType::Cluster,
            "namespace" => AccessScopeType::Namespace,
            other => AccessScopeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccessScopeType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccessScopeType::from(s))
    }
}
impl AccessScopeType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AccessScopeType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AccessScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
