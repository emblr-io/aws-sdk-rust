...
impl ::std::convert::From<&str> for SupportType {
    fn from(s: &str) -> Self {
        match s {
            "EXTENDED" => SupportType::Extended,
            "STANDARD" => SupportType::Standard,
            other => SupportType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SupportType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SupportType::from(s))
    }
}
impl SupportType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SupportType::Extended => "EXTENDED",
            SupportType::Standard => "STANDARD",
            SupportType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for SupportType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
