...
impl ::std::convert::From<&str> for ConnectorConfigProvider {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectorConfigProvider::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectorConfigProvider {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectorConfigProvider::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectorConfigProvider {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
