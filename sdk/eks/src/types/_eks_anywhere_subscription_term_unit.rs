...
pub enum EksAnywhereSubscriptionTermUnit {
    #[allow(missing_docs)] // documentation missing in model
    Months,
...
impl ::std::convert::From<&str> for EksAnywhereSubscriptionTermUnit {
    fn from(s: &str) -> Self {
        match s {
            "MONTHS" => EksAnywhereSubscriptionTermUnit::Months,
            other => EksAnywhereSubscriptionTermUnit::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EksAnywhereSubscriptionTermUnit {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EksAnywhereSubscriptionTermUnit::from(s))
    }
}
impl EksAnywhereSubscriptionTermUnit {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EksAnywhereSubscriptionTermUnit::Months => "MONTHS",
            EksAnywhereSubscriptionTermUnit::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for EksAnywhereSubscriptionTermUnit {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EksAnywhereSubscriptionTermUnit {
