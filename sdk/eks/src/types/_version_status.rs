...
/// match versionstatus {
///     VersionStatus::ExtendedSupport => { /* ... */ },
///     VersionStatus::StandardSupport => { /* ... */ },
...
impl ::std::convert::From<&str> for VersionStatus {
    fn from(s: &str) -> Self {
        match s {
            "EXTENDED_SUPPORT" => VersionStatus::ExtendedSupport,
            "STANDARD_SUPPORT" => VersionStatus::StandardSupport,
...
impl VersionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            VersionStatus::ExtendedSupport => "EXTENDED_SUPPORT",
            VersionStatus::StandardSupport => "STANDARD_SUPPORT",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["EXTENDED_SUPPORT", "STANDARD_SUPPORT", "UNSUPPORTED"]
    }
}
