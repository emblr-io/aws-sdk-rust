...
impl ::std::convert::From<&str> for TaintEffect {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TaintEffect::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TaintEffect {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TaintEffect::from(s))
    }
}
impl TaintEffect {
...
impl ::std::convert::AsRef<str> for TaintEffect {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
