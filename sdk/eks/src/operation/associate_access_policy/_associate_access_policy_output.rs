...
impl AssociateAccessPolicyOutput {
    ...
    pub fn builder() -> crate::operation::associate_access_policy::builders::AssociateAccessPolicyOutputBuilder {
        crate::operation::associate_access_policy::builders::AssociateAccessPolicyOutputBuilder::default()
    }
}
...
pub struct AssociateAccessPolicyOutputBuilder {
    ...
    pub(crate) associated_access_policy: ::std::option::Option<crate::types::AssociatedAccessPolicy>,
    _request_id: Option<String>,
}
impl AssociateAccessPolicyOutputBuilder {
    /// <p>The name of your cluster.</p>
    ...
    /// <p>The <code>AccessPolicy</code> and scope associated to the <code>AccessEntry</code>.</p>
    pub fn associated_access_policy(mut self, input: crate::types::AssociatedAccessPolicy) -> Self {
        self.associated_access_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The <code>AccessPolicy</code> and scope associated to the <code>AccessEntry</code>.</p>
