...
impl ListNodegroupsInput {
    /// Creates a new builder-style object to manufacture [`ListNodegroupsInput`](crate::operation::list_nodegroups::ListNodegroupsInput).
    pub fn builder() -> crate::operation::list_nodegroups::builders::ListNodegroupsInputBuilder {
        crate::operation::list_nodegroups::builders::ListNodegroupsInputBuilder::default()
    }
}
