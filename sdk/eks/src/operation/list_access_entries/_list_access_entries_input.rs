...
pub struct ListAccessEntriesInput {
    ...
    pub associated_policy_arn: ::std::option::Option<::std::string::String>,
...
impl ListAccessEntriesInput {
    /// Creates a new builder-style object to manufacture [`ListAccessEntriesInput`](crate::operation::list_access_entries::ListAccessEntriesInput).
    pub fn builder() -> crate::operation::list_access_entries::builders::ListAccessEntriesInputBuilder {
        crate::operation::list_access_entries::builders::ListAccessEntriesInputBuilder::default()
    }
}

/// A builder for [`ListAccessEntriesInput`](crate::operation::list_access_entries::ListAccessEntriesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListAccessEntriesInputBuilder {
    pub(crate) cluster_name: ::std::option::Option<::std::string::String>,
    pub(crate) associated_policy_arn: ::std::option::Option<::std::string::String>,
    pub(crate) max_results: ::std::option::Option<i32>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
}
impl ListAccessEntriesInputBuilder {
    /// <p>The name of your cluster.</p>
    ...
    /// <p>The ARN of an <code>AccessPolicy</code>. When you specify an access policy ARN, only the access entries associated to that access policy are returned. For a list of available policy ARNs, use <code>ListAccessPolicies</code>.</p>
    pub fn associated_policy_arn(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.associated_policy_arn = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The ARN of an <code>AccessPolicy</code>. When you specify an access policy ARN, only the access entries associated to that access policy are returned. For a list of available policy ARNs, use <code>ListAccessPolicies</code>.</p>
