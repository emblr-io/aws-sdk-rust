...
pub struct ListAiAgentVersionsInput {
...
impl ListAiAgentVersionsInput {
    /// Creates a new builder-style object to manufacture [`ListAiAgentVersionsInput`](crate::operation::list_ai_agent_versions::ListAiAgentVersionsInput).
    pub fn builder() -> crate::operation::list_ai_agent_versions::builders::ListAiAgentVersionsInputBuilder {
        crate::operation::list_ai_agent_versions::builders::ListAiAgentVersionsInputBuilder::default()
    }
}

/// A builder for [`ListAiAgentVersionsInput`](crate::operation::list_ai_agent_versions::ListAiAgentVersionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListAiAgentVersionsInputBuilder {
...
impl ListAiAgentVersionsInputBuilder {
    /// <p>The identifier of the Amazon Q in Connect assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
    ...
    /// Consumes the builder and constructs a [`ListAiAgentVersionsInput`](crate::operation::list_ai_agent_versions::ListAiAgentVersionsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_ai_agent_versions::ListAiAgentVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_ai_agent_versions::ListAiAgentVersionsInput {
