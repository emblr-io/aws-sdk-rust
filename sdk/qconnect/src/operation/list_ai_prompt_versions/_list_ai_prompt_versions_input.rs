...
pub struct ListAiPromptVersionsInput {
...
impl ListAiPromptVersionsInput {
    /// <p>The identifier of the Amazon Q in Connect assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
...
impl ListAiPromptVersionsInput {
    /// Creates a new builder-style object to manufacture [`ListAiPromptVersionsInput`](crate::operation::list_ai_prompt_versions::ListAiPromptVersionsInput).
    pub fn builder() -> crate::operation::list_ai_prompt_versions::builders::ListAiPromptVersionsInputBuilder {
        crate::operation::list_ai_prompt_versions::builders::ListAiPromptVersionsInputBuilder::default()
    }
}

/// A builder for [`ListAiPromptVersionsInput`](crate::operation::list_ai_prompt_versions::ListAiPromptVersionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListAiPromptVersionsInputBuilder {
...
impl ListAiPromptVersionsInputBuilder {
    /// <p>The identifier of the Amazon Q in Connect assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
    ...
    /// Consumes the builder and constructs a [`ListAiPromptVersionsInput`](crate::operation::list_ai_prompt_versions::ListAiPromptVersionsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_ai_prompt_versions::ListAiPromptVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_ai_prompt_versions::ListAiPromptVersionsInput {
