...
impl StartImportJobOutput {
    ...
    pub fn builder() -> crate::operation::start_import_job::builders::StartImportJobOutputBuilder {
        crate::operation::start_import_job::builders::StartImportJobOutputBuilder::default()
    }
}

/// A builder for [`StartImportJobOutput`](crate::operation::start_import_job::StartImportJobOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartImportJobOutputBuilder {
    pub(crate) import_job: ::std::option::Option<crate::types::ImportJobData>,
    _request_id: Option<String>,
}
impl StartImportJobOutputBuilder {
    /// <p>The import job.</p>
