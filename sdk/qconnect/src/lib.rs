...
//! offered by Amazon Q Connect. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Q Connect.
...
/// Configuration for Amazon Q Connect.
pub mod config;
