...
impl ::std::convert::From<&str> for AssistantType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssistantType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssistantType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssistantType::from(s))
    }
}
impl AssistantType {
...
impl ::std::convert::AsRef<str> for AssistantType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
