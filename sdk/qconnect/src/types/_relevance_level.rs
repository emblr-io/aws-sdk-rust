...
impl ::std::convert::From<&str> for RelevanceLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RelevanceLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RelevanceLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RelevanceLevel::from(s))
    }
}
impl RelevanceLevel {
...
impl ::std::convert::AsRef<str> for RelevanceLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
