...
impl ::std::fmt::Debug for GuardrailRegexConfig {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GuardrailRegexConfig");
...
impl ::std::fmt::Debug for GuardrailRegexConfigBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GuardrailRegexConfigBuilder");
        formatter.field("name", &"*** Sensitive Data Redacted ***");
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("pattern", &"*** Sensitive Data Redacted ***");
        formatter.field("action", &"*** Sensitive Data Redacted ***");
