...
pub enum ContentFeedbackData {
    /// <p>Information about the feedback for a generative target type.</p>
    GenerativeContentFeedbackData(crate::types::GenerativeContentFeedbackData),
...
impl ContentFeedbackData {
    ...
    pub fn is_generative_content_feedback_data(&self) -> bool {
        self.as_generative_content_feedback_data().is_ok()
    }
