...
pub enum QueryConditionFieldName {
    #[allow(missing_docs)] // documentation missing in model
    ResultType,
...
impl ::std::convert::From<&str> for QueryConditionFieldName {
    fn from(s: &str) -> Self {
        match s {
            "RESULT_TYPE" => QueryConditionFieldName::ResultType,
            other => QueryConditionFieldName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for QueryConditionFieldName {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(QueryConditionFieldName::from(s))
    }
}
impl QueryConditionFieldName {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            QueryConditionFieldName::ResultType => "RESULT_TYPE",
            QueryConditionFieldName::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for QueryConditionFieldName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
