...
/// match syncstatus {
///     SyncStatus::CreateInProgress => { /* ... */ },
///     SyncStatus::SyncingInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for SyncStatus {
    fn from(s: &str) -> Self {
        match s {
            "CREATE_IN_PROGRESS" => SyncStatus::CreateInProgress,
            "SYNCING_IN_PROGRESS" => SyncStatus::SyncingInProgress,
            "SYNC_FAILED" => SyncStatus::SyncFailed,
            "SYNC_SUCCESS" => SyncStatus::SyncSuccess,
            other => SyncStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncStatus::from(s))
    }
}
impl SyncStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SyncStatus::CreateInProgress => "CREATE_IN_PROGRESS",
            SyncStatus::SyncingInProgress => "SYNCING_IN_PROGRESS",
            SyncStatus::SyncFailed => "SYNC_FAILED",
            SyncStatus::SyncSuccess => "SYNC_SUCCESS",
            SyncStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["CREATE_IN_PROGRESS", "SYNCING_IN_PROGRESS", "SYNC_FAILED", "SYNC_SUCCESS"]
    }
}
impl ::std::convert::AsRef<str> for SyncStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SyncStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SyncStatus::CreateInProgress => write!(f, "CREATE_IN_PROGRESS"),
