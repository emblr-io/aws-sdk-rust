...
///     RecommendationTriggerType::Generative => { /* ... */ },
...
impl ::std::convert::From<&str> for RecommendationTriggerType {
    fn from(s: &str) -> Self {
        match s {
            "GENERATIVE" => RecommendationTriggerType::Generative,
            "QUERY" => RecommendationTriggerType::Query,
            other => RecommendationTriggerType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecommendationTriggerType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecommendationTriggerType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecommendationTriggerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
