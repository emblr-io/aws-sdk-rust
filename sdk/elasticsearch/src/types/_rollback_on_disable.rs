...
impl ::std::convert::From<&str> for RollbackOnDisable {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RollbackOnDisable::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RollbackOnDisable {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RollbackOnDisable::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RollbackOnDisable {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
