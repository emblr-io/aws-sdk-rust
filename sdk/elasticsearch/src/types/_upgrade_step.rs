...
impl ::std::convert::From<&str> for UpgradeStep {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpgradeStep::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpgradeStep {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpgradeStep::from(s))
    }
}
impl UpgradeStep {
...
impl ::std::convert::AsRef<str> for UpgradeStep {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
