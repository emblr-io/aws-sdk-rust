...
impl ::std::convert::From<&str> for AutoTuneType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoTuneType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoTuneType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoTuneType::from(s))
    }
}
impl AutoTuneType {
...
impl ::std::convert::AsRef<str> for AutoTuneType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
