...
impl ::std::convert::From<&str> for PropertyValueType {
    fn from(s: &str) -> Self {
        match s {
            "PLAIN_TEXT" => PropertyValueType::PlainText,
            "STRINGIFIED_JSON" => PropertyValueType::StringifiedJson,
            other => PropertyValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PropertyValueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PropertyValueType::from(s))
    }
}
impl PropertyValueType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PropertyValueType::PlainText => "PLAIN_TEXT",
            PropertyValueType::StringifiedJson => "STRINGIFIED_JSON",
            PropertyValueType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for PropertyValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
