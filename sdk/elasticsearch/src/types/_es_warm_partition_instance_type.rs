...
impl ::std::convert::From<&str> for EsWarmPartitionInstanceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EsWarmPartitionInstanceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EsWarmPartitionInstanceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EsWarmPartitionInstanceType::from(s))
    }
}
