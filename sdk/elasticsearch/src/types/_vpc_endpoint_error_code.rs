...
impl ::std::convert::From<&str> for VpcEndpointErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcEndpointErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpcEndpointErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpcEndpointErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VpcEndpointErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
