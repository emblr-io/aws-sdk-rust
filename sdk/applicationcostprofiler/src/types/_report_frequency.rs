...
impl ::std::convert::From<&str> for ReportFrequency {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportFrequency::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportFrequency {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportFrequency::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportFrequency {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
