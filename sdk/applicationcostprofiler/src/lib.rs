...
//! offered by AWS Application Cost Profiler. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Application Cost Profiler.
...
/// Configuration for AWS Application Cost Profiler.
pub mod config;
