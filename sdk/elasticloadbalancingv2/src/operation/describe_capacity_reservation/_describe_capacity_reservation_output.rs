...
impl DescribeCapacityReservationOutput {
    /// <p>The last time the capacity reservation was modified.</p>
...
impl ::aws_types::request_id::RequestId for DescribeCapacityReservationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeCapacityReservationOutput {
    /// Creates a new builder-style object to manufacture [`DescribeCapacityReservationOutput`](crate::operation::describe_capacity_reservation::DescribeCapacityReservationOutput).
    pub fn builder() -> crate::operation::describe_capacity_reservation::builders::DescribeCapacityReservationOutputBuilder {
        crate::operation::describe_capacity_reservation::builders::DescribeCapacityReservationOutputBuilder::default()
    }
}

/// A builder for [`DescribeCapacityReservationOutput`](crate::operation::describe_capacity_reservation::DescribeCapacityReservationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeCapacityReservationOutputBuilder {
...
impl DescribeCapacityReservationOutputBuilder {
    /// <p>The last time the capacity reservation was modified.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeCapacityReservationOutput`](crate::operation::describe_capacity_reservation::DescribeCapacityReservationOutput).
    pub fn build(self) -> crate::operation::describe_capacity_reservation::DescribeCapacityReservationOutput {
        crate::operation::describe_capacity_reservation::DescribeCapacityReservationOutput {
