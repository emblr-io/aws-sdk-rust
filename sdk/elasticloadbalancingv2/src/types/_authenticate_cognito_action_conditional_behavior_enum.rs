...
impl ::std::convert::From<&str> for AuthenticateCognitoActionConditionalBehaviorEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthenticateCognitoActionConditionalBehaviorEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::str::FromStr for AuthenticateCognitoActionConditionalBehaviorEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthenticateCognitoActionConditionalBehaviorEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthenticateCognitoActionConditionalBehaviorEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
