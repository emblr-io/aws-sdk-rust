...
pub struct TargetHealth {
    ...
    /// <ul>
    /// <li>
    /// <p><code>Elb.RegistrationInProgress</code> - The target is in the process of being registered with the load balancer.</p></li>
    /// <li>
    /// <p><code>Elb.InitialHealthChecking</code> - The load balancer is still sending the target the minimum number of health checks required to determine its health status.</p></li>
    /// </ul>
    ...
    /// <ul>
    /// <li>
    /// <p><code>Target.NotRegistered</code> - The target is not registered with the target group.</p></li>
    /// <li>
    /// <p><code>Target.NotInUse</code> - The target group is not used by any load balancer or the target is in an Availability Zone that is not enabled for its load balancer.</p></li>
    /// <li>
    /// <p><code>Target.InvalidState</code> - The target is in the stopped or terminated state.</p></li>
    /// <li>
    /// <p><code>Target.IpUnusable</code> - The target IP address is reserved for use by a load balancer.</p></li>
    /// </ul>
    /// <p>If the target state is <code>draining</code>, the reason code can be the following value:</p>
    /// <ul>
    /// <li>
    /// <p><code>Target.DeregistrationInProgress</code> - The target is in the process of being deregistered and the deregistration delay period has not expired.</p></li>
    /// </ul>
...
impl TargetHealthBuilder {
    ...
    /// <p>The state of the target.</p>
    pub fn get_state(&self) -> &::std::option::Option<crate::types::TargetHealthStateEnum> {
        &self.state
    }
    /// <p>The reason code.</p>
    /// <p>If the target state is <code>healthy</code>, a reason code is not provided.</p>
