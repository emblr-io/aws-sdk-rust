...
impl DescribeTrustStoreRevocation {
    /// Creates a new builder-style object to manufacture [`DescribeTrustStoreRevocation`](crate::types::DescribeTrustStoreRevocation).
    pub fn builder() -> crate::types::builders::DescribeTrustStoreRevocationBuilder {
        crate::types::builders::DescribeTrustStoreRevocationBuilder::default()
    }
}
...
impl DescribeTrustStoreRevocationBuilder {
    /// <p>The Amazon Resource Name (ARN) of the trust store.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeTrustStoreRevocation`](crate::types::DescribeTrustStoreRevocation).
    pub fn build(self) -> crate::types::DescribeTrustStoreRevocation {
        crate::types::DescribeTrustStoreRevocation {
