...
impl ::std::convert::From<&str> for TargetTypeEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetTypeEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetTypeEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetTypeEnum::from(s))
    }
}
impl TargetTypeEnum {
...
impl ::std::convert::AsRef<str> for TargetTypeEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
