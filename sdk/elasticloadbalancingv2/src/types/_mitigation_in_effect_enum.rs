...
pub enum MitigationInEffectEnum {
    #[allow(missing_docs)] // documentation missing in model
    No,
    #[allow(missing_docs)] // documentation missing in model
    Yes,
...
impl ::std::convert::From<&str> for MitigationInEffectEnum {
    fn from(s: &str) -> Self {
        match s {
            "no" => MitigationInEffectEnum::No,
            "yes" => MitigationInEffectEnum::Yes,
            other => MitigationInEffectEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MitigationInEffectEnum {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MitigationInEffectEnum::from(s))
    }
}
impl MitigationInEffectEnum {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MitigationInEffectEnum::No => "no",
            MitigationInEffectEnum::Yes => "yes",
            MitigationInEffectEnum::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for MitigationInEffectEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
