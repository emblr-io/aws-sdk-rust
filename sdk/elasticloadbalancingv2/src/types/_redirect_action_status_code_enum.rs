...
impl ::std::convert::From<&str> for RedirectActionStatusCodeEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RedirectActionStatusCodeEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RedirectActionStatusCodeEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RedirectActionStatusCodeEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RedirectActionStatusCodeEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RedirectActionStatusCodeEnum {
