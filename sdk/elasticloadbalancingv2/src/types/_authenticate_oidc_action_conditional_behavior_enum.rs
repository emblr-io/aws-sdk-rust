...
impl ::std::convert::From<&str> for AuthenticateOidcActionConditionalBehaviorEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                AuthenticateOidcActionConditionalBehaviorEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for AuthenticateOidcActionConditionalBehaviorEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthenticateOidcActionConditionalBehaviorEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthenticateOidcActionConditionalBehaviorEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
