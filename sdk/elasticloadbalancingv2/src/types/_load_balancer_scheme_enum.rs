...
impl ::std::convert::From<&str> for LoadBalancerSchemeEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoadBalancerSchemeEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoadBalancerSchemeEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoadBalancerSchemeEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LoadBalancerSchemeEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
