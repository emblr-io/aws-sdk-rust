...
//! offered by Amazon Lookout for Vision. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Lookout for Vision.
...
/// Configuration for Amazon Lookout for Vision.
pub mod config;
