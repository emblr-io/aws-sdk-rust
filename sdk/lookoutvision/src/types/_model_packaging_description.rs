...
impl ModelPackagingDescription {
    /// Creates a new builder-style object to manufacture [`ModelPackagingDescription`](crate::types::ModelPackagingDescription).
    pub fn builder() -> crate::types::builders::ModelPackagingDescriptionBuilder {
        crate::types::builders::ModelPackagingDescriptionBuilder::default()
    }
}
...
impl ModelPackagingDescriptionBuilder {
    ...
    pub fn build(self) -> crate::types::ModelPackagingDescription {
        crate::types::ModelPackagingDescription {
