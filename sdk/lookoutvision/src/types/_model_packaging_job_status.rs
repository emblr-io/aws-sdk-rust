...
impl ::std::convert::From<&str> for ModelPackagingJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelPackagingJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelPackagingJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelPackagingJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelPackagingJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
