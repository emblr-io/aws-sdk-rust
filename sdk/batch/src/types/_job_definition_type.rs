...
impl ::std::convert::From<&str> for JobDefinitionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobDefinitionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobDefinitionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobDefinitionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JobDefinitionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
