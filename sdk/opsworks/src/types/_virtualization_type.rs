...
impl ::std::convert::From<&str> for VirtualizationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VirtualizationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VirtualizationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VirtualizationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VirtualizationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
