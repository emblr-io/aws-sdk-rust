...
impl ::std::convert::From<&str> for CloudWatchLogsTimeZone {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CloudWatchLogsTimeZone::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CloudWatchLogsTimeZone {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CloudWatchLogsTimeZone::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CloudWatchLogsTimeZone {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
