...
impl ::std::convert::From<&str> for StackAttributesKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackAttributesKeys::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackAttributesKeys {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackAttributesKeys::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StackAttributesKeys {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
