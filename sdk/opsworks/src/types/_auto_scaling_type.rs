...
impl ::std::convert::From<&str> for AutoScalingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoScalingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoScalingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoScalingType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoScalingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
