...
impl ::std::convert::From<&str> for RootDeviceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RootDeviceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RootDeviceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RootDeviceType::from(s))
    }
}
impl RootDeviceType {
...
impl ::std::convert::AsRef<str> for RootDeviceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RootDeviceType {
