...
impl ::aws_types::request_id::RequestId for UpdateRdsDbInstanceOutput {
...
impl UpdateRdsDbInstanceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateRdsDbInstanceOutput`](crate::operation::update_rds_db_instance::UpdateRdsDbInstanceOutput).
    pub fn build(self) -> crate::operation::update_rds_db_instance::UpdateRdsDbInstanceOutput {
