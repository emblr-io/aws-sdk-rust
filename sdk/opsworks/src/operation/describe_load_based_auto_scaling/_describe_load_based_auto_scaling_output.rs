...
impl DescribeLoadBasedAutoScalingOutput {
    /// <p>An array of <code>LoadBasedAutoScalingConfiguration</code> objects that describe each layer's configuration.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.load_based_auto_scaling_configurations.is_none()`.
    pub fn load_based_auto_scaling_configurations(&self) -> &[crate::types::LoadBasedAutoScalingConfiguration] {
