...
impl ::std::convert::From<&str> for RoutingControlState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RoutingControlState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RoutingControlState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RoutingControlState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RoutingControlState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
