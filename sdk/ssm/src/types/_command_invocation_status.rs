...
impl ::std::convert::From<&str> for CommandInvocationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CommandInvocationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CommandInvocationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CommandInvocationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CommandInvocationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CommandInvocationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            CommandInvocationStatus::Cancelled => write!(f, "Cancelled"),
            CommandInvocationStatus::Cancelling => write!(f, "Cancelling"),
            CommandInvocationStatus::Delayed => write!(f, "Delayed"),
            CommandInvocationStatus::Failed => write!(f, "Failed"),
            CommandInvocationStatus::InProgress => write!(f, "InProgress"),
