...
impl AssociationVersionInfo {
    /// Creates a new builder-style object to manufacture [`AssociationVersionInfo`](crate::types::AssociationVersionInfo).
    pub fn builder() -> crate::types::builders::AssociationVersionInfoBuilder {
        crate::types::builders::AssociationVersionInfoBuilder::default()
    }
}
...
impl AssociationVersionInfoBuilder {
    /// <p>The ID created by the system when the association was created.</p>
    ...
    /// Consumes the builder and constructs a [`AssociationVersionInfo`](crate::types::AssociationVersionInfo).
    pub fn build(self) -> crate::types::AssociationVersionInfo {
        crate::types::AssociationVersionInfo {
...
impl ::std::fmt::Debug for AssociationVersionInfoBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("AssociationVersionInfoBuilder");
        formatter.field("association_id", &self.association_id);
        formatter.field("association_version", &self.association_version);
        formatter.field("created_date", &self.created_date);
        formatter.field("name", &self.name);
