...
impl ::std::convert::From<&str> for StopType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StopType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StopType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StopType::from(s))
    }
}
impl StopType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            StopType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for StopType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
