...
impl ::std::fmt::Display for UnsupportedInventorySchemaVersionException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "UnsupportedInventorySchemaVersionException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::UnsupportedInventorySchemaVersionException {
...
impl UnsupportedInventorySchemaVersionExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`UnsupportedInventorySchemaVersionException`](crate::types::error::UnsupportedInventorySchemaVersionException).
    pub fn build(self) -> crate::types::error::UnsupportedInventorySchemaVersionException {
