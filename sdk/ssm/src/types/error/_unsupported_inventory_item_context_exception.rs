...
impl ::std::fmt::Display for UnsupportedInventoryItemContextException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "UnsupportedInventoryItemContextException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::UnsupportedInventoryItemContextException {
