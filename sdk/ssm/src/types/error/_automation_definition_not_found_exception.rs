...
impl ::std::fmt::Display for AutomationDefinitionNotFoundException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "AutomationDefinitionNotFoundException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::AutomationDefinitionNotFoundException {
...
impl AutomationDefinitionNotFoundExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`AutomationDefinitionNotFoundException`](crate::types::error::AutomationDefinitionNotFoundException).
    pub fn build(self) -> crate::types::error::AutomationDefinitionNotFoundException {
