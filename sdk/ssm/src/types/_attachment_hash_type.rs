...
impl ::std::convert::From<&str> for AttachmentHashType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AttachmentHashType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttachmentHashType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttachmentHashType::from(s))
    }
}
impl AttachmentHashType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AttachmentHashType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AttachmentHashType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AttachmentHashType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AttachmentHashType::Sha256 => write!(f, "Sha256"),
            AttachmentHashType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
