...
impl ::std::convert::From<&str> for CommandFilterKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CommandFilterKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CommandFilterKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CommandFilterKey::from(s))
    }
}
impl CommandFilterKey {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CommandFilterKey::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for CommandFilterKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
