...
impl ::std::convert::From<&str> for ResourceTypeForTagging {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceTypeForTagging::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceTypeForTagging {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceTypeForTagging::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceTypeForTagging {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
