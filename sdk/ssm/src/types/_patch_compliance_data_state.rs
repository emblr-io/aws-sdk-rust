...
impl ::std::convert::From<&str> for PatchComplianceDataState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PatchComplianceDataState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PatchComplianceDataState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PatchComplianceDataState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PatchComplianceDataState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
