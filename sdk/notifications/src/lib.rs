...
//! aws-sdk-notifications = "0.0.0-local"
...
//! offered by AWS User Notifications. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS User Notifications.
...
/// Configuration for AWS User Notifications.
pub mod config;
