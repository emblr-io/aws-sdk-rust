...
impl ::std::convert::From<&str> for ChannelType {
    fn from(s: &str) -> Self {
        match s {
            "ACCOUNT_CONTACT" => ChannelType::AccountContact,
...
impl ChannelType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ChannelType::AccountContact => "ACCOUNT_CONTACT",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ACCOUNT_CONTACT", "CHATBOT", "EMAIL", "MOBILE"]
    }
}
...
impl ::std::fmt::Display for ChannelType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ChannelType::AccountContact => write!(f, "ACCOUNT_CONTACT"),
            ChannelType::Chatbot => write!(f, "CHATBOT"),
            ChannelType::Email => write!(f, "EMAIL"),
            ChannelType::Mobile => write!(f, "MOBILE"),
