...
pub struct NotificationHubStatusSummary {
    ...
    /// <ul>
    /// <li>
    /// <p>Incoming <code>NotificationEvents</code> are replicated to this <code>NotificationHub</code>.</p></li>
    /// </ul></li>
    /// <li>
    /// <p><code>REGISTERING</code></p>
    /// <ul>
    /// <li>
    /// <p>The <code>NotificationConfiguration</code> is initializing. A <code>NotificationConfiguration</code> with this status can't be deregistered.</p></li>
    /// </ul></li>
    /// <li>
    /// <p><code>DEREGISTERING</code></p>
    /// <ul>
    /// <li>
    /// <p>The <code>NotificationConfiguration</code> is being deleted. You can't register additional <code>NotificationHubs</code> in the same Region as a <code>NotificationConfiguration</code> with this status.</p></li>
    /// </ul></li>
    /// </ul></li>
    /// </ul>
