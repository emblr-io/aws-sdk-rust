...
impl ::std::fmt::Display for ServiceQuotaTemplateNotInUseException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "ServiceQuotaTemplateNotInUseException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::ServiceQuotaTemplateNotInUseException {
...
impl ServiceQuotaTemplateNotInUseExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`ServiceQuotaTemplateNotInUseException`](crate::types::error::ServiceQuotaTemplateNotInUseException).
    pub fn build(self) -> crate::types::error::ServiceQuotaTemplateNotInUseException {
