...
impl ::std::convert::From<&str> for KafkaVersionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => KafkaVersionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for KafkaVersionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KafkaVersionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for KafkaVersionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for KafkaVersionStatus {
