...
impl ::std::convert::From<&str> for ClientBroker {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientBroker::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientBroker {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientBroker::from(s))
    }
}
impl ClientBroker {
...
impl ::std::convert::AsRef<str> for ClientBroker {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
