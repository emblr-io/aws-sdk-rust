...
impl ::std::convert::From<&str> for StorageMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StorageMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StorageMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StorageMode::from(s))
    }
}
impl StorageMode {
...
impl ::std::convert::AsRef<str> for StorageMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
