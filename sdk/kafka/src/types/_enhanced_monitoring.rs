...
impl ::std::convert::From<&str> for EnhancedMonitoring {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnhancedMonitoring::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnhancedMonitoring {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnhancedMonitoring::from(s))
    }
}
