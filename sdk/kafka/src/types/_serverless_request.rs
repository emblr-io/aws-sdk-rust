...
impl ServerlessRequest {
    /// Creates a new builder-style object to manufacture [`ServerlessRequest`](crate::types::ServerlessRequest).
    pub fn builder() -> crate::types::builders::ServerlessRequestBuilder {
        crate::types::builders::ServerlessRequestBuilder::default()
    }
}
