...
impl ::aws_types::request_id::RequestId for UpdateBrokerStorageOutput {
...
impl UpdateBrokerStorageOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateBrokerStorageOutput`](crate::operation::update_broker_storage::UpdateBrokerStorageOutput).
    pub fn build(self) -> crate::operation::update_broker_storage::UpdateBrokerStorageOutput {
