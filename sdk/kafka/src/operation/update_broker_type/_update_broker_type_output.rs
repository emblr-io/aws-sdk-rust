...
impl ::aws_types::request_id::RequestId for UpdateBrokerTypeOutput {
...
impl UpdateBrokerTypeOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateBrokerTypeOutput`](crate::operation::update_broker_type::UpdateBrokerTypeOutput).
    pub fn build(self) -> crate::operation::update_broker_type::UpdateBrokerTypeOutput {
