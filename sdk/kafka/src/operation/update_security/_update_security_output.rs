...
impl ::aws_types::request_id::RequestId for UpdateSecurityOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateSecurityOutput {
    /// Creates a new builder-style object to manufacture [`UpdateSecurityOutput`](crate::operation::update_security::UpdateSecurityOutput).
    pub fn builder() -> crate::operation::update_security::builders::UpdateSecurityOutputBuilder {
        crate::operation::update_security::builders::UpdateSecurityOutputBuilder::default()
    }
}

/// A builder for [`UpdateSecurityOutput`](crate::operation::update_security::UpdateSecurityOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateSecurityOutputBuilder {
    pub(crate) cluster_arn: ::std::option::Option<::std::string::String>,
    pub(crate) cluster_operation_arn: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl UpdateSecurityOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateSecurityOutput`](crate::operation::update_security::UpdateSecurityOutput).
    pub fn build(self) -> crate::operation::update_security::UpdateSecurityOutput {
