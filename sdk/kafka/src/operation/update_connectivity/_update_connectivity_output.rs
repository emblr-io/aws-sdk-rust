...
impl ::aws_types::request_id::RequestId for UpdateConnectivityOutput {
...
impl UpdateConnectivityOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateConnectivityOutput`](crate::operation::update_connectivity::UpdateConnectivityOutput).
    pub fn build(self) -> crate::operation::update_connectivity::UpdateConnectivityOutput {
