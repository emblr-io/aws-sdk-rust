...
impl UpdateStorageOutput {
    /// Creates a new builder-style object to manufacture [`UpdateStorageOutput`](crate::operation::update_storage::UpdateStorageOutput).
    pub fn builder() -> crate::operation::update_storage::builders::UpdateStorageOutputBuilder {
        crate::operation::update_storage::builders::UpdateStorageOutputBuilder::default()
    }
}
...
impl UpdateStorageOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateStorageOutput`](crate::operation::update_storage::UpdateStorageOutput).
    pub fn build(self) -> crate::operation::update_storage::UpdateStorageOutput {
