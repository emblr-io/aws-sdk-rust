...
//! offered by Managed Streaming for Kafka. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Managed Streaming for Kafka.
...
/// For example, the [`BatchAssociateScramSecret`](crate::operation::batch_associate_scram_secret) operation has
...
/// Configuration for Managed Streaming for Kafka.
pub mod config;
