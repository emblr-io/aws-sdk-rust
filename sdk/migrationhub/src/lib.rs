...
//! aws-sdk-migrationhub = "0.0.0-local"
...
//! offered by AWS Migration Hub. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Migration Hub.
...
/// Configuration for AWS Migration Hub.
pub mod config;
