...
impl ::std::convert::From<&str> for ResourceAttributeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceAttributeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceAttributeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceAttributeType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceAttributeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
