...
impl ListCustomDomainAssociationsInput {
    /// Creates a new builder-style object to manufacture [`ListCustomDomainAssociationsInput`](crate::operation::list_custom_domain_associations::ListCustomDomainAssociationsInput).
    pub fn builder() -> crate::operation::list_custom_domain_associations::builders::ListCustomDomainAssociationsInputBuilder {
        crate::operation::list_custom_domain_associations::builders::ListCustomDomainAssociationsInputBuilder::default()
    }
}

/// A builder for [`ListCustomDomainAssociationsInput`](crate::operation::list_custom_domain_associations::ListCustomDomainAssociationsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListCustomDomainAssociationsInputBuilder {
...
impl ListCustomDomainAssociationsInputBuilder {
    /// <p>When <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page.</p>
