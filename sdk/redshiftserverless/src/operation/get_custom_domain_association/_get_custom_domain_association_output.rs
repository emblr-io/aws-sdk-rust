...
pub struct GetCustomDomainAssociationOutput {
...
impl GetCustomDomainAssociationOutput {
    /// <p>The custom domain name associated with the workgroup.</p>
...
impl ::aws_types::request_id::RequestId for GetCustomDomainAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetCustomDomainAssociationOutput {
    /// Creates a new builder-style object to manufacture [`GetCustomDomainAssociationOutput`](crate::operation::get_custom_domain_association::GetCustomDomainAssociationOutput).
    pub fn builder() -> crate::operation::get_custom_domain_association::builders::GetCustomDomainAssociationOutputBuilder {
        crate::operation::get_custom_domain_association::builders::GetCustomDomainAssociationOutputBuilder::default()
    }
}

/// A builder for [`GetCustomDomainAssociationOutput`](crate::operation::get_custom_domain_association::GetCustomDomainAssociationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetCustomDomainAssociationOutputBuilder {
...
impl GetCustomDomainAssociationOutputBuilder {
    /// <p>The custom domain name associated with the workgroup.</p>
    ...
    /// Consumes the builder and constructs a [`GetCustomDomainAssociationOutput`](crate::operation::get_custom_domain_association::GetCustomDomainAssociationOutput).
    pub fn build(self) -> crate::operation::get_custom_domain_association::GetCustomDomainAssociationOutput {
        crate::operation::get_custom_domain_association::GetCustomDomainAssociationOutput {
