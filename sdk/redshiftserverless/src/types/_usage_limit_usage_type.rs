...
impl ::std::convert::From<&str> for UsageLimitUsageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UsageLimitUsageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UsageLimitUsageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UsageLimitUsageType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UsageLimitUsageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
