...
impl ::std::convert::From<&str> for LogExport {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LogExport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogExport {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogExport::from(s))
    }
}
impl LogExport {
...
impl ::std::convert::AsRef<str> for LogExport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
