...
impl ::std::convert::From<&str> for WorkgroupStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkgroupStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkgroupStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkgroupStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkgroupStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
