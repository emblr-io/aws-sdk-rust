...
impl ::std::convert::From<&str> for ComputePlatform {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComputePlatform::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ComputePlatform {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ComputePlatform::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ComputePlatform {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
