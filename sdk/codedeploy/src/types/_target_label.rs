...
impl ::std::convert::From<&str> for TargetLabel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetLabel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetLabel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetLabel::from(s))
    }
}
impl TargetLabel {
...
impl ::std::convert::AsRef<str> for TargetLabel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
