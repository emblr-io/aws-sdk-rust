...
impl ::std::convert::From<&str> for ApplicationRevisionSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationRevisionSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationRevisionSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationRevisionSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationRevisionSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ApplicationRevisionSortBy {
