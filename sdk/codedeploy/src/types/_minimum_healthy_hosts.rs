...
pub struct MinimumHealthyHosts {
    ...
    /// <ul>
    /// <li>
    /// <p><code>HOST_COUNT</code>: The minimum number of healthy instances as an absolute value.</p></li>
    /// <li>
    /// <p><code>FLEET_PERCENT</code>: The minimum number of healthy instances as a percentage of the total number of instances in the deployment.</p></li>
    /// </ul>
