...
impl ::std::convert::From<&str> for DeploymentTargetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeploymentTargetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentTargetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentTargetType::from(s))
    }
}
