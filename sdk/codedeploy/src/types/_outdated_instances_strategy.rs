...
impl ::std::convert::From<&str> for OutdatedInstancesStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OutdatedInstancesStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OutdatedInstancesStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OutdatedInstancesStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OutdatedInstancesStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
