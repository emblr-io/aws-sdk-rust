...
impl ::std::convert::From<&str> for DeploymentWaitType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeploymentWaitType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentWaitType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentWaitType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeploymentWaitType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
