...
impl ::std::convert::From<&str> for TagFilterType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TagFilterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TagFilterType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TagFilterType::from(s))
    }
}
impl TagFilterType {
...
impl ::std::convert::AsRef<str> for TagFilterType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
