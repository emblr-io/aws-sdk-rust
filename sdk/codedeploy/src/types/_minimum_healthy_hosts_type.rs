...
impl ::std::convert::From<&str> for MinimumHealthyHostsType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MinimumHealthyHostsType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MinimumHealthyHostsType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MinimumHealthyHostsType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MinimumHealthyHostsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MinimumHealthyHostsType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            MinimumHealthyHostsType::FleetPercent => write!(f, "FLEET_PERCENT"),
            MinimumHealthyHostsType::HostCount => write!(f, "HOST_COUNT"),
            MinimumHealthyHostsType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
