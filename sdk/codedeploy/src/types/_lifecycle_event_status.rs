...
impl ::std::convert::From<&str> for LifecycleEventStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LifecycleEventStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LifecycleEventStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LifecycleEventStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LifecycleEventStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
