...
impl ::std::convert::From<&str> for InstanceAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceAction::from(s))
    }
}
impl InstanceAction {
...
impl ::std::convert::AsRef<str> for InstanceAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
