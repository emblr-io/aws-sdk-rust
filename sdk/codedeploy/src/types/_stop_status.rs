...
impl ::std::convert::From<&str> for StopStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StopStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StopStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StopStatus::from(s))
    }
}
impl StopStatus {
...
impl ::std::convert::AsRef<str> for StopStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
