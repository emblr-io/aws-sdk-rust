...
impl DeploymentConfigLimitExceededException {
    ...
    pub fn builder() -> crate::types::error::builders::DeploymentConfigLimitExceededExceptionBuilder {
        crate::types::error::builders::DeploymentConfigLimitExceededExceptionBuilder::default()
    }
}

/// A builder for [`DeploymentConfigLimitExceededException`](crate::types::error::DeploymentConfigLimitExceededException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeploymentConfigLimitExceededExceptionBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl DeploymentConfigLimitExceededExceptionBuilder {
    /// <p>The message that corresponds to the exception thrown by CodeDeploy.</p>
