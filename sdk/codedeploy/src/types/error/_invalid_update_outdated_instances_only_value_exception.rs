...
impl ::std::fmt::Display for InvalidUpdateOutdatedInstancesOnlyValueException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidUpdateOutdatedInstancesOnlyValueException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidUpdateOutdatedInstancesOnlyValueException {
