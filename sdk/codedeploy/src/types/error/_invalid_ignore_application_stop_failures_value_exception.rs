...
impl ::std::fmt::Display for InvalidIgnoreApplicationStopFailuresValueException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidIgnoreApplicationStopFailuresValueException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidIgnoreApplicationStopFailuresValueException {
