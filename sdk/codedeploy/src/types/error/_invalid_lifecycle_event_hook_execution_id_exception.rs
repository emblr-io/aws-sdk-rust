...
impl ::std::fmt::Display for InvalidLifecycleEventHookExecutionIdException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidLifecycleEventHookExecutionIdException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidLifecycleEventHookExecutionIdException {
