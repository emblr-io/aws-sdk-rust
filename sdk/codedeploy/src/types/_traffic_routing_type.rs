...
impl ::std::convert::From<&str> for TrafficRoutingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficRoutingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficRoutingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficRoutingType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficRoutingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
