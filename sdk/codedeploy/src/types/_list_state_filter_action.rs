...
impl ::std::convert::From<&str> for ListStateFilterAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListStateFilterAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListStateFilterAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListStateFilterAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListStateFilterAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
