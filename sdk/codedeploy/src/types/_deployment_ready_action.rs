...
impl ::std::convert::From<&str> for DeploymentReadyAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeploymentReadyAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentReadyAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentReadyAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeploymentReadyAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
