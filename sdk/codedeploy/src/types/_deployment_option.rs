...
impl ::std::convert::From<&str> for DeploymentOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeploymentOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeploymentOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
