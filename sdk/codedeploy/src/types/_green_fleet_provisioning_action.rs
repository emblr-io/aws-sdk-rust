...
impl ::std::convert::From<&str> for GreenFleetProvisioningAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GreenFleetProvisioningAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GreenFleetProvisioningAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GreenFleetProvisioningAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GreenFleetProvisioningAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
