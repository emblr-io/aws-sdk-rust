...
impl ::std::convert::From<&str> for AutoRollbackEvent {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoRollbackEvent::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoRollbackEvent {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoRollbackEvent::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoRollbackEvent {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
