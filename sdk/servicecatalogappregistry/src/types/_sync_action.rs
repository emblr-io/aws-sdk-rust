...
impl ::std::convert::From<&str> for SyncAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncAction::from(s))
    }
}
impl SyncAction {
...
impl ::std::convert::AsRef<str> for SyncAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
