...
impl ::std::convert::From<&str> for ResourceGroupState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceGroupState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceGroupState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceGroupState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceGroupState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
