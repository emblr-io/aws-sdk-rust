...
//! offered by AWS Service Catalog App Registry. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Service Catalog App Registry.
...
/// let config = aws_sdk_servicecatalogappregistry::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`AssociateAttributeGroup`](crate::operation::associate_attribute_group) operation has
/// a [`Client::associate_attribute_group`], function which returns a builder for that operation.
...
/// Configuration for AWS Service Catalog App Registry.
pub mod config;
