...
impl ::std::convert::From<&str> for ApplicationLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationLifecycle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
