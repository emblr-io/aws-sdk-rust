...
impl ::std::convert::From<&str> for DataSetTaskLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataSetTaskLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataSetTaskLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataSetTaskLifecycle::from(s))
    }
}
