...
impl ::std::convert::From<&str> for BatchJobType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchJobType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchJobType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchJobType::from(s))
    }
}
impl BatchJobType {
...
impl ::std::convert::AsRef<str> for BatchJobType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
