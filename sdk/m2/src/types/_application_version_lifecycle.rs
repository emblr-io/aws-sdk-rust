...
impl ::std::convert::From<&str> for ApplicationVersionLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationVersionLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationVersionLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationVersionLifecycle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationVersionLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
