...
impl ::std::convert::From<&str> for ApplicationDeploymentLifecycle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationDeploymentLifecycle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationDeploymentLifecycle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationDeploymentLifecycle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationDeploymentLifecycle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ApplicationDeploymentLifecycle {
