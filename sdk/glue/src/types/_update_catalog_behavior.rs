...
impl ::std::convert::From<&str> for UpdateCatalogBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateCatalogBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpdateCatalogBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpdateCatalogBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UpdateCatalogBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
