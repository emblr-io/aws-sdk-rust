...
impl ::std::convert::From<&str> for UnnestSpec {
    fn from(s: &str) -> Self {
        match s {
            "FULL" => UnnestSpec::Full,
            "NOUNNEST" => UnnestSpec::Nounnest,
            "TOPLEVEL" => UnnestSpec::Toplevel,
            other => UnnestSpec::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnnestSpec {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnnestSpec::from(s))
    }
}
impl UnnestSpec {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            UnnestSpec::Full => "FULL",
            UnnestSpec::Nounnest => "NOUNNEST",
            UnnestSpec::Toplevel => "TOPLEVEL",
            UnnestSpec::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["FULL", "NOUNNEST", "TOPLEVEL"]
    }
}
impl ::std::convert::AsRef<str> for UnnestSpec {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for UnnestSpec {
