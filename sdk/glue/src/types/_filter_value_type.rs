...
impl ::std::convert::From<&str> for FilterValueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterValueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterValueType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
