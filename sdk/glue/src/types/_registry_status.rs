...
impl ::std::convert::From<&str> for RegistryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RegistryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RegistryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RegistryStatus::from(s))
    }
}
impl RegistryStatus {
...
impl ::std::convert::AsRef<str> for RegistryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
