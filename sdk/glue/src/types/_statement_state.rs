...
impl ::std::convert::From<&str> for StatementState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatementState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatementState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatementState::from(s))
    }
}
impl StatementState {
...
impl ::std::convert::AsRef<str> for StatementState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
