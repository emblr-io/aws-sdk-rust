...
impl ::std::convert::From<&str> for BackfillErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BackfillErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BackfillErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BackfillErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BackfillErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
