...
impl ::std::convert::From<&str> for JdbcDataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JdbcDataType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JdbcDataType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JdbcDataType::from(s))
    }
}
impl JdbcDataType {
...
impl ::std::convert::AsRef<str> for JdbcDataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
