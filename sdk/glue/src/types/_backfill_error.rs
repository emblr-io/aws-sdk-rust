...
/// <ul>
/// <li>
/// <p>EncryptedPartitionError: The partitions are encrypted.</p></li>
/// <li>
/// <p>InvalidPartitionTypeDataError: The partition value doesn't match the data type for that partition column.</p></li>
/// <li>
/// <p>MissingPartitionValueError: The partitions are encrypted.</p></li>
/// <li>
/// <p>UnsupportedPartitionCharacterError: Characters inside the partition value are not supported. For example: U+0000 , U+0001, U+0002.</p></li>
/// <li>
