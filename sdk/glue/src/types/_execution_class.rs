...
impl ::std::convert::From<&str> for ExecutionClass {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExecutionClass::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExecutionClass {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExecutionClass::from(s))
    }
}
impl ExecutionClass {
...
impl ::std::convert::AsRef<str> for ExecutionClass {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
