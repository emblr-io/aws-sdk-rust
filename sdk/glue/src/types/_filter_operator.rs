...
impl ::std::convert::From<&str> for FilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterOperator::from(s))
    }
}
impl FilterOperator {
...
impl ::std::convert::AsRef<str> for FilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
