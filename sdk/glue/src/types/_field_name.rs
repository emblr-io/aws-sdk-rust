...
impl ::std::convert::From<&str> for FieldName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FieldName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FieldName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FieldName::from(s))
    }
}
impl FieldName {
...
impl ::std::convert::AsRef<str> for FieldName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
