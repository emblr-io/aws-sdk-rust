...
impl ::std::convert::From<&str> for SortDirectionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortDirectionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortDirectionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortDirectionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortDirectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SortDirectionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SortDirectionType::Ascending => write!(f, "ASCENDING"),
            SortDirectionType::Descending => write!(f, "DESCENDING"),
            SortDirectionType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
