...
impl ::std::convert::From<&str> for UnionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnionType::from(s))
    }
}
impl UnionType {
...
impl ::std::convert::AsRef<str> for UnionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
