...
impl ::std::convert::From<&str> for TriggerState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TriggerState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TriggerState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TriggerState::from(s))
    }
}
impl TriggerState {
...
impl ::std::convert::AsRef<str> for TriggerState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
