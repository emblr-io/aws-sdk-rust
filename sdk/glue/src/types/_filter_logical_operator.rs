...
impl ::std::convert::From<&str> for FilterLogicalOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterLogicalOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterLogicalOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterLogicalOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterLogicalOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
