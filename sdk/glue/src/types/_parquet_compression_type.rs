...
impl ::std::convert::From<&str> for ParquetCompressionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParquetCompressionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParquetCompressionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParquetCompressionType::from(s))
    }
}
