...
impl ::std::convert::From<&str> for LastCrawlStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LastCrawlStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LastCrawlStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LastCrawlStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LastCrawlStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
