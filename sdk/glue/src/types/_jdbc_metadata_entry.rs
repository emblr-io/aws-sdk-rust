...
impl ::std::convert::From<&str> for JdbcMetadataEntry {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JdbcMetadataEntry::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JdbcMetadataEntry {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JdbcMetadataEntry::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JdbcMetadataEntry {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
