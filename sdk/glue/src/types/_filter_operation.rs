...
impl ::std::convert::From<&str> for FilterOperation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterOperation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterOperation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterOperation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterOperation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FilterOperation {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FilterOperation::Eq => write!(f, "EQ"),
            FilterOperation::Gt => write!(f, "GT"),
            FilterOperation::Gte => write!(f, "GTE"),
            FilterOperation::Isnull => write!(f, "ISNULL"),
