...
impl ::std::convert::From<&str> for SourceControlProvider {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SourceControlProvider::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SourceControlProvider {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SourceControlProvider::from(s))
    }
}
