...
impl SelectFields {
    /// Creates a new builder-style object to manufacture [`SelectFields`](crate::types::SelectFields).
    pub fn builder() -> crate::types::builders::SelectFieldsBuilder {
        crate::types::builders::SelectFieldsBuilder::default()
    }
}
