...
impl ::std::convert::From<&str> for TransformType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransformType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransformType::from(s))
    }
}
impl TransformType {
...
impl ::std::convert::AsRef<str> for TransformType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
