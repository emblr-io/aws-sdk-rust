...
impl ::std::convert::From<&str> for TransformSortColumnType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformSortColumnType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransformSortColumnType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransformSortColumnType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransformSortColumnType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
