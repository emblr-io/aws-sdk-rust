...
impl ::std::convert::From<&str> for UpdateBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpdateBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpdateBehavior::from(s))
    }
}
impl UpdateBehavior {
...
impl ::std::convert::AsRef<str> for UpdateBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
