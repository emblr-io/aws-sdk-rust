...
impl ::std::convert::From<&str> for CrawlerHistoryState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CrawlerHistoryState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CrawlerHistoryState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CrawlerHistoryState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CrawlerHistoryState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
