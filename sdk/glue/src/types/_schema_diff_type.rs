...
impl ::std::convert::From<&str> for SchemaDiffType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SchemaDiffType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SchemaDiffType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SchemaDiffType::from(s))
    }
}
impl SchemaDiffType {
...
impl ::std::convert::AsRef<str> for SchemaDiffType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
