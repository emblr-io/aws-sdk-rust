...
impl MySqlCatalogTarget {
    /// Creates a new builder-style object to manufacture [`MySqlCatalogTarget`](crate::types::MySqlCatalogTarget).
    pub fn builder() -> crate::types::builders::MySqlCatalogTargetBuilder {
        crate::types::builders::MySqlCatalogTargetBuilder::default()
    }
}

/// A builder for [`MySqlCatalogTarget`](crate::types::MySqlCatalogTarget).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct MySqlCatalogTargetBuilder {
