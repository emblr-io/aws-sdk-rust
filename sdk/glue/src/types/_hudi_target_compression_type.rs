...
impl ::std::convert::From<&str> for HudiTargetCompressionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HudiTargetCompressionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HudiTargetCompressionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HudiTargetCompressionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HudiTargetCompressionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
