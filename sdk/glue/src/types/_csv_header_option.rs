...
impl ::std::convert::From<&str> for CsvHeaderOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CsvHeaderOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CsvHeaderOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CsvHeaderOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CsvHeaderOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
