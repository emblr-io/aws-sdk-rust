...
impl ::std::convert::From<&str> for Sort {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Sort::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Sort {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Sort::from(s))
    }
}
impl Sort {
...
impl ::std::convert::AsRef<str> for Sort {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
