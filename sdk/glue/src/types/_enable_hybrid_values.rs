...
impl ::std::convert::From<&str> for EnableHybridValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnableHybridValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnableHybridValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnableHybridValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EnableHybridValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EnableHybridValues {
