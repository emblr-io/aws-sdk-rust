...
impl S3DeltaCatalogTarget {
    /// Creates a new builder-style object to manufacture [`S3DeltaCatalogTarget`](crate::types::S3DeltaCatalogTarget).
    pub fn builder() -> crate::types::builders::S3DeltaCatalogTargetBuilder {
        crate::types::builders::S3DeltaCatalogTargetBuilder::default()
    }
}
...
impl S3DeltaCatalogTargetBuilder {
    ...
    /// - [`name`](crate::types::builders::S3DeltaCatalogTargetBuilder::name)
