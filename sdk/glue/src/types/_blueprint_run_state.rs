...
impl ::std::convert::From<&str> for BlueprintRunState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BlueprintRunState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BlueprintRunState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BlueprintRunState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BlueprintRunState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
