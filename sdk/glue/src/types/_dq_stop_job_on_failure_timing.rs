...
impl ::std::convert::From<&str> for DqStopJobOnFailureTiming {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DqStopJobOnFailureTiming::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DqStopJobOnFailureTiming {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DqStopJobOnFailureTiming::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DqStopJobOnFailureTiming {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
