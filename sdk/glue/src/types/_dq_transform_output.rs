...
impl ::std::convert::From<&str> for DqTransformOutput {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DqTransformOutput::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DqTransformOutput {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DqTransformOutput::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DqTransformOutput {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
