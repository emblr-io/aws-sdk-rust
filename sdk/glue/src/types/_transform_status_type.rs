...
impl ::std::convert::From<&str> for TransformStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransformStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransformStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransformStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
