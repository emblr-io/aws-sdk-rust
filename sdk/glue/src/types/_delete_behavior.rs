...
impl ::std::convert::From<&str> for DeleteBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeleteBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeleteBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeleteBehavior::from(s))
    }
}
impl DeleteBehavior {
...
impl ::std::convert::AsRef<str> for DeleteBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
