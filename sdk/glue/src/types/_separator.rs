...
impl ::std::convert::From<&str> for Separator {
    fn from(s: &str) -> Self {
        match s {
            ...
            "tab" => Separator::Tab,
            other => Separator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Separator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Separator::from(s))
    }
}
impl Separator {
...
impl ::std::convert::AsRef<str> for Separator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
