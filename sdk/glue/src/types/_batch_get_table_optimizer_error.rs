...
impl BatchGetTableOptimizerError {
    /// Creates a new builder-style object to manufacture [`BatchGetTableOptimizerError`](crate::types::BatchGetTableOptimizerError).
    pub fn builder() -> crate::types::builders::BatchGetTableOptimizerErrorBuilder {
        crate::types::builders::BatchGetTableOptimizerErrorBuilder::default()
    }
}
...
impl BatchGetTableOptimizerErrorBuilder {
    /// <p>An <code>ErrorDetail</code> object containing code and message details about the error.</p>
