...
impl ::std::convert::From<&str> for SourceControlAuthStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SourceControlAuthStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SourceControlAuthStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SourceControlAuthStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SourceControlAuthStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
