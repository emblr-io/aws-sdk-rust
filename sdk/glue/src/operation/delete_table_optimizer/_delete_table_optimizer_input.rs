...
impl DeleteTableOptimizerInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::delete_table_optimizer::DeleteTableOptimizerInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::delete_table_optimizer::DeleteTableOptimizerInput {
