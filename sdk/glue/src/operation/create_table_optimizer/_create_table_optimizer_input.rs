...
impl CreateTableOptimizerInput {
    /// Creates a new builder-style object to manufacture [`CreateTableOptimizerInput`](crate::operation::create_table_optimizer::CreateTableOptimizerInput).
    pub fn builder() -> crate::operation::create_table_optimizer::builders::CreateTableOptimizerInputBuilder {
        crate::operation::create_table_optimizer::builders::CreateTableOptimizerInputBuilder::default()
    }
}
