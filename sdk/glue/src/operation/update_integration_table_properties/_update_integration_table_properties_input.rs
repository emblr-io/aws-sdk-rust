...
pub struct UpdateIntegrationTablePropertiesInput {
...
impl UpdateIntegrationTablePropertiesInput {
    /// <p>The connection ARN of the source, or the database ARN of the target.</p>
...
impl UpdateIntegrationTablePropertiesInput {
    /// Creates a new builder-style object to manufacture [`UpdateIntegrationTablePropertiesInput`](crate::operation::update_integration_table_properties::UpdateIntegrationTablePropertiesInput).
    pub fn builder() -> crate::operation::update_integration_table_properties::builders::UpdateIntegrationTablePropertiesInputBuilder {
        crate::operation::update_integration_table_properties::builders::UpdateIntegrationTablePropertiesInputBuilder::default()
    }
}

/// A builder for [`UpdateIntegrationTablePropertiesInput`](crate::operation::update_integration_table_properties::UpdateIntegrationTablePropertiesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateIntegrationTablePropertiesInputBuilder {
...
impl UpdateIntegrationTablePropertiesInputBuilder {
    /// <p>The connection ARN of the source, or the database ARN of the target.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateIntegrationTablePropertiesInput`](crate::operation::update_integration_table_properties::UpdateIntegrationTablePropertiesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::update_integration_table_properties::UpdateIntegrationTablePropertiesInput,
