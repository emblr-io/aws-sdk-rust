...
impl ::aws_types::request_id::RequestId for DeletePartitionIndexOutput {
...
impl DeletePartitionIndexOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeletePartitionIndexOutput`](crate::operation::delete_partition_index::DeletePartitionIndexOutput).
    pub fn build(self) -> crate::operation::delete_partition_index::DeletePartitionIndexOutput {
