...
impl ::aws_types::request_id::RequestId for GetCrawlerOutput {
...
impl GetCrawlerOutputBuilder {
    ...
    pub fn crawler(mut self, input: crate::types::Crawler) -> Self {
        self.crawler = ::std::option::Option::Some(input);
        self
    }
    /// <p>The metadata for the specified crawler.</p>
    ...
    /// <p>The metadata for the specified crawler.</p>
    pub fn get_crawler(&self) -> &::std::option::Option<crate::types::Crawler> {
        &self.crawler
    }
