...
impl GetJobBookmarkOutput {
    ...
    pub fn builder() -> crate::operation::get_job_bookmark::builders::GetJobBookmarkOutputBuilder {
        crate::operation::get_job_bookmark::builders::GetJobBookmarkOutputBuilder::default()
    }
}
...
impl GetJobBookmarkOutputBuilder {
    /// <p>A structure that defines a point that a job can resume processing.</p>
    pub fn job_bookmark_entry(mut self, input: crate::types::JobBookmarkEntry) -> Self {
        self.job_bookmark_entry = ::std::option::Option::Some(input);
        self
    }
    /// <p>A structure that defines a point that a job can resume processing.</p>
