...
pub struct UpdateIntegrationResourcePropertyOutput {
...
impl UpdateIntegrationResourcePropertyOutput {
    /// <p>The connection ARN of the source, or the database ARN of the target.</p>
...
impl ::aws_types::request_id::RequestId for UpdateIntegrationResourcePropertyOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateIntegrationResourcePropertyOutput {
    /// Creates a new builder-style object to manufacture [`UpdateIntegrationResourcePropertyOutput`](crate::operation::update_integration_resource_property::UpdateIntegrationResourcePropertyOutput).
    pub fn builder() -> crate::operation::update_integration_resource_property::builders::UpdateIntegrationResourcePropertyOutputBuilder {
        crate::operation::update_integration_resource_property::builders::UpdateIntegrationResourcePropertyOutputBuilder::default()
    }
}

/// A builder for [`UpdateIntegrationResourcePropertyOutput`](crate::operation::update_integration_resource_property::UpdateIntegrationResourcePropertyOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateIntegrationResourcePropertyOutputBuilder {
...
impl UpdateIntegrationResourcePropertyOutputBuilder {
    /// <p>The connection ARN of the source, or the database ARN of the target.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateIntegrationResourcePropertyOutput`](crate::operation::update_integration_resource_property::UpdateIntegrationResourcePropertyOutput).
    pub fn build(self) -> crate::operation::update_integration_resource_property::UpdateIntegrationResourcePropertyOutput {
