...
impl GetTableOptimizerInput {
    /// Creates a new builder-style object to manufacture [`GetTableOptimizerInput`](crate::operation::get_table_optimizer::GetTableOptimizerInput).
    pub fn builder() -> crate::operation::get_table_optimizer::builders::GetTableOptimizerInputBuilder {
        crate::operation::get_table_optimizer::builders::GetTableOptimizerInputBuilder::default()
    }
}
...
impl GetTableOptimizerInputBuilder {
    /// <p>The Catalog ID of the table.</p>
