...
impl ::aws_types::request_id::RequestId for CreatePartitionIndexOutput {
...
impl CreatePartitionIndexOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePartitionIndexOutput`](crate::operation::create_partition_index::CreatePartitionIndexOutput).
    pub fn build(self) -> crate::operation::create_partition_index::CreatePartitionIndexOutput {
