...
pub struct UpdateColumnStatisticsTaskSettingsInput {
...
impl UpdateColumnStatisticsTaskSettingsInput {
    /// Creates a new builder-style object to manufacture [`UpdateColumnStatisticsTaskSettingsInput`](crate::operation::update_column_statistics_task_settings::UpdateColumnStatisticsTaskSettingsInput).
    pub fn builder() -> crate::operation::update_column_statistics_task_settings::builders::UpdateColumnStatisticsTaskSettingsInputBuilder {
        crate::operation::update_column_statistics_task_settings::builders::UpdateColumnStatisticsTaskSettingsInputBuilder::default()
    }
}

/// A builder for [`UpdateColumnStatisticsTaskSettingsInput`](crate::operation::update_column_statistics_task_settings::UpdateColumnStatisticsTaskSettingsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateColumnStatisticsTaskSettingsInputBuilder {
...
impl UpdateColumnStatisticsTaskSettingsInputBuilder {
    /// <p>The name of the database where the table resides.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateColumnStatisticsTaskSettingsInput`](crate::operation::update_column_statistics_task_settings::UpdateColumnStatisticsTaskSettingsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::update_column_statistics_task_settings::UpdateColumnStatisticsTaskSettingsInput,
