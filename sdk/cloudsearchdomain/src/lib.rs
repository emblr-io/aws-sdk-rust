...
//! offered by Amazon CloudSearch Domain. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudSearch Domain.
...
/// For example, the [`Search`](crate::operation::search) operation has
/// a [`Client::search`], function which returns a builder for that operation.
...
/// Configuration for Amazon CloudSearch Domain.
pub mod config;
