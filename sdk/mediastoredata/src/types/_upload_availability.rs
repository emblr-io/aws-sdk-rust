...
impl ::std::convert::From<&str> for UploadAvailability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UploadAvailability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UploadAvailability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UploadAvailability::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UploadAvailability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
