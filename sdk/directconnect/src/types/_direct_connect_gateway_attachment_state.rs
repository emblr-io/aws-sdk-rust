...
impl ::std::convert::From<&str> for DirectConnectGatewayAttachmentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectConnectGatewayAttachmentState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectConnectGatewayAttachmentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectConnectGatewayAttachmentState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DirectConnectGatewayAttachmentState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
