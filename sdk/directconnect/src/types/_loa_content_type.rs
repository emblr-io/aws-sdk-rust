...
impl ::std::convert::From<&str> for LoaContentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoaContentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoaContentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoaContentType::from(s))
    }
}
impl LoaContentType {
...
impl ::std::convert::AsRef<str> for LoaContentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
