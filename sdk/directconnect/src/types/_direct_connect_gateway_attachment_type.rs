...
impl ::std::convert::From<&str> for DirectConnectGatewayAttachmentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectConnectGatewayAttachmentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectConnectGatewayAttachmentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectConnectGatewayAttachmentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DirectConnectGatewayAttachmentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DirectConnectGatewayAttachmentType {
