...
impl ::std::convert::From<&str> for DirectConnectGatewayAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectConnectGatewayAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectConnectGatewayAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectConnectGatewayAssociationState::from(s))
    }
}
