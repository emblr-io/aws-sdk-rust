...
impl ::std::convert::From<&str> for DirectConnectGatewayState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectConnectGatewayState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectConnectGatewayState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectConnectGatewayState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DirectConnectGatewayState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
