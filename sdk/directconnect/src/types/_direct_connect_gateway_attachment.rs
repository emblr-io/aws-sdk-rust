...
pub struct DirectConnectGatewayAttachment {
    ...
    /// <ul>
    /// <li>
    /// <p><code>attaching</code>: The initial state after a virtual interface is created using the Direct Connect gateway.</p></li>
    /// <li>
    /// <p><code>attached</code>: The Direct Connect gateway and virtual interface are attached and ready to pass traffic.</p></li>
    /// <li>
    /// <p><code>detaching</code>: The initial state after calling <code>DeleteVirtualInterface</code>.</p></li>
    /// <li>
    /// <p><code>detached</code>: The virtual interface is detached from the Direct Connect gateway. Traffic flow between the Direct Connect gateway and virtual interface is stopped.</p></li>
    /// </ul>
...
impl DirectConnectGatewayAttachmentBuilder {
    ...
    /// <p>The Amazon Web Services Region where the virtual interface is located.</p>
    pub fn virtual_interface_region(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    pub fn get_virtual_interface_region(&self) -> &::std::option::Option<::std::string::String> {
        &self.virtual_interface_region
    }
    /// <p>The ID of the Amazon Web Services account that owns the virtual interface.</p>
    pub fn virtual_interface_owner_account(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
