...
impl ::std::convert::From<&str> for HasLogicalRedundancy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HasLogicalRedundancy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HasLogicalRedundancy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HasLogicalRedundancy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HasLogicalRedundancy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
