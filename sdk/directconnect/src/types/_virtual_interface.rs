...
impl VirtualInterface {
    /// Creates a new builder-style object to manufacture [`VirtualInterface`](crate::types::VirtualInterface).
    pub fn builder() -> crate::types::builders::VirtualInterfaceBuilder {
        crate::types::builders::VirtualInterfaceBuilder::default()
    }
}
...
impl VirtualInterfaceBuilder {
    ...
    /// Consumes the builder and constructs a [`VirtualInterface`](crate::types::VirtualInterface).
    pub fn build(self) -> crate::types::VirtualInterface {
        crate::types::VirtualInterface {
