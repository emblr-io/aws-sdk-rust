...
impl NewPublicVirtualInterfaceAllocation {
    /// Creates a new builder-style object to manufacture [`NewPublicVirtualInterfaceAllocation`](crate::types::NewPublicVirtualInterfaceAllocation).
    pub fn builder() -> crate::types::builders::NewPublicVirtualInterfaceAllocationBuilder {
        crate::types::builders::NewPublicVirtualInterfaceAllocationBuilder::default()
    }
}

/// A builder for [`NewPublicVirtualInterfaceAllocation`](crate::types::NewPublicVirtualInterfaceAllocation).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct NewPublicVirtualInterfaceAllocationBuilder {
...
impl NewPublicVirtualInterfaceAllocationBuilder {
    ...
    /// - [`virtual_interface_name`](crate::types::builders::NewPublicVirtualInterfaceAllocationBuilder::virtual_interface_name)
    pub fn build(self) -> ::std::result::Result<crate::types::NewPublicVirtualInterfaceAllocation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::NewPublicVirtualInterfaceAllocation {
            virtual_interface_name: self.virtual_interface_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "virtual_interface_name",
                    "virtual_interface_name was not specified but it is required when building NewPublicVirtualInterfaceAllocation",
                )
            })?,
