...
impl ::std::convert::From<&str> for InterconnectState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InterconnectState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InterconnectState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InterconnectState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InterconnectState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
