...
impl NewTransitVirtualInterface {
    /// Creates a new builder-style object to manufacture [`NewTransitVirtualInterface`](crate::types::NewTransitVirtualInterface).
    pub fn builder() -> crate::types::builders::NewTransitVirtualInterfaceBuilder {
        crate::types::builders::NewTransitVirtualInterfaceBuilder::default()
    }
}

/// A builder for [`NewTransitVirtualInterface`](crate::types::NewTransitVirtualInterface).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct NewTransitVirtualInterfaceBuilder {
