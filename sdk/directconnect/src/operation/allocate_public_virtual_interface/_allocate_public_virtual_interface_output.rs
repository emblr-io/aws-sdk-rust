...
impl ::aws_types::request_id::RequestId for AllocatePublicVirtualInterfaceOutput {
...
/// A builder for [`AllocatePublicVirtualInterfaceOutput`](crate::operation::allocate_public_virtual_interface::AllocatePublicVirtualInterfaceOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AllocatePublicVirtualInterfaceOutputBuilder {
...
impl AllocatePublicVirtualInterfaceOutputBuilder {
    /// <p>The ID of the Amazon Web Services account that owns the virtual interface.</p>
