...
impl ::aws_types::request_id::RequestId for DisassociateConnectionFromLagOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DisassociateConnectionFromLagOutput {
    /// Creates a new builder-style object to manufacture [`DisassociateConnectionFromLagOutput`](crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagOutput).
    pub fn builder() -> crate::operation::disassociate_connection_from_lag::builders::DisassociateConnectionFromLagOutputBuilder {
        crate::operation::disassociate_connection_from_lag::builders::DisassociateConnectionFromLagOutputBuilder::default()
    }
}

/// A builder for [`DisassociateConnectionFromLagOutput`](crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DisassociateConnectionFromLagOutputBuilder {
...
impl DisassociateConnectionFromLagOutputBuilder {
    /// <p>The ID of the Amazon Web Services account that owns the connection.</p>
    ...
    /// Consumes the builder and constructs a [`DisassociateConnectionFromLagOutput`](crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagOutput).
    pub fn build(self) -> crate::operation::disassociate_connection_from_lag::DisassociateConnectionFromLagOutput {
