...
pub struct CreatePrivateVirtualInterfaceOutput {
    ...
    /// <li>
    /// <p><code>verifying</code>: This state only applies to public virtual interfaces. Each public virtual interface needs validation before the virtual interface can be created.</p></li>
    /// <li>
    /// <p><code>pending</code>: A virtual interface is in this state from the time that it is created until the virtual interface is ready to forward traffic.</p></li>
    /// <li>
    ...
    /// <li>
    /// <p><code>rejected</code>: The virtual interface owner has declined creation of the virtual interface. If a virtual interface in the <code>Confirming</code> state is deleted by the virtual interface owner, the virtual interface enters the <code>Rejected</code> state.</p></li>
    /// <li>
...
impl ::aws_types::request_id::RequestId for CreatePrivateVirtualInterfaceOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreatePrivateVirtualInterfaceOutput {
    /// Creates a new builder-style object to manufacture [`CreatePrivateVirtualInterfaceOutput`](crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceOutput).
    pub fn builder() -> crate::operation::create_private_virtual_interface::builders::CreatePrivateVirtualInterfaceOutputBuilder {
        crate::operation::create_private_virtual_interface::builders::CreatePrivateVirtualInterfaceOutputBuilder::default()
    }
}

/// A builder for [`CreatePrivateVirtualInterfaceOutput`](crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreatePrivateVirtualInterfaceOutputBuilder {
...
impl CreatePrivateVirtualInterfaceOutputBuilder {
    /// <p>The ID of the Amazon Web Services account that owns the virtual interface.</p>
    ...
    /// Consumes the builder and constructs a [`CreatePrivateVirtualInterfaceOutput`](crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceOutput).
    pub fn build(self) -> crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceOutput {
