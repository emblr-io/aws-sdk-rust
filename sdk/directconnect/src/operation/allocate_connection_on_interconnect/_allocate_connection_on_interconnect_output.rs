...
impl ::aws_types::request_id::RequestId for AllocateConnectionOnInterconnectOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl AllocateConnectionOnInterconnectOutput {
    /// Creates a new builder-style object to manufacture [`AllocateConnectionOnInterconnectOutput`](crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectOutput).
    pub fn builder() -> crate::operation::allocate_connection_on_interconnect::builders::AllocateConnectionOnInterconnectOutputBuilder {
        crate::operation::allocate_connection_on_interconnect::builders::AllocateConnectionOnInterconnectOutputBuilder::default()
    }
}
...
impl AllocateConnectionOnInterconnectOutputBuilder {
    /// <p>The ID of the Amazon Web Services account that owns the connection.</p>
    ...
    /// Consumes the builder and constructs a [`AllocateConnectionOnInterconnectOutput`](crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectOutput).
    pub fn build(self) -> crate::operation::allocate_connection_on_interconnect::AllocateConnectionOnInterconnectOutput {
