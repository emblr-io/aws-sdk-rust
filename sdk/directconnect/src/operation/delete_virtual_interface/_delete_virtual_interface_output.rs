...
impl ::aws_types::request_id::RequestId for DeleteVirtualInterfaceOutput {
...
impl DeleteVirtualInterfaceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteVirtualInterfaceOutput`](crate::operation::delete_virtual_interface::DeleteVirtualInterfaceOutput).
    pub fn build(self) -> crate::operation::delete_virtual_interface::DeleteVirtualInterfaceOutput {
