...
impl AllocatePrivateVirtualInterfaceOutput {
    /// Creates a new builder-style object to manufacture [`AllocatePrivateVirtualInterfaceOutput`](crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput).
    pub fn builder() -> crate::operation::allocate_private_virtual_interface::builders::AllocatePrivateVirtualInterfaceOutputBuilder {
        crate::operation::allocate_private_virtual_interface::builders::AllocatePrivateVirtualInterfaceOutputBuilder::default()
    }
}
...
impl AllocatePrivateVirtualInterfaceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`AllocatePrivateVirtualInterfaceOutput`](crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput).
    pub fn build(self) -> crate::operation::allocate_private_virtual_interface::AllocatePrivateVirtualInterfaceOutput {
