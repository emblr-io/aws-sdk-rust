...
impl ::std::convert::From<&str> for MessageContentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MessageContentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MessageContentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MessageContentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MessageContentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MessageContentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            MessageContentType::CustomPayload => write!(f, "CustomPayload"),
