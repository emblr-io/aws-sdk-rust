...
impl ::std::convert::From<&str> for Shape {
    fn from(s: &str) -> Self {
        match s {
            ...
            "List" => Shape::List,
            "Scalar" => Shape::Scalar,
            other => Shape::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Shape {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Shape::from(s))
    }
}
impl Shape {
...
impl ::std::convert::AsRef<str> for Shape {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
