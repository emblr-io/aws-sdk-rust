...
impl ::std::convert::From<&str> for IntentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IntentState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IntentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IntentState::from(s))
    }
}
impl IntentState {
...
impl ::std::convert::AsRef<str> for IntentState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
