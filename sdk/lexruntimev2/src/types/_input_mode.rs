...
impl ::std::convert::From<&str> for InputMode {
    fn from(s: &str) -> Self {
        match s {
            "DTMF" => InputMode::Dtmf,
            "Speech" => InputMode::Speech,
            "Text" => InputMode::Text,
            other => InputMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InputMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InputMode::from(s))
    }
}
impl InputMode {
...
impl ::std::convert::AsRef<str> for InputMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
