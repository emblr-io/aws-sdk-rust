...
impl ::std::convert::From<&str> for StyleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StyleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StyleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StyleType::from(s))
    }
}
impl StyleType {
...
impl ::std::convert::AsRef<str> for StyleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
