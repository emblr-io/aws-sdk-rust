...
impl ::std::convert::From<&str> for SentimentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SentimentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SentimentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SentimentType::from(s))
    }
}
impl SentimentType {
...
impl ::std::convert::AsRef<str> for SentimentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SentimentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SentimentType::Mixed => write!(f, "MIXED"),
            SentimentType::Negative => write!(f, "NEGATIVE"),
            SentimentType::Neutral => write!(f, "NEUTRAL"),
            SentimentType::Positive => write!(f, "POSITIVE"),
