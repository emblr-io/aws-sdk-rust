...
impl ::std::convert::From<&str> for SnsActionEncoding {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnsActionEncoding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnsActionEncoding {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnsActionEncoding::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SnsActionEncoding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
