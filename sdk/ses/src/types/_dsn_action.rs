...
impl ::std::convert::From<&str> for DsnAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DsnAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DsnAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DsnAction::from(s))
    }
}
impl DsnAction {
...
impl ::std::convert::AsRef<str> for DsnAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
