...
impl ::std::convert::From<&str> for ConfigurationSetAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigurationSetAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigurationSetAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigurationSetAttribute::from(s))
    }
}
