...
impl ::std::convert::From<&str> for ReceiptFilterPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReceiptFilterPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReceiptFilterPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReceiptFilterPolicy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReceiptFilterPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
