...
impl ::std::fmt::Display for InvalidSnsDestinationException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidSnsDestinationException [InvalidSNSDestinationException]")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidSnsDestinationException {
...
impl InvalidSnsDestinationException {
    /// Creates a new builder-style object to manufacture [`InvalidSnsDestinationException`](crate::types::error::InvalidSnsDestinationException).
    pub fn builder() -> crate::types::error::builders::InvalidSnsDestinationExceptionBuilder {
        crate::types::error::builders::InvalidSnsDestinationExceptionBuilder::default()
    }
}

/// A builder for [`InvalidSnsDestinationException`](crate::types::error::InvalidSnsDestinationException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InvalidSnsDestinationExceptionBuilder {
    pub(crate) configuration_set_name: ::std::option::Option<::std::string::String>,
    pub(crate) event_destination_name: ::std::option::Option<::std::string::String>,
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl InvalidSnsDestinationExceptionBuilder {
    /// <p>Indicates that the configuration set does not exist.</p>
    ...
    /// Consumes the builder and constructs a [`InvalidSnsDestinationException`](crate::types::error::InvalidSnsDestinationException).
    pub fn build(self) -> crate::types::error::InvalidSnsDestinationException {
        crate::types::error::InvalidSnsDestinationException {
