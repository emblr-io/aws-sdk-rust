...
impl ::std::fmt::Display for ConfigurationSetSendingPausedException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "ConfigurationSetSendingPausedException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::ConfigurationSetSendingPausedException {
...
impl ConfigurationSetSendingPausedExceptionBuilder {
    ...
    /// Consumes the builder and constructs a [`ConfigurationSetSendingPausedException`](crate::types::error::ConfigurationSetSendingPausedException).
    pub fn build(self) -> crate::types::error::ConfigurationSetSendingPausedException {
