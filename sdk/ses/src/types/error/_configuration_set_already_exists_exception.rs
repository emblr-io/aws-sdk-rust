...
impl ::std::fmt::Display for ConfigurationSetAlreadyExistsException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "ConfigurationSetAlreadyExistsException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::ConfigurationSetAlreadyExistsException {
...
impl ConfigurationSetAlreadyExistsExceptionBuilder {
    ...
    /// Consumes the builder and constructs a [`ConfigurationSetAlreadyExistsException`](crate::types::error::ConfigurationSetAlreadyExistsException).
    pub fn build(self) -> crate::types::error::ConfigurationSetAlreadyExistsException {
