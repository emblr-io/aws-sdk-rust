...
impl ::std::convert::From<&str> for StopScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StopScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StopScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StopScope::from(s))
    }
}
impl StopScope {
...
impl ::std::convert::AsRef<str> for StopScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
