...
pub struct MlInputChannelSummary {
...
impl MlInputChannelSummary {
    ...
    pub fn builder() -> crate::types::builders::MlInputChannelSummaryBuilder {
        crate::types::builders::MlInputChannelSummaryBuilder::default()
    }
}

/// A builder for [`MlInputChannelSummary`](crate::types::MlInputChannelSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct MlInputChannelSummaryBuilder {
...
impl MlInputChannelSummaryBuilder {
    ...
    /// - [`update_time`](crate::types::builders::MlInputChannelSummaryBuilder::update_time)
    /// - [`membership_identifier`](crate::types::builders::MlInputChannelSummaryBuilder::membership_identifier)
    /// - [`collaboration_identifier`](crate::types::builders::MlInputChannelSummaryBuilder::collaboration_identifier)
    /// - [`name`](crate::types::builders::MlInputChannelSummaryBuilder::name)
    /// - [`configured_model_algorithm_associations`](crate::types::builders::MlInputChannelSummaryBuilder::configured_model_algorithm_associations)
    /// - [`ml_input_channel_arn`](crate::types::builders::MlInputChannelSummaryBuilder::ml_input_channel_arn)
    /// - [`status`](crate::types::builders::MlInputChannelSummaryBuilder::status)
    pub fn build(self) -> ::std::result::Result<crate::types::MlInputChannelSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::MlInputChannelSummary {
            create_time: self.create_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "create_time",
                    "create_time was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            update_time: self.update_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "update_time",
                    "update_time was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            membership_identifier: self.membership_identifier.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "membership_identifier",
                    "membership_identifier was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            collaboration_identifier: self.collaboration_identifier.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "collaboration_identifier",
                    "collaboration_identifier was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            configured_model_algorithm_associations: self.configured_model_algorithm_associations.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    ...
                    "configured_model_algorithm_associations was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            ...
            ml_input_channel_arn: self.ml_input_channel_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    ...
                    "ml_input_channel_arn was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building MlInputChannelSummary",
                )
            })?,
