...
pub struct DeleteTrainingDatasetInput {
...
impl DeleteTrainingDatasetInput {
    /// <p>The Amazon Resource Name (ARN) of the training dataset that you want to delete.</p>
...
impl DeleteTrainingDatasetInput {
    /// Creates a new builder-style object to manufacture [`DeleteTrainingDatasetInput`](crate::operation::delete_training_dataset::DeleteTrainingDatasetInput).
    pub fn builder() -> crate::operation::delete_training_dataset::builders::DeleteTrainingDatasetInputBuilder {
        crate::operation::delete_training_dataset::builders::DeleteTrainingDatasetInputBuilder::default()
    }
}
...
impl DeleteTrainingDatasetInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteTrainingDatasetInput`](crate::operation::delete_training_dataset::DeleteTrainingDatasetInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::delete_training_dataset::DeleteTrainingDatasetInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::delete_training_dataset::DeleteTrainingDatasetInput {
