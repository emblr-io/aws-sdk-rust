...
pub struct ListCollaborationTrainedModelInferenceJobsInput {
...
impl ListCollaborationTrainedModelInferenceJobsInput {
    ...
    pub fn builder(
    ) -> crate::operation::list_collaboration_trained_model_inference_jobs::builders::ListCollaborationTrainedModelInferenceJobsInputBuilder {
        crate::operation::list_collaboration_trained_model_inference_jobs::builders::ListCollaborationTrainedModelInferenceJobsInputBuilder::default()
    }
}

/// A builder for [`ListCollaborationTrainedModelInferenceJobsInput`](crate::operation::list_collaboration_trained_model_inference_jobs::ListCollaborationTrainedModelInferenceJobsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListCollaborationTrainedModelInferenceJobsInputBuilder {
...
impl ListCollaborationTrainedModelInferenceJobsInputBuilder {
    ...
    pub fn build(
        ...
        crate::operation::list_collaboration_trained_model_inference_jobs::ListCollaborationTrainedModelInferenceJobsInput,
