...
impl GetConfiguredAudienceModelPolicyOutput {
    ...
    pub fn builder() -> crate::operation::get_configured_audience_model_policy::builders::GetConfiguredAudienceModelPolicyOutputBuilder {
        crate::operation::get_configured_audience_model_policy::builders::GetConfiguredAudienceModelPolicyOutputBuilder::default()
    }
}

/// A builder for [`GetConfiguredAudienceModelPolicyOutput`](crate::operation::get_configured_audience_model_policy::GetConfiguredAudienceModelPolicyOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetConfiguredAudienceModelPolicyOutputBuilder {
...
impl GetConfiguredAudienceModelPolicyOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the configured audience model.</p>
