...
impl ListSessionsOutputBuilder {
    ...
    pub fn session_summaries(mut self, input: crate::types::SessionSummary) -> Self {
        ...
        v.push(input);
        self.session_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of summaries for each session in your Amazon Web Services account.</p>
    ...
    /// - [`session_summaries`](crate::operation::list_sessions::builders::ListSessionsOutputBuilder::session_summaries)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_sessions::ListSessionsOutput {
            session_summaries: self.session_summaries.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "session_summaries",
                    "session_summaries was not specified but it is required when building ListSessionsOutput",
                )
            })?,
