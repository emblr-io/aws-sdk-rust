...
impl ::std::convert::From<&str> for ConfirmationState {
    fn from(s: &str) -> Self {
        match s {
            "CONFIRM" => ConfirmationState::Confirm,
            "DENY" => ConfirmationState::Deny,
            other => ConfirmationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfirmationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfirmationState::from(s))
    }
}
impl ConfirmationState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConfirmationState::Confirm => "CONFIRM",
            ConfirmationState::Deny => "DENY",
...
impl ::std::convert::AsRef<str> for ConfirmationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ConfirmationState {
