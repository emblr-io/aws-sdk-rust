...
///     NodeType::FlowInputNode => { /* ... */ },
///     NodeType::FlowOutputNode => { /* ... */ },
///     NodeType::KnowledgeBaseNode => { /* ... */ },
///     NodeType::LambdaFunctionNode => { /* ... */ },
///     NodeType::LexNode => { /* ... */ },
///     NodeType::PromptNode => { /* ... */ },
...
impl ::std::convert::From<&str> for NodeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "FlowInputNode" => NodeType::FlowInputNode,
            "FlowOutputNode" => NodeType::FlowOutputNode,
            "KnowledgeBaseNode" => NodeType::KnowledgeBaseNode,
            "LambdaFunctionNode" => NodeType::LambdaFunctionNode,
            "LexNode" => NodeType::LexNode,
            "PromptNode" => NodeType::PromptNode,
...
impl ::std::str::FromStr for NodeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeType::from(s))
    }
}
impl NodeType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NodeType::FlowInputNode => "FlowInputNode",
            NodeType::FlowOutputNode => "FlowOutputNode",
            NodeType::KnowledgeBaseNode => "KnowledgeBaseNode",
            NodeType::LambdaFunctionNode => "LambdaFunctionNode",
            NodeType::LexNode => "LexNode",
            NodeType::PromptNode => "PromptNode",
...
impl ::std::fmt::Display for NodeType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            NodeType::ConditionNode => write!(f, "ConditionNode"),
            NodeType::FlowInputNode => write!(f, "FlowInputNode"),
            NodeType::FlowOutputNode => write!(f, "FlowOutputNode"),
            NodeType::KnowledgeBaseNode => write!(f, "KnowledgeBaseNode"),
