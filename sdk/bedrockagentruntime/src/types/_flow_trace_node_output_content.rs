...
pub enum FlowTraceNodeOutputContent {
...
impl FlowTraceNodeOutputContent {
    #[allow(irrefutable_let_patterns)]
    /// Tries to convert the enum instance into [`Document`](crate::types::FlowTraceNodeOutputContent::Document), extracting the inner [`Document`](::aws_smithy_types::Document).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_document(&self) -> ::std::result::Result<&::aws_smithy_types::Document, &Self> {
        if let FlowTraceNodeOutputContent::Document(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`Document`](crate::types::FlowTraceNodeOutputContent::Document).
