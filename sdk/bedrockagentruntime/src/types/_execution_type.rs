...
impl ::std::convert::From<&str> for ExecutionType {
    fn from(s: &str) -> Self {
        match s {
            "LAMBDA" => ExecutionType::Lambda,
            "RETURN_CONTROL" => ExecutionType::ReturnControl,
...
impl ExecutionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ExecutionType::Lambda => "LAMBDA",
            ExecutionType::ReturnControl => "RETURN_CONTROL",
