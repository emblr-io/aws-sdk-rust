...
impl ::std::convert::From<&str> for FlowExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "TimedOut" => FlowExecutionStatus::TimedOut,
            other => FlowExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FlowExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FlowExecutionStatus::from(s))
    }
}
impl FlowExecutionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            FlowExecutionStatus::TimedOut => "TimedOut",
            FlowExecutionStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["Aborted", "Failed", "Running", "Succeeded", "TimedOut"]
    }
}
impl ::std::convert::AsRef<str> for FlowExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
