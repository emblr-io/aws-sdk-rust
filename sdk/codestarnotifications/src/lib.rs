...
//! offered by AWS CodeStar Notifications. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`CreateNotificationRule`](crate::operation::create_notification_rule) operation has
/// a [`Client::create_notification_rule`], function which returns a builder for that operation.
