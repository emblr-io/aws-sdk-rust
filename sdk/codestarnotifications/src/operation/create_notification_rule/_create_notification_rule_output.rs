...
impl ::aws_types::request_id::RequestId for CreateNotificationRuleOutput {
...
impl CreateNotificationRuleOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the notification rule.</p>
    ...
    /// Consumes the builder and constructs a [`CreateNotificationRuleOutput`](crate::operation::create_notification_rule::CreateNotificationRuleOutput).
    pub fn build(self) -> crate::operation::create_notification_rule::CreateNotificationRuleOutput {
