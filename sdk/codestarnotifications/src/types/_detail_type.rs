...
impl ::std::convert::From<&str> for DetailType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DetailType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DetailType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DetailType::from(s))
    }
}
impl DetailType {
...
impl ::std::convert::AsRef<str> for DetailType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
