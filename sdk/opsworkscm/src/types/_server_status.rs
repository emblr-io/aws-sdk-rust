...
impl ::std::convert::From<&str> for ServerStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServerStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServerStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServerStatus::from(s))
    }
}
impl ServerStatus {
...
impl ::std::convert::AsRef<str> for ServerStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
