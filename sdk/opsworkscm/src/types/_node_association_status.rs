...
impl ::std::convert::From<&str> for NodeAssociationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeAssociationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeAssociationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeAssociationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NodeAssociationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
