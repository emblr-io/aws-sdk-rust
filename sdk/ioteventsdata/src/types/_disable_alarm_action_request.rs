...
impl DisableAlarmActionRequest {
    /// Creates a new builder-style object to manufacture [`DisableAlarmActionRequest`](crate::types::DisableAlarmActionRequest).
    pub fn builder() -> crate::types::builders::DisableAlarmActionRequestBuilder {
        crate::types::builders::DisableAlarmActionRequestBuilder::default()
    }
}
...
impl DisableAlarmActionRequestBuilder {
    /// <p>The request ID. Each ID must be unique within each batch.</p>
