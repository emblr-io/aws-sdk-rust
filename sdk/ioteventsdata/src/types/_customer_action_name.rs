...
impl ::std::convert::From<&str> for CustomerActionName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomerActionName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomerActionName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomerActionName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomerActionName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
