...
impl ResetAlarmActionRequest {
    /// Creates a new builder-style object to manufacture [`ResetAlarmActionRequest`](crate::types::ResetAlarmActionRequest).
    pub fn builder() -> crate::types::builders::ResetAlarmActionRequestBuilder {
        crate::types::builders::ResetAlarmActionRequestBuilder::default()
    }
}
...
impl ResetAlarmActionRequestBuilder {
    /// <p>The request ID. Each ID must be unique within each batch.</p>
