...
impl ListAlarmsInput {
    /// Creates a new builder-style object to manufacture [`ListAlarmsInput`](crate::operation::list_alarms::ListAlarmsInput).
    pub fn builder() -> crate::operation::list_alarms::builders::ListAlarmsInputBuilder {
        crate::operation::list_alarms::builders::ListAlarmsInputBuilder::default()
    }
}
