...
//! offered by CloudWatch Observability Access Manager. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`CreateLink`](crate::operation::create_link) operation has
