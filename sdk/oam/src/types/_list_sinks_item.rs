...
impl ListSinksItem {
    /// Creates a new builder-style object to manufacture [`ListSinksItem`](crate::types::ListSinksItem).
    pub fn builder() -> crate::types::builders::ListSinksItemBuilder {
        crate::types::builders::ListSinksItemBuilder::default()
    }
}
