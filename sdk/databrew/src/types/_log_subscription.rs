...
impl ::std::convert::From<&str> for LogSubscription {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LogSubscription::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogSubscription {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogSubscription::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LogSubscription {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
