...
impl ::std::convert::From<&str> for SampleMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SampleMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SampleMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SampleMode::from(s))
    }
}
impl SampleMode {
...
impl ::std::convert::AsRef<str> for SampleMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
