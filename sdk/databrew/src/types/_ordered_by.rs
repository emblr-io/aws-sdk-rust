...
impl ::std::convert::From<&str> for OrderedBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderedBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderedBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderedBy::from(s))
    }
}
impl OrderedBy {
...
impl ::std::convert::AsRef<str> for OrderedBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OrderedBy {
