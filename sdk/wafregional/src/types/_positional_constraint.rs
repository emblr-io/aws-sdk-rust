...
impl ::std::convert::From<&str> for PositionalConstraint {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PositionalConstraint::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PositionalConstraint {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PositionalConstraint::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PositionalConstraint {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
