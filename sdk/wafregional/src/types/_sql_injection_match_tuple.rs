...
impl SqlInjectionMatchTuple {
    /// Creates a new builder-style object to manufacture [`SqlInjectionMatchTuple`](crate::types::SqlInjectionMatchTuple).
    pub fn builder() -> crate::types::builders::SqlInjectionMatchTupleBuilder {
        crate::types::builders::SqlInjectionMatchTupleBuilder::default()
    }
}
