...
pub struct GetByteMatchSetOutput {
    ...
    /// <ul>
    /// <li>
    /// <p><code>ByteMatchSet</code>: Contains <code>ByteMatchSetId</code>, <code>ByteMatchTuples</code>, and <code>Name</code></p></li>
    /// <li>
    /// <p><code>ByteMatchTuples</code>: Contains an array of <code>ByteMatchTuple</code> objects. Each <code>ByteMatchTuple</code> object contains <code>FieldToMatch</code>, <code>PositionalConstraint</code>, <code>TargetString</code>, and <code>TextTransformation</code></p></li>
    /// <li>
...
impl GetByteMatchSetOutputBuilder {
    ...
    pub fn byte_match_set(mut self, input: crate::types::ByteMatchSet) -> Self {
        self.byte_match_set = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the <code>ByteMatchSet</code> that you specified in the <code>GetByteMatchSet</code> request. For more information, see the following topics:</p>
    /// <ul>
