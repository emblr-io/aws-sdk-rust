...
//! aws-sdk-wafregional = "0.0.0-local"
...
//! offered by AWS WAF Regional. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS WAF Regional.
...
/// Configuration for AWS WAF Regional.
pub mod config;
