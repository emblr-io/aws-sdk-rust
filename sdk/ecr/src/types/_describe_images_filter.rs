...
impl DescribeImagesFilter {
    /// Creates a new builder-style object to manufacture [`DescribeImagesFilter`](crate::types::DescribeImagesFilter).
    pub fn builder() -> crate::types::builders::DescribeImagesFilterBuilder {
        crate::types::builders::DescribeImagesFilterBuilder::default()
    }
}
