...
pub struct GetStagesOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::Stage>>,
...
impl GetStagesOutput {
    ...
    pub fn items(&self) -> &[crate::types::Stage] {
...
impl GetStagesOutputBuilder {
    ...
    ///
    /// <p>The elements from this collection.</p>
    pub fn items(mut self, input: crate::types::Stage) -> Self {
    ...
    /// <p>The elements from this collection.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Stage>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The elements from this collection.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Stage>> {
        &self.items
    }
    /// <p>The next page of elements from this collection. Not valid for the last element of the collection.</p>
