...
impl GetDomainNamesOutput {
    ...
    pub fn items(&self) -> &[crate::types::DomainName] {
...
impl ::aws_types::request_id::RequestId for GetDomainNamesOutput {
...
impl GetDomainNamesOutputBuilder {
    ...
    /// <p>The elements from this collection.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::DomainName>> {
        &self.items
    }
    /// <p>The next page of elements from this collection. Not valid for the last element of the collection.</p>
