...
impl ::aws_types::request_id::RequestId for GetIntegrationsOutput {
...
impl GetIntegrationsOutput {
    ...
    pub fn builder() -> crate::operation::get_integrations::builders::GetIntegrationsOutputBuilder {
        crate::operation::get_integrations::builders::GetIntegrationsOutputBuilder::default()
    }
}

/// A builder for [`GetIntegrationsOutput`](crate::operation::get_integrations::GetIntegrationsOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetIntegrationsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::Integration>>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl GetIntegrationsOutputBuilder {
