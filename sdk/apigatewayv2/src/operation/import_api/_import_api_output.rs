...
impl ::aws_types::request_id::RequestId for ImportApiOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ImportApiOutput {
    /// Creates a new builder-style object to manufacture [`ImportApiOutput`](crate::operation::import_api::ImportApiOutput).
    pub fn builder() -> crate::operation::import_api::builders::ImportApiOutputBuilder {
        crate::operation::import_api::builders::ImportApiOutputBuilder::default()
    }
}
...
impl ImportApiOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ImportApiOutput`](crate::operation::import_api::ImportApiOutput).
    pub fn build(self) -> crate::operation::import_api::ImportApiOutput {
