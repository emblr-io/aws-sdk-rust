...
pub struct GetIntegrationResponsesOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::IntegrationResponse>>,
...
impl GetIntegrationResponsesOutput {
    ...
    pub fn items(&self) -> &[crate::types::IntegrationResponse] {
...
impl ::aws_types::request_id::RequestId for GetIntegrationResponsesOutput {
...
impl GetIntegrationResponsesOutputBuilder {
    /// Appends an item to `items`.
    ///
    /// To override the contents of this collection use [`set_items`](Self::set_items).
    ///
    /// <p>The elements from this collection.</p>
    pub fn items(mut self, input: crate::types::IntegrationResponse) -> Self {
