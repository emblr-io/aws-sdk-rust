...
impl CreateRouteResponseOutput {
    /// Creates a new builder-style object to manufacture [`CreateRouteResponseOutput`](crate::operation::create_route_response::CreateRouteResponseOutput).
    pub fn builder() -> crate::operation::create_route_response::builders::CreateRouteResponseOutputBuilder {
        crate::operation::create_route_response::builders::CreateRouteResponseOutputBuilder::default()
    }
}

/// A builder for [`CreateRouteResponseOutput`](crate::operation::create_route_response::CreateRouteResponseOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateRouteResponseOutputBuilder {
...
impl CreateRouteResponseOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateRouteResponseOutput`](crate::operation::create_route_response::CreateRouteResponseOutput).
    pub fn build(self) -> crate::operation::create_route_response::CreateRouteResponseOutput {
