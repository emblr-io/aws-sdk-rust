...
impl ::std::convert::From<&str> for VpcLinkStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcLinkStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpcLinkStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpcLinkStatus::from(s))
    }
}
impl VpcLinkStatus {
...
impl ::std::convert::AsRef<str> for VpcLinkStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
