...
impl ::std::fmt::Display for TipOfSourceReferenceIsDifferentException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "TipOfSourceReferenceIsDifferentException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::TipOfSourceReferenceIsDifferentException {
