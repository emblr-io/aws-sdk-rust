...
impl ::std::fmt::Display for InvalidApprovalRuleTemplateDescriptionException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidApprovalRuleTemplateDescriptionException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidApprovalRuleTemplateDescriptionException {
