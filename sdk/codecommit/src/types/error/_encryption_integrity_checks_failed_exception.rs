...
impl ::std::fmt::Display for EncryptionIntegrityChecksFailedException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "EncryptionIntegrityChecksFailedException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::EncryptionIntegrityChecksFailedException {
...
impl EncryptionIntegrityChecksFailedExceptionBuilder {
    /// <p>Any message associated with the exception.</p>
    ...
    /// Consumes the builder and constructs a [`EncryptionIntegrityChecksFailedException`](crate::types::error::EncryptionIntegrityChecksFailedException).
    pub fn build(self) -> crate::types::error::EncryptionIntegrityChecksFailedException {
