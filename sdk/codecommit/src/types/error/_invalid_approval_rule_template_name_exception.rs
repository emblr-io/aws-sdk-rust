...
impl ::std::fmt::Display for InvalidApprovalRuleTemplateNameException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidApprovalRuleTemplateNameException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidApprovalRuleTemplateNameException {
...
impl InvalidApprovalRuleTemplateNameExceptionBuilder {
    /// <p>Any message associated with the exception.</p>
    ...
    /// Consumes the builder and constructs a [`InvalidApprovalRuleTemplateNameException`](crate::types::error::InvalidApprovalRuleTemplateNameException).
    pub fn build(self) -> crate::types::error::InvalidApprovalRuleTemplateNameException {
