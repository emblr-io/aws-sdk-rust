...
impl ::std::fmt::Display for MaximumOpenPullRequestsExceededException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "MaximumOpenPullRequestsExceededException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::MaximumOpenPullRequestsExceededException {
...
impl MaximumOpenPullRequestsExceededExceptionBuilder {
    /// <p>Any message associated with the exception.</p>
    ...
    /// Consumes the builder and constructs a [`MaximumOpenPullRequestsExceededException`](crate::types::error::MaximumOpenPullRequestsExceededException).
    pub fn build(self) -> crate::types::error::MaximumOpenPullRequestsExceededException {
