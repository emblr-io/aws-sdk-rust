...
impl ::std::fmt::Display for MaximumRuleTemplatesAssociatedWithRepositoryException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "MaximumRuleTemplatesAssociatedWithRepositoryException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::MaximumRuleTemplatesAssociatedWithRepositoryException {
...
impl MaximumRuleTemplatesAssociatedWithRepositoryExceptionBuilder {
    /// <p>Any message associated with the exception.</p>
