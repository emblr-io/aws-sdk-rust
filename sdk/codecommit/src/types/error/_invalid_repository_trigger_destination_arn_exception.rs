...
impl ::std::fmt::Display for InvalidRepositoryTriggerDestinationArnException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidRepositoryTriggerDestinationArnException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidRepositoryTriggerDestinationArnException {
