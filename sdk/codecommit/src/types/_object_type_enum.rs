...
///     ObjectTypeEnum::Directory => { /* ... */ },
///     ObjectTypeEnum::File => { /* ... */ },
///     ObjectTypeEnum::GitLink => { /* ... */ },
///     ObjectTypeEnum::SymbolicLink => { /* ... */ },
...
impl ::std::convert::From<&str> for ObjectTypeEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ObjectTypeEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ObjectTypeEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ObjectTypeEnum::from(s))
    }
}
impl ObjectTypeEnum {
