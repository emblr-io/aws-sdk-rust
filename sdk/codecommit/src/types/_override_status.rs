...
impl ::std::convert::From<&str> for OverrideStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OverrideStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OverrideStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OverrideStatus::from(s))
    }
}
impl OverrideStatus {
...
impl ::std::convert::AsRef<str> for OverrideStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
