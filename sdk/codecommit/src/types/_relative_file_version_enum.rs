...
impl ::std::convert::From<&str> for RelativeFileVersionEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RelativeFileVersionEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RelativeFileVersionEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RelativeFileVersionEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RelativeFileVersionEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
