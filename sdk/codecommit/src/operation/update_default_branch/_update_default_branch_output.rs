...
impl ::aws_types::request_id::RequestId for UpdateDefaultBranchOutput {
...
impl UpdateDefaultBranchOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateDefaultBranchOutput`](crate::operation::update_default_branch::UpdateDefaultBranchOutput).
    pub fn build(self) -> crate::operation::update_default_branch::UpdateDefaultBranchOutput {
