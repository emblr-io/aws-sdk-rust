...
//! offered by AWS AppSync. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS AppSync.
...
/// For example, the [`AssociateApi`](crate::operation::associate_api) operation has
