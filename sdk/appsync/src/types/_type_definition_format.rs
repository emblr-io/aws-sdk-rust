...
impl ::std::convert::From<&str> for TypeDefinitionFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TypeDefinitionFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TypeDefinitionFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TypeDefinitionFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TypeDefinitionFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
