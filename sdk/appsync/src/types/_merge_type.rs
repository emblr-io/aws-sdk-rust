...
impl ::std::convert::From<&str> for MergeType {
    fn from(s: &str) -> Self {
        match s {
            "AUTO_MERGE" => MergeType::AutoMerge,
            "MANUAL_MERGE" => MergeType::ManualMerge,
            other => MergeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MergeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MergeType::from(s))
    }
}
impl MergeType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MergeType::AutoMerge => "AUTO_MERGE",
            MergeType::ManualMerge => "MANUAL_MERGE",
            MergeType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for MergeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
