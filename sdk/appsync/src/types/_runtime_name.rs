...
impl ::std::convert::From<&str> for RuntimeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RuntimeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RuntimeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RuntimeName::from(s))
    }
}
impl RuntimeName {
...
impl ::std::convert::AsRef<str> for RuntimeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
