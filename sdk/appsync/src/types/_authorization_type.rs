...
impl ::std::convert::From<&str> for AuthorizationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthorizationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthorizationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthorizationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthorizationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
