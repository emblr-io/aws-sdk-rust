...
impl ::std::convert::From<&str> for Ownership {
    fn from(s: &str) -> Self {
        match s {
            "CURRENT_ACCOUNT" => Ownership::CurrentAccount,
            "OTHER_ACCOUNTS" => Ownership::OtherAccounts,
            other => Ownership::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Ownership {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Ownership::from(s))
    }
}
impl Ownership {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Ownership::CurrentAccount => "CURRENT_ACCOUNT",
            Ownership::OtherAccounts => "OTHER_ACCOUNTS",
