...
///     ApiCachingBehavior::OperationLevelCaching => { /* ... */ },
...
impl ::std::convert::From<&str> for ApiCachingBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            "OPERATION_LEVEL_CACHING" => ApiCachingBehavior::OperationLevelCaching,
            "PER_RESOLVER_CACHING" => ApiCachingBehavior::PerResolverCaching,
            other => ApiCachingBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApiCachingBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApiCachingBehavior::from(s))
    }
}
impl ApiCachingBehavior {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ApiCachingBehavior::OperationLevelCaching => "OPERATION_LEVEL_CACHING",
...
impl ::std::convert::AsRef<str> for ApiCachingBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
