...
impl CognitoConfigBuilder {
    ...
    /// - [`user_pool_id`](crate::types::builders::CognitoConfigBuilder::user_pool_id)
    /// - [`aws_region`](crate::types::builders::CognitoConfigBuilder::aws_region)
    pub fn build(self) -> ::std::result::Result<crate::types::CognitoConfig, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::CognitoConfig {
            user_pool_id: self.user_pool_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "user_pool_id",
                    "user_pool_id was not specified but it is required when building CognitoConfig",
                )
            })?,
            aws_region: self.aws_region.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "aws_region",
                    "aws_region was not specified but it is required when building CognitoConfig",
                )
            })?,
