...
impl ::std::convert::From<&str> for ApiCacheStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApiCacheStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApiCacheStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApiCacheStatus::from(s))
    }
}
impl ApiCacheStatus {
...
impl ::std::convert::AsRef<str> for ApiCacheStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
