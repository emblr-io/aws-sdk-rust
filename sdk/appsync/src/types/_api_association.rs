...
pub struct ApiAssociation {
    ...
    /// <ul>
    /// <li>
    /// <p><b>PROCESSING</b>: The API association is being created. You cannot modify association requests during processing.</p></li>
    /// <li>
    /// <p><b>SUCCESS</b>: The API association was successful. You can modify associations after success.</p></li>
    /// <li>
...
impl ApiAssociationBuilder {
    ...
    /// <p>Details about the last deployment status.</p>
    pub fn deployment_detail(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
