...
impl ::std::convert::From<&str> for DefaultAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DefaultAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DefaultAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DefaultAction::from(s))
    }
}
impl DefaultAction {
...
impl ::std::convert::AsRef<str> for DefaultAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
