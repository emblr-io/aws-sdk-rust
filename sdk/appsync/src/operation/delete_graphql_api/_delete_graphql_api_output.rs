...
impl ::aws_types::request_id::RequestId for DeleteGraphqlApiOutput {
...
impl DeleteGraphqlApiOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteGraphqlApiOutput`](crate::operation::delete_graphql_api::DeleteGraphqlApiOutput).
    pub fn build(self) -> crate::operation::delete_graphql_api::DeleteGraphqlApiOutput {
        crate::operation::delete_graphql_api::DeleteGraphqlApiOutput {
