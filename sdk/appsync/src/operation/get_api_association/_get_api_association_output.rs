...
impl ::aws_types::request_id::RequestId for GetApiAssociationOutput {
...
impl GetApiAssociationOutputBuilder {
    ...
    pub fn api_association(mut self, input: crate::types::ApiAssociation) -> Self {
        self.api_association = ::std::option::Option::Some(input);
        self
    }
    /// <p>The <code>ApiAssociation</code> object.</p>
    ...
    /// <p>The <code>ApiAssociation</code> object.</p>
    pub fn get_api_association(&self) -> &::std::option::Option<crate::types::ApiAssociation> {
        &self.api_association
    }
