...
//! offered by AWS CloudHSM V2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS CloudHSM V2.
...
/// For example, the [`CopyBackupToRegion`](crate::operation::copy_backup_to_region) operation has
/// a [`Client::copy_backup_to_region`], function which returns a builder for that operation.
...
/// Configuration for AWS CloudHSM V2.
pub mod config;
