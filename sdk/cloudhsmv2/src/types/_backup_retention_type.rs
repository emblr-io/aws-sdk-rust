...
impl ::std::convert::From<&str> for BackupRetentionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BackupRetentionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BackupRetentionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BackupRetentionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BackupRetentionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BackupRetentionType {
