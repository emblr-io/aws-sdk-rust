...
impl ::std::convert::From<&str> for BackupPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BackupPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for BackupPolicy {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            BackupPolicy::Default => write!(f, "DEFAULT"),
            BackupPolicy::Unknown(value) => write!(f, "{}", value),
        }
    }
}
