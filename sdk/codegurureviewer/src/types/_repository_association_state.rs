...
///
/// ```text
/// # let repositoryassociationstate = unimplemented!();
/// match repositoryassociationstate {
///     RepositoryAssociationState::Associated => { /* ... */ },
///     RepositoryAssociationState::Associating => { /* ... */ },
///     RepositoryAssociationState::Disassociated => { /* ... */ },
///     RepositoryAssociationState::Disassociating => { /* ... */ },
///     RepositoryAssociationState::Failed => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `repositoryassociationstate` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `RepositoryAssociationState::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `RepositoryAssociationState::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `RepositoryAssociationState::NewFeature` is defined.
/// Specifically, when `repositoryassociationstate` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RepositoryAssociationState::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for RepositoryAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RepositoryAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RepositoryAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RepositoryAssociationState::from(s))
    }
}
impl RepositoryAssociationState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RepositoryAssociationState::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for RepositoryAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
