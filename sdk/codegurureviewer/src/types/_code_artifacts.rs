...
/// <ul>
/// <li>
/// <p>Source code artifacts are source code files in a Git repository that are compressed into a .zip file.</p></li>
/// <li>
/// <p>Build artifacts are .jar or .class files that are compressed in a .zip file.</p></li>
/// </ul>
#[non_exhaustive]
