...
///     EncryptionOption::AoCmk => { /* ... */ },
///     EncryptionOption::CmCmk => { /* ... */ },
...
impl ::std::convert::From<&str> for EncryptionOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EncryptionOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncryptionOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncryptionOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EncryptionOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
