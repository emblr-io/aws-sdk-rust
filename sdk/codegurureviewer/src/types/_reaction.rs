...
impl ::std::convert::From<&str> for Reaction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Reaction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Reaction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Reaction::from(s))
    }
}
impl Reaction {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Reaction::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for Reaction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
