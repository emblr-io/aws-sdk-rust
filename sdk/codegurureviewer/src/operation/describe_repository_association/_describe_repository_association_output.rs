...
impl ::aws_types::request_id::RequestId for DescribeRepositoryAssociationOutput {
...
impl DescribeRepositoryAssociationOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::describe_repository_association::DescribeRepositoryAssociationOutput {
