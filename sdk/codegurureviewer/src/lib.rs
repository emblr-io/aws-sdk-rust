...
//! offered by Amazon CodeGuru Reviewer. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CodeGuru Reviewer.
...
/// For example, the [`AssociateRepository`](crate::operation::associate_repository) operation has
...
/// Configuration for Amazon CodeGuru Reviewer.
pub mod config;
