...
impl ListTagsForResourceOutput {
    /// The Amazon Resource Name (ARN) and tags for an AWS Elemental MediaConvert resource.
    pub fn resource_tags(&self) -> ::std::option::Option<&crate::types::ResourceTags> {
...
impl ListTagsForResourceOutputBuilder {
    /// The Amazon Resource Name (ARN) and tags for an AWS Elemental MediaConvert resource.
    pub fn resource_tags(mut self, input: crate::types::ResourceTags) -> Self {
        self.resource_tags = ::std::option::Option::Some(input);
        self
    }
    /// The Amazon Resource Name (ARN) and tags for an AWS Elemental MediaConvert resource.
