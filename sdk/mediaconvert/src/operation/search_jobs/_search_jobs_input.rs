...
pub struct SearchJobsInput {
    ...
    pub input_file: ::std::option::Option<::std::string::String>,
...
impl SearchJobsInput {
    /// Optional. Provide your input file URL or your partial input file name. The maximum length for an input file is 300 characters.
    pub fn input_file(&self) -> ::std::option::Option<&str> {
...
pub struct SearchJobsInputBuilder {
    pub(crate) input_file: ::std::option::Option<::std::string::String>,
...
impl SearchJobsInputBuilder {
    ...
    pub fn input_file(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.input_file = ::std::option::Option::Some(input.into());
        self
    }
    /// Optional. Provide your input file URL or your partial input file name. The maximum length for an input file is 300 characters.
