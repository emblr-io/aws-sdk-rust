...
//! aws-sdk-mediaconvert = "0.0.0-local"
...
//! offered by AWS Elemental MediaConvert. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Elemental MediaConvert.
...
/// For example, the [`AssociateCertificate`](crate::operation::associate_certificate) operation has
/// a [`Client::associate_certificate`], function which returns a builder for that operation.
...
/// Configuration for AWS Elemental MediaConvert.
pub mod config;
