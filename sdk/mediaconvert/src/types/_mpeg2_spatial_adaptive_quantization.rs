...
/// When writing a match expression against `Mpeg2SpatialAdaptiveQuantization`, it is important to ensure
...
///     Mpeg2SpatialAdaptiveQuantization::Disabled => { /* ... */ },
///     Mpeg2SpatialAdaptiveQuantization::Enabled => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `mpeg2spatialadaptivequantization` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Mpeg2SpatialAdaptiveQuantization::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Mpeg2SpatialAdaptiveQuantization::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Mpeg2SpatialAdaptiveQuantization::NewFeature` is defined.
...
impl ::std::convert::From<&str> for Mpeg2SpatialAdaptiveQuantization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Mpeg2SpatialAdaptiveQuantization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Mpeg2SpatialAdaptiveQuantization {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Mpeg2SpatialAdaptiveQuantization::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Mpeg2SpatialAdaptiveQuantization {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Mpeg2SpatialAdaptiveQuantization {
