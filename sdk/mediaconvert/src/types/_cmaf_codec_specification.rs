...
/// When writing a match expression against `CmafCodecSpecification`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `cmafcodecspecification` represents
...
/// version of SDK where the variant `CmafCodecSpecification::NewFeature` is defined.
/// Specifically, when `cmafcodecspecification` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `CmafCodecSpecification::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for CmafCodecSpecification {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CmafCodecSpecification::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CmafCodecSpecification {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CmafCodecSpecification::from(s))
    }
}
impl CmafCodecSpecification {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CmafCodecSpecification::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for CmafCodecSpecification {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
