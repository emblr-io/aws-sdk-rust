...
/// When writing a match expression against `Vc3FramerateConversionAlgorithm`, it is important to ensure
...
///
/// ```text
/// # let vc3framerateconversionalgorithm = unimplemented!();
/// match vc3framerateconversionalgorithm {
///     Vc3FramerateConversionAlgorithm::DuplicateDrop => { /* ... */ },
///     Vc3FramerateConversionAlgorithm::Frameformer => { /* ... */ },
///     Vc3FramerateConversionAlgorithm::Interpolate => { /* ... */ },
///     Vc3FramerateConversionAlgorithm::MaintainFrameCount => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `vc3framerateconversionalgorithm` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Vc3FramerateConversionAlgorithm::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Vc3FramerateConversionAlgorithm::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Vc3FramerateConversionAlgorithm::NewFeature` is defined.
/// Specifically, when `vc3framerateconversionalgorithm` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Vc3FramerateConversionAlgorithm::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for Vc3FramerateConversionAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MAINTAIN_FRAME_COUNT" => Vc3FramerateConversionAlgorithm::MaintainFrameCount,
            other => Vc3FramerateConversionAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Vc3FramerateConversionAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Vc3FramerateConversionAlgorithm::from(s))
    }
}
impl Vc3FramerateConversionAlgorithm {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Vc3FramerateConversionAlgorithm::MaintainFrameCount => "MAINTAIN_FRAME_COUNT",
            Vc3FramerateConversionAlgorithm::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for Vc3FramerateConversionAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
