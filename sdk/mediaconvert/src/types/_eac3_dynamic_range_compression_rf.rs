...
/// When writing a match expression against `Eac3DynamicRangeCompressionRf`, it is important to ensure
...
///     Eac3DynamicRangeCompressionRf::FilmLight => { /* ... */ },
///     Eac3DynamicRangeCompressionRf::FilmStandard => { /* ... */ },
///     Eac3DynamicRangeCompressionRf::MusicLight => { /* ... */ },
///     Eac3DynamicRangeCompressionRf::MusicStandard => { /* ... */ },
///     Eac3DynamicRangeCompressionRf::None => { /* ... */ },
///     Eac3DynamicRangeCompressionRf::Speech => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `eac3dynamicrangecompressionrf` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Eac3DynamicRangeCompressionRf::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Eac3DynamicRangeCompressionRf::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Eac3DynamicRangeCompressionRf::NewFeature` is defined.
...
impl ::std::convert::From<&str> for Eac3DynamicRangeCompressionRf {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Eac3DynamicRangeCompressionRf::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Eac3DynamicRangeCompressionRf {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Eac3DynamicRangeCompressionRf::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Eac3DynamicRangeCompressionRf {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Eac3DynamicRangeCompressionRf {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Eac3DynamicRangeCompressionRf::FilmLight => write!(f, "FILM_LIGHT"),
            Eac3DynamicRangeCompressionRf::FilmStandard => write!(f, "FILM_STANDARD"),
            Eac3DynamicRangeCompressionRf::MusicLight => write!(f, "MUSIC_LIGHT"),
            Eac3DynamicRangeCompressionRf::MusicStandard => write!(f, "MUSIC_STANDARD"),
            Eac3DynamicRangeCompressionRf::None => write!(f, "NONE"),
            Eac3DynamicRangeCompressionRf::Speech => write!(f, "SPEECH"),
            Eac3DynamicRangeCompressionRf::Unknown(value) => write!(f, "{}", value),
        }
    }
}
