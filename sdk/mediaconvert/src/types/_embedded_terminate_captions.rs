...
/// When writing a match expression against `EmbeddedTerminateCaptions`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `embeddedterminatecaptions` represents
...
/// version of SDK where the variant `EmbeddedTerminateCaptions::NewFeature` is defined.
/// Specifically, when `embeddedterminatecaptions` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `EmbeddedTerminateCaptions::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for EmbeddedTerminateCaptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EmbeddedTerminateCaptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl EmbeddedTerminateCaptions {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EmbeddedTerminateCaptions::Unknown(value) => value.as_str(),
        }
    }
