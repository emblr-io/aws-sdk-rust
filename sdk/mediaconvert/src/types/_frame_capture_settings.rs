...
pub struct FrameCaptureSettings {
    ...
    pub max_captures: ::std::option::Option<i32>,
...
impl FrameCaptureSettings {
    ...
    /// Maximum number of captures (encoded jpg output files).
    pub fn max_captures(&self) -> ::std::option::Option<i32> {
        self.max_captures
    }
    /// JPEG Quality - a higher value equals higher quality.
    pub fn quality(&self) -> ::std::option::Option<i32> {
        self.quality
    }
}
impl FrameCaptureSettings {
...
impl FrameCaptureSettingsBuilder {
    ...
    pub fn max_captures(mut self, input: i32) -> Self {
        self.max_captures = ::std::option::Option::Some(input);
        self
    }
    /// Maximum number of captures (encoded jpg output files).
