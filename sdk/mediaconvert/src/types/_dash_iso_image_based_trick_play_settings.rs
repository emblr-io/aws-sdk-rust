...
pub struct DashIsoImageBasedTrickPlaySettings {
    ...
    pub interval_cadence: ::std::option::Option<crate::types::DashIsoIntervalCadence>,
...
impl DashIsoImageBasedTrickPlaySettings {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval.
    pub fn interval_cadence(&self) -> ::std::option::Option<&crate::types::DashIsoIntervalCadence> {
...
impl DashIsoImageBasedTrickPlaySettings {
    /// Creates a new builder-style object to manufacture [`DashIsoImageBasedTrickPlaySettings`](crate::types::DashIsoImageBasedTrickPlaySettings).
    pub fn builder() -> crate::types::builders::DashIsoImageBasedTrickPlaySettingsBuilder {
        crate::types::builders::DashIsoImageBasedTrickPlaySettingsBuilder::default()
    }
}
...
impl DashIsoImageBasedTrickPlaySettingsBuilder {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval.
    pub fn interval_cadence(mut self, input: crate::types::DashIsoIntervalCadence) -> Self {
        self.interval_cadence = ::std::option::Option::Some(input);
        self
    }
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval.
    ...
    pub fn thumbnail_interval(mut self, input: f64) -> Self {
        self.thumbnail_interval = ::std::option::Option::Some(input);
        self
    }
    /// Enter the interval, in seconds, that MediaConvert uses to generate thumbnails. If the interval you enter doesn't align with the output frame rate, MediaConvert automatically rounds the interval to align with the output frame rate. For example, if the output frame rate is 29.97 frames per second and you enter 5, MediaConvert uses a 150 frame interval to generate thumbnails.
    ...
    /// Consumes the builder and constructs a [`DashIsoImageBasedTrickPlaySettings`](crate::types::DashIsoImageBasedTrickPlaySettings).
    pub fn build(self) -> crate::types::DashIsoImageBasedTrickPlaySettings {
        crate::types::DashIsoImageBasedTrickPlaySettings {
