...
impl ::std::convert::From<&str> for M3u8PcrControl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => M3u8PcrControl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for M3u8PcrControl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(M3u8PcrControl::from(s))
    }
}
impl M3u8PcrControl {
...
impl ::std::convert::AsRef<str> for M3u8PcrControl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
