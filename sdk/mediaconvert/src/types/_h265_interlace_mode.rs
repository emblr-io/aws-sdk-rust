...
/// When writing a match expression against `H265InterlaceMode`, it is important to ensure
...
///
/// ```text
/// # let h265interlacemode = unimplemented!();
/// match h265interlacemode {
///     H265InterlaceMode::BottomField => { /* ... */ },
///     H265InterlaceMode::FollowBottomField => { /* ... */ },
///     H265InterlaceMode::FollowTopField => { /* ... */ },
///     H265InterlaceMode::Progressive => { /* ... */ },
///     H265InterlaceMode::TopField => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `h265interlacemode` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `H265InterlaceMode::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `H265InterlaceMode::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `H265InterlaceMode::NewFeature` is defined.
/// Specifically, when `h265interlacemode` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `H265InterlaceMode::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for H265InterlaceMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H265InterlaceMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265InterlaceMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265InterlaceMode::from(s))
    }
}
impl H265InterlaceMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H265InterlaceMode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H265InterlaceMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
