...
/// When writing a match expression against `InputFilterEnable`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `inputfilterenable` represents
...
/// version of SDK where the variant `InputFilterEnable::NewFeature` is defined.
/// Specifically, when `inputfilterenable` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `InputFilterEnable::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for InputFilterEnable {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InputFilterEnable::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InputFilterEnable {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InputFilterEnable::from(s))
    }
}
impl InputFilterEnable {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            InputFilterEnable::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for InputFilterEnable {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
