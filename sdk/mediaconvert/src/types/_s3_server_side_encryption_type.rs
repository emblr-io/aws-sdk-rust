...
impl ::std::convert::From<&str> for S3ServerSideEncryptionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => S3ServerSideEncryptionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for S3ServerSideEncryptionType {
