...
impl ::std::convert::From<&str> for Mpeg2TemporalAdaptiveQuantization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Mpeg2TemporalAdaptiveQuantization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Mpeg2TemporalAdaptiveQuantization {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Mpeg2TemporalAdaptiveQuantization::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Mpeg2TemporalAdaptiveQuantization {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
