...
impl ::std::convert::From<&str> for XavcInterlaceMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => XavcInterlaceMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for XavcInterlaceMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(XavcInterlaceMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for XavcInterlaceMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
