...
impl H264QvbrSettings {
    /// Creates a new builder-style object to manufacture [`H264QvbrSettings`](crate::types::H264QvbrSettings).
    pub fn builder() -> crate::types::builders::H264QvbrSettingsBuilder {
        crate::types::builders::H264QvbrSettingsBuilder::default()
    }
}
...
impl H264QvbrSettingsBuilder {
    ...
    pub fn max_average_bitrate(mut self, input: i32) -> Self {
        self.max_average_bitrate = ::std::option::Option::Some(input);
        self
    }
    /// Use this setting only when Rate control mode is QVBR and Quality tuning level is Multi-pass HQ. For Max average bitrate values suited to the complexity of your input video, the service limits the average bitrate of the video part of this output to the value that you choose. That is, the total size of the video element is less than or equal to the value you set multiplied by the number of seconds of encoded output.
