...
impl ::std::convert::From<&str> for ImscStylePassthrough {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImscStylePassthrough::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImscStylePassthrough {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImscStylePassthrough::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImscStylePassthrough {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
