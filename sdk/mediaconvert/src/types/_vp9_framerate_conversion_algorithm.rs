...
/// When writing a match expression against `Vp9FramerateConversionAlgorithm`, it is important to ensure
...
///
/// ```text
/// # let vp9framerateconversionalgorithm = unimplemented!();
/// match vp9framerateconversionalgorithm {
///     Vp9FramerateConversionAlgorithm::DuplicateDrop => { /* ... */ },
///     Vp9FramerateConversionAlgorithm::Frameformer => { /* ... */ },
///     Vp9FramerateConversionAlgorithm::Interpolate => { /* ... */ },
///     Vp9FramerateConversionAlgorithm::MaintainFrameCount => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `vp9framerateconversionalgorithm` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Vp9FramerateConversionAlgorithm::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Vp9FramerateConversionAlgorithm::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Vp9FramerateConversionAlgorithm::NewFeature` is defined.
/// Specifically, when `vp9framerateconversionalgorithm` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Vp9FramerateConversionAlgorithm::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for Vp9FramerateConversionAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MAINTAIN_FRAME_COUNT" => Vp9FramerateConversionAlgorithm::MaintainFrameCount,
            other => Vp9FramerateConversionAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Vp9FramerateConversionAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Vp9FramerateConversionAlgorithm::from(s))
    }
}
impl Vp9FramerateConversionAlgorithm {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Vp9FramerateConversionAlgorithm::MaintainFrameCount => "MAINTAIN_FRAME_COUNT",
            Vp9FramerateConversionAlgorithm::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for Vp9FramerateConversionAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Vp9FramerateConversionAlgorithm {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            Vp9FramerateConversionAlgorithm::MaintainFrameCount => write!(f, "MAINTAIN_FRAME_COUNT"),
