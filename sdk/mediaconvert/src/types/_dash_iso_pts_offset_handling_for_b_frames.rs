...
impl ::std::convert::From<&str> for DashIsoPtsOffsetHandlingForBFrames {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DashIsoPtsOffsetHandlingForBFrames::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DashIsoPtsOffsetHandlingForBFrames {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DashIsoPtsOffsetHandlingForBFrames::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DashIsoPtsOffsetHandlingForBFrames {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
