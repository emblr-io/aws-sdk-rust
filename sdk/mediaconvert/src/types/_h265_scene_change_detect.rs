...
/// When writing a match expression against `H265SceneChangeDetect`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `h265scenechangedetect` represents
...
/// version of SDK where the variant `H265SceneChangeDetect::NewFeature` is defined.
/// Specifically, when `h265scenechangedetect` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `H265SceneChangeDetect::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for H265SceneChangeDetect {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H265SceneChangeDetect::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265SceneChangeDetect {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265SceneChangeDetect::from(s))
    }
}
impl H265SceneChangeDetect {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H265SceneChangeDetect::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H265SceneChangeDetect {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for H265SceneChangeDetect {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            H265SceneChangeDetect::Disabled => write!(f, "DISABLED"),
            H265SceneChangeDetect::Enabled => write!(f, "ENABLED"),
            H265SceneChangeDetect::TransitionDetection => write!(f, "TRANSITION_DETECTION"),
