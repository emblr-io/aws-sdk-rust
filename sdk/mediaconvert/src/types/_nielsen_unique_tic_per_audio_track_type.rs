...
/// When writing a match expression against `NielsenUniqueTicPerAudioTrackType`, it is important to ensure
...
///
/// ```text
/// # let nielsenuniqueticperaudiotracktype = unimplemented!();
/// match nielsenuniqueticperaudiotracktype {
///     NielsenUniqueTicPerAudioTrackType::ReserveUniqueTicsPerTrack => { /* ... */ },
///     NielsenUniqueTicPerAudioTrackType::SameTicsPerTrack => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `nielsenuniqueticperaudiotracktype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `NielsenUniqueTicPerAudioTrackType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `NielsenUniqueTicPerAudioTrackType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `NielsenUniqueTicPerAudioTrackType::NewFeature` is defined.
/// Specifically, when `nielsenuniqueticperaudiotracktype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `NielsenUniqueTicPerAudioTrackType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for NielsenUniqueTicPerAudioTrackType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NielsenUniqueTicPerAudioTrackType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NielsenUniqueTicPerAudioTrackType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NielsenUniqueTicPerAudioTrackType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NielsenUniqueTicPerAudioTrackType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
