...
impl ::std::convert::From<&str> for DvbSubtitleFontColor {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DvbSubtitleFontColor::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DvbSubtitleFontColor {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DvbSubtitleFontColor::from(s))
    }
}
