...
impl ::std::convert::From<&str> for Xavc4kIntraVbrProfileClass {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Xavc4kIntraVbrProfileClass::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for Xavc4kIntraVbrProfileClass {
