...
impl ::std::convert::From<&str> for AvcIntraInterlaceMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AvcIntraInterlaceMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AvcIntraInterlaceMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AvcIntraInterlaceMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AvcIntraInterlaceMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
