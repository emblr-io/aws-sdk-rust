...
impl ::std::convert::From<&str> for H265TemporalAdaptiveQuantization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H265TemporalAdaptiveQuantization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265TemporalAdaptiveQuantization {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265TemporalAdaptiveQuantization::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for H265TemporalAdaptiveQuantization {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
