...
/// When writing a match expression against `Mpeg2SlowPal`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `mpeg2slowpal` represents
...
/// version of SDK where the variant `Mpeg2SlowPal::NewFeature` is defined.
/// Specifically, when `mpeg2slowpal` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Mpeg2SlowPal::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for Mpeg2SlowPal {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Mpeg2SlowPal::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Mpeg2SlowPal {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Mpeg2SlowPal::from(s))
    }
}
impl Mpeg2SlowPal {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Mpeg2SlowPal::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for Mpeg2SlowPal {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
