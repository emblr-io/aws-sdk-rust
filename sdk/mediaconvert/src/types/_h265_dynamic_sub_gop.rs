...
/// When writing a match expression against `H265DynamicSubGop`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `h265dynamicsubgop` represents
...
/// version of SDK where the variant `H265DynamicSubGop::NewFeature` is defined.
/// Specifically, when `h265dynamicsubgop` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `H265DynamicSubGop::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for H265DynamicSubGop {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H265DynamicSubGop::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265DynamicSubGop {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265DynamicSubGop::from(s))
    }
}
impl H265DynamicSubGop {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H265DynamicSubGop::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H265DynamicSubGop {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
