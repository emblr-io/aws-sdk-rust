...
impl ::std::convert::From<&str> for DashIsoGroupAudioChannelConfigSchemeIdUri {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                DashIsoGroupAudioChannelConfigSchemeIdUri::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for DashIsoGroupAudioChannelConfigSchemeIdUri {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DashIsoGroupAudioChannelConfigSchemeIdUri::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DashIsoGroupAudioChannelConfigSchemeIdUri {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
