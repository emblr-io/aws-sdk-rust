...
impl ::std::convert::From<&str> for OutputSdt {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OutputSdt::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OutputSdt {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OutputSdt::from(s))
    }
}
impl OutputSdt {
...
impl ::std::convert::AsRef<str> for OutputSdt {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
