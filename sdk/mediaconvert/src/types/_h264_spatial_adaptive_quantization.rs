...
impl ::std::convert::From<&str> for H264SpatialAdaptiveQuantization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H264SpatialAdaptiveQuantization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H264SpatialAdaptiveQuantization {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H264SpatialAdaptiveQuantization::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for H264SpatialAdaptiveQuantization {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for H264SpatialAdaptiveQuantization {
