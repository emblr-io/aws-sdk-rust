...
///     Eac3AtmosCodingMode::CodingModeAuto => { /* ... */ },
...
impl ::std::convert::From<&str> for Eac3AtmosCodingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Eac3AtmosCodingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Eac3AtmosCodingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Eac3AtmosCodingMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Eac3AtmosCodingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
