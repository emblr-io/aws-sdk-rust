...
/// When writing a match expression against `CmafManifestDurationFormat`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `cmafmanifestdurationformat` represents
...
/// version of SDK where the variant `CmafManifestDurationFormat::NewFeature` is defined.
/// Specifically, when `cmafmanifestdurationformat` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `CmafManifestDurationFormat::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for CmafManifestDurationFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CmafManifestDurationFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CmafManifestDurationFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CmafManifestDurationFormat::from(s))
    }
}
impl CmafManifestDurationFormat {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CmafManifestDurationFormat::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for CmafManifestDurationFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
