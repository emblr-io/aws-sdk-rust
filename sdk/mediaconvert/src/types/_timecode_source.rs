...
impl ::std::convert::From<&str> for TimecodeSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimecodeSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimecodeSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimecodeSource::from(s))
    }
}
impl TimecodeSource {
...
impl ::std::convert::AsRef<str> for TimecodeSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
