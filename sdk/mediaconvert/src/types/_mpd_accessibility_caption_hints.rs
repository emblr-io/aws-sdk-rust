...
impl ::std::convert::From<&str> for MpdAccessibilityCaptionHints {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MpdAccessibilityCaptionHints::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MpdAccessibilityCaptionHints {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MpdAccessibilityCaptionHints::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MpdAccessibilityCaptionHints {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
