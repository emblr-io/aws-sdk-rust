...
/// When writing a match expression against `AdvancedInputFilterAddTexture`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `advancedinputfilteraddtexture` represents
...
/// version of SDK where the variant `AdvancedInputFilterAddTexture::NewFeature` is defined.
/// Specifically, when `advancedinputfilteraddtexture` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AdvancedInputFilterAddTexture::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AdvancedInputFilterAddTexture {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AdvancedInputFilterAddTexture::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl AdvancedInputFilterAddTexture {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AdvancedInputFilterAddTexture::Disabled => "DISABLED",
            AdvancedInputFilterAddTexture::Enabled => "ENABLED",
            AdvancedInputFilterAddTexture::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::fmt::Display for AdvancedInputFilterAddTexture {
