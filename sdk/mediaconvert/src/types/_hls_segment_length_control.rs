...
/// When writing a match expression against `HlsSegmentLengthControl`, it is important to ensure
...
///
/// ```text
/// # let hlssegmentlengthcontrol = unimplemented!();
/// match hlssegmentlengthcontrol {
///     HlsSegmentLengthControl::Exact => { /* ... */ },
///     HlsSegmentLengthControl::GopMultiple => { /* ... */ },
///     HlsSegmentLengthControl::Match => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `hlssegmentlengthcontrol` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `HlsSegmentLengthControl::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `HlsSegmentLengthControl::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `HlsSegmentLengthControl::NewFeature` is defined.
/// Specifically, when `hlssegmentlengthcontrol` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `HlsSegmentLengthControl::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for HlsSegmentLengthControl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HlsSegmentLengthControl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl HlsSegmentLengthControl {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            HlsSegmentLengthControl::Match => "MATCH",
            HlsSegmentLengthControl::Unknown(value) => value.as_str(),
        }
    }
