...
impl ::std::convert::From<&str> for SimulateReservedQueue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SimulateReservedQueue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SimulateReservedQueue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SimulateReservedQueue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SimulateReservedQueue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
