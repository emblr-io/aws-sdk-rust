...
/// When writing a match expression against `Mpeg2Telecine`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `mpeg2telecine` represents
...
/// version of SDK where the variant `Mpeg2Telecine::NewFeature` is defined.
/// Specifically, when `mpeg2telecine` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Mpeg2Telecine::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for Mpeg2Telecine {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Mpeg2Telecine::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Mpeg2Telecine {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Mpeg2Telecine::from(s))
    }
}
impl Mpeg2Telecine {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Mpeg2Telecine::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for Mpeg2Telecine {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
