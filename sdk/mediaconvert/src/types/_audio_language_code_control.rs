...
impl ::std::convert::From<&str> for AudioLanguageCodeControl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioLanguageCodeControl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioLanguageCodeControl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioLanguageCodeControl::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AudioLanguageCodeControl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
