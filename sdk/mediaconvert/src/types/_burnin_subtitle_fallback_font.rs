...
impl ::std::convert::From<&str> for BurninSubtitleFallbackFont {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BurninSubtitleFallbackFont::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BurninSubtitleFallbackFont {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BurninSubtitleFallbackFont::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BurninSubtitleFallbackFont {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
