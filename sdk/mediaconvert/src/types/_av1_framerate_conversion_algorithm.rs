...
/// When writing a match expression against `Av1FramerateConversionAlgorithm`, it is important to ensure
...
///
/// ```text
/// # let av1framerateconversionalgorithm = unimplemented!();
/// match av1framerateconversionalgorithm {
...
/// }
/// ```
/// The above code demonstrates that when `av1framerateconversionalgorithm` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Av1FramerateConversionAlgorithm::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Av1FramerateConversionAlgorithm::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Av1FramerateConversionAlgorithm::NewFeature` is defined.
/// Specifically, when `av1framerateconversionalgorithm` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Av1FramerateConversionAlgorithm::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::str::FromStr for Av1FramerateConversionAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Av1FramerateConversionAlgorithm::from(s))
    }
}
