...
/// When writing a match expression against `H265FramerateConversionAlgorithm`, it is important to ensure
...
///
/// ```text
/// # let h265framerateconversionalgorithm = unimplemented!();
/// match h265framerateconversionalgorithm {
///     H265FramerateConversionAlgorithm::DuplicateDrop => { /* ... */ },
///     H265FramerateConversionAlgorithm::Frameformer => { /* ... */ },
///     H265FramerateConversionAlgorithm::Interpolate => { /* ... */ },
///     H265FramerateConversionAlgorithm::MaintainFrameCount => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `h265framerateconversionalgorithm` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `H265FramerateConversionAlgorithm::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `H265FramerateConversionAlgorithm::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `H265FramerateConversionAlgorithm::NewFeature` is defined.
/// Specifically, when `h265framerateconversionalgorithm` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `H265FramerateConversionAlgorithm::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for H265FramerateConversionAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MAINTAIN_FRAME_COUNT" => H265FramerateConversionAlgorithm::MaintainFrameCount,
            other => H265FramerateConversionAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265FramerateConversionAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265FramerateConversionAlgorithm::from(s))
    }
}
impl H265FramerateConversionAlgorithm {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H265FramerateConversionAlgorithm::MaintainFrameCount => "MAINTAIN_FRAME_COUNT",
            H265FramerateConversionAlgorithm::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H265FramerateConversionAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
