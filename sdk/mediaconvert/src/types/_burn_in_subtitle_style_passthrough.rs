...
/// When writing a match expression against `BurnInSubtitleStylePassthrough`, it is important to ensure
...
///
/// ```text
/// # let burninsubtitlestylepassthrough = unimplemented!();
/// match burninsubtitlestylepassthrough {
///     BurnInSubtitleStylePassthrough::Disabled => { /* ... */ },
///     BurnInSubtitleStylePassthrough::Enabled => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `burninsubtitlestylepassthrough` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `BurnInSubtitleStylePassthrough::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `BurnInSubtitleStylePassthrough::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `BurnInSubtitleStylePassthrough::NewFeature` is defined.
/// Specifically, when `burninsubtitlestylepassthrough` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `BurnInSubtitleStylePassthrough::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for BurnInSubtitleStylePassthrough {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BurnInSubtitleStylePassthrough::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BurnInSubtitleStylePassthrough {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BurnInSubtitleStylePassthrough::from(s))
    }
}
impl BurnInSubtitleStylePassthrough {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            BurnInSubtitleStylePassthrough::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for BurnInSubtitleStylePassthrough {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
