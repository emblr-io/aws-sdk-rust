...
/// When writing a match expression against `ProresParControl`, it is important to ensure
...
///
/// ```text
/// # let proresparcontrol = unimplemented!();
/// match proresparcontrol {
///     ProresParControl::InitializeFromSource => { /* ... */ },
///     ProresParControl::Specified => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `proresparcontrol` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ProresParControl::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ProresParControl::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ProresParControl::NewFeature` is defined.
/// Specifically, when `proresparcontrol` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ProresParControl::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for ProresParControl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProresParControl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProresParControl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProresParControl::from(s))
    }
}
impl ProresParControl {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ProresParControl::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ProresParControl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
