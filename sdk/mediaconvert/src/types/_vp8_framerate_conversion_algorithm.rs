...
/// When writing a match expression against `Vp8FramerateConversionAlgorithm`, it is important to ensure
...
///
/// ```text
/// # let vp8framerateconversionalgorithm = unimplemented!();
/// match vp8framerateconversionalgorithm {
///     Vp8FramerateConversionAlgorithm::DuplicateDrop => { /* ... */ },
///     Vp8FramerateConversionAlgorithm::Frameformer => { /* ... */ },
///     Vp8FramerateConversionAlgorithm::Interpolate => { /* ... */ },
///     Vp8FramerateConversionAlgorithm::MaintainFrameCount => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `vp8framerateconversionalgorithm` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Vp8FramerateConversionAlgorithm::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Vp8FramerateConversionAlgorithm::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Vp8FramerateConversionAlgorithm::NewFeature` is defined.
/// Specifically, when `vp8framerateconversionalgorithm` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `Vp8FramerateConversionAlgorithm::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for Vp8FramerateConversionAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MAINTAIN_FRAME_COUNT" => Vp8FramerateConversionAlgorithm::MaintainFrameCount,
            other => Vp8FramerateConversionAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl Vp8FramerateConversionAlgorithm {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Vp8FramerateConversionAlgorithm::MaintainFrameCount => "MAINTAIN_FRAME_COUNT",
            Vp8FramerateConversionAlgorithm::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::fmt::Display for Vp8FramerateConversionAlgorithm {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Vp8FramerateConversionAlgorithm::DuplicateDrop => write!(f, "DUPLICATE_DROP"),
