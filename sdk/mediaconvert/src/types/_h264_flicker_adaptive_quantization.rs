...
impl ::std::convert::From<&str> for H264FlickerAdaptiveQuantization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H264FlickerAdaptiveQuantization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for H264FlickerAdaptiveQuantization {
