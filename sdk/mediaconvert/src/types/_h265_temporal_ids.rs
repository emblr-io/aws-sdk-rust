...
impl ::std::convert::From<&str> for H265TemporalIds {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H265TemporalIds::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265TemporalIds {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265TemporalIds::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for H265TemporalIds {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for H265TemporalIds {
