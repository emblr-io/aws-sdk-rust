...
/// When writing a match expression against `Eac3AtmosMeteringMode`, it is important to ensure
...
///     Eac3AtmosMeteringMode::ItuBs17701 => { /* ... */ },
///     Eac3AtmosMeteringMode::ItuBs17702 => { /* ... */ },
///     Eac3AtmosMeteringMode::ItuBs17703 => { /* ... */ },
///     Eac3AtmosMeteringMode::ItuBs17704 => { /* ... */ },
///     Eac3AtmosMeteringMode::LeqA => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `eac3atmosmeteringmode` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `Eac3AtmosMeteringMode::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `Eac3AtmosMeteringMode::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `Eac3AtmosMeteringMode::NewFeature` is defined.
