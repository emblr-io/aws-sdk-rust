...
/// When writing a match expression against `H265ParControl`, it is important to ensure
...
///
/// ```text
/// # let h265parcontrol = unimplemented!();
/// match h265parcontrol {
///     H265ParControl::InitializeFromSource => { /* ... */ },
///     H265ParControl::Specified => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `h265parcontrol` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `H265ParControl::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `H265ParControl::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `H265ParControl::NewFeature` is defined.
/// Specifically, when `h265parcontrol` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `H265ParControl::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for H265ParControl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H265ParControl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H265ParControl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H265ParControl::from(s))
    }
}
impl H265ParControl {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H265ParControl::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H265ParControl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
