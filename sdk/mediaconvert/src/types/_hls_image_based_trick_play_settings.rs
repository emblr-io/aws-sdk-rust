...
pub struct HlsImageBasedTrickPlaySettings {
    ...
    pub interval_cadence: ::std::option::Option<crate::types::HlsIntervalCadence>,
...
impl HlsImageBasedTrickPlaySettings {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval.
    pub fn interval_cadence(&self) -> ::std::option::Option<&crate::types::HlsIntervalCadence> {
...
impl HlsImageBasedTrickPlaySettings {
    /// Creates a new builder-style object to manufacture [`HlsImageBasedTrickPlaySettings`](crate::types::HlsImageBasedTrickPlaySettings).
    pub fn builder() -> crate::types::builders::HlsImageBasedTrickPlaySettingsBuilder {
        crate::types::builders::HlsImageBasedTrickPlaySettingsBuilder::default()
    }
}
...
impl HlsImageBasedTrickPlaySettingsBuilder {
    /// The cadence MediaConvert follows for generating thumbnails. If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence). If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval.
    pub fn interval_cadence(mut self, input: crate::types::HlsIntervalCadence) -> Self {
    ...
    pub fn build(self) -> crate::types::HlsImageBasedTrickPlaySettings {
        crate::types::HlsImageBasedTrickPlaySettings {
