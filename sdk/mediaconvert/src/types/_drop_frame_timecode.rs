...
impl ::std::convert::From<&str> for DropFrameTimecode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DropFrameTimecode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DropFrameTimecode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DropFrameTimecode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DropFrameTimecode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
