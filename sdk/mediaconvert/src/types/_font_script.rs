...
/// When writing a match expression against `FontScript`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `fontscript` represents
...
/// version of SDK where the variant `FontScript::NewFeature` is defined.
/// Specifically, when `fontscript` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `FontScript::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for FontScript {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FontScript::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FontScript {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FontScript::from(s))
    }
}
impl FontScript {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            FontScript::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for FontScript {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
