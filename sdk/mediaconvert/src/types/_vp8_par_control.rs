...
impl ::std::convert::From<&str> for Vp8ParControl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Vp8ParControl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Vp8ParControl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Vp8ParControl::from(s))
    }
}
impl Vp8ParControl {
...
impl ::std::convert::AsRef<str> for Vp8ParControl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
