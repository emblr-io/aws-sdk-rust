...
impl ::std::convert::From<&str> for XavcFlickerAdaptiveQuantization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => XavcFlickerAdaptiveQuantization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for XavcFlickerAdaptiveQuantization {
