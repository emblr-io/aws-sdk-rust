...
impl ::std::convert::From<&str> for Eac3DynamicRangeCompressionLine {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Eac3DynamicRangeCompressionLine::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Eac3DynamicRangeCompressionLine {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Eac3DynamicRangeCompressionLine::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Eac3DynamicRangeCompressionLine {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Eac3DynamicRangeCompressionLine {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Eac3DynamicRangeCompressionLine::FilmLight => write!(f, "FILM_LIGHT"),
            Eac3DynamicRangeCompressionLine::FilmStandard => write!(f, "FILM_STANDARD"),
            Eac3DynamicRangeCompressionLine::MusicLight => write!(f, "MUSIC_LIGHT"),
