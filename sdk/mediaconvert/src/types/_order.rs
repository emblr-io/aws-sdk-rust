...
impl ::std::convert::From<&str> for Order {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Order::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Order {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Order::from(s))
    }
}
impl Order {
...
impl ::std::convert::AsRef<str> for Order {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
