...
/// When writing a match expression against `H264FramerateConversionAlgorithm`, it is important to ensure
...
///
/// ```text
/// # let h264framerateconversionalgorithm = unimplemented!();
/// match h264framerateconversionalgorithm {
///     H264FramerateConversionAlgorithm::DuplicateDrop => { /* ... */ },
///     H264FramerateConversionAlgorithm::Frameformer => { /* ... */ },
///     H264FramerateConversionAlgorithm::Interpolate => { /* ... */ },
///     H264FramerateConversionAlgorithm::MaintainFrameCount => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `h264framerateconversionalgorithm` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `H264FramerateConversionAlgorithm::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `H264FramerateConversionAlgorithm::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `H264FramerateConversionAlgorithm::NewFeature` is defined.
/// Specifically, when `h264framerateconversionalgorithm` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `H264FramerateConversionAlgorithm::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for H264FramerateConversionAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MAINTAIN_FRAME_COUNT" => H264FramerateConversionAlgorithm::MaintainFrameCount,
            other => H264FramerateConversionAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H264FramerateConversionAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H264FramerateConversionAlgorithm::from(s))
    }
}
impl H264FramerateConversionAlgorithm {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H264FramerateConversionAlgorithm::MaintainFrameCount => "MAINTAIN_FRAME_COUNT",
            H264FramerateConversionAlgorithm::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H264FramerateConversionAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for H264FramerateConversionAlgorithm {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            H264FramerateConversionAlgorithm::DuplicateDrop => write!(f, "DUPLICATE_DROP"),
