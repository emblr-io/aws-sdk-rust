...
/// When writing a match expression against `ProresInterlaceMode`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `proresinterlacemode` represents
...
/// version of SDK where the variant `ProresInterlaceMode::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ProresInterlaceMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProresInterlaceMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProresInterlaceMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProresInterlaceMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProresInterlaceMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
