...
impl ::std::convert::From<&str> for NoiseReducerFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NoiseReducerFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NoiseReducerFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NoiseReducerFilter::from(s))
    }
}
