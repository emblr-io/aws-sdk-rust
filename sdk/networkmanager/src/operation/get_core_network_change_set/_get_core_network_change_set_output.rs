...
impl ::aws_types::request_id::RequestId for GetCoreNetworkChangeSetOutput {
...
impl GetCoreNetworkChangeSetOutputBuilder {
    ...
    pub fn core_network_changes(mut self, input: crate::types::CoreNetworkChange) -> Self {
        ...
        v.push(input);
        self.core_network_changes = ::std::option::Option::Some(v);
        self
    }
    /// <p>Describes a core network changes.</p>
