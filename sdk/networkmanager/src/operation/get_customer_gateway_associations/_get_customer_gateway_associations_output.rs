...
impl ::aws_types::request_id::RequestId for GetCustomerGatewayAssociationsOutput {
...
impl GetCustomerGatewayAssociationsOutputBuilder {
    ...
    pub fn set_customer_gateway_associations(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::CustomerGatewayAssociation>>,
    ) -> Self {
