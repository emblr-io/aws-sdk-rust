...
impl ListCoreNetworksInputBuilder {
    /// <p>The maximum number of results to return.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_core_networks::ListCoreNetworksInput, ::aws_smithy_types::error::operation::BuildError> {
