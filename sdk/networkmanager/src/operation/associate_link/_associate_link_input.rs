...
impl AssociateLinkInput {
    /// Creates a new builder-style object to manufacture [`AssociateLinkInput`](crate::operation::associate_link::AssociateLinkInput).
    pub fn builder() -> crate::operation::associate_link::builders::AssociateLinkInputBuilder {
        crate::operation::associate_link::builders::AssociateLinkInputBuilder::default()
    }
}
