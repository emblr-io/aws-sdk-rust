...
impl ::std::convert::From<&str> for PeeringState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PeeringState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PeeringState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PeeringState::from(s))
    }
}
impl PeeringState {
...
impl ::std::convert::AsRef<str> for PeeringState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
