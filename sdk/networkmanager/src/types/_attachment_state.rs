...
impl ::std::convert::From<&str> for AttachmentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AttachmentState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttachmentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttachmentState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AttachmentState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
