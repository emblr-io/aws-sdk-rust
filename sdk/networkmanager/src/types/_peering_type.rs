...
impl ::std::convert::From<&str> for PeeringType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PeeringType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PeeringType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PeeringType::from(s))
    }
}
impl PeeringType {
...
impl ::std::convert::AsRef<str> for PeeringType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
