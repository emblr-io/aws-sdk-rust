...
impl ::std::convert::From<&str> for ConnectPeerState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectPeerState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectPeerState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectPeerState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectPeerState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
