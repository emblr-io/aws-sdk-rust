...
impl ::std::convert::From<&str> for LinkAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LinkAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LinkAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LinkAssociationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LinkAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
