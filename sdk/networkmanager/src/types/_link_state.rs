...
impl ::std::convert::From<&str> for LinkState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LinkState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LinkState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LinkState::from(s))
    }
}
impl LinkState {
...
impl ::std::convert::AsRef<str> for LinkState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
