...
impl ::std::convert::From<&str> for CoreNetworkState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CoreNetworkState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CoreNetworkState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CoreNetworkState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CoreNetworkState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
