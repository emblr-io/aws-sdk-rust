...
//! aws-sdk-computeoptimizer = "0.0.0-local"
...
//! offered by AWS Compute Optimizer. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Compute Optimizer.
...
/// For example, the [`DeleteRecommendationPreferences`](crate::operation::delete_recommendation_preferences) operation has
/// a [`Client::delete_recommendation_preferences`], function which returns a builder for that operation.
