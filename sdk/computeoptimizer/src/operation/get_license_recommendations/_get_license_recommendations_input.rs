...
pub struct GetLicenseRecommendationsInput {
...
impl GetLicenseRecommendationsInput {
    /// Creates a new builder-style object to manufacture [`GetLicenseRecommendationsInput`](crate::operation::get_license_recommendations::GetLicenseRecommendationsInput).
    pub fn builder() -> crate::operation::get_license_recommendations::builders::GetLicenseRecommendationsInputBuilder {
        crate::operation::get_license_recommendations::builders::GetLicenseRecommendationsInputBuilder::default()
    }
}

/// A builder for [`GetLicenseRecommendationsInput`](crate::operation::get_license_recommendations::GetLicenseRecommendationsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetLicenseRecommendationsInputBuilder {
...
impl GetLicenseRecommendationsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetLicenseRecommendationsInput`](crate::operation::get_license_recommendations::GetLicenseRecommendationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
