...
pub struct ExportRdsDatabaseRecommendationsInput {
    ...
    pub fields_to_export: ::std::option::Option<::std::vec::Vec<crate::types::ExportableRdsdbField>>,
...
impl ExportRdsDatabaseRecommendationsInput {
    ...
    pub fn fields_to_export(&self) -> &[crate::types::ExportableRdsdbField] {
...
impl ExportRdsDatabaseRecommendationsInput {
    /// Creates a new builder-style object to manufacture [`ExportRdsDatabaseRecommendationsInput`](crate::operation::export_rds_database_recommendations::ExportRdsDatabaseRecommendationsInput).
    pub fn builder() -> crate::operation::export_rds_database_recommendations::builders::ExportRdsDatabaseRecommendationsInputBuilder {
        crate::operation::export_rds_database_recommendations::builders::ExportRdsDatabaseRecommendationsInputBuilder::default()
    }
}
...
pub struct ExportRdsDatabaseRecommendationsInputBuilder {
    ...
    pub(crate) fields_to_export: ::std::option::Option<::std::vec::Vec<crate::types::ExportableRdsdbField>>,
...
impl ExportRdsDatabaseRecommendationsInputBuilder {
    ...
    ///
    /// <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    pub fn fields_to_export(mut self, input: crate::types::ExportableRdsdbField) -> Self {
    ...
    /// <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    pub fn set_fields_to_export(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ExportableRdsdbField>>) -> Self {
        self.fields_to_export = input;
        self
    }
    /// <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    pub fn get_fields_to_export(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ExportableRdsdbField>> {
    ...
    /// Consumes the builder and constructs a [`ExportRdsDatabaseRecommendationsInput`](crate::operation::export_rds_database_recommendations::ExportRdsDatabaseRecommendationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::export_rds_database_recommendations::ExportRdsDatabaseRecommendationsInput,
