...
pub struct ExportIdleRecommendationsInput {
    /// <p>The Amazon Web Services account IDs for the export idle resource recommendations.</p>
    ...
    pub fields_to_export: ::std::option::Option<::std::vec::Vec<crate::types::ExportableIdleField>>,
...
impl ExportIdleRecommendationsInput {
    /// <p>The Amazon Web Services account IDs for the export idle resource recommendations.</p>
    /// <p>If your account is the management account or the delegated administrator of an organization, use this parameter to specify the member account you want to export recommendations to.</p>
    /// <p>This parameter can't be specified together with the include member accounts parameter. The parameters are mutually exclusive.</p>
    /// <p>If this parameter or the include member accounts parameter is omitted, the recommendations for member accounts aren't included in the export.</p>
    ...
    pub fn fields_to_export(&self) -> &[crate::types::ExportableIdleField] {
...
impl ExportIdleRecommendationsInput {
    /// Creates a new builder-style object to manufacture [`ExportIdleRecommendationsInput`](crate::operation::export_idle_recommendations::ExportIdleRecommendationsInput).
    pub fn builder() -> crate::operation::export_idle_recommendations::builders::ExportIdleRecommendationsInputBuilder {
        crate::operation::export_idle_recommendations::builders::ExportIdleRecommendationsInputBuilder::default()
    }
}

/// A builder for [`ExportIdleRecommendationsInput`](crate::operation::export_idle_recommendations::ExportIdleRecommendationsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ExportIdleRecommendationsInputBuilder {
    pub(crate) account_ids: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    pub(crate) filters: ::std::option::Option<::std::vec::Vec<crate::types::IdleRecommendationFilter>>,
    pub(crate) fields_to_export: ::std::option::Option<::std::vec::Vec<crate::types::ExportableIdleField>>,
...
impl ExportIdleRecommendationsInputBuilder {
    ...
    ///
    /// <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    pub fn fields_to_export(mut self, input: crate::types::ExportableIdleField) -> Self {
    ...
    /// <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    pub fn set_fields_to_export(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ExportableIdleField>>) -> Self {
        self.fields_to_export = input;
        self
    }
    /// <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    pub fn get_fields_to_export(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ExportableIdleField>> {
    ...
    /// Consumes the builder and constructs a [`ExportIdleRecommendationsInput`](crate::operation::export_idle_recommendations::ExportIdleRecommendationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::export_idle_recommendations::ExportIdleRecommendationsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::export_idle_recommendations::ExportIdleRecommendationsInput {
