...
impl ::std::convert::From<&str> for Currency {
    fn from(s: &str) -> Self {
        match s {
            "CNY" => Currency::Cny,
            "USD" => Currency::Usd,
            other => Currency::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Currency {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Currency::from(s))
    }
}
impl Currency {
...
impl ::std::convert::AsRef<str> for Currency {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
