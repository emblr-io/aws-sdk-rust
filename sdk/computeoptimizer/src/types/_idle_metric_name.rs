...
/// When writing a match expression against `IdleMetricName`, it is important to ensure
...
///     IdleMetricName::EbsVolumeWriteIops => { /* ... */ },
...
/// }
/// ```
/// The above code demonstrates that when `idlemetricname` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `IdleMetricName::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `IdleMetricName::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `IdleMetricName::NewFeature` is defined.
/// Specifically, when `idlemetricname` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `IdleMetricName::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for IdleMetricName {
    fn from(s: &str) -> Self {
        match s {
            ...
            "EBSVolumeWriteIOPS" => IdleMetricName::EbsVolumeWriteIops,
...
impl ::std::str::FromStr for IdleMetricName {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IdleMetricName::from(s))
    }
}
impl IdleMetricName {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            IdleMetricName::EbsVolumeWriteIops => "EBSVolumeWriteIOPS",
...
impl ::std::convert::AsRef<str> for IdleMetricName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for IdleMetricName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            IdleMetricName::EbsVolumeWriteIops => write!(f, "EBSVolumeWriteIOPS"),
