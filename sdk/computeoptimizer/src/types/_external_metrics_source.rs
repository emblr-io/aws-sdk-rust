...
impl ::std::convert::From<&str> for ExternalMetricsSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExternalMetricsSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExternalMetricsSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExternalMetricsSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExternalMetricsSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
