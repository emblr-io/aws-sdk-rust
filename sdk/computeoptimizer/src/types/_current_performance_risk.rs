...
impl ::std::convert::From<&str> for CurrentPerformanceRisk {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CurrentPerformanceRisk::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CurrentPerformanceRisk {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CurrentPerformanceRisk::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CurrentPerformanceRisk {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
