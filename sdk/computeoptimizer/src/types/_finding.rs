...
impl ::std::convert::From<&str> for Finding {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Finding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Finding {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Finding::from(s))
    }
}
impl Finding {
...
impl ::std::convert::AsRef<str> for Finding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
