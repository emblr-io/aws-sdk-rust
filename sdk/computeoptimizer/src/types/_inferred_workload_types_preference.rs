...
impl ::std::convert::From<&str> for InferredWorkloadTypesPreference {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferredWorkloadTypesPreference::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferredWorkloadTypesPreference {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferredWorkloadTypesPreference::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferredWorkloadTypesPreference {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
