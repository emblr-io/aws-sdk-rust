...
impl ::std::convert::From<&str> for EcsServiceRecommendationFinding {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EcsServiceRecommendationFinding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EcsServiceRecommendationFinding {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EcsServiceRecommendationFinding::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EcsServiceRecommendationFinding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
