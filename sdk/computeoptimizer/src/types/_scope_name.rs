...
impl ::std::convert::From<&str> for ScopeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScopeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScopeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScopeName::from(s))
    }
}
impl ScopeName {
...
impl ::std::convert::AsRef<str> for ScopeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
