...
/// When writing a match expression against `IdleRecommendationResourceType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `idlerecommendationresourcetype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `IdleRecommendationResourceType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `IdleRecommendationResourceType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `IdleRecommendationResourceType::NewFeature` is defined.
/// Specifically, when `idlerecommendationresourcetype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `IdleRecommendationResourceType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum IdleRecommendationResourceType {
    #[allow(missing_docs)] // documentation missing in model
    AutoScalingGroup,
    #[allow(missing_docs)] // documentation missing in model
    EbsVolume,
...
impl ::std::convert::From<&str> for IdleRecommendationResourceType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for IdleRecommendationResourceType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IdleRecommendationResourceType::from(s))
    }
}
impl IdleRecommendationResourceType {
...
impl ::std::fmt::Display for IdleRecommendationResourceType {
