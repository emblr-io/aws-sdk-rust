...
impl ::std::convert::From<&str> for EcsServiceMetricName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EcsServiceMetricName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EcsServiceMetricName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EcsServiceMetricName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EcsServiceMetricName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
