...
impl RecommendationSourceBuilder {
    /// <p>The Amazon Resource Name (ARN) of the recommendation source.</p>
    pub fn recommendation_source_arn(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.recommendation_source_arn = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The Amazon Resource Name (ARN) of the recommendation source.</p>
    ...
    pub fn recommendation_source_type(mut self, input: crate::types::RecommendationSourceType) -> Self {
        self.recommendation_source_type = ::std::option::Option::Some(input);
        self
    }
    /// <p>The resource type of the recommendation source.</p>
    ...
    /// <p>The resource type of the recommendation source.</p>
    pub fn get_recommendation_source_type(&self) -> &::std::option::Option<crate::types::RecommendationSourceType> {
