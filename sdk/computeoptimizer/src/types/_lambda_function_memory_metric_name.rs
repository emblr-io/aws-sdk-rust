...
impl ::std::convert::From<&str> for LambdaFunctionMemoryMetricName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LambdaFunctionMemoryMetricName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LambdaFunctionMemoryMetricName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LambdaFunctionMemoryMetricName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LambdaFunctionMemoryMetricName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LambdaFunctionMemoryMetricName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            LambdaFunctionMemoryMetricName::Duration => write!(f, "Duration"),
            LambdaFunctionMemoryMetricName::Unknown(value) => write!(f, "{}", value),
        }
    }
}
