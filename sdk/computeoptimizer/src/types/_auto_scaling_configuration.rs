...
impl ::std::convert::From<&str> for AutoScalingConfiguration {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoScalingConfiguration::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoScalingConfiguration {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoScalingConfiguration::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoScalingConfiguration {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
