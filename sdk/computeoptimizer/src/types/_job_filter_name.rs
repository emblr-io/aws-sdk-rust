...
impl ::std::convert::From<&str> for JobFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobFilterName::from(s))
    }
}
impl JobFilterName {
...
impl ::std::convert::AsRef<str> for JobFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
