...
impl ::std::convert::From<&str> for EcsServiceRecommendationFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EcsServiceRecommendationFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EcsServiceRecommendationFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EcsServiceRecommendationFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EcsServiceRecommendationFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
