...
/// When writing a match expression against `RdsInstanceFindingReasonCode`, it is important to ensure
...
///
/// ```text
/// # let rdsinstancefindingreasoncode = unimplemented!();
...
///     RdsInstanceFindingReasonCode::NewGenerationDbInstanceClassAvailable => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `rdsinstancefindingreasoncode` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `RdsInstanceFindingReasonCode::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `RdsInstanceFindingReasonCode::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `RdsInstanceFindingReasonCode::NewFeature` is defined.
/// Specifically, when `rdsinstancefindingreasoncode` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RdsInstanceFindingReasonCode::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum RdsInstanceFindingReasonCode {
    #[allow(missing_docs)] // documentation missing in model
    CpuOverProvisioned,
    #[allow(missing_docs)] // documentation missing in model
    CpuUnderProvisioned,
...
impl ::std::convert::From<&str> for RdsInstanceFindingReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NewGenerationDBInstanceClassAvailable" => RdsInstanceFindingReasonCode::NewGenerationDbInstanceClassAvailable,
            other => RdsInstanceFindingReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RdsInstanceFindingReasonCode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RdsInstanceFindingReasonCode::from(s))
    }
}
impl RdsInstanceFindingReasonCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RdsInstanceFindingReasonCode::NewGenerationDbInstanceClassAvailable => "NewGenerationDBInstanceClassAvailable",
            RdsInstanceFindingReasonCode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for RdsInstanceFindingReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RdsInstanceFindingReasonCode {
