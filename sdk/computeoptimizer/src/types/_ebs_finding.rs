...
impl ::std::convert::From<&str> for EbsFinding {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EbsFinding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EbsFinding {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EbsFinding::from(s))
    }
}
impl EbsFinding {
...
impl ::std::convert::AsRef<str> for EbsFinding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
