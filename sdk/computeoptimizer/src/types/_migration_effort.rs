...
impl ::std::convert::From<&str> for MigrationEffort {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MigrationEffort::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MigrationEffort {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MigrationEffort::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MigrationEffort {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
