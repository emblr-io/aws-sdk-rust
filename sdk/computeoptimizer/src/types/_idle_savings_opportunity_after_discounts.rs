...
impl IdleSavingsOpportunityAfterDiscounts {
    /// <p>The estimated monthly savings possible as a percentage of monthly cost by adopting Compute Optimizer's idle resource recommendations. This includes any applicable discounts.</p>
...
impl IdleSavingsOpportunityAfterDiscounts {
    /// Creates a new builder-style object to manufacture [`IdleSavingsOpportunityAfterDiscounts`](crate::types::IdleSavingsOpportunityAfterDiscounts).
    pub fn builder() -> crate::types::builders::IdleSavingsOpportunityAfterDiscountsBuilder {
        crate::types::builders::IdleSavingsOpportunityAfterDiscountsBuilder::default()
    }
}

/// A builder for [`IdleSavingsOpportunityAfterDiscounts`](crate::types::IdleSavingsOpportunityAfterDiscounts).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct IdleSavingsOpportunityAfterDiscountsBuilder {
...
impl IdleSavingsOpportunityAfterDiscountsBuilder {
    /// <p>The estimated monthly savings possible as a percentage of monthly cost by adopting Compute Optimizer's idle resource recommendations. This includes any applicable discounts.</p>
    ...
    /// Consumes the builder and constructs a [`IdleSavingsOpportunityAfterDiscounts`](crate::types::IdleSavingsOpportunityAfterDiscounts).
    pub fn build(self) -> crate::types::IdleSavingsOpportunityAfterDiscounts {
        crate::types::IdleSavingsOpportunityAfterDiscounts {
