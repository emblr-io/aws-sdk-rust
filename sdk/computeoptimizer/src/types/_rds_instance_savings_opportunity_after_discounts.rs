...
pub struct RdsInstanceSavingsOpportunityAfterDiscounts {
    ...
    pub estimated_monthly_savings: ::std::option::Option<crate::types::RdsInstanceEstimatedMonthlySavings>,
}
impl RdsInstanceSavingsOpportunityAfterDiscounts {
    /// <p>The estimated monthly savings possible as a percentage of monthly cost by adopting Compute Optimizer’s DB instance recommendations. This includes any applicable Savings Plans discounts.</p>
    pub fn savings_opportunity_percentage(&self) -> f64 {
        self.savings_opportunity_percentage
    }
    /// <p>The estimated monthly savings possible by adopting Compute Optimizer’s DB instance recommendations. This includes any applicable Savings Plans discounts.</p>
    pub fn estimated_monthly_savings(&self) -> ::std::option::Option<&crate::types::RdsInstanceEstimatedMonthlySavings> {
        self.estimated_monthly_savings.as_ref()
    }
}
impl RdsInstanceSavingsOpportunityAfterDiscounts {
    /// Creates a new builder-style object to manufacture [`RdsInstanceSavingsOpportunityAfterDiscounts`](crate::types::RdsInstanceSavingsOpportunityAfterDiscounts).
    pub fn builder() -> crate::types::builders::RdsInstanceSavingsOpportunityAfterDiscountsBuilder {
        crate::types::builders::RdsInstanceSavingsOpportunityAfterDiscountsBuilder::default()
    }
}

/// A builder for [`RdsInstanceSavingsOpportunityAfterDiscounts`](crate::types::RdsInstanceSavingsOpportunityAfterDiscounts).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RdsInstanceSavingsOpportunityAfterDiscountsBuilder {
    pub(crate) savings_opportunity_percentage: ::std::option::Option<f64>,
    pub(crate) estimated_monthly_savings: ::std::option::Option<crate::types::RdsInstanceEstimatedMonthlySavings>,
}
impl RdsInstanceSavingsOpportunityAfterDiscountsBuilder {
    /// <p>The estimated monthly savings possible as a percentage of monthly cost by adopting Compute Optimizer’s DB instance recommendations. This includes any applicable Savings Plans discounts.</p>
    ...
    /// <p>The estimated monthly savings possible by adopting Compute Optimizer’s DB instance recommendations. This includes any applicable Savings Plans discounts.</p>
    pub fn estimated_monthly_savings(mut self, input: crate::types::RdsInstanceEstimatedMonthlySavings) -> Self {
        self.estimated_monthly_savings = ::std::option::Option::Some(input);
        self
    }
    /// <p>The estimated monthly savings possible by adopting Compute Optimizer’s DB instance recommendations. This includes any applicable Savings Plans discounts.</p>
    pub fn set_estimated_monthly_savings(mut self, input: ::std::option::Option<crate::types::RdsInstanceEstimatedMonthlySavings>) -> Self {
        self.estimated_monthly_savings = input;
        self
    }
    /// <p>The estimated monthly savings possible by adopting Compute Optimizer’s DB instance recommendations. This includes any applicable Savings Plans discounts.</p>
    pub fn get_estimated_monthly_savings(&self) -> &::std::option::Option<crate::types::RdsInstanceEstimatedMonthlySavings> {
        &self.estimated_monthly_savings
    }
    /// Consumes the builder and constructs a [`RdsInstanceSavingsOpportunityAfterDiscounts`](crate::types::RdsInstanceSavingsOpportunityAfterDiscounts).
    pub fn build(self) -> crate::types::RdsInstanceSavingsOpportunityAfterDiscounts {
        crate::types::RdsInstanceSavingsOpportunityAfterDiscounts {
