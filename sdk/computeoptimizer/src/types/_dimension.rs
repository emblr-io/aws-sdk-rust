...
impl ::std::convert::From<&str> for Dimension {
    fn from(s: &str) -> Self {
        match s {
            "SavingsValue" => Dimension::SavingsValue,
            "SavingsValueAfterDiscount" => Dimension::SavingsValueAfterDiscount,
...
impl Dimension {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Dimension::SavingsValue => "SavingsValue",
            Dimension::SavingsValueAfterDiscount => "SavingsValueAfterDiscount",
            Dimension::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["SavingsValue", "SavingsValueAfterDiscount"]
    }
}
