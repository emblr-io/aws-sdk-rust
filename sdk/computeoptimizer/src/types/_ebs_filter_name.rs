...
impl ::std::convert::From<&str> for EbsFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EbsFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EbsFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EbsFilterName::from(s))
    }
}
impl EbsFilterName {
...
impl ::std::convert::AsRef<str> for EbsFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
