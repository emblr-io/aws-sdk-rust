...
/// <p>Describes the savings opportunity for Amazon RDS storage recommendations after applying Savings Plans discounts.</p>
...
impl RdsStorageSavingsOpportunityAfterDiscounts {
    /// Creates a new builder-style object to manufacture [`RdsStorageSavingsOpportunityAfterDiscounts`](crate::types::RdsStorageSavingsOpportunityAfterDiscounts).
    pub fn builder() -> crate::types::builders::RdsStorageSavingsOpportunityAfterDiscountsBuilder {
        crate::types::builders::RdsStorageSavingsOpportunityAfterDiscountsBuilder::default()
    }
}

/// A builder for [`RdsStorageSavingsOpportunityAfterDiscounts`](crate::types::RdsStorageSavingsOpportunityAfterDiscounts).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RdsStorageSavingsOpportunityAfterDiscountsBuilder {
...
impl RdsStorageSavingsOpportunityAfterDiscountsBuilder {
    ...
    /// Consumes the builder and constructs a [`RdsStorageSavingsOpportunityAfterDiscounts`](crate::types::RdsStorageSavingsOpportunityAfterDiscounts).
    pub fn build(self) -> crate::types::RdsStorageSavingsOpportunityAfterDiscounts {
        crate::types::RdsStorageSavingsOpportunityAfterDiscounts {
