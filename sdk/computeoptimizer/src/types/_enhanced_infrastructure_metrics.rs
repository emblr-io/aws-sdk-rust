...
impl ::std::convert::From<&str> for EnhancedInfrastructureMetrics {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnhancedInfrastructureMetrics::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnhancedInfrastructureMetrics {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnhancedInfrastructureMetrics::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EnhancedInfrastructureMetrics {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
