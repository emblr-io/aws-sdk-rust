...
impl ::std::convert::From<&str> for InferredWorkloadType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferredWorkloadType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferredWorkloadType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferredWorkloadType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferredWorkloadType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
