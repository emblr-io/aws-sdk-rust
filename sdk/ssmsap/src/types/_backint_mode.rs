...
impl ::std::convert::From<&str> for BackintMode {
    fn from(s: &str) -> Self {
        match s {
            "AWSBackup" => BackintMode::AwsBackup,
            other => BackintMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BackintMode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BackintMode::from(s))
    }
}
impl BackintMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            BackintMode::AwsBackup => "AWSBackup",
            BackintMode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for BackintMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
