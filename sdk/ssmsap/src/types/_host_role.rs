...
impl ::std::convert::From<&str> for HostRole {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HostRole::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HostRole {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HostRole::from(s))
    }
}
impl HostRole {
...
impl ::std::convert::AsRef<str> for HostRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
