...
///     AllocationType::ElasticIp => { /* ... */ },
///     AllocationType::Overlay => { /* ... */ },
///     AllocationType::UnknownValue => { /* ... */ },
///     AllocationType::VpcSubnet => { /* ... */ },
...
///
///
/// _Note: `AllocationType::Unknown` has been renamed to `::UnknownValue`._
#[non_exhaustive]
...
impl ::std::convert::From<&str> for AllocationType {
    fn from(s: &str) -> Self {
        match s {
            "ELASTIC_IP" => AllocationType::ElasticIp,
            "OVERLAY" => AllocationType::Overlay,
            "UNKNOWN" => AllocationType::UnknownValue,
            "VPC_SUBNET" => AllocationType::VpcSubnet,
...
impl ::std::str::FromStr for AllocationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllocationType::from(s))
    }
}
impl AllocationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AllocationType::ElasticIp => "ELASTIC_IP",
            AllocationType::Overlay => "OVERLAY",
            AllocationType::UnknownValue => "UNKNOWN",
            AllocationType::VpcSubnet => "VPC_SUBNET",
            AllocationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ELASTIC_IP", "OVERLAY", "UNKNOWN", "VPC_SUBNET"]
    }
}
