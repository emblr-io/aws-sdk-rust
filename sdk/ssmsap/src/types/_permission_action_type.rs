...
impl ::std::convert::From<&str> for PermissionActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PermissionActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PermissionActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PermissionActionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PermissionActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
