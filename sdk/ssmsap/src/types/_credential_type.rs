...
impl ::std::convert::From<&str> for CredentialType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CredentialType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CredentialType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CredentialType::from(s))
    }
}
impl CredentialType {
...
impl ::std::convert::AsRef<str> for CredentialType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CredentialType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            CredentialType::Admin => write!(f, "ADMIN"),
            CredentialType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
