...
impl ::std::convert::From<&str> for ConnectedEntityType {
    fn from(s: &str) -> Self {
        match s {
            "DBMS" => ConnectedEntityType::Dbms,
            other => ConnectedEntityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectedEntityType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectedEntityType::from(s))
    }
}
impl ConnectedEntityType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConnectedEntityType::Dbms => "DBMS",
            ConnectedEntityType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ConnectedEntityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ConnectedEntityType {
