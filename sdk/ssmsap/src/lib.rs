...
//! offered by AWS Systems Manager for SAP. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Systems Manager for SAP.
...
/// For example, the [`DeleteResourcePermission`](crate::operation::delete_resource_permission) operation has
...
/// Configuration for AWS Systems Manager for SAP.
pub mod config;
