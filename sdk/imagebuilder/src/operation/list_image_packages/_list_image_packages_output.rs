...
impl ListImagePackagesOutput {
    ...
    /// <p>The list of Image Packages returned in the response.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.image_package_list.is_none()`.
    pub fn image_package_list(&self) -> &[crate::types::ImagePackage] {
        self.image_package_list.as_deref().unwrap_or_default()
    }
    /// <p>The next token used for paginated responses. When this field isn't empty, there are additional elements that the service hasn't included in this request. Use this token with the next request to retrieve additional objects.</p>
...
impl ::aws_types::request_id::RequestId for ListImagePackagesOutput {
...
impl ListImagePackagesOutputBuilder {
    ...
    pub fn image_package_list(mut self, input: crate::types::ImagePackage) -> Self {
        ...
        v.push(input);
        self.image_package_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>The list of Image Packages returned in the response.</p>
