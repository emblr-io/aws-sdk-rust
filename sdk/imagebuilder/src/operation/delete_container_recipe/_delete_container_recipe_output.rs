...
impl ::aws_types::request_id::RequestId for DeleteContainerRecipeOutput {
...
impl DeleteContainerRecipeOutputBuilder {
    /// <p>The request ID that uniquely identifies this request.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteContainerRecipeOutput`](crate::operation::delete_container_recipe::DeleteContainerRecipeOutput).
    pub fn build(self) -> crate::operation::delete_container_recipe::DeleteContainerRecipeOutput {
