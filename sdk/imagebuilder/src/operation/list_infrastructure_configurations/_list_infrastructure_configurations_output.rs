...
impl ListInfrastructureConfigurationsOutput {
    ...
    pub fn infrastructure_configuration_summary_list(&self) -> &[crate::types::InfrastructureConfigurationSummary] {
        self.infrastructure_configuration_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>The next token used for paginated responses. When this field isn't empty, there are additional elements that the service hasn't included in this request. Use this token with the next request to retrieve additional objects.</p>
...
impl ::aws_types::request_id::RequestId for ListInfrastructureConfigurationsOutput {
...
impl ListInfrastructureConfigurationsOutputBuilder {
    ...
    pub fn infrastructure_configuration_summary_list(mut self, input: crate::types::InfrastructureConfigurationSummary) -> Self {
        ...
        v.push(input);
        self.infrastructure_configuration_summary_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>The list of infrastructure configurations.</p>
