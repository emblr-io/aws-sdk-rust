...
//! offered by EC2 Image Builder. The return value of each of these methods is a "fluent builder",
...
/// Client for calling EC2 Image Builder.
...
/// Configuration for EC2 Image Builder.
pub mod config;
