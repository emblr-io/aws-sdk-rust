...
impl ImageScanFindingsFilter {
    /// Creates a new builder-style object to manufacture [`ImageScanFindingsFilter`](crate::types::ImageScanFindingsFilter).
    pub fn builder() -> crate::types::builders::ImageScanFindingsFilterBuilder {
        crate::types::builders::ImageScanFindingsFilterBuilder::default()
    }
}

/// A builder for [`ImageScanFindingsFilter`](crate::types::ImageScanFindingsFilter).
