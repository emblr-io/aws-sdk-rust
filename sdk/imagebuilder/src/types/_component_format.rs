...
impl ::std::convert::From<&str> for ComponentFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComponentFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ComponentFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ComponentFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ComponentFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
