...
impl ::std::convert::From<&str> for ImageSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageSource::from(s))
    }
}
impl ImageSource {
...
impl ::std::convert::AsRef<str> for ImageSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
