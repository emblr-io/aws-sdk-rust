...
impl ::std::convert::From<&str> for WorkflowStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkflowStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkflowStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkflowStatus::from(s))
    }
}
impl WorkflowStatus {
...
impl ::std::fmt::Display for WorkflowStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            WorkflowStatus::Deprecated => write!(f, "DEPRECATED"),
