...
/// When writing a match expression against `LifecycleExecutionStatus`, it is important to ensure
...
///
/// ```text
/// # let lifecycleexecutionstatus = unimplemented!();
/// match lifecycleexecutionstatus {
...
/// }
/// ```
/// The above code demonstrates that when `lifecycleexecutionstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `LifecycleExecutionStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `LifecycleExecutionStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `LifecycleExecutionStatus::NewFeature` is defined.
/// Specifically, when `lifecycleexecutionstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `LifecycleExecutionStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for LifecycleExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for LifecycleExecutionStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LifecycleExecutionStatus::from(s))
    }
}
impl LifecycleExecutionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            LifecycleExecutionStatus::Cancelled => "CANCELLED",
