...
impl ::std::convert::From<&str> for EbsVolumeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EbsVolumeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EbsVolumeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EbsVolumeType::from(s))
    }
}
impl EbsVolumeType {
...
impl ::std::convert::AsRef<str> for EbsVolumeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
