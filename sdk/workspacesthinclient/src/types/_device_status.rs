...
impl ::std::convert::From<&str> for DeviceStatus {
    fn from(s: &str) -> Self {
        match s {
            "ARCHIVED" => DeviceStatus::Archived,
            "DEREGISTERED" => DeviceStatus::Deregistered,
            "DEREGISTERING" => DeviceStatus::Deregistering,
            "REGISTERED" => DeviceStatus::Registered,
            other => DeviceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceStatus::from(s))
    }
}
impl DeviceStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DeviceStatus::Deregistering => "DEREGISTERING",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ARCHIVED", "DEREGISTERED", "DEREGISTERING", "REGISTERED"]
    }
}
impl ::std::convert::AsRef<str> for DeviceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DeviceStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DeviceStatus::Archived => write!(f, "ARCHIVED"),
