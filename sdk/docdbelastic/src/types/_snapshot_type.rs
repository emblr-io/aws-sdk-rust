...
impl ::std::convert::From<&str> for SnapshotType {
    fn from(s: &str) -> Self {
        match s {
            "AUTOMATED" => SnapshotType::Automated,
            "MANUAL" => SnapshotType::Manual,
            other => SnapshotType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnapshotType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnapshotType::from(s))
    }
}
impl SnapshotType {
