...
impl ::std::convert::From<&str> for Auth {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Auth::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Auth {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Auth::from(s))
    }
}
impl Auth {
...
impl ::std::convert::AsRef<str> for Auth {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
