...
impl ::std::convert::From<&str> for FeedbackValueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeedbackValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeedbackValueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeedbackValueType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FeedbackValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
