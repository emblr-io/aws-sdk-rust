...
impl ::std::convert::From<&str> for EventResponseType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventResponseType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventResponseType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventResponseType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventResponseType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
