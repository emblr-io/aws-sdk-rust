...
impl ::std::convert::From<&str> for AttributeDataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AttributeDataType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttributeDataType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttributeDataType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AttributeDataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
