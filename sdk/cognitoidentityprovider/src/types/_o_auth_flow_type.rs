...
impl ::std::convert::From<&str> for OAuthFlowType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OAuthFlowType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OAuthFlowType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OAuthFlowType::from(s))
    }
}
impl OAuthFlowType {
...
impl ::std::convert::AsRef<str> for OAuthFlowType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
