...
impl ::std::convert::From<&str> for ChallengeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChallengeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChallengeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChallengeName::from(s))
    }
}
impl ChallengeName {
...
impl ::std::convert::AsRef<str> for ChallengeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
