...
impl ::std::convert::From<&str> for EventFilterType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventFilterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventFilterType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventFilterType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventFilterType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
