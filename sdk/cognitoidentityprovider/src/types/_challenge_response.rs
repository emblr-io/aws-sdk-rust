...
impl ::std::convert::From<&str> for ChallengeResponse {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChallengeResponse::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChallengeResponse {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChallengeResponse::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChallengeResponse {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
