...
impl ::std::convert::From<&str> for MessageActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MessageActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MessageActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MessageActionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MessageActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MessageActionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            MessageActionType::Resend => write!(f, "RESEND"),
            MessageActionType::Suppress => write!(f, "SUPPRESS"),
            MessageActionType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
