...
impl ::std::convert::From<&str> for DomainStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DomainStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DomainStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DomainStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DomainStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
