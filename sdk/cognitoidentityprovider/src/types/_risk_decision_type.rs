...
impl ::std::convert::From<&str> for RiskDecisionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RiskDecisionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RiskDecisionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RiskDecisionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RiskDecisionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
