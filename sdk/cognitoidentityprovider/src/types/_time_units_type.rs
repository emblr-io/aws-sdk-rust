...
impl ::std::convert::From<&str> for TimeUnitsType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimeUnitsType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimeUnitsType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimeUnitsType::from(s))
    }
}
impl TimeUnitsType {
...
impl ::std::convert::AsRef<str> for TimeUnitsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
