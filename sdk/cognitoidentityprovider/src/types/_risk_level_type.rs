...
impl ::std::convert::From<&str> for RiskLevelType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RiskLevelType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RiskLevelType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RiskLevelType::from(s))
    }
}
impl RiskLevelType {
...
impl ::std::convert::AsRef<str> for RiskLevelType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
