...
impl ::aws_types::request_id::RequestId for DeleteBackendAuthOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteBackendAuthOutput {
    /// Creates a new builder-style object to manufacture [`DeleteBackendAuthOutput`](crate::operation::delete_backend_auth::DeleteBackendAuthOutput).
    pub fn builder() -> crate::operation::delete_backend_auth::builders::DeleteBackendAuthOutputBuilder {
        crate::operation::delete_backend_auth::builders::DeleteBackendAuthOutputBuilder::default()
    }
}

/// A builder for [`DeleteBackendAuthOutput`](crate::operation::delete_backend_auth::DeleteBackendAuthOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteBackendAuthOutputBuilder {
...
impl DeleteBackendAuthOutputBuilder {
    /// <p>The app ID.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteBackendAuthOutput`](crate::operation::delete_backend_auth::DeleteBackendAuthOutput).
    pub fn build(self) -> crate::operation::delete_backend_auth::DeleteBackendAuthOutput {
