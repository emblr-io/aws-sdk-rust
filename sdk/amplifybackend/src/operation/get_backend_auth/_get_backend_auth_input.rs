...
impl GetBackendAuthInput {
    /// Creates a new builder-style object to manufacture [`GetBackendAuthInput`](crate::operation::get_backend_auth::GetBackendAuthInput).
    pub fn builder() -> crate::operation::get_backend_auth::builders::GetBackendAuthInputBuilder {
        crate::operation::get_backend_auth::builders::GetBackendAuthInputBuilder::default()
    }
}

/// A builder for [`GetBackendAuthInput`](crate::operation::get_backend_auth::GetBackendAuthInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetBackendAuthInputBuilder {
...
impl GetBackendAuthInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_backend_auth::GetBackendAuthInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_backend_auth::GetBackendAuthInput {
            app_id: self.app_id,
