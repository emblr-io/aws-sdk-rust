...
impl ::aws_types::request_id::RequestId for DeleteBackendOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteBackendOutput {
    /// Creates a new builder-style object to manufacture [`DeleteBackendOutput`](crate::operation::delete_backend::DeleteBackendOutput).
    pub fn builder() -> crate::operation::delete_backend::builders::DeleteBackendOutputBuilder {
        crate::operation::delete_backend::builders::DeleteBackendOutputBuilder::default()
    }
}

/// A builder for [`DeleteBackendOutput`](crate::operation::delete_backend::DeleteBackendOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteBackendOutputBuilder {
...
impl DeleteBackendOutputBuilder {
    /// <p>The app ID.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteBackendOutput`](crate::operation::delete_backend::DeleteBackendOutput).
    pub fn build(self) -> crate::operation::delete_backend::DeleteBackendOutput {
        crate::operation::delete_backend::DeleteBackendOutput {
            app_id: self.app_id,
