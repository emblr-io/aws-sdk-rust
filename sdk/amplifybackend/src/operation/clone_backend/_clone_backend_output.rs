...
impl ::aws_types::request_id::RequestId for CloneBackendOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CloneBackendOutput {
    /// Creates a new builder-style object to manufacture [`CloneBackendOutput`](crate::operation::clone_backend::CloneBackendOutput).
    pub fn builder() -> crate::operation::clone_backend::builders::CloneBackendOutputBuilder {
        crate::operation::clone_backend::builders::CloneBackendOutputBuilder::default()
    }
}

/// A builder for [`CloneBackendOutput`](crate::operation::clone_backend::CloneBackendOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CloneBackendOutputBuilder {
...
impl CloneBackendOutputBuilder {
    /// <p>The app ID.</p>
    ...
    /// Consumes the builder and constructs a [`CloneBackendOutput`](crate::operation::clone_backend::CloneBackendOutput).
    pub fn build(self) -> crate::operation::clone_backend::CloneBackendOutput {
