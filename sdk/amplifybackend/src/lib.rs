...
//! aws-sdk-amplifybackend = "0.0.0-local"
...
//! offered by AmplifyBackend. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AmplifyBackend.
...
/// For example, the [`CloneBackend`](crate::operation::clone_backend) operation has
...
/// Configuration for AmplifyBackend.
pub mod config;
