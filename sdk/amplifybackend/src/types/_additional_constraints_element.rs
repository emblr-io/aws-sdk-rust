...
impl ::std::convert::From<&str> for AdditionalConstraintsElement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AdditionalConstraintsElement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AdditionalConstraintsElement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AdditionalConstraintsElement::from(s))
    }
}
