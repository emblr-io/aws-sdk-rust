...
impl ::std::convert::From<&str> for UnAuthenticatedElement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnAuthenticatedElement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnAuthenticatedElement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnAuthenticatedElement::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UnAuthenticatedElement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
