...
impl ::std::convert::From<&str> for DeliveryMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeliveryMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeliveryMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeliveryMethod::from(s))
    }
}
impl DeliveryMethod {
...
impl ::std::convert::AsRef<str> for DeliveryMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
