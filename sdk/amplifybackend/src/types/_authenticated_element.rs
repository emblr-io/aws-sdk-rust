...
impl ::std::convert::From<&str> for AuthenticatedElement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthenticatedElement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthenticatedElement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthenticatedElement::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthenticatedElement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
