...
impl ListServiceDependentsInput {
    /// <p>The start of the time period to retrieve information about. When used in a raw HTTP Query API, it is formatted as be epoch time in seconds. For example: <code>1698778057</code></p>
    /// <p>Your requested start time will be rounded to the nearest hour.</p>
...
impl ListServiceDependentsInput {
    /// Creates a new builder-style object to manufacture [`ListServiceDependentsInput`](crate::operation::list_service_dependents::ListServiceDependentsInput).
    pub fn builder() -> crate::operation::list_service_dependents::builders::ListServiceDependentsInputBuilder {
        crate::operation::list_service_dependents::builders::ListServiceDependentsInputBuilder::default()
    }
}

/// A builder for [`ListServiceDependentsInput`](crate::operation::list_service_dependents::ListServiceDependentsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListServiceDependentsInputBuilder {
...
impl ListServiceDependentsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListServiceDependentsInput`](crate::operation::list_service_dependents::ListServiceDependentsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_service_dependents::ListServiceDependentsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_service_dependents::ListServiceDependentsInput {
