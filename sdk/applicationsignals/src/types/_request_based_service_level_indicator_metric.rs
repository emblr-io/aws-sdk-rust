...
impl RequestBasedServiceLevelIndicatorMetric {
    ...
    pub fn total_request_count_metric(&self) -> &[crate::types::MetricDataQuery] {
        use std::ops::Deref;
        self.total_request_count_metric.deref()
    }
    /// <p>This structure defines the metric that is used as the "good request" or "bad request" value for a request-based SLO. This value observed for the metric defined in <code>TotalRequestCountMetric</code> is divided by the number found for <code>MonitoredRequestCountMetric</code> to determine the percentage of successful requests that this SLO tracks.</p>
...
impl RequestBasedServiceLevelIndicatorMetric {
    ...
    pub fn builder() -> crate::types::builders::RequestBasedServiceLevelIndicatorMetricBuilder {
        crate::types::builders::RequestBasedServiceLevelIndicatorMetricBuilder::default()
    }
}

/// A builder for [`RequestBasedServiceLevelIndicatorMetric`](crate::types::RequestBasedServiceLevelIndicatorMetric).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RequestBasedServiceLevelIndicatorMetricBuilder {
...
impl RequestBasedServiceLevelIndicatorMetricBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::RequestBasedServiceLevelIndicatorMetric, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RequestBasedServiceLevelIndicatorMetric {
            key_attributes: self.key_attributes,
            operation_name: self.operation_name,
            metric_type: self.metric_type,
            total_request_count_metric: self.total_request_count_metric.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "total_request_count_metric",
                    "total_request_count_metric was not specified but it is required when building RequestBasedServiceLevelIndicatorMetric",
                )
            })?,
