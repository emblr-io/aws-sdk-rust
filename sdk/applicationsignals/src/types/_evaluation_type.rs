...
impl ::std::convert::From<&str> for EvaluationType {
    fn from(s: &str) -> Self {
        match s {
            "PeriodBased" => EvaluationType::PeriodBased,
            "RequestBased" => EvaluationType::RequestBased,
            other => EvaluationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EvaluationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EvaluationType::from(s))
    }
}
impl EvaluationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EvaluationType::PeriodBased => "PeriodBased",
            EvaluationType::RequestBased => "RequestBased",
...
impl ::std::convert::AsRef<str> for EvaluationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
