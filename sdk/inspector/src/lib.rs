...
//! offered by Amazon Inspector. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Inspector.
...
/// For example, the [`CreateAssessmentTarget`](crate::operation::create_assessment_target) operation has
...
/// Configuration for Amazon Inspector.
pub mod config;
