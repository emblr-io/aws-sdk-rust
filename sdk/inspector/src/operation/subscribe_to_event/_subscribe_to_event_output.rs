...
impl SubscribeToEventOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`SubscribeToEventOutput`](crate::operation::subscribe_to_event::SubscribeToEventOutput).
    pub fn build(self) -> crate::operation::subscribe_to_event::SubscribeToEventOutput {
