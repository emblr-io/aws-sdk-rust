...
impl ::std::convert::From<&str> for AgentHealthCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AgentHealthCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AgentHealthCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AgentHealthCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AgentHealthCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
