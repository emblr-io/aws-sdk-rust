...
impl ::std::convert::From<&str> for PreviewStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PreviewStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PreviewStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PreviewStatus::from(s))
    }
}
impl PreviewStatus {
...
impl ::std::convert::AsRef<str> for PreviewStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
