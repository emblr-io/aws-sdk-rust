...
impl ::std::convert::From<&str> for InvalidCrossAccountRoleErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InvalidCrossAccountRoleErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InvalidCrossAccountRoleErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InvalidCrossAccountRoleErrorCode::from(s))
    }
}
