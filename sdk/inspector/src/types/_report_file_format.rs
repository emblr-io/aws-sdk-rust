...
impl ::std::convert::From<&str> for ReportFileFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportFileFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportFileFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportFileFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportFileFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
