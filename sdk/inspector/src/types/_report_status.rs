...
impl ::std::convert::From<&str> for ReportStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportStatus::from(s))
    }
}
impl ReportStatus {
...
impl ::std::convert::AsRef<str> for ReportStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
