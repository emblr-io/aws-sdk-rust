...
impl ::std::convert::From<&str> for AssessmentRunNotificationSnsStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssessmentRunNotificationSnsStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssessmentRunNotificationSnsStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssessmentRunNotificationSnsStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssessmentRunNotificationSnsStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
