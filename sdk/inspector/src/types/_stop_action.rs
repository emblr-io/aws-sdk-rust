...
impl ::std::convert::From<&str> for StopAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StopAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StopAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StopAction::from(s))
    }
}
impl StopAction {
...
impl ::std::convert::AsRef<str> for StopAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
