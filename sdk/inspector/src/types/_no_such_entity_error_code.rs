...
impl ::std::convert::From<&str> for NoSuchEntityErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NoSuchEntityErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NoSuchEntityErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NoSuchEntityErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NoSuchEntityErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
