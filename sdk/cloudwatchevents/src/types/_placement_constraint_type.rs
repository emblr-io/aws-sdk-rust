...
impl ::std::convert::From<&str> for PlacementConstraintType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlacementConstraintType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlacementConstraintType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlacementConstraintType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PlacementConstraintType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
