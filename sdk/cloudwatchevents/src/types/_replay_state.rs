...
impl ::std::convert::From<&str> for ReplayState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplayState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplayState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplayState::from(s))
    }
}
impl ReplayState {
...
impl ::std::convert::AsRef<str> for ReplayState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
