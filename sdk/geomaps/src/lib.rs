...
//! offered by Amazon Location Service Maps V2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Location Service Maps V2.
...
/// For example, the [`GetGlyphs`](crate::operation::get_glyphs) operation has
/// a [`Client::get_glyphs`], function which returns a builder for that operation.
...
/// Configuration for Amazon Location Service Maps V2.
pub mod config;
