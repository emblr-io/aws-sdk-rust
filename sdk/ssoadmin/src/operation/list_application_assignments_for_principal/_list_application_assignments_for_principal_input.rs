...
pub struct ListApplicationAssignmentsForPrincipalInput {
    ...
    pub filter: ::std::option::Option<crate::types::ListApplicationAssignmentsFilter>,
...
impl ListApplicationAssignmentsForPrincipalInput {
    /// Creates a new builder-style object to manufacture [`ListApplicationAssignmentsForPrincipalInput`](crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipalInput).
    pub fn builder() -> crate::operation::list_application_assignments_for_principal::builders::ListApplicationAssignmentsForPrincipalInputBuilder {
        crate::operation::list_application_assignments_for_principal::builders::ListApplicationAssignmentsForPrincipalInputBuilder::default()
    }
}

/// A builder for [`ListApplicationAssignmentsForPrincipalInput`](crate::operation::list_application_assignments_for_principal::ListApplicationAssignmentsForPrincipalInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListApplicationAssignmentsForPrincipalInputBuilder {
    pub(crate) instance_arn: ::std::option::Option<::std::string::String>,
    pub(crate) principal_id: ::std::option::Option<::std::string::String>,
    pub(crate) principal_type: ::std::option::Option<crate::types::PrincipalType>,
    pub(crate) filter: ::std::option::Option<crate::types::ListApplicationAssignmentsFilter>,
