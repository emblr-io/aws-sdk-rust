...
impl ::aws_types::request_id::RequestId for DeleteInstanceAccessControlAttributeConfigurationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteInstanceAccessControlAttributeConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`DeleteInstanceAccessControlAttributeConfigurationOutput`](crate::operation::delete_instance_access_control_attribute_configuration::DeleteInstanceAccessControlAttributeConfigurationOutput).
    pub fn builder() -> crate::operation::delete_instance_access_control_attribute_configuration::builders::DeleteInstanceAccessControlAttributeConfigurationOutputBuilder{
        crate::operation::delete_instance_access_control_attribute_configuration::builders::DeleteInstanceAccessControlAttributeConfigurationOutputBuilder::default()
    }
}
...
impl DeleteInstanceAccessControlAttributeConfigurationOutputBuilder {
