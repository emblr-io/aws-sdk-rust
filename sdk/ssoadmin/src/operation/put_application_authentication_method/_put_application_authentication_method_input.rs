...
impl PutApplicationAuthenticationMethodInput {
    /// Creates a new builder-style object to manufacture [`PutApplicationAuthenticationMethodInput`](crate::operation::put_application_authentication_method::PutApplicationAuthenticationMethodInput).
    pub fn builder() -> crate::operation::put_application_authentication_method::builders::PutApplicationAuthenticationMethodInputBuilder {
        crate::operation::put_application_authentication_method::builders::PutApplicationAuthenticationMethodInputBuilder::default()
    }
}
