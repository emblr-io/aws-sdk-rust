...
impl ::std::convert::From<&str> for FederationProtocol {
    fn from(s: &str) -> Self {
        match s {
            "OAUTH" => FederationProtocol::Oauth,
            "SAML" => FederationProtocol::Saml,
            other => FederationProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FederationProtocol {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FederationProtocol::from(s))
    }
}
impl FederationProtocol {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            FederationProtocol::Oauth => "OAUTH",
            FederationProtocol::Saml => "SAML",
            FederationProtocol::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for FederationProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
