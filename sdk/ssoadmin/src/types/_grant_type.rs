...
impl ::std::convert::From<&str> for GrantType {
    fn from(s: &str) -> Self {
        match s {
            "authorization_code" => GrantType::AuthorizationCode,
            "refresh_token" => GrantType::RefreshToken,
            "urn:ietf:params:oauth:grant-type:jwt-bearer" => GrantType::JwtBearer,
            "urn:ietf:params:oauth:grant-type:token-exchange" => GrantType::TokenExchange,
            other => GrantType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GrantType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GrantType::from(s))
    }
}
impl GrantType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            GrantType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for GrantType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
