...
impl ::std::convert::From<&str> for ProvisionTargetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisionTargetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisionTargetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisionTargetType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProvisionTargetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
