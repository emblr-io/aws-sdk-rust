...
impl ::std::convert::From<&str> for InstanceAccessControlAttributeConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceAccessControlAttributeConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::str::FromStr for InstanceAccessControlAttributeConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceAccessControlAttributeConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceAccessControlAttributeConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
