...
impl ::std::convert::From<&str> for StatusValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatusValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatusValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatusValues::from(s))
    }
}
impl StatusValues {
...
impl ::std::convert::AsRef<str> for StatusValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for StatusValues {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            StatusValues::Failed => write!(f, "FAILED"),
            StatusValues::InProgress => write!(f, "IN_PROGRESS"),
            StatusValues::Succeeded => write!(f, "SUCCEEDED"),
            StatusValues::Unknown(value) => write!(f, "{}", value),
        }
    }
}
