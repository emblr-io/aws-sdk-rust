...
//! aws-sdk-greengrassv2 = "0.0.0-local"
...
//! offered by AWS IoT Greengrass V2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT Greengrass V2.
...
/// For example, the [`AssociateServiceRoleToAccount`](crate::operation::associate_service_role_to_account) operation has
/// a [`Client::associate_service_role_to_account`], function which returns a builder for that operation.
