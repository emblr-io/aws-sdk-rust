...
impl ::std::convert::From<&str> for EffectiveDeploymentExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EffectiveDeploymentExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EffectiveDeploymentExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EffectiveDeploymentExecutionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EffectiveDeploymentExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
