...
impl ::std::convert::From<&str> for RecipeOutputFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecipeOutputFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecipeOutputFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecipeOutputFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecipeOutputFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
