...
impl ::std::convert::From<&str> for CoreDeviceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CoreDeviceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CoreDeviceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CoreDeviceStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CoreDeviceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
