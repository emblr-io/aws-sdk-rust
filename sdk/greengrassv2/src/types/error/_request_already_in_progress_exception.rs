...
impl ::aws_types::request_id::RequestId for crate::types::error::RequestAlreadyInProgressException {
...
impl RequestAlreadyInProgressException {
    ...
    pub fn builder() -> crate::types::error::builders::RequestAlreadyInProgressExceptionBuilder {
        crate::types::error::builders::RequestAlreadyInProgressExceptionBuilder::default()
    }
}

/// A builder for [`RequestAlreadyInProgressException`](crate::types::error::RequestAlreadyInProgressException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RequestAlreadyInProgressExceptionBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl RequestAlreadyInProgressExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
