...
///     VendorGuidance::Deleted => { /* ... */ },
///     VendorGuidance::Discontinued => { /* ... */ },
...
impl ::std::convert::From<&str> for VendorGuidance {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VendorGuidance::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VendorGuidance {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VendorGuidance::from(s))
    }
}
impl VendorGuidance {
...
impl ::std::convert::AsRef<str> for VendorGuidance {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
