...
impl ::std::convert::From<&str> for IoTJobExecutionFailureType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IoTJobExecutionFailureType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IoTJobExecutionFailureType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IoTJobExecutionFailureType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IoTJobExecutionFailureType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
