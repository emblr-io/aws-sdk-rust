...
impl ::std::convert::From<&str> for ContainerLevelMetrics {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContainerLevelMetrics::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContainerLevelMetrics {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContainerLevelMetrics::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContainerLevelMetrics {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
