...
impl ::std::convert::From<&str> for ExportDataFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportDataFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportDataFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportDataFormat::from(s))
    }
}
...
impl ::std::fmt::Display for ExportDataFormat {
