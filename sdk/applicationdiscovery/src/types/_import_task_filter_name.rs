...
impl ::std::convert::From<&str> for ImportTaskFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImportTaskFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImportTaskFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImportTaskFilterName::from(s))
    }
}
