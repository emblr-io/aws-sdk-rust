...
impl ::std::convert::From<&str> for Tenancy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Tenancy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Tenancy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Tenancy::from(s))
    }
}
impl Tenancy {
...
impl ::std::convert::AsRef<str> for Tenancy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
