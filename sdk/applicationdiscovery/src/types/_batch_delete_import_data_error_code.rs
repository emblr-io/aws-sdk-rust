...
impl ::std::convert::From<&str> for BatchDeleteImportDataErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchDeleteImportDataErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchDeleteImportDataErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchDeleteImportDataErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchDeleteImportDataErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BatchDeleteImportDataErrorCode {
