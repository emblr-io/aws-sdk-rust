...
impl ::std::convert::From<&str> for OfferingClass {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OfferingClass::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OfferingClass {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OfferingClass::from(s))
    }
}
impl OfferingClass {
...
impl ::std::convert::AsRef<str> for OfferingClass {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OfferingClass {
