...
impl ::std::convert::From<&str> for ConfigurationItemType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigurationItemType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigurationItemType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigurationItemType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfigurationItemType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
