...
impl ::std::convert::From<&str> for PurchasingOption {
    fn from(s: &str) -> Self {
        match s {
            "ALL_UPFRONT" => PurchasingOption::AllUpfront,
            "NO_UPFRONT" => PurchasingOption::NoUpfront,
            "PARTIAL_UPFRONT" => PurchasingOption::PartialUpfront,
            other => PurchasingOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PurchasingOption {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PurchasingOption::from(s))
    }
}
impl PurchasingOption {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PurchasingOption::AllUpfront => "ALL_UPFRONT",
            PurchasingOption::NoUpfront => "NO_UPFRONT",
            PurchasingOption::PartialUpfront => "PARTIAL_UPFRONT",
            PurchasingOption::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for PurchasingOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
