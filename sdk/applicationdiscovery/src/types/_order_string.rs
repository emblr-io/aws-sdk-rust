...
impl ::std::convert::From<&str> for OrderString {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderString::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderString {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderString::from(s))
    }
}
impl OrderString {
...
impl ::std::convert::AsRef<str> for OrderString {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OrderString {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OrderString::Asc => write!(f, "ASC"),
            OrderString::Desc => write!(f, "DESC"),
            OrderString::Unknown(value) => write!(f, "{}", value),
        }
    }
}
