...
impl ::std::convert::From<&str> for StepActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StepActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StepActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StepActionType::from(s))
    }
}
impl StepActionType {
...
impl ::std::convert::AsRef<str> for StepActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
