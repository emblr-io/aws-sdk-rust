...
impl ::std::convert::From<&str> for RunEnvironment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RunEnvironment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RunEnvironment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RunEnvironment::from(s))
    }
}
impl RunEnvironment {
...
impl ::std::convert::AsRef<str> for RunEnvironment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
