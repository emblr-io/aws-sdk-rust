...
impl WorkflowStepAutomationConfiguration {
    /// Creates a new builder-style object to manufacture [`WorkflowStepAutomationConfiguration`](crate::types::WorkflowStepAutomationConfiguration).
    pub fn builder() -> crate::types::builders::WorkflowStepAutomationConfigurationBuilder {
        crate::types::builders::WorkflowStepAutomationConfigurationBuilder::default()
    }
}
...
impl WorkflowStepAutomationConfigurationBuilder {
    /// <p>The Amazon S3 bucket where the script is located.</p>
    pub fn script_location_s3_bucket(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.script_location_s3_bucket = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The Amazon S3 bucket where the script is located.</p>
    ...
    /// <p>The Amazon S3 key for the script location.</p>
    pub fn get_script_location_s3_key(&self) -> &::std::option::Option<crate::types::PlatformScriptKey> {
