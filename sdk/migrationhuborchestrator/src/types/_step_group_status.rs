...
impl ::std::convert::From<&str> for StepGroupStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StepGroupStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StepGroupStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StepGroupStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StepGroupStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
