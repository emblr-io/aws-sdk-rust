...
impl ::std::convert::From<&str> for PluginHealth {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PluginHealth::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PluginHealth {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PluginHealth::from(s))
    }
}
impl PluginHealth {
...
impl ::std::convert::AsRef<str> for PluginHealth {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
