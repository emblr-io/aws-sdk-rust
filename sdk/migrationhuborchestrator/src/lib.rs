...
//! offered by AWS Migration Hub Orchestrator. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Migration Hub Orchestrator.
...
/// For example, the [`CreateTemplate`](crate::operation::create_template) operation has
/// a [`Client::create_template`], function which returns a builder for that operation.
...
/// Configuration for AWS Migration Hub Orchestrator.
pub mod config;
