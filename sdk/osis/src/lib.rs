...
//! offered by Amazon OpenSearch Ingestion. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon OpenSearch Ingestion.
...
/// For example, the [`CreatePipeline`](crate::operation::create_pipeline) operation has
...
/// Configuration for Amazon OpenSearch Ingestion.
pub mod config;
