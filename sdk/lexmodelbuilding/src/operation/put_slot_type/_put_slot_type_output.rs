...
impl ::aws_types::request_id::RequestId for PutSlotTypeOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PutSlotTypeOutput {
    /// Creates a new builder-style object to manufacture [`PutSlotTypeOutput`](crate::operation::put_slot_type::PutSlotTypeOutput).
    pub fn builder() -> crate::operation::put_slot_type::builders::PutSlotTypeOutputBuilder {
        crate::operation::put_slot_type::builders::PutSlotTypeOutputBuilder::default()
    }
}

/// A builder for [`PutSlotTypeOutput`](crate::operation::put_slot_type::PutSlotTypeOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutSlotTypeOutputBuilder {
...
impl PutSlotTypeOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutSlotTypeOutput`](crate::operation::put_slot_type::PutSlotTypeOutput).
    pub fn build(self) -> crate::operation::put_slot_type::PutSlotTypeOutput {
