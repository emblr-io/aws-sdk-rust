...
impl ::std::convert::From<&str> for MigrationAlertType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MigrationAlertType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MigrationAlertType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MigrationAlertType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MigrationAlertType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
