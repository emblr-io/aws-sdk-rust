...
impl ::std::convert::From<&str> for FulfillmentActivityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FulfillmentActivityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FulfillmentActivityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FulfillmentActivityType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FulfillmentActivityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
