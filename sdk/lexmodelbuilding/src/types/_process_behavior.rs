...
impl ::std::convert::From<&str> for ProcessBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProcessBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProcessBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProcessBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProcessBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
