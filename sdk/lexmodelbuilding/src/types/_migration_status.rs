...
impl ::std::convert::From<&str> for MigrationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MigrationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MigrationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MigrationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MigrationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
