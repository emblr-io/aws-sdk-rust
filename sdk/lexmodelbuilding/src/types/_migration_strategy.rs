...
impl ::std::convert::From<&str> for MigrationStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MigrationStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MigrationStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MigrationStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MigrationStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
