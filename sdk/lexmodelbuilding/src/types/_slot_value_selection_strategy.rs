...
impl ::std::convert::From<&str> for SlotValueSelectionStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotValueSelectionStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotValueSelectionStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotValueSelectionStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SlotValueSelectionStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
