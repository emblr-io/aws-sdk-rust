...
impl ::std::convert::From<&str> for MigrationSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MigrationSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MigrationSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MigrationSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MigrationSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
