...
impl ::std::convert::From<&str> for ObfuscationSetting {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ObfuscationSetting::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ObfuscationSetting {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ObfuscationSetting::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ObfuscationSetting {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
