...
//! offered by Amazon S3 on Outposts. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon S3 on Outposts.
...
/// Configuration for Amazon S3 on Outposts.
pub mod config;
