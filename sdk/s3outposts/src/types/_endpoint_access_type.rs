...
impl ::std::convert::From<&str> for EndpointAccessType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndpointAccessType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndpointAccessType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndpointAccessType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EndpointAccessType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
