...
impl ::std::convert::From<&str> for EndpointStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndpointStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndpointStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndpointStatus::from(s))
    }
}
impl EndpointStatus {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["Available", "Create_Failed", "Delete_Failed", "Deleting", "Pending"]
    }
}
impl ::std::convert::AsRef<str> for EndpointStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EndpointStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EndpointStatus::Available => write!(f, "Available"),
            EndpointStatus::CreateFailed => write!(f, "Create_Failed"),
            EndpointStatus::DeleteFailed => write!(f, "Delete_Failed"),
