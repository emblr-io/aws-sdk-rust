...
as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-ssmquicksetup` to
your project, add the following to your **Cargo.toml** file:

```toml
[dependencies]
aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
aws-sdk-ssmquicksetup = "0.0.0-local"
...
See the [client documentation](https://docs.rs/aws-sdk-ssmquicksetup/latest/aws_sdk_ssmquicksetup/client/struct.Client.html)
