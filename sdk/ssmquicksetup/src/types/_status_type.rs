...
impl ::std::convert::From<&str> for StatusType {
    fn from(s: &str) -> Self {
        match s {
            "AsyncExecutions" => StatusType::AsyncExecutions,
            "Deployment" => StatusType::Deployment,
...
impl ::std::str::FromStr for StatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatusType::from(s))
    }
}
impl StatusType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            StatusType::AsyncExecutions => "AsyncExecutions",
            StatusType::Deployment => "Deployment",
            StatusType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["AsyncExecutions", "Deployment"]
    }
}
