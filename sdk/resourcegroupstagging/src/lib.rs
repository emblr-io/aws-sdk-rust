...
//! aws-sdk-resourcegroupstagging = "0.0.0-local"
...
//! offered by AWS Resource Groups Tagging API. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Resource Groups Tagging API.
...
/// For example, the [`GetComplianceSummary`](crate::operation::get_compliance_summary) operation has
/// a [`Client::get_compliance_summary`], function which returns a builder for that operation.
...
/// Configuration for AWS Resource Groups Tagging API.
pub mod config;
