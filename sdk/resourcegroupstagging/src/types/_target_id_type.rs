...
impl ::std::convert::From<&str> for TargetIdType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetIdType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetIdType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetIdType::from(s))
    }
}
impl TargetIdType {
...
impl ::std::convert::AsRef<str> for TargetIdType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
