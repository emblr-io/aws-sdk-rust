...
impl ::std::convert::From<&str> for GroupByAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupByAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupByAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupByAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupByAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
