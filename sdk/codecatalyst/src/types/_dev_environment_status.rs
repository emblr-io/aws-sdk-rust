...
impl ::std::convert::From<&str> for DevEnvironmentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DevEnvironmentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DevEnvironmentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DevEnvironmentStatus::from(s))
    }
}
