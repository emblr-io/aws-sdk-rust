...
impl ::std::convert::From<&str> for DevEnvironmentSessionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DevEnvironmentSessionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DevEnvironmentSessionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DevEnvironmentSessionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DevEnvironmentSessionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
