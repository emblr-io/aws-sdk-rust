...
impl ::aws_types::request_id::RequestId for ListDevEnvironmentSessionsOutput {
...
impl ListDevEnvironmentSessionsOutputBuilder {
    /// Appends an item to `items`.
    ///
    /// To override the contents of this collection use [`set_items`](Self::set_items).
    ///
    /// <p>Information about each session retrieved in the list.</p>
    pub fn items(mut self, input: crate::types::DevEnvironmentSessionSummary) -> Self {
