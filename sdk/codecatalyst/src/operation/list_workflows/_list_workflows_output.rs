...
pub struct ListWorkflowsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::WorkflowSummary>>,
...
impl ListWorkflowsOutput {
    ...
    pub fn items(&self) -> &[crate::types::WorkflowSummary] {
...
pub struct ListWorkflowsOutputBuilder {
    ...
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::WorkflowSummary>>,
    _request_id: Option<String>,
}
impl ListWorkflowsOutputBuilder {
    ...
    ///
    /// <p>Information about the workflows in a project.</p>
    pub fn items(mut self, input: crate::types::WorkflowSummary) -> Self {
    ...
    /// <p>Information about the workflows in a project.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::WorkflowSummary>>) -> Self {
        self.items = input;
        self
    }
    /// <p>Information about the workflows in a project.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::WorkflowSummary>> {
        &self.items
    }
