...
impl ::std::convert::From<&str> for LfPermission {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LfPermission::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LfPermission {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LfPermission::from(s))
    }
}
impl LfPermission {
...
impl ::std::convert::AsRef<str> for LfPermission {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
