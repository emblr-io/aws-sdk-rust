...
impl ::std::convert::From<&str> for TableTagPolicyLfPermission {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableTagPolicyLfPermission::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableTagPolicyLfPermission {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableTagPolicyLfPermission::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TableTagPolicyLfPermission {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
