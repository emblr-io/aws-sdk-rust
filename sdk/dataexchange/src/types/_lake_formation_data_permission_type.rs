...
impl ::std::convert::From<&str> for LakeFormationDataPermissionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LakeFormationDataPermissionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LakeFormationDataPermissionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LakeFormationDataPermissionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LakeFormationDataPermissionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
