...
impl ::std::convert::From<&str> for LfResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LfResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LfResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LfResourceType::from(s))
    }
}
impl LfResourceType {
...
impl ::std::convert::AsRef<str> for LfResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
