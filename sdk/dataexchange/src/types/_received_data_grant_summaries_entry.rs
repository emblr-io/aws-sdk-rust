...
pub struct ReceivedDataGrantSummariesEntry {
...
impl ReceivedDataGrantSummariesEntry {
    /// <p>The name of the data grant.</p>
...
impl ReceivedDataGrantSummariesEntry {
    /// Creates a new builder-style object to manufacture [`ReceivedDataGrantSummariesEntry`](crate::types::ReceivedDataGrantSummariesEntry).
    pub fn builder() -> crate::types::builders::ReceivedDataGrantSummariesEntryBuilder {
        crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::default()
    }
}

/// A builder for [`ReceivedDataGrantSummariesEntry`](crate::types::ReceivedDataGrantSummariesEntry).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ReceivedDataGrantSummariesEntryBuilder {
...
impl ReceivedDataGrantSummariesEntryBuilder {
    /// <p>The name of the data grant.</p>
    ...
    /// Consumes the builder and constructs a [`ReceivedDataGrantSummariesEntry`](crate::types::ReceivedDataGrantSummariesEntry).
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::name)
    /// - [`sender_principal`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::sender_principal)
    /// - [`receiver_principal`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::receiver_principal)
    /// - [`acceptance_state`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::acceptance_state)
    /// - [`data_set_id`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::data_set_id)
    /// - [`id`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::id)
    /// - [`arn`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::arn)
    /// - [`created_at`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::created_at)
    /// - [`updated_at`](crate::types::builders::ReceivedDataGrantSummariesEntryBuilder::updated_at)
    pub fn build(self) -> ::std::result::Result<crate::types::ReceivedDataGrantSummariesEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ReceivedDataGrantSummariesEntry {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            sender_principal: self.sender_principal.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "sender_principal",
                    "sender_principal was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            receiver_principal: self.receiver_principal.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "receiver_principal",
                    "receiver_principal was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            acceptance_state: self.acceptance_state.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "acceptance_state",
                    "acceptance_state was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            ...
            data_set_id: self.data_set_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "data_set_id",
                    "data_set_id was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building ReceivedDataGrantSummariesEntry",
                )
            })?,
        })
    }
