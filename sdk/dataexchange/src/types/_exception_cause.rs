...
impl ::std::convert::From<&str> for ExceptionCause {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExceptionCause::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExceptionCause {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExceptionCause::from(s))
    }
}
impl ExceptionCause {
...
impl ::std::convert::AsRef<str> for ExceptionCause {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
