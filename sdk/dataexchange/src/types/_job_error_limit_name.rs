...
impl ::std::convert::From<&str> for JobErrorLimitName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobErrorLimitName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobErrorLimitName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobErrorLimitName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JobErrorLimitName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
