...
impl ::std::convert::From<&str> for DatabaseLfTagPolicyPermission {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatabaseLfTagPolicyPermission::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatabaseLfTagPolicyPermission {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatabaseLfTagPolicyPermission::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatabaseLfTagPolicyPermission {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
