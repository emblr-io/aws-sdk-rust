...
pub struct GetReceivedDataGrantOutput {
...
impl GetReceivedDataGrantOutput {
    /// <p>The name of the data grant.</p>
...
impl ::aws_types::request_id::RequestId for GetReceivedDataGrantOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetReceivedDataGrantOutput {
    /// Creates a new builder-style object to manufacture [`GetReceivedDataGrantOutput`](crate::operation::get_received_data_grant::GetReceivedDataGrantOutput).
    pub fn builder() -> crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder {
        crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::default()
    }
}

/// A builder for [`GetReceivedDataGrantOutput`](crate::operation::get_received_data_grant::GetReceivedDataGrantOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetReceivedDataGrantOutputBuilder {
...
impl GetReceivedDataGrantOutputBuilder {
    /// <p>The name of the data grant.</p>
    ...
    /// Consumes the builder and constructs a [`GetReceivedDataGrantOutput`](crate::operation::get_received_data_grant::GetReceivedDataGrantOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::name)
    /// - [`receiver_principal`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::receiver_principal)
    /// - [`acceptance_state`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::acceptance_state)
    /// - [`grant_distribution_scope`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::grant_distribution_scope)
    /// - [`data_set_id`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::data_set_id)
    /// - [`id`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::id)
    /// - [`arn`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::arn)
    /// - [`created_at`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::get_received_data_grant::builders::GetReceivedDataGrantOutputBuilder::updated_at)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_received_data_grant::GetReceivedDataGrantOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::get_received_data_grant::GetReceivedDataGrantOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            ...
            receiver_principal: self.receiver_principal.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "receiver_principal",
                    "receiver_principal was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            ...
            acceptance_state: self.acceptance_state.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "acceptance_state",
                    "acceptance_state was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            ...
            grant_distribution_scope: self.grant_distribution_scope.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    ...
                    "grant_distribution_scope was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            data_set_id: self.data_set_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "data_set_id",
                    "data_set_id was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building GetReceivedDataGrantOutput",
                )
            })?,
