...
impl ::aws_types::request_id::RequestId for GetEventActionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetEventActionOutput {
    /// Creates a new builder-style object to manufacture [`GetEventActionOutput`](crate::operation::get_event_action::GetEventActionOutput).
    pub fn builder() -> crate::operation::get_event_action::builders::GetEventActionOutputBuilder {
        crate::operation::get_event_action::builders::GetEventActionOutputBuilder::default()
    }
}

/// A builder for [`GetEventActionOutput`](crate::operation::get_event_action::GetEventActionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetEventActionOutputBuilder {
...
impl GetEventActionOutputBuilder {
    /// <p>What occurs after a certain event.</p>
    ...
    /// Consumes the builder and constructs a [`GetEventActionOutput`](crate::operation::get_event_action::GetEventActionOutput).
    pub fn build(self) -> crate::operation::get_event_action::GetEventActionOutput {
