...
pub struct ListJobsOutput {
    ...
    pub jobs: ::std::option::Option<::std::vec::Vec<crate::types::JobEntry>>,
...
impl ListJobsOutput {
    ...
    pub fn jobs(&self) -> &[crate::types::JobEntry] {
...
pub struct ListJobsOutputBuilder {
    pub(crate) jobs: ::std::option::Option<::std::vec::Vec<crate::types::JobEntry>>,
...
impl ListJobsOutputBuilder {
    ...
    ///
    /// <p>The jobs listed by the request.</p>
    pub fn jobs(mut self, input: crate::types::JobEntry) -> Self {
    ...
    /// <p>The jobs listed by the request.</p>
    pub fn set_jobs(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::JobEntry>>) -> Self {
        self.jobs = input;
        self
    }
    /// <p>The jobs listed by the request.</p>
    pub fn get_jobs(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::JobEntry>> {
        &self.jobs
    }
    /// <p>The token value retrieved from a previous call to access the next page of results.</p>
