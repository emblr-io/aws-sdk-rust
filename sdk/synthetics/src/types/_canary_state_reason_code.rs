...
impl ::std::convert::From<&str> for CanaryStateReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CanaryStateReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CanaryStateReasonCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CanaryStateReasonCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CanaryStateReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
