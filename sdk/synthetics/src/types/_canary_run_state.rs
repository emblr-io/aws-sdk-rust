...
impl ::std::convert::From<&str> for CanaryRunState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CanaryRunState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CanaryRunState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CanaryRunState::from(s))
    }
}
impl CanaryRunState {
...
impl ::std::convert::AsRef<str> for CanaryRunState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
