...
impl ::std::convert::From<&str> for InvitationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InvitationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InvitationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InvitationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InvitationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for InvitationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            InvitationStatus::Accepting => write!(f, "ACCEPTING"),
