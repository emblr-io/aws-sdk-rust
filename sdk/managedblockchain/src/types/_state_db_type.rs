...
impl ::std::convert::From<&str> for StateDbType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StateDbType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StateDbType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StateDbType::from(s))
    }
}
impl StateDbType {
...
impl ::std::convert::AsRef<str> for StateDbType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
