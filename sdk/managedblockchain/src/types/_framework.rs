...
impl ::std::convert::From<&str> for Framework {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Framework::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Framework {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Framework::from(s))
    }
}
impl Framework {
...
impl ::std::convert::AsRef<str> for Framework {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
