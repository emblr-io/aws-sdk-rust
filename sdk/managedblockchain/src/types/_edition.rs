...
impl ::std::convert::From<&str> for Edition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Edition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Edition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Edition::from(s))
    }
}
impl Edition {
...
impl ::std::convert::AsRef<str> for Edition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
