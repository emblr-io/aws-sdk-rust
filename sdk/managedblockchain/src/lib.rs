...
//! aws-sdk-managedblockchain = "0.0.0-local"
...
//! offered by Amazon Managed Blockchain. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Managed Blockchain.
...
/// For example, the [`CreateAccessor`](crate::operation::create_accessor) operation has
...
/// Configuration for Amazon Managed Blockchain.
pub mod config;
