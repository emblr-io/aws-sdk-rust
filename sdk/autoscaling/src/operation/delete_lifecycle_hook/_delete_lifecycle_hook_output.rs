...
impl ::aws_types::request_id::RequestId for DeleteLifecycleHookOutput {
...
impl DeleteLifecycleHookOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteLifecycleHookOutput`](crate::operation::delete_lifecycle_hook::DeleteLifecycleHookOutput).
    pub fn build(self) -> crate::operation::delete_lifecycle_hook::DeleteLifecycleHookOutput {
