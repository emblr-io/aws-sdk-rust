...
impl DescribeInstanceRefreshesOutput {
    ...
    pub fn instance_refreshes(&self) -> &[crate::types::InstanceRefresh] {
        self.instance_refreshes.as_deref().unwrap_or_default()
    }
    /// <p>A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the <code>NextToken</code> value when requesting the next set of items. This value is null when there are no more items to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeInstanceRefreshesOutput {
...
impl DescribeInstanceRefreshesOutputBuilder {
    ...
    pub fn instance_refreshes(mut self, input: crate::types::InstanceRefresh) -> Self {
        ...
        v.push(input);
        self.instance_refreshes = ::std::option::Option::Some(v);
        self
    }
    /// <p>The instance refreshes for the specified group, sorted by creation timestamp in descending order.</p>
