...
impl ::std::convert::From<&str> for LocalStorage {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocalStorage::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocalStorage {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocalStorage::from(s))
    }
}
impl LocalStorage {
...
impl ::std::convert::AsRef<str> for LocalStorage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
