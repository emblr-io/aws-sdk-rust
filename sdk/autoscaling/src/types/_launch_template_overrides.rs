...
/// <ul>
/// <li>
/// <p>Override the instance type that is specified in the launch template.</p></li>
/// <li>
/// <p>Use multiple instance types.</p></li>
/// </ul>
