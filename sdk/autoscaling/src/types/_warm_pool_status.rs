...
impl ::std::convert::From<&str> for WarmPoolStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WarmPoolStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WarmPoolStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WarmPoolStatus::from(s))
    }
}
impl WarmPoolStatus {
...
impl ::std::convert::AsRef<str> for WarmPoolStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
