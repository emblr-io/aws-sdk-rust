...
impl ::std::convert::From<&str> for WarmPoolState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WarmPoolState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WarmPoolState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WarmPoolState::from(s))
    }
}
impl WarmPoolState {
...
impl ::std::convert::AsRef<str> for WarmPoolState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
