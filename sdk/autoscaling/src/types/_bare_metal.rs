...
impl ::std::convert::From<&str> for BareMetal {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BareMetal::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BareMetal {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BareMetal::from(s))
    }
}
impl BareMetal {
...
impl ::std::convert::AsRef<str> for BareMetal {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
