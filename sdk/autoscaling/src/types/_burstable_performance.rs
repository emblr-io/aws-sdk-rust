...
impl ::std::convert::From<&str> for BurstablePerformance {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BurstablePerformance::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BurstablePerformance {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BurstablePerformance::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BurstablePerformance {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
