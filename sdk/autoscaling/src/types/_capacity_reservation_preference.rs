...
///     CapacityReservationPreference::CapacityReservationsFirst => { /* ... */ },
...
impl ::std::convert::From<&str> for CapacityReservationPreference {
    fn from(s: &str) -> Self {
        match s {
            "capacity-reservations-first" => CapacityReservationPreference::CapacityReservationsFirst,
...
impl ::std::str::FromStr for CapacityReservationPreference {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CapacityReservationPreference::from(s))
    }
}
impl CapacityReservationPreference {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CapacityReservationPreference::CapacityReservationsFirst => "capacity-reservations-first",
            CapacityReservationPreference::CapacityReservationsOnly => "capacity-reservations-only",
            CapacityReservationPreference::Default => "default",
...
impl ::std::fmt::Display for CapacityReservationPreference {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            CapacityReservationPreference::CapacityReservationsFirst => write!(f, "capacity-reservations-first"),
