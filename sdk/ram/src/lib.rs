...
//! offered by AWS Resource Access Manager. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Resource Access Manager.
...
/// For example, the [`AcceptResourceShareInvitation`](crate::operation::accept_resource_share_invitation) operation has
/// a [`Client::accept_resource_share_invitation`], function which returns a builder for that operation.
...
/// Configuration for AWS Resource Access Manager.
pub mod config;
