...
impl ::aws_types::request_id::RequestId for AssociateResourceSharePermissionOutput {
...
impl AssociateResourceSharePermissionOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::associate_resource_share_permission::AssociateResourceSharePermissionOutput {
