...
impl ::std::convert::From<&str> for ResourceRegionScopeFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceRegionScopeFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceRegionScopeFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceRegionScopeFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceRegionScopeFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
