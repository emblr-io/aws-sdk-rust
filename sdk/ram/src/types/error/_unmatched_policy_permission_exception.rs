...
impl ::std::error::Error for UnmatchedPolicyPermissionException {}
impl ::aws_types::request_id::RequestId for crate::types::error::UnmatchedPolicyPermissionException {
...
impl UnmatchedPolicyPermissionException {
    ...
    pub fn builder() -> crate::types::error::builders::UnmatchedPolicyPermissionExceptionBuilder {
        crate::types::error::builders::UnmatchedPolicyPermissionExceptionBuilder::default()
    }
}

/// A builder for [`UnmatchedPolicyPermissionException`](crate::types::error::UnmatchedPolicyPermissionException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UnmatchedPolicyPermissionExceptionBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl UnmatchedPolicyPermissionExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
