...
impl ServiceUnavailableExceptionBuilder {
    ...
    /// - [`message`](crate::types::error::builders::ServiceUnavailableExceptionBuilder::message)
    pub fn build(self) -> ::std::result::Result<crate::types::error::ServiceUnavailableException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::ServiceUnavailableException {
            message: self.message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "message",
                    "message was not specified but it is required when building ServiceUnavailableException",
                )
            })?,
