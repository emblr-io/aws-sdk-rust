...
impl ::std::fmt::Display for ResourceShareInvitationArnNotFoundException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "ResourceShareInvitationArnNotFoundException")?;
        {
...
impl ::aws_types::request_id::RequestId for crate::types::error::ResourceShareInvitationArnNotFoundException {
...
impl ResourceShareInvitationArnNotFoundExceptionBuilder {
    ...
    /// - [`message`](crate::types::error::builders::ResourceShareInvitationArnNotFoundExceptionBuilder::message)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::error::ResourceShareInvitationArnNotFoundException, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::types::error::ResourceShareInvitationArnNotFoundException {
            message: self.message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "message",
                    "message was not specified but it is required when building ResourceShareInvitationArnNotFoundException",
                )
            })?,
