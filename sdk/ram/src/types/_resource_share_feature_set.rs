...
impl ::std::convert::From<&str> for ResourceShareFeatureSet {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceShareFeatureSet::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceShareFeatureSet {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceShareFeatureSet::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceShareFeatureSet {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
