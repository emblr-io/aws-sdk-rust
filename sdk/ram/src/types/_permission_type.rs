...
impl ::std::convert::From<&str> for PermissionType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_MANAGED" => PermissionType::AwsManaged,
            "CUSTOMER_MANAGED" => PermissionType::CustomerManaged,
            other => PermissionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl PermissionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PermissionType::AwsManaged => "AWS_MANAGED",
