...
impl ::std::convert::From<&str> for ResourceRegionScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceRegionScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceRegionScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceRegionScope::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceRegionScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
