...
//! offered by Amazon Mechanical Turk. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Mechanical Turk.
...
/// For example, the [`AcceptQualificationRequest`](crate::operation::accept_qualification_request) operation has
/// a [`Client::accept_qualification_request`], function which returns a builder for that operation.
...
/// Configuration for Amazon Mechanical Turk.
pub mod config;
