...
impl ListHiTsForQualificationTypeInput {
    /// Creates a new builder-style object to manufacture [`ListHiTsForQualificationTypeInput`](crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeInput).
    pub fn builder() -> crate::operation::list_hits_for_qualification_type::builders::ListHiTsForQualificationTypeInputBuilder {
        crate::operation::list_hits_for_qualification_type::builders::ListHiTsForQualificationTypeInputBuilder::default()
    }
}

/// A builder for [`ListHiTsForQualificationTypeInput`](crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeInput).
...
impl ListHiTsForQualificationTypeInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListHiTsForQualificationTypeInput`](crate::operation::list_hits_for_qualification_type::ListHiTsForQualificationTypeInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
