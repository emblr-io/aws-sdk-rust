...
impl ::std::convert::From<&str> for HitReviewStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HitReviewStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HitReviewStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HitReviewStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HitReviewStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
