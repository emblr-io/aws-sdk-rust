...
//! offered by Amazon Elastic VMware Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Elastic VMware Service.
...
/// Configuration for Amazon Elastic VMware Service.
pub mod config;
