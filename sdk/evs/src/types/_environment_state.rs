...
impl ::std::convert::From<&str> for EnvironmentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            "CREATE_FAILED" => EnvironmentState::CreateFailed,
...
impl ::std::str::FromStr for EnvironmentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnvironmentState::from(s))
    }
}
impl EnvironmentState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EnvironmentState::Created => "CREATED",
            EnvironmentState::CreateFailed => "CREATE_FAILED",
            EnvironmentState::Creating => "CREATING",
            EnvironmentState::Deleted => "DELETED",
...
impl ::std::fmt::Display for EnvironmentState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EnvironmentState::Created => write!(f, "CREATED"),
            EnvironmentState::CreateFailed => write!(f, "CREATE_FAILED"),
