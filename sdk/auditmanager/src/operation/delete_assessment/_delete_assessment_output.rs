...
impl ::aws_types::request_id::RequestId for DeleteAssessmentOutput {
...
impl DeleteAssessmentOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteAssessmentOutput`](crate::operation::delete_assessment::DeleteAssessmentOutput).
    pub fn build(self) -> crate::operation::delete_assessment::DeleteAssessmentOutput {
