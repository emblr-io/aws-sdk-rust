...
impl ::std::convert::From<&str> for FrameworkType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FrameworkType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FrameworkType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FrameworkType::from(s))
    }
}
impl FrameworkType {
...
impl ::std::convert::AsRef<str> for FrameworkType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
