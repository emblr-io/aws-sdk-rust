...
impl ::std::convert::From<&str> for EvidenceFinderBackfillStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EvidenceFinderBackfillStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EvidenceFinderBackfillStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EvidenceFinderBackfillStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EvidenceFinderBackfillStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
