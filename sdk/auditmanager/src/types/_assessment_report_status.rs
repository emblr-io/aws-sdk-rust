...
impl ::std::convert::From<&str> for AssessmentReportStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssessmentReportStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssessmentReportStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssessmentReportStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssessmentReportStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AssessmentReportStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AssessmentReportStatus::Complete => write!(f, "COMPLETE"),
            AssessmentReportStatus::Failed => write!(f, "FAILED"),
            AssessmentReportStatus::InProgress => write!(f, "IN_PROGRESS"),
            AssessmentReportStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
