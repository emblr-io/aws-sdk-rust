...
impl ::std::convert::From<&str> for DeleteResources {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeleteResources::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeleteResources {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeleteResources::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeleteResources {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
