...
impl ::std::convert::From<&str> for ShareRequestType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ShareRequestType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShareRequestType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShareRequestType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ShareRequestType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
