...
impl ::std::convert::From<&str> for DelegationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DelegationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DelegationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DelegationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DelegationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
