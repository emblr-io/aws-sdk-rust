...
impl ::std::convert::From<&str> for PhoneNumberWorkflowStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PhoneNumberWorkflowStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PhoneNumberWorkflowStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PhoneNumberWorkflowStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PhoneNumberWorkflowStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
