...
impl ::std::convert::From<&str> for ContactFlowState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContactFlowState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContactFlowState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContactFlowState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContactFlowState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ContactFlowState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ContactFlowState::Active => write!(f, "ACTIVE"),
            ContactFlowState::Archived => write!(f, "ARCHIVED"),
            ContactFlowState::Unknown(value) => write!(f, "{}", value),
        }
    }
}
