...
impl ::std::convert::From<&str> for MonitorCapability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitorCapability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitorCapability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitorCapability::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitorCapability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
