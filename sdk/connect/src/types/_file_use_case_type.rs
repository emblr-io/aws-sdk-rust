...
impl ::std::convert::From<&str> for FileUseCaseType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for FileUseCaseType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FileUseCaseType::from(s))
    }
}
...
impl ::std::fmt::Display for FileUseCaseType {
