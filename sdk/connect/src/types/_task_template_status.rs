...
impl ::std::convert::From<&str> for TaskTemplateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TaskTemplateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TaskTemplateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TaskTemplateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TaskTemplateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
