...
impl ::std::convert::From<&str> for ContactFlowModuleStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContactFlowModuleStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContactFlowModuleStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContactFlowModuleStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContactFlowModuleStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
