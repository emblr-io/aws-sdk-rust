...
impl PromptSearchFilter {
    /// Creates a new builder-style object to manufacture [`PromptSearchFilter`](crate::types::PromptSearchFilter).
    pub fn builder() -> crate::types::builders::PromptSearchFilterBuilder {
        crate::types::builders::PromptSearchFilterBuilder::default()
    }
}
...
impl PromptSearchFilterBuilder {
    /// <p>An object that can be used to specify Tag conditions inside the <code>SearchFilter</code>. This accepts an <code>OR</code> of <code>AND</code> (List of List) input where:</p>
    /// <ul>
    /// <li>
    /// <p>Top level list specifies conditions that need to be applied with <code>OR</code> operator</p></li>
