...
impl ::std::convert::From<&str> for TrafficDistributionGroupStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficDistributionGroupStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficDistributionGroupStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficDistributionGroupStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficDistributionGroupStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
