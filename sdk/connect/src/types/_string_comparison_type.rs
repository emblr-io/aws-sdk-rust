...
impl ::std::convert::From<&str> for StringComparisonType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StringComparisonType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StringComparisonType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StringComparisonType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StringComparisonType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
