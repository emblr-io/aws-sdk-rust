...
/// When writing a match expression against `RealTimeContactAnalysisSegmentType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `realtimecontactanalysissegmenttype` represents
...
/// version of SDK where the variant `RealTimeContactAnalysisSegmentType::NewFeature` is defined.
/// Specifically, when `realtimecontactanalysissegmenttype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RealTimeContactAnalysisSegmentType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum RealTimeContactAnalysisSegmentType {
    #[allow(missing_docs)] // documentation missing in model
    Attachments,
    #[allow(missing_docs)] // documentation missing in model
    Categories,
...
impl ::std::convert::From<&str> for RealTimeContactAnalysisSegmentType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for RealTimeContactAnalysisSegmentType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RealTimeContactAnalysisSegmentType::from(s))
    }
}
