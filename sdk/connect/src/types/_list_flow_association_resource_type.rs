...
/// When writing a match expression against `ListFlowAssociationResourceType`, it is important to ensure
...
///     ListFlowAssociationResourceType::AnalyticsConnector => { /* ... */ },
...
///     ListFlowAssociationResourceType::WhatsappMessagingPhoneNumber => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `listflowassociationresourcetype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ListFlowAssociationResourceType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ListFlowAssociationResourceType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ListFlowAssociationResourceType::NewFeature` is defined.
/// Specifically, when `listflowassociationresourcetype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ListFlowAssociationResourceType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for ListFlowAssociationResourceType {
    fn from(s: &str) -> Self {
        match s {
            "ANALYTICS_CONNECTOR" => ListFlowAssociationResourceType::AnalyticsConnector,
            ...
            "WHATSAPP_MESSAGING_PHONE_NUMBER" => ListFlowAssociationResourceType::WhatsappMessagingPhoneNumber,
            other => ListFlowAssociationResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListFlowAssociationResourceType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListFlowAssociationResourceType::from(s))
    }
}
impl ListFlowAssociationResourceType {
    /// Returns the `&str` value of the enum member.
    pub fn as_str(&self) -> &str {
        match self {
            ListFlowAssociationResourceType::AnalyticsConnector => "ANALYTICS_CONNECTOR",
            ...
            ListFlowAssociationResourceType::WhatsappMessagingPhoneNumber => "WHATSAPP_MESSAGING_PHONE_NUMBER",
...
impl ::std::fmt::Display for ListFlowAssociationResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ListFlowAssociationResourceType::AnalyticsConnector => write!(f, "ANALYTICS_CONNECTOR"),
