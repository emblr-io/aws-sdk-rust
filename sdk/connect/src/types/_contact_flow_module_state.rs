...
impl ::std::convert::From<&str> for ContactFlowModuleState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContactFlowModuleState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContactFlowModuleState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContactFlowModuleState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContactFlowModuleState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ContactFlowModuleState {
