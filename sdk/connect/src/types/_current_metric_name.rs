...
impl ::std::convert::From<&str> for CurrentMetricName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CurrentMetricName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CurrentMetricName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CurrentMetricName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CurrentMetricName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
