...
impl ::std::convert::From<&str> for PhoneType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PhoneType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PhoneType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PhoneType::from(s))
    }
}
impl PhoneType {
...
impl ::std::convert::AsRef<str> for PhoneType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
