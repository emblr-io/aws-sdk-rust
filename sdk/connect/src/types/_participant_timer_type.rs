...
impl ::std::convert::From<&str> for ParticipantTimerType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParticipantTimerType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParticipantTimerType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParticipantTimerType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ParticipantTimerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
