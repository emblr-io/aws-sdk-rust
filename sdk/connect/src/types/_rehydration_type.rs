...
impl ::std::convert::From<&str> for RehydrationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RehydrationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RehydrationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RehydrationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RehydrationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
