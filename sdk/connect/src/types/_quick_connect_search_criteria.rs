...
impl QuickConnectSearchCriteria {
    ...
    pub fn or_conditions(&self) -> &[crate::types::QuickConnectSearchCriteria] {
    ...
    pub fn and_conditions(&self) -> &[crate::types::QuickConnectSearchCriteria] {
...
impl QuickConnectSearchCriteria {
    /// Creates a new builder-style object to manufacture [`QuickConnectSearchCriteria`](crate::types::QuickConnectSearchCriteria).
    pub fn builder() -> crate::types::builders::QuickConnectSearchCriteriaBuilder {
        crate::types::builders::QuickConnectSearchCriteriaBuilder::default()
    }
}
...
impl QuickConnectSearchCriteriaBuilder {
    ...
    ///
    /// <p>A list of conditions which would be applied together with an OR condition.</p>
    pub fn or_conditions(mut self, input: crate::types::QuickConnectSearchCriteria) -> Self {
    ...
    ///
    /// <p>A list of conditions which would be applied together with an AND condition.</p>
    pub fn and_conditions(mut self, input: crate::types::QuickConnectSearchCriteria) -> Self {
    ...
    /// Consumes the builder and constructs a [`QuickConnectSearchCriteria`](crate::types::QuickConnectSearchCriteria).
    pub fn build(self) -> crate::types::QuickConnectSearchCriteria {
        crate::types::QuickConnectSearchCriteria {
