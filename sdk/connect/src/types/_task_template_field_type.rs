...
///     TaskTemplateFieldType::ExpiryDuration => { /* ... */ },
...
///     TaskTemplateFieldType::SelfAssign => { /* ... */ },
...
impl ::std::convert::From<&str> for TaskTemplateFieldType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "EXPIRY_DURATION" => TaskTemplateFieldType::ExpiryDuration,
            ...
            "SELF_ASSIGN" => TaskTemplateFieldType::SelfAssign,
            ...
            other => TaskTemplateFieldType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TaskTemplateFieldType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TaskTemplateFieldType::from(s))
    }
}
impl TaskTemplateFieldType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TaskTemplateFieldType::ExpiryDuration => "EXPIRY_DURATION",
            ...
            TaskTemplateFieldType::SelfAssign => "SELF_ASSIGN",
...
impl ::std::convert::AsRef<str> for TaskTemplateFieldType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TaskTemplateFieldType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            TaskTemplateFieldType::ExpiryDuration => write!(f, "EXPIRY_DURATION"),
            ...
            TaskTemplateFieldType::SelfAssign => write!(f, "SELF_ASSIGN"),
