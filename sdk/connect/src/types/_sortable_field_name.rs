...
/// When writing a match expression against `SortableFieldName`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `sortablefieldname` represents
...
/// version of SDK where the variant `SortableFieldName::NewFeature` is defined.
/// Specifically, when `sortablefieldname` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SortableFieldName::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for SortableFieldName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortableFieldName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortableFieldName {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortableFieldName::from(s))
    }
}
impl SortableFieldName {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SortableFieldName::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for SortableFieldName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
