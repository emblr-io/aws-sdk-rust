...
impl ::std::convert::From<&str> for TimerEligibleParticipantRoles {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimerEligibleParticipantRoles::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimerEligibleParticipantRoles {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimerEligibleParticipantRoles::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TimerEligibleParticipantRoles {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
