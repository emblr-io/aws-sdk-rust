...
impl ::std::convert::From<&str> for NotificationDeliveryType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotificationDeliveryType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotificationDeliveryType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotificationDeliveryType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NotificationDeliveryType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for NotificationDeliveryType {
