...
impl ::std::convert::From<&str> for ContactFlowType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContactFlowType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContactFlowType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContactFlowType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContactFlowType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
