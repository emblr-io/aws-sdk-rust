...
impl ::std::convert::From<&str> for HierarchyGroupMatchType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HierarchyGroupMatchType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HierarchyGroupMatchType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HierarchyGroupMatchType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HierarchyGroupMatchType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
