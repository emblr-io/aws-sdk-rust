...
impl ::std::convert::From<&str> for RulePublishStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RulePublishStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RulePublishStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RulePublishStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RulePublishStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
