...
impl AgentStatusSearchCriteria {
    ...
    pub fn or_conditions(&self) -> &[crate::types::AgentStatusSearchCriteria] {
    ...
    pub fn and_conditions(&self) -> &[crate::types::AgentStatusSearchCriteria] {
...
impl AgentStatusSearchCriteria {
    /// Creates a new builder-style object to manufacture [`AgentStatusSearchCriteria`](crate::types::AgentStatusSearchCriteria).
    pub fn builder() -> crate::types::builders::AgentStatusSearchCriteriaBuilder {
        crate::types::builders::AgentStatusSearchCriteriaBuilder::default()
    }
}

/// A builder for [`AgentStatusSearchCriteria`](crate::types::AgentStatusSearchCriteria).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AgentStatusSearchCriteriaBuilder {
    pub(crate) or_conditions: ::std::option::Option<::std::vec::Vec<crate::types::AgentStatusSearchCriteria>>,
    pub(crate) and_conditions: ::std::option::Option<::std::vec::Vec<crate::types::AgentStatusSearchCriteria>>,
    pub(crate) string_condition: ::std::option::Option<crate::types::StringCondition>,
}
impl AgentStatusSearchCriteriaBuilder {
    /// Appends an item to `or_conditions`.
    ///
    /// To override the contents of this collection use [`set_or_conditions`](Self::set_or_conditions).
    ///
    /// <p>A list of conditions which would be applied together with an <code>OR</code> condition.</p>
    pub fn or_conditions(mut self, input: crate::types::AgentStatusSearchCriteria) -> Self {
    ...
    /// <p>A list of conditions which would be applied together with an <code>OR</code> condition.</p>
    pub fn set_or_conditions(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::AgentStatusSearchCriteria>>) -> Self {
        self.or_conditions = input;
        self
    }
    /// <p>A list of conditions which would be applied together with an <code>OR</code> condition.</p>
    pub fn get_or_conditions(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::AgentStatusSearchCriteria>> {
        &self.or_conditions
    }
    ...
    /// Consumes the builder and constructs a [`AgentStatusSearchCriteria`](crate::types::AgentStatusSearchCriteria).
    pub fn build(self) -> crate::types::AgentStatusSearchCriteria {
        crate::types::AgentStatusSearchCriteria {
