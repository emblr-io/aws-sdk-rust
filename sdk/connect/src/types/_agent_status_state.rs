...
impl ::std::convert::From<&str> for AgentStatusState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AgentStatusState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AgentStatusState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AgentStatusState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AgentStatusState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
