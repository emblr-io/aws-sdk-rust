...
impl ::std::convert::From<&str> for DeviceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "APNS_SANDBOX" => DeviceType::ApnsSandbox,
            "GCM" => DeviceType::Gcm,
            other => DeviceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceType::from(s))
    }
}
impl DeviceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DeviceType::ApnsSandbox => "APNS_SANDBOX",
            DeviceType::Gcm => "GCM",
