...
impl ListSecurityProfilesOutput {
    /// <p>Information about the security profiles.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.security_profile_summary_list.is_none()`.
    pub fn security_profile_summary_list(&self) -> &[crate::types::SecurityProfileSummary] {
        self.security_profile_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
...
impl ListSecurityProfilesOutputBuilder {
    ...
    pub fn security_profile_summary_list(mut self, input: crate::types::SecurityProfileSummary) -> Self {
        ...
        v.push(input);
        self.security_profile_summary_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>Information about the security profiles.</p>
    ...
    /// <p>Information about the security profiles.</p>
    pub fn get_security_profile_summary_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::SecurityProfileSummary>> {
