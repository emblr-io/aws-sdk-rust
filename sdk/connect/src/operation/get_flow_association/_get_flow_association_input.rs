...
pub struct GetFlowAssociationInput {
...
impl GetFlowAssociationInput {
    /// Creates a new builder-style object to manufacture [`GetFlowAssociationInput`](crate::operation::get_flow_association::GetFlowAssociationInput).
    pub fn builder() -> crate::operation::get_flow_association::builders::GetFlowAssociationInputBuilder {
        crate::operation::get_flow_association::builders::GetFlowAssociationInputBuilder::default()
    }
}
...
impl GetFlowAssociationInputBuilder {
    /// <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ...
    /// Consumes the builder and constructs a [`GetFlowAssociationInput`](crate::operation::get_flow_association::GetFlowAssociationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_flow_association::GetFlowAssociationInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::get_flow_association::GetFlowAssociationInput {
