...
impl ::aws_types::request_id::RequestId for GetContactAttributesOutput {
...
impl GetContactAttributesOutput {
    ...
    pub fn builder() -> crate::operation::get_contact_attributes::builders::GetContactAttributesOutputBuilder {
