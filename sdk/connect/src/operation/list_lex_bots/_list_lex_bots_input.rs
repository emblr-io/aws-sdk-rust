...
impl ListLexBotsInput {
    /// Creates a new builder-style object to manufacture [`ListLexBotsInput`](crate::operation::list_lex_bots::ListLexBotsInput).
    pub fn builder() -> crate::operation::list_lex_bots::builders::ListLexBotsInputBuilder {
        crate::operation::list_lex_bots::builders::ListLexBotsInputBuilder::default()
    }
}
