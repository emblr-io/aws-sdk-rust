...
impl ::aws_types::request_id::RequestId for DeleteTaskTemplateOutput {
...
impl DeleteTaskTemplateOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteTaskTemplateOutput`](crate::operation::delete_task_template::DeleteTaskTemplateOutput).
    pub fn build(self) -> crate::operation::delete_task_template::DeleteTaskTemplateOutput {
