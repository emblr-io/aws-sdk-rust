...
impl ListRoutingProfilesOutput {
    /// <p>Information about the routing profiles.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.routing_profile_summary_list.is_none()`.
    pub fn routing_profile_summary_list(&self) -> &[crate::types::RoutingProfileSummary] {
        self.routing_profile_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
...
impl ::aws_types::request_id::RequestId for ListRoutingProfilesOutput {
