...
impl CompleteAttachedFileUploadInput {
    /// Creates a new builder-style object to manufacture [`CompleteAttachedFileUploadInput`](crate::operation::complete_attached_file_upload::CompleteAttachedFileUploadInput).
    pub fn builder() -> crate::operation::complete_attached_file_upload::builders::CompleteAttachedFileUploadInputBuilder {
        crate::operation::complete_attached_file_upload::builders::CompleteAttachedFileUploadInputBuilder::default()
    }
}
...
impl CompleteAttachedFileUploadInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CompleteAttachedFileUploadInput`](crate::operation::complete_attached_file_upload::CompleteAttachedFileUploadInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::complete_attached_file_upload::CompleteAttachedFileUploadInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::complete_attached_file_upload::CompleteAttachedFileUploadInput {
