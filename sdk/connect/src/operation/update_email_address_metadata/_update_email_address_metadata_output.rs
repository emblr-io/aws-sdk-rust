...
impl ::aws_types::request_id::RequestId for UpdateEmailAddressMetadataOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateEmailAddressMetadataOutput {
    /// Creates a new builder-style object to manufacture [`UpdateEmailAddressMetadataOutput`](crate::operation::update_email_address_metadata::UpdateEmailAddressMetadataOutput).
    pub fn builder() -> crate::operation::update_email_address_metadata::builders::UpdateEmailAddressMetadataOutputBuilder {
        crate::operation::update_email_address_metadata::builders::UpdateEmailAddressMetadataOutputBuilder::default()
    }
}

/// A builder for [`UpdateEmailAddressMetadataOutput`](crate::operation::update_email_address_metadata::UpdateEmailAddressMetadataOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateEmailAddressMetadataOutputBuilder {
...
impl UpdateEmailAddressMetadataOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateEmailAddressMetadataOutput`](crate::operation::update_email_address_metadata::UpdateEmailAddressMetadataOutput).
    pub fn build(self) -> crate::operation::update_email_address_metadata::UpdateEmailAddressMetadataOutput {
