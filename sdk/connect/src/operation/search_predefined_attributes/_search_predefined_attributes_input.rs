...
impl SearchPredefinedAttributesInput {
    /// Creates a new builder-style object to manufacture [`SearchPredefinedAttributesInput`](crate::operation::search_predefined_attributes::SearchPredefinedAttributesInput).
    pub fn builder() -> crate::operation::search_predefined_attributes::builders::SearchPredefinedAttributesInputBuilder {
        crate::operation::search_predefined_attributes::builders::SearchPredefinedAttributesInputBuilder::default()
    }
}
...
pub struct SearchPredefinedAttributesInputBuilder {
    ...
    pub(crate) search_criteria: ::std::option::Option<crate::types::PredefinedAttributeSearchCriteria>,
}
