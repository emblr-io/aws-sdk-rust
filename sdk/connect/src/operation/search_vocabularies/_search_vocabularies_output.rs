...
impl SearchVocabulariesOutput {
    ...
    pub fn vocabulary_summary_list(&self) -> &[crate::types::VocabularySummary] {
        self.vocabulary_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>If there are additional results, this is the token for the next set of results.</p>
...
impl ::aws_types::request_id::RequestId for SearchVocabulariesOutput {
...
impl SearchVocabulariesOutputBuilder {
    ...
    pub fn vocabulary_summary_list(mut self, input: crate::types::VocabularySummary) -> Self {
        ...
        v.push(input);
        self.vocabulary_summary_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>The list of the available custom vocabularies.</p>
