...
impl UpdateHoursOfOperationOverrideInput {
    /// Creates a new builder-style object to manufacture [`UpdateHoursOfOperationOverrideInput`](crate::operation::update_hours_of_operation_override::UpdateHoursOfOperationOverrideInput).
    pub fn builder() -> crate::operation::update_hours_of_operation_override::builders::UpdateHoursOfOperationOverrideInputBuilder {
        crate::operation::update_hours_of_operation_override::builders::UpdateHoursOfOperationOverrideInputBuilder::default()
    }
}

/// A builder for [`UpdateHoursOfOperationOverrideInput`](crate::operation::update_hours_of_operation_override::UpdateHoursOfOperationOverrideInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateHoursOfOperationOverrideInputBuilder {
...
impl UpdateHoursOfOperationOverrideInputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateHoursOfOperationOverrideInput`](crate::operation::update_hours_of_operation_override::UpdateHoursOfOperationOverrideInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::update_hours_of_operation_override::UpdateHoursOfOperationOverrideInput,
