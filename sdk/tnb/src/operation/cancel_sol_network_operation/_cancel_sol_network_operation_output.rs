...
pub struct CancelSolNetworkOperationOutput {
    _request_id: Option<String>,
}
impl ::aws_types::request_id::RequestId for CancelSolNetworkOperationOutput {
...
impl CancelSolNetworkOperationOutputBuilder {
