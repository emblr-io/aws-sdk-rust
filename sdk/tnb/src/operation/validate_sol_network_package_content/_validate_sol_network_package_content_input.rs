...
impl ::std::fmt::Debug for ValidateSolNetworkPackageContentInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ValidateSolNetworkPackageContentInput");
...
impl ::std::fmt::Debug for ValidateSolNetworkPackageContentInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ValidateSolNetworkPackageContentInputBuilder");
        formatter.field("nsd_info_id", &self.nsd_info_id);
        formatter.field("content_type", &self.content_type);
        formatter.field("file", &"*** Sensitive Data Redacted ***");
        formatter.finish()
