...
impl ::std::fmt::Debug for ValidateSolFunctionPackageContentInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ValidateSolFunctionPackageContentInput");
...
impl ::std::fmt::Debug for ValidateSolFunctionPackageContentInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ValidateSolFunctionPackageContentInputBuilder");
        formatter.field("vnf_pkg_id", &self.vnf_pkg_id);
        formatter.field("content_type", &self.content_type);
        formatter.field("file", &"*** Sensitive Data Redacted ***");
        formatter.finish()
