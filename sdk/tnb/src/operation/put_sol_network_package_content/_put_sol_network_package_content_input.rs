...
impl ::std::fmt::Debug for PutSolNetworkPackageContentInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("PutSolNetworkPackageContentInput");
...
impl ::std::fmt::Debug for PutSolNetworkPackageContentInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("PutSolNetworkPackageContentInputBuilder");
        formatter.field("nsd_info_id", &self.nsd_info_id);
        formatter.field("content_type", &self.content_type);
        formatter.field("file", &"*** Sensitive Data Redacted ***");
        formatter.finish()
