...
//! as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-tnb` to
//! your project, add the following to your **Cargo.toml** file:
//!
//! ```toml
//! [dependencies]
//! aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
//! aws-sdk-tnb = "0.0.0-local"
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-tnb/latest/aws_sdk_tnb/client/struct.Client.html)
...
//! offered by AWS Telco Network Builder. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Telco Network Builder.
...
/// Configuration for AWS Telco Network Builder.
pub mod config;
