...
impl ::std::convert::From<&str> for ResolverQueryLogConfigAssociationError {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResolverQueryLogConfigAssociationError::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResolverQueryLogConfigAssociationError {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResolverQueryLogConfigAssociationError::from(s))
    }
}
