...
impl ::std::convert::From<&str> for ResolverEndpointStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResolverEndpointStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResolverEndpointStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResolverEndpointStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResolverEndpointStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
