...
impl ::std::convert::From<&str> for ResolverRuleAssociationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResolverRuleAssociationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResolverRuleAssociationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResolverRuleAssociationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResolverRuleAssociationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
