...
impl ::aws_types::request_id::RequestId for StartPersonTrackingOutput {
...
impl StartPersonTrackingOutputBuilder {
    /// <p>The identifier for the person detection job. Use <code>JobId</code> to identify the job in a subsequent call to <code>GetPersonTracking</code>.</p>
    ...
    /// Consumes the builder and constructs a [`StartPersonTrackingOutput`](crate::operation::start_person_tracking::StartPersonTrackingOutput).
    pub fn build(self) -> crate::operation::start_person_tracking::StartPersonTrackingOutput {
