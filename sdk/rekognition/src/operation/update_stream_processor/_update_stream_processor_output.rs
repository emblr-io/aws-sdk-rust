...
impl ::aws_types::request_id::RequestId for UpdateStreamProcessorOutput {
...
impl UpdateStreamProcessorOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateStreamProcessorOutput`](crate::operation::update_stream_processor::UpdateStreamProcessorOutput).
    pub fn build(self) -> crate::operation::update_stream_processor::UpdateStreamProcessorOutput {
