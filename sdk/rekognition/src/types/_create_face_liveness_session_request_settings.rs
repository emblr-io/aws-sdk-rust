...
pub struct CreateFaceLivenessSessionRequestSettings {
    ...
    pub challenge_preferences: ::std::option::Option<::std::vec::Vec<crate::types::ChallengePreference>>,
}
impl CreateFaceLivenessSessionRequestSettings {
    ...
    /// <p>Indicates preferred challenge types and versions for the Face Liveness session to be created.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.challenge_preferences.is_none()`.
    pub fn challenge_preferences(&self) -> &[crate::types::ChallengePreference] {
        self.challenge_preferences.as_deref().unwrap_or_default()
    }
}
impl CreateFaceLivenessSessionRequestSettings {
...
pub struct CreateFaceLivenessSessionRequestSettingsBuilder {
    ...
    pub(crate) challenge_preferences: ::std::option::Option<::std::vec::Vec<crate::types::ChallengePreference>>,
}
impl CreateFaceLivenessSessionRequestSettingsBuilder {
    ...
    /// Appends an item to `challenge_preferences`.
    ///
    /// To override the contents of this collection use [`set_challenge_preferences`](Self::set_challenge_preferences).
    ///
    /// <p>Indicates preferred challenge types and versions for the Face Liveness session to be created.</p>
    pub fn challenge_preferences(mut self, input: crate::types::ChallengePreference) -> Self {
        let mut v = self.challenge_preferences.unwrap_or_default();
        v.push(input);
        self.challenge_preferences = ::std::option::Option::Some(v);
        self
    }
    /// <p>Indicates preferred challenge types and versions for the Face Liveness session to be created.</p>
    pub fn set_challenge_preferences(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ChallengePreference>>) -> Self {
        self.challenge_preferences = input;
        self
    }
    /// <p>Indicates preferred challenge types and versions for the Face Liveness session to be created.</p>
    pub fn get_challenge_preferences(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ChallengePreference>> {
        &self.challenge_preferences
    }
    ...
    pub fn build(self) -> crate::types::CreateFaceLivenessSessionRequestSettings {
        crate::types::CreateFaceLivenessSessionRequestSettings {
            ...
            challenge_preferences: self.challenge_preferences,
        }
    }
}
