...
impl ::std::convert::From<&str> for VideoColorRange {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VideoColorRange::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VideoColorRange {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VideoColorRange::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VideoColorRange {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
