...
impl ::std::convert::From<&str> for FaceSearchSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FaceSearchSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FaceSearchSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FaceSearchSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FaceSearchSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
