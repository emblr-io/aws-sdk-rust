...
impl ::std::convert::From<&str> for ProtectiveEquipmentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProtectiveEquipmentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProtectiveEquipmentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProtectiveEquipmentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProtectiveEquipmentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
