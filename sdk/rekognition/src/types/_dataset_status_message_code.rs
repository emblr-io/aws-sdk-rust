...
impl ::std::convert::From<&str> for DatasetStatusMessageCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatasetStatusMessageCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatasetStatusMessageCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatasetStatusMessageCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatasetStatusMessageCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
