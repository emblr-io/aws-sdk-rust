...
impl ::std::convert::From<&str> for LabelDetectionSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LabelDetectionSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LabelDetectionSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LabelDetectionSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LabelDetectionSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
