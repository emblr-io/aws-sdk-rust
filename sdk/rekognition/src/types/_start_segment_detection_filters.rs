...
impl StartSegmentDetectionFiltersBuilder {
    ...
    /// <p>Filters that are specific to technical cues.</p>
    pub fn get_technical_cue_filter(&self) -> &::std::option::Option<crate::types::StartTechnicalCueDetectionFilter> {
    ...
    /// <p>Filters that are specific to shot detections.</p>
    pub fn get_shot_filter(&self) -> &::std::option::Option<crate::types::StartShotDetectionFilter> {
        &self.shot_filter
    }
