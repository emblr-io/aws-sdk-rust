...
impl ::std::convert::From<&str> for FaceAttributes {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FaceAttributes::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FaceAttributes {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FaceAttributes::from(s))
    }
}
impl FaceAttributes {
...
impl ::std::convert::AsRef<str> for FaceAttributes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FaceAttributes {
