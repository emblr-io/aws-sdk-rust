...
impl ::std::convert::From<&str> for BodyPart {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BodyPart::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BodyPart {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BodyPart::from(s))
    }
}
impl BodyPart {
...
impl ::std::convert::AsRef<str> for BodyPart {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
