...
impl ::std::convert::From<&str> for DetectLabelsFeatureName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DetectLabelsFeatureName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DetectLabelsFeatureName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DetectLabelsFeatureName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DetectLabelsFeatureName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DetectLabelsFeatureName {
