...
impl ::std::convert::From<&str> for ContentModerationSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentModerationSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentModerationSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentModerationSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContentModerationSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
