...
impl ::std::convert::From<&str> for QualityFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => QualityFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for QualityFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(QualityFilter::from(s))
    }
}
impl QualityFilter {
...
impl ::std::convert::AsRef<str> for QualityFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
