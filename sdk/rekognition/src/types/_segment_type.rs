...
impl ::std::convert::From<&str> for SegmentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SegmentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for SegmentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SegmentType::Shot => write!(f, "SHOT"),
            SegmentType::TechnicalCue => write!(f, "TECHNICAL_CUE"),
