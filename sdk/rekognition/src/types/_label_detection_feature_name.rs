...
impl ::std::convert::From<&str> for LabelDetectionFeatureName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LabelDetectionFeatureName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LabelDetectionFeatureName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LabelDetectionFeatureName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LabelDetectionFeatureName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
