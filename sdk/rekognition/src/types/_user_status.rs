...
impl ::std::convert::From<&str> for UserStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UserStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UserStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UserStatus::from(s))
    }
}
impl UserStatus {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ACTIVE", "CREATED", "CREATING", "UPDATING"]
    }
}
impl ::std::convert::AsRef<str> for UserStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
