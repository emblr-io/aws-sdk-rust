...
/// When writing a match expression against `UnsuccessfulFaceAssociationReason`, it is important to ensure
...
///
/// ```text
/// # let unsuccessfulfaceassociationreason = unimplemented!();
/// match unsuccessfulfaceassociationreason {
///     UnsuccessfulFaceAssociationReason::AssociatedToADifferentUser => { /* ... */ },
///     UnsuccessfulFaceAssociationReason::FaceNotFound => { /* ... */ },
///     UnsuccessfulFaceAssociationReason::LowMatchConfidence => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `unsuccessfulfaceassociationreason` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `UnsuccessfulFaceAssociationReason::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `UnsuccessfulFaceAssociationReason::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `UnsuccessfulFaceAssociationReason::NewFeature` is defined.
/// Specifically, when `unsuccessfulfaceassociationreason` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `UnsuccessfulFaceAssociationReason::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for UnsuccessfulFaceAssociationReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnsuccessfulFaceAssociationReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnsuccessfulFaceAssociationReason {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnsuccessfulFaceAssociationReason::from(s))
    }
}
impl UnsuccessfulFaceAssociationReason {
...
impl ::std::fmt::Display for UnsuccessfulFaceAssociationReason {
