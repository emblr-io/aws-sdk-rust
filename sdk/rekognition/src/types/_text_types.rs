...
impl ::std::convert::From<&str> for TextTypes {
    fn from(s: &str) -> Self {
        match s {
            "LINE" => TextTypes::Line,
            "WORD" => TextTypes::Word,
            other => TextTypes::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TextTypes {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TextTypes::from(s))
    }
}
impl TextTypes {
...
impl ::std::convert::AsRef<str> for TextTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
