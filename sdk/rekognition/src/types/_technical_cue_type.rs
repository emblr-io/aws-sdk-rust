...
impl ::std::convert::From<&str> for TechnicalCueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TechnicalCueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TechnicalCueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TechnicalCueType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TechnicalCueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
