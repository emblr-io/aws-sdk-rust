...
impl ::std::convert::From<&str> for GenderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GenderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GenderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GenderType::from(s))
    }
}
impl GenderType {
...
impl ::std::convert::AsRef<str> for GenderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
