...
impl ::std::fmt::Display for InvalidImageFormatException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidImageFormatException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidImageFormatException {
...
impl InvalidImageFormatException {
    /// Creates a new builder-style object to manufacture [`InvalidImageFormatException`](crate::types::error::InvalidImageFormatException).
    pub fn builder() -> crate::types::error::builders::InvalidImageFormatExceptionBuilder {
        crate::types::error::builders::InvalidImageFormatExceptionBuilder::default()
    }
}
...
impl InvalidImageFormatExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`InvalidImageFormatException`](crate::types::error::InvalidImageFormatException).
    pub fn build(self) -> crate::types::error::InvalidImageFormatException {
        crate::types::error::InvalidImageFormatException {
