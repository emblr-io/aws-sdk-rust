...
impl ::std::fmt::Display for SessionNotFoundException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "SessionNotFoundException")?;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SessionNotFoundException {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        &self.meta
    }
}
impl SessionNotFoundException {
    /// Creates a new builder-style object to manufacture [`SessionNotFoundException`](crate::types::error::SessionNotFoundException).
    pub fn builder() -> crate::types::error::builders::SessionNotFoundExceptionBuilder {
        crate::types::error::builders::SessionNotFoundExceptionBuilder::default()
    }
}
...
impl SessionNotFoundExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`SessionNotFoundException`](crate::types::error::SessionNotFoundException).
    pub fn build(self) -> crate::types::error::SessionNotFoundException {
        crate::types::error::SessionNotFoundException {
