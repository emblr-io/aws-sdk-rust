...
impl ComputeNodeGroupSlurmConfiguration {
    /// Creates a new builder-style object to manufacture [`ComputeNodeGroupSlurmConfiguration`](crate::types::ComputeNodeGroupSlurmConfiguration).
    pub fn builder() -> crate::types::builders::ComputeNodeGroupSlurmConfigurationBuilder {
        crate::types::builders::ComputeNodeGroupSlurmConfigurationBuilder::default()
    }
}

/// A builder for [`ComputeNodeGroupSlurmConfiguration`](crate::types::ComputeNodeGroupSlurmConfiguration).
