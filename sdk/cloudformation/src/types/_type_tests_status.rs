...
impl ::std::convert::From<&str> for TypeTestsStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TypeTestsStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TypeTestsStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TypeTestsStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TypeTestsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
