...
impl ::std::convert::From<&str> for ResourceAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceAttribute::from(s))
    }
}
...
impl ::std::fmt::Display for ResourceAttribute {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ResourceAttribute::UpdateReplacePolicy => write!(f, "UpdateReplacePolicy"),
