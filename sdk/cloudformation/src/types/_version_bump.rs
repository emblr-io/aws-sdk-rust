...
impl ::std::convert::From<&str> for VersionBump {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VersionBump::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VersionBump {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VersionBump::from(s))
    }
}
impl VersionBump {
...
impl ::std::convert::AsRef<str> for VersionBump {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
