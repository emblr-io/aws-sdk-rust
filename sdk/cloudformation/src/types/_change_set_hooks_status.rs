...
impl ::std::convert::From<&str> for ChangeSetHooksStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChangeSetHooksStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChangeSetHooksStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChangeSetHooksStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChangeSetHooksStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
