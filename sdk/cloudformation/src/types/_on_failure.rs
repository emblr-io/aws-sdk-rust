...
impl ::std::convert::From<&str> for OnFailure {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OnFailure::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OnFailure {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OnFailure::from(s))
    }
}
impl OnFailure {
...
impl ::std::convert::AsRef<str> for OnFailure {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
