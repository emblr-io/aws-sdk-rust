...
impl ::std::convert::From<&str> for OperationResultFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OperationResultFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OperationResultFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OperationResultFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OperationResultFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
