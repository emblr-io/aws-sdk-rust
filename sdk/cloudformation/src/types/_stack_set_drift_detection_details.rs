...
pub struct StackSetDriftDetectionDetails {
    ...
    /// <ul>
    /// <li>
    /// <p><code>COMPLETED</code>: The drift detection operation completed without failing on any stack instances.</p></li>
    /// <li>
    /// <p><code>FAILED</code>: The drift detection operation exceeded the specified failure tolerance.</p></li>
    /// <li>
    /// <p><code>PARTIAL_SUCCESS</code>: The drift detection operation completed without exceeding the failure tolerance for the operation.</p></li>
    /// <li>
    /// <p><code>IN_PROGRESS</code>: The drift detection operation is currently being performed.</p></li>
    /// <li>
    ...
    /// <ul>
    /// <li>
    /// <p>Stack instances that match the stack set configuration.</p></li>
    /// <li>
    /// <p>Stack instances that have drifted from the stack set configuration.</p></li>
    /// <li>
...
impl StackSetDriftDetectionDetailsBuilder {
    ...
    /// <p><code>IN_SYNC</code>: All of the stack instances belonging to the stack set stack match from the expected template and parameter configuration.</p></li>
    /// </ul>
    pub fn get_drift_status(&self) -> &::std::option::Option<crate::types::StackSetDriftStatus> {
        &self.drift_status
    }
    /// <p>The status of the stack set drift detection operation.</p>
    /// <ul>
    ...
    pub fn total_stack_instances_count(mut self, input: i32) -> Self {
        self.total_stack_instances_count = ::std::option::Option::Some(input);
        self
    }
    /// <p>The total number of stack instances belonging to this stack set.</p>
    /// <p>The total number of stack instances is equal to the total of:</p>
    ...
    /// <p>Stack instances currently being checked for drift.</p></li>
    /// </ul>
    pub fn get_total_stack_instances_count(&self) -> &::std::option::Option<i32> {
        &self.total_stack_instances_count
    }
    /// <p>The number of stack instances that have drifted from the expected template and parameter configuration of the stack set. A stack instance is considered to have drifted if one or more of the resources in the associated stack don't match their expected configuration.</p>
    pub fn drifted_stack_instances_count(mut self, input: i32) -> Self {
        self.drifted_stack_instances_count = ::std::option::Option::Some(input);
        self
    }
    /// <p>The number of stack instances that have drifted from the expected template and parameter configuration of the stack set. A stack instance is considered to have drifted if one or more of the resources in the associated stack don't match their expected configuration.</p>
    ...
    pub fn in_sync_stack_instances_count(mut self, input: i32) -> Self {
        self.in_sync_stack_instances_count = ::std::option::Option::Some(input);
        self
    }
    /// <p>The number of stack instances which match the expected template and parameter configuration of the stack set.</p>
    ...
    pub fn in_progress_stack_instances_count(mut self, input: i32) -> Self {
        self.in_progress_stack_instances_count = ::std::option::Option::Some(input);
        self
    }
    /// <p>The number of stack instances that are currently being checked for drift.</p>
