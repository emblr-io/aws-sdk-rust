...
impl ::std::convert::From<&str> for HookFailureMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HookFailureMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HookFailureMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HookFailureMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HookFailureMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
