...
impl ::std::convert::From<&str> for RegistryType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RegistryType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RegistryType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RegistryType::from(s))
    }
}
impl RegistryType {
...
impl ::std::convert::AsRef<str> for RegistryType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
