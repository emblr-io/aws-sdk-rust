...
impl ::std::convert::From<&str> for DeprecatedStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeprecatedStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeprecatedStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeprecatedStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeprecatedStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
