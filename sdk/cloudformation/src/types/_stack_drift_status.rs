...
impl ::std::convert::From<&str> for StackDriftStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackDriftStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackDriftStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackDriftStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StackDriftStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
