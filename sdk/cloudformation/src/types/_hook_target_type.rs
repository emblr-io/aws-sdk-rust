...
impl ::std::convert::From<&str> for HookTargetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HookTargetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HookTargetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HookTargetType::from(s))
    }
}
impl HookTargetType {
...
impl ::std::convert::AsRef<str> for HookTargetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for HookTargetType {
