...
impl ::std::convert::From<&str> for IdentityProvider {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IdentityProvider::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IdentityProvider {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IdentityProvider::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IdentityProvider {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
