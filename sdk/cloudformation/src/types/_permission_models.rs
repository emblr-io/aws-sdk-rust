...
impl ::std::convert::From<&str> for PermissionModels {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PermissionModels::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PermissionModels {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PermissionModels::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PermissionModels {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
