...
impl ::std::convert::From<&str> for PublisherStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PublisherStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PublisherStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PublisherStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PublisherStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
