...
impl ::std::convert::From<&str> for StackSetDriftStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackSetDriftStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackSetDriftStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackSetDriftStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StackSetDriftStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for StackSetDriftStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            StackSetDriftStatus::Drifted => write!(f, "DRIFTED"),
            StackSetDriftStatus::InSync => write!(f, "IN_SYNC"),
            StackSetDriftStatus::NotChecked => write!(f, "NOT_CHECKED"),
            StackSetDriftStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
