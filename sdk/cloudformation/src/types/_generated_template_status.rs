...
/// When writing a match expression against `GeneratedTemplateStatus`, it is important to ensure
...
///     GeneratedTemplateStatus::Complete => { /* ... */ },
///     GeneratedTemplateStatus::CreateInProgress => { /* ... */ },
///     GeneratedTemplateStatus::CreatePending => { /* ... */ },
///     GeneratedTemplateStatus::DeleteInProgress => { /* ... */ },
///     GeneratedTemplateStatus::DeletePending => { /* ... */ },
///     GeneratedTemplateStatus::Failed => { /* ... */ },
///     GeneratedTemplateStatus::UpdateInProgress => { /* ... */ },
///     GeneratedTemplateStatus::UpdatePending => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `generatedtemplatestatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `GeneratedTemplateStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `GeneratedTemplateStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `GeneratedTemplateStatus::NewFeature` is defined.
