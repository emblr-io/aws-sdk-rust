...
impl ::std::convert::From<&str> for HookInvocationPoint {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HookInvocationPoint::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HookInvocationPoint {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HookInvocationPoint::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HookInvocationPoint {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for HookInvocationPoint {
