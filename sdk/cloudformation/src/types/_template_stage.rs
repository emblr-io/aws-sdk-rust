...
impl ::std::convert::From<&str> for TemplateStage {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TemplateStage::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TemplateStage {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TemplateStage::from(s))
    }
}
impl TemplateStage {
...
impl ::std::convert::AsRef<str> for TemplateStage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
