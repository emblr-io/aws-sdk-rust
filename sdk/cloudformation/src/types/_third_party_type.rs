...
impl ::std::convert::From<&str> for ThirdPartyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThirdPartyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThirdPartyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThirdPartyType::from(s))
    }
}
impl ThirdPartyType {
...
impl ::std::convert::AsRef<str> for ThirdPartyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
