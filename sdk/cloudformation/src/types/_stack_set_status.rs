...
impl ::std::convert::From<&str> for StackSetStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackSetStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackSetStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackSetStatus::from(s))
    }
}
impl StackSetStatus {
...
impl ::std::convert::AsRef<str> for StackSetStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
