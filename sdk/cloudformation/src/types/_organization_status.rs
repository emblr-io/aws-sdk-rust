...
impl ::std::convert::From<&str> for OrganizationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "DISABLED_PERMANENTLY" => OrganizationStatus::DisabledPermanently,
...
impl OrganizationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OrganizationStatus::DisabledPermanently => "DISABLED_PERMANENTLY",
            OrganizationStatus::Enabled => "ENABLED",
            OrganizationStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["DISABLED", "DISABLED_PERMANENTLY", "ENABLED"]
    }
}
