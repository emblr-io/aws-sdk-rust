...
impl ::std::convert::From<&str> for StackSetOperationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackSetOperationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackSetOperationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackSetOperationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StackSetOperationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for StackSetOperationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            StackSetOperationStatus::Failed => write!(f, "FAILED"),
            StackSetOperationStatus::Queued => write!(f, "QUEUED"),
            StackSetOperationStatus::Running => write!(f, "RUNNING"),
