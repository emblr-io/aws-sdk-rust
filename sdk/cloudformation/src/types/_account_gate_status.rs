...
impl ::std::convert::From<&str> for AccountGateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountGateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountGateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountGateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccountGateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
