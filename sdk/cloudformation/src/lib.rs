...
//! aws-sdk-cloudformation = "0.0.0-local"
...
//! offered by AWS CloudFormation. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS CloudFormation.
