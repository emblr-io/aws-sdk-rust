...
pub struct ListGeneratedTemplatesOutput {
    ...
    pub summaries: ::std::option::Option<::std::vec::Vec<crate::types::TemplateSummary>>,
...
impl ListGeneratedTemplatesOutput {
    /// <p>A list of summaries of the generated templates.</p>
    ///
    ...
    pub fn summaries(&self) -> &[crate::types::TemplateSummary] {
...
impl ::aws_types::request_id::RequestId for ListGeneratedTemplatesOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ListGeneratedTemplatesOutput {
    /// Creates a new builder-style object to manufacture [`ListGeneratedTemplatesOutput`](crate::operation::list_generated_templates::ListGeneratedTemplatesOutput).
    pub fn builder() -> crate::operation::list_generated_templates::builders::ListGeneratedTemplatesOutputBuilder {
        crate::operation::list_generated_templates::builders::ListGeneratedTemplatesOutputBuilder::default()
    }
}
...
impl ListGeneratedTemplatesOutputBuilder {
    ...
    ///
    /// <p>A list of summaries of the generated templates.</p>
    pub fn summaries(mut self, input: crate::types::TemplateSummary) -> Self {
    ...
    /// <p>A list of summaries of the generated templates.</p>
    pub fn set_summaries(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::TemplateSummary>>) -> Self {
        self.summaries = input;
        self
    }
    /// <p>A list of summaries of the generated templates.</p>
    pub fn get_summaries(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::TemplateSummary>> {
        &self.summaries
    }
    /// <p>If the request doesn't return all the remaining results, <code>NextToken</code> is set to a token. To retrieve the next set of results, call <code>ListGeneratedTemplates</code> again and use that value for the <code>NextToken</code> parameter. If the request returns all results, <code>NextToken</code> is set to an empty string.</p>
    ...
    /// Consumes the builder and constructs a [`ListGeneratedTemplatesOutput`](crate::operation::list_generated_templates::ListGeneratedTemplatesOutput).
    pub fn build(self) -> crate::operation::list_generated_templates::ListGeneratedTemplatesOutput {
