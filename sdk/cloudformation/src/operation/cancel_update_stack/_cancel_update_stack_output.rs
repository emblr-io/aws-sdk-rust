...
impl ::aws_types::request_id::RequestId for CancelUpdateStackOutput {
...
impl CancelUpdateStackOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CancelUpdateStackOutput`](crate::operation::cancel_update_stack::CancelUpdateStackOutput).
    pub fn build(self) -> crate::operation::cancel_update_stack::CancelUpdateStackOutput {
