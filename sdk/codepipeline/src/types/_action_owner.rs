...
impl ::std::convert::From<&str> for ActionOwner {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionOwner::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionOwner {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionOwner::from(s))
    }
}
impl ActionOwner {
...
impl ::std::convert::AsRef<str> for ActionOwner {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
