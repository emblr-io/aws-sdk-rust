...
impl GitFilePathFilterCriteria {
    /// <p>The list of patterns of Git repository file paths that, when a commit is pushed, are to be included as criteria that starts the pipeline.</p>
    ///
...
impl GitFilePathFilterCriteria {
    /// Creates a new builder-style object to manufacture [`GitFilePathFilterCriteria`](crate::types::GitFilePathFilterCriteria).
    pub fn builder() -> crate::types::builders::GitFilePathFilterCriteriaBuilder {
        crate::types::builders::GitFilePathFilterCriteriaBuilder::default()
    }
}
...
impl GitFilePathFilterCriteriaBuilder {
    ...
    /// Consumes the builder and constructs a [`GitFilePathFilterCriteria`](crate::types::GitFilePathFilterCriteria).
    pub fn build(self) -> crate::types::GitFilePathFilterCriteria {
        crate::types::GitFilePathFilterCriteria {
