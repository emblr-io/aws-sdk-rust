...
impl ::std::convert::From<&str> for StageRetryMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StageRetryMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StageRetryMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StageRetryMode::from(s))
    }
}
impl StageRetryMode {
...
impl ::std::fmt::Display for StageRetryMode {
