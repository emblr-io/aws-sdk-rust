...
impl ::std::convert::From<&str> for ActionConfigurationPropertyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionConfigurationPropertyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionConfigurationPropertyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionConfigurationPropertyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActionConfigurationPropertyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
