...
impl ThirdPartyJobData {
    /// Creates a new builder-style object to manufacture [`ThirdPartyJobData`](crate::types::ThirdPartyJobData).
    pub fn builder() -> crate::types::builders::ThirdPartyJobDataBuilder {
        crate::types::builders::ThirdPartyJobDataBuilder::default()
    }
}

/// A builder for [`ThirdPartyJobData`](crate::types::ThirdPartyJobData).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct ThirdPartyJobDataBuilder {
...
impl ThirdPartyJobDataBuilder {
    ...
    /// Consumes the builder and constructs a [`ThirdPartyJobData`](crate::types::ThirdPartyJobData).
    pub fn build(self) -> crate::types::ThirdPartyJobData {
        crate::types::ThirdPartyJobData {
...
impl ::std::fmt::Debug for ThirdPartyJobDataBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ThirdPartyJobDataBuilder");
        formatter.field("action_type_id", &self.action_type_id);
        formatter.field("action_configuration", &self.action_configuration);
        formatter.field("pipeline_context", &self.pipeline_context);
        formatter.field("input_artifacts", &self.input_artifacts);
