...
impl ::std::convert::From<&str> for StageExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StageExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StageExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StageExecutionStatus::from(s))
    }
}
...
impl ::std::fmt::Display for StageExecutionStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            StageExecutionStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
