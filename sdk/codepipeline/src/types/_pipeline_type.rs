...
impl ::std::convert::From<&str> for PipelineType {
    fn from(s: &str) -> Self {
        match s {
            "V1" => PipelineType::V1,
            "V2" => PipelineType::V2,
            other => PipelineType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PipelineType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PipelineType::from(s))
    }
}
impl PipelineType {
...
impl ::std::convert::AsRef<str> for PipelineType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
