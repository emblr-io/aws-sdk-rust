...
impl ::std::convert::From<&str> for ArtifactStoreType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArtifactStoreType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactStoreType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactStoreType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArtifactStoreType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
