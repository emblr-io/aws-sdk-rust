...
impl ::std::convert::From<&str> for ActionExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionExecutionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActionExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
