...
impl ::std::convert::From<&str> for FailureType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailureType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailureType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailureType::from(s))
    }
}
impl FailureType {
...
impl ::std::convert::AsRef<str> for FailureType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
