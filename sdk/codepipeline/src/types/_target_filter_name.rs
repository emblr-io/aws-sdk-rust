...
impl ::std::convert::From<&str> for TargetFilterName {
    fn from(s: &str) -> Self {
        match s {
            "TARGET_STATUS" => TargetFilterName::TargetStatus,
            other => TargetFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetFilterName::from(s))
    }
}
impl TargetFilterName {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            TargetFilterName::TargetStatus => "TARGET_STATUS",
...
impl ::std::convert::AsRef<str> for TargetFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TargetFilterName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TargetFilterName::TargetStatus => write!(f, "TARGET_STATUS"),
