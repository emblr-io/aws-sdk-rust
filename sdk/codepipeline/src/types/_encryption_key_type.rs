...
impl ::std::convert::From<&str> for EncryptionKeyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EncryptionKeyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncryptionKeyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncryptionKeyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EncryptionKeyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EncryptionKeyType {
