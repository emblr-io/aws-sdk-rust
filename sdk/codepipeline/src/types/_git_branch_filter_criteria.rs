...
impl GitBranchFilterCriteria {
    /// Creates a new builder-style object to manufacture [`GitBranchFilterCriteria`](crate::types::GitBranchFilterCriteria).
    pub fn builder() -> crate::types::builders::GitBranchFilterCriteriaBuilder {
        crate::types::builders::GitBranchFilterCriteriaBuilder::default()
    }
}
...
impl GitBranchFilterCriteriaBuilder {
    ...
    /// Consumes the builder and constructs a [`GitBranchFilterCriteria`](crate::types::GitBranchFilterCriteria).
    pub fn build(self) -> crate::types::GitBranchFilterCriteria {
        crate::types::GitBranchFilterCriteria {
