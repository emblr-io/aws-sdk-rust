...
impl ::std::convert::From<&str> for ConditionType {
    fn from(s: &str) -> Self {
        match s {
            "BEFORE_ENTRY" => ConditionType::BeforeEntry,
            "ON_SUCCESS" => ConditionType::OnSuccess,
            other => ConditionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConditionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConditionType::from(s))
    }
}
impl ConditionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConditionType::BeforeEntry => "BEFORE_ENTRY",
