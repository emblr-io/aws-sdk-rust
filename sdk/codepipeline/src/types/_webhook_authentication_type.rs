...
impl ::std::convert::From<&str> for WebhookAuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WebhookAuthenticationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WebhookAuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WebhookAuthenticationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WebhookAuthenticationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for WebhookAuthenticationType {
