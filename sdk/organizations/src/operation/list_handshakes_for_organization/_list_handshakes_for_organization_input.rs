...
impl ListHandshakesForOrganizationInput {
    /// Creates a new builder-style object to manufacture [`ListHandshakesForOrganizationInput`](crate::operation::list_handshakes_for_organization::ListHandshakesForOrganizationInput).
    pub fn builder() -> crate::operation::list_handshakes_for_organization::builders::ListHandshakesForOrganizationInputBuilder {
        crate::operation::list_handshakes_for_organization::builders::ListHandshakesForOrganizationInputBuilder::default()
    }
}

/// A builder for [`ListHandshakesForOrganizationInput`](crate::operation::list_handshakes_for_organization::ListHandshakesForOrganizationInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListHandshakesForOrganizationInputBuilder {
...
impl ListHandshakesForOrganizationInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListHandshakesForOrganizationInput`](crate::operation::list_handshakes_for_organization::ListHandshakesForOrganizationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::list_handshakes_for_organization::ListHandshakesForOrganizationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::list_handshakes_for_organization::ListHandshakesForOrganizationInput {
            filter: self.filter,
