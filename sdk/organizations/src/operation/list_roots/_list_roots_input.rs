...
impl ListRootsInput {
    /// Creates a new builder-style object to manufacture [`ListRootsInput`](crate::operation::list_roots::ListRootsInput).
    pub fn builder() -> crate::operation::list_roots::builders::ListRootsInputBuilder {
        crate::operation::list_roots::builders::ListRootsInputBuilder::default()
    }
}

/// A builder for [`ListRootsInput`](crate::operation::list_roots::ListRootsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListRootsInputBuilder {
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    pub(crate) max_results: ::std::option::Option<i32>,
}
impl ListRootsInputBuilder {
    /// <p>The parameter for receiving additional results if you receive a <code>NextToken</code> response in a previous request. A <code>NextToken</code> response indicates that more output is available. Set this parameter to the value of the previous call's <code>NextToken</code> response to indicate where the output should continue from.</p>
