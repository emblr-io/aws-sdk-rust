...
impl ::aws_types::request_id::RequestId for DescribeEffectivePolicyOutput {
...
impl DescribeEffectivePolicyOutputBuilder {
    ...
    pub fn effective_policy(mut self, input: crate::types::EffectivePolicy) -> Self {
        self.effective_policy = ::std::option::Option::Some(input);
        self
    }
    /// <p>The contents of the effective policy.</p>
    ...
    /// <p>The contents of the effective policy.</p>
    pub fn get_effective_policy(&self) -> &::std::option::Option<crate::types::EffectivePolicy> {
