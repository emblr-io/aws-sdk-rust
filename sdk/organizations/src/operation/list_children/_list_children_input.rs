...
pub struct ListChildrenInput {
    ...
    pub child_type: ::std::option::Option<crate::types::ChildType>,
...
impl ListChildrenInput {
    ...
    /// <p>Filters the output to include only the specified child type.</p>
    pub fn child_type(&self) -> ::std::option::Option<&crate::types::ChildType> {
...
impl ListChildrenInput {
    /// Creates a new builder-style object to manufacture [`ListChildrenInput`](crate::operation::list_children::ListChildrenInput).
    pub fn builder() -> crate::operation::list_children::builders::ListChildrenInputBuilder {
        crate::operation::list_children::builders::ListChildrenInputBuilder::default()
    }
}
