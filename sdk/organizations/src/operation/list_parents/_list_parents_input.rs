...
impl ListParentsInput {
    /// Creates a new builder-style object to manufacture [`ListParentsInput`](crate::operation::list_parents::ListParentsInput).
    pub fn builder() -> crate::operation::list_parents::builders::ListParentsInputBuilder {
        crate::operation::list_parents::builders::ListParentsInputBuilder::default()
    }
}
