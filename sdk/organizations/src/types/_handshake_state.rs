...
impl ::std::convert::From<&str> for HandshakeState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HandshakeState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HandshakeState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HandshakeState::from(s))
    }
}
impl HandshakeState {
...
impl ::std::convert::AsRef<str> for HandshakeState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
