...
impl ::std::convert::From<&str> for PolicyTypeStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PolicyTypeStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PolicyTypeStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyTypeStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PolicyTypeStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
