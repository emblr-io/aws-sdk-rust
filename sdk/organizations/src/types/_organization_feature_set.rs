...
impl ::std::convert::From<&str> for OrganizationFeatureSet {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrganizationFeatureSet::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrganizationFeatureSet {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrganizationFeatureSet::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrganizationFeatureSet {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
