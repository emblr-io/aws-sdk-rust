...
impl ::std::convert::From<&str> for ParentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParentType::from(s))
    }
}
impl ParentType {
...
impl ::std::convert::AsRef<str> for ParentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
