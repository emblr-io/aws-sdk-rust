...
impl ::std::convert::From<&str> for AccountStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountStatus::from(s))
    }
}
impl AccountStatus {
...
impl ::std::convert::AsRef<str> for AccountStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AccountStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            AccountStatus::PendingClosure => write!(f, "PENDING_CLOSURE"),
