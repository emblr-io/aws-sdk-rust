...
impl ::std::convert::From<&str> for AccountJoinedMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountJoinedMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountJoinedMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountJoinedMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccountJoinedMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
