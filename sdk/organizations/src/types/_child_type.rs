...
impl ::std::convert::From<&str> for ChildType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChildType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChildType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChildType::from(s))
    }
}
impl ChildType {
...
impl ::std::convert::AsRef<str> for ChildType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
