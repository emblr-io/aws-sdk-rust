...
impl ::std::convert::From<&str> for CreateAccountState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CreateAccountState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CreateAccountState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CreateAccountState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CreateAccountState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
