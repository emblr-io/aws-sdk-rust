...
///     KeyState::CreateInProgress => { /* ... */ },
///     KeyState::DeleteComplete => { /* ... */ },
///     KeyState::DeletePending => { /* ... */ },
...
impl ::std::convert::From<&str> for KeyState {
    fn from(s: &str) -> Self {
        match s {
            "CREATE_COMPLETE" => KeyState::CreateComplete,
            "CREATE_IN_PROGRESS" => KeyState::CreateInProgress,
            "DELETE_COMPLETE" => KeyState::DeleteComplete,
            "DELETE_PENDING" => KeyState::DeletePending,
...
impl KeyState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            KeyState::CreateComplete => "CREATE_COMPLETE",
            KeyState::CreateInProgress => "CREATE_IN_PROGRESS",
            KeyState::DeleteComplete => "DELETE_COMPLETE",
            KeyState::DeletePending => "DELETE_PENDING",
