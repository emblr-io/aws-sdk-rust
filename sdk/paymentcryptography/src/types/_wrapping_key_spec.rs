...
///     WrappingKeySpec::RsaOaepSha256 => { /* ... */ },
///     WrappingKeySpec::RsaOaepSha512 => { /* ... */ },
...
impl ::std::convert::From<&str> for WrappingKeySpec {
    fn from(s: &str) -> Self {
        match s {
            "RSA_OAEP_SHA_256" => WrappingKeySpec::RsaOaepSha256,
            "RSA_OAEP_SHA_512" => WrappingKeySpec::RsaOaepSha512,
...
impl WrappingKeySpec {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            WrappingKeySpec::RsaOaepSha256 => "RSA_OAEP_SHA_256",
            WrappingKeySpec::RsaOaepSha512 => "RSA_OAEP_SHA_512",
