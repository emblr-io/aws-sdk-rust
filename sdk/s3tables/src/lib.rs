...
//! offered by Amazon S3 Tables. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon S3 Tables.
...
/// For example, the [`CreateNamespace`](crate::operation::create_namespace) operation has
...
/// Configuration for Amazon S3 Tables.
pub mod config;
