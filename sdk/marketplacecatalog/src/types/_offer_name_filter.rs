...
impl OfferNameFilter {
    /// Creates a new builder-style object to manufacture [`OfferNameFilter`](crate::types::OfferNameFilter).
    pub fn builder() -> crate::types::builders::OfferNameFilterBuilder {
        crate::types::builders::OfferNameFilterBuilder::default()
    }
}

/// A builder for [`OfferNameFilter`](crate::types::OfferNameFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OfferNameFilterBuilder {
...
impl OfferNameFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`OfferNameFilter`](crate::types::OfferNameFilter).
    pub fn build(self) -> crate::types::OfferNameFilter {
        crate::types::OfferNameFilter {
