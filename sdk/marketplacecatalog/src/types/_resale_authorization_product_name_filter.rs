...
pub struct ResaleAuthorizationProductNameFilter {
...
impl ResaleAuthorizationProductNameFilter {
    /// <p>Allows filtering on the <code>ProductName</code> of a ResaleAuthorization with list input.</p>
    ///
...
impl ResaleAuthorizationProductNameFilter {
    /// Creates a new builder-style object to manufacture [`ResaleAuthorizationProductNameFilter`](crate::types::ResaleAuthorizationProductNameFilter).
    pub fn builder() -> crate::types::builders::ResaleAuthorizationProductNameFilterBuilder {
        crate::types::builders::ResaleAuthorizationProductNameFilterBuilder::default()
    }
}

/// A builder for [`ResaleAuthorizationProductNameFilter`](crate::types::ResaleAuthorizationProductNameFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ResaleAuthorizationProductNameFilterBuilder {
...
impl ResaleAuthorizationProductNameFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`ResaleAuthorizationProductNameFilter`](crate::types::ResaleAuthorizationProductNameFilter).
    pub fn build(self) -> crate::types::ResaleAuthorizationProductNameFilter {
        crate::types::ResaleAuthorizationProductNameFilter {
