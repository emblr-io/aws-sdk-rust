...
impl ResaleAuthorizationResellerAccountIdFilter {
    /// Creates a new builder-style object to manufacture [`ResaleAuthorizationResellerAccountIdFilter`](crate::types::ResaleAuthorizationResellerAccountIdFilter).
    pub fn builder() -> crate::types::builders::ResaleAuthorizationResellerAccountIdFilterBuilder {
        crate::types::builders::ResaleAuthorizationResellerAccountIdFilterBuilder::default()
    }
}

/// A builder for [`ResaleAuthorizationResellerAccountIdFilter`](crate::types::ResaleAuthorizationResellerAccountIdFilter).
