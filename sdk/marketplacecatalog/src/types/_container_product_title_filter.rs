...
pub struct ContainerProductTitleFilter {
...
impl ContainerProductTitleFilter {
    /// <p>A string array of unique product title values to be filtered on.</p>
    ///
...
impl ContainerProductTitleFilter {
    /// Creates a new builder-style object to manufacture [`ContainerProductTitleFilter`](crate::types::ContainerProductTitleFilter).
    pub fn builder() -> crate::types::builders::ContainerProductTitleFilterBuilder {
        crate::types::builders::ContainerProductTitleFilterBuilder::default()
    }
}
...
impl ContainerProductTitleFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`ContainerProductTitleFilter`](crate::types::ContainerProductTitleFilter).
    pub fn build(self) -> crate::types::ContainerProductTitleFilter {
        crate::types::ContainerProductTitleFilter {
