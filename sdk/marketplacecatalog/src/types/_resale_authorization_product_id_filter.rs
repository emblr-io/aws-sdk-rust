...
pub struct ResaleAuthorizationProductIdFilter {
...
impl ResaleAuthorizationProductIdFilter {
    /// <p>Allows filtering on the <code>ProductId</code> of a ResaleAuthorization with list input.</p>
    ///
...
impl ResaleAuthorizationProductIdFilter {
    /// Creates a new builder-style object to manufacture [`ResaleAuthorizationProductIdFilter`](crate::types::ResaleAuthorizationProductIdFilter).
    pub fn builder() -> crate::types::builders::ResaleAuthorizationProductIdFilterBuilder {
        crate::types::builders::ResaleAuthorizationProductIdFilterBuilder::default()
    }
}

/// A builder for [`ResaleAuthorizationProductIdFilter`](crate::types::ResaleAuthorizationProductIdFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ResaleAuthorizationProductIdFilterBuilder {
...
impl ResaleAuthorizationProductIdFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`ResaleAuthorizationProductIdFilter`](crate::types::ResaleAuthorizationProductIdFilter).
    pub fn build(self) -> crate::types::ResaleAuthorizationProductIdFilter {
        crate::types::ResaleAuthorizationProductIdFilter {
