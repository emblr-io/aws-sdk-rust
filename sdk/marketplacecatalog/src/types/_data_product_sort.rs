...
impl DataProductSort {
    /// Creates a new builder-style object to manufacture [`DataProductSort`](crate::types::DataProductSort).
    pub fn builder() -> crate::types::builders::DataProductSortBuilder {
        crate::types::builders::DataProductSortBuilder::default()
    }
}
...
impl DataProductSortBuilder {
    /// <p>Field to sort the data products by.</p>
    pub fn sort_by(mut self, input: crate::types::DataProductSortBy) -> Self {
