...
pub struct SaaSProductTitleFilter {
...
impl SaaSProductTitleFilter {
    /// Creates a new builder-style object to manufacture [`SaaSProductTitleFilter`](crate::types::SaaSProductTitleFilter).
    pub fn builder() -> crate::types::builders::SaaSProductTitleFilterBuilder {
        crate::types::builders::SaaSProductTitleFilterBuilder::default()
    }
}

/// A builder for [`SaaSProductTitleFilter`](crate::types::SaaSProductTitleFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SaaSProductTitleFilterBuilder {
...
impl SaaSProductTitleFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`SaaSProductTitleFilter`](crate::types::SaaSProductTitleFilter).
    pub fn build(self) -> crate::types::SaaSProductTitleFilter {
        crate::types::SaaSProductTitleFilter {
