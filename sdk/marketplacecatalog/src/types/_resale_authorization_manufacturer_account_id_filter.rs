...
pub struct ResaleAuthorizationManufacturerAccountIdFilter {
...
impl ResaleAuthorizationManufacturerAccountIdFilter {
    /// <p>Allows filtering on the <code>ManufacturerAccountId</code> of a ResaleAuthorization with list input.</p>
    ///
...
impl ResaleAuthorizationManufacturerAccountIdFilter {
    /// Creates a new builder-style object to manufacture [`ResaleAuthorizationManufacturerAccountIdFilter`](crate::types::ResaleAuthorizationManufacturerAccountIdFilter).
    pub fn builder() -> crate::types::builders::ResaleAuthorizationManufacturerAccountIdFilterBuilder {
        crate::types::builders::ResaleAuthorizationManufacturerAccountIdFilterBuilder::default()
    }
}

/// A builder for [`ResaleAuthorizationManufacturerAccountIdFilter`](crate::types::ResaleAuthorizationManufacturerAccountIdFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ResaleAuthorizationManufacturerAccountIdFilterBuilder {
...
impl ResaleAuthorizationManufacturerAccountIdFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`ResaleAuthorizationManufacturerAccountIdFilter`](crate::types::ResaleAuthorizationManufacturerAccountIdFilter).
    pub fn build(self) -> crate::types::ResaleAuthorizationManufacturerAccountIdFilter {
        crate::types::ResaleAuthorizationManufacturerAccountIdFilter {
