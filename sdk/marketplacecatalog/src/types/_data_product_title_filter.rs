...
pub struct DataProductTitleFilter {
...
impl DataProductTitleFilter {
    /// Creates a new builder-style object to manufacture [`DataProductTitleFilter`](crate::types::DataProductTitleFilter).
    pub fn builder() -> crate::types::builders::DataProductTitleFilterBuilder {
        crate::types::builders::DataProductTitleFilterBuilder::default()
    }
}

/// A builder for [`DataProductTitleFilter`](crate::types::DataProductTitleFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DataProductTitleFilterBuilder {
...
impl DataProductTitleFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`DataProductTitleFilter`](crate::types::DataProductTitleFilter).
    pub fn build(self) -> crate::types::DataProductTitleFilter {
        crate::types::DataProductTitleFilter {
