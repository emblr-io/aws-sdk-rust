...
pub struct DataProductLastModifiedDateFilterDateRange {
...
impl DataProductLastModifiedDateFilterDateRange {
    /// <p>Date after which the data product was last modified.</p>
...
impl DataProductLastModifiedDateFilterDateRange {
    /// Creates a new builder-style object to manufacture [`DataProductLastModifiedDateFilterDateRange`](crate::types::DataProductLastModifiedDateFilterDateRange).
    pub fn builder() -> crate::types::builders::DataProductLastModifiedDateFilterDateRangeBuilder {
        crate::types::builders::DataProductLastModifiedDateFilterDateRangeBuilder::default()
    }
}

/// A builder for [`DataProductLastModifiedDateFilterDateRange`](crate::types::DataProductLastModifiedDateFilterDateRange).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DataProductLastModifiedDateFilterDateRangeBuilder {
    pub(crate) after_value: ::std::option::Option<::std::string::String>,
    pub(crate) before_value: ::std::option::Option<::std::string::String>,
}
impl DataProductLastModifiedDateFilterDateRangeBuilder {
    /// <p>Date after which the data product was last modified.</p>
    ...
    /// Consumes the builder and constructs a [`DataProductLastModifiedDateFilterDateRange`](crate::types::DataProductLastModifiedDateFilterDateRange).
    pub fn build(self) -> crate::types::DataProductLastModifiedDateFilterDateRange {
        crate::types::DataProductLastModifiedDateFilterDateRange {
