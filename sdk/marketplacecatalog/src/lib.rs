...
//! offered by AWS Marketplace Catalog Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Marketplace Catalog Service.
...
/// Configuration for AWS Marketplace Catalog Service.
pub mod config;
