...
impl ::aws_types::request_id::RequestId for AbortEnvironmentUpdateOutput {
...
impl AbortEnvironmentUpdateOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`AbortEnvironmentUpdateOutput`](crate::operation::abort_environment_update::AbortEnvironmentUpdateOutput).
    pub fn build(self) -> crate::operation::abort_environment_update::AbortEnvironmentUpdateOutput {
