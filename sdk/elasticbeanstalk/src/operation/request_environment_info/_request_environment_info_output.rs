...
impl ::aws_types::request_id::RequestId for RequestEnvironmentInfoOutput {
...
impl RequestEnvironmentInfoOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`RequestEnvironmentInfoOutput`](crate::operation::request_environment_info::RequestEnvironmentInfoOutput).
    pub fn build(self) -> crate::operation::request_environment_info::RequestEnvironmentInfoOutput {
