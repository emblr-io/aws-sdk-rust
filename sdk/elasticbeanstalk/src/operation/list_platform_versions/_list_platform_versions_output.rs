...
impl ListPlatformVersionsOutput {
    /// <p>Summary information about the platform versions.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.platform_summary_list.is_none()`.
    pub fn platform_summary_list(&self) -> &[crate::types::PlatformSummary] {
        self.platform_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>In a paginated request, if this value isn't <code>null</code>, it's the token that you can pass in a subsequent request to get the next response page.</p>
...
impl ::aws_types::request_id::RequestId for ListPlatformVersionsOutput {
...
impl ListPlatformVersionsOutputBuilder {
    ...
    pub fn platform_summary_list(mut self, input: crate::types::PlatformSummary) -> Self {
        ...
        v.push(input);
        self.platform_summary_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>Summary information about the platform versions.</p>
