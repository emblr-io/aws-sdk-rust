...
impl ::std::convert::From<&str> for EnvironmentHealthAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnvironmentHealthAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl EnvironmentHealthAttribute {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EnvironmentHealthAttribute::Unknown(value) => value.as_str(),
        }
    }
