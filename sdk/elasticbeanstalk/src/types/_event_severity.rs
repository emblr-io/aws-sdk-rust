...
impl ::std::convert::From<&str> for EventSeverity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventSeverity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventSeverity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventSeverity::from(s))
    }
}
impl EventSeverity {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EventSeverity::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for EventSeverity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
