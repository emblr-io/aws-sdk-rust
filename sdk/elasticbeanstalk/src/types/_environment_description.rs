...
impl EnvironmentDescription {
    /// Creates a new builder-style object to manufacture [`EnvironmentDescription`](crate::types::EnvironmentDescription).
    pub fn builder() -> crate::types::builders::EnvironmentDescriptionBuilder {
        crate::types::builders::EnvironmentDescriptionBuilder::default()
    }
}
...
impl EnvironmentDescriptionBuilder {
    ...
    /// Consumes the builder and constructs a [`EnvironmentDescription`](crate::types::EnvironmentDescription).
    pub fn build(self) -> crate::types::EnvironmentDescription {
        crate::types::EnvironmentDescription {
