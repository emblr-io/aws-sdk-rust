...
//! offered by AWS Elastic Beanstalk. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Elastic Beanstalk.
...
/// For example, the [`AbortEnvironmentUpdate`](crate::operation::abort_environment_update) operation has
/// a [`Client::abort_environment_update`], function which returns a builder for that operation.
