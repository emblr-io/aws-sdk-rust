...
//! offered by AWS Cloud Control API. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Cloud Control API.
...
/// For example, the [`CancelResourceRequest`](crate::operation::cancel_resource_request) operation has
...
/// Configuration for AWS Cloud Control API.
pub mod config;
