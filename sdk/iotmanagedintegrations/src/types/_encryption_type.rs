...
///     EncryptionType::CustomerKeyEncryption => { /* ... */ },
///     EncryptionType::ManagedIntegrationsDefaultEncryption => { /* ... */ },
...
impl ::std::convert::From<&str> for EncryptionType {
    fn from(s: &str) -> Self {
        match s {
            "CUSTOMER_KEY_ENCRYPTION" => EncryptionType::CustomerKeyEncryption,
            "MANAGED_INTEGRATIONS_DEFAULT_ENCRYPTION" => EncryptionType::ManagedIntegrationsDefaultEncryption,
...
impl EncryptionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EncryptionType::CustomerKeyEncryption => "CUSTOMER_KEY_ENCRYPTION",
            EncryptionType::ManagedIntegrationsDefaultEncryption => "MANAGED_INTEGRATIONS_DEFAULT_ENCRYPTION",
            EncryptionType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["CUSTOMER_KEY_ENCRYPTION", "MANAGED_INTEGRATIONS_DEFAULT_ENCRYPTION"]
    }
}
