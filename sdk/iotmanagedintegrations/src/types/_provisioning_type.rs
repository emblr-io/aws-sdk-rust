...
///     ProvisioningType::FleetProvisioning => { /* ... */ },
///     ProvisioningType::Jitr => { /* ... */ },
...
impl ::std::convert::From<&str> for ProvisioningType {
    fn from(s: &str) -> Self {
        match s {
            "FLEET_PROVISIONING" => ProvisioningType::FleetProvisioning,
            "JITR" => ProvisioningType::Jitr,
            other => ProvisioningType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisioningType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisioningType::from(s))
    }
}
impl ProvisioningType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ProvisioningType::FleetProvisioning => "FLEET_PROVISIONING",
            ProvisioningType::Jitr => "JITR",
...
impl ::std::convert::AsRef<str> for ProvisioningType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
