...
impl ::std::convert::From<&str> for ConfigurationState {
    fn from(s: &str) -> Self {
        match s {
            "ENABLED" => ConfigurationState::Enabled,
            "UPDATE_FAILED" => ConfigurationState::UpdateFailed,
            "UPDATE_IN_PROGRESS" => ConfigurationState::UpdateInProgress,
            other => ConfigurationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigurationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigurationState::from(s))
    }
}
impl ConfigurationState {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ENABLED", "UPDATE_FAILED", "UPDATE_IN_PROGRESS"]
    }
}
impl ::std::convert::AsRef<str> for ConfigurationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
