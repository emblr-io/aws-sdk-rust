...
pub struct ListAccountAssociationsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::AccountAssociationItem>>,
...
impl ListAccountAssociationsOutput {
    ...
    pub fn items(&self) -> &[crate::types::AccountAssociationItem] {
...
pub struct ListAccountAssociationsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::AccountAssociationItem>>,
...
impl ListAccountAssociationsOutputBuilder {
    ...
    ///
    /// <p>The list of account associations that match the specified criteria.</p>
    pub fn items(mut self, input: crate::types::AccountAssociationItem) -> Self {
    ...
    /// <p>The list of account associations that match the specified criteria.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::AccountAssociationItem>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The list of account associations that match the specified criteria.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::AccountAssociationItem>> {
        &self.items
    }
    /// <p>A token used for pagination of results when there are more account associations than can be returned in a single response.</p>
