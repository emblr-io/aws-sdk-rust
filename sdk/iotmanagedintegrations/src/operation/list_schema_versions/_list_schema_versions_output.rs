...
pub struct ListSchemaVersionsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::SchemaVersionListItem>>,
...
impl ListSchemaVersionsOutput {
    ...
    pub fn items(&self) -> &[crate::types::SchemaVersionListItem] {
...
pub struct ListSchemaVersionsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::SchemaVersionListItem>>,
...
impl ListSchemaVersionsOutputBuilder {
    ...
    ///
    /// <p>The list of schema versions.</p>
    pub fn items(mut self, input: crate::types::SchemaVersionListItem) -> Self {
    ...
    /// <p>The list of schema versions.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::SchemaVersionListItem>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The list of schema versions.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::SchemaVersionListItem>> {
        &self.items
    }
    /// <p>A token that can be used to retrieve the next set of results.</p>
