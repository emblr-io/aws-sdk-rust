...
impl ::std::convert::From<&str> for TargetStatus {
    fn from(s: &str) -> Self {
        match s {
            "DRAINING" => TargetStatus::Draining,
            "HEALTHY" => TargetStatus::Healthy,
            "INITIAL" => TargetStatus::Initial,
            "UNAVAILABLE" => TargetStatus::Unavailable,
            "UNHEALTHY" => TargetStatus::Unhealthy,
            "UNUSED" => TargetStatus::Unused,
...
impl TargetStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TargetStatus::Initial => "INITIAL",
            TargetStatus::Unavailable => "UNAVAILABLE",
            TargetStatus::Unhealthy => "UNHEALTHY",
            TargetStatus::Unused => "UNUSED",
