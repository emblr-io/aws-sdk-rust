...
//! offered by Amazon VPC Lattice. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon VPC Lattice.
...
/// Configuration for Amazon VPC Lattice.
pub mod config;
