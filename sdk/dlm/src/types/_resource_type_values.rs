...
impl ::std::convert::From<&str> for ResourceTypeValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceTypeValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceTypeValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceTypeValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceTypeValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ResourceTypeValues {
