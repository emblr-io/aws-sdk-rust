...
impl ::std::convert::From<&str> for LocationValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            "LOCAL_ZONE" => LocationValues::LocalZone,
            "OUTPOST_LOCAL" => LocationValues::OutpostLocal,
            other => LocationValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocationValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocationValues::from(s))
    }
}
impl LocationValues {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            LocationValues::LocalZone => "LOCAL_ZONE",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CLOUD", "LOCAL_ZONE", "OUTPOST_LOCAL"]
    }
}
impl ::std::convert::AsRef<str> for LocationValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
