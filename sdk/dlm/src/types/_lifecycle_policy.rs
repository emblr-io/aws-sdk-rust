...
pub struct LifecyclePolicy {
    ...
    /// <p>Indicates whether the policy is a default lifecycle policy or a custom lifecycle policy.</p>
    /// <ul>
    /// <li>
    /// <p><code>true</code> - the policy is a default policy.</p></li>
    /// <li>
    /// <p><code>false</code> - the policy is a custom policy.</p></li>
    /// </ul>
