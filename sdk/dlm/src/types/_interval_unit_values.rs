...
impl ::std::convert::From<&str> for IntervalUnitValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IntervalUnitValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IntervalUnitValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IntervalUnitValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IntervalUnitValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for IntervalUnitValues {
