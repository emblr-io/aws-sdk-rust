...
impl ::std::convert::From<&str> for EventSourceValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventSourceValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventSourceValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventSourceValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventSourceValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
