...
impl ::std::convert::From<&str> for EventTypeValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventTypeValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventTypeValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventTypeValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventTypeValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EventTypeValues {
