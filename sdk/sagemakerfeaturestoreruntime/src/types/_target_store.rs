...
impl ::std::convert::From<&str> for TargetStore {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetStore::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetStore {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetStore::from(s))
    }
}
impl TargetStore {
...
impl ::std::convert::AsRef<str> for TargetStore {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
