...
//! offered by Amazon SageMaker Feature Store Runtime. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon SageMaker Feature Store Runtime.
...
/// For example, the [`BatchGetRecord`](crate::operation::batch_get_record) operation has
/// a [`Client::batch_get_record`], function which returns a builder for that operation.
...
/// Configuration for Amazon SageMaker Feature Store Runtime.
pub mod config;
