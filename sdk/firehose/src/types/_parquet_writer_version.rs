...
impl ::std::convert::From<&str> for ParquetWriterVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParquetWriterVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParquetWriterVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParquetWriterVersion::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ParquetWriterVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
