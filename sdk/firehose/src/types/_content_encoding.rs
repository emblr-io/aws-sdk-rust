...
impl ::std::convert::From<&str> for ContentEncoding {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentEncoding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentEncoding {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentEncoding::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContentEncoding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
