...
impl ::std::convert::From<&str> for SnapshotStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnapshotStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnapshotStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnapshotStatus::from(s))
    }
}
impl SnapshotStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SnapshotStatus::Suspended => "SUSPENDED",
            SnapshotStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["COMPLETE", "IN_PROGRESS", "SUSPENDED"]
    }
}
...
impl ::std::fmt::Display for SnapshotStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            SnapshotStatus::Suspended => write!(f, "SUSPENDED"),
