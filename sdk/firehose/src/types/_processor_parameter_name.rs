...
impl ::std::convert::From<&str> for ProcessorParameterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProcessorParameterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProcessorParameterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProcessorParameterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProcessorParameterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
