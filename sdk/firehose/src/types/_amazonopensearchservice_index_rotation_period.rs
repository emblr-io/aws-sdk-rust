...
impl ::std::convert::From<&str> for AmazonopensearchserviceIndexRotationPeriod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                AmazonopensearchserviceIndexRotationPeriod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for AmazonopensearchserviceIndexRotationPeriod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AmazonopensearchserviceIndexRotationPeriod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AmazonopensearchserviceIndexRotationPeriod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
