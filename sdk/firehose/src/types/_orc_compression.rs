...
impl ::std::convert::From<&str> for OrcCompression {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrcCompression::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrcCompression {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrcCompression::from(s))
    }
}
impl OrcCompression {
...
impl ::std::convert::AsRef<str> for OrcCompression {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
