...
impl ::std::convert::From<&str> for OrcFormatVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrcFormatVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrcFormatVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrcFormatVersion::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrcFormatVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
