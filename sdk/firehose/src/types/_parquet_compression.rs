...
impl ::std::convert::From<&str> for ParquetCompression {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParquetCompression::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParquetCompression {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParquetCompression::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ParquetCompression {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
