...
impl ::std::convert::From<&str> for ElasticsearchIndexRotationPeriod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElasticsearchIndexRotationPeriod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ElasticsearchIndexRotationPeriod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ElasticsearchIndexRotationPeriod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ElasticsearchIndexRotationPeriod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
