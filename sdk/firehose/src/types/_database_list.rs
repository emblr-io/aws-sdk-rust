...
/// <p>The structure used to configure the list of database patterns in source database endpoint for Firehose to read from.</p>
...
pub struct DatabaseList {
    /// <p>The list of database patterns in source database endpoint to be included for Firehose to read from.</p>
    /// <p>Amazon Data Firehose is in preview release and is subject to change.</p>
    pub include: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    /// <p>The list of database patterns in source database endpoint to be excluded for Firehose to read from.</p>
    /// <p>Amazon Data Firehose is in preview release and is subject to change.</p>
...
impl DatabaseList {
    /// Creates a new builder-style object to manufacture [`DatabaseList`](crate::types::DatabaseList).
    pub fn builder() -> crate::types::builders::DatabaseListBuilder {
        crate::types::builders::DatabaseListBuilder::default()
    }
}

/// A builder for [`DatabaseList`](crate::types::DatabaseList).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DatabaseListBuilder {
...
impl DatabaseListBuilder {
    ...
    /// Consumes the builder and constructs a [`DatabaseList`](crate::types::DatabaseList).
    pub fn build(self) -> crate::types::DatabaseList {
        crate::types::DatabaseList {
