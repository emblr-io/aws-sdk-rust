...
impl ::std::convert::From<&str> for RedshiftS3BackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RedshiftS3BackupMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RedshiftS3BackupMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RedshiftS3BackupMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RedshiftS3BackupMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
