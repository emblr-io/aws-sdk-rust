...
//! offered by Amazon Kinesis Firehose. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Kinesis Firehose.
...
/// For example, the [`CreateDeliveryStream`](crate::operation::create_delivery_stream) operation has
/// a [`Client::create_delivery_stream`], function which returns a builder for that operation.
...
/// Configuration for Amazon Kinesis Firehose.
pub mod config;
