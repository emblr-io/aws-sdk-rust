...
//! aws-sdk-cleanrooms = "0.0.0-local"
...
//! offered by AWS Clean Rooms Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Clean Rooms Service.
