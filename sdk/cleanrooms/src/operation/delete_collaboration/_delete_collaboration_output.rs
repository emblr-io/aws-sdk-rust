...
impl ::aws_types::request_id::RequestId for DeleteCollaborationOutput {
...
impl DeleteCollaborationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteCollaborationOutput`](crate::operation::delete_collaboration::DeleteCollaborationOutput).
    pub fn build(self) -> crate::operation::delete_collaboration::DeleteCollaborationOutput {
