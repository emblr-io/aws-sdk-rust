...
pub struct DeleteConfiguredTableAssociationAnalysisRuleInput {
...
impl DeleteConfiguredTableAssociationAnalysisRuleInput {
    /// <p>A unique identifier for the membership that the configured table association belongs to. Currently accepts the membership ID.</p>
...
impl DeleteConfiguredTableAssociationAnalysisRuleInput {
    /// Creates a new builder-style object to manufacture [`DeleteConfiguredTableAssociationAnalysisRuleInput`](crate::operation::delete_configured_table_association_analysis_rule::DeleteConfiguredTableAssociationAnalysisRuleInput).
    pub fn builder(
    ) -> crate::operation::delete_configured_table_association_analysis_rule::builders::DeleteConfiguredTableAssociationAnalysisRuleInputBuilder {
        crate::operation::delete_configured_table_association_analysis_rule::builders::DeleteConfiguredTableAssociationAnalysisRuleInputBuilder::default()
    }
}

/// A builder for [`DeleteConfiguredTableAssociationAnalysisRuleInput`](crate::operation::delete_configured_table_association_analysis_rule::DeleteConfiguredTableAssociationAnalysisRuleInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteConfiguredTableAssociationAnalysisRuleInputBuilder {
...
impl DeleteConfiguredTableAssociationAnalysisRuleInputBuilder {
    /// <p>A unique identifier for the membership that the configured table association belongs to. Currently accepts the membership ID.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteConfiguredTableAssociationAnalysisRuleInput`](crate::operation::delete_configured_table_association_analysis_rule::DeleteConfiguredTableAssociationAnalysisRuleInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::delete_configured_table_association_analysis_rule::DeleteConfiguredTableAssociationAnalysisRuleInput,
