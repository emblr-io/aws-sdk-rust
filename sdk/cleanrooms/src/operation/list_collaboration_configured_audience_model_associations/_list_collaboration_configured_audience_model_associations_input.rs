...
pub struct ListCollaborationConfiguredAudienceModelAssociationsInput {
...
impl ListCollaborationConfiguredAudienceModelAssociationsInput {
    /// <p>A unique identifier for the collaboration that the configured audience model association belongs to. Accepts a collaboration ID.</p>
...
impl ListCollaborationConfiguredAudienceModelAssociationsInput {
    /// Creates a new builder-style object to manufacture [`ListCollaborationConfiguredAudienceModelAssociationsInput`](crate::operation::list_collaboration_configured_audience_model_associations::ListCollaborationConfiguredAudienceModelAssociationsInput).
    pub fn builder() -> crate::operation::list_collaboration_configured_audience_model_associations::builders::ListCollaborationConfiguredAudienceModelAssociationsInputBuilder{
        crate::operation::list_collaboration_configured_audience_model_associations::builders::ListCollaborationConfiguredAudienceModelAssociationsInputBuilder::default()
    }
}
...
impl ListCollaborationConfiguredAudienceModelAssociationsInputBuilder {
    /// <p>A unique identifier for the collaboration that the configured audience model association belongs to. Accepts a collaboration ID.</p>
    ...
    /// Consumes the builder and constructs a [`ListCollaborationConfiguredAudienceModelAssociationsInput`](crate::operation::list_collaboration_configured_audience_model_associations::ListCollaborationConfiguredAudienceModelAssociationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::list_collaboration_configured_audience_model_associations::ListCollaborationConfiguredAudienceModelAssociationsInput,
