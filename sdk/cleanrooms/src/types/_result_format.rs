...
impl ::std::convert::From<&str> for ResultFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResultFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResultFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResultFormat::from(s))
    }
}
impl ResultFormat {
...
impl ::std::convert::AsRef<str> for ResultFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ResultFormat {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ResultFormat::Parquet => write!(f, "PARQUET"),
            ResultFormat::Unknown(value) => write!(f, "{}", value),
        }
    }
}
