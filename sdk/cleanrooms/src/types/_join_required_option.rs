...
impl ::std::convert::From<&str> for JoinRequiredOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JoinRequiredOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JoinRequiredOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JoinRequiredOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JoinRequiredOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for JoinRequiredOption {
