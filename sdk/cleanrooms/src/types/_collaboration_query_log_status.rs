...
impl ::std::convert::From<&str> for CollaborationQueryLogStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CollaborationQueryLogStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CollaborationQueryLogStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CollaborationQueryLogStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CollaborationQueryLogStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
