...
pub struct ConfiguredTableAssociationAnalysisRuleAggregation {
    ...
    /// <p>The <code>allowedAdditionalAnalyses</code> parameter is currently supported for the list analysis rule (<code>AnalysisRuleList</code>) and the custom analysis rule (<code>AnalysisRuleCustom</code>).</p>
    pub allowed_additional_analyses: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
}
impl ConfiguredTableAssociationAnalysisRuleAggregation {
    /// <p>The list of collaboration members who are allowed to receive results of queries run with this configured table.</p>
    ///
...
impl ConfiguredTableAssociationAnalysisRuleAggregation {
    /// Creates a new builder-style object to manufacture [`ConfiguredTableAssociationAnalysisRuleAggregation`](crate::types::ConfiguredTableAssociationAnalysisRuleAggregation).
    pub fn builder() -> crate::types::builders::ConfiguredTableAssociationAnalysisRuleAggregationBuilder {
        crate::types::builders::ConfiguredTableAssociationAnalysisRuleAggregationBuilder::default()
    }
}

/// A builder for [`ConfiguredTableAssociationAnalysisRuleAggregation`](crate::types::ConfiguredTableAssociationAnalysisRuleAggregation).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ConfiguredTableAssociationAnalysisRuleAggregationBuilder {
...
impl ConfiguredTableAssociationAnalysisRuleAggregationBuilder {
    ...
    /// Consumes the builder and constructs a [`ConfiguredTableAssociationAnalysisRuleAggregation`](crate::types::ConfiguredTableAssociationAnalysisRuleAggregation).
    pub fn build(self) -> crate::types::ConfiguredTableAssociationAnalysisRuleAggregation {
        crate::types::ConfiguredTableAssociationAnalysisRuleAggregation {
