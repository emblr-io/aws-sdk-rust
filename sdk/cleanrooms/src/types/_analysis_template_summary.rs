...
impl AnalysisTemplateSummary {
    ...
    pub fn builder() -> crate::types::builders::AnalysisTemplateSummaryBuilder {
        crate::types::builders::AnalysisTemplateSummaryBuilder::default()
    }
}

/// A builder for [`AnalysisTemplateSummary`](crate::types::AnalysisTemplateSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AnalysisTemplateSummaryBuilder {
...
impl AnalysisTemplateSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AnalysisTemplateSummary, ::aws_smithy_types::error::operation::BuildError> {
