...
impl ::std::convert::From<&str> for ProtectedQueryType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProtectedQueryType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProtectedQueryType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProtectedQueryType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProtectedQueryType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ProtectedQueryType {
