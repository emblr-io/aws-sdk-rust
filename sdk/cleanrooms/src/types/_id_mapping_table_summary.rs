...
pub struct IdMappingTableSummary {
...
impl IdMappingTableSummary {
    /// Creates a new builder-style object to manufacture [`IdMappingTableSummary`](crate::types::IdMappingTableSummary).
    pub fn builder() -> crate::types::builders::IdMappingTableSummaryBuilder {
        crate::types::builders::IdMappingTableSummaryBuilder::default()
    }
}

/// A builder for [`IdMappingTableSummary`](crate::types::IdMappingTableSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct IdMappingTableSummaryBuilder {
...
impl IdMappingTableSummaryBuilder {
    /// <p>The Amazon Resource Name (ARN) of the collaboration that contains this ID mapping table.</p>
    ...
    /// Consumes the builder and constructs a [`IdMappingTableSummary`](crate::types::IdMappingTableSummary).
    /// This method will fail if any of the following fields are not set:
    /// - [`collaboration_arn`](crate::types::builders::IdMappingTableSummaryBuilder::collaboration_arn)
    /// - [`collaboration_id`](crate::types::builders::IdMappingTableSummaryBuilder::collaboration_id)
    /// - [`membership_id`](crate::types::builders::IdMappingTableSummaryBuilder::membership_id)
    /// - [`membership_arn`](crate::types::builders::IdMappingTableSummaryBuilder::membership_arn)
    /// - [`create_time`](crate::types::builders::IdMappingTableSummaryBuilder::create_time)
    /// - [`update_time`](crate::types::builders::IdMappingTableSummaryBuilder::update_time)
    /// - [`id`](crate::types::builders::IdMappingTableSummaryBuilder::id)
    /// - [`arn`](crate::types::builders::IdMappingTableSummaryBuilder::arn)
    /// - [`name`](crate::types::builders::IdMappingTableSummaryBuilder::name)
    pub fn build(self) -> ::std::result::Result<crate::types::IdMappingTableSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::IdMappingTableSummary {
            collaboration_arn: self.collaboration_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "collaboration_arn",
                    "collaboration_arn was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            collaboration_id: self.collaboration_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "collaboration_id",
                    "collaboration_id was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            membership_id: self.membership_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "membership_id",
                    "membership_id was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            membership_arn: self.membership_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "membership_arn",
                    "membership_arn was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            create_time: self.create_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "create_time",
                    "create_time was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            update_time: self.update_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "update_time",
                    "update_time was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
            ...
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building IdMappingTableSummary",
                )
            })?,
        })
    }
