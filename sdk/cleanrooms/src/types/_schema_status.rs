...
impl ::std::convert::From<&str> for SchemaStatus {
    fn from(s: &str) -> Self {
        match s {
            "NOT_READY" => SchemaStatus::NotReady,
            "READY" => SchemaStatus::Ready,
            other => SchemaStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SchemaStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SchemaStatus::from(s))
    }
}
impl SchemaStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SchemaStatus::NotReady => "NOT_READY",
