...
impl ::std::convert::From<&str> for ProtectedQueryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProtectedQueryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProtectedQueryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProtectedQueryStatus::from(s))
    }
}
