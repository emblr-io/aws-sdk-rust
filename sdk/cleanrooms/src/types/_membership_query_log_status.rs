...
impl ::std::convert::From<&str> for MembershipQueryLogStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MembershipQueryLogStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MembershipQueryLogStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MembershipQueryLogStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MembershipQueryLogStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
