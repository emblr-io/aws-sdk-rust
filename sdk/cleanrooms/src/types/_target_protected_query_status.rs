...
impl ::std::convert::From<&str> for TargetProtectedQueryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetProtectedQueryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetProtectedQueryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetProtectedQueryStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TargetProtectedQueryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TargetProtectedQueryStatus {
