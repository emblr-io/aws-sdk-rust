...
impl ::std::convert::From<&str> for FilterableMemberStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterableMemberStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterableMemberStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterableMemberStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterableMemberStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
