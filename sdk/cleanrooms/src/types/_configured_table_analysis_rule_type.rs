...
impl ::std::convert::From<&str> for ConfiguredTableAnalysisRuleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfiguredTableAnalysisRuleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfiguredTableAnalysisRuleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfiguredTableAnalysisRuleType::from(s))
    }
}
