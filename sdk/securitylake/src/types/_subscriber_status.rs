...
impl ::std::convert::From<&str> for SubscriberStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SubscriberStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubscriberStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubscriberStatus::from(s))
    }
}
impl SubscriberStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SubscriberStatus::Deactivated => "DEACTIVATED",
            SubscriberStatus::Pending => "PENDING",
            SubscriberStatus::Ready => "READY",
...
impl ::std::convert::AsRef<str> for SubscriberStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
