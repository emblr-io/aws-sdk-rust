...
impl UpdateSubscriberNotificationOutput {
    ...
    pub fn builder() -> crate::operation::update_subscriber_notification::builders::UpdateSubscriberNotificationOutputBuilder {
        crate::operation::update_subscriber_notification::builders::UpdateSubscriberNotificationOutputBuilder::default()
    }
}

/// A builder for [`UpdateSubscriberNotificationOutput`](crate::operation::update_subscriber_notification::UpdateSubscriberNotificationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateSubscriberNotificationOutputBuilder {
    pub(crate) subscriber_endpoint: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl UpdateSubscriberNotificationOutputBuilder {
    /// <p>The subscriber endpoint to which exception messages are posted.</p>
