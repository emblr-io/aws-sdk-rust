...
//! offered by AWS Certificate Manager Private Certificate Authority. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Certificate Manager Private Certificate Authority.
...
/// For example, the [`CreateCertificateAuthority`](crate::operation::create_certificate_authority) operation has
/// a [`Client::create_certificate_authority`], function which returns a builder for that operation.
