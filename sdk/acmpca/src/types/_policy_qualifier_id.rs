...
impl ::std::convert::From<&str> for PolicyQualifierId {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PolicyQualifierId::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PolicyQualifierId {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyQualifierId::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PolicyQualifierId {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PolicyQualifierId {
