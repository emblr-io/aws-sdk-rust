...
impl ::aws_types::request_id::RequestId for crate::types::error::PermissionAlreadyExistsException {
...
impl PermissionAlreadyExistsException {
    ...
    pub fn builder() -> crate::types::error::builders::PermissionAlreadyExistsExceptionBuilder {
        crate::types::error::builders::PermissionAlreadyExistsExceptionBuilder::default()
    }
}

/// A builder for [`PermissionAlreadyExistsException`](crate::types::error::PermissionAlreadyExistsException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PermissionAlreadyExistsExceptionBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl PermissionAlreadyExistsExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    pub fn build(self) -> crate::types::error::PermissionAlreadyExistsException {
