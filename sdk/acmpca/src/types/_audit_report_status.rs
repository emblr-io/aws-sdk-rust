...
impl ::std::convert::From<&str> for AuditReportStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditReportStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditReportStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditReportStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuditReportStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
