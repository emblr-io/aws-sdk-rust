...
impl ::std::convert::From<&str> for CertificateAuthorityUsageMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CertificateAuthorityUsageMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CertificateAuthorityUsageMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CertificateAuthorityUsageMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CertificateAuthorityUsageMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
