...
impl ::aws_types::request_id::RequestId for DeleteDatasetContentOutput {
...
impl DeleteDatasetContentOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteDatasetContentOutput`](crate::operation::delete_dataset_content::DeleteDatasetContentOutput).
    pub fn build(self) -> crate::operation::delete_dataset_content::DeleteDatasetContentOutput {
