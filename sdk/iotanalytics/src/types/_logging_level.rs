...
impl ::std::convert::From<&str> for LoggingLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoggingLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoggingLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoggingLevel::from(s))
    }
}
impl LoggingLevel {
...
impl ::std::convert::AsRef<str> for LoggingLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
