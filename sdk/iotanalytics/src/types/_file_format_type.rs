...
impl ::std::convert::From<&str> for FileFormatType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FileFormatType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FileFormatType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FileFormatType::from(s))
    }
}
impl FileFormatType {
...
impl ::std::convert::AsRef<str> for FileFormatType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
