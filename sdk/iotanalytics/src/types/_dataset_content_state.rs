...
impl ::std::convert::From<&str> for DatasetContentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatasetContentState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatasetContentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatasetContentState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatasetContentState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
