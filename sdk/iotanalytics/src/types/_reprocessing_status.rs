...
impl ::std::convert::From<&str> for ReprocessingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReprocessingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReprocessingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReprocessingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReprocessingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
