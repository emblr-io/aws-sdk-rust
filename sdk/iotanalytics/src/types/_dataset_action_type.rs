...
impl ::std::convert::From<&str> for DatasetActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatasetActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatasetActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatasetActionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatasetActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
