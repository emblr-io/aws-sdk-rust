...
impl ::std::convert::From<&str> for FailbackLaunchType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailbackLaunchType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailbackLaunchType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailbackLaunchType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FailbackLaunchType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
