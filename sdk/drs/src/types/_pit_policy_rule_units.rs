...
impl ::std::convert::From<&str> for PitPolicyRuleUnits {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PitPolicyRuleUnits::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PitPolicyRuleUnits {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PitPolicyRuleUnits::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PitPolicyRuleUnits {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
