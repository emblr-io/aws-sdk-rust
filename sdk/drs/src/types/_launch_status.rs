...
impl ::std::convert::From<&str> for LaunchStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LaunchStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LaunchStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchStatus::from(s))
    }
}
impl LaunchStatus {
...
impl ::std::convert::AsRef<str> for LaunchStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LaunchStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            LaunchStatus::InProgress => write!(f, "IN_PROGRESS"),
