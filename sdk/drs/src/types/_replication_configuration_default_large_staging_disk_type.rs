...
impl ::std::convert::From<&str> for ReplicationConfigurationDefaultLargeStagingDiskType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicationConfigurationDefaultLargeStagingDiskType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::str::FromStr for ReplicationConfigurationDefaultLargeStagingDiskType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationConfigurationDefaultLargeStagingDiskType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReplicationConfigurationDefaultLargeStagingDiskType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ReplicationConfigurationDefaultLargeStagingDiskType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ReplicationConfigurationDefaultLargeStagingDiskType::Auto => write!(f, "AUTO"),
