...
impl LaunchAction {
    /// Creates a new builder-style object to manufacture [`LaunchAction`](crate::types::LaunchAction).
    pub fn builder() -> crate::types::builders::LaunchActionBuilder {
        crate::types::builders::LaunchActionBuilder::default()
    }
}

/// A builder for [`LaunchAction`](crate::types::LaunchAction).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LaunchActionBuilder {
...
impl LaunchActionBuilder {
    ...
    /// Consumes the builder and constructs a [`LaunchAction`](crate::types::LaunchAction).
    pub fn build(self) -> crate::types::LaunchAction {
        crate::types::LaunchAction {
