...
impl ::std::convert::From<&str> for RecoveryInstanceDataReplicationInitiationStepStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecoveryInstanceDataReplicationInitiationStepStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::str::FromStr for RecoveryInstanceDataReplicationInitiationStepStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecoveryInstanceDataReplicationInitiationStepStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecoveryInstanceDataReplicationInitiationStepStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
