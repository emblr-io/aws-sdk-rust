...
impl ::std::convert::From<&str> for ReplicationConfigurationEbsEncryption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicationConfigurationEbsEncryption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationConfigurationEbsEncryption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationConfigurationEbsEncryption::from(s))
    }
}
...
impl ::std::fmt::Display for ReplicationConfigurationEbsEncryption {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ReplicationConfigurationEbsEncryption::None => write!(f, "NONE"),
