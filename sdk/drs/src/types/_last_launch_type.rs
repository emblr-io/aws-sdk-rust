...
impl ::std::convert::From<&str> for LastLaunchType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LastLaunchType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LastLaunchType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LastLaunchType::from(s))
    }
}
impl LastLaunchType {
...
impl ::std::convert::AsRef<str> for LastLaunchType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
