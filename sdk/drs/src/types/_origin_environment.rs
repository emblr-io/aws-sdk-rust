...
impl ::std::convert::From<&str> for OriginEnvironment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OriginEnvironment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OriginEnvironment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OriginEnvironment::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OriginEnvironment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
