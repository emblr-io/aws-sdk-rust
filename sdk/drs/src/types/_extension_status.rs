...
impl ::std::convert::From<&str> for ExtensionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExtensionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExtensionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExtensionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExtensionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
