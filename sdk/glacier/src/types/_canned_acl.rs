...
impl ::std::convert::From<&str> for CannedAcl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CannedAcl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CannedAcl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CannedAcl::from(s))
    }
}
impl CannedAcl {
...
impl ::std::convert::AsRef<str> for CannedAcl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CannedAcl {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            CannedAcl::AwsExecRead => write!(f, "aws-exec-read"),
            ...
            CannedAcl::Unknown(value) => write!(f, "{}", value),
        }
    }
}
