...
impl ::std::convert::From<&str> for ResourceSortType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceSortType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceSortType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceSortType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceSortType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
