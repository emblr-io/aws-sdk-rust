...
impl ::std::convert::From<&str> for DocumentStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DocumentStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DocumentStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DocumentStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DocumentStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
