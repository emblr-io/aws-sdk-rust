...
impl ::std::convert::From<&str> for ResourceStateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceStateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceStateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceStateType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceStateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
