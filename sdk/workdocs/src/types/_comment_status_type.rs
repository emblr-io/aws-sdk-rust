...
impl ::std::convert::From<&str> for CommentStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CommentStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CommentStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CommentStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CommentStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
