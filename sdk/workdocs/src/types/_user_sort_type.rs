...
impl ::std::convert::From<&str> for UserSortType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UserSortType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UserSortType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UserSortType::from(s))
    }
}
impl UserSortType {
...
impl ::std::convert::AsRef<str> for UserSortType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
