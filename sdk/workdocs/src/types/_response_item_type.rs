...
/// When writing a match expression against `ResponseItemType`, it is important to ensure
...
///     ResponseItemType::Comment => { /* ... */ },
///     ResponseItemType::Document => { /* ... */ },
///     ResponseItemType::DocumentVersion => { /* ... */ },
///     ResponseItemType::Folder => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `responseitemtype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ResponseItemType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ResponseItemType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ResponseItemType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ResponseItemType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResponseItemType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResponseItemType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResponseItemType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResponseItemType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
