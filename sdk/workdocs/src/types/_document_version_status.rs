...
impl ::std::convert::From<&str> for DocumentVersionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DocumentVersionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DocumentVersionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DocumentVersionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DocumentVersionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DocumentVersionStatus {
