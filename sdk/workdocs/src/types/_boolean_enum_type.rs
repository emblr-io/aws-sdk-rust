...
impl ::std::convert::From<&str> for BooleanEnumType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BooleanEnumType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BooleanEnumType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BooleanEnumType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BooleanEnumType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
