...
impl ::std::convert::From<&str> for UserFilterType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UserFilterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UserFilterType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UserFilterType::from(s))
    }
}
impl UserFilterType {
...
impl ::std::convert::AsRef<str> for UserFilterType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for UserFilterType {
