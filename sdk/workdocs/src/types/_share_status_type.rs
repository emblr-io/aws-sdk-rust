...
impl ::std::convert::From<&str> for ShareStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ShareStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShareStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShareStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ShareStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
