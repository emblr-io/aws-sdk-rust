...
impl ::std::convert::From<&str> for RolePermissionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RolePermissionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RolePermissionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RolePermissionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RolePermissionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
