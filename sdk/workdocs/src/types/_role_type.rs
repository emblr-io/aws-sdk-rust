...
impl ::std::convert::From<&str> for RoleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RoleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RoleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RoleType::from(s))
    }
}
impl RoleType {
...
impl ::std::convert::AsRef<str> for RoleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
