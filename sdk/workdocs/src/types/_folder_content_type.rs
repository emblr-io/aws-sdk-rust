...
impl ::std::convert::From<&str> for FolderContentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FolderContentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FolderContentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FolderContentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FolderContentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
