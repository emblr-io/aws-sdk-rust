...
impl ::aws_types::request_id::RequestId for DeleteFolderContentsOutput {
...
impl DeleteFolderContentsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteFolderContentsOutput`](crate::operation::delete_folder_contents::DeleteFolderContentsOutput).
    pub fn build(self) -> crate::operation::delete_folder_contents::DeleteFolderContentsOutput {
