...
impl ::aws_types::request_id::RequestId for DeleteDocumentVersionOutput {
...
impl DeleteDocumentVersionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteDocumentVersionOutput`](crate::operation::delete_document_version::DeleteDocumentVersionOutput).
    pub fn build(self) -> crate::operation::delete_document_version::DeleteDocumentVersionOutput {
