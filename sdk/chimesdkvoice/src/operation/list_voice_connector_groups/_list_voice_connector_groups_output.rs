...
impl ListVoiceConnectorGroupsOutput {
    /// <p>The details of the Voice Connector groups.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.voice_connector_groups.is_none()`.
    pub fn voice_connector_groups(&self) -> &[crate::types::VoiceConnectorGroup] {
        self.voice_connector_groups.as_deref().unwrap_or_default()
    }
    /// <p>The token used to return the next page of results.</p>
...
impl ::aws_types::request_id::RequestId for ListVoiceConnectorGroupsOutput {
...
impl ListVoiceConnectorGroupsOutputBuilder {
    ...
    pub fn voice_connector_groups(mut self, input: crate::types::VoiceConnectorGroup) -> Self {
        ...
        v.push(input);
        self.voice_connector_groups = ::std::option::Option::Some(v);
        self
    }
    /// <p>The details of the Voice Connector groups.</p>
