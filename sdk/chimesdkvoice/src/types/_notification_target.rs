...
impl ::std::convert::From<&str> for NotificationTarget {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotificationTarget::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotificationTarget {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotificationTarget::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NotificationTarget {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
