...
impl ::std::convert::From<&str> for ProxySessionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProxySessionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProxySessionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProxySessionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProxySessionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
