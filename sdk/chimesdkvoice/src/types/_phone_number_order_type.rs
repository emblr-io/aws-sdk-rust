...
impl ::std::convert::From<&str> for PhoneNumberOrderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PhoneNumberOrderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PhoneNumberOrderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PhoneNumberOrderType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PhoneNumberOrderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
