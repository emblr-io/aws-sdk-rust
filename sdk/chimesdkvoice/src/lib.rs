...
//! offered by Amazon Chime SDK Voice. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Chime SDK Voice.
...
/// Configuration for Amazon Chime SDK Voice.
pub mod config;
