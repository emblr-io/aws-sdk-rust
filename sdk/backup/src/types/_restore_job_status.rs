...
impl ::std::convert::From<&str> for RestoreJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RestoreJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RestoreJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RestoreJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RestoreJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
