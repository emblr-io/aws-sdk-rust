...
impl ::std::convert::From<&str> for BackupJobState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BackupJobState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BackupJobState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BackupJobState::from(s))
    }
}
impl BackupJobState {
...
impl ::std::convert::AsRef<str> for BackupJobState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BackupJobState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            BackupJobState::Aborted => write!(f, "ABORTED"),
            BackupJobState::Aborting => write!(f, "ABORTING"),
            BackupJobState::Completed => write!(f, "COMPLETED"),
            BackupJobState::Created => write!(f, "CREATED"),
            BackupJobState::Expired => write!(f, "EXPIRED"),
            BackupJobState::Failed => write!(f, "FAILED"),
