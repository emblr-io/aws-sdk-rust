...
impl ::std::convert::From<&str> for LegalHoldStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LegalHoldStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LegalHoldStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LegalHoldStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LegalHoldStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
