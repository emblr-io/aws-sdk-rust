...
impl ::std::convert::From<&str> for BackupVaultEvent {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BackupVaultEvent::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BackupVaultEvent {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BackupVaultEvent::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BackupVaultEvent {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
