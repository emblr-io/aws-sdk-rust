...
impl ::std::convert::From<&str> for AggregationPeriod {
    fn from(s: &str) -> Self {
        match s {
            "FOURTEEN_DAYS" => AggregationPeriod::FourteenDays,
            "ONE_DAY" => AggregationPeriod::OneDay,
            "SEVEN_DAYS" => AggregationPeriod::SevenDays,
            other => AggregationPeriod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AggregationPeriod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AggregationPeriod::from(s))
    }
}
impl AggregationPeriod {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AggregationPeriod::FourteenDays => "FOURTEEN_DAYS",
            AggregationPeriod::OneDay => "ONE_DAY",
            AggregationPeriod::SevenDays => "SEVEN_DAYS",
            AggregationPeriod::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["FOURTEEN_DAYS", "ONE_DAY", "SEVEN_DAYS"]
    }
}
impl ::std::convert::AsRef<str> for AggregationPeriod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AggregationPeriod {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AggregationPeriod::FourteenDays => write!(f, "FOURTEEN_DAYS"),
            AggregationPeriod::OneDay => write!(f, "ONE_DAY"),
            AggregationPeriod::SevenDays => write!(f, "SEVEN_DAYS"),
