...
/// <p>This is a summary of restore jobs created or running within the most recent 30 days.</p>
...
impl RestoreJobSummary {
    /// Creates a new builder-style object to manufacture [`RestoreJobSummary`](crate::types::RestoreJobSummary).
    pub fn builder() -> crate::types::builders::RestoreJobSummaryBuilder {
        crate::types::builders::RestoreJobSummaryBuilder::default()
    }
}
