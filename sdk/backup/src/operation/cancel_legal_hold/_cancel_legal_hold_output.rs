...
impl ::aws_types::request_id::RequestId for CancelLegalHoldOutput {
...
impl CancelLegalHoldOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CancelLegalHoldOutput`](crate::operation::cancel_legal_hold::CancelLegalHoldOutput).
    pub fn build(self) -> crate::operation::cancel_legal_hold::CancelLegalHoldOutput {
