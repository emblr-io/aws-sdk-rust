...
impl GetRestoreTestingPlanInput {
    /// Creates a new builder-style object to manufacture [`GetRestoreTestingPlanInput`](crate::operation::get_restore_testing_plan::GetRestoreTestingPlanInput).
    pub fn builder() -> crate::operation::get_restore_testing_plan::builders::GetRestoreTestingPlanInputBuilder {
        crate::operation::get_restore_testing_plan::builders::GetRestoreTestingPlanInputBuilder::default()
    }
}
...
impl GetRestoreTestingPlanInputBuilder {
    /// <p>Required unique name of the restore testing plan.</p>
