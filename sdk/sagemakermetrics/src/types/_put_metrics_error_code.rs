...
impl ::std::convert::From<&str> for PutMetricsErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PutMetricsErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PutMetricsErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PutMetricsErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PutMetricsErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
