...
impl ::std::convert::From<&str> for MetricStatistic {
    fn from(s: &str) -> Self {
        match s {
            "Avg" => MetricStatistic::Avg,
            "Count" => MetricStatistic::Count,
            "Last" => MetricStatistic::Last,
            "Max" => MetricStatistic::Max,
            "Min" => MetricStatistic::Min,
            "StdDev" => MetricStatistic::StdDev,
            other => MetricStatistic::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MetricStatistic {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MetricStatistic::from(s))
    }
}
impl MetricStatistic {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MetricStatistic::Avg => "Avg",
            MetricStatistic::Count => "Count",
            MetricStatistic::Last => "Last",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["Avg", "Count", "Last", "Max", "Min", "StdDev"]
    }
}
impl ::std::convert::AsRef<str> for MetricStatistic {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MetricStatistic {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            MetricStatistic::Avg => write!(f, "Avg"),
            MetricStatistic::Count => write!(f, "Count"),
            MetricStatistic::Last => write!(f, "Last"),
