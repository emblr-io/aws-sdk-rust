...
impl ::std::convert::From<&str> for ContentRedactionOutput {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentRedactionOutput::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentRedactionOutput {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentRedactionOutput::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContentRedactionOutput {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ContentRedactionOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ContentRedactionOutput::Redacted => write!(f, "redacted"),
            ContentRedactionOutput::RedactedAndUnredacted => write!(f, "redacted_and_unredacted"),
            ContentRedactionOutput::Unknown(value) => write!(f, "{}", value),
        }
    }
}
