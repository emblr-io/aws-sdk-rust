...
impl ::std::convert::From<&str> for ContentIdentificationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentIdentificationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentIdentificationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentIdentificationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContentIdentificationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
