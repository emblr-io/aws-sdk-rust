...
impl ::std::convert::From<&str> for Sentiment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Sentiment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Sentiment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Sentiment::from(s))
    }
}
impl Sentiment {
...
impl ::std::convert::AsRef<str> for Sentiment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
