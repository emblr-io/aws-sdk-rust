...
//! aws-sdk-transcribestreaming = "0.0.0-local"
...
//! offered by Amazon Transcribe Streaming Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Transcribe Streaming Service.
