...
impl ::std::convert::From<&str> for RescoreExecutionPlanStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RescoreExecutionPlanStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RescoreExecutionPlanStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RescoreExecutionPlanStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RescoreExecutionPlanStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
