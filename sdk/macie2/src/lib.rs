...
//! offered by Amazon Macie 2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Macie 2.
...
/// Configuration for Amazon Macie 2.
pub mod config;
