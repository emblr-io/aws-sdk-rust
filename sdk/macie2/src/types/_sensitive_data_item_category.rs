...
impl ::std::convert::From<&str> for SensitiveDataItemCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SensitiveDataItemCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SensitiveDataItemCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SensitiveDataItemCategory::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SensitiveDataItemCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
