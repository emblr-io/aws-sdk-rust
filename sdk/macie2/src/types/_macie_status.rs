...
impl ::std::convert::From<&str> for MacieStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MacieStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MacieStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MacieStatus::from(s))
    }
}
impl MacieStatus {
...
impl ::std::convert::AsRef<str> for MacieStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
