...
impl ::std::convert::From<&str> for FindingsFilterAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FindingsFilterAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FindingsFilterAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FindingsFilterAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FindingsFilterAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
