...
impl ::std::convert::From<&str> for RevealRequestStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RevealRequestStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RevealRequestStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RevealRequestStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RevealRequestStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
