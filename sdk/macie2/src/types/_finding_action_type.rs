...
impl ::std::convert::From<&str> for FindingActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FindingActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FindingActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FindingActionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FindingActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
