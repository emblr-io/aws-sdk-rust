...
impl ::std::convert::From<&str> for SearchResourcesSimpleCriterionKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SearchResourcesSimpleCriterionKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SearchResourcesSimpleCriterionKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchResourcesSimpleCriterionKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SearchResourcesSimpleCriterionKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
