...
impl ::std::convert::From<&str> for IsMonitoredByJob {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IsMonitoredByJob::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IsMonitoredByJob {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IsMonitoredByJob::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IsMonitoredByJob {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
