...
impl ::std::convert::From<&str> for UsageStatisticsFilterKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UsageStatisticsFilterKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UsageStatisticsFilterKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UsageStatisticsFilterKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UsageStatisticsFilterKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
