...
impl ::std::convert::From<&str> for ListJobsSortAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListJobsSortAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListJobsSortAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListJobsSortAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListJobsSortAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
