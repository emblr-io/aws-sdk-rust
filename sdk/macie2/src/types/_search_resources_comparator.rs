...
impl ::std::convert::From<&str> for SearchResourcesComparator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SearchResourcesComparator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SearchResourcesComparator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchResourcesComparator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SearchResourcesComparator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
