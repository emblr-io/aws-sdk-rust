...
impl ::std::convert::From<&str> for ManagedDataIdentifierSelector {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ManagedDataIdentifierSelector::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ManagedDataIdentifierSelector {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ManagedDataIdentifierSelector::from(s))
    }
}
