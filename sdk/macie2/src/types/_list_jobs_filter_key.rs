...
impl ::std::convert::From<&str> for ListJobsFilterKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListJobsFilterKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListJobsFilterKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListJobsFilterKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListJobsFilterKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
