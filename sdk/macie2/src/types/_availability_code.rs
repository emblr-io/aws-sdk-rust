...
impl ::std::convert::From<&str> for AvailabilityCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AvailabilityCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AvailabilityCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AvailabilityCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AvailabilityCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
