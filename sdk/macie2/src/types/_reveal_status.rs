...
impl ::std::convert::From<&str> for RevealStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RevealStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RevealStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RevealStatus::from(s))
    }
}
impl RevealStatus {
...
impl ::std::convert::AsRef<str> for RevealStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
