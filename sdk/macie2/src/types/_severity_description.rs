...
impl ::std::convert::From<&str> for SeverityDescription {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SeverityDescription::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SeverityDescription {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SeverityDescription::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SeverityDescription {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SeverityDescription {
