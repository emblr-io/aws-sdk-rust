...
impl ::std::convert::From<&str> for AutomatedDiscoveryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutomatedDiscoveryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutomatedDiscoveryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutomatedDiscoveryStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutomatedDiscoveryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
