...
impl ::aws_types::request_id::RequestId for DeleteAllowListOutput {
...
impl DeleteAllowListOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteAllowListOutput`](crate::operation::delete_allow_list::DeleteAllowListOutput).
    pub fn build(self) -> crate::operation::delete_allow_list::DeleteAllowListOutput {
