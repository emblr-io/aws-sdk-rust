...
impl ::std::convert::From<&str> for PendingAutomaticFailoverStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PendingAutomaticFailoverStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PendingAutomaticFailoverStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PendingAutomaticFailoverStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PendingAutomaticFailoverStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PendingAutomaticFailoverStatus {
