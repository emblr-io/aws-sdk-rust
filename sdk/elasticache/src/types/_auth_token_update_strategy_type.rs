...
impl ::std::convert::From<&str> for AuthTokenUpdateStrategyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthTokenUpdateStrategyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthTokenUpdateStrategyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthTokenUpdateStrategyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthTokenUpdateStrategyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
