...
impl ::std::convert::From<&str> for DataTieringStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataTieringStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataTieringStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataTieringStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataTieringStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DataTieringStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DataTieringStatus::Disabled => write!(f, "disabled"),
            DataTieringStatus::Enabled => write!(f, "enabled"),
