...
impl ::std::convert::From<&str> for SlaMet {
    fn from(s: &str) -> Self {
        match s {
            ...
            "no" => SlaMet::No,
            "yes" => SlaMet::Yes,
            other => SlaMet::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlaMet {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlaMet::from(s))
    }
}
impl SlaMet {
...
impl ::std::convert::AsRef<str> for SlaMet {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
