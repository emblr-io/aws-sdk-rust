...
impl ::std::convert::From<&str> for NodeUpdateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeUpdateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeUpdateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeUpdateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NodeUpdateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
