...
impl ::std::convert::From<&str> for AutomaticFailoverStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutomaticFailoverStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutomaticFailoverStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutomaticFailoverStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutomaticFailoverStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
