...
impl ::std::convert::From<&str> for OutpostMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OutpostMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OutpostMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OutpostMode::from(s))
    }
}
impl OutpostMode {
...
impl ::std::convert::AsRef<str> for OutpostMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
