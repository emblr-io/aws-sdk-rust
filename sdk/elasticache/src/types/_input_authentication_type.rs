...
impl ::std::convert::From<&str> for InputAuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InputAuthenticationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InputAuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InputAuthenticationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InputAuthenticationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for InputAuthenticationType {
