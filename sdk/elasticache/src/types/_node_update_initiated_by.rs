...
impl ::std::convert::From<&str> for NodeUpdateInitiatedBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeUpdateInitiatedBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeUpdateInitiatedBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeUpdateInitiatedBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NodeUpdateInitiatedBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
