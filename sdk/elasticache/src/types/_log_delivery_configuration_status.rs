...
impl ::std::convert::From<&str> for LogDeliveryConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LogDeliveryConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogDeliveryConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogDeliveryConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LogDeliveryConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
