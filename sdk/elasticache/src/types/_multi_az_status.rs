...
impl ::std::convert::From<&str> for MultiAzStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MultiAzStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MultiAzStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MultiAzStatus::from(s))
    }
}
impl MultiAzStatus {
...
impl ::std::convert::AsRef<str> for MultiAzStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
