...
impl ::aws_types::request_id::RequestId for CreateUserGroupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateUserGroupOutput {
    /// Creates a new builder-style object to manufacture [`CreateUserGroupOutput`](crate::operation::create_user_group::CreateUserGroupOutput).
    pub fn builder() -> crate::operation::create_user_group::builders::CreateUserGroupOutputBuilder {
        crate::operation::create_user_group::builders::CreateUserGroupOutputBuilder::default()
    }
}

/// A builder for [`CreateUserGroupOutput`](crate::operation::create_user_group::CreateUserGroupOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateUserGroupOutputBuilder {
...
impl CreateUserGroupOutputBuilder {
    /// <p>The ID of the user group.</p>
    ...
    /// Consumes the builder and constructs a [`CreateUserGroupOutput`](crate::operation::create_user_group::CreateUserGroupOutput).
    pub fn build(self) -> crate::operation::create_user_group::CreateUserGroupOutput {
