...
impl ::aws_types::request_id::RequestId for ModifyUserGroupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ModifyUserGroupOutput {
    /// Creates a new builder-style object to manufacture [`ModifyUserGroupOutput`](crate::operation::modify_user_group::ModifyUserGroupOutput).
    pub fn builder() -> crate::operation::modify_user_group::builders::ModifyUserGroupOutputBuilder {
        crate::operation::modify_user_group::builders::ModifyUserGroupOutputBuilder::default()
    }
}
...
impl ModifyUserGroupOutputBuilder {
    /// <p>The ID of the user group.</p>
    ...
    /// Consumes the builder and constructs a [`ModifyUserGroupOutput`](crate::operation::modify_user_group::ModifyUserGroupOutput).
    pub fn build(self) -> crate::operation::modify_user_group::ModifyUserGroupOutput {
