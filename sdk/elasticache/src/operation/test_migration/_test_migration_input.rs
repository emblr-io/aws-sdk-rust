...
impl TestMigrationInput {
    /// Creates a new builder-style object to manufacture [`TestMigrationInput`](crate::operation::test_migration::TestMigrationInput).
    pub fn builder() -> crate::operation::test_migration::builders::TestMigrationInputBuilder {
        crate::operation::test_migration::builders::TestMigrationInputBuilder::default()
    }
}
