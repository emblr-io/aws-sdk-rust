...
pub struct ListAllowedNodeTypeModificationsOutput {
    ...
    /// <p>When scaling up a Valkey or Redis OSS cluster or replication group using <code>ModifyCacheCluster</code> or <code>ModifyReplicationGroup</code>, use a value from this list for the <code>CacheNodeType</code> parameter.</p>
