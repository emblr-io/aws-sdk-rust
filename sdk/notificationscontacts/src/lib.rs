...
//! offered by AWS User Notifications Contacts. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS User Notifications Contacts.
...
/// let config = aws_sdk_notificationscontacts::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for AWS User Notifications Contacts.
pub mod config;
