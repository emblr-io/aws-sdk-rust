...
impl ::std::convert::From<&str> for Tcs {
    fn from(s: &str) -> Self {
        match s {
            ...
            "ST428-1" => Tcs::St4281,
            other => Tcs::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Tcs {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Tcs::from(s))
    }
}
impl Tcs {
...
impl ::std::convert::AsRef<str> for Tcs {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
