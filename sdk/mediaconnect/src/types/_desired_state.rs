...
impl ::std::convert::From<&str> for DesiredState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DesiredState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DesiredState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DesiredState::from(s))
    }
}
impl DesiredState {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ACTIVE", "DELETED", "STANDBY"]
    }
}
impl ::std::convert::AsRef<str> for DesiredState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DesiredState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            DesiredState::Standby => write!(f, "STANDBY"),
