...
impl ::std::convert::From<&str> for EncoderProfile {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EncoderProfile::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncoderProfile {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncoderProfile::from(s))
    }
}
impl EncoderProfile {
...
impl ::std::convert::AsRef<str> for EncoderProfile {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
