...
impl ::std::convert::From<&str> for PriceUnits {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PriceUnits::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PriceUnits {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PriceUnits::from(s))
    }
}
impl PriceUnits {
...
impl ::std::convert::AsRef<str> for PriceUnits {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
