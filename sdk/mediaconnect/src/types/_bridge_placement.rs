...
impl ::std::convert::From<&str> for BridgePlacement {
    fn from(s: &str) -> Self {
        match s {
            "AVAILABLE" => BridgePlacement::Available,
            "LOCKED" => BridgePlacement::Locked,
            other => BridgePlacement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BridgePlacement {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BridgePlacement::from(s))
    }
}
impl BridgePlacement {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            BridgePlacement::Available => "AVAILABLE",
            BridgePlacement::Locked => "LOCKED",
            BridgePlacement::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for BridgePlacement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BridgePlacement {
