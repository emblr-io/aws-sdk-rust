...
impl ::std::convert::From<&str> for Range {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NARROW" => Range::Narrow,
            other => Range::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Range {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Range::from(s))
    }
}
impl Range {
...
impl ::std::convert::AsRef<str> for Range {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
