...
impl ::std::convert::From<&str> for DurationUnits {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DurationUnits::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DurationUnits {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DurationUnits::from(s))
    }
}
impl DurationUnits {
...
impl ::std::convert::AsRef<str> for DurationUnits {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DurationUnits {
