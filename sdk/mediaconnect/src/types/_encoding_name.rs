...
impl ::std::convert::From<&str> for EncodingName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EncodingName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncodingName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncodingName::from(s))
    }
}
impl EncodingName {
...
impl ::std::convert::AsRef<str> for EncodingName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
