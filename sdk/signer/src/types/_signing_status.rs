...
impl ::std::convert::From<&str> for SigningStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SigningStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SigningStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SigningStatus::from(s))
    }
}
impl SigningStatus {
...
impl ::std::convert::AsRef<str> for SigningStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
