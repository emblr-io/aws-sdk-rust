...
impl ::std::convert::From<&str> for ValidityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ValidityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValidityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValidityType::from(s))
    }
}
impl ValidityType {
...
impl ::std::convert::AsRef<str> for ValidityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
