...
impl ::std::convert::From<&str> for HashAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HashAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HashAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HashAlgorithm::from(s))
    }
}
impl HashAlgorithm {
...
impl ::std::convert::AsRef<str> for HashAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
