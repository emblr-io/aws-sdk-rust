...
impl ::std::convert::From<&str> for EncryptionAlgorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EncryptionAlgorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncryptionAlgorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncryptionAlgorithm::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EncryptionAlgorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
