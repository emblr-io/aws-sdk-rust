...
impl ::std::convert::From<&str> for SigningProfileStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SigningProfileStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SigningProfileStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SigningProfileStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SigningProfileStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
