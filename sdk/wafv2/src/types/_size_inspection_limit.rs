...
/// When writing a match expression against `SizeInspectionLimit`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `sizeinspectionlimit` represents
...
/// version of SDK where the variant `SizeInspectionLimit::NewFeature` is defined.
...
impl ::std::convert::From<&str> for SizeInspectionLimit {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SizeInspectionLimit::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SizeInspectionLimit {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SizeInspectionLimit::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SizeInspectionLimit {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
