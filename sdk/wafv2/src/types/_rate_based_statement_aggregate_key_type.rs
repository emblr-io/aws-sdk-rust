...
/// }
/// ```
/// The above code demonstrates that when `ratebasedstatementaggregatekeytype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `RateBasedStatementAggregateKeyType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `RateBasedStatementAggregateKeyType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `RateBasedStatementAggregateKeyType::NewFeature` is defined.
/// Specifically, when `ratebasedstatementaggregatekeytype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RateBasedStatementAggregateKeyType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for RateBasedStatementAggregateKeyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RateBasedStatementAggregateKeyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RateBasedStatementAggregateKeyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RateBasedStatementAggregateKeyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RateBasedStatementAggregateKeyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
