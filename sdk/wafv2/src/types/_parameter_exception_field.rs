...
impl ::std::str::FromStr for ParameterExceptionField {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParameterExceptionField::from(s))
    }
}
...
impl ::std::fmt::Display for ParameterExceptionField {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ParameterExceptionField::AcpRuleSetResponseInspection => write!(f, "ACP_RULE_SET_RESPONSE_INSPECTION"),
            ParameterExceptionField::AndStatement => write!(f, "AND_STATEMENT"),
            ParameterExceptionField::AssociableResource => write!(f, "ASSOCIABLE_RESOURCE"),
            ParameterExceptionField::AssociatedResourceType => write!(f, "ASSOCIATED_RESOURCE_TYPE"),
            ParameterExceptionField::AtpRuleSetResponseInspection => write!(f, "ATP_RULE_SET_RESPONSE_INSPECTION"),
            ParameterExceptionField::BodyParsingFallbackBehavior => write!(f, "BODY_PARSING_FALLBACK_BEHAVIOR"),
            ParameterExceptionField::ByteMatchStatement => write!(f, "BYTE_MATCH_STATEMENT"),
            ParameterExceptionField::ChallengeConfig => write!(f, "CHALLENGE_CONFIG"),
            ParameterExceptionField::ChangePropagationStatus => write!(f, "CHANGE_PROPAGATION_STATUS"),
            ParameterExceptionField::CookieMatchPattern => write!(f, "COOKIE_MATCH_PATTERN"),
            ParameterExceptionField::CustomKeys => write!(f, "CUSTOM_KEYS"),
            ...
            ParameterExceptionField::ExpireTimestamp => write!(f, "EXPIRE_TIMESTAMP"),
            ParameterExceptionField::FallbackBehavior => write!(f, "FALLBACK_BEHAVIOR"),
            ParameterExceptionField::FieldToMatch => write!(f, "FIELD_TO_MATCH"),
            ParameterExceptionField::FilterCondition => write!(f, "FILTER_CONDITION"),
            ParameterExceptionField::FirewallManagerStatement => write!(f, "FIREWALL_MANAGER_STATEMENT"),
            ParameterExceptionField::ForwardedIpConfig => write!(f, "FORWARDED_IP_CONFIG"),
            ParameterExceptionField::GeoMatchStatement => write!(f, "GEO_MATCH_STATEMENT"),
            ParameterExceptionField::HeaderMatchPattern => write!(f, "HEADER_MATCH_PATTERN"),
            ParameterExceptionField::HeaderName => write!(f, "HEADER_NAME"),
            ParameterExceptionField::IpAddress => write!(f, "IP_ADDRESS"),
            ParameterExceptionField::IpAddressVersion => write!(f, "IP_ADDRESS_VERSION"),
            ParameterExceptionField::IpSet => write!(f, "IP_SET"),
            ParameterExceptionField::IpSetForwardedIpConfig => write!(f, "IP_SET_FORWARDED_IP_CONFIG"),
            ParameterExceptionField::IpSetReferenceStatement => write!(f, "IP_SET_REFERENCE_STATEMENT"),
            ParameterExceptionField::JsonMatchPattern => write!(f, "JSON_MATCH_PATTERN"),
            ParameterExceptionField::JsonMatchScope => write!(f, "JSON_MATCH_SCOPE"),
            ...
            ParameterExceptionField::MapMatchScope => write!(f, "MAP_MATCH_SCOPE"),
            ParameterExceptionField::MetricName => write!(f, "METRIC_NAME"),
            ParameterExceptionField::NotStatement => write!(f, "NOT_STATEMENT"),
            ParameterExceptionField::OrStatement => write!(f, "OR_STATEMENT"),
            ParameterExceptionField::OverrideAction => write!(f, "OVERRIDE_ACTION"),
            ParameterExceptionField::OversizeHandling => write!(f, "OVERSIZE_HANDLING"),
            ...
            ParameterExceptionField::RegexPatternSet => write!(f, "REGEX_PATTERN_SET"),
            ParameterExceptionField::ResourceArn => write!(f, "RESOURCE_ARN"),
            ParameterExceptionField::ResourceType => write!(f, "RESOURCE_TYPE"),
            ParameterExceptionField::ResponseContentType => write!(f, "RESPONSE_CONTENT_TYPE"),
            ParameterExceptionField::Rule => write!(f, "RULE"),
            ParameterExceptionField::RuleAction => write!(f, "RULE_ACTION"),
            ParameterExceptionField::RuleGroup => write!(f, "RULE_GROUP"),
            ParameterExceptionField::RuleGroupReferenceStatement => write!(f, "RULE_GROUP_REFERENCE_STATEMENT"),
            ParameterExceptionField::ScopeDown => write!(f, "SCOPE_DOWN"),
            ParameterExceptionField::ScopeValue => write!(f, "SCOPE_VALUE"),
            ParameterExceptionField::SingleHeader => write!(f, "SINGLE_HEADER"),
            ParameterExceptionField::SingleQueryArgument => write!(f, "SINGLE_QUERY_ARGUMENT"),
            ParameterExceptionField::SizeConstraintStatement => write!(f, "SIZE_CONSTRAINT_STATEMENT"),
            ParameterExceptionField::SqliMatchStatement => write!(f, "SQLI_MATCH_STATEMENT"),
            ParameterExceptionField::Statement => write!(f, "STATEMENT"),
            ParameterExceptionField::Tags => write!(f, "TAGS"),
            ParameterExceptionField::TagKeys => write!(f, "TAG_KEYS"),
            ParameterExceptionField::TextTransformation => write!(f, "TEXT_TRANSFORMATION"),
