...
impl ::std::convert::From<&str> for LabelMatchScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LabelMatchScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LabelMatchScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LabelMatchScope::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LabelMatchScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
