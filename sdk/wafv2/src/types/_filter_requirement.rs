...
/// }
/// ```
/// The above code demonstrates that when `filterrequirement` represents
...
/// version of SDK where the variant `FilterRequirement::NewFeature` is defined.
/// Specifically, when `filterrequirement` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `FilterRequirement::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for FilterRequirement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterRequirement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterRequirement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterRequirement::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterRequirement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
