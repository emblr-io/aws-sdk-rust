...
impl Ja4Fingerprint {
    /// Creates a new builder-style object to manufacture [`Ja4Fingerprint`](crate::types::Ja4Fingerprint).
    pub fn builder() -> crate::types::builders::Ja4FingerprintBuilder {
        crate::types::builders::Ja4FingerprintBuilder::default()
    }
}

/// A builder for [`Ja4Fingerprint`](crate::types::Ja4Fingerprint).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct Ja4FingerprintBuilder {
    pub(crate) fallback_behavior: ::std::option::Option<crate::types::FallbackBehavior>,
}
impl Ja4FingerprintBuilder {
    /// <p>The match status to assign to the web request if the request doesn't have a JA4 fingerprint.</p>
    /// <p>You can specify the following fallback behaviors:</p>
    /// <ul>
    /// <li>
    ...
    /// Consumes the builder and constructs a [`Ja4Fingerprint`](crate::types::Ja4Fingerprint).
    /// This method will fail if any of the following fields are not set:
    /// - [`fallback_behavior`](crate::types::builders::Ja4FingerprintBuilder::fallback_behavior)
    pub fn build(self) -> ::std::result::Result<crate::types::Ja4Fingerprint, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::Ja4Fingerprint {
            fallback_behavior: self.fallback_behavior.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "fallback_behavior",
                    "fallback_behavior was not specified but it is required when building Ja4Fingerprint",
                )
            })?,
        })
    }
