...
//! offered by AppFabric. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`BatchGetUserAccessTasks`](crate::operation::batch_get_user_access_tasks) operation has
/// a [`Client::batch_get_user_access_tasks`], function which returns a builder for that operation.
