...
pub struct DeleteIngestionInput {
...
impl DeleteIngestionInput {
    /// Creates a new builder-style object to manufacture [`DeleteIngestionInput`](crate::operation::delete_ingestion::DeleteIngestionInput).
    pub fn builder() -> crate::operation::delete_ingestion::builders::DeleteIngestionInputBuilder {
        crate::operation::delete_ingestion::builders::DeleteIngestionInputBuilder::default()
    }
}

/// A builder for [`DeleteIngestionInput`](crate::operation::delete_ingestion::DeleteIngestionInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteIngestionInputBuilder {
...
impl DeleteIngestionInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteIngestionInput`](crate::operation::delete_ingestion::DeleteIngestionInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::delete_ingestion::DeleteIngestionInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::delete_ingestion::DeleteIngestionInput {
