...
impl ::std::convert::From<&str> for Persona {
    fn from(s: &str) -> Self {
        match s {
            "admin" => Persona::Admin,
            "endUser" => Persona::Enduser,
            other => Persona::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Persona {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Persona::from(s))
    }
}
impl Persona {
...
impl ::std::convert::AsRef<str> for Persona {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
