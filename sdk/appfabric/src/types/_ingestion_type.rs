...
impl ::std::convert::From<&str> for IngestionType {
    fn from(s: &str) -> Self {
        match s {
            "auditLog" => IngestionType::AuditLog,
            other => IngestionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl IngestionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            IngestionType::AuditLog => "auditLog",
