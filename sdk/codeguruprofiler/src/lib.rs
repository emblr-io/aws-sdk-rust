...
//! offered by Amazon CodeGuru Profiler. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CodeGuru Profiler.
...
/// Configuration for Amazon CodeGuru Profiler.
pub mod config;
