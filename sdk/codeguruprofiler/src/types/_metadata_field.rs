...
impl ::std::convert::From<&str> for MetadataField {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MetadataField::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MetadataField {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MetadataField::from(s))
    }
}
impl MetadataField {
...
impl ::std::convert::AsRef<str> for MetadataField {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
