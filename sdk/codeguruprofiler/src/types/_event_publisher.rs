...
impl ::std::convert::From<&str> for EventPublisher {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventPublisher::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventPublisher {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventPublisher::from(s))
    }
}
impl EventPublisher {
...
impl ::std::convert::AsRef<str> for EventPublisher {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EventPublisher {
