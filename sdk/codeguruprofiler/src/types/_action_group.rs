...
impl ::std::convert::From<&str> for ActionGroup {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionGroup::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionGroup {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionGroup::from(s))
    }
}
impl ActionGroup {
...
impl ::std::convert::AsRef<str> for ActionGroup {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
