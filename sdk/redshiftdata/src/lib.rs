...
//! aws-sdk-redshiftdata = "0.0.0-local"
...
//! offered by Redshift Data API Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Redshift Data API Service.
...
/// Configuration for Redshift Data API Service.
pub mod config;
