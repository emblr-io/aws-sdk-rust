...
impl ::std::convert::From<&str> for StatementStatusString {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatementStatusString::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for StatementStatusString {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            StatementStatusString::Aborted => write!(f, "ABORTED"),
            StatementStatusString::Failed => write!(f, "FAILED"),
            StatementStatusString::Finished => write!(f, "FINISHED"),
