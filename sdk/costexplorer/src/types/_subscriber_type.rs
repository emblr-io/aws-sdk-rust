...
impl ::std::convert::From<&str> for SubscriberType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SubscriberType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubscriberType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubscriberType::from(s))
    }
}
impl SubscriberType {
...
impl ::std::convert::AsRef<str> for SubscriberType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
