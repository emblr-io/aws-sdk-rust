...
impl ::std::convert::From<&str> for RightsizingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RightsizingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RightsizingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RightsizingType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RightsizingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
