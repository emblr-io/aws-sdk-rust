...
impl ::std::convert::From<&str> for CostCategorySplitChargeRuleParameterType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostCategorySplitChargeRuleParameterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostCategorySplitChargeRuleParameterType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostCategorySplitChargeRuleParameterType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CostCategorySplitChargeRuleParameterType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CostCategorySplitChargeRuleParameterType {
