...
impl ::std::convert::From<&str> for AccountScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountScope::from(s))
    }
}
impl AccountScope {
...
impl ::std::convert::AsRef<str> for AccountScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
