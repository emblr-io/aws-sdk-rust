...
impl ::std::convert::From<&str> for GenerationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GenerationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GenerationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GenerationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GenerationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
