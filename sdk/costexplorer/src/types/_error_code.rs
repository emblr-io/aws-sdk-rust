...
///     ErrorCode::InvalidSavingsPlansToAdd => { /* ... */ },
///     ErrorCode::InvalidSavingsPlansToExclude => { /* ... */ },
///     ErrorCode::NoUsageFound => { /* ... */ },
...
impl ::std::convert::From<&str> for ErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "INVALID_ACCOUNT_ID" => ErrorCode::InvalidAccountId,
            "INVALID_SAVINGS_PLANS_TO_ADD" => ErrorCode::InvalidSavingsPlansToAdd,
            "INVALID_SAVINGS_PLANS_TO_EXCLUDE" => ErrorCode::InvalidSavingsPlansToExclude,
            "NO_USAGE_FOUND" => ErrorCode::NoUsageFound,
...
impl ErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ErrorCode::InvalidSavingsPlansToAdd => "INVALID_SAVINGS_PLANS_TO_ADD",
            ErrorCode::InvalidSavingsPlansToExclude => "INVALID_SAVINGS_PLANS_TO_EXCLUDE",
            ErrorCode::NoUsageFound => "NO_USAGE_FOUND",
...
impl ::std::fmt::Display for ErrorCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ErrorCode::InvalidAccountId => write!(f, "INVALID_ACCOUNT_ID"),
