...
impl ::std::convert::From<&str> for AnomalyFeedbackType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnomalyFeedbackType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnomalyFeedbackType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnomalyFeedbackType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AnomalyFeedbackType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
