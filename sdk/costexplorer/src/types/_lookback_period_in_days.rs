...
impl ::std::convert::From<&str> for LookbackPeriodInDays {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LookbackPeriodInDays::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LookbackPeriodInDays {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LookbackPeriodInDays::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LookbackPeriodInDays {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
