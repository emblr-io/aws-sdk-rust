...
impl ::std::convert::From<&str> for CostCategoryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostCategoryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostCategoryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostCategoryStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CostCategoryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
