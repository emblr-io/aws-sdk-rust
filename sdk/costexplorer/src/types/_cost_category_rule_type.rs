...
impl ::std::convert::From<&str> for CostCategoryRuleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostCategoryRuleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostCategoryRuleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostCategoryRuleType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CostCategoryRuleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
