...
impl ::std::convert::From<&str> for GroupDefinitionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupDefinitionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupDefinitionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupDefinitionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupDefinitionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
