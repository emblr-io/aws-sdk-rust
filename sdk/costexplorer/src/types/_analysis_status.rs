...
impl ::std::convert::From<&str> for AnalysisStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnalysisStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnalysisStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnalysisStatus::from(s))
    }
}
impl AnalysisStatus {
...
impl ::std::convert::AsRef<str> for AnalysisStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
