...
impl ::std::convert::From<&str> for MonitorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitorType::from(s))
    }
}
impl MonitorType {
...
impl ::std::convert::AsRef<str> for MonitorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
