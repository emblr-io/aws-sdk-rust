...
impl ::std::convert::From<&str> for PaymentOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PaymentOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PaymentOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PaymentOption::from(s))
    }
}
impl PaymentOption {
...
impl ::std::convert::AsRef<str> for PaymentOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
