...
impl ::std::convert::From<&str> for TermInYears {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TermInYears::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TermInYears {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TermInYears::from(s))
    }
}
impl TermInYears {
...
impl ::std::convert::AsRef<str> for TermInYears {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
