...
impl ::std::convert::From<&str> for CostCategoryInheritedValueDimensionName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostCategoryInheritedValueDimensionName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostCategoryInheritedValueDimensionName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostCategoryInheritedValueDimensionName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CostCategoryInheritedValueDimensionName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
