...
impl ::std::convert::From<&str> for RecommendationTarget {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecommendationTarget::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecommendationTarget {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecommendationTarget::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecommendationTarget {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
