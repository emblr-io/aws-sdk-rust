...
impl ::std::convert::From<&str> for CostCategorySplitChargeMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostCategorySplitChargeMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostCategorySplitChargeMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostCategorySplitChargeMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CostCategorySplitChargeMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
