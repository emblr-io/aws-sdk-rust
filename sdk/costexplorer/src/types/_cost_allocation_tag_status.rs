...
impl ::std::convert::From<&str> for CostAllocationTagStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostAllocationTagStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostAllocationTagStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostAllocationTagStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CostAllocationTagStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
