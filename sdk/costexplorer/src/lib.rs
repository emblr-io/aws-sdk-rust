...
//! aws-sdk-costexplorer = "0.0.0-local"
...
//! offered by AWS Cost Explorer Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Cost Explorer Service.
...
/// For example, the [`CreateCostCategoryDefinition`](crate::operation::create_cost_category_definition) operation has
/// a [`Client::create_cost_category_definition`], function which returns a builder for that operation.
...
/// Configuration for AWS Cost Explorer Service.
pub mod config;
