...
//! aws-sdk-cloudfrontkeyvaluestore = "0.0.0-local"
...
//! offered by Amazon CloudFront KeyValueStore. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudFront KeyValueStore.
...
/// For example, the [`DeleteKey`](crate::operation::delete_key) operation has
/// a [`Client::delete_key`], function which returns a builder for that operation.
...
/// Configuration for Amazon CloudFront KeyValueStore.
pub mod config;
