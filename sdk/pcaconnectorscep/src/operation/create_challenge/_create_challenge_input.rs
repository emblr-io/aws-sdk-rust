...
impl CreateChallengeInput {
    /// Creates a new builder-style object to manufacture [`CreateChallengeInput`](crate::operation::create_challenge::CreateChallengeInput).
    pub fn builder() -> crate::operation::create_challenge::builders::CreateChallengeInputBuilder {
        crate::operation::create_challenge::builders::CreateChallengeInputBuilder::default()
    }
}

/// A builder for [`CreateChallengeInput`](crate::operation::create_challenge::CreateChallengeInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateChallengeInputBuilder {
    pub(crate) connector_arn: ::std::option::Option<::std::string::String>,
    pub(crate) client_token: ::std::option::Option<::std::string::String>,
    pub(crate) tags: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
}
impl CreateChallengeInputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the connector that you want to create a challenge for.</p>
    ...
    /// Consumes the builder and constructs a [`CreateChallengeInput`](crate::operation::create_challenge::CreateChallengeInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_challenge::CreateChallengeInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_challenge::CreateChallengeInput {
