...
//! offered by Private CA Connector for SCEP. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Private CA Connector for SCEP.
...
/// For example, the [`CreateChallenge`](crate::operation::create_challenge) operation has
/// a [`Client::create_challenge`], function which returns a builder for that operation.
...
/// Configuration for Private CA Connector for SCEP.
pub mod config;
