...
impl ::std::convert::From<&str> for ConnectorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "CREATING" => ConnectorStatus::Creating,
            "DELETING" => ConnectorStatus::Deleting,
...
impl ::std::str::FromStr for ConnectorStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectorStatus::from(s))
    }
}
impl ConnectorStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ConnectorStatus::Creating => "CREATING",
            ConnectorStatus::Deleting => "DELETING",
