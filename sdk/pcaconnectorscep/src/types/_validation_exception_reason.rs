...
///     ValidationExceptionReason::CaCertValidityTooShort => { /* ... */ },
///     ValidationExceptionReason::InvalidCaUsageMode => { /* ... */ },
///     ValidationExceptionReason::InvalidConnectorType => { /* ... */ },
///     ValidationExceptionReason::InvalidState => { /* ... */ },
///     ValidationExceptionReason::NoClientToken => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "CA_CERT_VALIDITY_TOO_SHORT" => ValidationExceptionReason::CaCertValidityTooShort,
            "INVALID_CA_USAGE_MODE" => ValidationExceptionReason::InvalidCaUsageMode,
            "INVALID_CONNECTOR_TYPE" => ValidationExceptionReason::InvalidConnectorType,
            "INVALID_STATE" => ValidationExceptionReason::InvalidState,
            "NO_CLIENT_TOKEN" => ValidationExceptionReason::NoClientToken,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ValidationExceptionReason::CaCertValidityTooShort => "CA_CERT_VALIDITY_TOO_SHORT",
            ValidationExceptionReason::InvalidCaUsageMode => "INVALID_CA_USAGE_MODE",
            ValidationExceptionReason::InvalidConnectorType => "INVALID_CONNECTOR_TYPE",
            ValidationExceptionReason::InvalidState => "INVALID_STATE",
            ValidationExceptionReason::NoClientToken => "NO_CLIENT_TOKEN",
...
impl ::std::fmt::Display for ValidationExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ValidationExceptionReason::CaCertValidityTooShort => write!(f, "CA_CERT_VALIDITY_TOO_SHORT"),
            ValidationExceptionReason::InvalidCaUsageMode => write!(f, "INVALID_CA_USAGE_MODE"),
            ValidationExceptionReason::InvalidConnectorType => write!(f, "INVALID_CONNECTOR_TYPE"),
