...
impl ::std::convert::From<&str> for ConnectorType {
    fn from(s: &str) -> Self {
        match s {
            "GENERAL_PURPOSE" => ConnectorType::GeneralPurpose,
            "INTUNE" => ConnectorType::Intune,
...
impl ConnectorType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConnectorType::GeneralPurpose => "GENERAL_PURPOSE",
            ConnectorType::Intune => "INTUNE",
