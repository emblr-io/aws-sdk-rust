...
impl ChallengeMetadata {
    /// Creates a new builder-style object to manufacture [`ChallengeMetadata`](crate::types::ChallengeMetadata).
    pub fn builder() -> crate::types::builders::ChallengeMetadataBuilder {
        crate::types::builders::ChallengeMetadataBuilder::default()
    }
}
...
impl ChallengeMetadataBuilder {
    ...
    /// Consumes the builder and constructs a [`ChallengeMetadata`](crate::types::ChallengeMetadata).
    pub fn build(self) -> crate::types::ChallengeMetadata {
        crate::types::ChallengeMetadata {
            arn: self.arn,
