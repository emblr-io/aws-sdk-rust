...
impl DataViewErrorInfo {
    /// Creates a new builder-style object to manufacture [`DataViewErrorInfo`](crate::types::DataViewErrorInfo).
    pub fn builder() -> crate::types::builders::DataViewErrorInfoBuilder {
        crate::types::builders::DataViewErrorInfoBuilder::default()
    }
}

/// A builder for [`DataViewErrorInfo`](crate::types::DataViewErrorInfo).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DataViewErrorInfoBuilder {
    pub(crate) error_message: ::std::option::Option<::std::string::String>,
    pub(crate) error_category: ::std::option::Option<crate::types::ErrorCategory>,
}
impl DataViewErrorInfoBuilder {
    /// <p>The text of the error message.</p>
