...
impl ::std::convert::From<&str> for ExportFileFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportFileFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportFileFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportFileFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExportFileFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
