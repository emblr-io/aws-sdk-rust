...
impl ::std::convert::From<&str> for ApplicationPermission {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationPermission::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationPermission {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationPermission::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationPermission {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
