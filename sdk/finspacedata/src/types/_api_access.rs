...
impl ::std::convert::From<&str> for ApiAccess {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApiAccess::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApiAccess {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApiAccess::from(s))
    }
}
impl ApiAccess {
...
impl ::std::convert::AsRef<str> for ApiAccess {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
