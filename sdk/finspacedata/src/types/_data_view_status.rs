...
impl ::std::convert::From<&str> for DataViewStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataViewStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataViewStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataViewStatus::from(s))
    }
}
impl DataViewStatus {
...
impl ::std::convert::AsRef<str> for DataViewStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
