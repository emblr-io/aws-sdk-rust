...
impl ::std::convert::From<&str> for DatasetKind {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatasetKind::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatasetKind {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatasetKind::from(s))
    }
}
impl DatasetKind {
...
impl ::std::convert::AsRef<str> for DatasetKind {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
