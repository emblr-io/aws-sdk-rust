...
//! aws-sdk-finspacedata = "0.0.0-local"
...
//! offered by FinSpace Public API. The return value of each of these methods is a "fluent builder",
...
/// Client for calling FinSpace Public API.
...
/// For example, the [`AssociateUserToPermissionGroup`](crate::operation::associate_user_to_permission_group) operation has
/// a [`Client::associate_user_to_permission_group`], function which returns a builder for that operation.
...
/// Configuration for FinSpace Public API.
pub mod config;
