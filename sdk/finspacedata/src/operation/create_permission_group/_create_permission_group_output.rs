...
impl ::aws_types::request_id::RequestId for CreatePermissionGroupOutput {
...
impl CreatePermissionGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePermissionGroupOutput`](crate::operation::create_permission_group::CreatePermissionGroupOutput).
    pub fn build(self) -> crate::operation::create_permission_group::CreatePermissionGroupOutput {
