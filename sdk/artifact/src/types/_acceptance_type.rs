...
impl ::std::convert::From<&str> for AcceptanceType {
    fn from(s: &str) -> Self {
        match s {
            "EXPLICIT" => AcceptanceType::Explicit,
            "PASSTHROUGH" => AcceptanceType::Passthrough,
            other => AcceptanceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AcceptanceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AcceptanceType::from(s))
    }
}
impl AcceptanceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AcceptanceType::Explicit => "EXPLICIT",
            AcceptanceType::Passthrough => "PASSTHROUGH",
...
impl ::std::convert::AsRef<str> for AcceptanceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
