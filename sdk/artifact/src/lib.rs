...
//! offered by AWS Artifact. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Artifact.
...
/// Configuration for AWS Artifact.
pub mod config;
