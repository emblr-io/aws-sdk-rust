...
impl ::std::convert::From<&str> for ModelState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelState::from(s))
    }
}
impl ModelState {
...
impl ::std::convert::AsRef<str> for ModelState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
