...
//! offered by AWS Amplify UI Builder. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Amplify UI Builder.
...
/// Configuration for AWS Amplify UI Builder.
pub mod config;
