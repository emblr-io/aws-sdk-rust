...
impl GetThemeInput {
    /// Creates a new builder-style object to manufacture [`GetThemeInput`](crate::operation::get_theme::GetThemeInput).
    pub fn builder() -> crate::operation::get_theme::builders::GetThemeInputBuilder {
        crate::operation::get_theme::builders::GetThemeInputBuilder::default()
    }
}
