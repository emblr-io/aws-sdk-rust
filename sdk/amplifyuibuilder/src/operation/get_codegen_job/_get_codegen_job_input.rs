...
impl GetCodegenJobInput {
    /// Creates a new builder-style object to manufacture [`GetCodegenJobInput`](crate::operation::get_codegen_job::GetCodegenJobInput).
    pub fn builder() -> crate::operation::get_codegen_job::builders::GetCodegenJobInputBuilder {
        crate::operation::get_codegen_job::builders::GetCodegenJobInputBuilder::default()
    }
}
