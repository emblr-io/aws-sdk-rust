...
impl ::std::convert::From<&str> for FixedPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FixedPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FixedPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FixedPosition::from(s))
    }
}
impl FixedPosition {
...
impl ::std::convert::AsRef<str> for FixedPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
