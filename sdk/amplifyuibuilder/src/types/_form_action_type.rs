...
impl ::std::convert::From<&str> for FormActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FormActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FormActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FormActionType::from(s))
    }
}
impl FormActionType {
...
impl ::std::convert::AsRef<str> for FormActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
