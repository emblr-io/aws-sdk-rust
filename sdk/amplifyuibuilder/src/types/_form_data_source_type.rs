...
impl ::std::convert::From<&str> for FormDataSourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FormDataSourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FormDataSourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FormDataSourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FormDataSourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FormDataSourceType {
