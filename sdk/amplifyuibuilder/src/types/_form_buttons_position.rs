...
impl ::std::convert::From<&str> for FormButtonsPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FormButtonsPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FormButtonsPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FormButtonsPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FormButtonsPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
