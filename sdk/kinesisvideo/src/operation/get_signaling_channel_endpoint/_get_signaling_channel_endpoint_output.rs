...
impl GetSignalingChannelEndpointOutput {
    /// <p>A list of endpoints for the specified signaling channel.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.resource_endpoint_list.is_none()`.
    pub fn resource_endpoint_list(&self) -> &[crate::types::ResourceEndpointListItem] {
        self.resource_endpoint_list.as_deref().unwrap_or_default()
    }
}
impl ::aws_types::request_id::RequestId for GetSignalingChannelEndpointOutput {
