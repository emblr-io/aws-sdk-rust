...
impl ::std::convert::From<&str> for FormatConfigKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FormatConfigKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FormatConfigKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FormatConfigKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FormatConfigKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FormatConfigKey {
