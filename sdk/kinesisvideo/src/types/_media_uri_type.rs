...
impl ::std::convert::From<&str> for MediaUriType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MediaUriType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MediaUriType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MediaUriType::from(s))
    }
}
impl MediaUriType {
...
impl ::std::convert::AsRef<str> for MediaUriType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
