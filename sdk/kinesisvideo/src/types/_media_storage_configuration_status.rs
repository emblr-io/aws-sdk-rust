...
impl ::std::convert::From<&str> for MediaStorageConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MediaStorageConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MediaStorageConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MediaStorageConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MediaStorageConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
