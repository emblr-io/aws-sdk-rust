...
///     RecorderStatus::SystemError => { /* ... */ },
///     RecorderStatus::UserError => { /* ... */ },
...
impl ::std::convert::From<&str> for RecorderStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "SYSTEM_ERROR" => RecorderStatus::SystemError,
            "USER_ERROR" => RecorderStatus::UserError,
...
impl ::std::str::FromStr for RecorderStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecorderStatus::from(s))
    }
}
impl RecorderStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RecorderStatus::SystemError => "SYSTEM_ERROR",
            RecorderStatus::UserError => "USER_ERROR",
