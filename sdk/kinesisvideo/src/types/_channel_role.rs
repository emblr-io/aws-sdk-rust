...
impl ::std::convert::From<&str> for ChannelRole {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelRole::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelRole {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelRole::from(s))
    }
}
impl ChannelRole {
...
impl ::std::convert::AsRef<str> for ChannelRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
