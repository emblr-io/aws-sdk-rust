...
impl ::std::convert::From<&str> for StrategyOnFullSize {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StrategyOnFullSize::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StrategyOnFullSize {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StrategyOnFullSize::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StrategyOnFullSize {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
