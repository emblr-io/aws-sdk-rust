...
impl ::std::convert::From<&str> for ChannelProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelProtocol::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChannelProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
