...
//! aws-sdk-cognitoidentity = "0.0.0-local"
...
//! offered by Amazon Cognito Identity. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Cognito Identity.
...
/// For example, the [`CreateIdentityPool`](crate::operation::create_identity_pool) operation has
/// a [`Client::create_identity_pool`], function which returns a builder for that operation.
...
/// Configuration for Amazon Cognito Identity.
pub mod config;
