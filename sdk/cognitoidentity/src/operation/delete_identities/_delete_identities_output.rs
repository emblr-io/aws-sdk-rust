...
impl DeleteIdentitiesOutput {
    /// <p>An array of UnprocessedIdentityId objects, each of which contains an ErrorCode and IdentityId.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.unprocessed_identity_ids.is_none()`.
    pub fn unprocessed_identity_ids(&self) -> &[crate::types::UnprocessedIdentityId] {
...
impl DeleteIdentitiesOutputBuilder {
    ...
    pub fn unprocessed_identity_ids(mut self, input: crate::types::UnprocessedIdentityId) -> Self {
        ...
        v.push(input);
        self.unprocessed_identity_ids = ::std::option::Option::Some(v);
        self
    }
    /// <p>An array of UnprocessedIdentityId objects, each of which contains an ErrorCode and IdentityId.</p>
