...
impl ::aws_types::request_id::RequestId for GetKxVolumeOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetKxVolumeOutput {
    /// Creates a new builder-style object to manufacture [`GetKxVolumeOutput`](crate::operation::get_kx_volume::GetKxVolumeOutput).
    pub fn builder() -> crate::operation::get_kx_volume::builders::GetKxVolumeOutputBuilder {
        crate::operation::get_kx_volume::builders::GetKxVolumeOutputBuilder::default()
    }
}

/// A builder for [`GetKxVolumeOutput`](crate::operation::get_kx_volume::GetKxVolumeOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetKxVolumeOutputBuilder {
...
impl GetKxVolumeOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetKxVolumeOutput`](crate::operation::get_kx_volume::GetKxVolumeOutput).
    pub fn build(self) -> crate::operation::get_kx_volume::GetKxVolumeOutput {
        crate::operation::get_kx_volume::GetKxVolumeOutput {
