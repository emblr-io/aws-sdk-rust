...
impl UpdateKxUserOutput {
    /// Creates a new builder-style object to manufacture [`UpdateKxUserOutput`](crate::operation::update_kx_user::UpdateKxUserOutput).
    pub fn builder() -> crate::operation::update_kx_user::builders::UpdateKxUserOutputBuilder {
        crate::operation::update_kx_user::builders::UpdateKxUserOutputBuilder::default()
    }
}

/// A builder for [`UpdateKxUserOutput`](crate::operation::update_kx_user::UpdateKxUserOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateKxUserOutputBuilder {
...
impl UpdateKxUserOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateKxUserOutput`](crate::operation::update_kx_user::UpdateKxUserOutput).
    pub fn build(self) -> crate::operation::update_kx_user::UpdateKxUserOutput {
