...
impl ::std::convert::From<&str> for FederationMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FederationMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FederationMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FederationMode::from(s))
    }
}
impl FederationMode {
...
impl ::std::convert::AsRef<str> for FederationMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
