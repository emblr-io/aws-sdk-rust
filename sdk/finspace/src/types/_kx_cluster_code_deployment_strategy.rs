...
pub enum KxClusterCodeDeploymentStrategy {
    #[allow(missing_docs)] // documentation missing in model
    Force,
    #[allow(missing_docs)] // documentation missing in model
    NoRestart,
...
impl ::std::convert::From<&str> for KxClusterCodeDeploymentStrategy {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for KxClusterCodeDeploymentStrategy {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KxClusterCodeDeploymentStrategy::from(s))
    }
}
