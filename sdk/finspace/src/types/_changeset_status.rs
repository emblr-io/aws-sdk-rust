...
impl ::std::convert::From<&str> for ChangesetStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChangesetStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChangesetStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChangesetStatus::from(s))
    }
}
impl ChangesetStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ChangesetStatus::Completed => "COMPLETED",
            ChangesetStatus::Failed => "FAILED",
            ChangesetStatus::Pending => "PENDING",
            ChangesetStatus::Processing => "PROCESSING",
...
impl ::std::convert::AsRef<str> for ChangesetStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
