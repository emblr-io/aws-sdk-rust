...
impl ::std::convert::From<&str> for AutoScalingMetric {
    fn from(s: &str) -> Self {
        match s {
            "CPU_UTILIZATION_PERCENTAGE" => AutoScalingMetric::CpuUtilizationPercentage,
            other => AutoScalingMetric::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoScalingMetric {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoScalingMetric::from(s))
    }
}
impl AutoScalingMetric {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AutoScalingMetric::CpuUtilizationPercentage => "CPU_UTILIZATION_PERCENTAGE",
            AutoScalingMetric::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AutoScalingMetric {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
