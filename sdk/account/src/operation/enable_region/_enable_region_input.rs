...
impl EnableRegionInput {
    /// Creates a new builder-style object to manufacture [`EnableRegionInput`](crate::operation::enable_region::EnableRegionInput).
    pub fn builder() -> crate::operation::enable_region::builders::EnableRegionInputBuilder {
        crate::operation::enable_region::builders::EnableRegionInputBuilder::default()
    }
}
