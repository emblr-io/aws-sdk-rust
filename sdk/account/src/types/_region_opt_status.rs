...
/// When writing a match expression against `RegionOptStatus`, it is important to ensure
...
///
/// ```text
/// # let regionoptstatus = unimplemented!();
/// match regionoptstatus {
...
/// }
/// ```
/// The above code demonstrates that when `regionoptstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `RegionOptStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `RegionOptStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `RegionOptStatus::NewFeature` is defined.
/// Specifically, when `regionoptstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RegionOptStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for RegionOptStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RegionOptStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RegionOptStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RegionOptStatus::from(s))
    }
}
impl RegionOptStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RegionOptStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for RegionOptStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
