...
///     ValidationExceptionReason::InvalidRegionOptTarget => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            "invalidRegionOptTarget" => ValidationExceptionReason::InvalidRegionOptTarget,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ValidationExceptionReason::InvalidRegionOptTarget => "invalidRegionOptTarget",
            ValidationExceptionReason::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["fieldValidationFailed", "invalidRegionOptTarget"]
    }
}
