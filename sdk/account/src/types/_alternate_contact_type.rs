...
impl ::std::convert::From<&str> for AlternateContactType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlternateContactType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlternateContactType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlternateContactType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AlternateContactType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
