...
impl ::std::convert::From<&str> for NetworkResourceFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceFilterKeys::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkResourceFilterKeys {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkResourceFilterKeys::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkResourceFilterKeys {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
