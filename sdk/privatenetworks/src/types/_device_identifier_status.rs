...
impl ::std::convert::From<&str> for DeviceIdentifierStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceIdentifierStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceIdentifierStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceIdentifierStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceIdentifierStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
