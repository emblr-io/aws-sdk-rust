...
impl ::std::convert::From<&str> for OrderFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderFilterKeys::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderFilterKeys {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderFilterKeys::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrderFilterKeys {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
