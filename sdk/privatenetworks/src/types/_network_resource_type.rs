...
impl ::std::convert::From<&str> for NetworkResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
