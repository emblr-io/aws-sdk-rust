...
impl ::std::convert::From<&str> for ElevationUnit {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElevationUnit::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ElevationUnit {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ElevationUnit::from(s))
    }
}
impl ElevationUnit {
...
impl ::std::convert::AsRef<str> for ElevationUnit {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ElevationUnit {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ElevationUnit::Feet => write!(f, "FEET"),
            ElevationUnit::Unknown(value) => write!(f, "{}", value),
        }
    }
}
