...
impl ::std::convert::From<&str> for NetworkSiteStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkSiteStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkSiteStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkSiteStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkSiteStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for NetworkSiteStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            NetworkSiteStatus::Available => write!(f, "AVAILABLE"),
            NetworkSiteStatus::Created => write!(f, "CREATED"),
            NetworkSiteStatus::Deleted => write!(f, "DELETED"),
            NetworkSiteStatus::Deprovisioning => write!(f, "DEPROVISIONING"),
            NetworkSiteStatus::Provisioning => write!(f, "PROVISIONING"),
            NetworkSiteStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
