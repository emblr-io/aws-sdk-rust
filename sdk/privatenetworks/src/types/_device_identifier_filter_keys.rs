...
impl ::std::convert::From<&str> for DeviceIdentifierFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceIdentifierFilterKeys::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceIdentifierFilterKeys {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceIdentifierFilterKeys::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceIdentifierFilterKeys {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
