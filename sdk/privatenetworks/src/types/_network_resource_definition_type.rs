...
impl ::std::convert::From<&str> for NetworkResourceDefinitionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkResourceDefinitionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkResourceDefinitionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkResourceDefinitionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkResourceDefinitionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
