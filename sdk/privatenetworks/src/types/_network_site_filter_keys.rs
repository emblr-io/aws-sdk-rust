...
impl ::std::convert::From<&str> for NetworkSiteFilterKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkSiteFilterKeys::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkSiteFilterKeys {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkSiteFilterKeys::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkSiteFilterKeys {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for NetworkSiteFilterKeys {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            NetworkSiteFilterKeys::Status => write!(f, "STATUS"),
            NetworkSiteFilterKeys::Unknown(value) => write!(f, "{}", value),
        }
    }
}
