...
//! offered by AWS Private 5G. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Private 5G.
...
/// let config = aws_sdk_privatenetworks::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`AcknowledgeOrderReceipt`](crate::operation::acknowledge_order_receipt) operation has
/// a [`Client::acknowledge_order_receipt`], function which returns a builder for that operation.
...
/// Configuration for AWS Private 5G.
pub mod config;
