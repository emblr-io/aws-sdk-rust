...
pub struct ListOrdersOutput {
    ...
    pub orders: ::std::option::Option<::std::vec::Vec<crate::types::Order>>,
...
impl ListOrdersOutput {
    ...
    pub fn orders(&self) -> &[crate::types::Order] {
...
impl ::aws_types::request_id::RequestId for ListOrdersOutput {
...
impl ListOrdersOutputBuilder {
    ...
    ///
    /// <p>Information about the orders.</p>
    pub fn orders(mut self, input: crate::types::Order) -> Self {
    ...
    /// <p>Information about the orders.</p>
    pub fn get_orders(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Order>> {
        &self.orders
    }
    /// <p>The token for the next page of results.</p>
