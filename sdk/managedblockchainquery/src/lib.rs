...
//! offered by Amazon Managed Blockchain Query. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Managed Blockchain Query.
...
/// For example, the [`GetTransaction`](crate::operation::get_transaction) operation has
/// a [`Client::get_transaction`], function which returns a builder for that operation.
...
/// Configuration for Amazon Managed Blockchain Query.
pub mod config;
