...
impl GraphDataSummary {
    /// Creates a new builder-style object to manufacture [`GraphDataSummary`](crate::types::GraphDataSummary).
    pub fn builder() -> crate::types::builders::GraphDataSummaryBuilder {
        crate::types::builders::GraphDataSummaryBuilder::default()
    }
}
...
impl GraphDataSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`GraphDataSummary`](crate::types::GraphDataSummary).
    pub fn build(self) -> crate::types::GraphDataSummary {
        crate::types::GraphDataSummary {
