...
impl CancelExportTaskOutputBuilder {
    ...
    /// - [`graph_id`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::graph_id)
    /// - [`role_arn`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::role_arn)
    /// - [`task_id`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::task_id)
    /// - [`status`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::status)
    /// - [`format`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::format)
    /// - [`destination`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::destination)
    /// - [`kms_key_identifier`](crate::operation::cancel_export_task::builders::CancelExportTaskOutputBuilder::kms_key_identifier)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::cancel_export_task::CancelExportTaskOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::cancel_export_task::CancelExportTaskOutput {
            graph_id: self.graph_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "graph_id",
                    "graph_id was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
            role_arn: self.role_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "role_arn",
                    "role_arn was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
            task_id: self.task_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "task_id",
                    "task_id was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
            format: self.format.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "format",
                    "format was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
            destination: self.destination.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "destination",
                    "destination was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
            kms_key_identifier: self.kms_key_identifier.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "kms_key_identifier",
                    "kms_key_identifier was not specified but it is required when building CancelExportTaskOutput",
                )
            })?,
