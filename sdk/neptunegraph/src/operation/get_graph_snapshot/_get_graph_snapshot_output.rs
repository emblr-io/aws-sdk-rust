...
impl GetGraphSnapshotOutput {
    ...
    pub fn builder() -> crate::operation::get_graph_snapshot::builders::GetGraphSnapshotOutputBuilder {
        crate::operation::get_graph_snapshot::builders::GetGraphSnapshotOutputBuilder::default()
    }
}

/// A builder for [`GetGraphSnapshotOutput`](crate::operation::get_graph_snapshot::GetGraphSnapshotOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetGraphSnapshotOutputBuilder {
