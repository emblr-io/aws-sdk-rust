...
impl GetQueryInput {
    /// Creates a new builder-style object to manufacture [`GetQueryInput`](crate::operation::get_query::GetQueryInput).
    pub fn builder() -> crate::operation::get_query::builders::GetQueryInputBuilder {
        crate::operation::get_query::builders::GetQueryInputBuilder::default()
    }
}

/// A builder for [`GetQueryInput`](crate::operation::get_query::GetQueryInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetQueryInputBuilder {
    pub(crate) graph_identifier: ::std::option::Option<::std::string::String>,
    pub(crate) query_id: ::std::option::Option<::std::string::String>,
}
impl GetQueryInputBuilder {
    /// <p>The unique identifier of the Neptune Analytics graph.</p>
