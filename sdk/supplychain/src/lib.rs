...
//! offered by AWS Supply Chain. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Supply Chain.
...
/// For example, the [`CreateBillOfMaterialsImportJob`](crate::operation::create_bill_of_materials_import_job) operation has
/// a [`Client::create_bill_of_materials_import_job`], function which returns a builder for that operation.
...
/// Configuration for AWS Supply Chain.
pub mod config;
