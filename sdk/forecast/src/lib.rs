...
//! offered by Amazon Forecast Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Forecast Service.
...
/// For example, the [`CreateAutoPredictor`](crate::operation::create_auto_predictor) operation has
...
/// Configuration for Amazon Forecast Service.
pub mod config;
