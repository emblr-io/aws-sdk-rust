...
impl ::aws_types::request_id::RequestId for UpdateDatasetGroupOutput {
...
impl UpdateDatasetGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateDatasetGroupOutput`](crate::operation::update_dataset_group::UpdateDatasetGroupOutput).
    pub fn build(self) -> crate::operation::update_dataset_group::UpdateDatasetGroupOutput {
