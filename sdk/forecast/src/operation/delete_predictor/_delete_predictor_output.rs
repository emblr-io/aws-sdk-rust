...
impl DeletePredictorOutput {
    ...
    pub fn builder() -> crate::operation::delete_predictor::builders::DeletePredictorOutputBuilder {
        crate::operation::delete_predictor::builders::DeletePredictorOutputBuilder::default()
    }
}

/// A builder for [`DeletePredictorOutput`](crate::operation::delete_predictor::DeletePredictorOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeletePredictorOutputBuilder {
    _request_id: Option<String>,
}
