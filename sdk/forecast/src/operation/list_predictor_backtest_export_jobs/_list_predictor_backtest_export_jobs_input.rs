...
pub struct ListPredictorBacktestExportJobsInput {
    ...
    /// <ul>
    /// <li>
    /// <p><code>Condition</code> - The condition to apply. Valid values are <code>IS</code> and <code>IS_NOT</code>. To include the predictor backtest export jobs that match the statement, specify <code>IS</code>. To exclude matching predictor backtest export jobs, specify <code>IS_NOT</code>.</p></li>
    /// <li>
    /// <p><code>Key</code> - The name of the parameter to filter on. Valid values are <code>PredictorArn</code> and <code>Status</code>.</p></li>
    /// <li>
...
impl ListPredictorBacktestExportJobsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListPredictorBacktestExportJobsInput`](crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
