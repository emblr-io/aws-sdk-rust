...
impl ::aws_types::request_id::RequestId for ListDatasetImportJobsOutput {
...
impl ListDatasetImportJobsOutputBuilder {
    ...
    pub fn dataset_import_jobs(mut self, input: crate::types::DatasetImportJobSummary) -> Self {
        ...
        v.push(input);
        self.dataset_import_jobs = ::std::option::Option::Some(v);
        self
    }
    /// <p>An array of objects that summarize each dataset import job's properties.</p>
    ...
    /// <p>An array of objects that summarize each dataset import job's properties.</p>
    pub fn get_dataset_import_jobs(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::DatasetImportJobSummary>> {
