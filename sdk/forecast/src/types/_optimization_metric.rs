...
impl ::std::convert::From<&str> for OptimizationMetric {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OptimizationMetric::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OptimizationMetric {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OptimizationMetric::from(s))
    }
}
