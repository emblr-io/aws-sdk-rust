...
impl ::std::convert::From<&str> for TimePointGranularity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimePointGranularity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimePointGranularity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimePointGranularity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TimePointGranularity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
