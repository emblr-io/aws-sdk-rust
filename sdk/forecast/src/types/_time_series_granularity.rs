...
impl ::std::convert::From<&str> for TimeSeriesGranularity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimeSeriesGranularity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimeSeriesGranularity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimeSeriesGranularity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TimeSeriesGranularity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
