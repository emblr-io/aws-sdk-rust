...
impl ::std::convert::From<&str> for FilterConditionString {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterConditionString::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterConditionString {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterConditionString::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterConditionString {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
