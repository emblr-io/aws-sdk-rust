...
impl ::std::convert::From<&str> for ImportMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImportMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImportMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImportMode::from(s))
    }
}
impl ImportMode {
...
impl ::std::convert::AsRef<str> for ImportMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
