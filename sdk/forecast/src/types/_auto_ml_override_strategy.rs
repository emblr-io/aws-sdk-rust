...
impl ::std::convert::From<&str> for AutoMlOverrideStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlOverrideStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlOverrideStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlOverrideStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoMlOverrideStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
