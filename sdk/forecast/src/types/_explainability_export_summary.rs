...
impl ExplainabilityExportSummary {
    /// Creates a new builder-style object to manufacture [`ExplainabilityExportSummary`](crate::types::ExplainabilityExportSummary).
    pub fn builder() -> crate::types::builders::ExplainabilityExportSummaryBuilder {
        crate::types::builders::ExplainabilityExportSummaryBuilder::default()
    }
}
...
impl ExplainabilityExportSummaryBuilder {
    ...
    pub fn build(self) -> crate::types::ExplainabilityExportSummary {
        crate::types::ExplainabilityExportSummary {
