...
pub struct BatchDisassociateCodeSecurityScanConfigurationOutput {
...
impl BatchDisassociateCodeSecurityScanConfigurationOutput {
    /// <p>Details of any code repositories that failed to be disassociated from the scan configuration.</p>
    ///
...
impl ::aws_types::request_id::RequestId for BatchDisassociateCodeSecurityScanConfigurationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl BatchDisassociateCodeSecurityScanConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`BatchDisassociateCodeSecurityScanConfigurationOutput`](crate::operation::batch_disassociate_code_security_scan_configuration::BatchDisassociateCodeSecurityScanConfigurationOutput).
    pub fn builder(
    ) -> crate::operation::batch_disassociate_code_security_scan_configuration::builders::BatchDisassociateCodeSecurityScanConfigurationOutputBuilder
    {
        crate::operation::batch_disassociate_code_security_scan_configuration::builders::BatchDisassociateCodeSecurityScanConfigurationOutputBuilder::default()
    }
}

/// A builder for [`BatchDisassociateCodeSecurityScanConfigurationOutput`](crate::operation::batch_disassociate_code_security_scan_configuration::BatchDisassociateCodeSecurityScanConfigurationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BatchDisassociateCodeSecurityScanConfigurationOutputBuilder {
...
impl BatchDisassociateCodeSecurityScanConfigurationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`BatchDisassociateCodeSecurityScanConfigurationOutput`](crate::operation::batch_disassociate_code_security_scan_configuration::BatchDisassociateCodeSecurityScanConfigurationOutput).
    pub fn build(
        self,
    ) -> crate::operation::batch_disassociate_code_security_scan_configuration::BatchDisassociateCodeSecurityScanConfigurationOutput {
        crate::operation::batch_disassociate_code_security_scan_configuration::BatchDisassociateCodeSecurityScanConfigurationOutput {
