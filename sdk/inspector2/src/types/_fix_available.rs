...
impl ::std::convert::From<&str> for FixAvailable {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FixAvailable::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FixAvailable {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FixAvailable::from(s))
    }
}
impl FixAvailable {
...
impl ::std::convert::AsRef<str> for FixAvailable {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
