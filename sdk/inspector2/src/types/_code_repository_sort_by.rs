...
///     CodeRepositorySortBy::All => { /* ... */ },
///     CodeRepositorySortBy::Critical => { /* ... */ },
///     CodeRepositorySortBy::High => { /* ... */ },
...
impl ::std::convert::From<&str> for CodeRepositorySortBy {
    fn from(s: &str) -> Self {
        match s {
            "ALL" => CodeRepositorySortBy::All,
            "CRITICAL" => CodeRepositorySortBy::Critical,
            "HIGH" => CodeRepositorySortBy::High,
            other => CodeRepositorySortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CodeRepositorySortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CodeRepositorySortBy::from(s))
    }
}
impl CodeRepositorySortBy {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CodeRepositorySortBy::All => "ALL",
            CodeRepositorySortBy::Critical => "CRITICAL",
            CodeRepositorySortBy::High => "HIGH",
...
impl ::std::convert::AsRef<str> for CodeRepositorySortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
