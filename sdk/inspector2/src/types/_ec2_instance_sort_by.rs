...
impl ::std::convert::From<&str> for Ec2InstanceSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Ec2InstanceSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Ec2InstanceSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Ec2InstanceSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Ec2InstanceSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
