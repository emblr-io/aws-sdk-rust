...
impl UpdateCisTargets {
    /// Creates a new builder-style object to manufacture [`UpdateCisTargets`](crate::types::UpdateCisTargets).
    pub fn builder() -> crate::types::builders::UpdateCisTargetsBuilder {
        crate::types::builders::UpdateCisTargetsBuilder::default()
    }
}

/// A builder for [`UpdateCisTargets`](crate::types::UpdateCisTargets).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateCisTargetsBuilder {
    pub(crate) account_ids: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    pub(crate) target_resource_tags:
        ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<::std::string::String>>>,
}
impl UpdateCisTargetsBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateCisTargets`](crate::types::UpdateCisTargets).
    pub fn build(self) -> crate::types::UpdateCisTargets {
        crate::types::UpdateCisTargets {
