...
impl ::std::convert::From<&str> for GroupKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupKey::from(s))
    }
}
impl GroupKey {
...
impl ::std::convert::AsRef<str> for GroupKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
