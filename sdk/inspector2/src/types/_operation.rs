...
/// match operation {
///     Operation::DisableRepository => { /* ... */ },
///     Operation::DisableScanning => { /* ... */ },
///     Operation::EnableRepository => { /* ... */ },
///     Operation::EnableScanning => { /* ... */ },
...
impl ::std::convert::From<&str> for Operation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Operation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Operation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Operation::from(s))
    }
}
impl Operation {
...
impl ::std::convert::AsRef<str> for Operation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
