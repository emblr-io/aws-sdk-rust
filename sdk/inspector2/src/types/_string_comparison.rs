...
impl ::std::convert::From<&str> for StringComparison {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StringComparison::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StringComparison {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StringComparison::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StringComparison {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
