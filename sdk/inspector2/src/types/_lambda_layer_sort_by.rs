...
impl ::std::convert::From<&str> for LambdaLayerSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LambdaLayerSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LambdaLayerSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LambdaLayerSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LambdaLayerSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
