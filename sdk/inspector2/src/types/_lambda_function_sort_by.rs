...
impl ::std::convert::From<&str> for LambdaFunctionSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LambdaFunctionSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LambdaFunctionSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LambdaFunctionSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LambdaFunctionSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
