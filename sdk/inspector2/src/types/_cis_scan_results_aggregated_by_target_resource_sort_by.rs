...
/// When writing a match expression against `CisScanResultsAggregatedByTargetResourceSortBy`, it is important to ensure
...
///     CisScanResultsAggregatedByTargetResourceSortBy::AccountId => { /* ... */ },
///     CisScanResultsAggregatedByTargetResourceSortBy::FailedCounts => { /* ... */ },
///     CisScanResultsAggregatedByTargetResourceSortBy::Platform => { /* ... */ },
///     CisScanResultsAggregatedByTargetResourceSortBy::ResourceId => { /* ... */ },
///     CisScanResultsAggregatedByTargetResourceSortBy::TargetStatus => { /* ... */ },
///     CisScanResultsAggregatedByTargetResourceSortBy::TargetStatusReason => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `cisscanresultsaggregatedbytargetresourcesortby` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `CisScanResultsAggregatedByTargetResourceSortBy::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `CisScanResultsAggregatedByTargetResourceSortBy::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `CisScanResultsAggregatedByTargetResourceSortBy::NewFeature` is defined.
