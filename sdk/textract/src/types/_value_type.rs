...
impl ::std::convert::From<&str> for ValueType {
    fn from(s: &str) -> Self {
        match s {
            "DATE" => ValueType::Date,
            other => ValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValueType::from(s))
    }
}
impl ValueType {
...
impl ::std::convert::AsRef<str> for ValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
