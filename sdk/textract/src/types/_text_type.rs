...
impl ::std::convert::From<&str> for TextType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TextType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TextType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TextType::from(s))
    }
}
impl TextType {
...
impl ::std::convert::AsRef<str> for TextType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TextType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TextType::Handwriting => write!(f, "HANDWRITING"),
            TextType::Printed => write!(f, "PRINTED"),
            TextType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
