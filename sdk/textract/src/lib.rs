...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-textract/latest/aws_sdk_textract/client/struct.Client.html)
...
//! offered by Amazon Textract. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Textract.
...
/// Configuration for Amazon Textract.
pub mod config;
