...
impl ::std::convert::From<&str> for ListDevicesSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListDevicesSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListDevicesSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListDevicesSortBy::from(s))
    }
}
impl ListDevicesSortBy {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CREATED_TIME", "DEVICE_AGGREGATED_STATUS", "DEVICE_ID", "NAME"]
    }
}
impl ::std::convert::AsRef<str> for ListDevicesSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
