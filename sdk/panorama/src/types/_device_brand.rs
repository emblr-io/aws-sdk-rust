...
impl ::std::convert::From<&str> for DeviceBrand {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceBrand::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceBrand {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceBrand::from(s))
    }
}
impl DeviceBrand {
...
impl ::std::convert::AsRef<str> for DeviceBrand {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
