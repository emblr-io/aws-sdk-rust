...
impl ::std::convert::From<&str> for JobResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JobResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
