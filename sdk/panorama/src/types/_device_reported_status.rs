...
impl ::std::convert::From<&str> for DeviceReportedStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceReportedStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceReportedStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceReportedStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceReportedStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
