...
impl ::std::convert::From<&str> for NodeFromTemplateJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeFromTemplateJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeFromTemplateJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeFromTemplateJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NodeFromTemplateJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
