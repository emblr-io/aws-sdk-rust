...
impl ::std::convert::From<&str> for NodeInstanceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeInstanceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeInstanceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeInstanceStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NodeInstanceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
