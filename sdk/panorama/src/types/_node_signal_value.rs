...
impl ::std::convert::From<&str> for NodeSignalValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeSignalValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeSignalValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeSignalValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NodeSignalValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
