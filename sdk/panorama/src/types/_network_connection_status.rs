...
impl ::std::convert::From<&str> for NetworkConnectionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkConnectionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkConnectionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkConnectionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkConnectionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
