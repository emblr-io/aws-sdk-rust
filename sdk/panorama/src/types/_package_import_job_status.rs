...
impl ::std::convert::From<&str> for PackageImportJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PackageImportJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PackageImportJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PackageImportJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PackageImportJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
