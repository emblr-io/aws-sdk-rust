...
impl ::std::convert::From<&str> for StatusFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatusFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatusFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatusFilter::from(s))
    }
}
impl StatusFilter {
...
impl ::std::convert::AsRef<str> for StatusFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
