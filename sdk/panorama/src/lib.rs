...
//! offered by AWS Panorama. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Panorama.
...
/// For example, the [`CreateApplicationInstance`](crate::operation::create_application_instance) operation has
...
/// Configuration for AWS Panorama.
pub mod config;
