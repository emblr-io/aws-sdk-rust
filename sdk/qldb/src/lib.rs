...
//! offered by Amazon QLDB. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon QLDB.
...
/// For example, the [`CancelJournalKinesisStream`](crate::operation::cancel_journal_kinesis_stream) operation has
/// a [`Client::cancel_journal_kinesis_stream`], function which returns a builder for that operation.
