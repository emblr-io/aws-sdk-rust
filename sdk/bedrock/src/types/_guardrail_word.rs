...
impl ::std::fmt::Debug for GuardrailWord {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GuardrailWord");
...
impl ::std::fmt::Debug for GuardrailWordBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GuardrailWordBuilder");
        formatter.field("text", &self.text);
        formatter.field("input_action", &"*** Sensitive Data Redacted ***");
        formatter.field("output_action", &"*** Sensitive Data Redacted ***");
        formatter.field("input_enabled", &self.input_enabled);
