...
impl ::std::convert::From<&str> for InferenceType {
    fn from(s: &str) -> Self {
        match s {
            "ON_DEMAND" => InferenceType::OnDemand,
            "PROVISIONED" => InferenceType::Provisioned,
            other => InferenceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferenceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferenceType::from(s))
    }
}
impl InferenceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            InferenceType::OnDemand => "ON_DEMAND",
            InferenceType::Provisioned => "PROVISIONED",
            InferenceType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for InferenceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
