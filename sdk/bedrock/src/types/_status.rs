...
impl ::std::convert::From<&str> for Status {
    fn from(s: &str) -> Self {
        match s {
            "INCOMPATIBLE_ENDPOINT" => Status::IncompatibleEndpoint,
...
impl Status {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Status::IncompatibleEndpoint => "INCOMPATIBLE_ENDPOINT",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["INCOMPATIBLE_ENDPOINT", "REGISTERED"]
    }
}
