...
pub enum QuickResponseContentProvider {
...
impl QuickResponseContentProvider {
...
impl ::std::fmt::Debug for QuickResponseContentProvider {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            QuickResponseContentProvider::Content(_) => f.debug_tuple("*** Sensitive Data Redacted ***").finish(),
            QuickResponseContentProvider::Unknown => f.debug_tuple("Unknown").finish(),
        }
    }
}
