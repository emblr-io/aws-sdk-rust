...
impl ::std::convert::From<&str> for ContentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentStatus::from(s))
    }
}
impl ContentStatus {
...
impl ::std::convert::AsRef<str> for ContentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
