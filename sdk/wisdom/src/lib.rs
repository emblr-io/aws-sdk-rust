...
//! offered by Amazon Connect Wisdom Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Connect Wisdom Service.
...
/// For example, the [`CreateAssistant`](crate::operation::create_assistant) operation has
/// a [`Client::create_assistant`], function which returns a builder for that operation.
...
/// Configuration for Amazon Connect Wisdom Service.
pub mod config;
