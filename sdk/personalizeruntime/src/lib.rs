...
//! offered by Amazon Personalize Runtime. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Personalize Runtime.
...
/// Configuration for Amazon Personalize Runtime.
pub mod config;
