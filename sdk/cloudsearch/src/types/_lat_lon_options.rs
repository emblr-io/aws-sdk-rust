...
impl LatLonOptions {
    /// Creates a new builder-style object to manufacture [`LatLonOptions`](crate::types::LatLonOptions).
    pub fn builder() -> crate::types::builders::LatLonOptionsBuilder {
        crate::types::builders::LatLonOptionsBuilder::default()
    }
}

/// A builder for [`LatLonOptions`](crate::types::LatLonOptions).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LatLonOptionsBuilder {
...
impl LatLonOptionsBuilder {
    ...
    /// Consumes the builder and constructs a [`LatLonOptions`](crate::types::LatLonOptions).
    pub fn build(self) -> crate::types::LatLonOptions {
        crate::types::LatLonOptions {
