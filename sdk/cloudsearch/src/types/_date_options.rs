...
impl DateOptions {
    /// Creates a new builder-style object to manufacture [`DateOptions`](crate::types::DateOptions).
    pub fn builder() -> crate::types::builders::DateOptionsBuilder {
        crate::types::builders::DateOptionsBuilder::default()
    }
}
