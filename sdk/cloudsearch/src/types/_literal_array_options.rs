...
impl LiteralArrayOptions {
    /// Creates a new builder-style object to manufacture [`LiteralArrayOptions`](crate::types::LiteralArrayOptions).
    pub fn builder() -> crate::types::builders::LiteralArrayOptionsBuilder {
        crate::types::builders::LiteralArrayOptionsBuilder::default()
    }
}

/// A builder for [`LiteralArrayOptions`](crate::types::LiteralArrayOptions).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LiteralArrayOptionsBuilder {
...
impl LiteralArrayOptionsBuilder {
    /// A value to use for the field if the field isn't specified for a document.
    ...
    pub fn build(self) -> crate::types::LiteralArrayOptions {
        crate::types::LiteralArrayOptions {
