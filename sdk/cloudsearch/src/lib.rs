...
//! aws-sdk-cloudsearch = "0.0.0-local"
...
//! offered by Amazon CloudSearch. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudSearch.
...
/// For example, the [`BuildSuggesters`](crate::operation::build_suggesters) operation has
