...
pub struct OpenIdConnectAccessTokenConfigurationItem {
...
impl ::std::fmt::Debug for OpenIdConnectAccessTokenConfigurationItem {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("OpenIdConnectAccessTokenConfigurationItem");
...
impl OpenIdConnectAccessTokenConfigurationItem {
    /// Creates a new builder-style object to manufacture [`OpenIdConnectAccessTokenConfigurationItem`](crate::types::OpenIdConnectAccessTokenConfigurationItem).
    pub fn builder() -> crate::types::builders::OpenIdConnectAccessTokenConfigurationItemBuilder {
        crate::types::builders::OpenIdConnectAccessTokenConfigurationItemBuilder::default()
    }
}

/// A builder for [`OpenIdConnectAccessTokenConfigurationItem`](crate::types::OpenIdConnectAccessTokenConfigurationItem).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct OpenIdConnectAccessTokenConfigurationItemBuilder {
...
impl OpenIdConnectAccessTokenConfigurationItemBuilder {
    ...
    /// Consumes the builder and constructs a [`OpenIdConnectAccessTokenConfigurationItem`](crate::types::OpenIdConnectAccessTokenConfigurationItem).
    pub fn build(self) -> crate::types::OpenIdConnectAccessTokenConfigurationItem {
        crate::types::OpenIdConnectAccessTokenConfigurationItem {
            principal_id_claim: self.principal_id_claim.unwrap_or_else(|| "sub".to_owned()),
            audiences: self.audiences,
        }
    }
}
impl ::std::fmt::Debug for OpenIdConnectAccessTokenConfigurationItemBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("OpenIdConnectAccessTokenConfigurationItemBuilder");
        formatter.field("principal_id_claim", &"*** Sensitive Data Redacted ***");
        formatter.field("audiences", &self.audiences);
        formatter.finish()
    }
