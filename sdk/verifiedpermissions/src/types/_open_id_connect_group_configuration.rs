...
impl ::std::fmt::Debug for OpenIdConnectGroupConfiguration {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("OpenIdConnectGroupConfiguration");
...
impl OpenIdConnectGroupConfiguration {
    /// Creates a new builder-style object to manufacture [`OpenIdConnectGroupConfiguration`](crate::types::OpenIdConnectGroupConfiguration).
    pub fn builder() -> crate::types::builders::OpenIdConnectGroupConfigurationBuilder {
        crate::types::builders::OpenIdConnectGroupConfigurationBuilder::default()
    }
}
...
impl OpenIdConnectGroupConfigurationBuilder {
    /// <p>The token claim that you want Verified Permissions to interpret as group membership. For example, <code>groups</code>.</p>
    ...
    /// Consumes the builder and constructs a [`OpenIdConnectGroupConfiguration`](crate::types::OpenIdConnectGroupConfiguration).
    /// This method will fail if any of the following fields are not set:
    /// - [`group_claim`](crate::types::builders::OpenIdConnectGroupConfigurationBuilder::group_claim)
    /// - [`group_entity_type`](crate::types::builders::OpenIdConnectGroupConfigurationBuilder::group_entity_type)
    pub fn build(self) -> ::std::result::Result<crate::types::OpenIdConnectGroupConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::OpenIdConnectGroupConfiguration {
            group_claim: self.group_claim.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "group_claim",
                    "group_claim was not specified but it is required when building OpenIdConnectGroupConfiguration",
                )
            })?,
            group_entity_type: self.group_entity_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "group_entity_type",
                    "group_entity_type was not specified but it is required when building OpenIdConnectGroupConfiguration",
                )
            })?,
        })
    }
}
impl ::std::fmt::Debug for OpenIdConnectGroupConfigurationBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("OpenIdConnectGroupConfigurationBuilder");
        formatter.field("group_claim", &"*** Sensitive Data Redacted ***");
        formatter.field("group_entity_type", &"*** Sensitive Data Redacted ***");
        formatter.finish()
    }
