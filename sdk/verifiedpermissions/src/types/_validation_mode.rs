...
impl ::std::convert::From<&str> for ValidationMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ValidationMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValidationMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValidationMode::from(s))
    }
}
impl ValidationMode {
...
impl ::std::convert::AsRef<str> for ValidationMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
