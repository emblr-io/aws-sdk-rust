...
pub struct UpdateOpenIdConnectAccessTokenConfiguration {
...
impl UpdateOpenIdConnectAccessTokenConfiguration {
    /// <p>The claim that determines the principal in OIDC access tokens. For example, <code>sub</code>.</p>
...
impl ::std::fmt::Debug for UpdateOpenIdConnectAccessTokenConfiguration {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateOpenIdConnectAccessTokenConfiguration");
...
impl UpdateOpenIdConnectAccessTokenConfiguration {
    /// Creates a new builder-style object to manufacture [`UpdateOpenIdConnectAccessTokenConfiguration`](crate::types::UpdateOpenIdConnectAccessTokenConfiguration).
    pub fn builder() -> crate::types::builders::UpdateOpenIdConnectAccessTokenConfigurationBuilder {
        crate::types::builders::UpdateOpenIdConnectAccessTokenConfigurationBuilder::default()
    }
}

/// A builder for [`UpdateOpenIdConnectAccessTokenConfiguration`](crate::types::UpdateOpenIdConnectAccessTokenConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct UpdateOpenIdConnectAccessTokenConfigurationBuilder {
...
impl UpdateOpenIdConnectAccessTokenConfigurationBuilder {
    /// <p>The claim that determines the principal in OIDC access tokens. For example, <code>sub</code>.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateOpenIdConnectAccessTokenConfiguration`](crate::types::UpdateOpenIdConnectAccessTokenConfiguration).
    pub fn build(self) -> crate::types::UpdateOpenIdConnectAccessTokenConfiguration {
        crate::types::UpdateOpenIdConnectAccessTokenConfiguration {
            principal_id_claim: self.principal_id_claim.unwrap_or_else(|| "sub".to_owned()),
            audiences: self.audiences,
        }
    }
}
impl ::std::fmt::Debug for UpdateOpenIdConnectAccessTokenConfigurationBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateOpenIdConnectAccessTokenConfigurationBuilder");
        formatter.field("principal_id_claim", &"*** Sensitive Data Redacted ***");
        formatter.field("audiences", &self.audiences);
        formatter.finish()
    }
