...
impl TemplateLinkedPolicyDefinitionDetail {
    /// Creates a new builder-style object to manufacture [`TemplateLinkedPolicyDefinitionDetail`](crate::types::TemplateLinkedPolicyDefinitionDetail).
    pub fn builder() -> crate::types::builders::TemplateLinkedPolicyDefinitionDetailBuilder {
        crate::types::builders::TemplateLinkedPolicyDefinitionDetailBuilder::default()
    }
}

/// A builder for [`TemplateLinkedPolicyDefinitionDetail`](crate::types::TemplateLinkedPolicyDefinitionDetail).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TemplateLinkedPolicyDefinitionDetailBuilder {
...
impl TemplateLinkedPolicyDefinitionDetailBuilder {
    /// <p>The unique identifier of the policy template used to create this policy.</p>
    ...
    /// Consumes the builder and constructs a [`TemplateLinkedPolicyDefinitionDetail`](crate::types::TemplateLinkedPolicyDefinitionDetail).
    /// This method will fail if any of the following fields are not set:
    /// - [`policy_template_id`](crate::types::builders::TemplateLinkedPolicyDefinitionDetailBuilder::policy_template_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::TemplateLinkedPolicyDefinitionDetail, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::TemplateLinkedPolicyDefinitionDetail {
            policy_template_id: self.policy_template_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "policy_template_id",
                    "policy_template_id was not specified but it is required when building TemplateLinkedPolicyDefinitionDetail",
                )
            })?,
