...
impl OpenIdConnectIdentityTokenConfiguration {
    /// <p>The claim that determines the principal in OIDC access tokens. For example, <code>sub</code>.</p>
...
impl ::std::fmt::Debug for OpenIdConnectIdentityTokenConfiguration {
...
impl OpenIdConnectIdentityTokenConfiguration {
    /// Creates a new builder-style object to manufacture [`OpenIdConnectIdentityTokenConfiguration`](crate::types::OpenIdConnectIdentityTokenConfiguration).
    pub fn builder() -> crate::types::builders::OpenIdConnectIdentityTokenConfigurationBuilder {
        crate::types::builders::OpenIdConnectIdentityTokenConfigurationBuilder::default()
    }
}
...
impl OpenIdConnectIdentityTokenConfigurationBuilder {
    /// <p>The claim that determines the principal in OIDC access tokens. For example, <code>sub</code>.</p>
    ...
    /// Consumes the builder and constructs a [`OpenIdConnectIdentityTokenConfiguration`](crate::types::OpenIdConnectIdentityTokenConfiguration).
    pub fn build(self) -> crate::types::OpenIdConnectIdentityTokenConfiguration {
        crate::types::OpenIdConnectIdentityTokenConfiguration {
            principal_id_claim: self.principal_id_claim.unwrap_or_else(|| "sub".to_owned()),
            client_ids: self.client_ids,
        }
    }
}
impl ::std::fmt::Debug for OpenIdConnectIdentityTokenConfigurationBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
