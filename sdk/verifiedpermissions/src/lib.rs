...
/// For example, the [`BatchIsAuthorized`](crate::operation::batch_is_authorized) operation has
/// a [`Client::batch_is_authorized`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.batch_is_authorized()
