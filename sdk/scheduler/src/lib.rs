...
//! offered by Amazon EventBridge Scheduler. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon EventBridge Scheduler.
...
/// For example, the [`CreateSchedule`](crate::operation::create_schedule) operation has
/// a [`Client::create_schedule`], function which returns a builder for that operation.
...
/// Configuration for Amazon EventBridge Scheduler.
pub mod config;
