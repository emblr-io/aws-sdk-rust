...
impl ::std::convert::From<&str> for FlexibleTimeWindowMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FlexibleTimeWindowMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FlexibleTimeWindowMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FlexibleTimeWindowMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FlexibleTimeWindowMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
