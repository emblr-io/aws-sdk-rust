...
pub enum ActionAfterCompletion {
    #[allow(missing_docs)] // documentation missing in model
    Delete,
    #[allow(missing_docs)] // documentation missing in model
    None,
...
impl ::std::convert::From<&str> for ActionAfterCompletion {
    fn from(s: &str) -> Self {
        match s {
            "DELETE" => ActionAfterCompletion::Delete,
            "NONE" => ActionAfterCompletion::None,
            other => ActionAfterCompletion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionAfterCompletion {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionAfterCompletion::from(s))
    }
}
impl ActionAfterCompletion {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ActionAfterCompletion::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ActionAfterCompletion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
