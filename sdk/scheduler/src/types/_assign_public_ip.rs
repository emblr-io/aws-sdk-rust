...
impl ::std::convert::From<&str> for AssignPublicIp {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssignPublicIp::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssignPublicIp {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssignPublicIp::from(s))
    }
}
impl AssignPublicIp {
...
impl ::std::convert::AsRef<str> for AssignPublicIp {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
