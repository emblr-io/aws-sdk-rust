...
impl ::std::convert::From<&str> for ScheduleGroupState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScheduleGroupState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScheduleGroupState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScheduleGroupState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScheduleGroupState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
