...
impl ::std::convert::From<&str> for PositionSolverProvider {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PositionSolverProvider::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PositionSolverProvider {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PositionSolverProvider::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PositionSolverProvider {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
