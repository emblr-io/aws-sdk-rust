...
impl ::std::convert::From<&str> for PositionConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PositionConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PositionConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PositionConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PositionConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PositionConfigurationStatus {
