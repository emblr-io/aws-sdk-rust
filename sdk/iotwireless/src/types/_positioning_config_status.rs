...
impl ::std::convert::From<&str> for PositioningConfigStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PositioningConfigStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PositioningConfigStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PositioningConfigStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PositioningConfigStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
