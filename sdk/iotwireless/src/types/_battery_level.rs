...
impl ::std::convert::From<&str> for BatteryLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatteryLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatteryLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatteryLevel::from(s))
    }
}
impl BatteryLevel {
...
impl ::std::convert::AsRef<str> for BatteryLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
