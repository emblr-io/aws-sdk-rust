...
impl ::std::convert::From<&str> for DownlinkMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DownlinkMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DownlinkMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DownlinkMode::from(s))
    }
}
impl DownlinkMode {
...
impl ::std::convert::AsRef<str> for DownlinkMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
