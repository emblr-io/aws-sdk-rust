...
impl ::std::convert::From<&str> for ApplicationConfigType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationConfigType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationConfigType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationConfigType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationConfigType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ApplicationConfigType {
