...
impl ::std::convert::From<&str> for WirelessDeviceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WirelessDeviceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WirelessDeviceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WirelessDeviceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WirelessDeviceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for WirelessDeviceType {
