...
impl ::std::convert::From<&str> for PartnerType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PartnerType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PartnerType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PartnerType::from(s))
    }
}
impl PartnerType {
...
impl ::std::convert::AsRef<str> for PartnerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
