...
impl ::std::convert::From<&str> for PositionResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PositionResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PositionResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PositionResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PositionResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
