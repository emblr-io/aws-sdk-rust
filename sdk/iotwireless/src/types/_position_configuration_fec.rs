...
impl ::std::convert::From<&str> for PositionConfigurationFec {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PositionConfigurationFec::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PositionConfigurationFec {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PositionConfigurationFec::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PositionConfigurationFec {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
