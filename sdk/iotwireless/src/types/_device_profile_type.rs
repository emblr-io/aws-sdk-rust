...
impl ::std::convert::From<&str> for DeviceProfileType {
    fn from(s: &str) -> Self {
        match s {
            "LoRaWAN" => DeviceProfileType::LoRaWan,
            "Sidewalk" => DeviceProfileType::Sidewalk,
            other => DeviceProfileType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceProfileType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceProfileType::from(s))
    }
}
impl DeviceProfileType {
    /// Returns the `&str` value of the enum member.
    pub fn as_str(&self) -> &str {
        match self {
            DeviceProfileType::LoRaWan => "LoRaWAN",
            DeviceProfileType::Sidewalk => "Sidewalk",
            DeviceProfileType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for DeviceProfileType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
