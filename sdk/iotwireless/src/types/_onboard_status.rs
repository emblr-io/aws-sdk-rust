...
impl ::std::convert::From<&str> for OnboardStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OnboardStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OnboardStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OnboardStatus::from(s))
    }
}
impl OnboardStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OnboardStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["FAILED", "INITIALIZED", "ONBOARDED", "PENDING"]
    }
}
impl ::std::convert::AsRef<str> for OnboardStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
