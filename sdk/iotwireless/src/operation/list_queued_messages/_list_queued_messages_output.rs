...
impl ListQueuedMessagesOutput {
    ...
    /// <p>The messages in the downlink queue.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.downlink_queue_messages_list.is_none()`.
    pub fn downlink_queue_messages_list(&self) -> &[crate::types::DownlinkQueueMessage] {
