...
impl ::aws_types::request_id::RequestId for UpdatePartnerAccountOutput {
...
impl UpdatePartnerAccountOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdatePartnerAccountOutput`](crate::operation::update_partner_account::UpdatePartnerAccountOutput).
    pub fn build(self) -> crate::operation::update_partner_account::UpdatePartnerAccountOutput {
