...
pub struct CreateAppVersionResourceOutput {
...
impl ::aws_types::request_id::RequestId for CreateAppVersionResourceOutput {
...
impl CreateAppVersionResourceOutputBuilder {
    ...
    /// - [`app_arn`](crate::operation::create_app_version_resource::builders::CreateAppVersionResourceOutputBuilder::app_arn)
    /// - [`app_version`](crate::operation::create_app_version_resource::builders::CreateAppVersionResourceOutputBuilder::app_version)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_app_version_resource::CreateAppVersionResourceOutput {
            app_arn: self.app_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "app_arn",
                    "app_arn was not specified but it is required when building CreateAppVersionResourceOutput",
                )
            })?,
            app_version: self.app_version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "app_version",
                    "app_version was not specified but it is required when building CreateAppVersionResourceOutput",
                )
            })?,
