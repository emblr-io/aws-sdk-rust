...
impl ::std::convert::From<&str> for EstimatedCostTier {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EstimatedCostTier::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EstimatedCostTier {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EstimatedCostTier::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EstimatedCostTier {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
