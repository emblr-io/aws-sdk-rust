...
impl ::std::convert::From<&str> for ResiliencyPolicyTier {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResiliencyPolicyTier::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResiliencyPolicyTier {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResiliencyPolicyTier::from(s))
    }
}
