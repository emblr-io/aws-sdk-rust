...
impl ::std::convert::From<&str> for DisruptionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DisruptionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DisruptionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DisruptionType::from(s))
    }
}
impl DisruptionType {
...
impl ::std::convert::AsRef<str> for DisruptionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
