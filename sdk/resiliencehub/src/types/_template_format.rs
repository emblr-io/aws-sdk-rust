...
impl ::std::convert::From<&str> for TemplateFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TemplateFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TemplateFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TemplateFormat::from(s))
    }
}
impl TemplateFormat {
...
impl ::std::convert::AsRef<str> for TemplateFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
