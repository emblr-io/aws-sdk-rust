...
impl ::std::convert::From<&str> for AppComplianceStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppComplianceStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppComplianceStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppComplianceStatusType::from(s))
    }
}
