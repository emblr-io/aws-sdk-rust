...
impl ::std::convert::From<&str> for AssessmentInvoker {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssessmentInvoker::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssessmentInvoker {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssessmentInvoker::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssessmentInvoker {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
