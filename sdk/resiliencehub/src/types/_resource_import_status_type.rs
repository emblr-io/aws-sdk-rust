...
impl ::std::convert::From<&str> for ResourceImportStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceImportStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceImportStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceImportStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceImportStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
