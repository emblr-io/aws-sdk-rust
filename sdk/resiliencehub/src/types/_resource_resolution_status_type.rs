...
impl ::std::convert::From<&str> for ResourceResolutionStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceResolutionStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceResolutionStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceResolutionStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceResolutionStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
