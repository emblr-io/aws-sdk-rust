...
impl ::std::convert::From<&str> for PhysicalIdentifierType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PhysicalIdentifierType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PhysicalIdentifierType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PhysicalIdentifierType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PhysicalIdentifierType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PhysicalIdentifierType {
