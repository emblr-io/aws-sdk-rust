...
impl ::std::convert::From<&str> for AppStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppStatusType::from(s))
    }
}
impl AppStatusType {
...
impl ::std::convert::AsRef<str> for AppStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
