...
impl ::std::convert::From<&str> for CostFrequency {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CostFrequency::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CostFrequency {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CostFrequency::from(s))
    }
}
impl CostFrequency {
...
impl ::std::convert::AsRef<str> for CostFrequency {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
