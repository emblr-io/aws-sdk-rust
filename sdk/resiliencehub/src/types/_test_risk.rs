...
impl ::std::convert::From<&str> for TestRisk {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TestRisk::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TestRisk {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TestRisk::from(s))
    }
}
impl TestRisk {
...
impl ::std::convert::AsRef<str> for TestRisk {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
