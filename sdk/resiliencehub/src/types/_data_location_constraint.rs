...
impl ::std::convert::From<&str> for DataLocationConstraint {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataLocationConstraint::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataLocationConstraint {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataLocationConstraint::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataLocationConstraint {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
