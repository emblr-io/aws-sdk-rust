...
impl ::std::convert::From<&str> for ConfigRecommendationOptimizationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigRecommendationOptimizationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigRecommendationOptimizationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigRecommendationOptimizationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfigRecommendationOptimizationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
