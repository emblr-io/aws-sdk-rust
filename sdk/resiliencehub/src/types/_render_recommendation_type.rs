...
impl ::std::convert::From<&str> for RenderRecommendationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RenderRecommendationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RenderRecommendationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RenderRecommendationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RenderRecommendationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
