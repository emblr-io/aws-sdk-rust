...
impl ::std::convert::From<&str> for RecommendationTemplateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecommendationTemplateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecommendationTemplateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecommendationTemplateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecommendationTemplateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
