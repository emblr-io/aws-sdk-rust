...
impl ::std::convert::From<&str> for AppAssessmentScheduleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppAssessmentScheduleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppAssessmentScheduleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppAssessmentScheduleType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AppAssessmentScheduleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
