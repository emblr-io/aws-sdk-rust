...
impl ::std::convert::From<&str> for AggregatedSourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AggregatedSourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AggregatedSourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AggregatedSourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AggregatedSourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
