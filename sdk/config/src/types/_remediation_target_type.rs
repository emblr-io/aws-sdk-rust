...
impl ::std::convert::From<&str> for RemediationTargetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RemediationTargetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RemediationTargetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RemediationTargetType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RemediationTargetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RemediationTargetType {
