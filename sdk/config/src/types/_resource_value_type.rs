...
impl ::std::convert::From<&str> for ResourceValueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceValueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceValueType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ResourceValueType {
