...
impl ::std::convert::From<&str> for ChronologicalOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChronologicalOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChronologicalOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChronologicalOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChronologicalOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
