...
impl ::std::convert::From<&str> for EvaluationMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EvaluationMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EvaluationMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EvaluationMode::from(s))
    }
}
impl EvaluationMode {
...
impl ::std::convert::AsRef<str> for EvaluationMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
