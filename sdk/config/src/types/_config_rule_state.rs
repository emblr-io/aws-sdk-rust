...
impl ::std::convert::From<&str> for ConfigRuleState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigRuleState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigRuleState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigRuleState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfigRuleState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
