...
impl ::std::str::FromStr for RemediationExecutionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RemediationExecutionState::from(s))
    }
}
...
impl ::std::fmt::Display for RemediationExecutionState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RemediationExecutionState::Failed => write!(f, "FAILED"),
