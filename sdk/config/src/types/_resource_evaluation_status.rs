...
impl ::std::convert::From<&str> for ResourceEvaluationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceEvaluationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceEvaluationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceEvaluationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceEvaluationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
