...
impl ::std::convert::From<&str> for ResourceConfigurationSchemaType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceConfigurationSchemaType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceConfigurationSchemaType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceConfigurationSchemaType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceConfigurationSchemaType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
