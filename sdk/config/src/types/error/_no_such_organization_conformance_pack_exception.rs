...
impl ::std::fmt::Display for NoSuchOrganizationConformancePackException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "NoSuchOrganizationConformancePackException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::NoSuchOrganizationConformancePackException {
