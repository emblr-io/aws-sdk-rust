...
impl StandardsControlAssociationDetail {
    /// Creates a new builder-style object to manufacture [`StandardsControlAssociationDetail`](crate::types::StandardsControlAssociationDetail).
    pub fn builder() -> crate::types::builders::StandardsControlAssociationDetailBuilder {
        crate::types::builders::StandardsControlAssociationDetailBuilder::default()
    }
}
