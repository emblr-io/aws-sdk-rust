...
pub struct AwsSecurityFinding {
    ...
    /// <p>The identifier for the solution-specific component (a discrete unit of logic) that generated a finding. In various security findings providers' solutions, this generator can be called a rule, a check, a detector, a plugin, or something else.</p>
    /// <p>Length Constraints: Minimum length of 1. Maximum length of 512.</p>
