...
///     ParameterValueType::Custom => { /* ... */ },
///     ParameterValueType::Default => { /* ... */ },
...
impl ::std::convert::From<&str> for ParameterValueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParameterValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParameterValueType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParameterValueType::from(s))
    }
}
impl ParameterValueType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ParameterValueType::Custom => "CUSTOM",
            ParameterValueType::Default => "DEFAULT",
...
impl ::std::convert::AsRef<str> for ParameterValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
