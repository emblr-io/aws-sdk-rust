...
/// }
/// ```
/// The above code demonstrates that when `networkdirection` represents
...
/// version of SDK where the variant `NetworkDirection::NewFeature` is defined.
/// Specifically, when `networkdirection` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `NetworkDirection::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for NetworkDirection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkDirection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkDirection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkDirection::from(s))
    }
}
impl NetworkDirection {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            NetworkDirection::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for NetworkDirection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
