...
/// }
/// ```
/// The above code demonstrates that when `daterangeunit` represents
...
/// version of SDK where the variant `DateRangeUnit::NewFeature` is defined.
/// Specifically, when `daterangeunit` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `DateRangeUnit::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for DateRangeUnit {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DateRangeUnit::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl DateRangeUnit {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DateRangeUnit::Unknown(value) => value.as_str(),
        }
    }
