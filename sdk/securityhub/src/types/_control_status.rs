...
impl ::std::convert::From<&str> for ControlStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ControlStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ControlStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ControlStatus::from(s))
    }
}
impl ControlStatus {
...
impl ::std::convert::AsRef<str> for ControlStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
