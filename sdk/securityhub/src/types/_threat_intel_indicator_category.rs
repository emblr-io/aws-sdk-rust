...
/// }
/// ```
/// The above code demonstrates that when `threatintelindicatorcategory` represents
...
/// version of SDK where the variant `ThreatIntelIndicatorCategory::NewFeature` is defined.
/// Specifically, when `threatintelindicatorcategory` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ThreatIntelIndicatorCategory::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for ThreatIntelIndicatorCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThreatIntelIndicatorCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThreatIntelIndicatorCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThreatIntelIndicatorCategory::from(s))
    }
}
impl ThreatIntelIndicatorCategory {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ThreatIntelIndicatorCategory::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ThreatIntelIndicatorCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
