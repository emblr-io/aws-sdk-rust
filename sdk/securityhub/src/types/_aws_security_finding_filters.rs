...
/// <p>You can filter by up to ten finding attributes. For each attribute, you can provide up to 20 filter values.</p>
#[non_exhaustive]
...
pub struct AwsSecurityFindingFilters {
    ...
    /// <li>
    /// <p><code>Compliance.Status</code> changes from <code>PASSED</code> to either <code>WARNING</code>, <code>FAILED</code>, or <code>NOT_AVAILABLE</code>.</p></li>
    /// </ul></li>
    /// <li>
    /// <p><code>NOTIFIED</code> - Indicates that the resource owner has been notified about the security issue. Used when the initial reviewer is not the resource owner, and needs intervention from the resource owner.</p>
    /// <p>If one of the following occurs, the workflow status is changed automatically from <code>NOTIFIED</code> to <code>NEW</code>:</p>
    /// <ul>
    /// <li>
    /// <p><code>RecordState</code> changes from <code>ARCHIVED</code> to <code>ACTIVE</code>.</p></li>
    /// <li>
    ...
    /// <p>For findings from controls, if <code>Compliance.Status</code> is <code>PASSED</code>, then Security Hub automatically sets the workflow status to <code>RESOLVED</code>.</p></li>
    /// </ul>
...
impl AwsSecurityFindingFilters {
    ...
    pub fn compliance_security_control_parameters_value(&self) -> &[crate::types::StringFilter] {
        self.compliance_security_control_parameters_value.as_deref().unwrap_or_default()
    }
    /// <p>The name of the Amazon Web Services account in which a finding is generated.</p>
    ///
...
pub struct AwsSecurityFindingFiltersBuilder {
    ...
    pub(crate) vulnerabilities_exploit_available: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>,
    pub(crate) vulnerabilities_fix_available: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>,
    pub(crate) compliance_security_control_parameters_name: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>,
    pub(crate) compliance_security_control_parameters_value: ::std::option::Option<::std::vec::Vec<crate::types::StringFilter>>,
...
impl AwsSecurityFindingFiltersBuilder {
    ...
    /// Appends an item to `vulnerabilities_exploit_available`.
    ///
    ...
    /// Appends an item to `vulnerabilities_fix_available`.
    ///
    ...
    /// Appends an item to `compliance_security_control_parameters_name`.
    ///
    ...
    /// Appends an item to `compliance_security_control_parameters_value`.
    ///
    ...
    pub fn build(self) -> crate::types::AwsSecurityFindingFilters {
        crate::types::AwsSecurityFindingFilters {
            ...
            vulnerabilities_exploit_available: self.vulnerabilities_exploit_available,
            vulnerabilities_fix_available: self.vulnerabilities_fix_available,
            compliance_security_control_parameters_name: self.compliance_security_control_parameters_name,
            compliance_security_control_parameters_value: self.compliance_security_control_parameters_value,
