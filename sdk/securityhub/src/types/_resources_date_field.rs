...
/// When writing a match expression against `ResourcesDateField`, it is important to ensure
...
///
/// ```text
/// # let resourcesdatefield = unimplemented!();
/// match resourcesdatefield {
///     ResourcesDateField::ResourceCreationTimeDt => { /* ... */ },
///     ResourcesDateField::ResourceDetailCaptureTimeDt => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `resourcesdatefield` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ResourcesDateField::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ResourcesDateField::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ResourcesDateField::NewFeature` is defined.
/// Specifically, when `resourcesdatefield` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ResourcesDateField::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::str::FromStr for ResourcesDateField {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourcesDateField::from(s))
    }
}
impl ResourcesDateField {
