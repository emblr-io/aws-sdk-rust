...
/// }
/// ```
/// The above code demonstrates that when `awsiamaccesskeystatus` represents
...
/// version of SDK where the variant `AwsIamAccessKeyStatus::NewFeature` is defined.
/// Specifically, when `awsiamaccesskeystatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AwsIamAccessKeyStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AwsIamAccessKeyStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AwsIamAccessKeyStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AwsIamAccessKeyStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AwsIamAccessKeyStatus::from(s))
    }
}
impl AwsIamAccessKeyStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AwsIamAccessKeyStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AwsIamAccessKeyStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
