...
///
/// ```text
/// # let severitylabel = unimplemented!();
/// match severitylabel {
...
/// }
/// ```
/// The above code demonstrates that when `severitylabel` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SeverityLabel::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SeverityLabel::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SeverityLabel::NewFeature` is defined.
/// Specifically, when `severitylabel` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SeverityLabel::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for SeverityLabel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SeverityLabel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SeverityLabel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SeverityLabel::from(s))
    }
}
impl SeverityLabel {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SeverityLabel::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for SeverityLabel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
