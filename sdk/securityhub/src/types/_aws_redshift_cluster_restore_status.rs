...
impl AwsRedshiftClusterRestoreStatus {
    /// Creates a new builder-style object to manufacture [`AwsRedshiftClusterRestoreStatus`](crate::types::AwsRedshiftClusterRestoreStatus).
    pub fn builder() -> crate::types::builders::AwsRedshiftClusterRestoreStatusBuilder {
...
impl AwsRedshiftClusterRestoreStatusBuilder {
    /// <p>The number of megabytes per second being transferred from the backup storage. Returns the average rate for a completed backup.</p>
    /// <p>This field is only updated when you restore to DC2 and DS2 node types.</p>
