...
impl AwsApiGatewayCanarySettings {
    /// Creates a new builder-style object to manufacture [`AwsApiGatewayCanarySettings`](crate::types::AwsApiGatewayCanarySettings).
    pub fn builder() -> crate::types::builders::AwsApiGatewayCanarySettingsBuilder {
        crate::types::builders::AwsApiGatewayCanarySettingsBuilder::default()
    }
}
...
impl AwsApiGatewayCanarySettingsBuilder {
    ...
    pub fn percent_traffic(mut self, input: f64) -> Self {
        self.percent_traffic = ::std::option::Option::Some(input);
        self
    }
    /// <p>The percentage of traffic that is diverted to a canary deployment.</p>
