...
impl AwsAppSyncGraphQlApiUserPoolConfigDetails {
    /// Creates a new builder-style object to manufacture [`AwsAppSyncGraphQlApiUserPoolConfigDetails`](crate::types::AwsAppSyncGraphQlApiUserPoolConfigDetails).
    pub fn builder() -> crate::types::builders::AwsAppSyncGraphQlApiUserPoolConfigDetailsBuilder {
        crate::types::builders::AwsAppSyncGraphQlApiUserPoolConfigDetailsBuilder::default()
    }
}
...
impl AwsAppSyncGraphQlApiUserPoolConfigDetailsBuilder {
    ...
    pub fn build(self) -> crate::types::AwsAppSyncGraphQlApiUserPoolConfigDetails {
        crate::types::AwsAppSyncGraphQlApiUserPoolConfigDetails {
