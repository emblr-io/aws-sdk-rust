...
pub struct CreateAggregatorV2Output {
...
impl ::aws_types::request_id::RequestId for CreateAggregatorV2Output {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateAggregatorV2Output {
    /// Creates a new builder-style object to manufacture [`CreateAggregatorV2Output`](crate::operation::create_aggregator_v2::CreateAggregatorV2Output).
    pub fn builder() -> crate::operation::create_aggregator_v2::builders::CreateAggregatorV2OutputBuilder {
        crate::operation::create_aggregator_v2::builders::CreateAggregatorV2OutputBuilder::default()
    }
}

/// A builder for [`CreateAggregatorV2Output`](crate::operation::create_aggregator_v2::CreateAggregatorV2Output).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateAggregatorV2OutputBuilder {
...
impl CreateAggregatorV2OutputBuilder {
    /// <p>The ARN of the AggregatorV2.</p>
    ...
    /// Consumes the builder and constructs a [`CreateAggregatorV2Output`](crate::operation::create_aggregator_v2::CreateAggregatorV2Output).
    pub fn build(self) -> crate::operation::create_aggregator_v2::CreateAggregatorV2Output {
