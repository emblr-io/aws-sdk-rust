...
impl UpdateConfigurationPolicyOutput {
    ...
    pub fn builder() -> crate::operation::update_configuration_policy::builders::UpdateConfigurationPolicyOutputBuilder {
        crate::operation::update_configuration_policy::builders::UpdateConfigurationPolicyOutputBuilder::default()
    }
}

/// A builder for [`UpdateConfigurationPolicyOutput`](crate::operation::update_configuration_policy::UpdateConfigurationPolicyOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateConfigurationPolicyOutputBuilder {
