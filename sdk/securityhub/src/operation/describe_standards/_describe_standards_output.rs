...
impl ::aws_types::request_id::RequestId for DescribeStandardsOutput {
...
impl DescribeStandardsOutputBuilder {
    ...
    pub fn standards(mut self, input: crate::types::Standard) -> Self {
        ...
        v.push(input);
        self.standards = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of available standards.</p>
    ...
    /// <p>A list of available standards.</p>
    pub fn get_standards(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Standard>> {
        &self.standards
    }
    /// <p>The pagination token to use to request the next page of results.</p>
