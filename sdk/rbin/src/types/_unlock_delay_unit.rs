...
impl ::std::convert::From<&str> for UnlockDelayUnit {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnlockDelayUnit::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnlockDelayUnit {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnlockDelayUnit::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UnlockDelayUnit {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
