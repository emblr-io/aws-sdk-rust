...
//! offered by Amazon Recycle Bin. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Recycle Bin.
...
/// For example, the [`CreateRule`](crate::operation::create_rule) operation has
/// a [`Client::create_rule`], function which returns a builder for that operation.
...
/// Configuration for Amazon Recycle Bin.
pub mod config;
