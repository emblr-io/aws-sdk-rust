...
//! offered by Amazon Elastic Container Registry Public. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Elastic Container Registry Public.
...
/// For example, the [`BatchCheckLayerAvailability`](crate::operation::batch_check_layer_availability) operation has
...
/// Configuration for Amazon Elastic Container Registry Public.
pub mod config;
