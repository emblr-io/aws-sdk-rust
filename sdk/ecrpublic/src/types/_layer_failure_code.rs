...
impl ::std::convert::From<&str> for LayerFailureCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LayerFailureCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LayerFailureCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LayerFailureCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LayerFailureCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
