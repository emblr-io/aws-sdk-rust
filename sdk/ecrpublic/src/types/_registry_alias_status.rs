...
impl ::std::convert::From<&str> for RegistryAliasStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RegistryAliasStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RegistryAliasStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RegistryAliasStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RegistryAliasStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
