...
//! aws-sdk-dynamodbstreams = "0.0.0-local"
...
//! offered by Amazon DynamoDB Streams. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon DynamoDB Streams.
...
/// For example, the [`DescribeStream`](crate::operation::describe_stream) operation has
/// a [`Client::describe_stream`], function which returns a builder for that operation.
...
/// Configuration for Amazon DynamoDB Streams.
pub mod config;
