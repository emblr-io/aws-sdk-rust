...
impl ::aws_types::request_id::RequestId for DeleteReferenceStoreOutput {
...
impl DeleteReferenceStoreOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteReferenceStoreOutput`](crate::operation::delete_reference_store::DeleteReferenceStoreOutput).
    pub fn build(self) -> crate::operation::delete_reference_store::DeleteReferenceStoreOutput {
