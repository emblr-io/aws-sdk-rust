...
impl ListReferencesInput {
    /// Creates a new builder-style object to manufacture [`ListReferencesInput`](crate::operation::list_references::ListReferencesInput).
    pub fn builder() -> crate::operation::list_references::builders::ListReferencesInputBuilder {
        crate::operation::list_references::builders::ListReferencesInputBuilder::default()
    }
}
...
pub struct ListReferencesInputBuilder {
    ...
    pub(crate) filter: ::std::option::Option<crate::types::ReferenceFilter>,
}
