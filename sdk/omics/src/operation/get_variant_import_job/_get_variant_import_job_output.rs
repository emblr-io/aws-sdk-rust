...
pub struct GetVariantImportJobOutput {
    ...
    /// <p>The job's items.</p>
    pub items: ::std::vec::Vec<crate::types::VariantImportItemDetail>,
...
impl GetVariantImportJobOutput {
    ...
    /// <p>The job's items.</p>
    pub fn items(&self) -> &[crate::types::VariantImportItemDetail] {
        use std::ops::Deref;
        self.items.deref()
    }
    /// <p>The job's left normalization setting.</p>
...
impl GetVariantImportJobOutputBuilder {
    ...
    /// <p>The job's items.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::VariantImportItemDetail>> {
        &self.items
    }
    /// <p>The job's left normalization setting.</p>
    /// This field is required.
    ...
    /// - [`id`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::id)
    /// - [`destination_name`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::destination_name)
    /// - [`role_arn`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::role_arn)
    /// - [`status`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::status)
    /// - [`status_message`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::status_message)
    /// - [`creation_time`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::creation_time)
    /// - [`update_time`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::update_time)
    /// - [`items`](crate::operation::get_variant_import_job::builders::GetVariantImportJobOutputBuilder::items)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_variant_import_job::GetVariantImportJobOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::get_variant_import_job::GetVariantImportJobOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            destination_name: self.destination_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "destination_name",
                    "destination_name was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            role_arn: self.role_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "role_arn",
                    "role_arn was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            status_message: self.status_message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status_message",
                    "status_message was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            creation_time: self.creation_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "creation_time",
                    "creation_time was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            update_time: self.update_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "update_time",
                    "update_time was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
            ...
            items: self.items.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "items",
                    "items was not specified but it is required when building GetVariantImportJobOutput",
                )
            })?,
