...
impl ::aws_types::request_id::RequestId for DeleteSequenceStoreOutput {
...
impl DeleteSequenceStoreOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteSequenceStoreOutput`](crate::operation::delete_sequence_store::DeleteSequenceStoreOutput).
    pub fn build(self) -> crate::operation::delete_sequence_store::DeleteSequenceStoreOutput {
