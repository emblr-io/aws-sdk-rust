...
impl DeleteSequenceStoreInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::delete_sequence_store::DeleteSequenceStoreInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::delete_sequence_store::DeleteSequenceStoreInput { id: self.id })
    }
}
