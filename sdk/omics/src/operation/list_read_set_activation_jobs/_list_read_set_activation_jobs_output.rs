...
impl ListReadSetActivationJobsOutput {
    ...
    /// <p>A list of jobs.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.activation_jobs.is_none()`.
    pub fn activation_jobs(&self) -> &[crate::types::ActivateReadSetJobItem] {
...
impl ListReadSetActivationJobsOutputBuilder {
    ...
    pub fn activation_jobs(mut self, input: crate::types::ActivateReadSetJobItem) -> Self {
        ...
        v.push(input);
        self.activation_jobs = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of jobs.</p>
