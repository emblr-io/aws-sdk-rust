...
//! offered by Amazon Omics. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Omics.
...
/// Configuration for Amazon Omics.
pub mod config;
