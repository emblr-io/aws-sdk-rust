...
impl ::std::convert::From<&str> for ReadSetActivationJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReadSetActivationJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReadSetActivationJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReadSetActivationJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReadSetActivationJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
