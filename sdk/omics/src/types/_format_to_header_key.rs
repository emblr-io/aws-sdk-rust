...
impl ::std::convert::From<&str> for FormatToHeaderKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FormatToHeaderKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FormatToHeaderKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FormatToHeaderKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FormatToHeaderKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
