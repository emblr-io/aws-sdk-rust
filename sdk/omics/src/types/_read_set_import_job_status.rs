...
impl ::std::convert::From<&str> for ReadSetImportJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReadSetImportJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReadSetImportJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReadSetImportJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReadSetImportJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
