...
impl ::std::convert::From<&str> for RunLogLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            "OFF" => RunLogLevel::Off,
            other => RunLogLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RunLogLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RunLogLevel::from(s))
    }
}
impl RunLogLevel {
...
impl ::std::convert::AsRef<str> for RunLogLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
