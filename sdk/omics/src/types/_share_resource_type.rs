...
///     ShareResourceType::AnnotationStore => { /* ... */ },
///     ShareResourceType::VariantStore => { /* ... */ },
///     ShareResourceType::Workflow => { /* ... */ },
...
impl ::std::convert::From<&str> for ShareResourceType {
    fn from(s: &str) -> Self {
        match s {
            "ANNOTATION_STORE" => ShareResourceType::AnnotationStore,
            "VARIANT_STORE" => ShareResourceType::VariantStore,
            "WORKFLOW" => ShareResourceType::Workflow,
            other => ShareResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShareResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShareResourceType::from(s))
    }
}
impl ShareResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ShareResourceType::AnnotationStore => "ANNOTATION_STORE",
            ShareResourceType::VariantStore => "VARIANT_STORE",
            ShareResourceType::Workflow => "WORKFLOW",
            ShareResourceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ANNOTATION_STORE", "VARIANT_STORE", "WORKFLOW"]
    }
}
