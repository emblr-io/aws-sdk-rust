...
impl ::std::convert::From<&str> for RunStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RunStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RunStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RunStatus::from(s))
    }
}
impl RunStatus {
...
impl ::std::convert::AsRef<str> for RunStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
