...
impl ::std::convert::From<&str> for ReadSetActivationJobItemStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReadSetActivationJobItemStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReadSetActivationJobItemStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReadSetActivationJobItemStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReadSetActivationJobItemStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
