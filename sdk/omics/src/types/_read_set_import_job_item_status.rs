...
impl ::std::convert::From<&str> for ReadSetImportJobItemStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReadSetImportJobItemStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReadSetImportJobItemStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReadSetImportJobItemStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReadSetImportJobItemStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ReadSetImportJobItemStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ReadSetImportJobItemStatus::Failed => write!(f, "FAILED"),
            ReadSetImportJobItemStatus::Finished => write!(f, "FINISHED"),
            ReadSetImportJobItemStatus::InProgress => write!(f, "IN_PROGRESS"),
            ReadSetImportJobItemStatus::NotStarted => write!(f, "NOT_STARTED"),
            ReadSetImportJobItemStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
