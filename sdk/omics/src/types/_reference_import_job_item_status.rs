...
impl ::std::convert::From<&str> for ReferenceImportJobItemStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReferenceImportJobItemStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceImportJobItemStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceImportJobItemStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReferenceImportJobItemStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
