...
impl ::std::convert::From<&str> for ReferenceFile {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReferenceFile::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceFile {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceFile::from(s))
    }
}
impl ReferenceFile {
...
impl ::std::convert::AsRef<str> for ReferenceFile {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
