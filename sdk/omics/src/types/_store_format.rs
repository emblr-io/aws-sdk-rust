...
impl ::std::convert::From<&str> for StoreFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            "TSV" => StoreFormat::Tsv,
            "VCF" => StoreFormat::Vcf,
            other => StoreFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StoreFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StoreFormat::from(s))
    }
}
impl StoreFormat {
...
impl ::std::convert::AsRef<str> for StoreFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
