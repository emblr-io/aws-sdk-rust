...
impl ::std::convert::From<&str> for AnomalyDetectorStateValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnomalyDetectorStateValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnomalyDetectorStateValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnomalyDetectorStateValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AnomalyDetectorStateValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
