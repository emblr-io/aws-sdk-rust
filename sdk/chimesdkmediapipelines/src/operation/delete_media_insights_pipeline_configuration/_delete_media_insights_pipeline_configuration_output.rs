...
pub struct DeleteMediaInsightsPipelineConfigurationOutput {
    _request_id: Option<String>,
}
impl ::aws_types::request_id::RequestId for DeleteMediaInsightsPipelineConfigurationOutput {
...
impl DeleteMediaInsightsPipelineConfigurationOutputBuilder {
