...
impl ListMediaCapturePipelinesOutput {
    /// <p>The media pipeline objects in the list.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.media_capture_pipelines.is_none()`.
    pub fn media_capture_pipelines(&self) -> &[crate::types::MediaCapturePipelineSummary] {
        self.media_capture_pipelines.as_deref().unwrap_or_default()
    }
    /// <p>The token used to retrieve the next page of results.</p>
...
impl ::aws_types::request_id::RequestId for ListMediaCapturePipelinesOutput {
...
impl ListMediaCapturePipelinesOutputBuilder {
    ...
    pub fn media_capture_pipelines(mut self, input: crate::types::MediaCapturePipelineSummary) -> Self {
        ...
        v.push(input);
        self.media_capture_pipelines = ::std::option::Option::Some(v);
        self
    }
    /// <p>The media pipeline objects in the list.</p>
    ...
    /// <p>The media pipeline objects in the list.</p>
    pub fn get_media_capture_pipelines(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::MediaCapturePipelineSummary>> {
