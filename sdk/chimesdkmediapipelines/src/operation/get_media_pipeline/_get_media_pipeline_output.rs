...
impl ::aws_types::request_id::RequestId for GetMediaPipelineOutput {
...
impl GetMediaPipelineOutputBuilder {
    ...
    pub fn media_pipeline(mut self, input: crate::types::MediaPipeline) -> Self {
        self.media_pipeline = ::std::option::Option::Some(input);
        self
    }
    /// <p>The media pipeline object.</p>
    ...
    /// <p>The media pipeline object.</p>
    pub fn get_media_pipeline(&self) -> &::std::option::Option<crate::types::MediaPipeline> {
        &self.media_pipeline
    }
