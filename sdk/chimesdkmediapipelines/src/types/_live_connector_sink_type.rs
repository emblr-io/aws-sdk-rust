...
impl ::std::convert::From<&str> for LiveConnectorSinkType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LiveConnectorSinkType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LiveConnectorSinkType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LiveConnectorSinkType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LiveConnectorSinkType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LiveConnectorSinkType {
