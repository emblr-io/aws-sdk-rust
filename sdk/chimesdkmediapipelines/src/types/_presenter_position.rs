...
impl ::std::convert::From<&str> for PresenterPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PresenterPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PresenterPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PresenterPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PresenterPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
