...
impl ::std::convert::From<&str> for ConcatenationSourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConcatenationSourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConcatenationSourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConcatenationSourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConcatenationSourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
