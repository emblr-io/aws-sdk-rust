...
impl ::std::convert::From<&str> for FragmentSelectorType {
    fn from(s: &str) -> Self {
        match s {
            "ProducerTimestamp" => FragmentSelectorType::ProducerTimestamp,
            "ServerTimestamp" => FragmentSelectorType::ServerTimestamp,
            other => FragmentSelectorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FragmentSelectorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FragmentSelectorType::from(s))
    }
}
impl FragmentSelectorType {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ProducerTimestamp", "ServerTimestamp"]
    }
}
impl ::std::convert::AsRef<str> for FragmentSelectorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
