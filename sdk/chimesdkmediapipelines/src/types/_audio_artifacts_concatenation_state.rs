...
impl ::std::convert::From<&str> for AudioArtifactsConcatenationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioArtifactsConcatenationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioArtifactsConcatenationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioArtifactsConcatenationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AudioArtifactsConcatenationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AudioArtifactsConcatenationState {
