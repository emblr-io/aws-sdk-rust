...
impl ::std::convert::From<&str> for LayoutOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LayoutOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LayoutOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LayoutOption::from(s))
    }
}
impl LayoutOption {
...
impl ::std::convert::AsRef<str> for LayoutOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
