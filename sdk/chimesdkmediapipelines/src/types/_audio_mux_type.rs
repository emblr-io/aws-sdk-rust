...
impl ::std::convert::From<&str> for AudioMuxType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioMuxType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioMuxType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioMuxType::from(s))
    }
}
impl AudioMuxType {
...
impl ::std::convert::AsRef<str> for AudioMuxType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
