...
impl ::std::convert::From<&str> for AudioChannelsOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioChannelsOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioChannelsOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioChannelsOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AudioChannelsOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
