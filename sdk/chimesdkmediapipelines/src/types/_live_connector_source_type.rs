...
impl ::std::convert::From<&str> for LiveConnectorSourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LiveConnectorSourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LiveConnectorSourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LiveConnectorSourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LiveConnectorSourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LiveConnectorSourceType {
