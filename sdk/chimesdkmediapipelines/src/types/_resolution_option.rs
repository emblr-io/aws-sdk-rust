...
impl ::std::convert::From<&str> for ResolutionOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResolutionOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResolutionOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResolutionOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResolutionOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
