...
impl ::std::convert::From<&str> for ArtifactsConcatenationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArtifactsConcatenationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactsConcatenationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactsConcatenationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArtifactsConcatenationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
