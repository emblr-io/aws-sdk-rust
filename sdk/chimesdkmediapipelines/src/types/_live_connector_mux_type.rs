...
impl ::std::convert::From<&str> for LiveConnectorMuxType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LiveConnectorMuxType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LiveConnectorMuxType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LiveConnectorMuxType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LiveConnectorMuxType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
