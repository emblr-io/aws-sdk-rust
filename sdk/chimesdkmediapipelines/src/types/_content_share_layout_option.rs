...
impl ::std::convert::From<&str> for ContentShareLayoutOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentShareLayoutOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentShareLayoutOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentShareLayoutOption::from(s))
    }
}
