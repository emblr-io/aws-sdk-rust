...
impl ::std::convert::From<&str> for ArtifactsState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArtifactsState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactsState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactsState::from(s))
    }
}
impl ArtifactsState {
...
impl ::std::convert::AsRef<str> for ArtifactsState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
