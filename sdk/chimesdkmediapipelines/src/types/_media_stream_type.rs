...
impl ::std::convert::From<&str> for MediaStreamType {
    fn from(s: &str) -> Self {
        match s {
            "IndividualAudio" => MediaStreamType::IndividualAudio,
            "MixedAudio" => MediaStreamType::MixedAudio,
            other => MediaStreamType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MediaStreamType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MediaStreamType::from(s))
    }
}
impl MediaStreamType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MediaStreamType::IndividualAudio => "IndividualAudio",
            MediaStreamType::MixedAudio => "MixedAudio",
            MediaStreamType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["IndividualAudio", "MixedAudio"]
    }
}
impl ::std::convert::AsRef<str> for MediaStreamType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
