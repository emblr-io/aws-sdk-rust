...
impl ::std::convert::From<&str> for PartialResultsStability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PartialResultsStability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PartialResultsStability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PartialResultsStability::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PartialResultsStability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
