...
impl ::std::convert::From<&str> for VideoMuxType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VideoMuxType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VideoMuxType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VideoMuxType::from(s))
    }
}
impl VideoMuxType {
...
impl ::std::convert::AsRef<str> for VideoMuxType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for VideoMuxType {
