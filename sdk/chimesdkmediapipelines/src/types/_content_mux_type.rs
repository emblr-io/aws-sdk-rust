...
impl ::std::convert::From<&str> for ContentMuxType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContentMuxType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContentMuxType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContentMuxType::from(s))
    }
}
impl ContentMuxType {
...
impl ::std::convert::AsRef<str> for ContentMuxType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
