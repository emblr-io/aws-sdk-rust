...
//! aws-sdk-chimesdkmediapipelines = "0.0.0-local"
...
//! offered by Amazon Chime SDK Media Pipelines. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Chime SDK Media Pipelines.
...
/// For example, the [`CreateMediaCapturePipeline`](crate::operation::create_media_capture_pipeline) operation has
/// a [`Client::create_media_capture_pipeline`], function which returns a builder for that operation.
...
/// Configuration for Amazon Chime SDK Media Pipelines.
pub mod config;
