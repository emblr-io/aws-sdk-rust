...
impl DescribeContactOutput {
    ...
    /// <p>List describing source and destination details for each dataflow edge.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.dataflow_list.is_none()`.
...
impl DescribeContactOutputBuilder {
    ...
    pub fn dataflow_list(mut self, input: crate::types::DataflowDetail) -> Self {
        ...
        v.push(input);
        self.dataflow_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>List describing source and destination details for each dataflow edge.</p>
