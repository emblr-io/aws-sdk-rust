...
//! aws-sdk-groundstation = "0.0.0-local"
...
//! offered by AWS Ground Station. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Ground Station.
...
/// For example, the [`CancelContact`](crate::operation::cancel_contact) operation has
/// a [`Client::cancel_contact`], function which returns a builder for that operation.
...
/// Configuration for AWS Ground Station.
pub mod config;
