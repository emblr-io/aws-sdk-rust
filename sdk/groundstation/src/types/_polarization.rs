...
impl ::std::convert::From<&str> for Polarization {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Polarization::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Polarization {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Polarization::from(s))
    }
}
impl Polarization {
...
impl ::std::convert::AsRef<str> for Polarization {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
