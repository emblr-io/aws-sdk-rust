...
impl ::std::convert::From<&str> for FrequencyUnits {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FrequencyUnits::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FrequencyUnits {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FrequencyUnits::from(s))
    }
}
impl FrequencyUnits {
...
impl ::std::convert::AsRef<str> for FrequencyUnits {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
