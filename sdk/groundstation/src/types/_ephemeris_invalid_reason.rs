...
impl ::std::convert::From<&str> for EphemerisInvalidReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EphemerisInvalidReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EphemerisInvalidReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EphemerisInvalidReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EphemerisInvalidReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
