...
impl ::std::convert::From<&str> for BandwidthUnits {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BandwidthUnits::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BandwidthUnits {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BandwidthUnits::from(s))
    }
}
impl BandwidthUnits {
...
impl ::std::convert::AsRef<str> for BandwidthUnits {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
