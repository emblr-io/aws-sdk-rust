...
impl ::std::convert::From<&str> for EphemerisSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EphemerisSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EphemerisSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EphemerisSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EphemerisSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
