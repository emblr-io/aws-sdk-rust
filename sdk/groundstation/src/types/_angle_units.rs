...
impl ::std::convert::From<&str> for AngleUnits {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AngleUnits::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AngleUnits {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AngleUnits::from(s))
    }
}
impl AngleUnits {
...
impl ::std::convert::AsRef<str> for AngleUnits {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
