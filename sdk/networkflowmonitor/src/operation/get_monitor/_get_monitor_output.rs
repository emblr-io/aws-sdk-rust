...
impl GetMonitorOutputBuilder {
    ...
    /// - [`monitor_status`](crate::operation::get_monitor::builders::GetMonitorOutputBuilder::monitor_status)
    /// - [`local_resources`](crate::operation::get_monitor::builders::GetMonitorOutputBuilder::local_resources)
    /// - [`remote_resources`](crate::operation::get_monitor::builders::GetMonitorOutputBuilder::remote_resources)
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_monitor::GetMonitorOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_monitor::GetMonitorOutput {
            ...
            monitor_status: self.monitor_status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "monitor_status",
                    "monitor_status was not specified but it is required when building GetMonitorOutput",
                )
            })?,
            local_resources: self.local_resources.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "local_resources",
                    "local_resources was not specified but it is required when building GetMonitorOutput",
                )
            })?,
            remote_resources: self.remote_resources.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "remote_resources",
                    "remote_resources was not specified but it is required when building GetMonitorOutput",
                )
            })?,
