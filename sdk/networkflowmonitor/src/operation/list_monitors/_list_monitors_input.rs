...
pub struct ListMonitorsInput {
    ...
    /// </ul>
    pub monitor_status: ::std::option::Option<crate::types::MonitorStatus>,
}
impl ListMonitorsInput {
    ...
    /// <p><code>DELETING</code>: The monitor is in the process of being deleted.</p></li>
    /// </ul>
    pub fn monitor_status(&self) -> ::std::option::Option<&crate::types::MonitorStatus> {
        self.monitor_status.as_ref()
    }
}
impl ListMonitorsInput {
