...
impl ::std::convert::From<&str> for ScanDirection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScanDirection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScanDirection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScanDirection::from(s))
    }
}
impl ScanDirection {
...
impl ::std::convert::AsRef<str> for ScanDirection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
