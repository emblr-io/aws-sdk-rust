...
//! offered by AWS Multi-party Approval. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Multi-party Approval.
...
/// For example, the [`CancelSession`](crate::operation::cancel_session) operation has
...
/// Configuration for AWS Multi-party Approval.
pub mod config;
