...
/// When writing a match expression against `SessionStatusCode`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `sessionstatuscode` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SessionStatusCode::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SessionStatusCode::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SessionStatusCode::NewFeature` is defined.
/// Specifically, when `sessionstatuscode` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SessionStatusCode::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for SessionStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SessionStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SessionStatusCode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SessionStatusCode::from(s))
    }
}
impl SessionStatusCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            SessionStatusCode::Unknown(value) => value.as_str(),
        }
    }
