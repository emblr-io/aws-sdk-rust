...
///     FilterField::ApprovalTeamName => { /* ... */ },
///     FilterField::InitiationTime => { /* ... */ },
///     FilterField::SessionStatus => { /* ... */ },
///     FilterField::Vote => { /* ... */ },
///     FilterField::VotingTime => { /* ... */ },
...
impl FilterField {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            FilterField::ActionName => "ActionName",
            FilterField::ApprovalTeamName => "ApprovalTeamName",
            FilterField::InitiationTime => "InitiationTime",
            FilterField::SessionStatus => "SessionStatus",
            FilterField::Vote => "Vote",
            FilterField::VotingTime => "VotingTime",
...
impl ::std::fmt::Display for FilterField {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FilterField::ActionName => write!(f, "ActionName"),
            FilterField::ApprovalTeamName => write!(f, "ApprovalTeamName"),
            FilterField::InitiationTime => write!(f, "InitiationTime"),
