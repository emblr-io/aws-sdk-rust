...
impl ::std::convert::From<&str> for QuotaPeriodType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => QuotaPeriodType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for QuotaPeriodType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(QuotaPeriodType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for QuotaPeriodType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
