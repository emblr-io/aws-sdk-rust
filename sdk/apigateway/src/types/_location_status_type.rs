...
impl ::std::convert::From<&str> for LocationStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocationStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocationStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocationStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocationStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
