...
impl ::std::convert::From<&str> for PutMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PutMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PutMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PutMode::from(s))
    }
}
impl PutMode {
...
impl ::std::convert::AsRef<str> for PutMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
