...
impl ::std::convert::From<&str> for Op {
    fn from(s: &str) -> Self {
        match s {
            ...
            "replace" => Op::Replace,
            "test" => Op::Test,
            other => Op::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Op {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Op::from(s))
    }
}
impl Op {
...
impl ::std::convert::AsRef<str> for Op {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
