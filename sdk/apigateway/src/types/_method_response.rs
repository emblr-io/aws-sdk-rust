...
impl MethodResponse {
    /// Creates a new builder-style object to manufacture [`MethodResponse`](crate::types::MethodResponse).
    pub fn builder() -> crate::types::builders::MethodResponseBuilder {
        crate::types::builders::MethodResponseBuilder::default()
    }
}
...
impl MethodResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`MethodResponse`](crate::types::MethodResponse).
    pub fn build(self) -> crate::types::MethodResponse {
        crate::types::MethodResponse {
