...
impl ::std::convert::From<&str> for DocumentationPartType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DocumentationPartType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DocumentationPartType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DocumentationPartType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DocumentationPartType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
