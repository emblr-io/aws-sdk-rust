...
impl ::std::convert::From<&str> for ApiKeySourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApiKeySourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApiKeySourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApiKeySourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApiKeySourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
