...
impl BasePathMapping {
    /// Creates a new builder-style object to manufacture [`BasePathMapping`](crate::types::BasePathMapping).
    pub fn builder() -> crate::types::builders::BasePathMappingBuilder {
        crate::types::builders::BasePathMappingBuilder::default()
    }
}

/// A builder for [`BasePathMapping`](crate::types::BasePathMapping).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BasePathMappingBuilder {
    pub(crate) base_path: ::std::option::Option<::std::string::String>,
    pub(crate) rest_api_id: ::std::option::Option<::std::string::String>,
    pub(crate) stage: ::std::option::Option<::std::string::String>,
}
impl BasePathMappingBuilder {
    /// <p>The base path name that callers of the API must provide as part of the URL after the domain name.</p>
