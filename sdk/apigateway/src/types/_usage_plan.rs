...
impl UsagePlan {
    /// Creates a new builder-style object to manufacture [`UsagePlan`](crate::types::UsagePlan).
    pub fn builder() -> crate::types::builders::UsagePlanBuilder {
        crate::types::builders::UsagePlanBuilder::default()
    }
}

/// A builder for [`UsagePlan`](crate::types::UsagePlan).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UsagePlanBuilder {
