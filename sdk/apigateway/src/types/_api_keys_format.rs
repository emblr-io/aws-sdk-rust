...
impl ::std::convert::From<&str> for ApiKeysFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApiKeysFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApiKeysFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApiKeysFormat::from(s))
    }
}
impl ApiKeysFormat {
...
impl ::std::convert::AsRef<str> for ApiKeysFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
