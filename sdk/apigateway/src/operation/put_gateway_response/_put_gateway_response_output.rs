...
impl ::aws_types::request_id::RequestId for PutGatewayResponseOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PutGatewayResponseOutput {
    /// Creates a new builder-style object to manufacture [`PutGatewayResponseOutput`](crate::operation::put_gateway_response::PutGatewayResponseOutput).
    pub fn builder() -> crate::operation::put_gateway_response::builders::PutGatewayResponseOutputBuilder {
        crate::operation::put_gateway_response::builders::PutGatewayResponseOutputBuilder::default()
    }
}
...
impl PutGatewayResponseOutputBuilder {
    /// <p>The response type of the associated GatewayResponse.</p>
    ...
    /// Consumes the builder and constructs a [`PutGatewayResponseOutput`](crate::operation::put_gateway_response::PutGatewayResponseOutput).
    pub fn build(self) -> crate::operation::put_gateway_response::PutGatewayResponseOutput {
