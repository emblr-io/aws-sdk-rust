...
impl GetRestApiOutput {
    ...
    pub fn builder() -> crate::operation::get_rest_api::builders::GetRestApiOutputBuilder {
        crate::operation::get_rest_api::builders::GetRestApiOutputBuilder::default()
    }
}

/// A builder for [`GetRestApiOutput`](crate::operation::get_rest_api::GetRestApiOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetRestApiOutputBuilder {
