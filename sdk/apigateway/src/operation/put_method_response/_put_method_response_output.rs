...
impl ::aws_types::request_id::RequestId for PutMethodResponseOutput {
...
impl PutMethodResponseOutput {
    ...
    pub fn builder() -> crate::operation::put_method_response::builders::PutMethodResponseOutputBuilder {
