...
impl ::aws_types::request_id::RequestId for UpdateDocumentationPartOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateDocumentationPartOutput {
    /// Creates a new builder-style object to manufacture [`UpdateDocumentationPartOutput`](crate::operation::update_documentation_part::UpdateDocumentationPartOutput).
    pub fn builder() -> crate::operation::update_documentation_part::builders::UpdateDocumentationPartOutputBuilder {
        crate::operation::update_documentation_part::builders::UpdateDocumentationPartOutputBuilder::default()
    }
}
...
impl UpdateDocumentationPartOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateDocumentationPartOutput`](crate::operation::update_documentation_part::UpdateDocumentationPartOutput).
    pub fn build(self) -> crate::operation::update_documentation_part::UpdateDocumentationPartOutput {
