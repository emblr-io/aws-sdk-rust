...
impl ::aws_types::request_id::RequestId for CreateRestApiOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateRestApiOutput {
    /// Creates a new builder-style object to manufacture [`CreateRestApiOutput`](crate::operation::create_rest_api::CreateRestApiOutput).
    pub fn builder() -> crate::operation::create_rest_api::builders::CreateRestApiOutputBuilder {
        crate::operation::create_rest_api::builders::CreateRestApiOutputBuilder::default()
    }
}
...
impl CreateRestApiOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateRestApiOutput`](crate::operation::create_rest_api::CreateRestApiOutput).
    pub fn build(self) -> crate::operation::create_rest_api::CreateRestApiOutput {
