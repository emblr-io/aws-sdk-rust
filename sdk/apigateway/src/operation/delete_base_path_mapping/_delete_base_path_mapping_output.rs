...
impl ::aws_types::request_id::RequestId for DeleteBasePathMappingOutput {
...
impl DeleteBasePathMappingOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteBasePathMappingOutput`](crate::operation::delete_base_path_mapping::DeleteBasePathMappingOutput).
    pub fn build(self) -> crate::operation::delete_base_path_mapping::DeleteBasePathMappingOutput {
