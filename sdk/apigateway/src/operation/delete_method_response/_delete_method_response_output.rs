...
impl ::aws_types::request_id::RequestId for DeleteMethodResponseOutput {
...
impl DeleteMethodResponseOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteMethodResponseOutput`](crate::operation::delete_method_response::DeleteMethodResponseOutput).
    pub fn build(self) -> crate::operation::delete_method_response::DeleteMethodResponseOutput {
