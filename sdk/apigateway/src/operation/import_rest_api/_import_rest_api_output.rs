...
impl ::aws_types::request_id::RequestId for ImportRestApiOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ImportRestApiOutput {
    /// Creates a new builder-style object to manufacture [`ImportRestApiOutput`](crate::operation::import_rest_api::ImportRestApiOutput).
    pub fn builder() -> crate::operation::import_rest_api::builders::ImportRestApiOutputBuilder {
        crate::operation::import_rest_api::builders::ImportRestApiOutputBuilder::default()
    }
}
...
impl ImportRestApiOutputBuilder {
    /// <p>The API's identifier. This identifier is unique across all of your APIs in API Gateway.</p>
    ...
    /// Consumes the builder and constructs a [`ImportRestApiOutput`](crate::operation::import_rest_api::ImportRestApiOutput).
    pub fn build(self) -> crate::operation::import_rest_api::ImportRestApiOutput {
