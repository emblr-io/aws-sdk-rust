...
impl PutIntegrationResponseOutput {
    /// Creates a new builder-style object to manufacture [`PutIntegrationResponseOutput`](crate::operation::put_integration_response::PutIntegrationResponseOutput).
    pub fn builder() -> crate::operation::put_integration_response::builders::PutIntegrationResponseOutputBuilder {
        crate::operation::put_integration_response::builders::PutIntegrationResponseOutputBuilder::default()
    }
}

/// A builder for [`PutIntegrationResponseOutput`](crate::operation::put_integration_response::PutIntegrationResponseOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutIntegrationResponseOutputBuilder {
...
impl PutIntegrationResponseOutputBuilder {
    /// <p>Specifies the status code that is used to map the integration response to an existing MethodResponse.</p>
    ...
    /// Consumes the builder and constructs a [`PutIntegrationResponseOutput`](crate::operation::put_integration_response::PutIntegrationResponseOutput).
    pub fn build(self) -> crate::operation::put_integration_response::PutIntegrationResponseOutput {
