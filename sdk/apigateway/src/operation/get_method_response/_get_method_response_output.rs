...
impl ::aws_types::request_id::RequestId for GetMethodResponseOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetMethodResponseOutput {
    /// Creates a new builder-style object to manufacture [`GetMethodResponseOutput`](crate::operation::get_method_response::GetMethodResponseOutput).
    pub fn builder() -> crate::operation::get_method_response::builders::GetMethodResponseOutputBuilder {
        crate::operation::get_method_response::builders::GetMethodResponseOutputBuilder::default()
    }
}
...
impl GetMethodResponseOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetMethodResponseOutput`](crate::operation::get_method_response::GetMethodResponseOutput).
    pub fn build(self) -> crate::operation::get_method_response::GetMethodResponseOutput {
