...
impl GetGatewayResponseOutput {
    /// Creates a new builder-style object to manufacture [`GetGatewayResponseOutput`](crate::operation::get_gateway_response::GetGatewayResponseOutput).
    pub fn builder() -> crate::operation::get_gateway_response::builders::GetGatewayResponseOutputBuilder {
        crate::operation::get_gateway_response::builders::GetGatewayResponseOutputBuilder::default()
    }
}
...
impl GetGatewayResponseOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetGatewayResponseOutput`](crate::operation::get_gateway_response::GetGatewayResponseOutput).
    pub fn build(self) -> crate::operation::get_gateway_response::GetGatewayResponseOutput {
