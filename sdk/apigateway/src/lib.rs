...
//! aws-sdk-apigateway = "0.0.0-local"
...
//! offered by Amazon API Gateway. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon API Gateway.
