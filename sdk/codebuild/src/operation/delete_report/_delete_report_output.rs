...
impl ::aws_types::request_id::RequestId for DeleteReportOutput {
...
impl DeleteReportOutput {
    ...
    pub fn builder() -> crate::operation::delete_report::builders::DeleteReportOutputBuilder {
        crate::operation::delete_report::builders::DeleteReportOutputBuilder::default()
    }
}

/// A builder for [`DeleteReportOutput`](crate::operation::delete_report::DeleteReportOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteReportOutputBuilder {
    _request_id: Option<String>,
}
