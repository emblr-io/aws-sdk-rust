...
///     ReportStatusType::Deleting => { /* ... */ },
///     ReportStatusType::Failed => { /* ... */ },
///     ReportStatusType::Generating => { /* ... */ },
///     ReportStatusType::Incomplete => { /* ... */ },
///     ReportStatusType::Succeeded => { /* ... */ },
...
impl ::std::convert::From<&str> for ReportStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
