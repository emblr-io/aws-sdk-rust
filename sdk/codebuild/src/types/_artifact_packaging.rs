...
impl ::std::convert::From<&str> for ArtifactPackaging {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArtifactPackaging::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactPackaging {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactPackaging::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArtifactPackaging {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
