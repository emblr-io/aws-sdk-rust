...
impl ::std::convert::From<&str> for ArtifactsType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "S3" => ArtifactsType::S3,
            other => ArtifactsType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactsType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactsType::from(s))
    }
}
impl ArtifactsType {
...
impl ::std::convert::AsRef<str> for ArtifactsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
