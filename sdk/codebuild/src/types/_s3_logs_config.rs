...
pub struct S3LogsConfig {
    ...
    /// <ul>
    /// <li>
    /// <p><code>ENABLED</code>: S3 build logs are enabled for this build project.</p></li>
    /// <li>
    /// <p><code>DISABLED</code>: S3 build logs are not enabled for this build project.</p></li>
    /// </ul>
