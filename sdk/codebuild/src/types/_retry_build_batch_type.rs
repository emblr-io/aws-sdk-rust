...
/// When writing a match expression against `RetryBuildBatchType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `retrybuildbatchtype` represents
...
/// version of SDK where the variant `RetryBuildBatchType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for RetryBuildBatchType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RetryBuildBatchType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RetryBuildBatchType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RetryBuildBatchType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RetryBuildBatchType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RetryBuildBatchType {
