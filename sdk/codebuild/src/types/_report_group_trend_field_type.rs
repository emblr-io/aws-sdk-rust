...
impl ::std::convert::From<&str> for ReportGroupTrendFieldType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportGroupTrendFieldType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportGroupTrendFieldType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportGroupTrendFieldType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportGroupTrendFieldType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
