...
/// }
/// ```
/// The above code demonstrates that when `reportpackagingtype` represents
...
/// version of SDK where the variant `ReportPackagingType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ReportPackagingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportPackagingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportPackagingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportPackagingType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportPackagingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
