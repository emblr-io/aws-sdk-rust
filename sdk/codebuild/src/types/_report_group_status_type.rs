...
impl ::std::convert::From<&str> for ReportGroupStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportGroupStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportGroupStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportGroupStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportGroupStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
