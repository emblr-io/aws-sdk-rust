...
///     IpAddressType::Ipv4Only => { /* ... */ },
///     IpAddressType::Ipv6Only => { /* ... */ },
...
impl ::std::convert::From<&str> for IpAddressType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "IPV4_ONLY" => IpAddressType::Ipv4Only,
            "IPV6_ONLY" => IpAddressType::Ipv6Only,
...
impl IpAddressType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            IpAddressType::Ipv4Only => "IPV4_ONLY",
            IpAddressType::Ipv6Only => "IPV6_ONLY",
            IpAddressType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["DUAL_STACK", "IPV4_ONLY", "IPV6_ONLY"]
    }
}
...
impl ::std::fmt::Display for IpAddressType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            IpAddressType::Ipv4Only => write!(f, "IPV4_ONLY"),
            IpAddressType::Ipv6Only => write!(f, "IPV6_ONLY"),
