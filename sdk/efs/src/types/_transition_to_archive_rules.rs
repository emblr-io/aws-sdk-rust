...
/// When writing a match expression against `TransitionToArchiveRules`, it is important to ensure
...
///     TransitionToArchiveRules::After14Days => { /* ... */ },
///     TransitionToArchiveRules::After180Days => { /* ... */ },
///     TransitionToArchiveRules::After1Day => { /* ... */ },
///     TransitionToArchiveRules::After270Days => { /* ... */ },
///     TransitionToArchiveRules::After30Days => { /* ... */ },
///     TransitionToArchiveRules::After365Days => { /* ... */ },
///     TransitionToArchiveRules::After60Days => { /* ... */ },
///     TransitionToArchiveRules::After7Days => { /* ... */ },
///     TransitionToArchiveRules::After90Days => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `transitiontoarchiverules` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `TransitionToArchiveRules::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `TransitionToArchiveRules::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `TransitionToArchiveRules::NewFeature` is defined.
