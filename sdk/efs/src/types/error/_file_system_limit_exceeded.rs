...
impl ::std::fmt::Display for FileSystemLimitExceeded {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "FileSystemLimitExceeded")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::FileSystemLimitExceeded {
...
impl FileSystemLimitExceeded {
    /// Creates a new builder-style object to manufacture [`FileSystemLimitExceeded`](crate::types::error::FileSystemLimitExceeded).
    pub fn builder() -> crate::types::error::builders::FileSystemLimitExceededBuilder {
        crate::types::error::builders::FileSystemLimitExceededBuilder::default()
    }
}
...
impl FileSystemLimitExceededBuilder {
    /// <p>The error code is a string that uniquely identifies an error condition. It is meant to be read and understood by programs that detect and handle errors by type.</p>
    ...
    /// Consumes the builder and constructs a [`FileSystemLimitExceeded`](crate::types::error::FileSystemLimitExceeded).
    /// This method will fail if any of the following fields are not set:
    /// - [`error_code`](crate::types::error::builders::FileSystemLimitExceededBuilder::error_code)
    pub fn build(self) -> ::std::result::Result<crate::types::error::FileSystemLimitExceeded, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::FileSystemLimitExceeded {
            error_code: self.error_code.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "error_code",
                    "error_code was not specified but it is required when building FileSystemLimitExceeded",
                )
            })?,
