...
impl ::std::fmt::Display for AvailabilityZonesMismatch {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "AvailabilityZonesMismatch")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::AvailabilityZonesMismatch {
...
impl AvailabilityZonesMismatch {
    /// Creates a new builder-style object to manufacture [`AvailabilityZonesMismatch`](crate::types::error::AvailabilityZonesMismatch).
    pub fn builder() -> crate::types::error::builders::AvailabilityZonesMismatchBuilder {
        crate::types::error::builders::AvailabilityZonesMismatchBuilder::default()
    }
}
...
impl AvailabilityZonesMismatchBuilder {
    /// <p>The error code is a string that uniquely identifies an error condition. It is meant to be read and understood by programs that detect and handle errors by type.</p>
    ...
    /// Consumes the builder and constructs a [`AvailabilityZonesMismatch`](crate::types::error::AvailabilityZonesMismatch).
    pub fn build(self) -> crate::types::error::AvailabilityZonesMismatch {
        crate::types::error::AvailabilityZonesMismatch {
