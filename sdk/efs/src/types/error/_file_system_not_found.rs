...
impl ::std::fmt::Display for FileSystemNotFound {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "FileSystemNotFound")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::FileSystemNotFound {
...
impl FileSystemNotFoundBuilder {
    ...
    /// - [`error_code`](crate::types::error::builders::FileSystemNotFoundBuilder::error_code)
    pub fn build(self) -> ::std::result::Result<crate::types::error::FileSystemNotFound, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::FileSystemNotFound {
            error_code: self.error_code.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "error_code",
                    "error_code was not specified but it is required when building FileSystemNotFound",
                )
            })?,
