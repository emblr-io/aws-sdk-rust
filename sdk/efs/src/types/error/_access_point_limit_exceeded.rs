...
impl ::std::fmt::Display for AccessPointLimitExceeded {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "AccessPointLimitExceeded")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::AccessPointLimitExceeded {
...
impl AccessPointLimitExceeded {
    /// Creates a new builder-style object to manufacture [`AccessPointLimitExceeded`](crate::types::error::AccessPointLimitExceeded).
    pub fn builder() -> crate::types::error::builders::AccessPointLimitExceededBuilder {
        crate::types::error::builders::AccessPointLimitExceededBuilder::default()
    }
}

/// A builder for [`AccessPointLimitExceeded`](crate::types::error::AccessPointLimitExceeded).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AccessPointLimitExceededBuilder {
    pub(crate) error_code: ::std::option::Option<::std::string::String>,
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl AccessPointLimitExceededBuilder {
    /// <p>The error code is a string that uniquely identifies an error condition. It is meant to be read and understood by programs that detect and handle errors by type.</p>
    ...
    /// Consumes the builder and constructs a [`AccessPointLimitExceeded`](crate::types::error::AccessPointLimitExceeded).
    /// This method will fail if any of the following fields are not set:
    /// - [`error_code`](crate::types::error::builders::AccessPointLimitExceededBuilder::error_code)
    pub fn build(self) -> ::std::result::Result<crate::types::error::AccessPointLimitExceeded, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::AccessPointLimitExceeded {
            error_code: self.error_code.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "error_code",
                    "error_code was not specified but it is required when building AccessPointLimitExceeded",
                )
            })?,
