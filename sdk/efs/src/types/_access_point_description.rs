...
impl AccessPointDescription {
    /// Creates a new builder-style object to manufacture [`AccessPointDescription`](crate::types::AccessPointDescription).
    pub fn builder() -> crate::types::builders::AccessPointDescriptionBuilder {
        crate::types::builders::AccessPointDescriptionBuilder::default()
    }
}
...
impl AccessPointDescriptionBuilder {
    /// <p>The opaque string specified in the request to ensure idempotent creation.</p>
