...
impl ListProductSubscriptionsOutput {
    /// <p>Metadata that describes the list product subscriptions operation.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.product_user_summaries.is_none()`.
    pub fn product_user_summaries(&self) -> &[crate::types::ProductUserSummary] {
        self.product_user_summaries.as_deref().unwrap_or_default()
    }
    /// <p>The next token used for paginated responses. When this field isn't empty, there are additional elements that the service hasn't included in this request. Use this token with the next request to retrieve additional objects.</p>
...
impl ::aws_types::request_id::RequestId for ListProductSubscriptionsOutput {
...
impl ListProductSubscriptionsOutputBuilder {
    ...
    pub fn product_user_summaries(mut self, input: crate::types::ProductUserSummary) -> Self {
        ...
        v.push(input);
        self.product_user_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>Metadata that describes the list product subscriptions operation.</p>
