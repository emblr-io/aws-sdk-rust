...
//! aws-sdk-licensemanagerusersubscriptions = "0.0.0-local"
...
//! offered by AWS License Manager User Subscriptions. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS License Manager User Subscriptions.
...
/// For example, the [`AssociateUser`](crate::operation::associate_user) operation has
...
/// Configuration for AWS License Manager User Subscriptions.
pub mod config;
