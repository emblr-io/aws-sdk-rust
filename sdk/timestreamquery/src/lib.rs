...
//! aws-sdk-timestreamquery = "0.0.0-local"
...
//! offered by Amazon Timestream Query. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Timestream Query.
