...
#[non_exhaustive]
pub struct ScheduledQueryInsightsResponseBuilder {
...
impl ScheduledQueryInsightsResponseBuilder {
    /// <p>Provides insights into the spatial coverage of the query, including the table with sub-optimal (max) spatial pruning. This information can help you identify areas for improvement in your partitioning strategy to enhance spatial pruning.</p>
    ...
    /// Consumes the builder and constructs a [`ScheduledQueryInsightsResponse`](crate::types::ScheduledQueryInsightsResponse).
    pub fn build(self) -> crate::types::ScheduledQueryInsightsResponse {
        crate::types::ScheduledQueryInsightsResponse {
