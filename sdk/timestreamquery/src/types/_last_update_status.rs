...
impl ::std::convert::From<&str> for LastUpdateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PENDING" => LastUpdateStatus::Pending,
            "SUCCEEDED" => LastUpdateStatus::Succeeded,
...
impl LastUpdateStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            LastUpdateStatus::Pending => "PENDING",
            LastUpdateStatus::Succeeded => "SUCCEEDED",
...
impl ::std::fmt::Display for LastUpdateStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            LastUpdateStatus::Pending => write!(f, "PENDING"),
            LastUpdateStatus::Succeeded => write!(f, "SUCCEEDED"),
