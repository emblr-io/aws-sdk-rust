...
/// When writing a match expression against `ScalarMeasureValueType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `scalarmeasurevaluetype` represents
...
/// version of SDK where the variant `ScalarMeasureValueType::NewFeature` is defined.
/// Specifically, when `scalarmeasurevaluetype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ScalarMeasureValueType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ScalarMeasureValueType {
    #[allow(missing_docs)] // documentation missing in model
    Bigint,
    #[allow(missing_docs)] // documentation missing in model
    Boolean,
...
impl ::std::convert::From<&str> for ScalarMeasureValueType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScalarMeasureValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScalarMeasureValueType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScalarMeasureValueType::from(s))
    }
}
impl ScalarMeasureValueType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ScalarMeasureValueType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ScalarMeasureValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
