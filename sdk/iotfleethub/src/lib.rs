...
//! offered by AWS IoT Fleet Hub. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT Fleet Hub.
...
/// Configuration for AWS IoT Fleet Hub.
pub mod config;
