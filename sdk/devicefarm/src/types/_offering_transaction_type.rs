...
impl ::std::convert::From<&str> for OfferingTransactionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OfferingTransactionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OfferingTransactionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OfferingTransactionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OfferingTransactionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
