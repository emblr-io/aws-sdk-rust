...
impl ::std::convert::From<&str> for DevicePoolType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DevicePoolType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DevicePoolType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DevicePoolType::from(s))
    }
}
impl DevicePoolType {
...
impl ::std::convert::AsRef<str> for DevicePoolType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
