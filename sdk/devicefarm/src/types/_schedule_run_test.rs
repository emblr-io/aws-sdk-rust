...
pub struct ScheduleRunTest {
    ...
    /// <ul>
    /// <li>
    /// <p>event_count: The number of events, between 1 and 10000, that the UI fuzz test should perform.</p></li>
    /// <li>
    ...
    /// <ul>
    /// <li>
    /// <p>Running a single test class: <code>LoginTests</code></p></li>
    /// <li>
    /// <p>Running a multiple test classes: <code>LoginTests,SmokeTests</code></p></li>
    /// <li>
...
impl ScheduleRunTestBuilder {
    ...
    /// - [`r#type`](crate::types::builders::ScheduleRunTestBuilder::type)
