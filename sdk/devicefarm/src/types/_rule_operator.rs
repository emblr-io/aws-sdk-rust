...
impl ::std::convert::From<&str> for RuleOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RuleOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RuleOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RuleOperator::from(s))
    }
}
impl RuleOperator {
...
impl ::std::convert::AsRef<str> for RuleOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
