...
impl ::std::convert::From<&str> for DeviceAvailability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceAvailability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceAvailability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceAvailability::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceAvailability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
