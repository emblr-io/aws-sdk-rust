...
impl ::std::convert::From<&str> for ExecutionResult {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExecutionResult::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExecutionResult {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExecutionResult::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExecutionResult {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
