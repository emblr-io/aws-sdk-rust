...
impl CustomerArtifactPaths {
    ...
    pub fn ios_paths(&self) -> &[::std::string::String] {
        self.ios_paths.as_deref().unwrap_or_default()
    }
    /// <p>Comma-separated list of paths on the Android device where the artifacts generated by the customer's tests are pulled from.</p>
    ///
    ...
    pub fn android_paths(&self) -> &[::std::string::String] {
        self.android_paths.as_deref().unwrap_or_default()
    }
    /// <p>Comma-separated list of paths in the test execution environment where the artifacts generated by the customer's tests are pulled from.</p>
    ///
    ...
    pub fn device_host_paths(&self) -> &[::std::string::String] {
        self.device_host_paths.as_deref().unwrap_or_default()
    }
}
impl CustomerArtifactPaths {
...
impl CustomerArtifactPathsBuilder {
    ...
    ///
    /// <p>Comma-separated list of paths on the iOS device where the artifacts generated by the customer's tests are pulled from.</p>
    pub fn ios_paths(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        let mut v = self.ios_paths.unwrap_or_default();
        v.push(input.into());
        self.ios_paths = ::std::option::Option::Some(v);
        self
    }
    /// <p>Comma-separated list of paths on the iOS device where the artifacts generated by the customer's tests are pulled from.</p>
    ...
    /// <p>Comma-separated list of paths on the iOS device where the artifacts generated by the customer's tests are pulled from.</p>
    pub fn get_ios_paths(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
        &self.ios_paths
    }
    ...
    ///
    /// <p>Comma-separated list of paths on the Android device where the artifacts generated by the customer's tests are pulled from.</p>
    pub fn android_paths(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        let mut v = self.android_paths.unwrap_or_default();
        v.push(input.into());
        self.android_paths = ::std::option::Option::Some(v);
        self
    }
    /// <p>Comma-separated list of paths on the Android device where the artifacts generated by the customer's tests are pulled from.</p>
    ...
    /// <p>Comma-separated list of paths on the Android device where the artifacts generated by the customer's tests are pulled from.</p>
    pub fn get_android_paths(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
        &self.android_paths
    }
    ...
    ///
    /// <p>Comma-separated list of paths in the test execution environment where the artifacts generated by the customer's tests are pulled from.</p>
    pub fn device_host_paths(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        let mut v = self.device_host_paths.unwrap_or_default();
        v.push(input.into());
        self.device_host_paths = ::std::option::Option::Some(v);
        self
    }
    /// <p>Comma-separated list of paths in the test execution environment where the artifacts generated by the customer's tests are pulled from.</p>
    ...
    /// <p>Comma-separated list of paths in the test execution environment where the artifacts generated by the customer's tests are pulled from.</p>
    pub fn get_device_host_paths(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
        &self.device_host_paths
    }
