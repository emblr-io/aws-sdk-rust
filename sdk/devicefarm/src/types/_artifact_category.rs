...
impl ::std::convert::From<&str> for ArtifactCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArtifactCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactCategory::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArtifactCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
