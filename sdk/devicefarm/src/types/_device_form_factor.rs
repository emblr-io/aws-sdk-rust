...
impl ::std::convert::From<&str> for DeviceFormFactor {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceFormFactor::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceFormFactor {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceFormFactor::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceFormFactor {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
