...
impl ::std::convert::From<&str> for DeviceFilterAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceFilterAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceFilterAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceFilterAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceFilterAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
