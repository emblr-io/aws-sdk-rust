...
impl ::std::convert::From<&str> for BillingMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BillingMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BillingMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BillingMethod::from(s))
    }
}
impl BillingMethod {
...
impl ::std::convert::AsRef<str> for BillingMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
