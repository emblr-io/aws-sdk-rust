...
impl ::std::convert::From<&str> for TestGridSessionArtifactCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TestGridSessionArtifactCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TestGridSessionArtifactCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TestGridSessionArtifactCategory::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TestGridSessionArtifactCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
