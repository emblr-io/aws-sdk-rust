...
impl ::std::convert::From<&str> for InteractionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InteractionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InteractionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InteractionMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InteractionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
