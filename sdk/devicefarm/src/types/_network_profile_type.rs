...
impl ::std::convert::From<&str> for NetworkProfileType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkProfileType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkProfileType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkProfileType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkProfileType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
