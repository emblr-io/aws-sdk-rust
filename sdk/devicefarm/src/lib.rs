...
//! offered by AWS Device Farm. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Device Farm.
...
/// For example, the [`CreateDevicePool`](crate::operation::create_device_pool) operation has
/// a [`Client::create_device_pool`], function which returns a builder for that operation.
...
/// Configuration for AWS Device Farm.
pub mod config;
