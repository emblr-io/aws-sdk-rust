...
impl ::aws_types::request_id::RequestId for DeleteTestGridProjectOutput {
...
impl DeleteTestGridProjectOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteTestGridProjectOutput`](crate::operation::delete_test_grid_project::DeleteTestGridProjectOutput).
    pub fn build(self) -> crate::operation::delete_test_grid_project::DeleteTestGridProjectOutput {
