...
impl ::std::convert::From<&str> for InferenceExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferenceExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferenceExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferenceExecutionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferenceExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
