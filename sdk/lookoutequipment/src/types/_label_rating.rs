...
impl ::std::convert::From<&str> for LabelRating {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LabelRating::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LabelRating {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LabelRating::from(s))
    }
}
impl LabelRating {
...
impl ::std::convert::AsRef<str> for LabelRating {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
