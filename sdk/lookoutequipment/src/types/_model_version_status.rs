...
///     ModelVersionStatus::Canceled => { /* ... */ },
///     ModelVersionStatus::Failed => { /* ... */ },
///     ModelVersionStatus::ImportInProgress => { /* ... */ },
///     ModelVersionStatus::InProgress => { /* ... */ },
///     ModelVersionStatus::Success => { /* ... */ },
...
impl ::std::convert::From<&str> for ModelVersionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "IMPORT_IN_PROGRESS" => ModelVersionStatus::ImportInProgress,
            "IN_PROGRESS" => ModelVersionStatus::InProgress,
            "SUCCESS" => ModelVersionStatus::Success,
            other => ModelVersionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelVersionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelVersionStatus::from(s))
    }
}
impl ModelVersionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ModelVersionStatus::Canceled => "CANCELED",
            ModelVersionStatus::Failed => "FAILED",
            ModelVersionStatus::ImportInProgress => "IMPORT_IN_PROGRESS",
            ModelVersionStatus::InProgress => "IN_PROGRESS",
            ModelVersionStatus::Success => "SUCCESS",
...
impl ::std::convert::AsRef<str> for ModelVersionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
