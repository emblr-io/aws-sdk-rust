...
impl ::std::convert::From<&str> for InferenceSchedulerStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferenceSchedulerStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferenceSchedulerStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferenceSchedulerStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferenceSchedulerStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
