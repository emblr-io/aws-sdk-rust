...
impl ::std::convert::From<&str> for LatestInferenceResult {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LatestInferenceResult::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LatestInferenceResult {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LatestInferenceResult::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LatestInferenceResult {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
