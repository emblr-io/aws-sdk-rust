...
impl UpdateRetrainingSchedulerInput {
    /// Creates a new builder-style object to manufacture [`UpdateRetrainingSchedulerInput`](crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerInput).
    pub fn builder() -> crate::operation::update_retraining_scheduler::builders::UpdateRetrainingSchedulerInputBuilder {
        crate::operation::update_retraining_scheduler::builders::UpdateRetrainingSchedulerInputBuilder::default()
    }
}
...
impl UpdateRetrainingSchedulerInputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateRetrainingSchedulerInput`](crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
