...
impl ListRetrainingSchedulersInput {
    /// Creates a new builder-style object to manufacture [`ListRetrainingSchedulersInput`](crate::operation::list_retraining_schedulers::ListRetrainingSchedulersInput).
    pub fn builder() -> crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersInputBuilder {
        crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersInputBuilder::default()
    }
}
...
impl ListRetrainingSchedulersInputBuilder {
    ...
    pub fn model_name_begins_with(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.model_name_begins_with = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>Specify this field to only list retraining schedulers whose machine learning models begin with the value you specify.</p>
