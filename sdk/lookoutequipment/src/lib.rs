...
//! offered by Amazon Lookout for Equipment. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Lookout for Equipment.
...
/// Configuration for Amazon Lookout for Equipment.
pub mod config;
