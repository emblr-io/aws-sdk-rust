...
impl ::std::convert::From<&str> for BadRequestReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BadRequestReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BadRequestReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BadRequestReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BadRequestReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BadRequestReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            BadRequestReason::InvalidParameters => write!(f, "InvalidParameters"),
