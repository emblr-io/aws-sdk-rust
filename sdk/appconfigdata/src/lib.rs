...
//! offered by AWS AppConfig Data. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS AppConfig Data.
...
/// For example, the [`GetLatestConfiguration`](crate::operation::get_latest_configuration) operation has
