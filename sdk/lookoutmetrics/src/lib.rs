...
//! aws-sdk-lookoutmetrics = "0.0.0-local"
...
//! offered by Amazon Lookout for Metrics. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Lookout for Metrics.
...
/// For example, the [`ActivateAnomalyDetector`](crate::operation::activate_anomaly_detector) operation has
...
/// Configuration for Amazon Lookout for Metrics.
pub mod config;
