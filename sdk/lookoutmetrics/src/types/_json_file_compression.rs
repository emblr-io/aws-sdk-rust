...
impl ::std::convert::From<&str> for JsonFileCompression {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JsonFileCompression::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JsonFileCompression {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JsonFileCompression::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JsonFileCompression {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
