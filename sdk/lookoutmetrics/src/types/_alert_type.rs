...
impl ::std::convert::From<&str> for AlertType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "SNS" => AlertType::Sns,
            other => AlertType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlertType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlertType::from(s))
    }
}
impl AlertType {
...
impl ::std::convert::AsRef<str> for AlertType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
