...
impl ::std::convert::From<&str> for Confidence {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Confidence::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Confidence {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Confidence::from(s))
    }
}
impl Confidence {
...
impl ::std::convert::AsRef<str> for Confidence {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Confidence {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            Confidence::Unknown(value) => write!(f, "{}", value),
        }
    }
}
