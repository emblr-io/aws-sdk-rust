...
impl ::std::convert::From<&str> for CsvFileCompression {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CsvFileCompression::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CsvFileCompression {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CsvFileCompression::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CsvFileCompression {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
