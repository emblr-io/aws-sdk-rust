...
impl ::std::convert::From<&str> for AlertStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlertStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlertStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlertStatus::from(s))
    }
}
impl AlertStatus {
...
impl ::std::convert::AsRef<str> for AlertStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
