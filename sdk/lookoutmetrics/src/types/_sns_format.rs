...
impl ::std::convert::From<&str> for SnsFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnsFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnsFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnsFormat::from(s))
    }
}
impl SnsFormat {
...
impl ::std::convert::AsRef<str> for SnsFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
