...
//! offered by Amazon Kinesis Video Signaling Channels. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Kinesis Video Signaling Channels.
...
/// For example, the [`GetIceServerConfig`](crate::operation::get_ice_server_config) operation has
/// a [`Client::get_ice_server_config`], function which returns a builder for that operation.
...
/// Configuration for Amazon Kinesis Video Signaling Channels.
pub mod config;
