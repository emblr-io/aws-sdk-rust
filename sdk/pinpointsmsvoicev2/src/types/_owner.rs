...
impl ::std::convert::From<&str> for Owner {
    fn from(s: &str) -> Self {
        match s {
            "SELF" => Owner::SelfValue,
            "SHARED" => Owner::Shared,
            other => Owner::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Owner {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Owner::from(s))
    }
}
impl Owner {
...
impl ::std::convert::AsRef<str> for Owner {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
