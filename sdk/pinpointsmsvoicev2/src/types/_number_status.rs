...
impl ::std::convert::From<&str> for NumberStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NumberStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NumberStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NumberStatus::from(s))
    }
}
impl NumberStatus {
...
impl ::std::convert::AsRef<str> for NumberStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
