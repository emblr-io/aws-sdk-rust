...
/// When writing a match expression against `ProtectStatus`, it is important to ensure
...
///
/// ```text
/// # let protectstatus = unimplemented!();
/// match protectstatus {
///     ProtectStatus::Allow => { /* ... */ },
///     ProtectStatus::Block => { /* ... */ },
...
/// }
/// ```
/// The above code demonstrates that when `protectstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ProtectStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ProtectStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ProtectStatus::NewFeature` is defined.
/// Specifically, when `protectstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ProtectStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for ProtectStatus {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ProtectStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProtectStatus::from(s))
    }
}
impl ProtectStatus {
...
impl ::std::fmt::Display for ProtectStatus {
