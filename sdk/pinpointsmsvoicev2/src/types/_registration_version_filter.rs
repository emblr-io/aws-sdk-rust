...
impl RegistrationVersionFilter {
    /// Creates a new builder-style object to manufacture [`RegistrationVersionFilter`](crate::types::RegistrationVersionFilter).
    pub fn builder() -> crate::types::builders::RegistrationVersionFilterBuilder {
        crate::types::builders::RegistrationVersionFilterBuilder::default()
    }
}

/// A builder for [`RegistrationVersionFilter`](crate::types::RegistrationVersionFilter).
...
impl RegistrationVersionFilterBuilder {
    ...
    pub fn name(mut self, input: crate::types::RegistrationVersionFilterName) -> Self {
