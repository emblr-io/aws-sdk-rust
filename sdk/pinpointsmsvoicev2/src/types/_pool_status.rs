...
impl ::std::convert::From<&str> for PoolStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PoolStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PoolStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PoolStatus::from(s))
    }
}
impl PoolStatus {
...
impl ::std::convert::AsRef<str> for PoolStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
