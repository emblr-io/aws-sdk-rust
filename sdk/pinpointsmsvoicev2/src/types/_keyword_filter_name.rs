...
impl ::std::convert::From<&str> for KeywordFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => KeywordFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for KeywordFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KeywordFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for KeywordFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for KeywordFilterName {
