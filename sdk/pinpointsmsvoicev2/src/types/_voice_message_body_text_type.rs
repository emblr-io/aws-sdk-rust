...
impl ::std::convert::From<&str> for VoiceMessageBodyTextType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VoiceMessageBodyTextType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VoiceMessageBodyTextType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VoiceMessageBodyTextType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VoiceMessageBodyTextType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
