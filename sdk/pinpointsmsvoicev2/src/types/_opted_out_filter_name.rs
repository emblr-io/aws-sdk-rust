...
impl ::std::convert::From<&str> for OptedOutFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OptedOutFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OptedOutFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OptedOutFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OptedOutFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
