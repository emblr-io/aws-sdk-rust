...
impl ::std::convert::From<&str> for PoolOriginationIdentitiesFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PoolOriginationIdentitiesFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PoolOriginationIdentitiesFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PoolOriginationIdentitiesFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PoolOriginationIdentitiesFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
