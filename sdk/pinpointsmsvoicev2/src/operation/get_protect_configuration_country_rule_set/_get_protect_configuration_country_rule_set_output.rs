...
pub struct GetProtectConfigurationCountryRuleSetOutput {
...
impl GetProtectConfigurationCountryRuleSetOutput {
    /// <p>The Amazon Resource Name (ARN) of the protect configuration.</p>
...
impl ::aws_types::request_id::RequestId for GetProtectConfigurationCountryRuleSetOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetProtectConfigurationCountryRuleSetOutput {
    /// Creates a new builder-style object to manufacture [`GetProtectConfigurationCountryRuleSetOutput`](crate::operation::get_protect_configuration_country_rule_set::GetProtectConfigurationCountryRuleSetOutput).
    pub fn builder() -> crate::operation::get_protect_configuration_country_rule_set::builders::GetProtectConfigurationCountryRuleSetOutputBuilder {
        crate::operation::get_protect_configuration_country_rule_set::builders::GetProtectConfigurationCountryRuleSetOutputBuilder::default()
    }
}
...
impl GetProtectConfigurationCountryRuleSetOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the protect configuration.</p>
    ...
    /// Consumes the builder and constructs a [`GetProtectConfigurationCountryRuleSetOutput`](crate::operation::get_protect_configuration_country_rule_set::GetProtectConfigurationCountryRuleSetOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`protect_configuration_arn`](crate::operation::get_protect_configuration_country_rule_set::builders::GetProtectConfigurationCountryRuleSetOutputBuilder::protect_configuration_arn)
    /// - [`protect_configuration_id`](crate::operation::get_protect_configuration_country_rule_set::builders::GetProtectConfigurationCountryRuleSetOutputBuilder::protect_configuration_id)
    /// - [`number_capability`](crate::operation::get_protect_configuration_country_rule_set::builders::GetProtectConfigurationCountryRuleSetOutputBuilder::number_capability)
    /// - [`country_rule_set`](crate::operation::get_protect_configuration_country_rule_set::builders::GetProtectConfigurationCountryRuleSetOutputBuilder::country_rule_set)
    pub fn build(
        self,
    ) -> ::std::result::Result<
            ...
            crate::operation::get_protect_configuration_country_rule_set::GetProtectConfigurationCountryRuleSetOutput {
                protect_configuration_arn: self.protect_configuration_arn.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        ...
                        "protect_configuration_arn was not specified but it is required when building GetProtectConfigurationCountryRuleSetOutput",
                    )
                })?,
                protect_configuration_id: self.protect_configuration_id.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        "protect_configuration_id",
                        "protect_configuration_id was not specified but it is required when building GetProtectConfigurationCountryRuleSetOutput",
                    )
                })?,
                number_capability: self.number_capability.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        "number_capability",
                        "number_capability was not specified but it is required when building GetProtectConfigurationCountryRuleSetOutput",
                    )
                })?,
                country_rule_set: self.country_rule_set.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        "country_rule_set",
                        "country_rule_set was not specified but it is required when building GetProtectConfigurationCountryRuleSetOutput",
                    )
                })?,
