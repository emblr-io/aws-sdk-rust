...
pub struct DeleteProtectConfigurationRuleSetNumberOverrideOutput {
...
impl ::aws_types::request_id::RequestId for DeleteProtectConfigurationRuleSetNumberOverrideOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteProtectConfigurationRuleSetNumberOverrideOutput {
    /// Creates a new builder-style object to manufacture [`DeleteProtectConfigurationRuleSetNumberOverrideOutput`](crate::operation::delete_protect_configuration_rule_set_number_override::DeleteProtectConfigurationRuleSetNumberOverrideOutput).
    pub fn builder(
    ...
    {
        crate::operation::delete_protect_configuration_rule_set_number_override::builders::DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder::default()
    }
}

/// A builder for [`DeleteProtectConfigurationRuleSetNumberOverrideOutput`](crate::operation::delete_protect_configuration_rule_set_number_override::DeleteProtectConfigurationRuleSetNumberOverrideOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder {
...
impl DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the protect configuration.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteProtectConfigurationRuleSetNumberOverrideOutput`](crate::operation::delete_protect_configuration_rule_set_number_override::DeleteProtectConfigurationRuleSetNumberOverrideOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`protect_configuration_arn`](crate::operation::delete_protect_configuration_rule_set_number_override::builders::DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder::protect_configuration_arn)
    /// - [`protect_configuration_id`](crate::operation::delete_protect_configuration_rule_set_number_override::builders::DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder::protect_configuration_id)
    /// - [`destination_phone_number`](crate::operation::delete_protect_configuration_rule_set_number_override::builders::DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder::destination_phone_number)
    /// - [`created_timestamp`](crate::operation::delete_protect_configuration_rule_set_number_override::builders::DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder::created_timestamp)
    /// - [`action`](crate::operation::delete_protect_configuration_rule_set_number_override::builders::DeleteProtectConfigurationRuleSetNumberOverrideOutputBuilder::action)
    pub fn build(
        self,
    ) -> ::std::result::Result<
        ...
        ::std::result::Result::Ok(
            crate::operation::delete_protect_configuration_rule_set_number_override::DeleteProtectConfigurationRuleSetNumberOverrideOutput {
                protect_configuration_arn: self.protect_configuration_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("protect_configuration_arn", "protect_configuration_arn was not specified but it is required when building DeleteProtectConfigurationRuleSetNumberOverrideOutput")
                    )?
                ,
                protect_configuration_id: self.protect_configuration_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("protect_configuration_id", "protect_configuration_id was not specified but it is required when building DeleteProtectConfigurationRuleSetNumberOverrideOutput")
                    )?
                ,
                destination_phone_number: self.destination_phone_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("destination_phone_number", "destination_phone_number was not specified but it is required when building DeleteProtectConfigurationRuleSetNumberOverrideOutput")
                    )?
                ,
                created_timestamp: self.created_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_timestamp", "created_timestamp was not specified but it is required when building DeleteProtectConfigurationRuleSetNumberOverrideOutput")
                    )?
                ,
                action: self.action
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("action", "action was not specified but it is required when building DeleteProtectConfigurationRuleSetNumberOverrideOutput")
                    )?
                ,
