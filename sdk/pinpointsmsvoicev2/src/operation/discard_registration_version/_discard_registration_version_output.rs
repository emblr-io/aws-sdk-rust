...
impl DiscardRegistrationVersionOutput {
    ...
    pub fn builder() -> crate::operation::discard_registration_version::builders::DiscardRegistrationVersionOutputBuilder {
        crate::operation::discard_registration_version::builders::DiscardRegistrationVersionOutputBuilder::default()
    }
}

/// A builder for [`DiscardRegistrationVersionOutput`](crate::operation::discard_registration_version::DiscardRegistrationVersionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DiscardRegistrationVersionOutputBuilder {
...
impl DiscardRegistrationVersionOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) for the registration.</p>
