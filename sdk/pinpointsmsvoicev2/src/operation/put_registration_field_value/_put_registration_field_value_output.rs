...
pub struct PutRegistrationFieldValueOutput {
...
impl PutRegistrationFieldValueOutput {
    /// <p>The Amazon Resource Name (ARN) for the registration.</p>
...
impl ::aws_types::request_id::RequestId for PutRegistrationFieldValueOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PutRegistrationFieldValueOutput {
    /// Creates a new builder-style object to manufacture [`PutRegistrationFieldValueOutput`](crate::operation::put_registration_field_value::PutRegistrationFieldValueOutput).
    pub fn builder() -> crate::operation::put_registration_field_value::builders::PutRegistrationFieldValueOutputBuilder {
        crate::operation::put_registration_field_value::builders::PutRegistrationFieldValueOutputBuilder::default()
    }
}

/// A builder for [`PutRegistrationFieldValueOutput`](crate::operation::put_registration_field_value::PutRegistrationFieldValueOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutRegistrationFieldValueOutputBuilder {
...
impl PutRegistrationFieldValueOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) for the registration.</p>
    ...
    /// Consumes the builder and constructs a [`PutRegistrationFieldValueOutput`](crate::operation::put_registration_field_value::PutRegistrationFieldValueOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`registration_arn`](crate::operation::put_registration_field_value::builders::PutRegistrationFieldValueOutputBuilder::registration_arn)
    /// - [`registration_id`](crate::operation::put_registration_field_value::builders::PutRegistrationFieldValueOutputBuilder::registration_id)
    /// - [`version_number`](crate::operation::put_registration_field_value::builders::PutRegistrationFieldValueOutputBuilder::version_number)
    /// - [`field_path`](crate::operation::put_registration_field_value::builders::PutRegistrationFieldValueOutputBuilder::field_path)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::put_registration_field_value::PutRegistrationFieldValueOutput {
            registration_arn: self.registration_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "registration_arn",
                    "registration_arn was not specified but it is required when building PutRegistrationFieldValueOutput",
                )
            })?,
            registration_id: self.registration_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "registration_id",
                    "registration_id was not specified but it is required when building PutRegistrationFieldValueOutput",
                )
            })?,
            version_number: self.version_number.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version_number",
                    "version_number was not specified but it is required when building PutRegistrationFieldValueOutput",
                )
            })?,
            field_path: self.field_path.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "field_path",
                    "field_path was not specified but it is required when building PutRegistrationFieldValueOutput",
                )
            })?,
