...
//! offered by AWS RDS DataService. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS RDS DataService.
...
/// Configuration for AWS RDS DataService.
pub mod config;
