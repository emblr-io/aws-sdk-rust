...
impl ::std::convert::From<&str> for LongReturnType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LongReturnType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LongReturnType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LongReturnType::from(s))
    }
}
impl LongReturnType {
...
impl ::std::convert::AsRef<str> for LongReturnType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
