...
impl ::std::convert::From<&str> for TypeHint {
    fn from(s: &str) -> Self {
        match s {
            ...
            "UUID" => TypeHint::Uuid,
            other => TypeHint::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TypeHint {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TypeHint::from(s))
    }
}
impl TypeHint {
...
impl ::std::convert::AsRef<str> for TypeHint {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
