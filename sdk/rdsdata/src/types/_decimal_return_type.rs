...
impl ::std::convert::From<&str> for DecimalReturnType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DecimalReturnType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DecimalReturnType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DecimalReturnType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DecimalReturnType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
