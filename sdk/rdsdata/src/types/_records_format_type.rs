...
impl ::std::convert::From<&str> for RecordsFormatType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordsFormatType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordsFormatType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordsFormatType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecordsFormatType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
