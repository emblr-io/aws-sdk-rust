...
impl ::std::convert::From<&str> for OrderedPhoneNumberStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderedPhoneNumberStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderedPhoneNumberStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderedPhoneNumberStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrderedPhoneNumberStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OrderedPhoneNumberStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OrderedPhoneNumberStatus::Acquired => write!(f, "Acquired"),
            OrderedPhoneNumberStatus::Failed => write!(f, "Failed"),
            OrderedPhoneNumberStatus::Processing => write!(f, "Processing"),
            OrderedPhoneNumberStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
