...
impl ::std::convert::From<&str> for AccountType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountType::from(s))
    }
}
impl AccountType {
...
impl ::std::fmt::Display for AccountType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccountType::EnterpriseDirectory => write!(f, "EnterpriseDirectory"),
