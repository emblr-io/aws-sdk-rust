...
impl ::std::convert::From<&str> for RoomMembershipRole {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RoomMembershipRole::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RoomMembershipRole {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RoomMembershipRole::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RoomMembershipRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
