...
impl ::std::convert::From<&str> for EmailStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EmailStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EmailStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EmailStatus::from(s))
    }
}
impl EmailStatus {
...
impl ::std::convert::AsRef<str> for EmailStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
