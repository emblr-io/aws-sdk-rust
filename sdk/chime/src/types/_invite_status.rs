...
impl ::std::convert::From<&str> for InviteStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InviteStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InviteStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InviteStatus::from(s))
    }
}
impl InviteStatus {
...
impl ::std::convert::AsRef<str> for InviteStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
