...
impl ::aws_types::request_id::RequestId for GetConnectorDefinitionVersionOutput {
...
/// A builder for [`GetConnectorDefinitionVersionOutput`](crate::operation::get_connector_definition_version::GetConnectorDefinitionVersionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetConnectorDefinitionVersionOutputBuilder {
    pub(crate) arn: ::std::option::Option<::std::string::String>,
    pub(crate) creation_timestamp: ::std::option::Option<::std::string::String>,
    pub(crate) definition: ::std::option::Option<crate::types::ConnectorDefinitionVersion>,
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    pub(crate) version: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl GetConnectorDefinitionVersionOutputBuilder {
    /// The ARN of the connector definition version.
    ...
    /// Information about the connector definition version.
    pub fn get_definition(&self) -> &::std::option::Option<crate::types::ConnectorDefinitionVersion> {
        &self.definition
    }
    /// The ID of the connector definition version.
