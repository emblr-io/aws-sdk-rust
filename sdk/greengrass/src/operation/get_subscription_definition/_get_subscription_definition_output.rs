...
impl GetSubscriptionDefinitionOutput {
    /// Creates a new builder-style object to manufacture [`GetSubscriptionDefinitionOutput`](crate::operation::get_subscription_definition::GetSubscriptionDefinitionOutput).
    pub fn builder() -> crate::operation::get_subscription_definition::builders::GetSubscriptionDefinitionOutputBuilder {
        crate::operation::get_subscription_definition::builders::GetSubscriptionDefinitionOutputBuilder::default()
    }
}

/// A builder for [`GetSubscriptionDefinitionOutput`](crate::operation::get_subscription_definition::GetSubscriptionDefinitionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetSubscriptionDefinitionOutputBuilder {
...
impl GetSubscriptionDefinitionOutputBuilder {
    /// The ARN of the definition.
    ...
    /// Consumes the builder and constructs a [`GetSubscriptionDefinitionOutput`](crate::operation::get_subscription_definition::GetSubscriptionDefinitionOutput).
    pub fn build(self) -> crate::operation::get_subscription_definition::GetSubscriptionDefinitionOutput {
