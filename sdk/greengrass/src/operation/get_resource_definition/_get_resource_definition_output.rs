...
impl ::aws_types::request_id::RequestId for GetResourceDefinitionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetResourceDefinitionOutput {
    /// Creates a new builder-style object to manufacture [`GetResourceDefinitionOutput`](crate::operation::get_resource_definition::GetResourceDefinitionOutput).
    pub fn builder() -> crate::operation::get_resource_definition::builders::GetResourceDefinitionOutputBuilder {
        crate::operation::get_resource_definition::builders::GetResourceDefinitionOutputBuilder::default()
    }
}

/// A builder for [`GetResourceDefinitionOutput`](crate::operation::get_resource_definition::GetResourceDefinitionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetResourceDefinitionOutputBuilder {
...
impl GetResourceDefinitionOutputBuilder {
    /// The ARN of the definition.
    ...
    /// Consumes the builder and constructs a [`GetResourceDefinitionOutput`](crate::operation::get_resource_definition::GetResourceDefinitionOutput).
    pub fn build(self) -> crate::operation::get_resource_definition::GetResourceDefinitionOutput {
