...
impl ::aws_types::request_id::RequestId for GetDeviceDefinitionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetDeviceDefinitionOutput {
    /// Creates a new builder-style object to manufacture [`GetDeviceDefinitionOutput`](crate::operation::get_device_definition::GetDeviceDefinitionOutput).
    pub fn builder() -> crate::operation::get_device_definition::builders::GetDeviceDefinitionOutputBuilder {
        crate::operation::get_device_definition::builders::GetDeviceDefinitionOutputBuilder::default()
    }
}

/// A builder for [`GetDeviceDefinitionOutput`](crate::operation::get_device_definition::GetDeviceDefinitionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetDeviceDefinitionOutputBuilder {
...
impl GetDeviceDefinitionOutputBuilder {
    /// The ARN of the definition.
    ...
    /// Consumes the builder and constructs a [`GetDeviceDefinitionOutput`](crate::operation::get_device_definition::GetDeviceDefinitionOutput).
    pub fn build(self) -> crate::operation::get_device_definition::GetDeviceDefinitionOutput {
