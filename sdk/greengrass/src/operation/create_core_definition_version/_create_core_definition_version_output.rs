...
impl ::aws_types::request_id::RequestId for CreateCoreDefinitionVersionOutput {
...
impl CreateCoreDefinitionVersionOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::create_core_definition_version::CreateCoreDefinitionVersionOutput {
