...
impl CreateResourceDefinitionInput {
    ...
    /// Information about the initial version of the resource definition.
    pub fn initial_version(&self) -> ::std::option::Option<&crate::types::ResourceDefinitionVersion> {
...
impl CreateResourceDefinitionInput {
    /// Creates a new builder-style object to manufacture [`CreateResourceDefinitionInput`](crate::operation::create_resource_definition::CreateResourceDefinitionInput).
    pub fn builder() -> crate::operation::create_resource_definition::builders::CreateResourceDefinitionInputBuilder {
        crate::operation::create_resource_definition::builders::CreateResourceDefinitionInputBuilder::default()
    }
}

/// A builder for [`CreateResourceDefinitionInput`](crate::operation::create_resource_definition::CreateResourceDefinitionInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateResourceDefinitionInputBuilder {
    pub(crate) amzn_client_token: ::std::option::Option<::std::string::String>,
    pub(crate) initial_version: ::std::option::Option<crate::types::ResourceDefinitionVersion>,
...
impl CreateResourceDefinitionInputBuilder {
    ...
    pub fn build(
        ...
        crate::operation::create_resource_definition::CreateResourceDefinitionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::create_resource_definition::CreateResourceDefinitionInput {
