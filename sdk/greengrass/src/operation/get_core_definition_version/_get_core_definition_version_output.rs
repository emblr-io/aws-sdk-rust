...
pub struct GetCoreDefinitionVersionOutput {
    ...
    pub definition: ::std::option::Option<crate::types::CoreDefinitionVersion>,
...
pub struct GetCoreDefinitionVersionOutputBuilder {
    ...
    pub(crate) definition: ::std::option::Option<crate::types::CoreDefinitionVersion>,
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    pub(crate) version: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl GetCoreDefinitionVersionOutputBuilder {
    /// The ARN of the core definition version.
    ...
    /// Information about the core definition version.
    pub fn definition(mut self, input: crate::types::CoreDefinitionVersion) -> Self {
