...
impl GetCoreDefinitionOutput {
    ...
    pub fn builder() -> crate::operation::get_core_definition::builders::GetCoreDefinitionOutputBuilder {
        crate::operation::get_core_definition::builders::GetCoreDefinitionOutputBuilder::default()
    }
}

/// A builder for [`GetCoreDefinitionOutput`](crate::operation::get_core_definition::GetCoreDefinitionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetCoreDefinitionOutputBuilder {
