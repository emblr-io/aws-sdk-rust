...
/// A builder for [`ListConnectorDefinitionsInput`](crate::operation::list_connector_definitions::ListConnectorDefinitionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListConnectorDefinitionsInputBuilder {
...
impl ListConnectorDefinitionsInputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::list_connector_definitions::ListConnectorDefinitionsInput {
