...
impl GetLoggerDefinitionVersionOutput {
    ...
    /// Information about the logger definition version.
    pub fn definition(&self) -> ::std::option::Option<&crate::types::LoggerDefinitionVersion> {
...
pub struct GetLoggerDefinitionVersionOutputBuilder {
    ...
    pub(crate) definition: ::std::option::Option<crate::types::LoggerDefinitionVersion>,
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) version: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl GetLoggerDefinitionVersionOutputBuilder {
    /// The ARN of the logger definition version.
