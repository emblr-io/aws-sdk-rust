...
impl ::aws_types::request_id::RequestId for GetConnectorDefinitionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetConnectorDefinitionOutput {
    /// Creates a new builder-style object to manufacture [`GetConnectorDefinitionOutput`](crate::operation::get_connector_definition::GetConnectorDefinitionOutput).
    pub fn builder() -> crate::operation::get_connector_definition::builders::GetConnectorDefinitionOutputBuilder {
        crate::operation::get_connector_definition::builders::GetConnectorDefinitionOutputBuilder::default()
    }
}

/// A builder for [`GetConnectorDefinitionOutput`](crate::operation::get_connector_definition::GetConnectorDefinitionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetConnectorDefinitionOutputBuilder {
...
impl GetConnectorDefinitionOutputBuilder {
    /// The ARN of the definition.
    ...
    /// Consumes the builder and constructs a [`GetConnectorDefinitionOutput`](crate::operation::get_connector_definition::GetConnectorDefinitionOutput).
    pub fn build(self) -> crate::operation::get_connector_definition::GetConnectorDefinitionOutput {
