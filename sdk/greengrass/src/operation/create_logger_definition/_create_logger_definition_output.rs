...
impl ::aws_types::request_id::RequestId for CreateLoggerDefinitionOutput {
...
impl CreateLoggerDefinitionOutputBuilder {
    /// The ARN of the definition.
    ...
    /// Consumes the builder and constructs a [`CreateLoggerDefinitionOutput`](crate::operation::create_logger_definition::CreateLoggerDefinitionOutput).
    pub fn build(self) -> crate::operation::create_logger_definition::CreateLoggerDefinitionOutput {
