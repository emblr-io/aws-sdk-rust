...
impl ::aws_types::request_id::RequestId for ListGroupVersionsOutput {
...
impl ListGroupVersionsOutputBuilder {
    /// The token for the next set of results, or ''null'' if there are no additional results.
    ...
    /// Consumes the builder and constructs a [`ListGroupVersionsOutput`](crate::operation::list_group_versions::ListGroupVersionsOutput).
    pub fn build(self) -> crate::operation::list_group_versions::ListGroupVersionsOutput {
        crate::operation::list_group_versions::ListGroupVersionsOutput {
