...
impl ::aws_types::request_id::RequestId for CreateCoreDefinitionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateCoreDefinitionOutput {
    /// Creates a new builder-style object to manufacture [`CreateCoreDefinitionOutput`](crate::operation::create_core_definition::CreateCoreDefinitionOutput).
    pub fn builder() -> crate::operation::create_core_definition::builders::CreateCoreDefinitionOutputBuilder {
        crate::operation::create_core_definition::builders::CreateCoreDefinitionOutputBuilder::default()
    }
}
...
impl CreateCoreDefinitionOutputBuilder {
    /// The ARN of the definition.
    ...
    /// Consumes the builder and constructs a [`CreateCoreDefinitionOutput`](crate::operation::create_core_definition::CreateCoreDefinitionOutput).
    pub fn build(self) -> crate::operation::create_core_definition::CreateCoreDefinitionOutput {
