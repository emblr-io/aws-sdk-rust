...
impl ::std::convert::From<&str> for SoftwareToUpdate {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SoftwareToUpdate::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SoftwareToUpdate {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SoftwareToUpdate::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SoftwareToUpdate {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
