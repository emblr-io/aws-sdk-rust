...
impl ::std::convert::From<&str> for ConfigurationSyncStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigurationSyncStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigurationSyncStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigurationSyncStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfigurationSyncStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
