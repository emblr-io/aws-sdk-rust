...
impl ::std::convert::From<&str> for LoggerLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoggerLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoggerLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoggerLevel::from(s))
    }
}
impl LoggerLevel {
...
impl ::std::convert::AsRef<str> for LoggerLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
