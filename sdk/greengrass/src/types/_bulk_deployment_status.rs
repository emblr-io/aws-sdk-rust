...
impl ::std::convert::From<&str> for BulkDeploymentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BulkDeploymentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BulkDeploymentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BulkDeploymentStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BulkDeploymentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
