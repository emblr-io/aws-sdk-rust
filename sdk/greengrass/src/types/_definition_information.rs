...
impl DefinitionInformation {
    /// Creates a new builder-style object to manufacture [`DefinitionInformation`](crate::types::DefinitionInformation).
    pub fn builder() -> crate::types::builders::DefinitionInformationBuilder {
        crate::types::builders::DefinitionInformationBuilder::default()
    }
}
...
impl DefinitionInformationBuilder {
    ...
    pub fn build(self) -> crate::types::DefinitionInformation {
        crate::types::DefinitionInformation {
            arn: self.arn,
