...
impl ::std::convert::From<&str> for LoggerComponent {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoggerComponent::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoggerComponent {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoggerComponent::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LoggerComponent {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
