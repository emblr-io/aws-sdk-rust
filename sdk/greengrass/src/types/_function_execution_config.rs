...
impl FunctionExecutionConfig {
    /// Creates a new builder-style object to manufacture [`FunctionExecutionConfig`](crate::types::FunctionExecutionConfig).
    pub fn builder() -> crate::types::builders::FunctionExecutionConfigBuilder {
        crate::types::builders::FunctionExecutionConfigBuilder::default()
    }
}

/// A builder for [`FunctionExecutionConfig`](crate::types::FunctionExecutionConfig).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct FunctionExecutionConfigBuilder {
...
impl FunctionExecutionConfigBuilder {
    ...
    pub fn isolation_mode(mut self, input: crate::types::FunctionIsolationMode) -> Self {
        self.isolation_mode = ::std::option::Option::Some(input);
        self
    }
    /// Specifies whether the Lambda function runs in a Greengrass container (default) or without containerization. Unless your scenario requires that you run without containerization, we recommend that you run in a Greengrass container. Omit this value to run the Lambda function with the default containerization for the group.
    ...
    pub fn build(self) -> crate::types::FunctionExecutionConfig {
        crate::types::FunctionExecutionConfig {
