...
//! aws-sdk-greengrass = "0.0.0-local"
...
//! offered by AWS Greengrass. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Greengrass.
...
/// Configuration for AWS Greengrass.
pub mod config;
