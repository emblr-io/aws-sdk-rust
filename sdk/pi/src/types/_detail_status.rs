...
impl ::std::convert::From<&str> for DetailStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DetailStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DetailStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DetailStatus::from(s))
    }
}
impl DetailStatus {
...
impl ::std::convert::AsRef<str> for DetailStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
