...
impl ::aws_types::request_id::RequestId for CreateCliTokenOutput {
...
impl CreateCliTokenOutputBuilder {
    /// <p>An Airflow CLI login token.</p>
    pub fn cli_token(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.cli_token = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>An Airflow CLI login token.</p>
