...
//! aws-sdk-forecastquery = "0.0.0-local"
...
//! offered by Amazon Forecast Query Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Forecast Query Service.
...
/// For example, the [`QueryForecast`](crate::operation::query_forecast) operation has
...
/// Configuration for Amazon Forecast Query Service.
pub mod config;
