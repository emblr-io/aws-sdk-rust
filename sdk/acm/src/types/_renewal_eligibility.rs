...
impl ::std::convert::From<&str> for RenewalEligibility {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RenewalEligibility::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RenewalEligibility {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RenewalEligibility::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RenewalEligibility {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
