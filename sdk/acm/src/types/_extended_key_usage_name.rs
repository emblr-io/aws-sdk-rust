...
impl ::std::convert::From<&str> for ExtendedKeyUsageName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExtendedKeyUsageName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExtendedKeyUsageName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExtendedKeyUsageName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExtendedKeyUsageName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
