...
impl ::std::convert::From<&str> for ImageError {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageError::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageError {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageError::from(s))
    }
}
impl ImageError {
...
impl ::std::convert::AsRef<str> for ImageError {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
