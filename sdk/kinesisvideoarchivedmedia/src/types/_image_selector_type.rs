...
impl ::std::convert::From<&str> for ImageSelectorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageSelectorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageSelectorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageSelectorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImageSelectorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
