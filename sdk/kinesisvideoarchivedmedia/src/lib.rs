...
//! aws-sdk-kinesisvideoarchivedmedia = "0.0.0-local"
...
//! offered by Amazon Kinesis Video Streams Archived Media. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Kinesis Video Streams Archived Media.
...
/// For example, the [`GetClip`](crate::operation::get_clip) operation has
/// a [`Client::get_clip`], function which returns a builder for that operation.
