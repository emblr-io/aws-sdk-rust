...
impl ::std::convert::From<&str> for EventStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
