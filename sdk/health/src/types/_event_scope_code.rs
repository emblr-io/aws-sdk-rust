...
impl ::std::convert::From<&str> for EventScopeCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventScopeCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventScopeCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventScopeCode::from(s))
    }
}
impl EventScopeCode {
...
impl ::std::convert::AsRef<str> for EventScopeCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
