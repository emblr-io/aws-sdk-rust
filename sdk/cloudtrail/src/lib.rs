...
//! offered by AWS CloudTrail. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS CloudTrail.
...
/// Configuration for AWS CloudTrail.
pub mod config;
