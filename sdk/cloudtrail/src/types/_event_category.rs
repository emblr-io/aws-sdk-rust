...
impl ::std::convert::From<&str> for EventCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventCategory::from(s))
    }
}
impl EventCategory {
...
impl ::std::convert::AsRef<str> for EventCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
