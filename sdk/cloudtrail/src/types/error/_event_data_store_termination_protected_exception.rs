...
impl ::std::fmt::Display for EventDataStoreTerminationProtectedException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "EventDataStoreTerminationProtectedException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::EventDataStoreTerminationProtectedException {
