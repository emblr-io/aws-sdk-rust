...
impl ::std::convert::From<&str> for ReadWriteType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReadWriteType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReadWriteType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReadWriteType::from(s))
    }
}
impl ReadWriteType {
...
impl ::std::convert::AsRef<str> for ReadWriteType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
