...
impl ::std::convert::From<&str> for LookupAttributeKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LookupAttributeKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LookupAttributeKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LookupAttributeKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LookupAttributeKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
