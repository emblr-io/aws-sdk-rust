...
/// match billingmode {
///     BillingMode::ExtendableRetentionPricing => { /* ... */ },
///     BillingMode::FixedRetentionPricing => { /* ... */ },
...
impl ::std::convert::From<&str> for BillingMode {
    fn from(s: &str) -> Self {
        match s {
            "EXTENDABLE_RETENTION_PRICING" => BillingMode::ExtendableRetentionPricing,
            "FIXED_RETENTION_PRICING" => BillingMode::FixedRetentionPricing,
...
impl BillingMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            BillingMode::ExtendableRetentionPricing => "EXTENDABLE_RETENTION_PRICING",
            BillingMode::FixedRetentionPricing => "FIXED_RETENTION_PRICING",
