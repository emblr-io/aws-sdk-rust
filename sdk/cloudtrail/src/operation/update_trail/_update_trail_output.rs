...
impl UpdateTrailOutput {
    /// Creates a new builder-style object to manufacture [`UpdateTrailOutput`](crate::operation::update_trail::UpdateTrailOutput).
    pub fn builder() -> crate::operation::update_trail::builders::UpdateTrailOutputBuilder {
        crate::operation::update_trail::builders::UpdateTrailOutputBuilder::default()
    }
}
...
impl UpdateTrailOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateTrailOutput`](crate::operation::update_trail::UpdateTrailOutput).
    pub fn build(self) -> crate::operation::update_trail::UpdateTrailOutput {
