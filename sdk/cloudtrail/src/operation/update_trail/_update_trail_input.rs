...
impl UpdateTrailInput {
    /// Creates a new builder-style object to manufacture [`UpdateTrailInput`](crate::operation::update_trail::UpdateTrailInput).
    pub fn builder() -> crate::operation::update_trail::builders::UpdateTrailInputBuilder {
        crate::operation::update_trail::builders::UpdateTrailInputBuilder::default()
    }
}

/// A builder for [`UpdateTrailInput`](crate::operation::update_trail::UpdateTrailInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateTrailInputBuilder {
