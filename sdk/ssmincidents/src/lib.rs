...
//! aws-sdk-ssmincidents = "0.0.0-local"
...
//! offered by AWS Systems Manager Incident Manager. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Systems Manager Incident Manager.
...
/// let config = aws_sdk_ssmincidents::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for AWS Systems Manager Incident Manager.
pub mod config;
