...
impl ::std::convert::From<&str> for ReplicationSetStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicationSetStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationSetStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationSetStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReplicationSetStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
