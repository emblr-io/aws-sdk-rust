...
impl ::std::convert::From<&str> for RegionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RegionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RegionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RegionStatus::from(s))
    }
}
impl RegionStatus {
...
impl ::std::convert::AsRef<str> for RegionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
