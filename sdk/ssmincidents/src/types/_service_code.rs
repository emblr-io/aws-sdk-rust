...
impl ::std::convert::From<&str> for ServiceCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServiceCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServiceCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServiceCode::from(s))
    }
}
impl ServiceCode {
...
impl ::std::convert::AsRef<str> for ServiceCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
