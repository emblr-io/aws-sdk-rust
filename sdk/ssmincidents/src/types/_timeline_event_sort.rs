...
impl ::std::convert::From<&str> for TimelineEventSort {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimelineEventSort::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimelineEventSort {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimelineEventSort::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TimelineEventSort {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TimelineEventSort {
