...
impl ::std::convert::From<&str> for VariableType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VariableType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VariableType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VariableType::from(s))
    }
}
impl VariableType {
...
impl ::std::convert::AsRef<str> for VariableType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
