...
impl ::std::convert::From<&str> for SsmTargetAccount {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SsmTargetAccount::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SsmTargetAccount {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SsmTargetAccount::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SsmTargetAccount {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
