...
impl ::std::convert::From<&str> for IncidentRecordStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IncidentRecordStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IncidentRecordStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IncidentRecordStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IncidentRecordStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
