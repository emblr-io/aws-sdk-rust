...
impl ::std::convert::From<&str> for AssignmentStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssignmentStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssignmentStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssignmentStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssignmentStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
