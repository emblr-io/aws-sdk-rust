...
impl ::std::convert::From<&str> for PolicyEvaluationDecisionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PolicyEvaluationDecisionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PolicyEvaluationDecisionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyEvaluationDecisionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PolicyEvaluationDecisionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
