...
impl ::std::convert::From<&str> for ReportStateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportStateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportStateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportStateType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportStateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
