...
impl ::std::convert::From<&str> for PolicyScopeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PolicyScopeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PolicyScopeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyScopeType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PolicyScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
