...
impl ::std::convert::From<&str> for DeletionTaskStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeletionTaskStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeletionTaskStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeletionTaskStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeletionTaskStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
