...
impl ::std::convert::From<&str> for PolicyUsageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PolicyUsageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PolicyUsageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyUsageType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PolicyUsageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
