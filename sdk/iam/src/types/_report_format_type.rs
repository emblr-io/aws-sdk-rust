...
impl ::std::convert::From<&str> for ReportFormatType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReportFormatType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReportFormatType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReportFormatType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReportFormatType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
