...
impl ::std::convert::From<&str> for JobStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobStatusType::from(s))
    }
}
impl JobStatusType {
...
impl ::std::convert::AsRef<str> for JobStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for JobStatusType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            JobStatusType::Completed => write!(f, "COMPLETED"),
            JobStatusType::Failed => write!(f, "FAILED"),
            JobStatusType::InProgress => write!(f, "IN_PROGRESS"),
            JobStatusType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
