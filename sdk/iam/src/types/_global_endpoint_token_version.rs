...
impl ::std::convert::From<&str> for GlobalEndpointTokenVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GlobalEndpointTokenVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GlobalEndpointTokenVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GlobalEndpointTokenVersion::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GlobalEndpointTokenVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
