...
/// <p>Contains the response to a successful <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_UpdateSAMLProvider.html">UpdateSAMLProvider</a> request.</p>
#[non_exhaustive]
...
impl ::aws_types::request_id::RequestId for UpdateSamlProviderOutput {
