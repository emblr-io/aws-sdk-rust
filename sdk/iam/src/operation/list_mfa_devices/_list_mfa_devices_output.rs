...
/// <p>Contains the response to a successful <a href="https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListMFADevices.html">ListMFADevices</a> request.</p>
#[non_exhaustive]
...
impl ::aws_types::request_id::RequestId for ListMfaDevicesOutput {
...
impl ListMfaDevicesOutputBuilder {
    ...
    pub fn mfa_devices(mut self, input: crate::types::MfaDevice) -> Self {
        ...
        v.push(input);
        self.mfa_devices = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of MFA devices.</p>
