...
/// match exporttype {
///     ExportType::FullExport => { /* ... */ },
///     ExportType::IncrementalExport => { /* ... */ },
...
impl ::std::convert::From<&str> for ExportType {
    fn from(s: &str) -> Self {
        match s {
            "FULL_EXPORT" => ExportType::FullExport,
            "INCREMENTAL_EXPORT" => ExportType::IncrementalExport,
            other => ExportType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportType::from(s))
    }
}
impl ExportType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ExportType::FullExport => "FULL_EXPORT",
            ExportType::IncrementalExport => "INCREMENTAL_EXPORT",
...
impl ::std::convert::AsRef<str> for ExportType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
