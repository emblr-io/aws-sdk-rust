...
impl ::std::convert::From<&str> for TableClass {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableClass::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableClass {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableClass::from(s))
    }
}
impl TableClass {
...
impl ::std::convert::AsRef<str> for TableClass {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
