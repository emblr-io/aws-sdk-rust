...
//! offered by Amazon Managed Grafana. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Managed Grafana.
...
/// For example, the [`AssociateLicense`](crate::operation::associate_license) operation has
/// a [`Client::associate_license`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.associate_license()
...
/// Configuration for Amazon Managed Grafana.
pub mod config;
