...
impl ::std::convert::From<&str> for AccountAccessType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountAccessType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountAccessType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountAccessType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccountAccessType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AccountAccessType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccountAccessType::CurrentAccount => write!(f, "CURRENT_ACCOUNT"),
            AccountAccessType::Organization => write!(f, "ORGANIZATION"),
            AccountAccessType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
