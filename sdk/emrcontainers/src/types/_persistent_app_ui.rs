...
impl ::std::convert::From<&str> for PersistentAppUi {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PersistentAppUi::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PersistentAppUi {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PersistentAppUi::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PersistentAppUi {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
