...
//! offered by Amazon EMR Containers. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon EMR Containers.
...
/// For example, the [`CancelJobRun`](crate::operation::cancel_job_run) operation has
