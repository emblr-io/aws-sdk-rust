...
impl GetLabelsInput {
    /// Creates a new builder-style object to manufacture [`GetLabelsInput`](crate::operation::get_labels::GetLabelsInput).
    pub fn builder() -> crate::operation::get_labels::builders::GetLabelsInputBuilder {
        crate::operation::get_labels::builders::GetLabelsInputBuilder::default()
    }
}

/// A builder for [`GetLabelsInput`](crate::operation::get_labels::GetLabelsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetLabelsInputBuilder {
