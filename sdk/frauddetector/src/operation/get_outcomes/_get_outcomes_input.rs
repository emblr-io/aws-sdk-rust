...
impl GetOutcomesInput {
    /// Creates a new builder-style object to manufacture [`GetOutcomesInput`](crate::operation::get_outcomes::GetOutcomesInput).
    pub fn builder() -> crate::operation::get_outcomes::builders::GetOutcomesInputBuilder {
        crate::operation::get_outcomes::builders::GetOutcomesInputBuilder::default()
    }
}

/// A builder for [`GetOutcomesInput`](crate::operation::get_outcomes::GetOutcomesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetOutcomesInputBuilder {
