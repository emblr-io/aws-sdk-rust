...
impl GetListElementsInput {
    /// Creates a new builder-style object to manufacture [`GetListElementsInput`](crate::operation::get_list_elements::GetListElementsInput).
    pub fn builder() -> crate::operation::get_list_elements::builders::GetListElementsInputBuilder {
        crate::operation::get_list_elements::builders::GetListElementsInputBuilder::default()
    }
}
...
impl GetListElementsInputBuilder {
    /// <p>The name of the list.</p>
