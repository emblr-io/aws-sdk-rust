...
impl ::aws_types::request_id::RequestId for PutKmsEncryptionKeyOutput {
...
impl PutKmsEncryptionKeyOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutKmsEncryptionKeyOutput`](crate::operation::put_kms_encryption_key::PutKmsEncryptionKeyOutput).
    pub fn build(self) -> crate::operation::put_kms_encryption_key::PutKmsEncryptionKeyOutput {
