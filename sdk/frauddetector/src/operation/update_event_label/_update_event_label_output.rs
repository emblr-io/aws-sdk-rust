...
impl ::aws_types::request_id::RequestId for UpdateEventLabelOutput {
...
impl UpdateEventLabelOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateEventLabelOutput`](crate::operation::update_event_label::UpdateEventLabelOutput).
    pub fn build(self) -> crate::operation::update_event_label::UpdateEventLabelOutput {
