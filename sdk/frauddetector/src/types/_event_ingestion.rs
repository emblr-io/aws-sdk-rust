...
impl ::std::convert::From<&str> for EventIngestion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventIngestion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventIngestion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventIngestion::from(s))
    }
}
impl EventIngestion {
...
impl ::std::convert::AsRef<str> for EventIngestion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
