...
impl ::std::convert::From<&str> for ModelSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelSource::from(s))
    }
}
impl ModelSource {
...
impl ::std::convert::AsRef<str> for ModelSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
