...
impl ::std::convert::From<&str> for UnlabeledEventsTreatment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnlabeledEventsTreatment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnlabeledEventsTreatment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnlabeledEventsTreatment::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UnlabeledEventsTreatment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
