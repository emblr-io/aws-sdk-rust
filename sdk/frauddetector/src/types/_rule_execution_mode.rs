...
impl ::std::convert::From<&str> for RuleExecutionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RuleExecutionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RuleExecutionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RuleExecutionMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RuleExecutionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
