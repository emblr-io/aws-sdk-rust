...
//! offered by Amazon Fraud Detector. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Fraud Detector.
...
/// Configuration for Amazon Fraud Detector.
pub mod config;
