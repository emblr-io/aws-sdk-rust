...
impl ::std::convert::From<&str> for OverwriteMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OverwriteMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OverwriteMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OverwriteMode::from(s))
    }
}
impl OverwriteMode {
...
impl ::std::convert::AsRef<str> for OverwriteMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
