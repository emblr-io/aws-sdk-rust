...
impl ::std::convert::From<&str> for ObjectTags {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ObjectTags::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ObjectTags {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ObjectTags::from(s))
    }
}
impl ObjectTags {
...
impl ::std::convert::AsRef<str> for ObjectTags {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
