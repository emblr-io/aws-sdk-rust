...
impl ::std::convert::From<&str> for AzureAccessTier {
    fn from(s: &str) -> Self {
        match s {
            "ARCHIVE" => AzureAccessTier::Archive,
            "COOL" => AzureAccessTier::Cool,
            "HOT" => AzureAccessTier::Hot,
            other => AzureAccessTier::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AzureAccessTier {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AzureAccessTier::from(s))
    }
}
impl AzureAccessTier {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AzureAccessTier::Archive => "ARCHIVE",
            AzureAccessTier::Cool => "COOL",
            AzureAccessTier::Hot => "HOT",
            AzureAccessTier::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AzureAccessTier {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
