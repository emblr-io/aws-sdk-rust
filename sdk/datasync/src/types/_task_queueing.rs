...
impl ::std::convert::From<&str> for TaskQueueing {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TaskQueueing::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TaskQueueing {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TaskQueueing::from(s))
    }
}
impl TaskQueueing {
...
impl ::std::convert::AsRef<str> for TaskQueueing {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
