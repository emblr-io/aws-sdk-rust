...
impl ::std::convert::From<&str> for TaskFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TaskFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TaskFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TaskFilterName::from(s))
    }
}
impl TaskFilterName {
...
impl ::std::convert::AsRef<str> for TaskFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
