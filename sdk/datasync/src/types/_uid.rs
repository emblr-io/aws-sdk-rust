...
impl ::std::convert::From<&str> for Uid {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NAME" => Uid::Name,
            "NONE" => Uid::None,
            other => Uid::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Uid {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Uid::from(s))
    }
}
impl Uid {
...
impl ::std::convert::AsRef<str> for Uid {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
