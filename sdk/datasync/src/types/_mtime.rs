...
impl ::std::convert::From<&str> for Mtime {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Mtime::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Mtime {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Mtime::from(s))
    }
}
impl Mtime {
...
impl ::std::convert::AsRef<str> for Mtime {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
