...
impl ::std::convert::From<&str> for PhaseStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PhaseStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PhaseStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PhaseStatus::from(s))
    }
}
impl PhaseStatus {
...
impl ::std::convert::AsRef<str> for PhaseStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
