...
impl ::std::convert::From<&str> for ScheduleDisabledBy {
    fn from(s: &str) -> Self {
        match s {
            "SERVICE" => ScheduleDisabledBy::Service,
            "USER" => ScheduleDisabledBy::User,
            other => ScheduleDisabledBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScheduleDisabledBy {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScheduleDisabledBy::from(s))
    }
}
impl ScheduleDisabledBy {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ScheduleDisabledBy::Service => "SERVICE",
            ScheduleDisabledBy::User => "USER",
            ScheduleDisabledBy::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ScheduleDisabledBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ScheduleDisabledBy {
