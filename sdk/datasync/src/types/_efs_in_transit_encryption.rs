...
impl ::std::convert::From<&str> for EfsInTransitEncryption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EfsInTransitEncryption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EfsInTransitEncryption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EfsInTransitEncryption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EfsInTransitEncryption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
