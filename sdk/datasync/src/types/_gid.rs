...
impl ::std::convert::From<&str> for Gid {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NAME" => Gid::Name,
            "NONE" => Gid::None,
            other => Gid::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Gid {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Gid::from(s))
    }
}
impl Gid {
...
impl ::std::convert::AsRef<str> for Gid {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
