...
impl ::std::convert::From<&str> for PreserveDevices {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PreserveDevices::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PreserveDevices {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PreserveDevices::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PreserveDevices {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
