...
impl ::std::convert::From<&str> for VerifyMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VerifyMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VerifyMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VerifyMode::from(s))
    }
}
impl VerifyMode {
...
impl ::std::convert::AsRef<str> for VerifyMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
