...
impl ::std::convert::From<&str> for S3StorageClass {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => S3StorageClass::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for S3StorageClass {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(S3StorageClass::from(s))
    }
}
impl S3StorageClass {
...
impl ::std::convert::AsRef<str> for S3StorageClass {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for S3StorageClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            S3StorageClass::GlacierInstantRetrieval => write!(f, "GLACIER_INSTANT_RETRIEVAL"),
