...
pub struct NfsMountOptions {
    ...
    /// <ul>
    /// <li>
    /// <p><code>AUTOMATIC</code> (default): DataSync chooses NFS version 4.1.</p></li>
    /// <li>
    /// <p><code>NFS3</code>: Stateless protocol version that allows for asynchronous writes on the server.</p></li>
    /// <li>
    /// <p><code>NFSv4_0</code>: Stateful, firewall-friendly protocol version that supports delegations and pseudo file systems.</p></li>
    /// <li>
    /// <p><code>NFSv4_1</code>: Stateful protocol version that supports sessions, directory delegations, and parallel data processing. NFS version 4.1 also includes all features available in version 4.0.</p></li>
    /// </ul><note>
