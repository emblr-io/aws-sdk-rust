...
impl ::std::convert::From<&str> for Atime {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NONE" => Atime::None,
            other => Atime::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Atime {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Atime::from(s))
    }
}
impl Atime {
...
impl ::std::convert::AsRef<str> for Atime {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
