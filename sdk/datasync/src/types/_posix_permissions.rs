...
impl ::std::convert::From<&str> for PosixPermissions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PosixPermissions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PosixPermissions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PosixPermissions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PosixPermissions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
