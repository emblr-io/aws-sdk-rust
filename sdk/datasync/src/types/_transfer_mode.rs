...
impl ::std::convert::From<&str> for TransferMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransferMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransferMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransferMode::from(s))
    }
}
impl TransferMode {
...
impl ::std::convert::AsRef<str> for TransferMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
