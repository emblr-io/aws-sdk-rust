...
//! offered by AWSKendraFrontendService. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWSKendraFrontendService.
...
/// Configuration for AWSKendraFrontendService.
pub mod config;
