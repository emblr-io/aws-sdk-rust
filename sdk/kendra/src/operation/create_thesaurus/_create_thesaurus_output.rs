...
impl CreateThesaurusOutput {
    ...
    pub fn builder() -> crate::operation::create_thesaurus::builders::CreateThesaurusOutputBuilder {
        crate::operation::create_thesaurus::builders::CreateThesaurusOutputBuilder::default()
    }
}

/// A builder for [`CreateThesaurusOutput`](crate::operation::create_thesaurus::CreateThesaurusOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateThesaurusOutputBuilder {
    pub(crate) id: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl CreateThesaurusOutputBuilder {
    /// <p>The identifier of the thesaurus.</p>
