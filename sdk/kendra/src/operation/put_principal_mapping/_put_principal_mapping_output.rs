...
impl ::aws_types::request_id::RequestId for PutPrincipalMappingOutput {
...
impl PutPrincipalMappingOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutPrincipalMappingOutput`](crate::operation::put_principal_mapping::PutPrincipalMappingOutput).
    pub fn build(self) -> crate::operation::put_principal_mapping::PutPrincipalMappingOutput {
