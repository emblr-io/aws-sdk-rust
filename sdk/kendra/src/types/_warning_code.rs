...
impl ::std::convert::From<&str> for WarningCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WarningCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WarningCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WarningCode::from(s))
    }
}
impl WarningCode {
...
impl ::std::convert::AsRef<str> for WarningCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
