...
impl ::std::convert::From<&str> for IssueSubEntity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IssueSubEntity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IssueSubEntity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IssueSubEntity::from(s))
    }
}
impl IssueSubEntity {
...
impl ::std::convert::AsRef<str> for IssueSubEntity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
