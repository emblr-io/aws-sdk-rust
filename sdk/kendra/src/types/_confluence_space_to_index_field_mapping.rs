...
impl ConfluenceSpaceToIndexFieldMapping {
    /// Creates a new builder-style object to manufacture [`ConfluenceSpaceToIndexFieldMapping`](crate::types::ConfluenceSpaceToIndexFieldMapping).
    pub fn builder() -> crate::types::builders::ConfluenceSpaceToIndexFieldMappingBuilder {
        crate::types::builders::ConfluenceSpaceToIndexFieldMappingBuilder::default()
    }
}
...
impl ConfluenceSpaceToIndexFieldMappingBuilder {
    ...
    /// Consumes the builder and constructs a [`ConfluenceSpaceToIndexFieldMapping`](crate::types::ConfluenceSpaceToIndexFieldMapping).
    pub fn build(self) -> crate::types::ConfluenceSpaceToIndexFieldMapping {
        crate::types::ConfluenceSpaceToIndexFieldMapping {
