...
impl ::std::convert::From<&str> for SlackEntity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlackEntity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlackEntity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlackEntity::from(s))
    }
}
impl SlackEntity {
...
impl ::std::convert::AsRef<str> for SlackEntity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
