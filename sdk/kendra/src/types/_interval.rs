...
impl ::std::convert::From<&str> for Interval {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Interval::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Interval {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Interval::from(s))
    }
}
impl Interval {
...
impl ::std::convert::AsRef<str> for Interval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
