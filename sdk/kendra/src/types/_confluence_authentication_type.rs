...
impl ::std::convert::From<&str> for ConfluenceAuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfluenceAuthenticationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfluenceAuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfluenceAuthenticationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfluenceAuthenticationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
