...
impl ::std::convert::From<&str> for AlfrescoEntity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlfrescoEntity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlfrescoEntity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlfrescoEntity::from(s))
    }
}
impl AlfrescoEntity {
...
impl ::std::convert::AsRef<str> for AlfrescoEntity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
