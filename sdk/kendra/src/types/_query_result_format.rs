...
impl ::std::convert::From<&str> for QueryResultFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => QueryResultFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for QueryResultFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(QueryResultFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for QueryResultFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
