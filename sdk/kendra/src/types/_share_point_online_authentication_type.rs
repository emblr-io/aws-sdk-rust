...
impl ::std::convert::From<&str> for SharePointOnlineAuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SharePointOnlineAuthenticationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SharePointOnlineAuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SharePointOnlineAuthenticationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SharePointOnlineAuthenticationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
