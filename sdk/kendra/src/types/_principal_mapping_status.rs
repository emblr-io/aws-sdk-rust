...
impl ::std::convert::From<&str> for PrincipalMappingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PrincipalMappingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PrincipalMappingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PrincipalMappingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PrincipalMappingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
