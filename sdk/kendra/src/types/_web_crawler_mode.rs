...
impl ::std::convert::From<&str> for WebCrawlerMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WebCrawlerMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WebCrawlerMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WebCrawlerMode::from(s))
    }
}
impl WebCrawlerMode {
...
impl ::std::convert::AsRef<str> for WebCrawlerMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
