...
impl ::std::convert::From<&str> for ThesaurusStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThesaurusStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThesaurusStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThesaurusStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ThesaurusStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
