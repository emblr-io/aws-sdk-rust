...
impl ::std::convert::From<&str> for UserGroupResolutionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UserGroupResolutionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UserGroupResolutionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UserGroupResolutionMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UserGroupResolutionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
