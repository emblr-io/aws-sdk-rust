...
impl ::std::convert::From<&str> for HighlightType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HighlightType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HighlightType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HighlightType::from(s))
    }
}
impl HighlightType {
...
impl ::std::convert::AsRef<str> for HighlightType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
