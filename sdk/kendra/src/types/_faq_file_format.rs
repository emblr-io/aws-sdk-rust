...
impl ::std::convert::From<&str> for FaqFileFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FaqFileFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FaqFileFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FaqFileFormat::from(s))
    }
}
impl FaqFileFormat {
...
impl ::std::convert::AsRef<str> for FaqFileFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
