...
impl ::std::convert::From<&str> for KeyLocation {
    fn from(s: &str) -> Self {
        match s {
            ...
            "URL" => KeyLocation::Url,
            other => KeyLocation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for KeyLocation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KeyLocation::from(s))
    }
}
impl KeyLocation {
...
impl ::std::convert::AsRef<str> for KeyLocation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
