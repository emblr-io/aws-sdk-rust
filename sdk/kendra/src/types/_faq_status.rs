...
impl ::std::convert::From<&str> for FaqStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FaqStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FaqStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FaqStatus::from(s))
    }
}
impl FaqStatus {
...
impl ::std::convert::AsRef<str> for FaqStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
