...
impl ::std::convert::From<&str> for RelevanceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RelevanceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RelevanceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RelevanceType::from(s))
    }
}
impl RelevanceType {
...
impl ::std::convert::AsRef<str> for RelevanceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
