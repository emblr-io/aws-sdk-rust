...
impl ::std::convert::From<&str> for PowerFeedDrop {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PowerFeedDrop::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PowerFeedDrop {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PowerFeedDrop::from(s))
    }
}
impl PowerFeedDrop {
...
impl ::std::convert::AsRef<str> for PowerFeedDrop {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
