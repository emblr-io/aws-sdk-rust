...
impl ::std::convert::From<&str> for SupportedHardwareType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SupportedHardwareType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SupportedHardwareType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SupportedHardwareType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SupportedHardwareType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
