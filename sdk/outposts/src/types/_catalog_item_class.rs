...
impl ::std::convert::From<&str> for CatalogItemClass {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CatalogItemClass::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CatalogItemClass {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CatalogItemClass::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CatalogItemClass {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
