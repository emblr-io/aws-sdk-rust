...
impl ::std::convert::From<&str> for FiberOpticCableType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FiberOpticCableType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FiberOpticCableType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FiberOpticCableType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FiberOpticCableType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FiberOpticCableType {
