...
impl ::std::convert::From<&str> for PowerPhase {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PowerPhase::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PowerPhase {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PowerPhase::from(s))
    }
}
impl PowerPhase {
...
impl ::std::convert::AsRef<str> for PowerPhase {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
