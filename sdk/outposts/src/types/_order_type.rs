...
impl ::std::convert::From<&str> for OrderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderType::from(s))
    }
}
impl OrderType {
...
impl ::std::convert::AsRef<str> for OrderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
