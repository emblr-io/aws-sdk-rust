...
//! offered by AWS Outposts. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Outposts.
...
/// Configuration for AWS Outposts.
pub mod config;
