...
impl ::std::convert::From<&str> for ClientVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientVersion::from(s))
    }
}
impl ClientVersion {
...
impl ::std::convert::AsRef<str> for ClientVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
