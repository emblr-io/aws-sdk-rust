...
//! offered by Amazon CloudHSM. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudHSM.
...
/// Configuration for Amazon CloudHSM.
pub mod config;
