...
impl ::std::convert::From<&str> for ProxyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProxyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProxyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProxyType::from(s))
    }
}
impl ProxyType {
...
impl ::std::convert::AsRef<str> for ProxyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
