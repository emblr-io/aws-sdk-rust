...
impl ::std::convert::From<&str> for RouteActivationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RouteActivationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RouteActivationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RouteActivationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RouteActivationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
