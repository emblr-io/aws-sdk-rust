...
pub struct RemoveGroupMemberInput {
    ...
    /// <p>The <code>SAMAccountName</code> of the user, group, or computer to remove from the group.</p>
...
impl RemoveGroupMemberInput {
    /// Creates a new builder-style object to manufacture [`RemoveGroupMemberInput`](crate::operation::remove_group_member::RemoveGroupMemberInput).
    pub fn builder() -> crate::operation::remove_group_member::builders::RemoveGroupMemberInputBuilder {
        crate::operation::remove_group_member::builders::RemoveGroupMemberInputBuilder::default()
    }
}

/// A builder for [`RemoveGroupMemberInput`](crate::operation::remove_group_member::RemoveGroupMemberInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RemoveGroupMemberInputBuilder {
...
impl RemoveGroupMemberInputBuilder {
    /// <p>The identifier (ID) of the directory that's associated with the member.</p>
    ...
    /// Consumes the builder and constructs a [`RemoveGroupMemberInput`](crate::operation::remove_group_member::RemoveGroupMemberInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::remove_group_member::RemoveGroupMemberInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::remove_group_member::RemoveGroupMemberInput {
