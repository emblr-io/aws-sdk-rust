...
/// <p>A user object that contains identifying information and attributes for a specified user.</p>
#[non_exhaustive]
...
impl UserBuilder {
    ...
    /// - [`sam_account_name`](crate::types::builders::UserBuilder::sam_account_name)
        ...
        ::std::result::Result::Ok(crate::types::User {
            ...
            sam_account_name: self.sam_account_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "sam_account_name",
                    "sam_account_name was not specified but it is required when building User",
                )
            })?,
