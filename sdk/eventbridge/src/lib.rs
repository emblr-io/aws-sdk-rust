...
//! offered by Amazon EventBridge. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon EventBridge.
...
/// Configuration for Amazon EventBridge.
pub mod config;
