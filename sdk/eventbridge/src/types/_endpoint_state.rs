...
impl ::std::convert::From<&str> for EndpointState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndpointState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndpointState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndpointState::from(s))
    }
}
impl EndpointState {
...
impl ::std::convert::AsRef<str> for EndpointState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EndpointState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            EndpointState::CreateFailed => write!(f, "CREATE_FAILED"),
            EndpointState::Creating => write!(f, "CREATING"),
            EndpointState::DeleteFailed => write!(f, "DELETE_FAILED"),
            EndpointState::Deleting => write!(f, "DELETING"),
            EndpointState::UpdateFailed => write!(f, "UPDATE_FAILED"),
            EndpointState::Updating => write!(f, "UPDATING"),
