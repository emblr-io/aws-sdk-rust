...
impl ::std::convert::From<&str> for ConnectionOAuthHttpMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectionOAuthHttpMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectionOAuthHttpMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectionOAuthHttpMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectionOAuthHttpMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
