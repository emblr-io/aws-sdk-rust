...
impl ::std::convert::From<&str> for ConnectionAuthorizationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectionAuthorizationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectionAuthorizationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectionAuthorizationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectionAuthorizationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
