...
pub struct ConnectionAuthResponseParameters {
    ...
    pub connectivity_parameters: ::std::option::Option<crate::types::DescribeConnectionConnectivityParameters>,
}
impl ConnectionAuthResponseParameters {
    ...
    /// <p>For private OAuth authentication endpoints. The parameters EventBridge uses to authenticate against the endpoint.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-target-connection-auth.html">Authorization methods for connections</a> in the <i> <i>Amazon EventBridge User Guide</i> </i>.</p>
    pub fn connectivity_parameters(&self) -> ::std::option::Option<&crate::types::DescribeConnectionConnectivityParameters> {
...
pub struct ConnectionAuthResponseParametersBuilder {
    ...
    pub(crate) connectivity_parameters: ::std::option::Option<crate::types::DescribeConnectionConnectivityParameters>,
}
impl ConnectionAuthResponseParametersBuilder {
    ...
    /// <p>For private OAuth authentication endpoints. The parameters EventBridge uses to authenticate against the endpoint.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-target-connection-auth.html">Authorization methods for connections</a> in the <i> <i>Amazon EventBridge User Guide</i> </i>.</p>
    pub fn connectivity_parameters(mut self, input: crate::types::DescribeConnectionConnectivityParameters) -> Self {
        self.connectivity_parameters = ::std::option::Option::Some(input);
        self
    }
    /// <p>For private OAuth authentication endpoints. The parameters EventBridge uses to authenticate against the endpoint.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-target-connection-auth.html">Authorization methods for connections</a> in the <i> <i>Amazon EventBridge User Guide</i> </i>.</p>
    pub fn set_connectivity_parameters(mut self, input: ::std::option::Option<crate::types::DescribeConnectionConnectivityParameters>) -> Self {
        self.connectivity_parameters = input;
        self
    }
    /// <p>For private OAuth authentication endpoints. The parameters EventBridge uses to authenticate against the endpoint.</p>
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-target-connection-auth.html">Authorization methods for connections</a> in the <i> <i>Amazon EventBridge User Guide</i> </i>.</p>
    pub fn get_connectivity_parameters(&self) -> &::std::option::Option<crate::types::DescribeConnectionConnectivityParameters> {
