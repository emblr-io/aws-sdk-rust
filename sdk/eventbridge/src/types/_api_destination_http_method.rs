...
impl ::std::convert::From<&str> for ApiDestinationHttpMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApiDestinationHttpMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApiDestinationHttpMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApiDestinationHttpMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApiDestinationHttpMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
