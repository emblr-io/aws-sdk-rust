...
impl ::std::convert::From<&str> for StreamMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StreamMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamMode::from(s))
    }
}
impl StreamMode {
...
impl ::std::convert::AsRef<str> for StreamMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
