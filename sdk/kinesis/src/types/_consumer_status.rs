...
impl ::std::convert::From<&str> for ConsumerStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConsumerStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConsumerStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConsumerStatus::from(s))
    }
}
impl ConsumerStatus {
...
impl ::std::convert::AsRef<str> for ConsumerStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
