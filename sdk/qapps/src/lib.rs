...
//! offered by QApps. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`AssociateLibraryItemReview`](crate::operation::associate_library_item_review) operation has
/// a [`Client::associate_library_item_review`], function which returns a builder for that operation.
