...
pub struct DeleteLibraryItemInput {
...
impl DeleteLibraryItemInput {
    /// Creates a new builder-style object to manufacture [`DeleteLibraryItemInput`](crate::operation::delete_library_item::DeleteLibraryItemInput).
    pub fn builder() -> crate::operation::delete_library_item::builders::DeleteLibraryItemInputBuilder {
        crate::operation::delete_library_item::builders::DeleteLibraryItemInputBuilder::default()
    }
}
...
impl DeleteLibraryItemInputBuilder {
    /// <p>The unique identifier of the Amazon Q Business application environment instance.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteLibraryItemInput`](crate::operation::delete_library_item::DeleteLibraryItemInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::delete_library_item::DeleteLibraryItemInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::delete_library_item::DeleteLibraryItemInput {
