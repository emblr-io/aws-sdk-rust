...
pub struct GetQAppOutput {
    ...
    pub app_definition: ::std::option::Option<crate::types::AppDefinition>,
...
impl GetQAppOutput {
    ...
    /// <p>The full definition of the Q App, specifying the cards and flow.</p>
    pub fn app_definition(&self) -> ::std::option::Option<&crate::types::AppDefinition> {
        self.app_definition.as_ref()
    }
}
impl ::aws_types::request_id::RequestId for GetQAppOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetQAppOutput {
    /// Creates a new builder-style object to manufacture [`GetQAppOutput`](crate::operation::get_q_app::GetQAppOutput).
    pub fn builder() -> crate::operation::get_q_app::builders::GetQAppOutputBuilder {
        crate::operation::get_q_app::builders::GetQAppOutputBuilder::default()
    }
}

/// A builder for [`GetQAppOutput`](crate::operation::get_q_app::GetQAppOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetQAppOutputBuilder {
    ...
    pub(crate) app_definition: ::std::option::Option<crate::types::AppDefinition>,
    _request_id: Option<String>,
}
impl GetQAppOutputBuilder {
    ...
    /// <p>The full definition of the Q App, specifying the cards and flow.</p>
    /// This field is required.
    pub fn app_definition(mut self, input: crate::types::AppDefinition) -> Self {
        self.app_definition = ::std::option::Option::Some(input);
        self
    }
    /// <p>The full definition of the Q App, specifying the cards and flow.</p>
    pub fn set_app_definition(mut self, input: ::std::option::Option<crate::types::AppDefinition>) -> Self {
        self.app_definition = input;
        self
    }
    /// <p>The full definition of the Q App, specifying the cards and flow.</p>
    pub fn get_app_definition(&self) -> &::std::option::Option<crate::types::AppDefinition> {
        &self.app_definition
    }
    ...
    /// Consumes the builder and constructs a [`GetQAppOutput`](crate::operation::get_q_app::GetQAppOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`app_id`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::app_id)
    /// - [`app_arn`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::app_arn)
    /// - [`title`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::title)
    /// - [`app_version`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::app_version)
    /// - [`status`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::status)
    /// - [`created_at`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::created_at)
    /// - [`created_by`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::created_by)
    /// - [`updated_at`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::updated_at)
    /// - [`updated_by`](crate::operation::get_q_app::builders::GetQAppOutputBuilder::updated_by)
    pub fn build(self) -> ::std::result::Result<crate::operation::get_q_app::GetQAppOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_q_app::GetQAppOutput {
            app_id: self.app_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "app_id",
                    "app_id was not specified but it is required when building GetQAppOutput",
                )
            })?,
            app_arn: self.app_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "app_arn",
                    "app_arn was not specified but it is required when building GetQAppOutput",
                )
            })?,
            title: self.title.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "title",
                    "title was not specified but it is required when building GetQAppOutput",
                )
            })?,
            ...
            app_version: self.app_version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "app_version",
                    "app_version was not specified but it is required when building GetQAppOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building GetQAppOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building GetQAppOutput",
                )
            })?,
            created_by: self.created_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_by",
                    "created_by was not specified but it is required when building GetQAppOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building GetQAppOutput",
                )
            })?,
            updated_by: self.updated_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_by",
                    "updated_by was not specified but it is required when building GetQAppOutput",
                )
            })?,
