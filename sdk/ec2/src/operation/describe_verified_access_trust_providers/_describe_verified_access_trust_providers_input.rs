...
impl DescribeVerifiedAccessTrustProvidersInput {
    /// <p>The IDs of the Verified Access trust providers.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.verified_access_trust_provider_ids.is_none()`.
    pub fn verified_access_trust_provider_ids(&self) -> &[::std::string::String] {
        self.verified_access_trust_provider_ids.as_deref().unwrap_or_default()
    }
    /// <p>The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p>
