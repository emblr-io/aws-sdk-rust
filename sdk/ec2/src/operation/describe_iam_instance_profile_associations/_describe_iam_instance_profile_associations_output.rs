...
impl DescribeIamInstanceProfileAssociationsOutput {
    /// <p>Information about the IAM instance profile associations.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.iam_instance_profile_associations.is_none()`.
    pub fn iam_instance_profile_associations(&self) -> &[crate::types::IamInstanceProfileAssociation] {
        self.iam_instance_profile_associations.as_deref().unwrap_or_default()
    }
    /// <p>The token to include in another request to get the next page of items. This value is <code>null</code> when there are no more items to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeIamInstanceProfileAssociationsOutput {
...
impl DescribeIamInstanceProfileAssociationsOutputBuilder {
    ...
    pub fn set_iam_instance_profile_associations(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::IamInstanceProfileAssociation>>,
    ) -> Self {
