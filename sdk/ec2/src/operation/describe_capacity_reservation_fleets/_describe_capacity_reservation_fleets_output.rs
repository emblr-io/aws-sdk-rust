...
impl DescribeCapacityReservationFleetsOutput {
    /// <p>Information about the Capacity Reservation Fleets.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.capacity_reservation_fleets.is_none()`.
    pub fn capacity_reservation_fleets(&self) -> &[crate::types::CapacityReservationFleet] {
        self.capacity_reservation_fleets.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeCapacityReservationFleetsOutput {
...
impl DescribeCapacityReservationFleetsOutputBuilder {
    ...
    pub fn capacity_reservation_fleets(mut self, input: crate::types::CapacityReservationFleet) -> Self {
        ...
        v.push(input);
        self.capacity_reservation_fleets = ::std::option::Option::Some(v);
        self
    }
    /// <p>Information about the Capacity Reservation Fleets.</p>
    ...
    /// <p>Information about the Capacity Reservation Fleets.</p>
    pub fn get_capacity_reservation_fleets(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::CapacityReservationFleet>> {
