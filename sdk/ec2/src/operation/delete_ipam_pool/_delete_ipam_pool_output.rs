...
impl ::aws_types::request_id::RequestId for DeleteIpamPoolOutput {
...
impl DeleteIpamPoolOutputBuilder {
    ...
    pub fn ipam_pool(mut self, input: crate::types::IpamPool) -> Self {
        self.ipam_pool = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the results of the deletion.</p>
    ...
    /// <p>Information about the results of the deletion.</p>
    pub fn get_ipam_pool(&self) -> &::std::option::Option<crate::types::IpamPool> {
        &self.ipam_pool
    }
