...
impl ::aws_types::request_id::RequestId for EnableVpcClassicLinkOutput {
...
impl EnableVpcClassicLinkOutputBuilder {
    /// <p>Returns <code>true</code> if the request succeeds; otherwise, it returns an error.</p>
    ...
    /// Consumes the builder and constructs a [`EnableVpcClassicLinkOutput`](crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkOutput).
    pub fn build(self) -> crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkOutput {
