...
pub struct DescribeTransitGatewayConnectPeersInput {
    ...
    /// <ul>
    /// <li>
    /// <p><code>state</code> - The state of the Connect peer (<code>pending</code> | <code>available</code> | <code>deleting</code> | <code>deleted</code>).</p></li>
    /// <li>
    /// <p><code>transit-gateway-attachment-id</code> - The ID of the attachment.</p></li>
    /// <li>
    /// <p><code>transit-gateway-connect-peer-id</code> - The ID of the Connect peer.</p></li>
    /// </ul>
