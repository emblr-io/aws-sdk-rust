...
impl EnableImageOutput {
    /// Creates a new builder-style object to manufacture [`EnableImageOutput`](crate::operation::enable_image::EnableImageOutput).
    pub fn builder() -> crate::operation::enable_image::builders::EnableImageOutputBuilder {
        crate::operation::enable_image::builders::EnableImageOutputBuilder::default()
    }
}
...
impl EnableImageOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`EnableImageOutput`](crate::operation::enable_image::EnableImageOutput).
    pub fn build(self) -> crate::operation::enable_image::EnableImageOutput {
