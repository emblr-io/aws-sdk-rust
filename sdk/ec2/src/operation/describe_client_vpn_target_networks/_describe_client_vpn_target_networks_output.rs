...
impl DescribeClientVpnTargetNetworksOutput {
    ...
    pub fn client_vpn_target_networks(&self) -> &[crate::types::TargetNetwork] {
        self.client_vpn_target_networks.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeClientVpnTargetNetworksOutput {
...
impl DescribeClientVpnTargetNetworksOutputBuilder {
    ...
    pub fn client_vpn_target_networks(mut self, input: crate::types::TargetNetwork) -> Self {
        ...
        v.push(input);
        self.client_vpn_target_networks = ::std::option::Option::Some(v);
        self
    }
    /// <p>Information about the associated target networks.</p>
