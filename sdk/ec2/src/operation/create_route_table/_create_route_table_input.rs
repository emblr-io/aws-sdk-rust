...
impl CreateRouteTableInput {
    /// Creates a new builder-style object to manufacture [`CreateRouteTableInput`](crate::operation::create_route_table::CreateRouteTableInput).
    pub fn builder() -> crate::operation::create_route_table::builders::CreateRouteTableInputBuilder {
        crate::operation::create_route_table::builders::CreateRouteTableInputBuilder::default()
    }
}
