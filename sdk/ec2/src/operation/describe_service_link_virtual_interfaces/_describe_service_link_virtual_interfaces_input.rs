...
pub struct DescribeServiceLinkVirtualInterfacesInput {
    ...
    /// <ul>
    /// <li>
    /// <p><code>outpost-lag-id</code> - The ID of the Outpost LAG.</p></li>
    /// <li>
    ...
    /// <li>
    /// <p><code>state</code> - The state of the Outpost LAG.</p></li>
    /// <li>
    ...
    /// <li>
    /// <p><code>local-gateway-virtual-interface-id</code> - The ID of the local gateway virtual interface.</p></li>
    /// </ul>
...
#[non_exhaustive]
pub struct DescribeServiceLinkVirtualInterfacesInputBuilder {
...
impl DescribeServiceLinkVirtualInterfacesInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeServiceLinkVirtualInterfacesInput`](crate::operation::describe_service_link_virtual_interfaces::DescribeServiceLinkVirtualInterfacesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_service_link_virtual_interfaces::DescribeServiceLinkVirtualInterfacesInput,
