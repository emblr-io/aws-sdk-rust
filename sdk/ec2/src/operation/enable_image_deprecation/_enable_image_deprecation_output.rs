...
impl ::aws_types::request_id::RequestId for EnableImageDeprecationOutput {
...
impl EnableImageDeprecationOutputBuilder {
    /// <p>Returns <code>true</code> if the request succeeds; otherwise, it returns an error.</p>
    ...
    /// Consumes the builder and constructs a [`EnableImageDeprecationOutput`](crate::operation::enable_image_deprecation::EnableImageDeprecationOutput).
    pub fn build(self) -> crate::operation::enable_image_deprecation::EnableImageDeprecationOutput {
