...
pub struct DescribeClientVpnConnectionsInput {
    ...
    /// <ul>
    /// <li>
    /// <p><code>connection-id</code> - The ID of the connection.</p></li>
    /// <li>
    /// <p><code>username</code> - For Active Directory client authentication, the user name of the client who established the client connection.</p></li>
    /// </ul>
...
impl DescribeClientVpnConnectionsInputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::describe_client_vpn_connections::DescribeClientVpnConnectionsInput {
