...
pub struct DescribeCapacityBlockExtensionOfferingsInput {
...
#[non_exhaustive]
pub struct DescribeCapacityBlockExtensionOfferingsInputBuilder {
...
impl DescribeCapacityBlockExtensionOfferingsInputBuilder {
    /// <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeCapacityBlockExtensionOfferingsInput`](crate::operation::describe_capacity_block_extension_offerings::DescribeCapacityBlockExtensionOfferingsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_capacity_block_extension_offerings::DescribeCapacityBlockExtensionOfferingsInput,
