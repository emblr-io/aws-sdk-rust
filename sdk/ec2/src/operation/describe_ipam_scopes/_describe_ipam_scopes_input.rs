...
impl DescribeIpamScopesInput {
    ...
    pub fn ipam_scope_ids(&self) -> &[::std::string::String] {
        self.ipam_scope_ids.as_deref().unwrap_or_default()
    }
}
impl DescribeIpamScopesInput {
...
impl DescribeIpamScopesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::describe_ipam_scopes::DescribeIpamScopesInput, ::aws_smithy_types::error::operation::BuildError>
    {
