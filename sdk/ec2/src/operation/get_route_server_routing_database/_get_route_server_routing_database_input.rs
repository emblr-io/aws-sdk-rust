...
pub struct GetRouteServerRoutingDatabaseInput {
...
#[non_exhaustive]
pub struct GetRouteServerRoutingDatabaseInputBuilder {
...
impl GetRouteServerRoutingDatabaseInputBuilder {
    /// <p>The ID of the route server for which to get the routing database.</p>
    ...
    /// Consumes the builder and constructs a [`GetRouteServerRoutingDatabaseInput`](crate::operation::get_route_server_routing_database::GetRouteServerRoutingDatabaseInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::get_route_server_routing_database::GetRouteServerRoutingDatabaseInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::get_route_server_routing_database::GetRouteServerRoutingDatabaseInput {
