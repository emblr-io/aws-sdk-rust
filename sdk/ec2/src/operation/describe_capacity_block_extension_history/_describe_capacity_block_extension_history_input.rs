...
pub struct DescribeCapacityBlockExtensionHistoryInput {
...
#[non_exhaustive]
pub struct DescribeCapacityBlockExtensionHistoryInputBuilder {
...
impl DescribeCapacityBlockExtensionHistoryInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeCapacityBlockExtensionHistoryInput`](crate::operation::describe_capacity_block_extension_history::DescribeCapacityBlockExtensionHistoryInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_capacity_block_extension_history::DescribeCapacityBlockExtensionHistoryInput,
