...
impl ReportInstanceStatusOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ReportInstanceStatusOutput`](crate::operation::report_instance_status::ReportInstanceStatusOutput).
    pub fn build(self) -> crate::operation::report_instance_status::ReportInstanceStatusOutput {
