...
pub struct EnableRouteServerPropagationInput {
...
impl EnableRouteServerPropagationInput {
    /// <p>The ID of the route server for which to enable propagation.</p>
...
impl EnableRouteServerPropagationInput {
    /// Creates a new builder-style object to manufacture [`EnableRouteServerPropagationInput`](crate::operation::enable_route_server_propagation::EnableRouteServerPropagationInput).
    pub fn builder() -> crate::operation::enable_route_server_propagation::builders::EnableRouteServerPropagationInputBuilder {
        crate::operation::enable_route_server_propagation::builders::EnableRouteServerPropagationInputBuilder::default()
    }
}

/// A builder for [`EnableRouteServerPropagationInput`](crate::operation::enable_route_server_propagation::EnableRouteServerPropagationInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct EnableRouteServerPropagationInputBuilder {
...
impl EnableRouteServerPropagationInputBuilder {
    /// <p>The ID of the route server for which to enable propagation.</p>
    ...
    /// Consumes the builder and constructs a [`EnableRouteServerPropagationInput`](crate::operation::enable_route_server_propagation::EnableRouteServerPropagationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::enable_route_server_propagation::EnableRouteServerPropagationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::enable_route_server_propagation::EnableRouteServerPropagationInput {
