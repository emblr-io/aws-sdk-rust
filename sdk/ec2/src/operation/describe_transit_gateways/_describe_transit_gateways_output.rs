...
impl DescribeTransitGatewaysOutput {
    /// <p>Information about the transit gateways.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.transit_gateways.is_none()`.
    pub fn transit_gateways(&self) -> &[crate::types::TransitGateway] {
        self.transit_gateways.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeTransitGatewaysOutput {
...
impl DescribeTransitGatewaysOutputBuilder {
    ...
    pub fn transit_gateways(mut self, input: crate::types::TransitGateway) -> Self {
        ...
        v.push(input);
        self.transit_gateways = ::std::option::Option::Some(v);
        self
    }
    /// <p>Information about the transit gateways.</p>
