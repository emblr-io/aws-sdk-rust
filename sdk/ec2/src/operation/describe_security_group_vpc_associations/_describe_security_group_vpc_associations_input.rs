...
pub struct DescribeSecurityGroupVpcAssociationsInput {
...
#[non_exhaustive]
pub struct DescribeSecurityGroupVpcAssociationsInputBuilder {
    pub(crate) filters: ::std::option::Option<::std::vec::Vec<crate::types::Filter>>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    pub(crate) max_results: ::std::option::Option<i32>,
    pub(crate) dry_run: ::std::option::Option<bool>,
}
impl DescribeSecurityGroupVpcAssociationsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeSecurityGroupVpcAssociationsInput`](crate::operation::describe_security_group_vpc_associations::DescribeSecurityGroupVpcAssociationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_security_group_vpc_associations::DescribeSecurityGroupVpcAssociationsInput,
