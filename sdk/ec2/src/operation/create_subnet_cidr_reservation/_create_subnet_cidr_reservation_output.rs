...
pub struct CreateSubnetCidrReservationOutput {
    ...
    pub subnet_cidr_reservation: ::std::option::Option<crate::types::SubnetCidrReservation>,
...
impl ::aws_types::request_id::RequestId for CreateSubnetCidrReservationOutput {
...
impl CreateSubnetCidrReservationOutputBuilder {
    /// <p>Information about the created subnet CIDR reservation.</p>
    pub fn subnet_cidr_reservation(mut self, input: crate::types::SubnetCidrReservation) -> Self {
        self.subnet_cidr_reservation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the created subnet CIDR reservation.</p>
