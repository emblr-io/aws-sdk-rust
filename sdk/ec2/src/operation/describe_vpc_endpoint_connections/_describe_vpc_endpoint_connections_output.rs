...
impl DescribeVpcEndpointConnectionsOutput {
    /// <p>Information about the VPC endpoint connections.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.vpc_endpoint_connections.is_none()`.
    pub fn vpc_endpoint_connections(&self) -> &[crate::types::VpcEndpointConnection] {
        self.vpc_endpoint_connections.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeVpcEndpointConnectionsOutput {
...
impl DescribeVpcEndpointConnectionsOutputBuilder {
    ...
    pub fn vpc_endpoint_connections(mut self, input: crate::types::VpcEndpointConnection) -> Self {
        ...
        v.push(input);
        self.vpc_endpoint_connections = ::std::option::Option::Some(v);
        self
    }
    /// <p>Information about the VPC endpoint connections.</p>
