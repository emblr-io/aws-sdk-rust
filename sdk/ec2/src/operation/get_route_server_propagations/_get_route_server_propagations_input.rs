...
pub struct GetRouteServerPropagationsInput {
...
#[non_exhaustive]
pub struct GetRouteServerPropagationsInputBuilder {
...
impl GetRouteServerPropagationsInputBuilder {
    /// <p>The ID of the route server for which to get propagation information.</p>
    ...
    /// Consumes the builder and constructs a [`GetRouteServerPropagationsInput`](crate::operation::get_route_server_propagations::GetRouteServerPropagationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::get_route_server_propagations::GetRouteServerPropagationsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::get_route_server_propagations::GetRouteServerPropagationsInput {
