...
impl DescribeLocalGatewayRouteTableVpcAssociationsOutput {
    /// <p>Information about the associations.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.local_gateway_route_table_vpc_associations.is_none()`.
    pub fn local_gateway_route_table_vpc_associations(&self) -> &[crate::types::LocalGatewayRouteTableVpcAssociation] {
        self.local_gateway_route_table_vpc_associations.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ::aws_types::request_id::RequestId for DescribeLocalGatewayRouteTableVpcAssociationsOutput {
