...
impl ::aws_types::request_id::RequestId for DeleteLocalGatewayRouteTableVpcAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteLocalGatewayRouteTableVpcAssociationOutput {
    /// Creates a new builder-style object to manufacture [`DeleteLocalGatewayRouteTableVpcAssociationOutput`](crate::operation::delete_local_gateway_route_table_vpc_association::DeleteLocalGatewayRouteTableVpcAssociationOutput).
    pub fn builder(
        ...
        crate::operation::delete_local_gateway_route_table_vpc_association::builders::DeleteLocalGatewayRouteTableVpcAssociationOutputBuilder::default(
        )
    }
}
...
impl DeleteLocalGatewayRouteTableVpcAssociationOutputBuilder {
    /// <p>Information about the association.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteLocalGatewayRouteTableVpcAssociationOutput`](crate::operation::delete_local_gateway_route_table_vpc_association::DeleteLocalGatewayRouteTableVpcAssociationOutput).
    pub fn build(self) -> crate::operation::delete_local_gateway_route_table_vpc_association::DeleteLocalGatewayRouteTableVpcAssociationOutput {
