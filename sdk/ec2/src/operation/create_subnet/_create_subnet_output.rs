...
impl ::aws_types::request_id::RequestId for CreateSubnetOutput {
...
impl CreateSubnetOutput {
    ...
    pub fn builder() -> crate::operation::create_subnet::builders::CreateSubnetOutputBuilder {
        crate::operation::create_subnet::builders::CreateSubnetOutputBuilder::default()
    }
}

/// A builder for [`CreateSubnetOutput`](crate::operation::create_subnet::CreateSubnetOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateSubnetOutputBuilder {
    pub(crate) subnet: ::std::option::Option<crate::types::Subnet>,
    _request_id: Option<String>,
}
impl CreateSubnetOutputBuilder {
    /// <p>Information about the subnet.</p>
    ...
    /// <p>Information about the subnet.</p>
    pub fn get_subnet(&self) -> &::std::option::Option<crate::types::Subnet> {
        &self.subnet
    }
