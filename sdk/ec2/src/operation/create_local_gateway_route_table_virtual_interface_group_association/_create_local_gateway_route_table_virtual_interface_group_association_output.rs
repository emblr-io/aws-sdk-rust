...
impl ::aws_types::request_id::RequestId for CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput {
    /// Creates a new builder-style object to manufacture [`CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput`](crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput).
    pub fn builder() -> crate::operation::create_local_gateway_route_table_virtual_interface_group_association::builders::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutputBuilder{
        crate::operation::create_local_gateway_route_table_virtual_interface_group_association::builders::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutputBuilder::default()
    }
}
...
impl CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutputBuilder {
    /// <p>Information about the local gateway route table virtual interface group association.</p>
    pub fn local_gateway_route_table_virtual_interface_group_association(
        mut self,
    ...
    /// Consumes the builder and constructs a [`CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput`](crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput).
    pub fn build(self) -> crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput{
