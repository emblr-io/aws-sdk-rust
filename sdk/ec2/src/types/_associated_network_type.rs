...
impl ::std::convert::From<&str> for AssociatedNetworkType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssociatedNetworkType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssociatedNetworkType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssociatedNetworkType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssociatedNetworkType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
