...
impl ::std::convert::From<&str> for FastLaunchResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FastLaunchResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FastLaunchResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FastLaunchResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FastLaunchResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FastLaunchResourceType {
