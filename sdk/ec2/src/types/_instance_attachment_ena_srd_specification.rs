...
pub struct InstanceAttachmentEnaSrdSpecification {
    /// <p>Indicates whether ENA Express is enabled for the network interface.</p>
    pub ena_srd_enabled: ::std::option::Option<bool>,
    /// <p>Configures ENA Express for UDP network traffic.</p>
    pub ena_srd_udp_specification: ::std::option::Option<crate::types::InstanceAttachmentEnaSrdUdpSpecification>,
}
impl InstanceAttachmentEnaSrdSpecification {
    ...
    /// <p>Configures ENA Express for UDP network traffic.</p>
    pub fn ena_srd_udp_specification(&self) -> ::std::option::Option<&crate::types::InstanceAttachmentEnaSrdUdpSpecification> {
...
impl InstanceAttachmentEnaSrdSpecificationBuilder {
    /// <p>Indicates whether ENA Express is enabled for the network interface.</p>
    ...
    /// <p>Configures ENA Express for UDP network traffic.</p>
    pub fn ena_srd_udp_specification(mut self, input: crate::types::InstanceAttachmentEnaSrdUdpSpecification) -> Self {
        self.ena_srd_udp_specification = ::std::option::Option::Some(input);
        self
    }
    /// <p>Configures ENA Express for UDP network traffic.</p>
    pub fn set_ena_srd_udp_specification(mut self, input: ::std::option::Option<crate::types::InstanceAttachmentEnaSrdUdpSpecification>) -> Self {
        self.ena_srd_udp_specification = input;
        self
    }
    /// <p>Configures ENA Express for UDP network traffic.</p>
    pub fn get_ena_srd_udp_specification(&self) -> &::std::option::Option<crate::types::InstanceAttachmentEnaSrdUdpSpecification> {
        &self.ena_srd_udp_specification
    }
    /// Consumes the builder and constructs a [`InstanceAttachmentEnaSrdSpecification`](crate::types::InstanceAttachmentEnaSrdSpecification).
    pub fn build(self) -> crate::types::InstanceAttachmentEnaSrdSpecification {
        crate::types::InstanceAttachmentEnaSrdSpecification {
