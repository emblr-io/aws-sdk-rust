...
impl ::std::convert::From<&str> for LaunchTemplateHttpTokensState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LaunchTemplateHttpTokensState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LaunchTemplateHttpTokensState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchTemplateHttpTokensState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchTemplateHttpTokensState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
