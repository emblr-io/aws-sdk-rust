...
impl ::std::convert::From<&str> for ClientVpnAuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientVpnAuthenticationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientVpnAuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientVpnAuthenticationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientVpnAuthenticationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
