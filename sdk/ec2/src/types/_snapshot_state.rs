...
impl ::std::convert::From<&str> for SnapshotState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnapshotState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnapshotState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnapshotState::from(s))
    }
}
impl SnapshotState {
...
impl ::std::convert::AsRef<str> for SnapshotState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
