...
impl ::std::convert::From<&str> for InstanceTypeHypervisor {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceTypeHypervisor::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceTypeHypervisor {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceTypeHypervisor::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceTypeHypervisor {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
