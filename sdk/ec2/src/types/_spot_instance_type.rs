...
impl ::std::convert::From<&str> for SpotInstanceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpotInstanceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpotInstanceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpotInstanceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SpotInstanceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
