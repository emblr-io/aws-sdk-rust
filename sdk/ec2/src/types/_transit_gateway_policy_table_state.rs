...
impl ::std::convert::From<&str> for TransitGatewayPolicyTableState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayPolicyTableState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayPolicyTableState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayPolicyTableState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayPolicyTableState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
