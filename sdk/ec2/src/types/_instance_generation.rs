...
impl ::std::convert::From<&str> for InstanceGeneration {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceGeneration::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceGeneration {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceGeneration::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceGeneration {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
