...
impl ::std::convert::From<&str> for IpamPoolCidrState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamPoolCidrState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamPoolCidrState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamPoolCidrState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IpamPoolCidrState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
