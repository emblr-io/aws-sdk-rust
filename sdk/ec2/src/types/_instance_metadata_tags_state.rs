...
impl ::std::convert::From<&str> for InstanceMetadataTagsState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceMetadataTagsState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceMetadataTagsState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceMetadataTagsState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceMetadataTagsState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
