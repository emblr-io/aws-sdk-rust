...
impl ::std::convert::From<&str> for LockState {
    fn from(s: &str) -> Self {
        match s {
            ...
            "compliance-cooloff" => LockState::ComplianceCooloff,
            "expired" => LockState::Expired,
            "governance" => LockState::Governance,
            other => LockState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LockState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LockState::from(s))
    }
}
impl LockState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            LockState::ComplianceCooloff => "compliance-cooloff",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["compliance", "compliance-cooloff", "expired", "governance"]
    }
}
impl ::std::convert::AsRef<str> for LockState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
