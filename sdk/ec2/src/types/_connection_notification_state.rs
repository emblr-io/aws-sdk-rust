...
impl ::std::convert::From<&str> for ConnectionNotificationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectionNotificationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectionNotificationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectionNotificationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectionNotificationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
