...
impl ::std::convert::From<&str> for VpnState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpnState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpnState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpnState::from(s))
    }
}
impl VpnState {
...
impl ::std::convert::AsRef<str> for VpnState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
