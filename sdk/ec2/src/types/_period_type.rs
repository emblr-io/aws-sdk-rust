...
impl ::std::convert::From<&str> for PeriodType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PeriodType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PeriodType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PeriodType::from(s))
    }
}
impl PeriodType {
...
impl ::std::convert::AsRef<str> for PeriodType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
