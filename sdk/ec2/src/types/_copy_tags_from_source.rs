...
impl ::std::convert::From<&str> for CopyTagsFromSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CopyTagsFromSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CopyTagsFromSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CopyTagsFromSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CopyTagsFromSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CopyTagsFromSource {
