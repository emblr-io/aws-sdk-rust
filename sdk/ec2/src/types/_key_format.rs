...
impl ::std::convert::From<&str> for KeyFormat {
    fn from(s: &str) -> Self {
        match s {
            "pem" => KeyFormat::Pem,
            "ppk" => KeyFormat::Ppk,
            other => KeyFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for KeyFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KeyFormat::from(s))
    }
}
impl KeyFormat {
...
impl ::std::convert::AsRef<str> for KeyFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
