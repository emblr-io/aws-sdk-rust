...
impl ::std::convert::From<&str> for ReplaceRootVolumeTaskState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplaceRootVolumeTaskState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplaceRootVolumeTaskState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplaceRootVolumeTaskState::from(s))
    }
}
