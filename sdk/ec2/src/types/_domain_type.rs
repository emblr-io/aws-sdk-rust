...
impl ::std::convert::From<&str> for DomainType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "vpc" => DomainType::Vpc,
            other => DomainType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DomainType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DomainType::from(s))
    }
}
impl DomainType {
...
impl ::std::convert::AsRef<str> for DomainType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
