...
impl ::std::convert::From<&str> for PrefixListState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PrefixListState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PrefixListState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PrefixListState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PrefixListState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
