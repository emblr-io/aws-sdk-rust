...
impl ::std::convert::From<&str> for AllocationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AllocationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AllocationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllocationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AllocationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
