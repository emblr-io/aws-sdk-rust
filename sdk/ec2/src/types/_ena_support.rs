...
impl ::std::convert::From<&str> for EnaSupport {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnaSupport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnaSupport {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnaSupport::from(s))
    }
}
impl EnaSupport {
...
impl ::std::convert::AsRef<str> for EnaSupport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
