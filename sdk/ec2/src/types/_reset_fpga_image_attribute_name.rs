...
impl ::std::convert::From<&str> for ResetFpgaImageAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResetFpgaImageAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResetFpgaImageAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResetFpgaImageAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResetFpgaImageAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ResetFpgaImageAttributeName {
