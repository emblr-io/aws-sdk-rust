...
impl ::std::convert::From<&str> for TrafficMirrorNetworkService {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficMirrorNetworkService::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficMirrorNetworkService {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficMirrorNetworkService::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficMirrorNetworkService {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TrafficMirrorNetworkService {
