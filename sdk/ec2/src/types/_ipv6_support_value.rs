...
impl ::std::convert::From<&str> for Ipv6SupportValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Ipv6SupportValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Ipv6SupportValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Ipv6SupportValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Ipv6SupportValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
