...
impl ::std::convert::From<&str> for ServiceConnectivityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServiceConnectivityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServiceConnectivityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServiceConnectivityType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServiceConnectivityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
