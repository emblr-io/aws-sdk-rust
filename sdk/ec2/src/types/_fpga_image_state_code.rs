...
impl ::std::convert::From<&str> for FpgaImageStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FpgaImageStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FpgaImageStateCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FpgaImageStateCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FpgaImageStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
