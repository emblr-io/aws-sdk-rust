...
impl ::std::convert::From<&str> for NatGatewayState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NatGatewayState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NatGatewayState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NatGatewayState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NatGatewayState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
