...
impl ::std::convert::From<&str> for Affinity {
    fn from(s: &str) -> Self {
        match s {
            ...
            "host" => Affinity::Host,
            other => Affinity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Affinity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Affinity::from(s))
    }
}
impl Affinity {
...
impl ::std::convert::AsRef<str> for Affinity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
