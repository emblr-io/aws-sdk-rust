...
impl ::std::convert::From<&str> for HostRecovery {
    fn from(s: &str) -> Self {
        match s {
            ...
            "on" => HostRecovery::On,
            other => HostRecovery::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HostRecovery {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HostRecovery::from(s))
    }
}
impl HostRecovery {
...
impl ::std::convert::AsRef<str> for HostRecovery {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
