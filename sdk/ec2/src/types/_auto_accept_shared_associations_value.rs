...
impl ::std::convert::From<&str> for AutoAcceptSharedAssociationsValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoAcceptSharedAssociationsValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoAcceptSharedAssociationsValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoAcceptSharedAssociationsValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoAcceptSharedAssociationsValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
