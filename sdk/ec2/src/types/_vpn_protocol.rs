...
impl ::std::convert::From<&str> for VpnProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpnProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpnProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpnProtocol::from(s))
    }
}
impl VpnProtocol {
...
impl ::std::convert::AsRef<str> for VpnProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
