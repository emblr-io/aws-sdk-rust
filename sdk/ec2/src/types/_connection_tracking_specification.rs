...
impl ConnectionTrackingSpecificationBuilder {
    /// <p>Timeout (in seconds) for idle TCP connections in an established state. Min: 60 seconds. Max: 432000 seconds (5 days). Default: 432000 seconds. Recommended: Less than 432000 seconds.</p>
    ...
    /// Consumes the builder and constructs a [`ConnectionTrackingSpecification`](crate::types::ConnectionTrackingSpecification).
    pub fn build(self) -> crate::types::ConnectionTrackingSpecification {
        crate::types::ConnectionTrackingSpecification {
