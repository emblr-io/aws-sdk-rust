...
impl ::std::convert::From<&str> for DiskImageFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DiskImageFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DiskImageFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DiskImageFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DiskImageFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
