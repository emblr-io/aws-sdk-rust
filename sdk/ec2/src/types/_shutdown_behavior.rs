...
impl ::std::convert::From<&str> for ShutdownBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ShutdownBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShutdownBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShutdownBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ShutdownBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
