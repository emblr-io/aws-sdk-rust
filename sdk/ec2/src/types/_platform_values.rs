...
impl ::std::convert::From<&str> for PlatformValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlatformValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlatformValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlatformValues::from(s))
    }
}
impl PlatformValues {
...
impl ::std::convert::AsRef<str> for PlatformValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PlatformValues {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            PlatformValues::Windows => write!(f, "Windows"),
            PlatformValues::Unknown(value) => write!(f, "{}", value),
        }
    }
}
