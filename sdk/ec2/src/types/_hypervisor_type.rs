...
impl ::std::convert::From<&str> for HypervisorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HypervisorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HypervisorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HypervisorType::from(s))
    }
}
impl HypervisorType {
...
impl ::std::convert::AsRef<str> for HypervisorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
