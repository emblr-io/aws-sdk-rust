...
impl ::std::convert::From<&str> for DefaultRouteTableAssociationValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DefaultRouteTableAssociationValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DefaultRouteTableAssociationValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DefaultRouteTableAssociationValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DefaultRouteTableAssociationValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
