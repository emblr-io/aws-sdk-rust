...
impl ::std::convert::From<&str> for IpamOverlapStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamOverlapStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamOverlapStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamOverlapStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IpamOverlapStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
