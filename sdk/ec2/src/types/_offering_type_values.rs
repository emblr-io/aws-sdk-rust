...
impl ::std::convert::From<&str> for OfferingTypeValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OfferingTypeValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OfferingTypeValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OfferingTypeValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OfferingTypeValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
