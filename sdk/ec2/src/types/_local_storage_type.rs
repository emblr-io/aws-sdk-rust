...
impl ::std::convert::From<&str> for LocalStorageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocalStorageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocalStorageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocalStorageType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocalStorageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
