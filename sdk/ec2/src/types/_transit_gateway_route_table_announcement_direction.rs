...
impl ::std::convert::From<&str> for TransitGatewayRouteTableAnnouncementDirection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                TransitGatewayRouteTableAnnouncementDirection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for TransitGatewayRouteTableAnnouncementDirection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayRouteTableAnnouncementDirection::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayRouteTableAnnouncementDirection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
