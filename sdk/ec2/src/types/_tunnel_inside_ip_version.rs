...
impl ::std::convert::From<&str> for TunnelInsideIpVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TunnelInsideIpVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TunnelInsideIpVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TunnelInsideIpVersion::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TunnelInsideIpVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
