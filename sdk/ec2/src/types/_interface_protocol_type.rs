...
impl ::std::convert::From<&str> for InterfaceProtocolType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InterfaceProtocolType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InterfaceProtocolType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InterfaceProtocolType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InterfaceProtocolType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
