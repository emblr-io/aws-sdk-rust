...
impl ::std::convert::From<&str> for UnsuccessfulInstanceCreditSpecificationErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnsuccessfulInstanceCreditSpecificationErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::str::FromStr for UnsuccessfulInstanceCreditSpecificationErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnsuccessfulInstanceCreditSpecificationErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UnsuccessfulInstanceCreditSpecificationErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
