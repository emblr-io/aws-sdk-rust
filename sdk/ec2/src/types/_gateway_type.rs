...
impl ::std::convert::From<&str> for GatewayType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GatewayType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GatewayType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GatewayType::from(s))
    }
}
impl GatewayType {
...
impl ::std::convert::AsRef<str> for GatewayType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
