...
impl ::std::convert::From<&str> for TrafficMirrorSessionField {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficMirrorSessionField::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficMirrorSessionField {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficMirrorSessionField::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficMirrorSessionField {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
