...
impl ::std::convert::From<&str> for TransitGatewayPrefixListReferenceState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayPrefixListReferenceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayPrefixListReferenceState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayPrefixListReferenceState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayPrefixListReferenceState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
