...
impl ::std::convert::From<&str> for SpreadLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpreadLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpreadLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpreadLevel::from(s))
    }
}
impl SpreadLevel {
...
impl ::std::convert::AsRef<str> for SpreadLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
