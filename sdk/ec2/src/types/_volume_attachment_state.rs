...
impl ::std::convert::From<&str> for VolumeAttachmentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VolumeAttachmentState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VolumeAttachmentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VolumeAttachmentState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VolumeAttachmentState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
