...
impl ::std::convert::From<&str> for CurrencyCodeValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CurrencyCodeValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CurrencyCodeValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CurrencyCodeValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CurrencyCodeValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CurrencyCodeValues {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            CurrencyCodeValues::Usd => write!(f, "USD"),
            CurrencyCodeValues::Unknown(value) => write!(f, "{}", value),
        }
    }
}
