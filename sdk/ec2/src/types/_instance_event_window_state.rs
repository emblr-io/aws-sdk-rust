...
impl ::std::convert::From<&str> for InstanceEventWindowState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceEventWindowState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceEventWindowState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceEventWindowState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceEventWindowState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
