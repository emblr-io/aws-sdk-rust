...
impl ::std::convert::From<&str> for DestinationFileFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DestinationFileFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DestinationFileFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DestinationFileFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DestinationFileFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
