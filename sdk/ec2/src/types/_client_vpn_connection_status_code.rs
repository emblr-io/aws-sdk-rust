...
impl ::std::convert::From<&str> for ClientVpnConnectionStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientVpnConnectionStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientVpnConnectionStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientVpnConnectionStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientVpnConnectionStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
