...
impl ::std::convert::From<&str> for SpotInstanceInterruptionBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpotInstanceInterruptionBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpotInstanceInterruptionBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpotInstanceInterruptionBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SpotInstanceInterruptionBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
