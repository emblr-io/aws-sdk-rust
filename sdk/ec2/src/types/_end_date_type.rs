...
impl ::std::convert::From<&str> for EndDateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndDateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndDateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndDateType::from(s))
    }
}
impl EndDateType {
...
impl ::std::convert::AsRef<str> for EndDateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
