...
impl ::std::convert::From<&str> for MoveStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MoveStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MoveStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MoveStatus::from(s))
    }
}
impl MoveStatus {
...
impl ::std::convert::AsRef<str> for MoveStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
