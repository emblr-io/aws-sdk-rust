...
impl DescribeFastSnapshotRestoreSuccessItem {
    /// Creates a new builder-style object to manufacture [`DescribeFastSnapshotRestoreSuccessItem`](crate::types::DescribeFastSnapshotRestoreSuccessItem).
    pub fn builder() -> crate::types::builders::DescribeFastSnapshotRestoreSuccessItemBuilder {
        crate::types::builders::DescribeFastSnapshotRestoreSuccessItemBuilder::default()
    }
}
...
impl DescribeFastSnapshotRestoreSuccessItemBuilder {
    /// <p>The ID of the snapshot.</p>
