...
impl ::std::convert::From<&str> for ElasticGpuStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElasticGpuStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ElasticGpuStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ElasticGpuStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ElasticGpuStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
