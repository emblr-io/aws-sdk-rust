...
impl ::std::convert::From<&str> for LocalGatewayRouteType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocalGatewayRouteType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocalGatewayRouteType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocalGatewayRouteType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocalGatewayRouteType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LocalGatewayRouteType {
