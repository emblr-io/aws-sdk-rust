...
impl ::std::convert::From<&str> for TransitGatewayConnectPeerState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayConnectPeerState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayConnectPeerState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayConnectPeerState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayConnectPeerState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
