...
impl ::std::convert::From<&str> for AllowsMultipleInstanceTypes {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AllowsMultipleInstanceTypes::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AllowsMultipleInstanceTypes {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllowsMultipleInstanceTypes::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AllowsMultipleInstanceTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
