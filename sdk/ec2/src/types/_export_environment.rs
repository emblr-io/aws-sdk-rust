...
impl ::std::convert::From<&str> for ExportEnvironment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportEnvironment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportEnvironment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportEnvironment::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExportEnvironment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
