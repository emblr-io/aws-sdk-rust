...
impl ::std::convert::From<&str> for ListingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListingStatus::from(s))
    }
}
impl ListingStatus {
...
impl ::std::convert::AsRef<str> for ListingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
