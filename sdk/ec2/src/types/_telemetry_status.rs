...
impl ::std::convert::From<&str> for TelemetryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TelemetryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TelemetryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TelemetryStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TelemetryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
