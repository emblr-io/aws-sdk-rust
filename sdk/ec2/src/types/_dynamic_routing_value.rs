...
impl ::std::convert::From<&str> for DynamicRoutingValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DynamicRoutingValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DynamicRoutingValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DynamicRoutingValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DynamicRoutingValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
