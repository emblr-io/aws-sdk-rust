...
impl ::std::convert::From<&str> for MonitoringState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitoringState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitoringState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitoringState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitoringState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
