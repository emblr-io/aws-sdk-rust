...
impl ::std::convert::From<&str> for TrafficMirrorFilterRuleField {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficMirrorFilterRuleField::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficMirrorFilterRuleField {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficMirrorFilterRuleField::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficMirrorFilterRuleField {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
