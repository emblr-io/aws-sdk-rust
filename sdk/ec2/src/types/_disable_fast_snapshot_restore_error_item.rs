...
impl DisableFastSnapshotRestoreErrorItem {
    /// Creates a new builder-style object to manufacture [`DisableFastSnapshotRestoreErrorItem`](crate::types::DisableFastSnapshotRestoreErrorItem).
    pub fn builder() -> crate::types::builders::DisableFastSnapshotRestoreErrorItemBuilder {
        crate::types::builders::DisableFastSnapshotRestoreErrorItemBuilder::default()
    }
}

/// A builder for [`DisableFastSnapshotRestoreErrorItem`](crate::types::DisableFastSnapshotRestoreErrorItem).
