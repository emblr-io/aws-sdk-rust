...
impl ::std::convert::From<&str> for ArchitectureValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArchitectureValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArchitectureValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArchitectureValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArchitectureValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
