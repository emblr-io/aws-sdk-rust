...
impl ::std::convert::From<&str> for DatafeedSubscriptionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatafeedSubscriptionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatafeedSubscriptionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatafeedSubscriptionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatafeedSubscriptionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
