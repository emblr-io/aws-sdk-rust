...
impl ::std::convert::From<&str> for FastLaunchStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FastLaunchStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FastLaunchStateCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FastLaunchStateCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FastLaunchStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
