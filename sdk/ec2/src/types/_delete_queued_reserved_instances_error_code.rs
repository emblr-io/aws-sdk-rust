...
impl ::std::convert::From<&str> for DeleteQueuedReservedInstancesErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeleteQueuedReservedInstancesErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeleteQueuedReservedInstancesErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeleteQueuedReservedInstancesErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeleteQueuedReservedInstancesErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
