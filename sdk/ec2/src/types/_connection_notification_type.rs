...
impl ::std::convert::From<&str> for ConnectionNotificationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectionNotificationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectionNotificationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectionNotificationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectionNotificationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
