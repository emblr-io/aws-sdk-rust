...
impl ::std::convert::From<&str> for StaticSourcesSupportValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StaticSourcesSupportValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StaticSourcesSupportValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StaticSourcesSupportValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StaticSourcesSupportValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
