...
impl ::std::convert::From<&str> for EbsEncryptionSupport {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EbsEncryptionSupport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EbsEncryptionSupport {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EbsEncryptionSupport::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EbsEncryptionSupport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
