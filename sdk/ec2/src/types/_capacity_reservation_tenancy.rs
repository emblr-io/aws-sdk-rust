...
impl ::std::convert::From<&str> for CapacityReservationTenancy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CapacityReservationTenancy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CapacityReservationTenancy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CapacityReservationTenancy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CapacityReservationTenancy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
