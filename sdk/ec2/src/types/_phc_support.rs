...
impl ::std::convert::From<&str> for PhcSupport {
    fn from(s: &str) -> Self {
        match s {
            "supported" => PhcSupport::Supported,
            "unsupported" => PhcSupport::Unsupported,
            other => PhcSupport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PhcSupport {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PhcSupport::from(s))
    }
}
impl PhcSupport {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PhcSupport::Supported => "supported",
            PhcSupport::Unsupported => "unsupported",
            PhcSupport::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for PhcSupport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PhcSupport {
