...
impl ::std::convert::From<&str> for UserTrustProviderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UserTrustProviderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UserTrustProviderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UserTrustProviderType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UserTrustProviderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
