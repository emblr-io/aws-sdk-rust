...
impl ::std::convert::From<&str> for SelfServicePortal {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SelfServicePortal::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SelfServicePortal {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SelfServicePortal::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SelfServicePortal {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
