...
impl ::std::convert::From<&str> for FastSnapshotRestoreStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FastSnapshotRestoreStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FastSnapshotRestoreStateCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FastSnapshotRestoreStateCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FastSnapshotRestoreStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
