...
impl ::std::convert::From<&str> for VolumeAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VolumeAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VolumeAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VolumeAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VolumeAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
