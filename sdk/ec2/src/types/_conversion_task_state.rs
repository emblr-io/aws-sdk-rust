...
impl ::std::convert::From<&str> for ConversionTaskState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConversionTaskState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConversionTaskState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConversionTaskState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConversionTaskState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
