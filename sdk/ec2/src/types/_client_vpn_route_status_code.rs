...
impl ::std::convert::From<&str> for ClientVpnRouteStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientVpnRouteStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientVpnRouteStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientVpnRouteStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientVpnRouteStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
