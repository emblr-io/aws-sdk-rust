...
impl ::std::convert::From<&str> for VpnStaticRouteSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpnStaticRouteSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpnStaticRouteSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpnStaticRouteSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VpnStaticRouteSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for VpnStaticRouteSource {
