...
impl ::std::convert::From<&str> for FleetReplacementStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetReplacementStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetReplacementStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetReplacementStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FleetReplacementStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FleetReplacementStrategy {
