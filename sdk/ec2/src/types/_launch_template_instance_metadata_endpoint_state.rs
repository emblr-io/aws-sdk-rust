...
impl ::std::convert::From<&str> for LaunchTemplateInstanceMetadataEndpointState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                LaunchTemplateInstanceMetadataEndpointState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for LaunchTemplateInstanceMetadataEndpointState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchTemplateInstanceMetadataEndpointState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchTemplateInstanceMetadataEndpointState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
