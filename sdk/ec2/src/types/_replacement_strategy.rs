...
impl ::std::convert::From<&str> for ReplacementStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplacementStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplacementStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplacementStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReplacementStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
