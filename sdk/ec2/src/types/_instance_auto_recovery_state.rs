...
impl ::std::convert::From<&str> for InstanceAutoRecoveryState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceAutoRecoveryState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceAutoRecoveryState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceAutoRecoveryState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceAutoRecoveryState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
