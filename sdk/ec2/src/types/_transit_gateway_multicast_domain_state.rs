...
impl ::std::convert::From<&str> for TransitGatewayMulticastDomainState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayMulticastDomainState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayMulticastDomainState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayMulticastDomainState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayMulticastDomainState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
