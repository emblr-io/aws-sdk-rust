...
impl ::std::convert::From<&str> for EphemeralNvmeSupport {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EphemeralNvmeSupport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EphemeralNvmeSupport {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EphemeralNvmeSupport::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EphemeralNvmeSupport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
