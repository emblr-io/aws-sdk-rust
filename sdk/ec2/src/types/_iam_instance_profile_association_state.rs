...
impl ::std::convert::From<&str> for IamInstanceProfileAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IamInstanceProfileAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IamInstanceProfileAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IamInstanceProfileAssociationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IamInstanceProfileAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
