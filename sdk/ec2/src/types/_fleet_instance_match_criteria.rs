...
impl ::std::convert::From<&str> for FleetInstanceMatchCriteria {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetInstanceMatchCriteria::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetInstanceMatchCriteria {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetInstanceMatchCriteria::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FleetInstanceMatchCriteria {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
