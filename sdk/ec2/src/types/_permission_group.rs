...
impl ::std::convert::From<&str> for PermissionGroup {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PermissionGroup::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PermissionGroup {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PermissionGroup::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PermissionGroup {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
