...
impl ::std::convert::From<&str> for ImdsSupportValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImdsSupportValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImdsSupportValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImdsSupportValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImdsSupportValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
