...
impl ::std::convert::From<&str> for ExportTaskState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportTaskState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportTaskState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportTaskState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExportTaskState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
