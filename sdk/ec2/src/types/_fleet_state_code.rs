...
impl ::std::convert::From<&str> for FleetStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetStateCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetStateCode::from(s))
    }
}
impl FleetStateCode {
...
impl ::std::convert::AsRef<str> for FleetStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FleetStateCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FleetStateCode::Active => write!(f, "active"),
            FleetStateCode::Deleted => write!(f, "deleted"),
            FleetStateCode::DeletedRunning => write!(f, "deleted_running"),
            FleetStateCode::DeletedTerminatingInstances => write!(f, "deleted_terminating"),
