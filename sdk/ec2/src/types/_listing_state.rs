...
impl ::std::convert::From<&str> for ListingState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListingState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListingState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListingState::from(s))
    }
}
impl ListingState {
...
impl ::std::convert::AsRef<str> for ListingState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
