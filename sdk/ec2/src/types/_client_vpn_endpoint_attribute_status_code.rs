...
impl ::std::convert::From<&str> for ClientVpnEndpointAttributeStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientVpnEndpointAttributeStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientVpnEndpointAttributeStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientVpnEndpointAttributeStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientVpnEndpointAttributeStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
