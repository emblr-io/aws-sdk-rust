...
impl ::std::convert::From<&str> for AddressTransferStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AddressTransferStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AddressTransferStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AddressTransferStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AddressTransferStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
