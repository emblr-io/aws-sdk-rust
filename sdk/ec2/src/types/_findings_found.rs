...
impl ::std::convert::From<&str> for FindingsFound {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FindingsFound::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FindingsFound {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FindingsFound::from(s))
    }
}
impl FindingsFound {
...
impl ::std::convert::AsRef<str> for FindingsFound {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
