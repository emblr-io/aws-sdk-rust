...
impl ::std::convert::From<&str> for InterfacePermissionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InterfacePermissionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InterfacePermissionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InterfacePermissionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InterfacePermissionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for InterfacePermissionType {
