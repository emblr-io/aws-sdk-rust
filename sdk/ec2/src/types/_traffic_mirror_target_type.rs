...
impl ::std::convert::From<&str> for TrafficMirrorTargetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficMirrorTargetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficMirrorTargetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficMirrorTargetType::from(s))
    }
}
