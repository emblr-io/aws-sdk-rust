...
impl ::std::convert::From<&str> for UnlimitedSupportedInstanceFamily {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UnlimitedSupportedInstanceFamily::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UnlimitedSupportedInstanceFamily {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UnlimitedSupportedInstanceFamily::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UnlimitedSupportedInstanceFamily {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
