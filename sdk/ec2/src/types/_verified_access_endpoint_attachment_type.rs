...
impl ::std::convert::From<&str> for VerifiedAccessEndpointAttachmentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VerifiedAccessEndpointAttachmentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VerifiedAccessEndpointAttachmentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VerifiedAccessEndpointAttachmentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VerifiedAccessEndpointAttachmentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for VerifiedAccessEndpointAttachmentType {
