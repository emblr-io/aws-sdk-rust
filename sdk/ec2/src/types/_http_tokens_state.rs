...
impl ::std::convert::From<&str> for HttpTokensState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HttpTokensState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HttpTokensState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HttpTokensState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HttpTokensState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
