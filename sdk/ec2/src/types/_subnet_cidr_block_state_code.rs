...
impl ::std::convert::From<&str> for SubnetCidrBlockStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SubnetCidrBlockStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubnetCidrBlockStateCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubnetCidrBlockStateCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SubnetCidrBlockStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
