...
impl ::std::convert::From<&str> for UsageClassType {
    fn from(s: &str) -> Self {
        match s {
            "capacity-block" => UsageClassType::CapacityBlock,
            "on-demand" => UsageClassType::OnDemand,
            "spot" => UsageClassType::Spot,
            other => UsageClassType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UsageClassType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UsageClassType::from(s))
    }
}
impl UsageClassType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            UsageClassType::CapacityBlock => "capacity-block",
...
impl ::std::convert::AsRef<str> for UsageClassType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
