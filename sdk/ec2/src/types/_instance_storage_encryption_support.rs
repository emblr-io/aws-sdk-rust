...
impl ::std::convert::From<&str> for InstanceStorageEncryptionSupport {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceStorageEncryptionSupport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceStorageEncryptionSupport {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceStorageEncryptionSupport::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceStorageEncryptionSupport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
