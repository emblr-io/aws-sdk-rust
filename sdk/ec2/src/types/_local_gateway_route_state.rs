...
impl ::std::convert::From<&str> for LocalGatewayRouteState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocalGatewayRouteState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocalGatewayRouteState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocalGatewayRouteState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocalGatewayRouteState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
