...
impl ::std::convert::From<&str> for VolumeModificationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VolumeModificationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VolumeModificationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VolumeModificationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VolumeModificationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
