...
impl ::std::convert::From<&str> for AutoAcceptSharedAttachmentsValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoAcceptSharedAttachmentsValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoAcceptSharedAttachmentsValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoAcceptSharedAttachmentsValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoAcceptSharedAttachmentsValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AutoAcceptSharedAttachmentsValue {
