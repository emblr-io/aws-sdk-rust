...
impl ::std::convert::From<&str> for MulticastSupportValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MulticastSupportValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MulticastSupportValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MulticastSupportValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MulticastSupportValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
