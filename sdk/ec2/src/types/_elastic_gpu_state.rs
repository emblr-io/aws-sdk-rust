...
impl ::std::convert::From<&str> for ElasticGpuState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ElasticGpuState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ElasticGpuState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ElasticGpuState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ElasticGpuState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ElasticGpuState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ElasticGpuState::Attached => write!(f, "ATTACHED"),
            ElasticGpuState::Unknown(value) => write!(f, "{}", value),
        }
    }
}
