...
impl ::std::convert::From<&str> for TpmSupportValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TpmSupportValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TpmSupportValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TpmSupportValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TpmSupportValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
