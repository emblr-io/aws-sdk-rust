...
impl ::std::convert::From<&str> for IpamState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamState::from(s))
    }
}
impl IpamState {
...
impl ::std::convert::AsRef<str> for IpamState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
