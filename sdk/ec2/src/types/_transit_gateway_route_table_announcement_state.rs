...
impl ::std::convert::From<&str> for TransitGatewayRouteTableAnnouncementState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                TransitGatewayRouteTableAnnouncementState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for TransitGatewayRouteTableAnnouncementState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayRouteTableAnnouncementState::from(s))
    }
}
...
impl ::std::fmt::Display for TransitGatewayRouteTableAnnouncementState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TransitGatewayRouteTableAnnouncementState::Available => write!(f, "available"),
            TransitGatewayRouteTableAnnouncementState::Deleted => write!(f, "deleted"),
            TransitGatewayRouteTableAnnouncementState::Deleting => write!(f, "deleting"),
