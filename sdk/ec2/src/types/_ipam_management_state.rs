...
impl ::std::convert::From<&str> for IpamManagementState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamManagementState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamManagementState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamManagementState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IpamManagementState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
