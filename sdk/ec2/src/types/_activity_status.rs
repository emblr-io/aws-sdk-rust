...
impl ::std::convert::From<&str> for ActivityStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActivityStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActivityStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActivityStatus::from(s))
    }
}
impl ActivityStatus {
...
impl ::std::convert::AsRef<str> for ActivityStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
