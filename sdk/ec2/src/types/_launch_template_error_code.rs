...
impl ::std::convert::From<&str> for LaunchTemplateErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LaunchTemplateErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LaunchTemplateErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchTemplateErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchTemplateErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
