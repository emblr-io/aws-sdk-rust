...
impl ::std::convert::From<&str> for ApplianceModeSupportValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplianceModeSupportValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplianceModeSupportValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplianceModeSupportValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplianceModeSupportValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
