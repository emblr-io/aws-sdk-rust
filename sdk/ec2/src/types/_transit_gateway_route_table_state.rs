...
impl ::std::convert::From<&str> for TransitGatewayRouteTableState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayRouteTableState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayRouteTableState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayRouteTableState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayRouteTableState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TransitGatewayRouteTableState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TransitGatewayRouteTableState::Available => write!(f, "available"),
