...
impl ::std::convert::From<&str> for VpcPeeringConnectionStateReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcPeeringConnectionStateReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpcPeeringConnectionStateReasonCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpcPeeringConnectionStateReasonCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VpcPeeringConnectionStateReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
