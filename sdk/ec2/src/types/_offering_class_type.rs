...
impl ::std::convert::From<&str> for OfferingClassType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OfferingClassType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OfferingClassType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OfferingClassType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OfferingClassType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
