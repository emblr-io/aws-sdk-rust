...
impl ::std::convert::From<&str> for DefaultRouteTablePropagationValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DefaultRouteTablePropagationValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DefaultRouteTablePropagationValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DefaultRouteTablePropagationValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DefaultRouteTablePropagationValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
