...
impl ::std::convert::From<&str> for AssociationStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssociationStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssociationStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssociationStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssociationStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
