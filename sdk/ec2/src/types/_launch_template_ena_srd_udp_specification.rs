...
pub struct LaunchTemplateEnaSrdUdpSpecification {
...
impl LaunchTemplateEnaSrdUdpSpecification {
    /// Creates a new builder-style object to manufacture [`LaunchTemplateEnaSrdUdpSpecification`](crate::types::LaunchTemplateEnaSrdUdpSpecification).
    pub fn builder() -> crate::types::builders::LaunchTemplateEnaSrdUdpSpecificationBuilder {
        crate::types::builders::LaunchTemplateEnaSrdUdpSpecificationBuilder::default()
    }
}

/// A builder for [`LaunchTemplateEnaSrdUdpSpecification`](crate::types::LaunchTemplateEnaSrdUdpSpecification).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LaunchTemplateEnaSrdUdpSpecificationBuilder {
    pub(crate) ena_srd_udp_enabled: ::std::option::Option<bool>,
}
impl LaunchTemplateEnaSrdUdpSpecificationBuilder {
    /// <p>Indicates whether UDP traffic to and from the instance uses ENA Express. To specify this setting, you must first enable ENA Express.</p>
    ...
    /// Consumes the builder and constructs a [`LaunchTemplateEnaSrdUdpSpecification`](crate::types::LaunchTemplateEnaSrdUdpSpecification).
    pub fn build(self) -> crate::types::LaunchTemplateEnaSrdUdpSpecification {
        crate::types::LaunchTemplateEnaSrdUdpSpecification {
