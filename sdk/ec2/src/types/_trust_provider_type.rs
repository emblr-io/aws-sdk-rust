...
impl ::std::convert::From<&str> for TrustProviderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrustProviderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrustProviderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrustProviderType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrustProviderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
