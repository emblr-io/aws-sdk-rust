...
impl ::std::convert::From<&str> for TransitGatewayMulitcastDomainAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                TransitGatewayMulitcastDomainAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for TransitGatewayMulitcastDomainAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayMulitcastDomainAssociationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayMulitcastDomainAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
