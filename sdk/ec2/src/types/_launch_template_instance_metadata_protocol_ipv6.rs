...
impl ::std::convert::From<&str> for LaunchTemplateInstanceMetadataProtocolIpv6 {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                LaunchTemplateInstanceMetadataProtocolIpv6::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for LaunchTemplateInstanceMetadataProtocolIpv6 {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchTemplateInstanceMetadataProtocolIpv6::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchTemplateInstanceMetadataProtocolIpv6 {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
