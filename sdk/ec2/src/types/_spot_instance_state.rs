...
impl ::std::convert::From<&str> for SpotInstanceState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpotInstanceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpotInstanceState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpotInstanceState::from(s))
    }
}
impl SpotInstanceState {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["active", "cancelled", "closed", "disabled", "failed", "open"]
    }
}
