...
impl ::std::convert::From<&str> for BootModeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BootModeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BootModeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BootModeType::from(s))
    }
}
impl BootModeType {
...
impl ::std::convert::AsRef<str> for BootModeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BootModeType {
