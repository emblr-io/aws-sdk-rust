...
impl ::std::convert::From<&str> for ClientCertificateRevocationListStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                ClientCertificateRevocationListStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for ClientCertificateRevocationListStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientCertificateRevocationListStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientCertificateRevocationListStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
