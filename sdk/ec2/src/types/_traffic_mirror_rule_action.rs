...
impl ::std::convert::From<&str> for TrafficMirrorRuleAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficMirrorRuleAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficMirrorRuleAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficMirrorRuleAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficMirrorRuleAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
