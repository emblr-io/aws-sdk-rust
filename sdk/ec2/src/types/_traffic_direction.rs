...
impl ::std::convert::From<&str> for TrafficDirection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrafficDirection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrafficDirection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrafficDirection::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrafficDirection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
