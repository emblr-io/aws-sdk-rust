...
impl ::std::convert::From<&str> for TransitGatewayRouteState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayRouteState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayRouteState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayRouteState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayRouteState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TransitGatewayRouteState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TransitGatewayRouteState::Active => write!(f, "active"),
            TransitGatewayRouteState::Blackhole => write!(f, "blackhole"),
            TransitGatewayRouteState::Deleted => write!(f, "deleted"),
            TransitGatewayRouteState::Deleting => write!(f, "deleting"),
            TransitGatewayRouteState::Pending => write!(f, "pending"),
            TransitGatewayRouteState::Unknown(value) => write!(f, "{}", value),
        }
    }
}
