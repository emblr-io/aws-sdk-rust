...
impl ::std::convert::From<&str> for VpcAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpcAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpcAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VpcAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
