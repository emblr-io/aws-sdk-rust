...
impl ::std::convert::From<&str> for AutoPlacement {
    fn from(s: &str) -> Self {
        match s {
            ...
            "on" => AutoPlacement::On,
            other => AutoPlacement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoPlacement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoPlacement::from(s))
    }
}
impl AutoPlacement {
...
impl ::std::convert::AsRef<str> for AutoPlacement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
