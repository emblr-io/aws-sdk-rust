...
impl ::std::convert::From<&str> for CarrierGatewayState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CarrierGatewayState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CarrierGatewayState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CarrierGatewayState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CarrierGatewayState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
