...
impl ::std::convert::From<&str> for IpamScopeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamScopeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamScopeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamScopeType::from(s))
    }
}
impl IpamScopeType {
...
impl ::std::convert::AsRef<str> for IpamScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
