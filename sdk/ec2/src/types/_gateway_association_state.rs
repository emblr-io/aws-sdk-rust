...
impl ::std::convert::From<&str> for GatewayAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GatewayAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GatewayAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GatewayAssociationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GatewayAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
