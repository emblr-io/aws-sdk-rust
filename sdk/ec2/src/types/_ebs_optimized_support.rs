...
impl ::std::convert::From<&str> for EbsOptimizedSupport {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EbsOptimizedSupport::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EbsOptimizedSupport {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EbsOptimizedSupport::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EbsOptimizedSupport {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
