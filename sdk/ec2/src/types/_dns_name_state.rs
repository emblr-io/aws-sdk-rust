...
impl ::std::convert::From<&str> for DnsNameState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DnsNameState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DnsNameState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DnsNameState::from(s))
    }
}
impl DnsNameState {
...
impl ::std::convert::AsRef<str> for DnsNameState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
