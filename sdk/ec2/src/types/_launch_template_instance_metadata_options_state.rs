...
impl ::std::convert::From<&str> for LaunchTemplateInstanceMetadataOptionsState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                LaunchTemplateInstanceMetadataOptionsState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for LaunchTemplateInstanceMetadataOptionsState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchTemplateInstanceMetadataOptionsState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchTemplateInstanceMetadataOptionsState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
