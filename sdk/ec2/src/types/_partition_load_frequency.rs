...
impl ::std::convert::From<&str> for PartitionLoadFrequency {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PartitionLoadFrequency::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PartitionLoadFrequency {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PartitionLoadFrequency::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PartitionLoadFrequency {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
