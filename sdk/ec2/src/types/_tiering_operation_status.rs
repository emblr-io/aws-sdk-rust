...
impl ::std::convert::From<&str> for TieringOperationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TieringOperationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TieringOperationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TieringOperationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TieringOperationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
