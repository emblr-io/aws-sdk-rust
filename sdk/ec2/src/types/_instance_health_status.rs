...
impl ::std::convert::From<&str> for InstanceHealthStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceHealthStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceHealthStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceHealthStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceHealthStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for InstanceHealthStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            InstanceHealthStatus::HealthyStatus => write!(f, "healthy"),
            InstanceHealthStatus::UnhealthyStatus => write!(f, "unhealthy"),
            InstanceHealthStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
