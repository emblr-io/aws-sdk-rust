...
impl ::std::convert::From<&str> for ResetImageAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResetImageAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResetImageAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResetImageAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResetImageAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
