...
impl ::std::convert::From<&str> for TransitGatewayAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransitGatewayAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransitGatewayAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransitGatewayAssociationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransitGatewayAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
