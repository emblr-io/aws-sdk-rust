...
impl ::std::convert::From<&str> for IpamComplianceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamComplianceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamComplianceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamComplianceStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IpamComplianceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
