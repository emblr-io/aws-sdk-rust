...
impl ::std::convert::From<&str> for ProtocolValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProtocolValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProtocolValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProtocolValue::from(s))
    }
}
impl ProtocolValue {
...
impl ::std::convert::AsRef<str> for ProtocolValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
