...
pub struct CreateVerifiedAccessNativeApplicationOidcOptions {
...
impl ::std::fmt::Debug for CreateVerifiedAccessNativeApplicationOidcOptions {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateVerifiedAccessNativeApplicationOidcOptions");
...
#[non_exhaustive]
pub struct CreateVerifiedAccessNativeApplicationOidcOptionsBuilder {
...
impl CreateVerifiedAccessNativeApplicationOidcOptionsBuilder {
    /// <p>The public signing key endpoint.</p>
    ...
    /// Consumes the builder and constructs a [`CreateVerifiedAccessNativeApplicationOidcOptions`](crate::types::CreateVerifiedAccessNativeApplicationOidcOptions).
    pub fn build(self) -> crate::types::CreateVerifiedAccessNativeApplicationOidcOptions {
        crate::types::CreateVerifiedAccessNativeApplicationOidcOptions {
...
impl ::std::fmt::Debug for CreateVerifiedAccessNativeApplicationOidcOptionsBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateVerifiedAccessNativeApplicationOidcOptionsBuilder");
        formatter.field("public_signing_key_endpoint", &self.public_signing_key_endpoint);
        formatter.field("issuer", &self.issuer);
        formatter.field("authorization_endpoint", &self.authorization_endpoint);
        formatter.field("token_endpoint", &self.token_endpoint);
