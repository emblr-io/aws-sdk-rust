...
impl ::std::convert::From<&str> for ImageTypeValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageTypeValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageTypeValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageTypeValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImageTypeValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
