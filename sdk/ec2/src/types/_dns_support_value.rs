...
impl ::std::convert::From<&str> for DnsSupportValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DnsSupportValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DnsSupportValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DnsSupportValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DnsSupportValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
