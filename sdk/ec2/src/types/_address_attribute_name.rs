...
impl ::std::convert::From<&str> for AddressAttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AddressAttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AddressAttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AddressAttributeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AddressAttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AddressAttributeName {
