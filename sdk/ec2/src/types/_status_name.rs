...
impl ::std::convert::From<&str> for StatusName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatusName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatusName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatusName::from(s))
    }
}
impl StatusName {
...
impl ::std::convert::AsRef<str> for StatusName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
