...
impl ::std::convert::From<&str> for IpamAddressHistoryResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamAddressHistoryResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamAddressHistoryResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamAddressHistoryResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IpamAddressHistoryResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
