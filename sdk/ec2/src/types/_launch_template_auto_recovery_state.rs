...
impl ::std::convert::From<&str> for LaunchTemplateAutoRecoveryState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LaunchTemplateAutoRecoveryState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LaunchTemplateAutoRecoveryState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchTemplateAutoRecoveryState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchTemplateAutoRecoveryState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
