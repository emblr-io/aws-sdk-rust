...
impl ::std::convert::From<&str> for ListServiceInstancesSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListServiceInstancesSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListServiceInstancesSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListServiceInstancesSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListServiceInstancesSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
