...
impl ::std::convert::From<&str> for ComponentDeploymentUpdateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComponentDeploymentUpdateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ComponentDeploymentUpdateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ComponentDeploymentUpdateType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ComponentDeploymentUpdateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
