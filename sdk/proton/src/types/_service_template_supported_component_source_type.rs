...
impl ::std::convert::From<&str> for ServiceTemplateSupportedComponentSourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => {
                ServiceTemplateSupportedComponentSourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
            }
        }
    }
}
impl ::std::str::FromStr for ServiceTemplateSupportedComponentSourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServiceTemplateSupportedComponentSourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServiceTemplateSupportedComponentSourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
