...
impl ::std::convert::From<&str> for Provisioning {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Provisioning::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Provisioning {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Provisioning::from(s))
    }
}
impl Provisioning {
...
impl ::std::convert::AsRef<str> for Provisioning {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
