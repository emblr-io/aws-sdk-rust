...
impl ::std::convert::From<&str> for SyncType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncType::from(s))
    }
}
impl SyncType {
...
impl ::std::convert::AsRef<str> for SyncType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
