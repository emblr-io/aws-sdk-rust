...
impl ::std::convert::From<&str> for ListServiceInstancesFilterBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListServiceInstancesFilterBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListServiceInstancesFilterBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListServiceInstancesFilterBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListServiceInstancesFilterBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
