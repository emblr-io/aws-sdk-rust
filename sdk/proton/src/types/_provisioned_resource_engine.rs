...
impl ::std::convert::From<&str> for ProvisionedResourceEngine {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisionedResourceEngine::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisionedResourceEngine {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisionedResourceEngine::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProvisionedResourceEngine {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
