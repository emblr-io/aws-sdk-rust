...
//! offered by Schemas. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`CreateDiscoverer`](crate::operation::create_discoverer) operation has
