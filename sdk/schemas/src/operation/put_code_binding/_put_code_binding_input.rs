...
impl PutCodeBindingInput {
    /// Creates a new builder-style object to manufacture [`PutCodeBindingInput`](crate::operation::put_code_binding::PutCodeBindingInput).
    pub fn builder() -> crate::operation::put_code_binding::builders::PutCodeBindingInputBuilder {
        crate::operation::put_code_binding::builders::PutCodeBindingInputBuilder::default()
    }
}
