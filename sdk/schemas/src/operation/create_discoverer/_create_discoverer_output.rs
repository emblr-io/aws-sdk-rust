...
impl ::aws_types::request_id::RequestId for CreateDiscovererOutput {
...
impl CreateDiscovererOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateDiscovererOutput`](crate::operation::create_discoverer::CreateDiscovererOutput).
    pub fn build(self) -> crate::operation::create_discoverer::CreateDiscovererOutput {
