...
impl ExportSchemaInput {
    /// Creates a new builder-style object to manufacture [`ExportSchemaInput`](crate::operation::export_schema::ExportSchemaInput).
    pub fn builder() -> crate::operation::export_schema::builders::ExportSchemaInputBuilder {
        crate::operation::export_schema::builders::ExportSchemaInputBuilder::default()
    }
}
