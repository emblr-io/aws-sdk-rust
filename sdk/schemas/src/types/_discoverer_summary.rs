...
impl DiscovererSummary {
    /// Creates a new builder-style object to manufacture [`DiscovererSummary`](crate::types::DiscovererSummary).
    pub fn builder() -> crate::types::builders::DiscovererSummaryBuilder {
        crate::types::builders::DiscovererSummaryBuilder::default()
    }
}
