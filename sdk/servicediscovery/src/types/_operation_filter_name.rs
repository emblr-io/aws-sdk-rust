...
impl ::std::convert::From<&str> for OperationFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OperationFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OperationFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OperationFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OperationFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
