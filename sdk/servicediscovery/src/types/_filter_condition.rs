...
impl ::std::convert::From<&str> for FilterCondition {
    fn from(s: &str) -> Self {
        match s {
            "BEGINS_WITH" => FilterCondition::BeginsWith,
            "BETWEEN" => FilterCondition::Between,
            "EQ" => FilterCondition::Eq,
            "IN" => FilterCondition::In,
            other => FilterCondition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterCondition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterCondition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FilterCondition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
