...
impl ::std::convert::From<&str> for HealthStatusFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HealthStatusFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HealthStatusFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HealthStatusFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HealthStatusFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
