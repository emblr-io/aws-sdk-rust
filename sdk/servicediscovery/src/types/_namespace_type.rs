...
impl ::std::convert::From<&str> for NamespaceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NamespaceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NamespaceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NamespaceType::from(s))
    }
}
impl NamespaceType {
...
impl ::std::convert::AsRef<str> for NamespaceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
