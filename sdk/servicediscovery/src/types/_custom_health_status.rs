...
impl ::std::convert::From<&str> for CustomHealthStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomHealthStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomHealthStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomHealthStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomHealthStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
