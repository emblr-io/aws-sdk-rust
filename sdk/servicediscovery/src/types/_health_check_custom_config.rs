...
/// <ol>
/// <li>
/// <p>You create a service.</p></li>
/// <li>
/// <p>You register an instance.</p></li>
/// <li>
/// <p>You configure a third-party health checker to monitor the resource that's associated with the new instance.</p><note>
/// <p>Cloud Map doesn't check the health of the resource directly.</p>
/// </note></li>
/// <li>
/// <p>The third-party health-checker determines that the resource is unhealthy and notifies your application.</p></li>
/// <li>
/// <p>Your application submits an <code>UpdateInstanceCustomHealthStatus</code> request.</p></li>
/// <li>
/// <p>Cloud Map waits for 30 seconds.</p></li>
/// <li>
/// <p>If another <code>UpdateInstanceCustomHealthStatus</code> request doesn't arrive during that time to change the status back to healthy, Cloud Map stops routing traffic to the resource.</p></li>
/// </ol>
#[non_exhaustive]
