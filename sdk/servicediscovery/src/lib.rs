...
//! offered by AWS Cloud Map. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Cloud Map.
...
/// For example, the [`CreateHttpNamespace`](crate::operation::create_http_namespace) operation has
/// a [`Client::create_http_namespace`], function which returns a builder for that operation.
...
/// Configuration for AWS Cloud Map.
pub mod config;
