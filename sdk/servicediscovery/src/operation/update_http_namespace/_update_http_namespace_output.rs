...
impl ::aws_types::request_id::RequestId for UpdateHttpNamespaceOutput {
...
impl UpdateHttpNamespaceOutputBuilder {
    /// <p>A value that you can use to determine whether the request completed successfully. To get the status of the operation, see <a href="https://docs.aws.amazon.com/cloud-map/latest/api/API_GetOperation.html">GetOperation</a>.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateHttpNamespaceOutput`](crate::operation::update_http_namespace::UpdateHttpNamespaceOutput).
    pub fn build(self) -> crate::operation::update_http_namespace::UpdateHttpNamespaceOutput {
