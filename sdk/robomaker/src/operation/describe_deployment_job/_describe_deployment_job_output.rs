...
impl ::aws_types::request_id::RequestId for DescribeDeploymentJobOutput {
...
impl DescribeDeploymentJobOutputBuilder {
    ...
    pub fn robot_deployment_summary(mut self, input: crate::types::RobotDeployment) -> Self {
        ...
        v.push(input);
        self.robot_deployment_summary = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of robot deployment summaries.</p>
    ...
    /// <p>A list of robot deployment summaries.</p>
    pub fn get_robot_deployment_summary(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::RobotDeployment>> {
        &self.robot_deployment_summary
    }
