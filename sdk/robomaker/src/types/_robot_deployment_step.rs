...
impl ::std::convert::From<&str> for RobotDeploymentStep {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RobotDeploymentStep::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RobotDeploymentStep {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RobotDeploymentStep::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RobotDeploymentStep {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
