...
/// When writing a match expression against `ExitBehavior`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `exitbehavior` represents
...
/// version of SDK where the variant `ExitBehavior::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ExitBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExitBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExitBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExitBehavior::from(s))
    }
}
impl ExitBehavior {
...
impl ::std::convert::AsRef<str> for ExitBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ExitBehavior {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ExitBehavior::Fail => write!(f, "FAIL"),
            ExitBehavior::Restart => write!(f, "RESTART"),
            ExitBehavior::Unknown(value) => write!(f, "{}", value),
        }
    }
}
