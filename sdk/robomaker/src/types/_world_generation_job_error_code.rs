...
impl ::std::convert::From<&str> for WorldGenerationJobErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorldGenerationJobErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorldGenerationJobErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorldGenerationJobErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorldGenerationJobErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
