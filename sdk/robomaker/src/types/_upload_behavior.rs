...
impl ::std::convert::From<&str> for UploadBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UploadBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UploadBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UploadBehavior::from(s))
    }
}
impl UploadBehavior {
...
impl ::std::convert::AsRef<str> for UploadBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
