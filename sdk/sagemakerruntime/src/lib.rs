...
//! aws-sdk-sagemakerruntime = "0.0.0-local"
...
//! offered by Amazon SageMaker Runtime. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon SageMaker Runtime.
...
/// For example, the [`InvokeEndpoint`](crate::operation::invoke_endpoint) operation has
