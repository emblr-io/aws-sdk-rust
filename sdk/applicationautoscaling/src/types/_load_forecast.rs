...
impl LoadForecastBuilder {
    ...
    /// - [`timestamps`](crate::types::builders::LoadForecastBuilder::timestamps)
    /// - [`values`](crate::types::builders::LoadForecastBuilder::values)
    pub fn build(self) -> ::std::result::Result<crate::types::LoadForecast, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::LoadForecast {
            timestamps: self.timestamps.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "timestamps",
                    "timestamps was not specified but it is required when building LoadForecast",
                )
            })?,
            values: self.values.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "values",
                    "values was not specified but it is required when building LoadForecast",
                )
            })?,
