...
pub struct PredictiveScalingMetricDataQuery {
    ...
    /// <p>Conditional: Within each <code>MetricDataQuery</code> object, you must specify either <code>Expression</code> or <code>MetricStat</code>, but not both.</p>
    pub metric_stat: ::std::option::Option<crate::types::PredictiveScalingMetricStat>,
...
impl PredictiveScalingMetricDataQuery {
    /// <p>A short name that identifies the object's results in the response. This name must be unique among all <code>MetricDataQuery</code> objects specified for a single scaling policy. If you are performing math expressions on this set of data, this name represents that data and can serve as a variable in the mathematical expression. The valid characters are letters, numbers, and underscores. The first character must be a lowercase letter.</p>
    pub fn id(&self) -> &str {
        use std::ops::Deref;
        self.id.deref()
    ...
    /// <p>Information about the metric data to return.</p>
    /// <p>Conditional: Within each <code>MetricDataQuery</code> object, you must specify either <code>Expression</code> or <code>MetricStat</code>, but not both.</p>
    pub fn metric_stat(&self) -> ::std::option::Option<&crate::types::PredictiveScalingMetricStat> {
...
impl PredictiveScalingMetricDataQuery {
    /// Creates a new builder-style object to manufacture [`PredictiveScalingMetricDataQuery`](crate::types::PredictiveScalingMetricDataQuery).
    pub fn builder() -> crate::types::builders::PredictiveScalingMetricDataQueryBuilder {
        crate::types::builders::PredictiveScalingMetricDataQueryBuilder::default()
    }
}

/// A builder for [`PredictiveScalingMetricDataQuery`](crate::types::PredictiveScalingMetricDataQuery).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PredictiveScalingMetricDataQueryBuilder {
    pub(crate) id: ::std::option::Option<::std::string::String>,
    pub(crate) expression: ::std::option::Option<::std::string::String>,
    pub(crate) metric_stat: ::std::option::Option<crate::types::PredictiveScalingMetricStat>,
    pub(crate) label: ::std::option::Option<::std::string::String>,
    pub(crate) return_data: ::std::option::Option<bool>,
}
impl PredictiveScalingMetricDataQueryBuilder {
    /// <p>A short name that identifies the object's results in the response. This name must be unique among all <code>MetricDataQuery</code> objects specified for a single scaling policy. If you are performing math expressions on this set of data, this name represents that data and can serve as a variable in the mathematical expression. The valid characters are letters, numbers, and underscores. The first character must be a lowercase letter.</p>
    ...
    /// <p>Information about the metric data to return.</p>
    /// <p>Conditional: Within each <code>MetricDataQuery</code> object, you must specify either <code>Expression</code> or <code>MetricStat</code>, but not both.</p>
    pub fn metric_stat(mut self, input: crate::types::PredictiveScalingMetricStat) -> Self {
        self.metric_stat = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the metric data to return.</p>
    /// <p>Conditional: Within each <code>MetricDataQuery</code> object, you must specify either <code>Expression</code> or <code>MetricStat</code>, but not both.</p>
    pub fn set_metric_stat(mut self, input: ::std::option::Option<crate::types::PredictiveScalingMetricStat>) -> Self {
        self.metric_stat = input;
        self
    }
    /// <p>Information about the metric data to return.</p>
    /// <p>Conditional: Within each <code>MetricDataQuery</code> object, you must specify either <code>Expression</code> or <code>MetricStat</code>, but not both.</p>
    pub fn get_metric_stat(&self) -> &::std::option::Option<crate::types::PredictiveScalingMetricStat> {
        &self.metric_stat
    }
    /// <p>A human-readable label for this metric or expression. This is especially useful if this is a math expression, so that you know what the value represents.</p>
    ...
    /// Consumes the builder and constructs a [`PredictiveScalingMetricDataQuery`](crate::types::PredictiveScalingMetricDataQuery).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::types::builders::PredictiveScalingMetricDataQueryBuilder::id)
    pub fn build(self) -> ::std::result::Result<crate::types::PredictiveScalingMetricDataQuery, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::PredictiveScalingMetricDataQuery {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building PredictiveScalingMetricDataQuery",
                )
            })?,
