...
impl ScalableTarget {
    /// Creates a new builder-style object to manufacture [`ScalableTarget`](crate::types::ScalableTarget).
    pub fn builder() -> crate::types::builders::ScalableTargetBuilder {
        crate::types::builders::ScalableTargetBuilder::default()
    }
}
