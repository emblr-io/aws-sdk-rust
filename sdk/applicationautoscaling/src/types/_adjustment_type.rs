...
impl ::std::convert::From<&str> for AdjustmentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AdjustmentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AdjustmentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AdjustmentType::from(s))
    }
}
impl AdjustmentType {
...
impl ::std::convert::AsRef<str> for AdjustmentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AdjustmentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AdjustmentType::ChangeInCapacity => write!(f, "ChangeInCapacity"),
            AdjustmentType::ExactCapacity => write!(f, "ExactCapacity"),
            AdjustmentType::PercentChangeInCapacity => write!(f, "PercentChangeInCapacity"),
