...
//! aws-sdk-applicationautoscaling = "0.0.0-local"
...
/// For example, the [`DeleteScalingPolicy`](crate::operation::delete_scaling_policy) operation has
/// a [`Client::delete_scaling_policy`], function which returns a builder for that operation.
