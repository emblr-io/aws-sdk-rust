...
impl ::std::convert::From<&str> for MembershipStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "Terminated" => MembershipStatus::Terminated,
            other => MembershipStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MembershipStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MembershipStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MembershipStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MembershipStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            MembershipStatus::Terminated => write!(f, "Terminated"),
