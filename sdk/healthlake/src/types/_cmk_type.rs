...
impl ::std::convert::From<&str> for CmkType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CmkType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CmkType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CmkType::from(s))
    }
}
impl CmkType {
...
impl ::std::convert::AsRef<str> for CmkType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CmkType {
