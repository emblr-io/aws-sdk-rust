...
impl ::std::convert::From<&str> for PreloadDataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PreloadDataType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PreloadDataType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PreloadDataType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PreloadDataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
