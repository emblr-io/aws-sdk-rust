...
/// match errorcategory {
///     ErrorCategory::NonRetryableError => { /* ... */ },
...
impl ::std::convert::From<&str> for ErrorCategory {
    fn from(s: &str) -> Self {
        match s {
            "NON_RETRYABLE_ERROR" => ErrorCategory::NonRetryableError,
            "RETRYABLE_ERROR" => ErrorCategory::RetryableError,
            other => ErrorCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ErrorCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ErrorCategory::from(s))
    }
}
impl ErrorCategory {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ErrorCategory::NonRetryableError => "NON_RETRYABLE_ERROR",
            ErrorCategory::RetryableError => "RETRYABLE_ERROR",
            ErrorCategory::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["NON_RETRYABLE_ERROR", "RETRYABLE_ERROR"]
    }
}
impl ::std::convert::AsRef<str> for ErrorCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
