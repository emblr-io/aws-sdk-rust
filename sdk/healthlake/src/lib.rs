...
//! aws-sdk-healthlake = "0.0.0-local"
...
//! offered by Amazon HealthLake. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon HealthLake.
...
/// Configuration for Amazon HealthLake.
pub mod config;
