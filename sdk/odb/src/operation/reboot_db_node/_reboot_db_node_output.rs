...
impl ::aws_types::request_id::RequestId for RebootDbNodeOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl RebootDbNodeOutput {
    /// Creates a new builder-style object to manufacture [`RebootDbNodeOutput`](crate::operation::reboot_db_node::RebootDbNodeOutput).
    pub fn builder() -> crate::operation::reboot_db_node::builders::RebootDbNodeOutputBuilder {
        crate::operation::reboot_db_node::builders::RebootDbNodeOutputBuilder::default()
    }
}

/// A builder for [`RebootDbNodeOutput`](crate::operation::reboot_db_node::RebootDbNodeOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RebootDbNodeOutputBuilder {
...
impl RebootDbNodeOutputBuilder {
    /// <p>The unique identifier of the DB node that was rebooted.</p>
    ...
    /// Consumes the builder and constructs a [`RebootDbNodeOutput`](crate::operation::reboot_db_node::RebootDbNodeOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`db_node_id`](crate::operation::reboot_db_node::builders::RebootDbNodeOutputBuilder::db_node_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::reboot_db_node::RebootDbNodeOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::reboot_db_node::RebootDbNodeOutput {
            db_node_id: self.db_node_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "db_node_id",
                    "db_node_id was not specified but it is required when building RebootDbNodeOutput",
                )
            })?,
            status: self.status,
