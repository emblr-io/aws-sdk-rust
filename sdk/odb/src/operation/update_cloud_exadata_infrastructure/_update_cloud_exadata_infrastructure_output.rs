...
pub struct UpdateCloudExadataInfrastructureOutput {
...
impl UpdateCloudExadataInfrastructureOutput {
    /// <p>The user-friendly name of the updated Exadata infrastructure.</p>
...
impl ::aws_types::request_id::RequestId for UpdateCloudExadataInfrastructureOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateCloudExadataInfrastructureOutput {
    /// Creates a new builder-style object to manufacture [`UpdateCloudExadataInfrastructureOutput`](crate::operation::update_cloud_exadata_infrastructure::UpdateCloudExadataInfrastructureOutput).
    pub fn builder() -> crate::operation::update_cloud_exadata_infrastructure::builders::UpdateCloudExadataInfrastructureOutputBuilder {
        crate::operation::update_cloud_exadata_infrastructure::builders::UpdateCloudExadataInfrastructureOutputBuilder::default()
    }
}

/// A builder for [`UpdateCloudExadataInfrastructureOutput`](crate::operation::update_cloud_exadata_infrastructure::UpdateCloudExadataInfrastructureOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateCloudExadataInfrastructureOutputBuilder {
...
impl UpdateCloudExadataInfrastructureOutputBuilder {
    /// <p>The user-friendly name of the updated Exadata infrastructure.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateCloudExadataInfrastructureOutput`](crate::operation::update_cloud_exadata_infrastructure::UpdateCloudExadataInfrastructureOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`cloud_exadata_infrastructure_id`](crate::operation::update_cloud_exadata_infrastructure::builders::UpdateCloudExadataInfrastructureOutputBuilder::cloud_exadata_infrastructure_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<
            ...
            crate::operation::update_cloud_exadata_infrastructure::UpdateCloudExadataInfrastructureOutput {
                ...
                cloud_exadata_infrastructure_id: self.cloud_exadata_infrastructure_id.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        ...
                        "cloud_exadata_infrastructure_id was not specified but it is required when building UpdateCloudExadataInfrastructureOutput",
                    )
                })?,
