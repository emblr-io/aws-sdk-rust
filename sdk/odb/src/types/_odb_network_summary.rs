...
impl OdbNetworkSummary {
    /// Creates a new builder-style object to manufacture [`OdbNetworkSummary`](crate::types::OdbNetworkSummary).
    pub fn builder() -> crate::types::builders::OdbNetworkSummaryBuilder {
        crate::types::builders::OdbNetworkSummaryBuilder::default()
    }
}

/// A builder for [`OdbNetworkSummary`](crate::types::OdbNetworkSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OdbNetworkSummaryBuilder {
...
impl OdbNetworkSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`OdbNetworkSummary`](crate::types::OdbNetworkSummary).
    /// This method will fail if any of the following fields are not set:
    /// - [`odb_network_id`](crate::types::builders::OdbNetworkSummaryBuilder::odb_network_id)
    pub fn build(self) -> ::std::result::Result<crate::types::OdbNetworkSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::OdbNetworkSummary {
            odb_network_id: self.odb_network_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "odb_network_id",
                    "odb_network_id was not specified but it is required when building OdbNetworkSummary",
                )
            })?,
