...
///     ResourceStatus::MaintenanceInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MAINTENANCE_IN_PROGRESS" => ResourceStatus::MaintenanceInProgress,
...
impl ResourceStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ResourceStatus::MaintenanceInProgress => "MAINTENANCE_IN_PROGRESS",
...
impl ::std::fmt::Display for ResourceStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ResourceStatus::MaintenanceInProgress => write!(f, "MAINTENANCE_IN_PROGRESS"),
