...
/// For example, the [`AcceptMarketplaceRegistration`](crate::operation::accept_marketplace_registration) operation has
/// a [`Client::accept_marketplace_registration`], function which returns a builder for that operation.
