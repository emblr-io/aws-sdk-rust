...
impl ::aws_types::request_id::RequestId for CreateCustomLineItemOutput {
...
impl CreateCustomLineItemOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the created custom line item.</p>
    ...
    /// Consumes the builder and constructs a [`CreateCustomLineItemOutput`](crate::operation::create_custom_line_item::CreateCustomLineItemOutput).
    pub fn build(self) -> crate::operation::create_custom_line_item::CreateCustomLineItemOutput {
