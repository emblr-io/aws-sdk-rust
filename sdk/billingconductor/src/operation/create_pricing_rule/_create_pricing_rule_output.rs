...
impl ::aws_types::request_id::RequestId for CreatePricingRuleOutput {
...
impl CreatePricingRuleOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the created pricing rule.</p>
    ...
    /// Consumes the builder and constructs a [`CreatePricingRuleOutput`](crate::operation::create_pricing_rule::CreatePricingRuleOutput).
    pub fn build(self) -> crate::operation::create_pricing_rule::CreatePricingRuleOutput {
