...
impl ::std::convert::From<&str> for CustomLineItemRelationship {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomLineItemRelationship::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomLineItemRelationship {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomLineItemRelationship::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomLineItemRelationship {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
