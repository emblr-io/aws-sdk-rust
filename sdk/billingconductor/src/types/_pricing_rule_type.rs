...
impl ::std::convert::From<&str> for PricingRuleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PricingRuleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PricingRuleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PricingRuleType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PricingRuleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
