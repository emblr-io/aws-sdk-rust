...
impl ::std::convert::From<&str> for PricingRuleScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PricingRuleScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PricingRuleScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PricingRuleScope::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PricingRuleScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
