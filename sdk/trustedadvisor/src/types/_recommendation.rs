...
impl RecommendationBuilder {
    ...
    /// - [`name`](crate::types::builders::RecommendationBuilder::name)
    /// - [`arn`](crate::types::builders::RecommendationBuilder::arn)
    /// - [`description`](crate::types::builders::RecommendationBuilder::description)
        ...
        ::std::result::Result::Ok(crate::types::Recommendation {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building Recommendation",
                )
            })?,
            ...
            pillars: self.pillars.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "pillars",
                    "pillars was not specified but it is required when building Recommendation",
                )
            })?,
            source: self.source.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "source",
                    "source was not specified but it is required when building Recommendation",
                )
            })?,
            ...
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building Recommendation",
                )
            })?,
            ...
            description: self.description.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "description",
                    "description was not specified but it is required when building Recommendation",
                )
            })?,
