...
impl RecommendationSummaryBuilder {
    ...
    /// - [`arn`](crate::types::builders::RecommendationSummaryBuilder::arn)
        ...
        ::std::result::Result::Ok(crate::types::RecommendationSummary {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building RecommendationSummary",
                )
            })?,
            ...
            pillars: self.pillars.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "pillars",
                    "pillars was not specified but it is required when building RecommendationSummary",
                )
            })?,
            source: self.source.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "source",
                    "source was not specified but it is required when building RecommendationSummary",
                )
            })?,
