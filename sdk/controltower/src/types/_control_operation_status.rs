...
impl ::std::convert::From<&str> for ControlOperationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ControlOperationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ControlOperationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ControlOperationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ControlOperationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
