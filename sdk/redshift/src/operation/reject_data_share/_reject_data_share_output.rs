...
impl ::aws_types::request_id::RequestId for RejectDataShareOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl RejectDataShareOutput {
    /// Creates a new builder-style object to manufacture [`RejectDataShareOutput`](crate::operation::reject_data_share::RejectDataShareOutput).
    pub fn builder() -> crate::operation::reject_data_share::builders::RejectDataShareOutputBuilder {
...
impl RejectDataShareOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the datashare that the consumer is to use.</p>
    ...
    /// Consumes the builder and constructs a [`RejectDataShareOutput`](crate::operation::reject_data_share::RejectDataShareOutput).
    pub fn build(self) -> crate::operation::reject_data_share::RejectDataShareOutput {
