...
impl ::aws_types::request_id::RequestId for CreateClusterSecurityGroupOutput {
...
impl CreateClusterSecurityGroupOutputBuilder {
    /// <p>Describes a security group.</p>
    pub fn cluster_security_group(mut self, input: crate::types::ClusterSecurityGroup) -> Self {
        self.cluster_security_group = ::std::option::Option::Some(input);
        self
    }
    /// <p>Describes a security group.</p>
    ...
    /// <p>Describes a security group.</p>
    pub fn get_cluster_security_group(&self) -> &::std::option::Option<crate::types::ClusterSecurityGroup> {
