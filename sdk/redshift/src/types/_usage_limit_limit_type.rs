...
impl ::std::convert::From<&str> for UsageLimitLimitType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UsageLimitLimitType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UsageLimitLimitType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UsageLimitLimitType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UsageLimitLimitType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
