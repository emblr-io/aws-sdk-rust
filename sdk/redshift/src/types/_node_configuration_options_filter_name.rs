...
impl ::std::convert::From<&str> for NodeConfigurationOptionsFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NodeConfigurationOptionsFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NodeConfigurationOptionsFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NodeConfigurationOptionsFilterName::from(s))
    }
}
