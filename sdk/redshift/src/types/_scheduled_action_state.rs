...
impl ::std::convert::From<&str> for ScheduledActionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScheduledActionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScheduledActionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScheduledActionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScheduledActionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
