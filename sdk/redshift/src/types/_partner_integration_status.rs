...
/// When writing a match expression against `PartnerIntegrationStatus`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `partnerintegrationstatus` represents
...
/// version of SDK where the variant `PartnerIntegrationStatus::NewFeature` is defined.
...
impl ::std::convert::From<&str> for PartnerIntegrationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PartnerIntegrationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PartnerIntegrationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PartnerIntegrationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PartnerIntegrationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
