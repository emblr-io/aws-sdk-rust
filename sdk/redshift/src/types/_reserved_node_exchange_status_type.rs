...
impl ::std::convert::From<&str> for ReservedNodeExchangeStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReservedNodeExchangeStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReservedNodeExchangeStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReservedNodeExchangeStatusType::from(s))
    }
}
