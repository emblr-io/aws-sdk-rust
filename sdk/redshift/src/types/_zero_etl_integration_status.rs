...
/// When writing a match expression against `ZeroEtlIntegrationStatus`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `zeroetlintegrationstatus` represents
...
/// version of SDK where the variant `ZeroEtlIntegrationStatus::NewFeature` is defined.
/// Specifically, when `zeroetlintegrationstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ZeroEtlIntegrationStatus::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ZeroEtlIntegrationStatus {
    #[allow(missing_docs)] // documentation missing in model
    Active,
    #[allow(missing_docs)] // documentation missing in model
    Creating,
...
impl ::std::convert::From<&str> for ZeroEtlIntegrationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "needs_attention" => ZeroEtlIntegrationStatus::NeedsAttention,
            "syncing" => ZeroEtlIntegrationStatus::Syncing,
            other => ZeroEtlIntegrationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ZeroEtlIntegrationStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ZeroEtlIntegrationStatus::from(s))
    }
}
impl ZeroEtlIntegrationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ZeroEtlIntegrationStatus::Active => "active",
            ZeroEtlIntegrationStatus::Creating => "creating",
            ZeroEtlIntegrationStatus::Deleting => "deleting",
            ZeroEtlIntegrationStatus::Failed => "failed",
            ZeroEtlIntegrationStatus::Modifying => "modifying",
            ZeroEtlIntegrationStatus::NeedsAttention => "needs_attention",
            ZeroEtlIntegrationStatus::Syncing => "syncing",
            ZeroEtlIntegrationStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ZeroEtlIntegrationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
