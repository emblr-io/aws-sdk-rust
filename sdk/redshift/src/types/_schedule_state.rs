...
impl ::std::convert::From<&str> for ScheduleState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScheduleState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScheduleState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScheduleState::from(s))
    }
}
impl ScheduleState {
...
impl ::std::convert::AsRef<str> for ScheduleState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ScheduleState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ScheduleState::Modifying => write!(f, "MODIFYING"),
