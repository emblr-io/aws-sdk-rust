...
impl ::std::fmt::Display for InProgressTableRestoreQuotaExceededFault {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InProgressTableRestoreQuotaExceededFault")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InProgressTableRestoreQuotaExceededFault {
