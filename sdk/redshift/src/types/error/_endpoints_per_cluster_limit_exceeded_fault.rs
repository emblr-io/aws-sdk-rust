...
impl ::std::fmt::Display for EndpointsPerClusterLimitExceededFault {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "EndpointsPerClusterLimitExceededFault")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::EndpointsPerClusterLimitExceededFault {
...
impl EndpointsPerClusterLimitExceededFaultBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`EndpointsPerClusterLimitExceededFault`](crate::types::error::EndpointsPerClusterLimitExceededFault).
    pub fn build(self) -> crate::types::error::EndpointsPerClusterLimitExceededFault {
