...
impl ::std::fmt::Display for NumberOfNodesPerClusterLimitExceededFault {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "NumberOfNodesPerClusterLimitExceededFault")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::NumberOfNodesPerClusterLimitExceededFault {
...
impl NumberOfNodesPerClusterLimitExceededFaultBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`NumberOfNodesPerClusterLimitExceededFault`](crate::types::error::NumberOfNodesPerClusterLimitExceededFault).
    pub fn build(self) -> crate::types::error::NumberOfNodesPerClusterLimitExceededFault {
