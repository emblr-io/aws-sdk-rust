...
impl ::std::convert::From<&str> for PresetSpeke20Audio {
    fn from(s: &str) -> Self {
        match s {
            "PRESET_AUDIO_1" => PresetSpeke20Audio::PresetAudio1,
            "PRESET_AUDIO_2" => PresetSpeke20Audio::PresetAudio2,
            "PRESET_AUDIO_3" => PresetSpeke20Audio::PresetAudio3,
            "SHARED" => PresetSpeke20Audio::Shared,
            "UNENCRYPTED" => PresetSpeke20Audio::Unencrypted,
            other => PresetSpeke20Audio::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PresetSpeke20Audio {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PresetSpeke20Audio::from(s))
    }
}
impl PresetSpeke20Audio {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PresetSpeke20Audio::PresetAudio1 => "PRESET_AUDIO_1",
            PresetSpeke20Audio::PresetAudio2 => "PRESET_AUDIO_2",
            PresetSpeke20Audio::PresetAudio3 => "PRESET_AUDIO_3",
