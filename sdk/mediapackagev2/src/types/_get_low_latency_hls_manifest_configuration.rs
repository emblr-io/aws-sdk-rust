...
impl GetLowLatencyHlsManifestConfiguration {
    ...
    pub fn builder() -> crate::types::builders::GetLowLatencyHlsManifestConfigurationBuilder {
        crate::types::builders::GetLowLatencyHlsManifestConfigurationBuilder::default()
    }
}

/// A builder for [`GetLowLatencyHlsManifestConfiguration`](crate::types::GetLowLatencyHlsManifestConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetLowLatencyHlsManifestConfigurationBuilder {
