...
impl ::aws_types::request_id::RequestId for DeleteXssMatchSetOutput {
...
impl DeleteXssMatchSetOutputBuilder {
    /// <p>The <code>ChangeToken</code> that you used to submit the <code>DeleteXssMatchSet</code> request. You can also use this value to query the status of the request. For more information, see <code>GetChangeTokenStatus</code>.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteXssMatchSetOutput`](crate::operation::delete_xss_match_set::DeleteXssMatchSetOutput).
    pub fn build(self) -> crate::operation::delete_xss_match_set::DeleteXssMatchSetOutput {
