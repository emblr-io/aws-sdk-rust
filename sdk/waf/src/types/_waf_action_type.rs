...
impl ::std::convert::From<&str> for WafActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WafActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WafActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WafActionType::from(s))
    }
}
impl WafActionType {
...
impl ::std::convert::AsRef<str> for WafActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
