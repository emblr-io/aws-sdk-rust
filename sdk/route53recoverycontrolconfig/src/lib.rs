...
//! aws-sdk-route53recoverycontrolconfig = "0.0.0-local"
...
//! offered by AWS Route53 Recovery Control Config. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Route53 Recovery Control Config.
...
/// let config = aws_sdk_route53recoverycontrolconfig::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for AWS Route53 Recovery Control Config.
pub mod config;
