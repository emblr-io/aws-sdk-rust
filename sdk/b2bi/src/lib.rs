...
//! offered by AWS B2B Data Interchange. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS B2B Data Interchange.
...
/// Configuration for AWS B2B Data Interchange.
pub mod config;
