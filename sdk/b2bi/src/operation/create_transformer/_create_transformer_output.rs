...
pub struct CreateTransformerOutput {
...
impl CreateTransformerOutput {
    /// Creates a new builder-style object to manufacture [`CreateTransformerOutput`](crate::operation::create_transformer::CreateTransformerOutput).
    pub fn builder() -> crate::operation::create_transformer::builders::CreateTransformerOutputBuilder {
        crate::operation::create_transformer::builders::CreateTransformerOutputBuilder::default()
    }
}
...
impl CreateTransformerOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateTransformerOutput`](crate::operation::create_transformer::CreateTransformerOutput).
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_transformer::CreateTransformerOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_transformer::CreateTransformerOutput {
            transformer_id: self.transformer_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "transformer_id",
                    "transformer_id was not specified but it is required when building CreateTransformerOutput",
                )
            })?,
            transformer_arn: self.transformer_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "transformer_arn",
                    "transformer_arn was not specified but it is required when building CreateTransformerOutput",
                )
            })?,
