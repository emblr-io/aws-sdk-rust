...
impl ::std::convert::From<&str> for TestCaseScenarioType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TestCaseScenarioType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TestCaseScenarioType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TestCaseScenarioType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TestCaseScenarioType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
