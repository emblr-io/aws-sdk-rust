...
impl ::std::convert::From<&str> for SuiteRunStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SuiteRunStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SuiteRunStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SuiteRunStatus::from(s))
    }
}
impl SuiteRunStatus {
...
impl ::std::convert::AsRef<str> for SuiteRunStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
