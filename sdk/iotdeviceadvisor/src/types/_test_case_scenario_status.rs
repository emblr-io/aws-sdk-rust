...
impl ::std::convert::From<&str> for TestCaseScenarioStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TestCaseScenarioStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TestCaseScenarioStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TestCaseScenarioStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TestCaseScenarioStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
