...
//! offered by AWS App Mesh. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS App Mesh.
...
/// For example, the [`CreateGatewayRoute`](crate::operation::create_gateway_route) operation has
/// a [`Client::create_gateway_route`], function which returns a builder for that operation.
...
/// Configuration for AWS App Mesh.
pub mod config;
