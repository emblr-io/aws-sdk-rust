...
impl ::aws_types::request_id::RequestId for DescribeMeshOutput {
...
impl DescribeMeshOutput {
    ...
    pub fn builder() -> crate::operation::describe_mesh::builders::DescribeMeshOutputBuilder {
        crate::operation::describe_mesh::builders::DescribeMeshOutputBuilder::default()
    }
}

/// A builder for [`DescribeMeshOutput`](crate::operation::describe_mesh::DescribeMeshOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeMeshOutputBuilder {
