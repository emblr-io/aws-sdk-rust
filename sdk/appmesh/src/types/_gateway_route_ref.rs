...
impl GatewayRouteRef {
    /// Creates a new builder-style object to manufacture [`GatewayRouteRef`](crate::types::GatewayRouteRef).
    pub fn builder() -> crate::types::builders::GatewayRouteRefBuilder {
        crate::types::builders::GatewayRouteRefBuilder::default()
    }
}
...
impl GatewayRouteRefBuilder {
    ...
    /// - [`mesh_name`](crate::types::builders::GatewayRouteRefBuilder::mesh_name)
    /// - [`gateway_route_name`](crate::types::builders::GatewayRouteRefBuilder::gateway_route_name)
    /// - [`virtual_gateway_name`](crate::types::builders::GatewayRouteRefBuilder::virtual_gateway_name)
    /// - [`mesh_owner`](crate::types::builders::GatewayRouteRefBuilder::mesh_owner)
    /// - [`resource_owner`](crate::types::builders::GatewayRouteRefBuilder::resource_owner)
    /// - [`arn`](crate::types::builders::GatewayRouteRefBuilder::arn)
