...
impl VirtualGatewayRef {
    /// Creates a new builder-style object to manufacture [`VirtualGatewayRef`](crate::types::VirtualGatewayRef).
    pub fn builder() -> crate::types::builders::VirtualGatewayRefBuilder {
        crate::types::builders::VirtualGatewayRefBuilder::default()
    }
}
