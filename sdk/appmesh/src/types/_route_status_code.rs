...
impl ::std::convert::From<&str> for RouteStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RouteStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RouteStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RouteStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RouteStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
