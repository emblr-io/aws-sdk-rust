...
impl ::std::convert::From<&str> for VirtualGatewayStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VirtualGatewayStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VirtualGatewayStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VirtualGatewayStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VirtualGatewayStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
