...
impl ::std::convert::From<&str> for VirtualNodeStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VirtualNodeStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VirtualNodeStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VirtualNodeStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VirtualNodeStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
