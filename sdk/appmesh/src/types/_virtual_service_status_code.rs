...
impl ::std::convert::From<&str> for VirtualServiceStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VirtualServiceStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VirtualServiceStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VirtualServiceStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VirtualServiceStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
