...
impl ::std::convert::From<&str> for MeshStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MeshStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MeshStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MeshStatusCode::from(s))
    }
}
impl MeshStatusCode {
...
impl ::std::convert::AsRef<str> for MeshStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
