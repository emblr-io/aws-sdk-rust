...
impl ::std::convert::From<&str> for DefaultGatewayRouteRewrite {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DefaultGatewayRouteRewrite::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DefaultGatewayRouteRewrite {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DefaultGatewayRouteRewrite::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DefaultGatewayRouteRewrite {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
