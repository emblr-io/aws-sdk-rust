...
impl ::std::convert::From<&str> for GatewayRouteStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GatewayRouteStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GatewayRouteStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GatewayRouteStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GatewayRouteStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
