...
impl ::std::convert::From<&str> for TcpRetryPolicyEvent {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TcpRetryPolicyEvent::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TcpRetryPolicyEvent {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TcpRetryPolicyEvent::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TcpRetryPolicyEvent {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TcpRetryPolicyEvent {
