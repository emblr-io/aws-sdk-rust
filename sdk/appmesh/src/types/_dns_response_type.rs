...
impl ::std::convert::From<&str> for DnsResponseType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DnsResponseType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DnsResponseType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DnsResponseType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DnsResponseType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DnsResponseType {
