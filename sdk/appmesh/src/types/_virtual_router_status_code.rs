...
impl ::std::convert::From<&str> for VirtualRouterStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VirtualRouterStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VirtualRouterStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VirtualRouterStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VirtualRouterStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
