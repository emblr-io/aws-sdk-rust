...
impl ::std::convert::From<&str> for VirtualGatewayListenerTlsMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VirtualGatewayListenerTlsMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VirtualGatewayListenerTlsMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VirtualGatewayListenerTlsMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VirtualGatewayListenerTlsMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for VirtualGatewayListenerTlsMode {
