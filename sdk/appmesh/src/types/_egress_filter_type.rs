...
impl ::std::convert::From<&str> for EgressFilterType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EgressFilterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EgressFilterType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EgressFilterType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EgressFilterType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
