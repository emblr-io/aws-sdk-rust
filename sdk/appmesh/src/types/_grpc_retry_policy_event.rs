...
impl ::std::convert::From<&str> for GrpcRetryPolicyEvent {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GrpcRetryPolicyEvent::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GrpcRetryPolicyEvent {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GrpcRetryPolicyEvent::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GrpcRetryPolicyEvent {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
