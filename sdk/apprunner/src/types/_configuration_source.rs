...
impl ::std::convert::From<&str> for ConfigurationSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigurationSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigurationSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigurationSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfigurationSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
