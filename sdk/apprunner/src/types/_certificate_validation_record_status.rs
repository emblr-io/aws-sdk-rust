...
impl ::std::convert::From<&str> for CertificateValidationRecordStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CertificateValidationRecordStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CertificateValidationRecordStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CertificateValidationRecordStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CertificateValidationRecordStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
