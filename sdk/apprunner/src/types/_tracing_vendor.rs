...
impl ::std::convert::From<&str> for TracingVendor {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TracingVendor::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TracingVendor {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TracingVendor::from(s))
    }
}
impl TracingVendor {
...
impl ::std::convert::AsRef<str> for TracingVendor {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TracingVendor {
