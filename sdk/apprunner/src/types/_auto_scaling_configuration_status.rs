...
impl ::std::convert::From<&str> for AutoScalingConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoScalingConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoScalingConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoScalingConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoScalingConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
