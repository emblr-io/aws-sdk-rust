...
impl ::std::convert::From<&str> for VpcConnectorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VpcConnectorStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VpcConnectorStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VpcConnectorStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VpcConnectorStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
