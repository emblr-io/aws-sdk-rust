...
impl ::std::convert::From<&str> for ImageRepositoryType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageRepositoryType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageRepositoryType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageRepositoryType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImageRepositoryType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
