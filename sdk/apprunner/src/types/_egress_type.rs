...
impl ::std::convert::From<&str> for EgressType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "VPC" => EgressType::Vpc,
            other => EgressType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EgressType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EgressType::from(s))
    }
}
impl EgressType {
...
impl ::std::convert::AsRef<str> for EgressType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
