...
impl ::std::convert::From<&str> for SourceCodeVersionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SourceCodeVersionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SourceCodeVersionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SourceCodeVersionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SourceCodeVersionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SourceCodeVersionType {
