...
impl ::std::convert::From<&str> for GroupingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupingType::from(s))
    }
}
impl GroupingType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            GroupingType::Group => "GROUP",
            GroupingType::Ungroup => "UNGROUP",
...
impl ::std::convert::AsRef<str> for GroupingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
