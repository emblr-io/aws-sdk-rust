...
impl ::std::convert::From<&str> for GroupLifecycleEventsStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupLifecycleEventsStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupLifecycleEventsStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupLifecycleEventsStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupLifecycleEventsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
