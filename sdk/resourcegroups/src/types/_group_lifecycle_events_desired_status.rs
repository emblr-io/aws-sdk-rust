...
impl ::std::convert::From<&str> for GroupLifecycleEventsDesiredStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupLifecycleEventsDesiredStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupLifecycleEventsDesiredStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupLifecycleEventsDesiredStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupLifecycleEventsDesiredStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
