...
impl ::std::convert::From<&str> for ResourceStatusValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceStatusValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceStatusValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceStatusValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceStatusValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
