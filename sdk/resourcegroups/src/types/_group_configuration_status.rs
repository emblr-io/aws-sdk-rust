...
impl ::std::convert::From<&str> for GroupConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
