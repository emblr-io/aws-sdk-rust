...
//! aws-sdk-resourcegroups = "0.0.0-local"
...
//! offered by AWS Resource Groups. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Resource Groups.
