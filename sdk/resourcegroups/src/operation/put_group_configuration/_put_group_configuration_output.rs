...
impl ::aws_types::request_id::RequestId for PutGroupConfigurationOutput {
...
impl PutGroupConfigurationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutGroupConfigurationOutput`](crate::operation::put_group_configuration::PutGroupConfigurationOutput).
    pub fn build(self) -> crate::operation::put_group_configuration::PutGroupConfigurationOutput {
