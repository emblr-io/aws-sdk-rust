...
impl ::std::convert::From<&str> for CreateLoggingConfigurationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CreateLoggingConfigurationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CreateLoggingConfigurationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CreateLoggingConfigurationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CreateLoggingConfigurationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CreateLoggingConfigurationState {
