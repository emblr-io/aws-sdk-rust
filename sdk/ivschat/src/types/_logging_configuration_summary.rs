...
impl LoggingConfigurationSummary {
    ...
    /// <p>The state of the logging configuration. When this is <code>ACTIVE</code>, the configuration is ready for logging chat content.</p>
    pub fn state(&self) -> ::std::option::Option<&crate::types::LoggingConfigurationState> {
        self.state.as_ref()
    }
    /// <p>Tags to attach to the resource. Array of maps, each of the form <code>string:string (key:value)</code>. See <a href="https://docs.aws.amazon.com/tag-editor/latest/userguide/best-practices-and-strats.html">Best practices and strategies</a> in <i>Tagging Amazon Web Services Resources and Tag Editor</i> for details, including restrictions that apply to tags and "Tag naming limits and requirements"; Amazon IVS Chat has no constraints on tags beyond what is documented there.</p>
...
impl LoggingConfigurationSummary {
    /// Creates a new builder-style object to manufacture [`LoggingConfigurationSummary`](crate::types::LoggingConfigurationSummary).
    pub fn builder() -> crate::types::builders::LoggingConfigurationSummaryBuilder {
        crate::types::builders::LoggingConfigurationSummaryBuilder::default()
    }
}

/// A builder for [`LoggingConfigurationSummary`](crate::types::LoggingConfigurationSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct LoggingConfigurationSummaryBuilder {
...
impl LoggingConfigurationSummaryBuilder {
    ...
    /// <p>The state of the logging configuration. When this is <code>ACTIVE</code>, the configuration is ready for logging chat content.</p>
    pub fn state(mut self, input: crate::types::LoggingConfigurationState) -> Self {
    ...
    /// <p>The state of the logging configuration. When this is <code>ACTIVE</code>, the configuration is ready for logging chat content.</p>
    pub fn get_state(&self) -> &::std::option::Option<crate::types::LoggingConfigurationState> {
        &self.state
    }
    ...
    /// Consumes the builder and constructs a [`LoggingConfigurationSummary`](crate::types::LoggingConfigurationSummary).
    pub fn build(self) -> crate::types::LoggingConfigurationSummary {
        crate::types::LoggingConfigurationSummary {
            arn: self.arn,
            id: self.id,
