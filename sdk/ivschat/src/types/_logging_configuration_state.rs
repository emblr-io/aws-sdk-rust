...
impl ::std::convert::From<&str> for LoggingConfigurationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoggingConfigurationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoggingConfigurationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoggingConfigurationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LoggingConfigurationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
