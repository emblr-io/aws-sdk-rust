...
impl ::std::convert::From<&str> for ScteMarkersSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScteMarkersSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScteMarkersSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScteMarkersSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScteMarkersSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
