...
impl ::std::convert::From<&str> for StreamOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StreamOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamOrder::from(s))
    }
}
impl StreamOrder {
...
impl ::std::convert::AsRef<str> for StreamOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
