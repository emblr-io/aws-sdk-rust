...
impl ::std::convert::From<&str> for EncryptionMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EncryptionMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncryptionMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncryptionMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EncryptionMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
