...
impl ::std::fmt::Display for PresetSpeke20Audio {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            PresetSpeke20Audio::PresetAudio1 => write!(f, "PRESET-AUDIO-1"),
            PresetSpeke20Audio::PresetAudio2 => write!(f, "PRESET-AUDIO-2"),
            PresetSpeke20Audio::PresetAudio3 => write!(f, "PRESET-AUDIO-3"),
