...
impl ::std::convert::From<&str> for AdMarkers {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AdMarkers::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AdMarkers {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AdMarkers::from(s))
    }
}
impl AdMarkers {
...
impl ::std::convert::AsRef<str> for AdMarkers {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
