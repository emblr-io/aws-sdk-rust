...
impl ListPackagingGroupsInputBuilder {
    /// Upper bound on number of records to return.
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_packaging_groups::ListPackagingGroupsInput, ::aws_smithy_types::error::operation::BuildError>
    {
