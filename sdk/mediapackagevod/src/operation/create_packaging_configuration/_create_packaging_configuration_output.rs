...
impl CreatePackagingConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`CreatePackagingConfigurationOutput`](crate::operation::create_packaging_configuration::CreatePackagingConfigurationOutput).
    pub fn builder() -> crate::operation::create_packaging_configuration::builders::CreatePackagingConfigurationOutputBuilder {
        crate::operation::create_packaging_configuration::builders::CreatePackagingConfigurationOutputBuilder::default()
    }
}
...
impl CreatePackagingConfigurationOutputBuilder {
    /// The ARN of the PackagingConfiguration.
    ...
    /// Consumes the builder and constructs a [`CreatePackagingConfigurationOutput`](crate::operation::create_packaging_configuration::CreatePackagingConfigurationOutput).
    pub fn build(self) -> crate::operation::create_packaging_configuration::CreatePackagingConfigurationOutput {
