...
impl ::std::convert::From<&str> for BlockerType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BlockerType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BlockerType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BlockerType::from(s))
    }
}
impl BlockerType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            BlockerType::Automated => "AUTOMATED",
...
impl ::std::convert::AsRef<str> for BlockerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
