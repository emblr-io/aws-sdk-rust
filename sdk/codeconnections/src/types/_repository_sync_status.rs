...
impl ::std::convert::From<&str> for RepositorySyncStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RepositorySyncStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RepositorySyncStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RepositorySyncStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RepositorySyncStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
