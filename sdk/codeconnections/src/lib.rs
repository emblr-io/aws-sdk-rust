...
//! as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-codeconnections` to
//! your project, add the following to your **Cargo.toml** file:
//!
//! ```toml
//! [dependencies]
//! aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
//! aws-sdk-codeconnections = "0.0.0-local"
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-codeconnections/latest/aws_sdk_codeconnections/client/struct.Client.html)
...
//! offered by AWS CodeConnections. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS CodeConnections.
...
/// For example, the [`CreateConnection`](crate::operation::create_connection) operation has
...
/// Configuration for AWS CodeConnections.
pub mod config;
