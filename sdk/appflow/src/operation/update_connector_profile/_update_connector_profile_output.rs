...
/// A builder for [`UpdateConnectorProfileOutput`](crate::operation::update_connector_profile::UpdateConnectorProfileOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateConnectorProfileOutputBuilder {
    pub(crate) connector_profile_arn: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl UpdateConnectorProfileOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the connector profile.</p>
