...
impl ::std::convert::From<&str> for OAuth2CustomPropType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OAuth2CustomPropType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OAuth2CustomPropType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OAuth2CustomPropType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OAuth2CustomPropType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
