...
impl GoogleAnalyticsConnectorProfileCredentials {
    /// Creates a new builder-style object to manufacture [`GoogleAnalyticsConnectorProfileCredentials`](crate::types::GoogleAnalyticsConnectorProfileCredentials).
    pub fn builder() -> crate::types::builders::GoogleAnalyticsConnectorProfileCredentialsBuilder {
        crate::types::builders::GoogleAnalyticsConnectorProfileCredentialsBuilder::default()
    }
}
...
impl GoogleAnalyticsConnectorProfileCredentialsBuilder {
    /// <p>The identifier for the desired client.</p>
    ...
    /// - [`client_id`](crate::types::builders::GoogleAnalyticsConnectorProfileCredentialsBuilder::client_id)
...
impl ::std::fmt::Debug for GoogleAnalyticsConnectorProfileCredentialsBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GoogleAnalyticsConnectorProfileCredentialsBuilder");
        formatter.field("client_id", &self.client_id);
        formatter.field("client_secret", &"*** Sensitive Data Redacted ***");
        formatter.field("access_token", &"*** Sensitive Data Redacted ***");
        formatter.field("refresh_token", &self.refresh_token);
