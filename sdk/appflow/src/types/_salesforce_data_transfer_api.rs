...
impl ::std::convert::From<&str> for SalesforceDataTransferApi {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SalesforceDataTransferApi::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SalesforceDataTransferApi {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SalesforceDataTransferApi::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SalesforceDataTransferApi {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SalesforceDataTransferApi {
