...
impl ::std::convert::From<&str> for PathPrefix {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PathPrefix::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PathPrefix {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PathPrefix::from(s))
    }
}
impl PathPrefix {
...
impl ::std::convert::AsRef<str> for PathPrefix {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
