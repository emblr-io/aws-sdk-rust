...
impl ::std::convert::From<&str> for PrefixFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PrefixFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PrefixFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PrefixFormat::from(s))
    }
}
impl PrefixFormat {
...
impl ::std::convert::AsRef<str> for PrefixFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
