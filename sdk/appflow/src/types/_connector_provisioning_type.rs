...
impl ::std::convert::From<&str> for ConnectorProvisioningType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectorProvisioningType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectorProvisioningType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectorProvisioningType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectorProvisioningType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
