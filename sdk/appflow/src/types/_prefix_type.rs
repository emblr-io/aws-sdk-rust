...
impl ::std::convert::From<&str> for PrefixType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PrefixType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PrefixType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PrefixType::from(s))
    }
}
impl PrefixType {
...
impl ::std::convert::AsRef<str> for PrefixType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
