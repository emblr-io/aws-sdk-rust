...
//! offered by AWS SSO Identity Store. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS SSO Identity Store.
...
/// Configuration for AWS SSO Identity Store.
pub mod config;
