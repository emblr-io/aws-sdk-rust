...
pub struct ListGroupMembershipsOutput {
    ...
    pub group_memberships: ::std::vec::Vec<crate::types::GroupMembership>,
...
impl ListGroupMembershipsOutput {
    /// <p>A list of <code>GroupMembership</code> objects in the group.</p>
    pub fn group_memberships(&self) -> &[crate::types::GroupMembership] {
        use std::ops::Deref;
        self.group_memberships.deref()
    }
    /// <p>The pagination token used for the <code>ListUsers</code>, <code>ListGroups</code>, and <code>ListGroupMemberships</code> API operations. This value is generated by the identity store service. It is returned in the API response if the total results are more than the size of one page. This token is also returned when it is used in the API request to search for the next page.</p>
...
impl ::aws_types::request_id::RequestId for ListGroupMembershipsOutput {
...
impl ListGroupMembershipsOutputBuilder {
    ...
    pub fn group_memberships(mut self, input: crate::types::GroupMembership) -> Self {
        ...
        v.push(input);
        self.group_memberships = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of <code>GroupMembership</code> objects in the group.</p>
    ...
    /// <p>A list of <code>GroupMembership</code> objects in the group.</p>
    pub fn get_group_memberships(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::GroupMembership>> {
    ...
    /// - [`group_memberships`](crate::operation::list_group_memberships::builders::ListGroupMembershipsOutputBuilder::group_memberships)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_group_memberships::ListGroupMembershipsOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_group_memberships::ListGroupMembershipsOutput {
            group_memberships: self.group_memberships.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "group_memberships",
                    "group_memberships was not specified but it is required when building ListGroupMembershipsOutput",
                )
            })?,
