...
//! offered by Amazon AppStream. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon AppStream.
...
/// Configuration for Amazon AppStream.
pub mod config;
