...
impl ::std::convert::From<&str> for UsageReportSchedule {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UsageReportSchedule::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UsageReportSchedule {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UsageReportSchedule::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UsageReportSchedule {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
