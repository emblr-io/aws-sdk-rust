...
impl ::std::convert::From<&str> for SessionConnectionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SessionConnectionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SessionConnectionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SessionConnectionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SessionConnectionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
