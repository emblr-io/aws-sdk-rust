...
impl ::std::convert::From<&str> for StreamView {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StreamView::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamView {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamView::from(s))
    }
}
impl StreamView {
...
impl ::std::convert::AsRef<str> for StreamView {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
