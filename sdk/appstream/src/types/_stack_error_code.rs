...
impl ::std::convert::From<&str> for StackErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackErrorCode::from(s))
    }
}
impl StackErrorCode {
...
impl ::std::convert::AsRef<str> for StackErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
