...
impl ::std::convert::From<&str> for AppVisibility {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppVisibility::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppVisibility {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppVisibility::from(s))
    }
}
impl AppVisibility {
...
impl ::std::convert::AsRef<str> for AppVisibility {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
