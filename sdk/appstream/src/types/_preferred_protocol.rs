...
impl ::std::convert::From<&str> for PreferredProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PreferredProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PreferredProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PreferredProtocol::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PreferredProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
