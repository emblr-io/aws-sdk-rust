...
impl ::std::convert::From<&str> for StorageConnectorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StorageConnectorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StorageConnectorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StorageConnectorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StorageConnectorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
