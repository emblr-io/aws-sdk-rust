...
impl ::std::convert::From<&str> for MessageAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MessageAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MessageAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MessageAction::from(s))
    }
}
impl MessageAction {
...
impl ::std::convert::AsRef<str> for MessageAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
