...
impl ::std::convert::From<&str> for VisibilityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VisibilityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VisibilityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VisibilityType::from(s))
    }
}
impl VisibilityType {
...
impl ::std::convert::AsRef<str> for VisibilityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
