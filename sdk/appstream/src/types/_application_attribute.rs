...
impl ::std::convert::From<&str> for ApplicationAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ApplicationAttribute {
