...
/// When writing a match expression against `AppBlockBuilderAttribute`, it is important to ensure
...
///
/// ```text
/// # let appblockbuilderattribute = unimplemented!();
/// match appblockbuilderattribute {
///     AppBlockBuilderAttribute::AccessEndpoints => { /* ... */ },
///     AppBlockBuilderAttribute::IamRoleArn => { /* ... */ },
///     AppBlockBuilderAttribute::VpcConfigurationSecurityGroupIds => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `appblockbuilderattribute` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `AppBlockBuilderAttribute::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `AppBlockBuilderAttribute::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `AppBlockBuilderAttribute::NewFeature` is defined.
/// Specifically, when `appblockbuilderattribute` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AppBlockBuilderAttribute::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AppBlockBuilderAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppBlockBuilderAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppBlockBuilderAttribute {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppBlockBuilderAttribute::from(s))
    }
}
impl AppBlockBuilderAttribute {
