...
pub struct DescribeAppBlockBuildersOutput {
    /// <p>The list that describes one or more app block builders.</p>
    pub app_block_builders: ::std::option::Option<::std::vec::Vec<crate::types::AppBlockBuilder>>,
...
impl ::aws_types::request_id::RequestId for DescribeAppBlockBuildersOutput {
...
impl DescribeAppBlockBuildersOutputBuilder {
    /// Appends an item to `app_block_builders`.
    ///
    /// To override the contents of this collection use [`set_app_block_builders`](Self::set_app_block_builders).
    ///
    /// <p>The list that describes one or more app block builders.</p>
    pub fn app_block_builders(mut self, input: crate::types::AppBlockBuilder) -> Self {
        let mut v = self.app_block_builders.unwrap_or_default();
        v.push(input);
        self.app_block_builders = ::std::option::Option::Some(v);
        self
    }
    /// <p>The list that describes one or more app block builders.</p>
