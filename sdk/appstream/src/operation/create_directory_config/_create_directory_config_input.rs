...
impl CreateDirectoryConfigInput {
    /// Creates a new builder-style object to manufacture [`CreateDirectoryConfigInput`](crate::operation::create_directory_config::CreateDirectoryConfigInput).
    pub fn builder() -> crate::operation::create_directory_config::builders::CreateDirectoryConfigInputBuilder {
        crate::operation::create_directory_config::builders::CreateDirectoryConfigInputBuilder::default()
    }
}
