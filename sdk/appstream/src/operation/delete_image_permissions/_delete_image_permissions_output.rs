...
impl ::aws_types::request_id::RequestId for DeleteImagePermissionsOutput {
...
impl DeleteImagePermissionsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteImagePermissionsOutput`](crate::operation::delete_image_permissions::DeleteImagePermissionsOutput).
    pub fn build(self) -> crate::operation::delete_image_permissions::DeleteImagePermissionsOutput {
