...
impl ::std::convert::From<&str> for Origination {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Origination::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Origination {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Origination::from(s))
    }
}
impl Origination {
...
impl ::std::convert::AsRef<str> for Origination {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
