...
///     ManifestLayout::DrmTopLevelCompact => { /* ... */ },
///     ManifestLayout::Full => { /* ... */ },
...
impl ::std::convert::From<&str> for ManifestLayout {
    fn from(s: &str) -> Self {
        match s {
            ...
            "DRM_TOP_LEVEL_COMPACT" => ManifestLayout::DrmTopLevelCompact,
            "FULL" => ManifestLayout::Full,
            other => ManifestLayout::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ManifestLayout {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ManifestLayout::from(s))
    }
}
impl ManifestLayout {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ManifestLayout::DrmTopLevelCompact => "DRM_TOP_LEVEL_COMPACT",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["COMPACT", "DRM_TOP_LEVEL_COMPACT", "FULL"]
    }
}
impl ::std::convert::AsRef<str> for ManifestLayout {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
