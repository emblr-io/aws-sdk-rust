...
impl OriginEndpoint {
    /// Creates a new builder-style object to manufacture [`OriginEndpoint`](crate::types::OriginEndpoint).
    pub fn builder() -> crate::types::builders::OriginEndpointBuilder {
        crate::types::builders::OriginEndpointBuilder::default()
    }
}

/// A builder for [`OriginEndpoint`](crate::types::OriginEndpoint).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct OriginEndpointBuilder {
...
impl OriginEndpointBuilder {
    ...
    /// Consumes the builder and constructs a [`OriginEndpoint`](crate::types::OriginEndpoint).
    pub fn build(self) -> crate::types::OriginEndpoint {
