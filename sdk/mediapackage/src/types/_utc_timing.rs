...
impl ::std::convert::From<&str> for UtcTiming {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NONE" => UtcTiming::None,
            other => UtcTiming::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UtcTiming {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UtcTiming::from(s))
    }
}
impl UtcTiming {
...
impl ::std::convert::AsRef<str> for UtcTiming {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
