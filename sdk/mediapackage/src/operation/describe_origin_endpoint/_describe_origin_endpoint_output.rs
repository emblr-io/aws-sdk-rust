...
impl DescribeOriginEndpointOutput {
    /// Creates a new builder-style object to manufacture [`DescribeOriginEndpointOutput`](crate::operation::describe_origin_endpoint::DescribeOriginEndpointOutput).
    pub fn builder() -> crate::operation::describe_origin_endpoint::builders::DescribeOriginEndpointOutputBuilder {
        crate::operation::describe_origin_endpoint::builders::DescribeOriginEndpointOutputBuilder::default()
    }
}
...
impl DescribeOriginEndpointOutputBuilder {
    /// The Amazon Resource Name (ARN) assigned to the OriginEndpoint.
    ...
    /// Consumes the builder and constructs a [`DescribeOriginEndpointOutput`](crate::operation::describe_origin_endpoint::DescribeOriginEndpointOutput).
    pub fn build(self) -> crate::operation::describe_origin_endpoint::DescribeOriginEndpointOutput {
        crate::operation::describe_origin_endpoint::DescribeOriginEndpointOutput {
            arn: self.arn,
