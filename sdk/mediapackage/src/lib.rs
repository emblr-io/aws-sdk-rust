...
//! aws-sdk-mediapackage = "0.0.0-local"
...
//! offered by AWS Elemental MediaPackage. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Elemental MediaPackage.
