...
impl ::std::convert::From<&str> for AzStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AzStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AzStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AzStatus::from(s))
    }
}
impl AzStatus {
...
impl ::std::convert::AsRef<str> for AzStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
