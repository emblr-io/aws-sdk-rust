...
impl ::std::convert::From<&str> for IpDiscovery {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpDiscovery::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpDiscovery {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpDiscovery::from(s))
    }
}
impl IpDiscovery {
...
impl ::std::convert::AsRef<str> for IpDiscovery {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
