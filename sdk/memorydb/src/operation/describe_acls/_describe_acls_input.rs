...
impl DescribeAcLsInput {
    /// Creates a new builder-style object to manufacture [`DescribeAcLsInput`](crate::operation::describe_acls::DescribeAcLsInput).
    pub fn builder() -> crate::operation::describe_acls::builders::DescribeAcLsInputBuilder {
        crate::operation::describe_acls::builders::DescribeAcLsInputBuilder::default()
    }
}

/// A builder for [`DescribeAcLsInput`](crate::operation::describe_acls::DescribeAcLsInput).
