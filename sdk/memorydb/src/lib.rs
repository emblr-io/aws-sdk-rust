...
//! offered by Amazon MemoryDB. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon MemoryDB.
...
/// For example, the [`CopySnapshot`](crate::operation::copy_snapshot) operation has
/// a [`Client::copy_snapshot`], function which returns a builder for that operation.
...
/// Configuration for Amazon MemoryDB.
pub mod config;
