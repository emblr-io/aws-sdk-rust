...
pub struct StartFlowFlushOutput {
...
impl ::aws_types::request_id::RequestId for StartFlowFlushOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartFlowFlushOutput {
    /// Creates a new builder-style object to manufacture [`StartFlowFlushOutput`](crate::operation::start_flow_flush::StartFlowFlushOutput).
    pub fn builder() -> crate::operation::start_flow_flush::builders::StartFlowFlushOutputBuilder {
        crate::operation::start_flow_flush::builders::StartFlowFlushOutputBuilder::default()
    }
}

/// A builder for [`StartFlowFlushOutput`](crate::operation::start_flow_flush::StartFlowFlushOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartFlowFlushOutputBuilder {
...
impl StartFlowFlushOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartFlowFlushOutput`](crate::operation::start_flow_flush::StartFlowFlushOutput).
    pub fn build(self) -> crate::operation::start_flow_flush::StartFlowFlushOutput {
