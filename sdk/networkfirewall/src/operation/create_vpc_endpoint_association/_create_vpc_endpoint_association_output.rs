...
pub struct CreateVpcEndpointAssociationOutput {
...
impl CreateVpcEndpointAssociationOutput {
    /// <p>The configuration settings for the VPC endpoint association. These settings include the firewall and the VPC and subnet to use for the firewall endpoint.</p>
...
impl ::aws_types::request_id::RequestId for CreateVpcEndpointAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateVpcEndpointAssociationOutput {
    /// Creates a new builder-style object to manufacture [`CreateVpcEndpointAssociationOutput`](crate::operation::create_vpc_endpoint_association::CreateVpcEndpointAssociationOutput).
    pub fn builder() -> crate::operation::create_vpc_endpoint_association::builders::CreateVpcEndpointAssociationOutputBuilder {
        crate::operation::create_vpc_endpoint_association::builders::CreateVpcEndpointAssociationOutputBuilder::default()
    }
}

/// A builder for [`CreateVpcEndpointAssociationOutput`](crate::operation::create_vpc_endpoint_association::CreateVpcEndpointAssociationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateVpcEndpointAssociationOutputBuilder {
...
impl CreateVpcEndpointAssociationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateVpcEndpointAssociationOutput`](crate::operation::create_vpc_endpoint_association::CreateVpcEndpointAssociationOutput).
    pub fn build(self) -> crate::operation::create_vpc_endpoint_association::CreateVpcEndpointAssociationOutput {
