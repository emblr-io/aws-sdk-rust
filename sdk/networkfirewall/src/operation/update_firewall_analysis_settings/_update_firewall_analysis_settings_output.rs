...
pub struct UpdateFirewallAnalysisSettingsOutput {
...
impl UpdateFirewallAnalysisSettingsOutput {
    /// <p>An optional setting indicating the specific traffic analysis types to enable on the firewall.</p>
    ///
...
impl ::aws_types::request_id::RequestId for UpdateFirewallAnalysisSettingsOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateFirewallAnalysisSettingsOutput {
    /// Creates a new builder-style object to manufacture [`UpdateFirewallAnalysisSettingsOutput`](crate::operation::update_firewall_analysis_settings::UpdateFirewallAnalysisSettingsOutput).
    pub fn builder() -> crate::operation::update_firewall_analysis_settings::builders::UpdateFirewallAnalysisSettingsOutputBuilder {
        crate::operation::update_firewall_analysis_settings::builders::UpdateFirewallAnalysisSettingsOutputBuilder::default()
    }
}

/// A builder for [`UpdateFirewallAnalysisSettingsOutput`](crate::operation::update_firewall_analysis_settings::UpdateFirewallAnalysisSettingsOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateFirewallAnalysisSettingsOutputBuilder {
...
impl UpdateFirewallAnalysisSettingsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateFirewallAnalysisSettingsOutput`](crate::operation::update_firewall_analysis_settings::UpdateFirewallAnalysisSettingsOutput).
    pub fn build(self) -> crate::operation::update_firewall_analysis_settings::UpdateFirewallAnalysisSettingsOutput {
