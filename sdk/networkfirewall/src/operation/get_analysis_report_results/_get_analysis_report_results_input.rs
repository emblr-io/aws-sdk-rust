...
pub struct GetAnalysisReportResultsInput {
...
impl GetAnalysisReportResultsInput {
    /// <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>
    /// <p>You must specify the ARN or the name, and you can specify both.</p>
...
impl GetAnalysisReportResultsInput {
    /// Creates a new builder-style object to manufacture [`GetAnalysisReportResultsInput`](crate::operation::get_analysis_report_results::GetAnalysisReportResultsInput).
    pub fn builder() -> crate::operation::get_analysis_report_results::builders::GetAnalysisReportResultsInputBuilder {
        crate::operation::get_analysis_report_results::builders::GetAnalysisReportResultsInputBuilder::default()
    }
}

/// A builder for [`GetAnalysisReportResultsInput`](crate::operation::get_analysis_report_results::GetAnalysisReportResultsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetAnalysisReportResultsInputBuilder {
...
impl GetAnalysisReportResultsInputBuilder {
    /// <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>
    /// <p>You must specify the ARN or the name, and you can specify both.</p>
    ...
    /// Consumes the builder and constructs a [`GetAnalysisReportResultsInput`](crate::operation::get_analysis_report_results::GetAnalysisReportResultsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::get_analysis_report_results::GetAnalysisReportResultsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::get_analysis_report_results::GetAnalysisReportResultsInput {
