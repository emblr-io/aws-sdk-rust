...
impl PortSet {
    /// Creates a new builder-style object to manufacture [`PortSet`](crate::types::PortSet).
    pub fn builder() -> crate::types::builders::PortSetBuilder {
        crate::types::builders::PortSetBuilder::default()
    }
}
