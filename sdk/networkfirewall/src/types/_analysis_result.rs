...
/// <p>The <code>AnalysisResult</code> data type is not related to traffic analysis reports you generate using <code>StartAnalysisReport</code>. For information on traffic analysis report results, see <code>AnalysisTypeReportResult</code>.</p>
#[non_exhaustive]
