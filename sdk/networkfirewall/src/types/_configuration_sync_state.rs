...
impl ::std::convert::From<&str> for ConfigurationSyncState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfigurationSyncState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfigurationSyncState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfigurationSyncState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfigurationSyncState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
