...
impl ::std::convert::From<&str> for OverrideAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OverrideAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OverrideAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OverrideAction::from(s))
    }
}
impl OverrideAction {
...
impl ::std::convert::AsRef<str> for OverrideAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
