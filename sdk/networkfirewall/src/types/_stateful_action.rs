...
impl ::std::convert::From<&str> for StatefulAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatefulAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatefulAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatefulAction::from(s))
    }
}
impl StatefulAction {
...
impl ::std::convert::AsRef<str> for StatefulAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
