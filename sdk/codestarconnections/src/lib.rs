...
//! offered by AWS CodeStar connections. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS CodeStar connections.
...
/// Configuration for AWS CodeStar connections.
pub mod config;
