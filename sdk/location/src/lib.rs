...
//! offered by Amazon Location Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Location Service.
...
/// For example, the [`AssociateTrackerConsumer`](crate::operation::associate_tracker_consumer) operation has
/// a [`Client::associate_tracker_consumer`], function which returns a builder for that operation.
...
/// Configuration for Amazon Location Service.
pub mod config;
