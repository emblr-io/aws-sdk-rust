...
impl DevicePosition {
    /// Creates a new builder-style object to manufacture [`DevicePosition`](crate::types::DevicePosition).
    pub fn builder() -> crate::types::builders::DevicePositionBuilder {
        crate::types::builders::DevicePositionBuilder::default()
    }
}
