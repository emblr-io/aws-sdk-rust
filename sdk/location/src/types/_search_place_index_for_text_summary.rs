...
impl SearchPlaceIndexForTextSummary {
    ...
    /// </note>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.result_b_box.is_none()`.
    pub fn result_b_box(&self) -> &[f64] {
        self.result_b_box.as_deref().unwrap_or_default()
    }
    /// <p>The geospatial data provider attached to the place index resource specified in the request. Values can be one of the following:</p>
    /// <ul>
    /// <li>
...
impl SearchPlaceIndexForTextSummary {
    /// Creates a new builder-style object to manufacture [`SearchPlaceIndexForTextSummary`](crate::types::SearchPlaceIndexForTextSummary).
    pub fn builder() -> crate::types::builders::SearchPlaceIndexForTextSummaryBuilder {
        crate::types::builders::SearchPlaceIndexForTextSummaryBuilder::default()
    }
}

/// A builder for [`SearchPlaceIndexForTextSummary`](crate::types::SearchPlaceIndexForTextSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct SearchPlaceIndexForTextSummaryBuilder {
...
impl ::std::fmt::Debug for SearchPlaceIndexForTextSummaryBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("SearchPlaceIndexForTextSummaryBuilder");
        formatter.field("text", &"*** Sensitive Data Redacted ***");
        formatter.field("bias_position", &"*** Sensitive Data Redacted ***");
        formatter.field("filter_b_box", &"*** Sensitive Data Redacted ***");
        formatter.field("filter_countries", &self.filter_countries);
