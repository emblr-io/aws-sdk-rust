...
/// <ul>
/// <li>
/// <p>If using HERE Technologies as a data provider, you can't store results for locations in Japan by setting <code>IntendedUse</code> to <code>Storage</code>. parameter.</p></li>
/// <li>
/// <p>Under the <code>MobileAssetTracking</code> or <code>MobilAssetManagement</code> pricing plan, you can't store results from your place index resources by setting <code>IntendedUse</code> to <code>Storage</code>. This returns a validation exception error.</p></li>
/// </ul>
...
pub struct DataSourceConfiguration {
    ...
    /// <ul>
    /// <li>
    /// <p><code>SingleUse</code> specifies that the results won't be stored.</p></li>
    /// <li>
