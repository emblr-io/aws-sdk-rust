...
impl ListMapsInput {
    /// Creates a new builder-style object to manufacture [`ListMapsInput`](crate::operation::list_maps::ListMapsInput).
    pub fn builder() -> crate::operation::list_maps::builders::ListMapsInputBuilder {
        crate::operation::list_maps::builders::ListMapsInputBuilder::default()
    }
}
