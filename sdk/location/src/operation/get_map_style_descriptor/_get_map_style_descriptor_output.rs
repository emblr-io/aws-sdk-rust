...
impl GetMapStyleDescriptorOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetMapStyleDescriptorOutput`](crate::operation::get_map_style_descriptor::GetMapStyleDescriptorOutput).
    pub fn build(self) -> crate::operation::get_map_style_descriptor::GetMapStyleDescriptorOutput {
