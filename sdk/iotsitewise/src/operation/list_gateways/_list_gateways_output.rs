...
impl ListGatewaysOutputBuilder {
    ...
    pub fn gateway_summaries(mut self, input: crate::types::GatewaySummary) -> Self {
        ...
        v.push(input);
        self.gateway_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list that summarizes each gateway.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_gateways::ListGatewaysOutput, ::aws_smithy_types::error::operation::BuildError> {
