...
impl ::aws_types::request_id::RequestId for ListAssociatedAssetsOutput {
...
impl ListAssociatedAssetsOutputBuilder {
    ...
    ///
    /// <p>A list that summarizes the associated assets.</p>
    pub fn asset_summaries(mut self, input: crate::types::AssociatedAssetsSummary) -> Self {
        let mut v = self.asset_summaries.unwrap_or_default();
        v.push(input);
        self.asset_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list that summarizes the associated assets.</p>
