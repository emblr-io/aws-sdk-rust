...
impl ::aws_types::request_id::RequestId for DeleteAccessPolicyOutput {
...
impl DeleteAccessPolicyOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteAccessPolicyOutput`](crate::operation::delete_access_policy::DeleteAccessPolicyOutput).
    pub fn build(self) -> crate::operation::delete_access_policy::DeleteAccessPolicyOutput {
