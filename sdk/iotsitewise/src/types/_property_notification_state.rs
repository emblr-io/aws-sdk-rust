...
impl ::std::convert::From<&str> for PropertyNotificationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PropertyNotificationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PropertyNotificationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PropertyNotificationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PropertyNotificationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
