...
impl ::std::convert::From<&str> for Quality {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Quality::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Quality {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Quality::from(s))
    }
}
impl Quality {
...
impl ::std::convert::AsRef<str> for Quality {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
