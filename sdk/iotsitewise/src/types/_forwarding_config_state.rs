...
impl ::std::convert::From<&str> for ForwardingConfigState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ForwardingConfigState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ForwardingConfigState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ForwardingConfigState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ForwardingConfigState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
