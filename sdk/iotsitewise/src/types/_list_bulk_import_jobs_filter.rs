...
impl ::std::convert::From<&str> for ListBulkImportJobsFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListBulkImportJobsFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListBulkImportJobsFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListBulkImportJobsFilter::from(s))
    }
}
