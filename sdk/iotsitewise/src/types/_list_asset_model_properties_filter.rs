...
impl ::std::convert::From<&str> for ListAssetModelPropertiesFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListAssetModelPropertiesFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListAssetModelPropertiesFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListAssetModelPropertiesFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListAssetModelPropertiesFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ListAssetModelPropertiesFilter {
