...
impl ::std::convert::From<&str> for AssetErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssetErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssetErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssetErrorCode::from(s))
    }
}
impl AssetErrorCode {
...
impl ::std::convert::AsRef<str> for AssetErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
