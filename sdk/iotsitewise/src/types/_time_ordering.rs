...
impl ::std::convert::From<&str> for TimeOrdering {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimeOrdering::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimeOrdering {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimeOrdering::from(s))
    }
}
impl TimeOrdering {
...
impl ::std::convert::AsRef<str> for TimeOrdering {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
