...
impl ::std::convert::From<&str> for ComputeLocation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComputeLocation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ComputeLocation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ComputeLocation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ComputeLocation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
