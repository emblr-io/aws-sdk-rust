...
impl ::std::convert::From<&str> for MonitorErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitorErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitorErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitorErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitorErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
