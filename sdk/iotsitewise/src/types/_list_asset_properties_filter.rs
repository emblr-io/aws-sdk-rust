...
impl ::std::convert::From<&str> for ListAssetPropertiesFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListAssetPropertiesFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListAssetPropertiesFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListAssetPropertiesFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListAssetPropertiesFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ListAssetPropertiesFilter {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ListAssetPropertiesFilter::All => write!(f, "ALL"),
            ListAssetPropertiesFilter::Base => write!(f, "BASE"),
            ListAssetPropertiesFilter::Unknown(value) => write!(f, "{}", value),
        }
    }
}
