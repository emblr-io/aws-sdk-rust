...
impl ::std::convert::From<&str> for TraversalDirection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TraversalDirection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TraversalDirection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TraversalDirection::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TraversalDirection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
