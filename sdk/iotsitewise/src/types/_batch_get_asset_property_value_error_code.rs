...
impl ::std::convert::From<&str> for BatchGetAssetPropertyValueErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchGetAssetPropertyValueErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchGetAssetPropertyValueErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchGetAssetPropertyValueErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchGetAssetPropertyValueErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BatchGetAssetPropertyValueErrorCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            BatchGetAssetPropertyValueErrorCode::AccessDeniedException => write!(f, "AccessDeniedException"),
            BatchGetAssetPropertyValueErrorCode::InvalidRequestException => write!(f, "InvalidRequestException"),
            BatchGetAssetPropertyValueErrorCode::ResourceNotFoundException => write!(f, "ResourceNotFoundException"),
            BatchGetAssetPropertyValueErrorCode::Unknown(value) => write!(f, "{}", value),
        }
    }
}
