...
impl ::std::convert::From<&str> for TraversalType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TraversalType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TraversalType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TraversalType::from(s))
    }
}
impl TraversalType {
...
impl ::std::convert::AsRef<str> for TraversalType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
