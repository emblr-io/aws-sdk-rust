...
impl ::std::convert::From<&str> for DetailedErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DetailedErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DetailedErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DetailedErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DetailedErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
