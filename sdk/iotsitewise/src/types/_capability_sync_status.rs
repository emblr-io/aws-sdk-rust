...
impl ::std::convert::From<&str> for CapabilitySyncStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CapabilitySyncStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CapabilitySyncStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CapabilitySyncStatus::from(s))
    }
}
