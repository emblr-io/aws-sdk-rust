...
impl ::std::convert::From<&str> for AssetState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssetState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssetState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssetState::from(s))
    }
}
impl AssetState {
...
impl ::std::fmt::Display for AssetState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            AssetState::Creating => write!(f, "CREATING"),
