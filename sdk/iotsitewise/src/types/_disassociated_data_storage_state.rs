...
impl ::std::convert::From<&str> for DisassociatedDataStorageState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DisassociatedDataStorageState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DisassociatedDataStorageState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DisassociatedDataStorageState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DisassociatedDataStorageState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
