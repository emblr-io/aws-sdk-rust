...
impl ::std::convert::From<&str> for BatchGetAssetPropertyAggregatesErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchGetAssetPropertyAggregatesErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchGetAssetPropertyAggregatesErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchGetAssetPropertyAggregatesErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchGetAssetPropertyAggregatesErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
