...
impl ::std::convert::From<&str> for AssetRelationshipType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssetRelationshipType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssetRelationshipType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssetRelationshipType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssetRelationshipType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
