...
impl ::std::convert::From<&str> for ImageFileType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageFileType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageFileType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageFileType::from(s))
    }
}
impl ImageFileType {
...
impl ::std::convert::AsRef<str> for ImageFileType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
