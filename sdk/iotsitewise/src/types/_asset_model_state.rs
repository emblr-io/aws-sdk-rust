...
impl ::std::convert::From<&str> for AssetModelState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssetModelState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssetModelState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssetModelState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssetModelState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
