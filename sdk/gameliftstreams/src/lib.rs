...
//! offered by Amazon GameLift Streams. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon GameLift Streams.
...
/// For example, the [`AddStreamGroupLocations`](crate::operation::add_stream_group_locations) operation has
/// a [`Client::add_stream_group_locations`], function which returns a builder for that operation.
...
/// Configuration for Amazon GameLift Streams.
pub mod config;
