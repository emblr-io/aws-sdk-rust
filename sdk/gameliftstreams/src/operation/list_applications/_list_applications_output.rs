...
pub struct ListApplicationsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::ApplicationSummary>>,
...
impl ListApplicationsOutput {
    ...
    pub fn items(&self) -> &[crate::types::ApplicationSummary] {
...
pub struct ListApplicationsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::ApplicationSummary>>,
...
impl ListApplicationsOutputBuilder {
    ...
    ///
    /// <p>A collection of Amazon GameLift Streams applications that are associated with the Amazon Web Services account in use. Each item includes application metadata and status.</p>
    pub fn items(mut self, input: crate::types::ApplicationSummary) -> Self {
    ...
    /// <p>A collection of Amazon GameLift Streams applications that are associated with the Amazon Web Services account in use. Each item includes application metadata and status.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ApplicationSummary>>) -> Self {
        self.items = input;
        self
    }
    /// <p>A collection of Amazon GameLift Streams applications that are associated with the Amazon Web Services account in use. Each item includes application metadata and status.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ApplicationSummary>> {
        &self.items
    }
    /// <p>A token that marks the start of the next sequential page of results. If an operation doesn't return a token, you've reached the end of the list.</p>
