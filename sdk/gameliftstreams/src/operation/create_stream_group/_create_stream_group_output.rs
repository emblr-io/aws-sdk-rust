...
pub struct CreateStreamGroupOutput {
...
impl ::aws_types::request_id::RequestId for CreateStreamGroupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateStreamGroupOutput {
    /// Creates a new builder-style object to manufacture [`CreateStreamGroupOutput`](crate::operation::create_stream_group::CreateStreamGroupOutput).
    pub fn builder() -> crate::operation::create_stream_group::builders::CreateStreamGroupOutputBuilder {
        crate::operation::create_stream_group::builders::CreateStreamGroupOutputBuilder::default()
    }
}

/// A builder for [`CreateStreamGroupOutput`](crate::operation::create_stream_group::CreateStreamGroupOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateStreamGroupOutputBuilder {
...
impl CreateStreamGroupOutputBuilder {
    /// <p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html">Amazon Resource Name (ARN)</a> that is assigned to the stream group resource and that uniquely identifies the group across all Amazon Web Services Regions. Format is <code>arn:aws:gameliftstreams:\[AWS Region\]:\[AWS account\]:streamgroup/\[resource ID\]</code>.</p>
    ...
    /// Consumes the builder and constructs a [`CreateStreamGroupOutput`](crate::operation::create_stream_group::CreateStreamGroupOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`arn`](crate::operation::create_stream_group::builders::CreateStreamGroupOutputBuilder::arn)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_stream_group::CreateStreamGroupOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_stream_group::CreateStreamGroupOutput {
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building CreateStreamGroupOutput",
                )
            })?,
