...
//! offered by Amazon SageMaker Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon SageMaker Service.
...
/// Configuration for Amazon SageMaker Service.
pub mod config;
