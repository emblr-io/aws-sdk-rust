...
impl ::aws_types::request_id::RequestId for DeleteImageVersionOutput {
...
impl DeleteImageVersionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteImageVersionOutput`](crate::operation::delete_image_version::DeleteImageVersionOutput).
    pub fn build(self) -> crate::operation::delete_image_version::DeleteImageVersionOutput {
        crate::operation::delete_image_version::DeleteImageVersionOutput {
