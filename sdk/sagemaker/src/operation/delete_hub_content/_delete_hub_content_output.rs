...
impl ::aws_types::request_id::RequestId for DeleteHubContentOutput {
...
impl DeleteHubContentOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteHubContentOutput`](crate::operation::delete_hub_content::DeleteHubContentOutput).
    pub fn build(self) -> crate::operation::delete_hub_content::DeleteHubContentOutput {
