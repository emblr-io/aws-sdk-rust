...
pub struct CreateClusterSchedulerConfigOutput {
...
impl CreateClusterSchedulerConfigOutput {
    /// <p>ARN of the cluster policy.</p>
...
impl ::aws_types::request_id::RequestId for CreateClusterSchedulerConfigOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateClusterSchedulerConfigOutput {
    /// Creates a new builder-style object to manufacture [`CreateClusterSchedulerConfigOutput`](crate::operation::create_cluster_scheduler_config::CreateClusterSchedulerConfigOutput).
    pub fn builder() -> crate::operation::create_cluster_scheduler_config::builders::CreateClusterSchedulerConfigOutputBuilder {
        crate::operation::create_cluster_scheduler_config::builders::CreateClusterSchedulerConfigOutputBuilder::default()
    }
}

/// A builder for [`CreateClusterSchedulerConfigOutput`](crate::operation::create_cluster_scheduler_config::CreateClusterSchedulerConfigOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateClusterSchedulerConfigOutputBuilder {
...
impl CreateClusterSchedulerConfigOutputBuilder {
    /// <p>ARN of the cluster policy.</p>
    ...
    /// Consumes the builder and constructs a [`CreateClusterSchedulerConfigOutput`](crate::operation::create_cluster_scheduler_config::CreateClusterSchedulerConfigOutput).
    pub fn build(self) -> crate::operation::create_cluster_scheduler_config::CreateClusterSchedulerConfigOutput {
