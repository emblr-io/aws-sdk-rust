...
impl ::aws_types::request_id::RequestId for ListWorkteamsOutput {
...
impl ListWorkteamsOutputBuilder {
    ...
    pub fn workteams(mut self, input: crate::types::Workteam) -> Self {
        ...
        v.push(input);
        self.workteams = ::std::option::Option::Some(v);
        self
    }
    /// <p>An array of <code>Workteam</code> objects, each describing a work team.</p>
    ...
    /// <p>An array of <code>Workteam</code> objects, each describing a work team.</p>
    pub fn get_workteams(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Workteam>> {
        &self.workteams
    }
    /// <p>If the response is truncated, Amazon SageMaker returns this token. To retrieve the next set of work teams, use it in the subsequent request.</p>
