...
impl ::aws_types::request_id::RequestId for DeleteFeatureGroupOutput {
...
impl DeleteFeatureGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteFeatureGroupOutput`](crate::operation::delete_feature_group::DeleteFeatureGroupOutput).
    pub fn build(self) -> crate::operation::delete_feature_group::DeleteFeatureGroupOutput {
