...
impl DeleteTrialOutput {
    /// Creates a new builder-style object to manufacture [`DeleteTrialOutput`](crate::operation::delete_trial::DeleteTrialOutput).
    pub fn builder() -> crate::operation::delete_trial::builders::DeleteTrialOutputBuilder {
        crate::operation::delete_trial::builders::DeleteTrialOutputBuilder::default()
    }
}

/// A builder for [`DeleteTrialOutput`](crate::operation::delete_trial::DeleteTrialOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteTrialOutputBuilder {
    pub(crate) trial_arn: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl DeleteTrialOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the trial that is being deleted.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteTrialOutput`](crate::operation::delete_trial::DeleteTrialOutput).
    pub fn build(self) -> crate::operation::delete_trial::DeleteTrialOutput {
