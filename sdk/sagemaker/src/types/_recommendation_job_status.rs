...
impl ::std::convert::From<&str> for RecommendationJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecommendationJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecommendationJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecommendationJobStatus::from(s))
    }
}
