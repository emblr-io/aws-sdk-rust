...
impl ::std::convert::From<&str> for ProjectSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProjectSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProjectSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProjectSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProjectSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
