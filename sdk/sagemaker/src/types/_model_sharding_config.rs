...
impl ModelShardingConfig {
    /// Creates a new builder-style object to manufacture [`ModelShardingConfig`](crate::types::ModelShardingConfig).
    pub fn builder() -> crate::types::builders::ModelShardingConfigBuilder {
        crate::types::builders::ModelShardingConfigBuilder::default()
    }
}

/// A builder for [`ModelShardingConfig`](crate::types::ModelShardingConfig).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ModelShardingConfigBuilder {
    pub(crate) image: ::std::option::Option<::std::string::String>,
    pub(crate) override_environment: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
}
impl ModelShardingConfigBuilder {
    /// <p>The URI of an LMI DLC in Amazon ECR. SageMaker uses this image to run the optimization.</p>
    ...
    /// Consumes the builder and constructs a [`ModelShardingConfig`](crate::types::ModelShardingConfig).
    pub fn build(self) -> crate::types::ModelShardingConfig {
        crate::types::ModelShardingConfig {
            image: self.image,
