...
impl ::std::convert::From<&str> for AppSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppSortKey::from(s))
    }
}
impl AppSortKey {
...
impl ::std::convert::AsRef<str> for AppSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
