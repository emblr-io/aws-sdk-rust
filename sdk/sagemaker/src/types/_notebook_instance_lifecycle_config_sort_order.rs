...
impl ::std::convert::From<&str> for NotebookInstanceLifecycleConfigSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotebookInstanceLifecycleConfigSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotebookInstanceLifecycleConfigSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotebookInstanceLifecycleConfigSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NotebookInstanceLifecycleConfigSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
