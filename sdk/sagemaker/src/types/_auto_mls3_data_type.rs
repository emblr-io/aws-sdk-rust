...
impl ::std::convert::From<&str> for AutoMls3DataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMls3DataType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMls3DataType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMls3DataType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoMls3DataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
