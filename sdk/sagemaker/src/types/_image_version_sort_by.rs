...
impl ::std::convert::From<&str> for ImageVersionSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageVersionSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageVersionSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageVersionSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImageVersionSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
