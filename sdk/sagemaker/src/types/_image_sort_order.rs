...
impl ::std::convert::From<&str> for ImageSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageSortOrder::from(s))
    }
}
impl ImageSortOrder {
...
impl ::std::convert::AsRef<str> for ImageSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
