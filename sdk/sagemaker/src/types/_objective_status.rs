...
impl ::std::convert::From<&str> for ObjectiveStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ObjectiveStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ObjectiveStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ObjectiveStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ObjectiveStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
