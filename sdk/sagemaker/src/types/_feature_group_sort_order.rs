...
impl ::std::convert::From<&str> for FeatureGroupSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeatureGroupSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeatureGroupSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeatureGroupSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FeatureGroupSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
