...
pub struct InputConfig {
    ...
    /// <ul>
    /// <li>
    /// <p><code>TensorFlow</code>: You must specify the name and shape (NHWC format) of the expected data inputs using a dictionary format for your trained model. The dictionary formats required for the console and CLI are different.</p>
    /// <ul>
    /// <li>
    ...
    /// </ul></li>
    /// <li>
    /// <p><code>MXNET/ONNX/DARKNET</code>: You must specify the name and shape (NCHW format) of the expected data inputs in order using a dictionary format for your trained model. The dictionary formats required for the console and CLI are different.</p>
    /// <ul>
    /// <li>
    /// <p>Examples for one input:</p>
    /// <ul>
    ...
    /// <li>
    /// <p><code>bias</code>: If the input type is an Image, you need to provide the bias vector.</p></li>
    /// <li>
    /// <p><code>scale</code>: If the input type is an Image, you need to provide a scale factor.</p></li>
    /// </ul>
