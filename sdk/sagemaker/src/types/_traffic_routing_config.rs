...
pub struct TrafficRoutingConfig {
    ...
    /// <ul>
    /// <li>
    /// <p><code>ALL_AT_ONCE</code>: Endpoint traffic shifts to the new fleet in a single step.</p></li>
    /// <li>
    /// <p><code>CANARY</code>: Endpoint traffic shifts to the new fleet in two steps. The first step is the canary, which is a small portion of the traffic. The second step is the remainder of the traffic.</p></li>
    /// <li>
    /// <p><code>LINEAR</code>: Endpoint traffic shifts to the new fleet in n steps of a configurable size.</p></li>
    /// </ul>
