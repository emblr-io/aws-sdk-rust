...
impl ::std::convert::From<&str> for DeviceDeploymentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceDeploymentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceDeploymentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceDeploymentStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceDeploymentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
