...
impl ::std::convert::From<&str> for AutoMlJobObjectiveType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlJobObjectiveType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlJobObjectiveType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlJobObjectiveType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoMlJobObjectiveType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
