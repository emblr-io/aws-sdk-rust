...
impl ::std::convert::From<&str> for SortExperimentsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortExperimentsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortExperimentsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortExperimentsBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortExperimentsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
