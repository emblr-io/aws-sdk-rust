...
impl ::std::convert::From<&str> for ListEdgePackagingJobsSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListEdgePackagingJobsSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListEdgePackagingJobsSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListEdgePackagingJobsSortBy::from(s))
    }
}
