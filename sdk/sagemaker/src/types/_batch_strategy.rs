...
impl ::std::convert::From<&str> for BatchStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchStrategy::from(s))
    }
}
impl BatchStrategy {
...
impl ::std::convert::AsRef<str> for BatchStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
