...
impl ::std::convert::From<&str> for EndpointSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndpointSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndpointSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndpointSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EndpointSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EndpointSortKey {
