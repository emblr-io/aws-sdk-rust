...
impl ::std::convert::From<&str> for NotebookInstanceLifecycleConfigSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotebookInstanceLifecycleConfigSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotebookInstanceLifecycleConfigSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotebookInstanceLifecycleConfigSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NotebookInstanceLifecycleConfigSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
