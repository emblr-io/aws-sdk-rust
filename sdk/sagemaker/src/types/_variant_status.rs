...
impl ::std::convert::From<&str> for VariantStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VariantStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VariantStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VariantStatus::from(s))
    }
}
impl VariantStatus {
...
impl ::std::convert::AsRef<str> for VariantStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
