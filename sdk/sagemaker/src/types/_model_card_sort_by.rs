...
impl ::std::convert::From<&str> for ModelCardSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
