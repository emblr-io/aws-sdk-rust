...
impl ::std::convert::From<&str> for EdgePresetDeploymentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EdgePresetDeploymentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EdgePresetDeploymentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EdgePresetDeploymentStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EdgePresetDeploymentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
