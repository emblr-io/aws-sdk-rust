...
impl ::std::convert::From<&str> for RepositoryAccessMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RepositoryAccessMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for RepositoryAccessMode {
