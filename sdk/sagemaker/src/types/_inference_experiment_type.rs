...
impl ::std::convert::From<&str> for InferenceExperimentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferenceExperimentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferenceExperimentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferenceExperimentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferenceExperimentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
