...
impl ::std::convert::From<&str> for CaptureStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CaptureStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CaptureStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CaptureStatus::from(s))
    }
}
impl CaptureStatus {
...
impl ::std::convert::AsRef<str> for CaptureStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
