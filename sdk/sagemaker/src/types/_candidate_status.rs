...
impl ::std::convert::From<&str> for CandidateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CandidateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CandidateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CandidateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CandidateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
