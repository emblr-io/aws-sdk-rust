...
impl ::std::convert::From<&str> for RetentionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RetentionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RetentionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RetentionType::from(s))
    }
}
impl RetentionType {
...
impl ::std::convert::AsRef<str> for RetentionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
