...
/// When writing a match expression against `HubContentSupportStatus`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `hubcontentsupportstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `HubContentSupportStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `HubContentSupportStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `HubContentSupportStatus::NewFeature` is defined.
/// Specifically, when `hubcontentsupportstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `HubContentSupportStatus::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum HubContentSupportStatus {
    #[allow(missing_docs)] // documentation missing in model
    Deprecated,
    #[allow(missing_docs)] // documentation missing in model
    Restricted,
...
impl ::std::convert::From<&str> for HubContentSupportStatus {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for HubContentSupportStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HubContentSupportStatus::from(s))
    }
}
impl HubContentSupportStatus {
...
impl ::std::fmt::Display for HubContentSupportStatus {
