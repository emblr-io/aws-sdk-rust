...
impl ::std::convert::From<&str> for Processor {
    fn from(s: &str) -> Self {
        match s {
            "CPU" => Processor::Cpu,
            "GPU" => Processor::Gpu,
            other => Processor::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Processor {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Processor::from(s))
    }
}
impl Processor {
...
impl ::std::convert::AsRef<str> for Processor {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
