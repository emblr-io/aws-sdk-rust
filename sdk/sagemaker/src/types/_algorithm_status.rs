...
impl ::std::convert::From<&str> for AlgorithmStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlgorithmStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlgorithmStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlgorithmStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AlgorithmStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
