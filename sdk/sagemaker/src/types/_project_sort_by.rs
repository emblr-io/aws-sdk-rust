...
impl ::std::convert::From<&str> for ProjectSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProjectSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProjectSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProjectSortBy::from(s))
    }
}
impl ProjectSortBy {
...
impl ::std::convert::AsRef<str> for ProjectSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
