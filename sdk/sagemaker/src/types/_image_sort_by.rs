...
impl ::std::convert::From<&str> for ImageSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageSortBy::from(s))
    }
}
impl ImageSortBy {
...
impl ::std::convert::AsRef<str> for ImageSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
