...
impl ::std::convert::From<&str> for ModelCardStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
