...
impl ::std::convert::From<&str> for RStudioServerProAccessStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RStudioServerProAccessStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RStudioServerProAccessStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RStudioServerProAccessStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RStudioServerProAccessStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RStudioServerProAccessStatus {
