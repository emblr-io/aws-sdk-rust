...
impl ::std::convert::From<&str> for ModelPackageStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelPackageStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelPackageStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelPackageStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelPackageStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
