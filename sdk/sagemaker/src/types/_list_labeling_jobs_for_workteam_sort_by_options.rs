...
impl ::std::convert::From<&str> for ListLabelingJobsForWorkteamSortByOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListLabelingJobsForWorkteamSortByOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListLabelingJobsForWorkteamSortByOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListLabelingJobsForWorkteamSortByOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListLabelingJobsForWorkteamSortByOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ListLabelingJobsForWorkteamSortByOptions {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ListLabelingJobsForWorkteamSortByOptions::CreationTime => write!(f, "CreationTime"),
            ListLabelingJobsForWorkteamSortByOptions::Unknown(value) => write!(f, "{}", value),
        }
    }
}
