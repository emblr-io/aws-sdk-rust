...
impl ::std::convert::From<&str> for ListWorkforcesSortByOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListWorkforcesSortByOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListWorkforcesSortByOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListWorkforcesSortByOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListWorkforcesSortByOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ListWorkforcesSortByOptions {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ListWorkforcesSortByOptions::CreateDate => write!(f, "CreateDate"),
            ListWorkforcesSortByOptions::Name => write!(f, "Name"),
            ListWorkforcesSortByOptions::Unknown(value) => write!(f, "{}", value),
        }
    }
}
