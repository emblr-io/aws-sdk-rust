...
impl ::std::convert::From<&str> for ModelPackageGroupSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelPackageGroupSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelPackageGroupSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelPackageGroupSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelPackageGroupSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ModelPackageGroupSortBy {
