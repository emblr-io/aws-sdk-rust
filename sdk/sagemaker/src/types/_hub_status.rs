...
impl ::std::convert::From<&str> for HubStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HubStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HubStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HubStatus::from(s))
    }
}
impl HubStatus {
...
impl ::std::convert::AsRef<str> for HubStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
