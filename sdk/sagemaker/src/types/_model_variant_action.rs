...
impl ::std::convert::From<&str> for ModelVariantAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelVariantAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelVariantAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelVariantAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelVariantAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
