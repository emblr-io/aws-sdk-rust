...
impl ::std::convert::From<&str> for HubContentSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HubContentSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HubContentSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HubContentSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HubContentSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for HubContentSortBy {
