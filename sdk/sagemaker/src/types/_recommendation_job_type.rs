...
impl ::std::convert::From<&str> for RecommendationJobType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecommendationJobType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecommendationJobType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecommendationJobType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecommendationJobType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
