...
impl ::std::convert::From<&str> for MonitoringExecutionSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitoringExecutionSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitoringExecutionSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitoringExecutionSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitoringExecutionSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
