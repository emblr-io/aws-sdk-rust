...
impl ::std::convert::From<&str> for FlatInvocations {
    fn from(s: &str) -> Self {
        match s {
            "Continue" => FlatInvocations::Continue,
            "Stop" => FlatInvocations::Stop,
            other => FlatInvocations::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FlatInvocations {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FlatInvocations::from(s))
    }
}
impl FlatInvocations {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            FlatInvocations::Continue => "Continue",
            FlatInvocations::Stop => "Stop",
            FlatInvocations::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for FlatInvocations {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
