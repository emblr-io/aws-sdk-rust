...
impl ::std::convert::From<&str> for ListWorkteamsSortByOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListWorkteamsSortByOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListWorkteamsSortByOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListWorkteamsSortByOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListWorkteamsSortByOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
