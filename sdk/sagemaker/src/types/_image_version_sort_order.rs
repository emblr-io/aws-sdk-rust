...
impl ::std::convert::From<&str> for ImageVersionSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageVersionSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageVersionSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageVersionSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImageVersionSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ImageVersionSortOrder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ImageVersionSortOrder::Ascending => write!(f, "ASCENDING"),
            ImageVersionSortOrder::Descending => write!(f, "DESCENDING"),
            ImageVersionSortOrder::Unknown(value) => write!(f, "{}", value),
        }
    }
}
