...
impl ::std::convert::From<&str> for LineageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LineageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LineageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LineageType::from(s))
    }
}
impl LineageType {
...
impl ::std::convert::AsRef<str> for LineageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
