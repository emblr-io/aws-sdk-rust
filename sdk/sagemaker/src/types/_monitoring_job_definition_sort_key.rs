...
impl ::std::convert::From<&str> for MonitoringJobDefinitionSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitoringJobDefinitionSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitoringJobDefinitionSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitoringJobDefinitionSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitoringJobDefinitionSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
