...
impl ::std::convert::From<&str> for DataDistributionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataDistributionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataDistributionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataDistributionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataDistributionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
