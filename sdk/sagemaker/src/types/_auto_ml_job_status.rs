...
impl ::std::convert::From<&str> for AutoMlJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoMlJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
