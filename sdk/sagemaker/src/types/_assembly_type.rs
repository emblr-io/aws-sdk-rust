...
impl ::std::convert::From<&str> for AssemblyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssemblyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssemblyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssemblyType::from(s))
    }
}
impl AssemblyType {
...
impl ::std::convert::AsRef<str> for AssemblyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
