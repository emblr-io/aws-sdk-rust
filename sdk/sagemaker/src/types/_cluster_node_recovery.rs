...
impl ::std::convert::From<&str> for ClusterNodeRecovery {
    fn from(s: &str) -> Self {
        match s {
            "Automatic" => ClusterNodeRecovery::Automatic,
            "None" => ClusterNodeRecovery::None,
            other => ClusterNodeRecovery::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClusterNodeRecovery {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClusterNodeRecovery::from(s))
    }
}
impl ClusterNodeRecovery {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ClusterNodeRecovery::Automatic => "Automatic",
            ClusterNodeRecovery::None => "None",
            ClusterNodeRecovery::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ClusterNodeRecovery {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ClusterNodeRecovery {
