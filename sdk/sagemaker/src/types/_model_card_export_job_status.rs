...
impl ::std::convert::From<&str> for ModelCardExportJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardExportJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardExportJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardExportJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardExportJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
