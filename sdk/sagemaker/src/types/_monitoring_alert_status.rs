...
impl ::std::convert::From<&str> for MonitoringAlertStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitoringAlertStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitoringAlertStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitoringAlertStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitoringAlertStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
