...
impl ::std::convert::From<&str> for ListCompilationJobsSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListCompilationJobsSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListCompilationJobsSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListCompilationJobsSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListCompilationJobsSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
