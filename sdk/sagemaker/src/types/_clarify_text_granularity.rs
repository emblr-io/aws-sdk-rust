...
impl ::std::convert::From<&str> for ClarifyTextGranularity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClarifyTextGranularity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClarifyTextGranularity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClarifyTextGranularity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClarifyTextGranularity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
