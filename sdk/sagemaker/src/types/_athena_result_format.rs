...
impl ::std::convert::From<&str> for AthenaResultFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AthenaResultFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AthenaResultFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AthenaResultFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AthenaResultFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
