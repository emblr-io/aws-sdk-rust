...
impl ::std::convert::From<&str> for ModelCardExportJobSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardExportJobSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardExportJobSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardExportJobSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardExportJobSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
