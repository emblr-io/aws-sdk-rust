...
impl ::std::convert::From<&str> for AlgorithmSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlgorithmSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlgorithmSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlgorithmSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AlgorithmSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
