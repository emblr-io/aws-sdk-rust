...
impl DebugRuleEvaluationStatus {
    /// Creates a new builder-style object to manufacture [`DebugRuleEvaluationStatus`](crate::types::DebugRuleEvaluationStatus).
    pub fn builder() -> crate::types::builders::DebugRuleEvaluationStatusBuilder {
        crate::types::builders::DebugRuleEvaluationStatusBuilder::default()
    }
}
