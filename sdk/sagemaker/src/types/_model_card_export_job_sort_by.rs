...
impl ::std::convert::From<&str> for ModelCardExportJobSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardExportJobSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardExportJobSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardExportJobSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardExportJobSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
