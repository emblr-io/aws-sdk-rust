...
impl ::std::convert::From<&str> for LabelingJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LabelingJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LabelingJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LabelingJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LabelingJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
