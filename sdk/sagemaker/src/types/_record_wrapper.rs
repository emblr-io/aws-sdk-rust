...
impl ::std::convert::From<&str> for RecordWrapper {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordWrapper::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordWrapper {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordWrapper::from(s))
    }
}
impl RecordWrapper {
...
impl ::std::convert::AsRef<str> for RecordWrapper {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
