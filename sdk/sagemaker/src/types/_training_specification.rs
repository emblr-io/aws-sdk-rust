...
pub struct TrainingSpecification {
    ...
    pub supports_distributed_training: ::std::option::Option<bool>,
...
impl TrainingSpecification {
    ...
    pub fn supported_hyper_parameters(&self) -> &[crate::types::HyperParameterSpecification] {
        self.supported_hyper_parameters.as_deref().unwrap_or_default()
    }
    /// <p>A list of the instance types that this algorithm can use for training.</p>
    ///
    ...
    pub fn supported_training_instance_types(&self) -> &[crate::types::TrainingInstanceType] {
        self.supported_training_instance_types.as_deref().unwrap_or_default()
    }
    /// <p>Indicates whether the algorithm supports distributed training. If set to false, buyers can't request more than one instance during training.</p>
    pub fn supports_distributed_training(&self) -> ::std::option::Option<bool> {
    ...
    pub fn training_channels(&self) -> &[crate::types::ChannelSpecification] {
        self.training_channels.as_deref().unwrap_or_default()
    }
    /// <p>A list of the metrics that the algorithm emits that can be used as the objective metric in a hyperparameter tuning job.</p>
    ///
    ...
    pub fn supported_tuning_job_objective_metrics(&self) -> &[crate::types::HyperParameterTuningJobObjective] {
        self.supported_tuning_job_objective_metrics.as_deref().unwrap_or_default()
    }
    /// <p>The additional data source used during the training job.</p>
...
impl TrainingSpecificationBuilder {
    ...
    /// <p>An MD5 hash of the training algorithm that identifies the Docker image used for training.</p>
    pub fn get_training_image_digest(&self) -> &::std::option::Option<::std::string::String> {
    ...
    pub fn supports_distributed_training(mut self, input: bool) -> Self {
        self.supports_distributed_training = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates whether the algorithm supports distributed training. If set to false, buyers can't request more than one instance during training.</p>
    ...
    /// <p>Indicates whether the algorithm supports distributed training. If set to false, buyers can't request more than one instance during training.</p>
    pub fn get_supports_distributed_training(&self) -> &::std::option::Option<bool> {
        &self.supports_distributed_training
    }
    ...
    pub fn training_channels(mut self, input: crate::types::ChannelSpecification) -> Self {
        ...
        v.push(input);
        self.training_channels = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of <code>ChannelSpecification</code> objects, which specify the input sources to be used by the algorithm.</p>
