...
impl ModelQuantizationConfig {
    /// Creates a new builder-style object to manufacture [`ModelQuantizationConfig`](crate::types::ModelQuantizationConfig).
    pub fn builder() -> crate::types::builders::ModelQuantizationConfigBuilder {
        crate::types::builders::ModelQuantizationConfigBuilder::default()
    }
}

/// A builder for [`ModelQuantizationConfig`](crate::types::ModelQuantizationConfig).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ModelQuantizationConfigBuilder {
...
impl ModelQuantizationConfigBuilder {
    ...
    /// Consumes the builder and constructs a [`ModelQuantizationConfig`](crate::types::ModelQuantizationConfig).
    pub fn build(self) -> crate::types::ModelQuantizationConfig {
        crate::types::ModelQuantizationConfig {
            image: self.image,
