...
impl ::std::convert::From<&str> for DirectInternetAccess {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectInternetAccess::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectInternetAccess {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectInternetAccess::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DirectInternetAccess {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
