...
impl ::std::convert::From<&str> for EnabledOrDisabled {
    fn from(s: &str) -> Self {
        match s {
            "Disabled" => EnabledOrDisabled::Disabled,
            "Enabled" => EnabledOrDisabled::Enabled,
            other => EnabledOrDisabled::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnabledOrDisabled {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnabledOrDisabled::from(s))
    }
}
impl EnabledOrDisabled {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EnabledOrDisabled::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for EnabledOrDisabled {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EnabledOrDisabled {
