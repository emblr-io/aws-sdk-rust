...
impl ThroughputConfig {
    /// Creates a new builder-style object to manufacture [`ThroughputConfig`](crate::types::ThroughputConfig).
    pub fn builder() -> crate::types::builders::ThroughputConfigBuilder {
        crate::types::builders::ThroughputConfigBuilder::default()
    }
}

/// A builder for [`ThroughputConfig`](crate::types::ThroughputConfig).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ThroughputConfigBuilder {
...
impl ThroughputConfigBuilder {
    ...
    /// Consumes the builder and constructs a [`ThroughputConfig`](crate::types::ThroughputConfig).
    pub fn build(self) -> crate::types::ThroughputConfig {
        crate::types::ThroughputConfig {
