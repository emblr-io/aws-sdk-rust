...
impl ::std::convert::From<&str> for OrderKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderKey::from(s))
    }
}
impl OrderKey {
...
impl ::std::convert::AsRef<str> for OrderKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
