...
impl ::std::convert::From<&str> for SortTrialsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortTrialsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortTrialsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortTrialsBy::from(s))
    }
}
impl SortTrialsBy {
...
impl ::std::convert::AsRef<str> for SortTrialsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SortTrialsBy {
