...
impl ::std::convert::From<&str> for MonitoringAlertHistorySortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitoringAlertHistorySortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitoringAlertHistorySortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitoringAlertHistorySortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitoringAlertHistorySortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
