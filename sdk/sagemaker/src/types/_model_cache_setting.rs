...
impl ::std::convert::From<&str> for ModelCacheSetting {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCacheSetting::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCacheSetting {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCacheSetting::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCacheSetting {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
