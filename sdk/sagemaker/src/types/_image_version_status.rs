...
impl ::std::convert::From<&str> for ImageVersionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImageVersionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImageVersionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageVersionStatus::from(s))
    }
}
