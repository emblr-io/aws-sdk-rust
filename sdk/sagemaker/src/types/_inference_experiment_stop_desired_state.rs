...
impl ::std::convert::From<&str> for InferenceExperimentStopDesiredState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferenceExperimentStopDesiredState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferenceExperimentStopDesiredState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferenceExperimentStopDesiredState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferenceExperimentStopDesiredState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
