...
impl ::std::convert::From<&str> for SortTrialComponentsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortTrialComponentsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortTrialComponentsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortTrialComponentsBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortTrialComponentsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SortTrialComponentsBy {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SortTrialComponentsBy::CreationTime => write!(f, "CreationTime"),
            SortTrialComponentsBy::Name => write!(f, "Name"),
            SortTrialComponentsBy::Unknown(value) => write!(f, "{}", value),
        }
    }
}
