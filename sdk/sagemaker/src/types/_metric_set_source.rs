...
impl ::std::convert::From<&str> for MetricSetSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MetricSetSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MetricSetSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MetricSetSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MetricSetSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
