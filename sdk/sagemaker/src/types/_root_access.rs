...
impl ::std::convert::From<&str> for RootAccess {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RootAccess::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RootAccess {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RootAccess::from(s))
    }
}
impl RootAccess {
...
impl ::std::convert::AsRef<str> for RootAccess {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
