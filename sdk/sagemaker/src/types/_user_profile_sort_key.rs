...
impl ::std::convert::From<&str> for UserProfileSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UserProfileSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UserProfileSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UserProfileSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UserProfileSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
