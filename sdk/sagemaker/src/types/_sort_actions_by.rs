...
impl ::std::convert::From<&str> for SortActionsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortActionsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortActionsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortActionsBy::from(s))
    }
}
impl SortActionsBy {
...
impl ::std::convert::AsRef<str> for SortActionsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
