...
impl ::std::convert::From<&str> for ThroughputMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThroughputMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThroughputMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThroughputMode::from(s))
    }
}
impl ThroughputMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ThroughputMode::OnDemand => "OnDemand",
...
impl ::std::convert::AsRef<str> for ThroughputMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ThroughputMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ThroughputMode::OnDemand => write!(f, "OnDemand"),
