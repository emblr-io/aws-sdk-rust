...
impl ::std::convert::From<&str> for InferenceExecutionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InferenceExecutionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InferenceExecutionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InferenceExecutionMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InferenceExecutionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
