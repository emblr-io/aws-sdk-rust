...
impl ::std::convert::From<&str> for SortContextsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortContextsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortContextsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortContextsBy::from(s))
    }
}
impl SortContextsBy {
...
impl ::std::convert::AsRef<str> for SortContextsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
