...
impl ::std::convert::From<&str> for WarmPoolResourceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WarmPoolResourceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WarmPoolResourceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WarmPoolResourceStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WarmPoolResourceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
