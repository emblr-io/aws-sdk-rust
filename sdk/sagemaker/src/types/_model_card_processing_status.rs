...
impl ::std::convert::From<&str> for ModelCardProcessingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardProcessingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardProcessingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardProcessingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardProcessingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
