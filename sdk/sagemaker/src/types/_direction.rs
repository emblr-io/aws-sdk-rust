...
impl ::std::convert::From<&str> for Direction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Direction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Direction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Direction::from(s))
    }
}
impl Direction {
...
impl ::std::convert::AsRef<str> for Direction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
