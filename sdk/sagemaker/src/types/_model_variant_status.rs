...
impl ::std::convert::From<&str> for ModelVariantStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelVariantStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelVariantStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelVariantStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelVariantStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ModelVariantStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ModelVariantStatus::Creating => write!(f, "Creating"),
            ModelVariantStatus::Deleted => write!(f, "Deleted"),
