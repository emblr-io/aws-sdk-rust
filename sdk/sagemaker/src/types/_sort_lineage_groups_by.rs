...
impl ::std::convert::From<&str> for SortLineageGroupsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortLineageGroupsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortLineageGroupsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortLineageGroupsBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortLineageGroupsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
