...
impl ::std::convert::From<&str> for SortPipelinesBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortPipelinesBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortPipelinesBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortPipelinesBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortPipelinesBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
