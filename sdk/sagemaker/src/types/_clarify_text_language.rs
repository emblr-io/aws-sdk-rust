...
impl ::std::convert::From<&str> for ClarifyTextLanguage {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClarifyTextLanguage::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for ClarifyTextLanguage {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ClarifyTextLanguage::Afrikaans => write!(f, "af"),
            ClarifyTextLanguage::Arabic => write!(f, "ar"),
            ClarifyTextLanguage::Bulgarian => write!(f, "bg"),
            ClarifyTextLanguage::Bengali => write!(f, "bn"),
            ClarifyTextLanguage::Catalan => write!(f, "ca"),
            ClarifyTextLanguage::Czech => write!(f, "cs"),
            ClarifyTextLanguage::Danish => write!(f, "da"),
            ClarifyTextLanguage::German => write!(f, "de"),
            ClarifyTextLanguage::Greek => write!(f, "el"),
            ClarifyTextLanguage::English => write!(f, "en"),
            ClarifyTextLanguage::Spanish => write!(f, "es"),
            ClarifyTextLanguage::Estonian => write!(f, "et"),
            ClarifyTextLanguage::Basque => write!(f, "eu"),
            ClarifyTextLanguage::Persian => write!(f, "fa"),
            ClarifyTextLanguage::Finnish => write!(f, "fi"),
            ClarifyTextLanguage::French => write!(f, "fr"),
            ClarifyTextLanguage::Irish => write!(f, "ga"),
            ClarifyTextLanguage::Gujarati => write!(f, "gu"),
            ClarifyTextLanguage::Hebrew => write!(f, "he"),
            ClarifyTextLanguage::Hindi => write!(f, "hi"),
            ClarifyTextLanguage::Croatian => write!(f, "hr"),
            ClarifyTextLanguage::Hungarian => write!(f, "hu"),
            ClarifyTextLanguage::Armenian => write!(f, "hy"),
            ClarifyTextLanguage::Indonesian => write!(f, "id"),
            ClarifyTextLanguage::Icelandic => write!(f, "is"),
            ClarifyTextLanguage::Italian => write!(f, "it"),
            ClarifyTextLanguage::Kannada => write!(f, "kn"),
            ClarifyTextLanguage::Kyrgyz => write!(f, "ky"),
            ClarifyTextLanguage::Luxembourgish => write!(f, "lb"),
            ClarifyTextLanguage::Ligurian => write!(f, "lij"),
            ClarifyTextLanguage::Lithuanian => write!(f, "lt"),
            ClarifyTextLanguage::Latvian => write!(f, "lv"),
            ClarifyTextLanguage::Macedonian => write!(f, "mk"),
            ClarifyTextLanguage::Malayalam => write!(f, "ml"),
            ClarifyTextLanguage::Marathi => write!(f, "mr"),
            ClarifyTextLanguage::NorwegianBokmal => write!(f, "nb"),
            ClarifyTextLanguage::Nepali => write!(f, "ne"),
            ClarifyTextLanguage::Dutch => write!(f, "nl"),
            ClarifyTextLanguage::Polish => write!(f, "pl"),
            ClarifyTextLanguage::Portuguese => write!(f, "pt"),
            ClarifyTextLanguage::Romanian => write!(f, "ro"),
            ClarifyTextLanguage::Russian => write!(f, "ru"),
            ClarifyTextLanguage::Sanskrit => write!(f, "sa"),
            ClarifyTextLanguage::Sinhala => write!(f, "si"),
            ClarifyTextLanguage::Slovak => write!(f, "sk"),
            ClarifyTextLanguage::Slovenian => write!(f, "sl"),
            ClarifyTextLanguage::Albanian => write!(f, "sq"),
            ClarifyTextLanguage::Serbian => write!(f, "sr"),
            ClarifyTextLanguage::Swedish => write!(f, "sv"),
            ClarifyTextLanguage::Tamil => write!(f, "ta"),
            ClarifyTextLanguage::Telugu => write!(f, "te"),
            ClarifyTextLanguage::Tagalog => write!(f, "tl"),
            ClarifyTextLanguage::Setswana => write!(f, "tn"),
            ClarifyTextLanguage::Turkish => write!(f, "tr"),
            ClarifyTextLanguage::Tatar => write!(f, "tt"),
            ClarifyTextLanguage::Ukrainian => write!(f, "uk"),
            ClarifyTextLanguage::Urdu => write!(f, "ur"),
