...
impl ::std::convert::From<&str> for ConditionOutcome {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConditionOutcome::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConditionOutcome {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConditionOutcome::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConditionOutcome {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
