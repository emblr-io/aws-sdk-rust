...
impl ::std::convert::From<&str> for SpaceSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpaceSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpaceSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpaceSortKey::from(s))
    }
}
impl SpaceSortKey {
...
impl ::std::convert::AsRef<str> for SpaceSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
