...
impl ::std::convert::From<&str> for SortAssociationsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortAssociationsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortAssociationsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortAssociationsBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortAssociationsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
