...
/// When writing a match expression against `AutoMlProblemTypeConfigName`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `automlproblemtypeconfigname` represents
...
/// version of SDK where the variant `AutoMlProblemTypeConfigName::NewFeature` is defined.
/// Specifically, when `automlproblemtypeconfigname` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AutoMlProblemTypeConfigName::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum AutoMlProblemTypeConfigName {
    #[allow(missing_docs)] // documentation missing in model
    ImageClassification,
    #[allow(missing_docs)] // documentation missing in model
    Tabular,
...
impl ::std::convert::From<&str> for AutoMlProblemTypeConfigName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlProblemTypeConfigName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlProblemTypeConfigName {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlProblemTypeConfigName::from(s))
    }
}
