...
impl ::std::convert::From<&str> for SplitType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SplitType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SplitType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SplitType::from(s))
    }
}
impl SplitType {
...
impl ::std::convert::AsRef<str> for SplitType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
