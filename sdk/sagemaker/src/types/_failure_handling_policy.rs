...
impl ::std::convert::From<&str> for FailureHandlingPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailureHandlingPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailureHandlingPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailureHandlingPolicy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FailureHandlingPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
