...
pub struct OutputConfig {
    ...
    /// <p><code> "CompilerOptions": {'gpu-code': 'sm_62', 'trt-ver': '6.0.1', 'cuda-ver': '10.0'}</code></p></li>
    /// <li>
    /// <p>EC2 m5.2xlarge instance OS</p>
    /// <p><code>"TargetPlatform": {"Os": "LINUX", "Arch": "X86_64", "Accelerator": "NVIDIA"},</code></p>
    /// <p><code> "CompilerOptions": {'mcpu': 'skylake-avx512'}</code></p></li>
    /// <li>
    /// <p>RK3399</p>
    /// <p><code>"TargetPlatform": {"Os": "LINUX", "Arch": "ARM64", "Accelerator": "MALI"}</code></p></li>
    /// <li>
    /// <p>ARMv7 phone (CPU)</p>
    ...
    /// <p><code> "CompilerOptions": {'ANDROID_PLATFORM': 29}</code></p></li>
    /// </ul>
    ...
    /// <ul>
    /// <li>
    /// <p><code>DTYPE</code>: Specifies the data type for the input. When compiling for <code>ml_*</code> (except for <code>ml_inf</code>) instances using PyTorch framework, provide the data type (dtype) of the model's input. <code>"float32"</code> is used if <code>"DTYPE"</code> is not specified. Options for data type are:</p>
    /// <ul>
    /// <li>
    /// <p>float32: Use either <code>"float"</code> or <code>"float32"</code>.</p></li>
    /// <li>
    /// <p>int64: Use either <code>"int64"</code> or <code>"long"</code>.</p></li>
    /// </ul>
    /// <p>For example, <code>{"dtype" : "float32"}</code>.</p></li>
    /// <li>
    /// <p><code>CPU</code>: Compilation for CPU supports the following compiler options.</p>
    /// <ul>
    /// <li>
    ...
    /// <ul>
    /// <li>
    /// <p><code>gpu_code</code>: Specifies the targeted architecture.</p></li>
    /// <li>
    /// <p><code>trt-ver</code>: Specifies the TensorRT versions in x.y.z. format.</p></li>
    /// <li>
    /// <p><code>cuda-ver</code>: Specifies the CUDA version in x.y format.</p></li>
    /// </ul>
    /// <p>For example, <code>{'gpu-code': 'sm_72', 'trt-ver': '6.0.1', 'cuda-ver': '10.1'}</code></p></li>
    /// <li>
    /// <p><code>ANDROID</code>: Compilation for the Android OS supports the following compiler options:</p>
    /// <ul>
    /// <li>
    ...
    /// <p>For information about supported compiler options, see <a href="https://awsdocs-neuron.readthedocs-hosted.com/en/latest/compiler/neuronx-cc/api-reference-guide/neuron-compiler-cli-reference-guide.html"> Neuron Compiler CLI Reference Guide</a>.</p></li>
    /// <li>
    /// <p><code>CoreML</code>: Compilation for the CoreML <a href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_OutputConfig.html">OutputConfig</a> <code>TargetDevice</code> supports the following compiler options:</p>
    /// <ul>
    /// <li>
