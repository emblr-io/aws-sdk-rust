...
impl ::std::convert::From<&str> for ProcessingS3CompressionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProcessingS3CompressionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProcessingS3CompressionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProcessingS3CompressionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProcessingS3CompressionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ProcessingS3CompressionType {
