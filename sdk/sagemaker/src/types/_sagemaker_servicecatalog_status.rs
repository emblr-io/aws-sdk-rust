...
impl ::std::convert::From<&str> for SagemakerServicecatalogStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SagemakerServicecatalogStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SagemakerServicecatalogStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SagemakerServicecatalogStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SagemakerServicecatalogStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
