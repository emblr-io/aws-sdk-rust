...
impl ::std::convert::From<&str> for StageStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StageStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StageStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StageStatus::from(s))
    }
}
impl StageStatus {
...
impl ::std::convert::AsRef<str> for StageStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
