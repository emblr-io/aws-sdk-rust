...
pub struct ModelPackage {
    ...
    /// <ul>
    /// <li>
    /// <p>For a versioned model, the name is automatically generated by SageMaker Model Registry and follows the format '<code>ModelPackageGroupName/ModelPackageVersion</code>'.</p></li>
    /// <li>
    /// <p>For an unversioned model, you must provide the name.</p></li>
    /// </ul>
