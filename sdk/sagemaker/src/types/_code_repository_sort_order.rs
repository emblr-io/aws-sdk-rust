...
impl ::std::convert::From<&str> for CodeRepositorySortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CodeRepositorySortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CodeRepositorySortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CodeRepositorySortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CodeRepositorySortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
