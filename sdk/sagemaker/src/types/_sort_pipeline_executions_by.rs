...
impl ::std::convert::From<&str> for SortPipelineExecutionsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortPipelineExecutionsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for SortPipelineExecutionsBy {
