...
impl ::std::convert::From<&str> for ListDeviceFleetsSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListDeviceFleetsSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListDeviceFleetsSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListDeviceFleetsSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListDeviceFleetsSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
