...
impl ::std::convert::From<&str> for AthenaResultCompressionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AthenaResultCompressionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AthenaResultCompressionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AthenaResultCompressionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AthenaResultCompressionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
