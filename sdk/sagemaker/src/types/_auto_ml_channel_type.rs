...
impl ::std::convert::From<&str> for AutoMlChannelType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlChannelType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlChannelType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlChannelType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoMlChannelType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
