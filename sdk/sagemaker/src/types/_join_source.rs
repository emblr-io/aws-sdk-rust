...
impl ::std::convert::From<&str> for JoinSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JoinSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JoinSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JoinSource::from(s))
    }
}
impl JoinSource {
...
impl ::std::convert::AsRef<str> for JoinSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
