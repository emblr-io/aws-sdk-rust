...
impl ::std::convert::From<&str> for HumanTaskUiStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HumanTaskUiStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HumanTaskUiStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HumanTaskUiStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HumanTaskUiStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
