...
impl ::std::convert::From<&str> for RedshiftResultFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RedshiftResultFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RedshiftResultFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RedshiftResultFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RedshiftResultFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
