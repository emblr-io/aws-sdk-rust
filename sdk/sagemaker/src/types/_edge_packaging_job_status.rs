...
impl ::std::convert::From<&str> for EdgePackagingJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EdgePackagingJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EdgePackagingJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EdgePackagingJobStatus::from(s))
    }
}
