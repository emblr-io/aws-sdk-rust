...
impl ::std::convert::From<&str> for ProcessingS3DataType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProcessingS3DataType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProcessingS3DataType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProcessingS3DataType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProcessingS3DataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
