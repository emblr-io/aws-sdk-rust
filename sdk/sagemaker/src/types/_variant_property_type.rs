...
impl ::std::convert::From<&str> for VariantPropertyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VariantPropertyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VariantPropertyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VariantPropertyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VariantPropertyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
