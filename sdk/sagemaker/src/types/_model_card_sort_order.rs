...
impl ::std::convert::From<&str> for ModelCardSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelCardSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelCardSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelCardSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelCardSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
