...
impl ::std::convert::From<&str> for TransformJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransformJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransformJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransformJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransformJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
