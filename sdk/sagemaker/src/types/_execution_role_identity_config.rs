...
impl ::std::convert::From<&str> for ExecutionRoleIdentityConfig {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExecutionRoleIdentityConfig::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExecutionRoleIdentityConfig {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExecutionRoleIdentityConfig::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExecutionRoleIdentityConfig {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
