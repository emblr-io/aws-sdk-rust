...
impl ::std::convert::From<&str> for HubSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HubSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HubSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HubSortBy::from(s))
    }
}
impl HubSortBy {
...
impl ::std::convert::AsRef<str> for HubSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
