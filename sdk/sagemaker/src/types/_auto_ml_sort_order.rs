...
impl ::std::convert::From<&str> for AutoMlSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoMlSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
