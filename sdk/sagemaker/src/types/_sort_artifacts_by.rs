...
impl ::std::convert::From<&str> for SortArtifactsBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortArtifactsBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortArtifactsBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortArtifactsBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SortArtifactsBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
