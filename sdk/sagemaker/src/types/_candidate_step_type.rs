...
impl ::std::convert::From<&str> for CandidateStepType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CandidateStepType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CandidateStepType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CandidateStepType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CandidateStepType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
