...
impl ::std::convert::From<&str> for StudioLifecycleConfigSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StudioLifecycleConfigSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StudioLifecycleConfigSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StudioLifecycleConfigSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StudioLifecycleConfigSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
