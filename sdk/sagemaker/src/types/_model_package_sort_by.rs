...
impl ::std::convert::From<&str> for ModelPackageSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelPackageSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelPackageSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelPackageSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelPackageSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
