...
impl ::std::convert::From<&str> for AutoMlMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoMlMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoMlMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoMlMode::from(s))
    }
}
impl AutoMlMode {
...
impl ::std::convert::AsRef<str> for AutoMlMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
