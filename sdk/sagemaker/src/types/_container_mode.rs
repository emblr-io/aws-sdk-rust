...
impl ::std::convert::From<&str> for ContainerMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContainerMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContainerMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContainerMode::from(s))
    }
}
impl ContainerMode {
...
impl ::std::convert::AsRef<str> for ContainerMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
