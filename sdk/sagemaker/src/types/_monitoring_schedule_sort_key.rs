...
impl ::std::convert::From<&str> for MonitoringScheduleSortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MonitoringScheduleSortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MonitoringScheduleSortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MonitoringScheduleSortKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MonitoringScheduleSortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MonitoringScheduleSortKey {
