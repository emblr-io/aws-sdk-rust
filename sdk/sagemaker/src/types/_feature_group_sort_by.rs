...
impl ::std::convert::From<&str> for FeatureGroupSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeatureGroupSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeatureGroupSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeatureGroupSortBy::from(s))
    }
}
impl FeatureGroupSortBy {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CreationTime", "FeatureGroupStatus", "Name", "OfflineStoreStatus"]
    }
}
impl ::std::convert::AsRef<str> for FeatureGroupSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
