...
impl ::std::convert::From<&str> for CompilationJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CompilationJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CompilationJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CompilationJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CompilationJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
