...
impl ::std::convert::From<&str> for ModelInfrastructureType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModelInfrastructureType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModelInfrastructureType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModelInfrastructureType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModelInfrastructureType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ModelInfrastructureType {
