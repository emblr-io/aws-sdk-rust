...
impl ::std::convert::From<&str> for HyperParameterTuningAllocationStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HyperParameterTuningAllocationStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HyperParameterTuningAllocationStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HyperParameterTuningAllocationStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HyperParameterTuningAllocationStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for HyperParameterTuningAllocationStrategy {
