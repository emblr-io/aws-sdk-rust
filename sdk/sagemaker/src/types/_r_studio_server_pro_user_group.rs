...
impl ::std::convert::From<&str> for RStudioServerProUserGroup {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RStudioServerProUserGroup::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RStudioServerProUserGroup {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RStudioServerProUserGroup::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RStudioServerProUserGroup {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
