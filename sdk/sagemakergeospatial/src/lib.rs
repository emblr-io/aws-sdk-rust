...
//! aws-sdk-sagemakergeospatial = "0.0.0-local"
...
//! offered by Amazon SageMaker geospatial capabilities. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon SageMaker geospatial capabilities.
...
/// For example, the [`DeleteEarthObservationJob`](crate::operation::delete_earth_observation_job) operation has
/// a [`Client::delete_earth_observation_job`], function which returns a builder for that operation.
...
/// Configuration for Amazon SageMaker geospatial capabilities.
pub mod config;
