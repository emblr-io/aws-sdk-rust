...
impl ::std::convert::From<&str> for TargetOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetOptions::from(s))
    }
}
impl TargetOptions {
...
impl ::std::convert::AsRef<str> for TargetOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
