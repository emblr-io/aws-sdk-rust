...
impl ::std::convert::From<&str> for AlgorithmNameGeoMosaic {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlgorithmNameGeoMosaic::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlgorithmNameGeoMosaic {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlgorithmNameGeoMosaic::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AlgorithmNameGeoMosaic {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
