...
impl ::std::convert::From<&str> for TemporalStatistics {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TemporalStatistics::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TemporalStatistics {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TemporalStatistics::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TemporalStatistics {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
