...
impl ::std::convert::From<&str> for EarthObservationJobErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EarthObservationJobErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EarthObservationJobErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EarthObservationJobErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EarthObservationJobErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
