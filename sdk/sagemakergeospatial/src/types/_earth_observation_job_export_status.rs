...
impl ::std::convert::From<&str> for EarthObservationJobExportStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EarthObservationJobExportStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EarthObservationJobExportStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EarthObservationJobExportStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EarthObservationJobExportStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
