...
impl ::std::convert::From<&str> for ExportErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExportErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
