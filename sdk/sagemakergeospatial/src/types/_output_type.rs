...
impl ::std::convert::From<&str> for OutputType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OutputType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OutputType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OutputType::from(s))
    }
}
impl OutputType {
...
impl ::std::convert::AsRef<str> for OutputType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
