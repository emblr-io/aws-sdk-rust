...
impl ::std::convert::From<&str> for VectorEnrichmentJobDocumentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VectorEnrichmentJobDocumentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VectorEnrichmentJobDocumentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VectorEnrichmentJobDocumentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VectorEnrichmentJobDocumentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for VectorEnrichmentJobDocumentType {
