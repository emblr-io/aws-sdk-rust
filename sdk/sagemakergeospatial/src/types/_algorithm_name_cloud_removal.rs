...
impl ::std::convert::From<&str> for AlgorithmNameCloudRemoval {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlgorithmNameCloudRemoval::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlgorithmNameCloudRemoval {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlgorithmNameCloudRemoval::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AlgorithmNameCloudRemoval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
