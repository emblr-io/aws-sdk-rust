...
impl ::std::convert::From<&str> for VectorEnrichmentJobExportStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VectorEnrichmentJobExportStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VectorEnrichmentJobExportStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VectorEnrichmentJobExportStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VectorEnrichmentJobExportStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
