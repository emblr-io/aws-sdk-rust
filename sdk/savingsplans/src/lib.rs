...
//! offered by AWS Savings Plans. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Savings Plans.
...
/// For example, the [`CreateSavingsPlan`](crate::operation::create_savings_plan) operation has
/// a [`Client::create_savings_plan`], function which returns a builder for that operation.
