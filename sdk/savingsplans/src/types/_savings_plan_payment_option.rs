...
impl ::std::convert::From<&str> for SavingsPlanPaymentOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SavingsPlanPaymentOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SavingsPlanPaymentOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SavingsPlanPaymentOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SavingsPlanPaymentOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SavingsPlanPaymentOption {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SavingsPlanPaymentOption::AllUpfront => write!(f, "All Upfront"),
            SavingsPlanPaymentOption::NoUpfront => write!(f, "No Upfront"),
            SavingsPlanPaymentOption::PartialUpfront => write!(f, "Partial Upfront"),
            SavingsPlanPaymentOption::Unknown(value) => write!(f, "{}", value),
        }
    }
}
