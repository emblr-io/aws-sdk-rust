...
//! offered by Amazon WorkMail. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon WorkMail.
...
/// Configuration for Amazon WorkMail.
pub mod config;
