...
impl ::std::convert::From<&str> for FolderName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FolderName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FolderName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FolderName::from(s))
    }
}
impl FolderName {
...
impl ::std::convert::AsRef<str> for FolderName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
