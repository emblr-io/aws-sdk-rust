...
impl ::std::convert::From<&str> for RetentionAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RetentionAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RetentionAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RetentionAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RetentionAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
