...
impl ::std::convert::From<&str> for EntityState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EntityState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EntityState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EntityState::from(s))
    }
}
impl EntityState {
...
impl ::std::convert::AsRef<str> for EntityState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
