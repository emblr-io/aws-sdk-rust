...
impl ::std::convert::From<&str> for AccessEffect {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessEffect::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccessEffect {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccessEffect::from(s))
    }
}
impl AccessEffect {
...
impl ::std::convert::AsRef<str> for AccessEffect {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AccessEffect {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccessEffect::Allow => write!(f, "ALLOW"),
            AccessEffect::Deny => write!(f, "DENY"),
            AccessEffect::Unknown(value) => write!(f, "{}", value),
        }
    }
}
