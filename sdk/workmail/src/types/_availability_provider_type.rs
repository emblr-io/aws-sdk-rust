...
impl ::std::convert::From<&str> for AvailabilityProviderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AvailabilityProviderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AvailabilityProviderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AvailabilityProviderType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AvailabilityProviderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
