...
impl ::aws_types::request_id::RequestId for RegisterMailDomainOutput {
...
impl RegisterMailDomainOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`RegisterMailDomainOutput`](crate::operation::register_mail_domain::RegisterMailDomainOutput).
    pub fn build(self) -> crate::operation::register_mail_domain::RegisterMailDomainOutput {
