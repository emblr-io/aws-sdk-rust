...
pub struct ListMailboxExportJobsOutput {
    ...
    pub jobs: ::std::option::Option<::std::vec::Vec<crate::types::MailboxExportJob>>,
...
impl ListMailboxExportJobsOutput {
    ...
    pub fn jobs(&self) -> &[crate::types::MailboxExportJob] {
...
impl ::aws_types::request_id::RequestId for ListMailboxExportJobsOutput {
...
impl ListMailboxExportJobsOutputBuilder {
    /// Appends an item to `jobs`.
    ///
    /// To override the contents of this collection use [`set_jobs`](Self::set_jobs).
    ///
    /// <p>The mailbox export job details.</p>
    pub fn jobs(mut self, input: crate::types::MailboxExportJob) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListMailboxExportJobsOutput`](crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsOutput).
    pub fn build(self) -> crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsOutput {
