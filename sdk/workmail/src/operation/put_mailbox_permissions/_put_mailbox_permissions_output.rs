...
impl ::aws_types::request_id::RequestId for PutMailboxPermissionsOutput {
...
impl PutMailboxPermissionsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutMailboxPermissionsOutput`](crate::operation::put_mailbox_permissions::PutMailboxPermissionsOutput).
    pub fn build(self) -> crate::operation::put_mailbox_permissions::PutMailboxPermissionsOutput {
