...
//! aws-sdk-inspectorscan = "0.0.0-local"
...
//! offered by Inspector Scan. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Inspector Scan.
...
/// let config = aws_sdk_inspectorscan::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`ScanSbom`](crate::operation::scan_sbom) operation has
/// a [`Client::scan_sbom`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.scan_sbom()
...
/// Configuration for Inspector Scan.
pub mod config;
