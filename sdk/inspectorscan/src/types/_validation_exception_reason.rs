...
///     ValidationExceptionReason::UnsupportedSbomType => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            "UNSUPPORTED_SBOM_TYPE" => ValidationExceptionReason::UnsupportedSbomType,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ValidationExceptionReason::UnsupportedSbomType => "UNSUPPORTED_SBOM_TYPE",
