...
pub enum BotAliasReplicationStatus {
...
impl ::std::convert::From<&str> for BotAliasReplicationStatus {
    fn from(s: &str) -> Self {
        match s {
            "Available" => BotAliasReplicationStatus::Available,
            "Creating" => BotAliasReplicationStatus::Creating,
            "Deleting" => BotAliasReplicationStatus::Deleting,
            "Failed" => BotAliasReplicationStatus::Failed,
            "Updating" => BotAliasReplicationStatus::Updating,
            other => BotAliasReplicationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BotAliasReplicationStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BotAliasReplicationStatus::from(s))
    }
}
impl BotAliasReplicationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            BotAliasReplicationStatus::Available => "Available",
            BotAliasReplicationStatus::Creating => "Creating",
            BotAliasReplicationStatus::Deleting => "Deleting",
            BotAliasReplicationStatus::Failed => "Failed",
            BotAliasReplicationStatus::Updating => "Updating",
            BotAliasReplicationStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for BotAliasReplicationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
