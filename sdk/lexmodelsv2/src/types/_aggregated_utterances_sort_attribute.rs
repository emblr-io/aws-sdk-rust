...
impl ::std::convert::From<&str> for AggregatedUtterancesSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AggregatedUtterancesSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AggregatedUtterancesSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AggregatedUtterancesSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AggregatedUtterancesSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
