...
impl ::std::convert::From<&str> for ImportSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImportSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImportSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImportSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImportSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ImportSortAttribute {
