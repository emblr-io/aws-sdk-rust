...
impl ::std::convert::From<&str> for SlotSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SlotSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SlotSortAttribute {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SlotSortAttribute::LastUpdatedDateTime => write!(f, "LastUpdatedDateTime"),
            SlotSortAttribute::SlotName => write!(f, "SlotName"),
            SlotSortAttribute::Unknown(value) => write!(f, "{}", value),
        }
    }
}
