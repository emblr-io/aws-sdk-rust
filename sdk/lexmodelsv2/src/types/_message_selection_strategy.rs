...
impl ::std::convert::From<&str> for MessageSelectionStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MessageSelectionStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MessageSelectionStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MessageSelectionStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MessageSelectionStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
