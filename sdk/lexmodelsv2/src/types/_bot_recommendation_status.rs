...
impl ::std::convert::From<&str> for BotRecommendationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BotRecommendationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BotRecommendationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BotRecommendationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BotRecommendationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
