...
/// When writing a match expression against `TestResultTypeFilter`, it is important to ensure
...
///
/// ```text
/// # let testresulttypefilter = unimplemented!();
/// match testresulttypefilter {
///     TestResultTypeFilter::ConversationLevelTestResults => { /* ... */ },
///     TestResultTypeFilter::IntentClassificationTestResults => { /* ... */ },
///     TestResultTypeFilter::OverallTestResults => { /* ... */ },
///     TestResultTypeFilter::SlotResolutionTestResults => { /* ... */ },
///     TestResultTypeFilter::UtteranceLevelResults => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `testresulttypefilter` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `TestResultTypeFilter::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `TestResultTypeFilter::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `TestResultTypeFilter::NewFeature` is defined.
/// Specifically, when `testresulttypefilter` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `TestResultTypeFilter::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for TestResultTypeFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TestResultTypeFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TestResultTypeFilter {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TestResultTypeFilter::from(s))
    }
}
impl TestResultTypeFilter {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TestResultTypeFilter::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for TestResultTypeFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
