...
pub struct AnalyticsSessionResult {
    ...
    pub group_by_keys: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionGroupByKey>>,
    ...
    pub metrics_results: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionMetricResult>>,
}
impl AnalyticsSessionResult {
    ...
    pub fn group_by_keys(&self) -> &[crate::types::AnalyticsSessionGroupByKey] {
    ...
    pub fn metrics_results(&self) -> &[crate::types::AnalyticsSessionMetricResult] {
        self.metrics_results.as_deref().unwrap_or_default()
    }
}
impl AnalyticsSessionResult {
    /// Creates a new builder-style object to manufacture [`AnalyticsSessionResult`](crate::types::AnalyticsSessionResult).
    pub fn builder() -> crate::types::builders::AnalyticsSessionResultBuilder {
        crate::types::builders::AnalyticsSessionResultBuilder::default()
    }
}
...
pub struct AnalyticsSessionResultBuilder {
    ...
    pub(crate) metrics_results: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionMetricResult>>,
}
impl AnalyticsSessionResultBuilder {
    ...
    ///
    /// <p>A list of objects containing the criteria you requested for grouping results and the values of the bins.</p>
    pub fn group_by_keys(mut self, input: crate::types::AnalyticsSessionGroupByKey) -> Self {
    ...
    /// <p>A list of objects containing the criteria you requested for grouping results and the values of the bins.</p>
    pub fn set_group_by_keys(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionGroupByKey>>) -> Self {
        self.group_by_keys = input;
        self
    }
    /// <p>A list of objects containing the criteria you requested for grouping results and the values of the bins.</p>
    pub fn get_group_by_keys(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionGroupByKey>> {
        &self.group_by_keys
    }
    ...
    ///
    /// <p>A list of objects, each of which contains a metric you want to list, the statistic for the metric you want to return, and the method by which to organize the results.</p>
    pub fn metrics_results(mut self, input: crate::types::AnalyticsSessionMetricResult) -> Self {
    ...
    /// <p>A list of objects, each of which contains a metric you want to list, the statistic for the metric you want to return, and the method by which to organize the results.</p>
    pub fn set_metrics_results(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionMetricResult>>) -> Self {
        self.metrics_results = input;
        self
    }
    /// <p>A list of objects, each of which contains a metric you want to list, the statistic for the metric you want to return, and the method by which to organize the results.</p>
    pub fn get_metrics_results(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionMetricResult>> {
        &self.metrics_results
    }
    /// Consumes the builder and constructs a [`AnalyticsSessionResult`](crate::types::AnalyticsSessionResult).
    pub fn build(self) -> crate::types::AnalyticsSessionResult {
        crate::types::AnalyticsSessionResult {
