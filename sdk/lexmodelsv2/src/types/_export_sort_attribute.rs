...
impl ::std::convert::From<&str> for ExportSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExportSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
