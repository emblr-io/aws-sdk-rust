...
impl ::std::convert::From<&str> for BotFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BotFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BotFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BotFilterName::from(s))
    }
}
impl BotFilterName {
...
impl ::std::convert::AsRef<str> for BotFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
