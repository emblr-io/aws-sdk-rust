...
impl ::std::convert::From<&str> for AggregatedUtterancesFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AggregatedUtterancesFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AggregatedUtterancesFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AggregatedUtterancesFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AggregatedUtterancesFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AggregatedUtterancesFilterName {
