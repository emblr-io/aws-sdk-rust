...
impl ::std::convert::From<&str> for TranscriptFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TranscriptFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TranscriptFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TranscriptFormat::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TranscriptFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TranscriptFormat {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TranscriptFormat::Lex => write!(f, "Lex"),
            TranscriptFormat::Unknown(value) => write!(f, "{}", value),
        }
    }
}
