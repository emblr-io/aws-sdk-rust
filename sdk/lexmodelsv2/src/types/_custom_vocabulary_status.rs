...
impl ::std::convert::From<&str> for CustomVocabularyStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomVocabularyStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomVocabularyStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomVocabularyStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomVocabularyStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
