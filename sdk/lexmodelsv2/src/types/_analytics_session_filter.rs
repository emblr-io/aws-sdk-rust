...
impl AnalyticsSessionFilter {
    /// Creates a new builder-style object to manufacture [`AnalyticsSessionFilter`](crate::types::AnalyticsSessionFilter).
    pub fn builder() -> crate::types::builders::AnalyticsSessionFilterBuilder {
        crate::types::builders::AnalyticsSessionFilterBuilder::default()
    }
}
