...
impl ::std::convert::From<&str> for BotSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BotSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BotSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BotSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BotSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BotSortAttribute {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            BotSortAttribute::BotName => write!(f, "BotName"),
            BotSortAttribute::Unknown(value) => write!(f, "{}", value),
        }
    }
}
