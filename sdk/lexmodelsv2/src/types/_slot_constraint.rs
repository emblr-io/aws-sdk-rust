...
impl ::std::convert::From<&str> for SlotConstraint {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotConstraint::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotConstraint {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotConstraint::from(s))
    }
}
impl SlotConstraint {
...
impl ::std::convert::AsRef<str> for SlotConstraint {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
