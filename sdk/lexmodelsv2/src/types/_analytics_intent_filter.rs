...
/// <p>Contains fields describing a condition by which to filter the intents. The expression may be understood as <code>name</code> <code>operator</code> <code>values</code>. For example:</p>
/// <ul>
/// <li>
...
pub struct AnalyticsIntentFilter {
    ...
    /// </ul>
    pub name: crate::types::AnalyticsIntentFilterName,
...
impl AnalyticsIntentFilter {
    /// Creates a new builder-style object to manufacture [`AnalyticsIntentFilter`](crate::types::AnalyticsIntentFilter).
    pub fn builder() -> crate::types::builders::AnalyticsIntentFilterBuilder {
        crate::types::builders::AnalyticsIntentFilterBuilder::default()
    }
}

/// A builder for [`AnalyticsIntentFilter`](crate::types::AnalyticsIntentFilter).
...
impl AnalyticsIntentFilterBuilder {
    ...
    pub fn name(mut self, input: crate::types::AnalyticsIntentFilterName) -> Self {
    ...
    /// <p><code>IntentEndState</code> – The final state of the intent.</p></li>
    /// </ul>
    pub fn get_name(&self) -> &::std::option::Option<crate::types::AnalyticsIntentFilterName> {
        &self.name
    }
    /// <p>The operation by which to filter the category. The following operations are possible:</p>
    /// <ul>
    ...
    /// - [`name`](crate::types::builders::AnalyticsIntentFilterBuilder::name)
