...
impl ::std::convert::From<&str> for AggregatedUtterancesFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AggregatedUtterancesFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AggregatedUtterancesFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AggregatedUtterancesFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AggregatedUtterancesFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
