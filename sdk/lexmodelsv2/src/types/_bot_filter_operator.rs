...
impl ::std::convert::From<&str> for BotFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BotFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BotFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BotFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BotFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
