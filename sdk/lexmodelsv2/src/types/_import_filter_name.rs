...
impl ::std::convert::From<&str> for ImportFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImportFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImportFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImportFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImportFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ImportFilterName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ImportFilterName::ImportResourceType => write!(f, "ImportResourceType"),
            ImportFilterName::Unknown(value) => write!(f, "{}", value),
        }
    }
}
