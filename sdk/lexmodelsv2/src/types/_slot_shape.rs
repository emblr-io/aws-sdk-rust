...
impl ::std::convert::From<&str> for SlotShape {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotShape::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotShape {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotShape::from(s))
    }
}
impl SlotShape {
...
impl ::std::convert::AsRef<str> for SlotShape {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
