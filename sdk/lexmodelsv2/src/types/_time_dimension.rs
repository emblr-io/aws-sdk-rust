...
impl ::std::convert::From<&str> for TimeDimension {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimeDimension::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimeDimension {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimeDimension::from(s))
    }
}
impl TimeDimension {
...
impl ::std::convert::AsRef<str> for TimeDimension {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
