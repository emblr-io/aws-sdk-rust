...
impl ::std::convert::From<&str> for IntentSortAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IntentSortAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IntentSortAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IntentSortAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IntentSortAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
