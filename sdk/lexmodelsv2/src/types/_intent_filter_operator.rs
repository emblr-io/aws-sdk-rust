...
impl ::std::convert::From<&str> for IntentFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IntentFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IntentFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IntentFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IntentFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
