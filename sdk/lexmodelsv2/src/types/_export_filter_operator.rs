...
impl ::std::convert::From<&str> for ExportFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExportFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExportFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExportFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExportFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ExportFilterOperator {
