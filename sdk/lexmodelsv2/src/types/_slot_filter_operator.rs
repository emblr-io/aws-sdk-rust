...
impl ::std::convert::From<&str> for SlotFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SlotFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
