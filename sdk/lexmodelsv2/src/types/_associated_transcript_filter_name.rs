...
impl ::std::convert::From<&str> for AssociatedTranscriptFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssociatedTranscriptFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssociatedTranscriptFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssociatedTranscriptFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssociatedTranscriptFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
