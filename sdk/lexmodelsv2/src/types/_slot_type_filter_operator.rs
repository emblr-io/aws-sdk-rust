...
impl ::std::convert::From<&str> for SlotTypeFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotTypeFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotTypeFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotTypeFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SlotTypeFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SlotTypeFilterOperator {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SlotTypeFilterOperator::Contains => write!(f, "CO"),
            SlotTypeFilterOperator::Equals => write!(f, "EQ"),
            SlotTypeFilterOperator::Unknown(value) => write!(f, "{}", value),
        }
    }
}
