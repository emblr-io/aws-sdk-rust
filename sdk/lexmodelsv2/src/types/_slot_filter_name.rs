...
impl ::std::convert::From<&str> for SlotFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SlotFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SlotFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SlotFilterName::from(s))
    }
}
impl SlotFilterName {
...
impl ::std::convert::AsRef<str> for SlotFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
