...
impl ::std::convert::From<&str> for SearchOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SearchOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SearchOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchOrder::from(s))
    }
}
impl SearchOrder {
...
impl ::std::convert::AsRef<str> for SearchOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
