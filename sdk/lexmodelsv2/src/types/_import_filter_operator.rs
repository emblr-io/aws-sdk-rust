...
impl ::std::convert::From<&str> for ImportFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImportFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImportFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImportFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImportFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
