...
impl ::std::convert::From<&str> for AudioRecognitionStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioRecognitionStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioRecognitionStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioRecognitionStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AudioRecognitionStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
