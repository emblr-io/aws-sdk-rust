...
impl DescribeDbSnapshotTenantDatabasesOutput {
    ...
    pub fn builder() -> crate::operation::describe_db_snapshot_tenant_databases::builders::DescribeDbSnapshotTenantDatabasesOutputBuilder {
        crate::operation::describe_db_snapshot_tenant_databases::builders::DescribeDbSnapshotTenantDatabasesOutputBuilder::default()
    }
}

/// A builder for [`DescribeDbSnapshotTenantDatabasesOutput`](crate::operation::describe_db_snapshot_tenant_databases::DescribeDbSnapshotTenantDatabasesOutput).
...
impl DescribeDbSnapshotTenantDatabasesOutputBuilder {
    ...
    /// Appends an item to `db_snapshot_tenant_databases`.
    ///
    /// To override the contents of this collection use [`set_db_snapshot_tenant_databases`](Self::set_db_snapshot_tenant_databases).
    ///
    /// <p>A list of DB snapshot tenant databases.</p>
