...
impl ::aws_types::request_id::RequestId for DeleteOptionGroupOutput {
...
impl DeleteOptionGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteOptionGroupOutput`](crate::operation::delete_option_group::DeleteOptionGroupOutput).
    pub fn build(self) -> crate::operation::delete_option_group::DeleteOptionGroupOutput {
