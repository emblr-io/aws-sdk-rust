...
pub struct ModifyDbProxyTargetGroupOutput {
    ...
    pub db_proxy_target_group: ::std::option::Option<crate::types::DbProxyTargetGroup>,
...
impl ::aws_types::request_id::RequestId for ModifyDbProxyTargetGroupOutput {
...
impl ModifyDbProxyTargetGroupOutputBuilder {
    /// <p>The settings of the modified <code>DBProxyTarget</code>.</p>
    pub fn db_proxy_target_group(mut self, input: crate::types::DbProxyTargetGroup) -> Self {
        self.db_proxy_target_group = ::std::option::Option::Some(input);
        self
    }
    /// <p>The settings of the modified <code>DBProxyTarget</code>.</p>
