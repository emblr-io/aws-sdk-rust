...
pub struct CreateDbShardGroupOutput {
...
impl CreateDbShardGroupOutput {
    /// Creates a new builder-style object to manufacture [`CreateDbShardGroupOutput`](crate::operation::create_db_shard_group::CreateDbShardGroupOutput).
    pub fn builder() -> crate::operation::create_db_shard_group::builders::CreateDbShardGroupOutputBuilder {
        crate::operation::create_db_shard_group::builders::CreateDbShardGroupOutputBuilder::default()
    }
}
...
impl CreateDbShardGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateDbShardGroupOutput`](crate::operation::create_db_shard_group::CreateDbShardGroupOutput).
    pub fn build(self) -> crate::operation::create_db_shard_group::CreateDbShardGroupOutput {
