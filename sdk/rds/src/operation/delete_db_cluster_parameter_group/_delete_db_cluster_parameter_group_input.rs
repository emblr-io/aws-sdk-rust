...
pub struct DeleteDbClusterParameterGroupInput {
    ...
    /// <ul>
    /// <li>
    /// <p>Must be the name of an existing DB cluster parameter group.</p></li>
    /// <li>
    /// <p>You can't delete a default DB cluster parameter group.</p></li>
    /// <li>
    /// <p>Can't be associated with any DB clusters.</p></li>
    /// </ul>
