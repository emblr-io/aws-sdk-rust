...
/// <ul>
/// <li>
/// <p><code>CreateDBClusterEndpoint</code></p></li>
/// <li>
/// <p><code>DescribeDBClusterEndpoints</code></p></li>
/// <li>
/// <p><code>ModifyDBClusterEndpoint</code></p></li>
/// <li>
/// <p><code>DeleteDBClusterEndpoint</code></p></li>
/// </ul>
...
impl ::aws_types::request_id::RequestId for DeleteDbClusterEndpointOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteDbClusterEndpointOutput {
    /// Creates a new builder-style object to manufacture [`DeleteDbClusterEndpointOutput`](crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput).
    pub fn builder() -> crate::operation::delete_db_cluster_endpoint::builders::DeleteDbClusterEndpointOutputBuilder {
        crate::operation::delete_db_cluster_endpoint::builders::DeleteDbClusterEndpointOutputBuilder::default()
    }
}

/// A builder for [`DeleteDbClusterEndpointOutput`](crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteDbClusterEndpointOutputBuilder {
...
impl DeleteDbClusterEndpointOutputBuilder {
    /// <p>The identifier associated with the endpoint. This parameter is stored as a lowercase string.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteDbClusterEndpointOutput`](crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput).
    pub fn build(self) -> crate::operation::delete_db_cluster_endpoint::DeleteDbClusterEndpointOutput {
