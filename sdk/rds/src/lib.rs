...
//! offered by Amazon Relational Database Service. The return value of each of these methods is a "fluent builder",
...
/// Configuration for Amazon Relational Database Service.
pub mod config;
