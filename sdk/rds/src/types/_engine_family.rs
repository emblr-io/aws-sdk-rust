...
impl ::std::convert::From<&str> for EngineFamily {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EngineFamily::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EngineFamily {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EngineFamily::from(s))
    }
}
impl EngineFamily {
...
impl ::std::convert::AsRef<str> for EngineFamily {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
