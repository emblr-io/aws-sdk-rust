...
impl ::std::convert::From<&str> for AutomationMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutomationMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutomationMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutomationMode::from(s))
    }
}
impl AutomationMode {
...
impl ::std::convert::AsRef<str> for AutomationMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
