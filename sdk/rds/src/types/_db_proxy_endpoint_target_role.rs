...
impl ::std::convert::From<&str> for DbProxyEndpointTargetRole {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DbProxyEndpointTargetRole::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DbProxyEndpointTargetRole {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DbProxyEndpointTargetRole::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DbProxyEndpointTargetRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DbProxyEndpointTargetRole {
