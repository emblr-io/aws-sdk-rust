...
impl ::std::convert::From<&str> for ClientPasswordAuthType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientPasswordAuthType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientPasswordAuthType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientPasswordAuthType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientPasswordAuthType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
