...
impl ::std::convert::From<&str> for WriteForwardingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WriteForwardingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WriteForwardingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WriteForwardingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WriteForwardingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
