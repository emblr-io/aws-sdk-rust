...
impl ::std::convert::From<&str> for ReplicaMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicaMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicaMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicaMode::from(s))
    }
}
impl ReplicaMode {
...
impl ::std::convert::AsRef<str> for ReplicaMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
