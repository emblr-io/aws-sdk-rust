...
impl ::std::convert::From<&str> for AuditPolicyState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditPolicyState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditPolicyState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditPolicyState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuditPolicyState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
