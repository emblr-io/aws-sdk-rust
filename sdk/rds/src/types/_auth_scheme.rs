...
impl ::std::convert::From<&str> for AuthScheme {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthScheme::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthScheme {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthScheme::from(s))
    }
}
impl AuthScheme {
...
impl ::std::convert::AsRef<str> for AuthScheme {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
