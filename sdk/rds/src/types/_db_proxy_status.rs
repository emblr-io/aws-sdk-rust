...
impl ::std::convert::From<&str> for DbProxyStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DbProxyStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DbProxyStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DbProxyStatus::from(s))
    }
}
impl DbProxyStatus {
...
impl ::std::convert::AsRef<str> for DbProxyStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
