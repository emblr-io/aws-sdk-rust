...
impl ::std::convert::From<&str> for FailoverStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailoverStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailoverStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailoverStatus::from(s))
    }
}
impl FailoverStatus {
...
impl ::std::convert::AsRef<str> for FailoverStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
