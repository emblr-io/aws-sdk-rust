...
impl ::std::fmt::Display for InvalidDbClusterSnapshotStateFault {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidDbClusterSnapshotStateFault [InvalidDBClusterSnapshotStateFault]")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidDbClusterSnapshotStateFault {
...
impl InvalidDbClusterSnapshotStateFault {
    ...
    pub fn builder() -> crate::types::error::builders::InvalidDbClusterSnapshotStateFaultBuilder {
        crate::types::error::builders::InvalidDbClusterSnapshotStateFaultBuilder::default()
    }
}

/// A builder for [`InvalidDbClusterSnapshotStateFault`](crate::types::error::InvalidDbClusterSnapshotStateFault).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InvalidDbClusterSnapshotStateFaultBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl InvalidDbClusterSnapshotStateFaultBuilder {
    #[allow(missing_docs)] // documentation missing in model
