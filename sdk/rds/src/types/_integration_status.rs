...
impl ::std::convert::From<&str> for IntegrationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "needs_attention" => IntegrationStatus::NeedsAttention,
...
impl IntegrationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            IntegrationStatus::Creating => "creating",
            IntegrationStatus::Deleting => "deleting",
            IntegrationStatus::Failed => "failed",
            IntegrationStatus::Modifying => "modifying",
            IntegrationStatus::NeedsAttention => "needs_attention",
