...
impl ::std::convert::From<&str> for IamAuthMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IamAuthMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IamAuthMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IamAuthMode::from(s))
    }
}
impl IamAuthMode {
...
impl ::std::convert::AsRef<str> for IamAuthMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
