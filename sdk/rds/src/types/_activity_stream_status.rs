...
impl ::std::convert::From<&str> for ActivityStreamStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActivityStreamStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActivityStreamStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActivityStreamStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActivityStreamStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
