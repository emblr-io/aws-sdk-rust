...
impl ::std::convert::From<&str> for ActivityStreamMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActivityStreamMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActivityStreamMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActivityStreamMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActivityStreamMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
