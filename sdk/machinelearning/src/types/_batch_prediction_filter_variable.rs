...
impl ::std::convert::From<&str> for BatchPredictionFilterVariable {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchPredictionFilterVariable::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchPredictionFilterVariable {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchPredictionFilterVariable::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchPredictionFilterVariable {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
