...
impl ::std::convert::From<&str> for RealtimeEndpointStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RealtimeEndpointStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RealtimeEndpointStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RealtimeEndpointStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RealtimeEndpointStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
