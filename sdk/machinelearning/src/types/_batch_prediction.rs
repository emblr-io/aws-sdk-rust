...
pub struct BatchPrediction {
    ...
    /// <ul>
    /// <li>
    /// <p><code>PENDING</code> - Amazon Machine Learning (Amazon ML) submitted a request to generate predictions for a batch of observations.</p></li>
    /// <li>
    /// <p><code>INPROGRESS</code> - The process is underway.</p></li>
    /// <li>
