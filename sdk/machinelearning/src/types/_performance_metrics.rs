...
/// <ul>
/// <li>
/// <p>BinaryAUC: The binary <code>MLModel</code> uses the Area Under the Curve (AUC) technique to measure performance.</p></li>
/// <li>
/// <p>RegressionRMSE: The regression <code>MLModel</code> uses the Root Mean Square Error (RMSE) technique to measure performance. RMSE measures the difference between predicted and actual values for a single variable.</p></li>
/// <li>
/// <p>MulticlassAvgFScore: The multiclass <code>MLModel</code> uses the F1 score technique to measure performance.</p></li>
/// </ul>
...
impl PerformanceMetricsBuilder {
    ...
    pub fn build(self) -> crate::types::PerformanceMetrics {
        crate::types::PerformanceMetrics { properties: self.properties }
    }
}
