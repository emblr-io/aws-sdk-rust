...
impl ::std::convert::From<&str> for MlModelFilterVariable {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MlModelFilterVariable::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MlModelFilterVariable {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MlModelFilterVariable::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MlModelFilterVariable {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
