...
//! offered by CloudWatch Observability Admin Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling CloudWatch Observability Admin Service.
...
/// Configuration for CloudWatch Observability Admin Service.
pub mod config;
