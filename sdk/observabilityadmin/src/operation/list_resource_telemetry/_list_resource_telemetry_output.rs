...
impl ::aws_types::request_id::RequestId for ListResourceTelemetryOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ListResourceTelemetryOutput {
    /// Creates a new builder-style object to manufacture [`ListResourceTelemetryOutput`](crate::operation::list_resource_telemetry::ListResourceTelemetryOutput).
    pub fn builder() -> crate::operation::list_resource_telemetry::builders::ListResourceTelemetryOutputBuilder {
        crate::operation::list_resource_telemetry::builders::ListResourceTelemetryOutputBuilder::default()
    }
}

/// A builder for [`ListResourceTelemetryOutput`](crate::operation::list_resource_telemetry::ListResourceTelemetryOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListResourceTelemetryOutputBuilder {
    pub(crate) telemetry_configurations: ::std::option::Option<::std::vec::Vec<crate::types::TelemetryConfiguration>>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl ListResourceTelemetryOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListResourceTelemetryOutput`](crate::operation::list_resource_telemetry::ListResourceTelemetryOutput).
    pub fn build(self) -> crate::operation::list_resource_telemetry::ListResourceTelemetryOutput {
