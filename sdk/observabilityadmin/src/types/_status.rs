...
impl ::std::convert::From<&str> for Status {
    fn from(s: &str) -> Self {
        match s {
            "FAILED_START" => Status::FailedStart,
            "FAILED_STOP" => Status::FailedStop,
...
impl Status {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Status::FailedStart => "FAILED_START",
            Status::FailedStop => "FAILED_STOP",
...
impl ::std::fmt::Display for Status {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Status::FailedStart => write!(f, "FAILED_START"),
            Status::FailedStop => write!(f, "FAILED_STOP"),
