...
impl ::std::convert::From<&str> for CommentBodyTextType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CommentBodyTextType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CommentBodyTextType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CommentBodyTextType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CommentBodyTextType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CommentBodyTextType {
