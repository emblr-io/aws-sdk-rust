...
impl ::std::convert::From<&str> for FieldNamespace {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FieldNamespace::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FieldNamespace {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FieldNamespace::from(s))
    }
}
impl FieldNamespace {
...
impl ::std::convert::AsRef<str> for FieldNamespace {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
