...
//! offered by Amazon Connect Cases. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Connect Cases.
...
/// Configuration for Amazon Connect Cases.
pub mod config;
