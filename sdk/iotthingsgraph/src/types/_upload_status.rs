...
impl ::std::convert::From<&str> for UploadStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UploadStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UploadStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UploadStatus::from(s))
    }
}
impl UploadStatus {
...
impl ::std::convert::AsRef<str> for UploadStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
