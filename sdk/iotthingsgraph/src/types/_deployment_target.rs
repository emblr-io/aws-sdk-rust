...
impl ::std::convert::From<&str> for DeploymentTarget {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeploymentTarget::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentTarget {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentTarget::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeploymentTarget {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
