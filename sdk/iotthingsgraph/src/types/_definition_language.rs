...
impl ::std::convert::From<&str> for DefinitionLanguage {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DefinitionLanguage::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DefinitionLanguage {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DefinitionLanguage::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DefinitionLanguage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
