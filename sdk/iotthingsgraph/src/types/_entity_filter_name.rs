...
impl ::std::convert::From<&str> for EntityFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EntityFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EntityFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EntityFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EntityFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EntityFilterName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EntityFilterName::Name => write!(f, "NAME"),
