...
impl ::std::convert::From<&str> for SystemTemplateFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SystemTemplateFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SystemTemplateFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SystemTemplateFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SystemTemplateFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SystemTemplateFilterName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SystemTemplateFilterName::FlowTemplateId => write!(f, "FLOW_TEMPLATE_ID"),
            SystemTemplateFilterName::Unknown(value) => write!(f, "{}", value),
        }
    }
}
