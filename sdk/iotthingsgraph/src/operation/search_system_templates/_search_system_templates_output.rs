...
impl SearchSystemTemplatesOutput {
    ...
    pub fn summaries(&self) -> &[crate::types::SystemTemplateSummary] {
...
impl ::aws_types::request_id::RequestId for SearchSystemTemplatesOutput {
...
impl SearchSystemTemplatesOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`SearchSystemTemplatesOutput`](crate::operation::search_system_templates::SearchSystemTemplatesOutput).
    pub fn build(self) -> crate::operation::search_system_templates::SearchSystemTemplatesOutput {
