...
//! aws-sdk-iotthingsgraph = "0.0.0-local"
...
//! offered by AWS IoT Things Graph. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT Things Graph.
...
/// For example, the [`AssociateEntityToThing`](crate::operation::associate_entity_to_thing) operation has
/// a [`Client::associate_entity_to_thing`], function which returns a builder for that operation.
...
/// Configuration for AWS IoT Things Graph.
pub mod config;
