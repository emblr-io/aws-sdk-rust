...
//! offered by AWS Systems Manager Incident Manager Contacts. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Systems Manager Incident Manager Contacts.
...
/// For example, the [`AcceptPage`](crate::operation::accept_page) operation has
/// a [`Client::accept_page`], function which returns a builder for that operation.
...
/// Configuration for AWS Systems Manager Incident Manager Contacts.
pub mod config;
