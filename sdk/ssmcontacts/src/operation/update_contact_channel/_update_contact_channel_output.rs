...
impl UpdateContactChannelOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateContactChannelOutput`](crate::operation::update_contact_channel::UpdateContactChannelOutput).
    pub fn build(self) -> crate::operation::update_contact_channel::UpdateContactChannelOutput {
