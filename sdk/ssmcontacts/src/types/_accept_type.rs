...
impl ::std::convert::From<&str> for AcceptType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AcceptType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AcceptType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AcceptType::from(s))
    }
}
impl AcceptType {
...
impl ::std::convert::AsRef<str> for AcceptType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AcceptType {
