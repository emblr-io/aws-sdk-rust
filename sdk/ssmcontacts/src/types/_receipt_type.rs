...
impl ::std::convert::From<&str> for ReceiptType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReceiptType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReceiptType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReceiptType::from(s))
    }
}
impl ReceiptType {
...
impl ::std::convert::AsRef<str> for ReceiptType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
