...
impl ::std::convert::From<&str> for ActivationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActivationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActivationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActivationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActivationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
