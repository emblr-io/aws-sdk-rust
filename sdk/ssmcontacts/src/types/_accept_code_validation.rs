...
impl ::std::convert::From<&str> for AcceptCodeValidation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AcceptCodeValidation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AcceptCodeValidation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AcceptCodeValidation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AcceptCodeValidation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
