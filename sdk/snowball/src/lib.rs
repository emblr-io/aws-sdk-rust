...
//! offered by Amazon Import/Export Snowball. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Import/Export Snowball.
...
/// For example, the [`CancelCluster`](crate::operation::cancel_cluster) operation has
...
/// Configuration for Amazon Import/Export Snowball.
pub mod config;
