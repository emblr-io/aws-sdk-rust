...
impl ::aws_types::request_id::RequestId for GetJobManifestOutput {
...
impl GetJobManifestOutputBuilder {
    /// <p>The Amazon S3 presigned URL for the manifest file associated with the specified <code>JobId</code> value.</p>
    pub fn manifest_uri(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.manifest_uri = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The Amazon S3 presigned URL for the manifest file associated with the specified <code>JobId</code> value.</p>
