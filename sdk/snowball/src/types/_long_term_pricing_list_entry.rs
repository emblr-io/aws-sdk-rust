...
impl LongTermPricingListEntryBuilder {
    ...
    /// <p>The end date the long-term pricing contract.</p>
    pub fn get_long_term_pricing_end_date(&self) -> &::std::option::Option<::aws_smithy_types::DateTime> {
        &self.long_term_pricing_end_date
    }
    /// <p>The start date of the long-term pricing contract.</p>
    pub fn long_term_pricing_start_date(mut self, input: ::aws_smithy_types::DateTime) -> Self {
        self.long_term_pricing_start_date = ::std::option::Option::Some(input);
        self
    }
    /// <p>The start date of the long-term pricing contract.</p>
    ...
    /// <p>The start date of the long-term pricing contract.</p>
    pub fn get_long_term_pricing_start_date(&self) -> &::std::option::Option<::aws_smithy_types::DateTime> {
    ...
    /// <p>The current active jobs on the device the long-term pricing type.</p>
    pub fn current_active_job(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.current_active_job = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The current active jobs on the device the long-term pricing type.</p>
    ...
    /// <p>The status of the long-term pricing type.</p>
    pub fn long_term_pricing_status(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.long_term_pricing_status = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The status of the long-term pricing type.</p>
