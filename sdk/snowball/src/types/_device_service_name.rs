...
/// When writing a match expression against `DeviceServiceName`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `deviceservicename` represents
...
/// version of SDK where the variant `DeviceServiceName::NewFeature` is defined.
