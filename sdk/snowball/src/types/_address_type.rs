...
impl ::std::convert::From<&str> for AddressType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_SHIP" => AddressType::AwsShip,
            "CUST_PICKUP" => AddressType::CustPickup,
            other => AddressType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AddressType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AddressType::from(s))
    }
}
impl AddressType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AddressType::AwsShip => "AWS_SHIP",
            AddressType::CustPickup => "CUST_PICKUP",
...
impl ::std::convert::AsRef<str> for AddressType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AddressType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AddressType::AwsShip => write!(f, "AWS_SHIP"),
            AddressType::CustPickup => write!(f, "CUST_PICKUP"),
