...
/// When writing a match expression against `ShippingOption`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `shippingoption` represents
...
/// version of SDK where the variant `ShippingOption::NewFeature` is defined.
...
impl ::std::str::FromStr for ShippingOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShippingOption::from(s))
    }
}
impl ShippingOption {
