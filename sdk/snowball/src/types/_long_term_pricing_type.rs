...
/// When writing a match expression against `LongTermPricingType`, it is important to ensure
...
///     LongTermPricingType::OneMonth => { /* ... */ },
///     LongTermPricingType::OneYear => { /* ... */ },
///     LongTermPricingType::ThreeYear => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `longtermpricingtype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `LongTermPricingType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `LongTermPricingType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `LongTermPricingType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for LongTermPricingType {
    fn from(s: &str) -> Self {
        match s {
            "OneMonth" => LongTermPricingType::OneMonth,
            "OneYear" => LongTermPricingType::OneYear,
            "ThreeYear" => LongTermPricingType::ThreeYear,
            other => LongTermPricingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LongTermPricingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LongTermPricingType::from(s))
    }
}
impl LongTermPricingType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            LongTermPricingType::OneMonth => "OneMonth",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["OneMonth", "OneYear", "ThreeYear"]
    }
}
impl ::std::convert::AsRef<str> for LongTermPricingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
