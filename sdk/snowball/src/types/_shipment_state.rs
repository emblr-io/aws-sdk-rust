...
impl ::std::convert::From<&str> for ShipmentState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ShipmentState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShipmentState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShipmentState::from(s))
    }
}
impl ShipmentState {
...
impl ::std::convert::AsRef<str> for ShipmentState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
