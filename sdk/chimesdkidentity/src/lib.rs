...
//! aws-sdk-chimesdkidentity = "0.0.0-local"
...
//! offered by Amazon Chime SDK Identity. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Chime SDK Identity.
...
/// For example, the [`CreateAppInstance`](crate::operation::create_app_instance) operation has
...
/// Configuration for Amazon Chime SDK Identity.
pub mod config;
