...
impl ::std::convert::From<&str> for EndpointStatusReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EndpointStatusReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EndpointStatusReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EndpointStatusReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EndpointStatusReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
