...
impl ::std::convert::From<&str> for AllowMessages {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AllowMessages::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AllowMessages {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllowMessages::from(s))
    }
}
impl AllowMessages {
...
impl ::std::convert::AsRef<str> for AllowMessages {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
