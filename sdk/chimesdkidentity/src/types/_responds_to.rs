...
impl ::std::convert::From<&str> for RespondsTo {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RespondsTo::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl RespondsTo {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RespondsTo::StandardMessages => "STANDARD_MESSAGES",
            RespondsTo::Unknown(value) => value.as_str(),
        }
    }
