...
impl ::std::convert::From<&str> for AppInstanceUserEndpointType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppInstanceUserEndpointType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppInstanceUserEndpointType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppInstanceUserEndpointType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AppInstanceUserEndpointType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
