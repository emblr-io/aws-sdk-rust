...
impl ::aws_types::request_id::RequestId for DeleteAppInstanceUserOutput {
...
impl DeleteAppInstanceUserOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteAppInstanceUserOutput`](crate::operation::delete_app_instance_user::DeleteAppInstanceUserOutput).
    pub fn build(self) -> crate::operation::delete_app_instance_user::DeleteAppInstanceUserOutput {
