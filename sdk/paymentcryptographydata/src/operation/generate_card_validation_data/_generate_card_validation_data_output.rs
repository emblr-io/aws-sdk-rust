...
impl ::std::fmt::Debug for GenerateCardValidationDataOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GenerateCardValidationDataOutput");
...
impl ::std::fmt::Debug for GenerateCardValidationDataOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GenerateCardValidationDataOutputBuilder");
        formatter.field("key_arn", &self.key_arn);
        formatter.field("key_check_value", &self.key_check_value);
        formatter.field("validation_data", &"*** Sensitive Data Redacted ***");
        formatter.field("_request_id", &self._request_id);
