...
impl ::std::convert::From<&str> for EncryptionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "CFB1" => EncryptionMode::Cfb1,
            "CFB128" => EncryptionMode::Cfb128,
            "CFB64" => EncryptionMode::Cfb64,
            "CFB8" => EncryptionMode::Cfb8,
            "ECB" => EncryptionMode::Ecb,
            "OFB" => EncryptionMode::Ofb,
            other => EncryptionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EncryptionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EncryptionMode::from(s))
    }
}
impl EncryptionMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EncryptionMode::Cfb1 => "CFB1",
            EncryptionMode::Cfb128 => "CFB128",
            EncryptionMode::Cfb64 => "CFB64",
