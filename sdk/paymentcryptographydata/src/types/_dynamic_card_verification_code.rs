...
impl DynamicCardVerificationCode {
    ...
    pub fn track_data(&self) -> &str {
        use std::ops::Deref;
        self.track_data.deref()
    }
}
impl ::std::fmt::Debug for DynamicCardVerificationCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("DynamicCardVerificationCode");
        ...
        formatter.field("track_data", &"*** Sensitive Data Redacted ***");
        formatter.finish()
    }
}
impl DynamicCardVerificationCode {
...
impl ::std::fmt::Debug for DynamicCardVerificationCodeBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("DynamicCardVerificationCodeBuilder");
        formatter.field("unpredictable_number", &self.unpredictable_number);
        formatter.field("pan_sequence_number", &self.pan_sequence_number);
        formatter.field("application_transaction_counter", &self.application_transaction_counter);
        formatter.field("track_data", &"*** Sensitive Data Redacted ***");
