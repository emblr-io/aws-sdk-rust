...
//! offered by Payment Cryptography Data Plane. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Payment Cryptography Data Plane.
...
/// For example, the [`DecryptData`](crate::operation::decrypt_data) operation has
...
/// Configuration for Payment Cryptography Data Plane.
pub mod config;
