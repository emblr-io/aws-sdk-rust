...
impl InputSummary {
    /// Creates a new builder-style object to manufacture [`InputSummary`](crate::types::InputSummary).
    pub fn builder() -> crate::types::builders::InputSummaryBuilder {
        crate::types::builders::InputSummaryBuilder::default()
    }
}

/// A builder for [`InputSummary`](crate::types::InputSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct InputSummaryBuilder {
...
impl InputSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`InputSummary`](crate::types::InputSummary).
    pub fn build(self) -> crate::types::InputSummary {
        crate::types::InputSummary {
