...
impl ::std::convert::From<&str> for AlarmModelVersionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AlarmModelVersionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AlarmModelVersionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AlarmModelVersionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AlarmModelVersionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
