...
impl ::std::convert::From<&str> for MessageFormatType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MessageFormatType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MessageFormatType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MessageFormatType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MessageFormatType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
