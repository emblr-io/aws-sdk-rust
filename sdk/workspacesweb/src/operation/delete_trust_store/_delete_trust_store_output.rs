...
impl ::aws_types::request_id::RequestId for DeleteTrustStoreOutput {
...
impl DeleteTrustStoreOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteTrustStoreOutput`](crate::operation::delete_trust_store::DeleteTrustStoreOutput).
    pub fn build(self) -> crate::operation::delete_trust_store::DeleteTrustStoreOutput {
        crate::operation::delete_trust_store::DeleteTrustStoreOutput {
