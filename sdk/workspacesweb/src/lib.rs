...
//! offered by Amazon WorkSpaces Web. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon WorkSpaces Web.
...
/// Configuration for Amazon WorkSpaces Web.
pub mod config;
