...
impl ::std::convert::From<&str> for EnabledType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnabledType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnabledType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnabledType::from(s))
    }
}
impl EnabledType {
...
impl ::std::convert::AsRef<str> for EnabledType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
