...
impl ::std::convert::From<&str> for BrowserType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BrowserType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BrowserType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BrowserType::from(s))
    }
}
impl BrowserType {
...
impl ::std::convert::AsRef<str> for BrowserType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
