...
/// match instancetype {
///     InstanceType::StandardLarge => { /* ... */ },
///     InstanceType::StandardRegular => { /* ... */ },
///     InstanceType::StandardXlarge => { /* ... */ },
...
impl ::std::convert::From<&str> for InstanceType {
    fn from(s: &str) -> Self {
        match s {
            "standard.large" => InstanceType::StandardLarge,
            "standard.regular" => InstanceType::StandardRegular,
            "standard.xlarge" => InstanceType::StandardXlarge,
...
impl InstanceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            InstanceType::StandardLarge => "standard.large",
            InstanceType::StandardRegular => "standard.regular",
            InstanceType::StandardXlarge => "standard.xlarge",
            InstanceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["standard.large", "standard.regular", "standard.xlarge"]
    }
}
