...
impl ::std::convert::From<&str> for RendererType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RendererType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RendererType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RendererType::from(s))
    }
}
impl RendererType {
...
impl ::std::convert::AsRef<str> for RendererType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
