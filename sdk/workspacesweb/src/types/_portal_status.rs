...
impl ::std::convert::From<&str> for PortalStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PortalStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PortalStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PortalStatus::from(s))
    }
}
impl PortalStatus {
...
impl ::std::convert::AsRef<str> for PortalStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
