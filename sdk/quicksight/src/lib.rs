...
//! aws-sdk-quicksight = "0.0.0-local"
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-quicksight/latest/aws_sdk_quicksight/client/struct.Client.html)
...
//! offered by Amazon QuickSight. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon QuickSight.
