...
impl ::std::convert::From<&str> for ReferenceLineLabelVerticalPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReferenceLineLabelVerticalPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceLineLabelVerticalPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceLineLabelVerticalPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReferenceLineLabelVerticalPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
