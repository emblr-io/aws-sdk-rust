...
impl ::std::convert::From<&str> for DashboardErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DashboardErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DashboardErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DashboardErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DashboardErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
