...
impl ::std::convert::From<&str> for GeoSpatialCountryCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GeoSpatialCountryCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GeoSpatialCountryCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GeoSpatialCountryCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GeoSpatialCountryCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
