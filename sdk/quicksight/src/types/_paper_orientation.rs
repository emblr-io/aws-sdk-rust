...
impl ::std::convert::From<&str> for PaperOrientation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PaperOrientation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PaperOrientation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PaperOrientation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PaperOrientation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
