...
impl ::std::convert::From<&str> for ComparisonMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComparisonMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ComparisonMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ComparisonMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ComparisonMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
