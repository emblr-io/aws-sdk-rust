...
impl ::std::convert::From<&str> for DataSetImportMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataSetImportMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataSetImportMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataSetImportMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataSetImportMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
