...
impl ::std::convert::From<&str> for ReferenceLineValueLabelRelativePosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReferenceLineValueLabelRelativePosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceLineValueLabelRelativePosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceLineValueLabelRelativePosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReferenceLineValueLabelRelativePosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
