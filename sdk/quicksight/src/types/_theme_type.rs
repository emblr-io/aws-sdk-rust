...
impl ::std::convert::From<&str> for ThemeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThemeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThemeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThemeType::from(s))
    }
}
impl ThemeType {
...
impl ::std::convert::AsRef<str> for ThemeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
