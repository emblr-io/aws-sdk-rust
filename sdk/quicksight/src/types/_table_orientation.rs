...
impl ::std::convert::From<&str> for TableOrientation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableOrientation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableOrientation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableOrientation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TableOrientation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
