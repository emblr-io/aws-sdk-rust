...
impl ::std::convert::From<&str> for NumericFilterSelectAllOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NumericFilterSelectAllOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NumericFilterSelectAllOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NumericFilterSelectAllOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NumericFilterSelectAllOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
