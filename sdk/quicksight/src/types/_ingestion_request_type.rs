...
impl ::std::convert::From<&str> for IngestionRequestType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IngestionRequestType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IngestionRequestType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IngestionRequestType::from(s))
    }
}
