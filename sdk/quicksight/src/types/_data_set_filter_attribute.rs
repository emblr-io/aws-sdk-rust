...
impl ::std::convert::From<&str> for DataSetFilterAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataSetFilterAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataSetFilterAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataSetFilterAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataSetFilterAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
