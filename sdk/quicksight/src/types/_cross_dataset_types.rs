...
impl ::std::convert::From<&str> for CrossDatasetTypes {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CrossDatasetTypes::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CrossDatasetTypes {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CrossDatasetTypes::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CrossDatasetTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
