...
impl ::std::convert::From<&str> for SheetContentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SheetContentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SheetContentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SheetContentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SheetContentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
