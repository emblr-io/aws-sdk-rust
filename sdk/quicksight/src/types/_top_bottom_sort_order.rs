...
impl ::std::convert::From<&str> for TopBottomSortOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TopBottomSortOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TopBottomSortOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TopBottomSortOrder::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TopBottomSortOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
