...
impl ::std::convert::From<&str> for ArcThickness {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArcThickness::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArcThickness {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArcThickness::from(s))
    }
}
impl ArcThickness {
...
impl ::std::convert::AsRef<str> for ArcThickness {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ArcThickness {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ArcThickness::Large => write!(f, "LARGE"),
            ArcThickness::Medium => write!(f, "MEDIUM"),
            ArcThickness::Small => write!(f, "SMALL"),
            ArcThickness::Whole => write!(f, "WHOLE"),
            ArcThickness::Unknown(value) => write!(f, "{}", value),
        }
    }
}
