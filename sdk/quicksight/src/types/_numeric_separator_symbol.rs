...
impl ::std::convert::From<&str> for NumericSeparatorSymbol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NumericSeparatorSymbol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NumericSeparatorSymbol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NumericSeparatorSymbol::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NumericSeparatorSymbol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
