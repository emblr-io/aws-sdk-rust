...
impl ::std::convert::From<&str> for SelectedTooltipType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SelectedTooltipType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SelectedTooltipType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SelectedTooltipType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SelectedTooltipType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
