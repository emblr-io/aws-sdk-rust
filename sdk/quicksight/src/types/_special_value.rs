...
impl ::std::convert::From<&str> for SpecialValue {
    fn from(s: &str) -> Self {
        match s {
            "EMPTY" => SpecialValue::Empty,
            "NULL" => SpecialValue::Null,
            "OTHER" => SpecialValue::Other,
            other => SpecialValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpecialValue {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpecialValue::from(s))
    }
}
impl SpecialValue {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SpecialValue::Empty => "EMPTY",
            SpecialValue::Null => "NULL",
            SpecialValue::Other => "OTHER",
            SpecialValue::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for SpecialValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
