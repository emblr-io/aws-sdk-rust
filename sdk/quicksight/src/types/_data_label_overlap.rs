...
impl ::std::convert::From<&str> for DataLabelOverlap {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataLabelOverlap::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataLabelOverlap {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataLabelOverlap::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataLabelOverlap {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
