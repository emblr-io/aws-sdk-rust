...
impl ::std::convert::From<&str> for DashboardUiState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DashboardUiState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DashboardUiState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DashboardUiState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DashboardUiState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
