...
impl ::std::convert::From<&str> for TargetVisualOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetVisualOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetVisualOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetVisualOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TargetVisualOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
