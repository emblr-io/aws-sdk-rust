...
impl ::std::convert::From<&str> for BarsArrangement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BarsArrangement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BarsArrangement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BarsArrangement::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BarsArrangement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
