...
impl ::std::convert::From<&str> for OtherCategories {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OtherCategories::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OtherCategories {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OtherCategories::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OtherCategories {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
