...
impl ::std::convert::From<&str> for HistogramBinType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HistogramBinType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HistogramBinType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HistogramBinType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HistogramBinType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
