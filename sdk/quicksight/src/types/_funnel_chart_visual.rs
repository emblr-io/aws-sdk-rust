...
impl FunnelChartVisual {
    ...
    /// <p>The configuration of a <code>FunnelChartVisual</code>.</p>
    pub fn chart_configuration(&self) -> ::std::option::Option<&crate::types::FunnelChartConfiguration> {
...
impl FunnelChartVisualBuilder {
    ...
    /// <p>The configuration of a <code>FunnelChartVisual</code>.</p>
    pub fn set_chart_configuration(mut self, input: ::std::option::Option<crate::types::FunnelChartConfiguration>) -> Self {
        self.chart_configuration = input;
        self
    }
    /// <p>The configuration of a <code>FunnelChartVisual</code>.</p>
    pub fn get_chart_configuration(&self) -> &::std::option::Option<crate::types::FunnelChartConfiguration> {
    ...
    /// - [`visual_id`](crate::types::builders::FunnelChartVisualBuilder::visual_id)
    pub fn build(self) -> ::std::result::Result<crate::types::FunnelChartVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::FunnelChartVisual {
            visual_id: self.visual_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "visual_id",
                    "visual_id was not specified but it is required when building FunnelChartVisual",
                )
            })?,
            title: self.title,
