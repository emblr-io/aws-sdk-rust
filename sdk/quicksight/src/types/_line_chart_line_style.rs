...
impl ::std::convert::From<&str> for LineChartLineStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LineChartLineStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LineChartLineStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LineChartLineStyle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LineChartLineStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
