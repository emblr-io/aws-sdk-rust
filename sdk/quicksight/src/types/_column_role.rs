...
impl ::std::convert::From<&str> for ColumnRole {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ColumnRole::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ColumnRole {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ColumnRole::from(s))
    }
}
impl ColumnRole {
...
impl ::std::convert::AsRef<str> for ColumnRole {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
