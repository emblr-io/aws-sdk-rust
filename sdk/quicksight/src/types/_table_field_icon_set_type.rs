...
impl ::std::convert::From<&str> for TableFieldIconSetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableFieldIconSetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableFieldIconSetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableFieldIconSetType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TableFieldIconSetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
