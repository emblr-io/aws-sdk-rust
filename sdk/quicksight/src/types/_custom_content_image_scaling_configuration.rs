...
impl ::std::convert::From<&str> for CustomContentImageScalingConfiguration {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomContentImageScalingConfiguration::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomContentImageScalingConfiguration {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomContentImageScalingConfiguration::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomContentImageScalingConfiguration {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
