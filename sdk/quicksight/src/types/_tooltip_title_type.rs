...
impl ::std::convert::From<&str> for TooltipTitleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TooltipTitleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TooltipTitleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TooltipTitleType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TooltipTitleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
