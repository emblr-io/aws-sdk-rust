...
impl ::std::convert::From<&str> for GroupFilterAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupFilterAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupFilterAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupFilterAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupFilterAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for GroupFilterAttribute {
