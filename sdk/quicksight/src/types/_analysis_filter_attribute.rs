...
impl ::std::convert::From<&str> for AnalysisFilterAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnalysisFilterAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnalysisFilterAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnalysisFilterAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AnalysisFilterAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
