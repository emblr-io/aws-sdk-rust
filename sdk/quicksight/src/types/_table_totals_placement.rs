...
impl ::std::convert::From<&str> for TableTotalsPlacement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableTotalsPlacement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableTotalsPlacement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableTotalsPlacement::from(s))
    }
}
