...
impl ::std::convert::From<&str> for EmbeddingIdentityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EmbeddingIdentityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EmbeddingIdentityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EmbeddingIdentityType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EmbeddingIdentityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
