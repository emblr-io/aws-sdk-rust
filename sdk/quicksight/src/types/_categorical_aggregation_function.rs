...
impl ::std::convert::From<&str> for CategoricalAggregationFunction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CategoricalAggregationFunction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CategoricalAggregationFunction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CategoricalAggregationFunction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CategoricalAggregationFunction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
