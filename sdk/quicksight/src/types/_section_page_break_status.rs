...
impl ::std::convert::From<&str> for SectionPageBreakStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SectionPageBreakStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SectionPageBreakStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SectionPageBreakStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SectionPageBreakStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
