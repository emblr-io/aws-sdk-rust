...
impl ::std::convert::From<&str> for ArcThicknessOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArcThicknessOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArcThicknessOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArcThicknessOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArcThicknessOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
