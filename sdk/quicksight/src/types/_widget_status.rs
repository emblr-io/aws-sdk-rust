...
impl ::std::convert::From<&str> for WidgetStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WidgetStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WidgetStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WidgetStatus::from(s))
    }
}
impl WidgetStatus {
...
impl ::std::convert::AsRef<str> for WidgetStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
