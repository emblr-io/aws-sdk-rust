...
impl ::std::convert::From<&str> for BarChartOrientation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BarChartOrientation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BarChartOrientation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BarChartOrientation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BarChartOrientation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
