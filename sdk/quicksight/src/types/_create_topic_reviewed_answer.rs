...
impl CreateTopicReviewedAnswer {
    ...
    pub fn builder() -> crate::types::builders::CreateTopicReviewedAnswerBuilder {
        crate::types::builders::CreateTopicReviewedAnswerBuilder::default()
    }
}
...
impl CreateTopicReviewedAnswerBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateTopicReviewedAnswer`](crate::types::CreateTopicReviewedAnswer).
    /// This method will fail if any of the following fields are not set:
    /// - [`answer_id`](crate::types::builders::CreateTopicReviewedAnswerBuilder::answer_id)
    /// - [`dataset_arn`](crate::types::builders::CreateTopicReviewedAnswerBuilder::dataset_arn)
    /// - [`question`](crate::types::builders::CreateTopicReviewedAnswerBuilder::question)
    pub fn build(self) -> ::std::result::Result<crate::types::CreateTopicReviewedAnswer, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::CreateTopicReviewedAnswer {
            answer_id: self.answer_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "answer_id",
                    "answer_id was not specified but it is required when building CreateTopicReviewedAnswer",
                )
            })?,
            dataset_arn: self.dataset_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "dataset_arn",
                    "dataset_arn was not specified but it is required when building CreateTopicReviewedAnswer",
                )
            })?,
            question: self.question.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "question",
                    "question was not specified but it is required when building CreateTopicReviewedAnswer",
                )
            })?,
            mir: self.mir,
