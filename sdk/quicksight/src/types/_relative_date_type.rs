...
impl ::std::convert::From<&str> for RelativeDateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RelativeDateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RelativeDateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RelativeDateType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RelativeDateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
