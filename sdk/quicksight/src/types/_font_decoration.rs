...
impl ::std::convert::From<&str> for FontDecoration {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FontDecoration::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FontDecoration {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FontDecoration::from(s))
    }
}
impl FontDecoration {
...
impl ::std::convert::AsRef<str> for FontDecoration {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
