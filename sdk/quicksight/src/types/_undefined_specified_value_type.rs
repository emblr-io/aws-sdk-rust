...
pub enum UndefinedSpecifiedValueType {
    #[allow(missing_docs)] // documentation missing in model
    Least,
    #[allow(missing_docs)] // documentation missing in model
    Most,
...
impl ::std::convert::From<&str> for UndefinedSpecifiedValueType {
    fn from(s: &str) -> Self {
        match s {
            "LEAST" => UndefinedSpecifiedValueType::Least,
            "MOST" => UndefinedSpecifiedValueType::Most,
            other => UndefinedSpecifiedValueType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UndefinedSpecifiedValueType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UndefinedSpecifiedValueType::from(s))
    }
}
impl UndefinedSpecifiedValueType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            UndefinedSpecifiedValueType::Least => "LEAST",
            UndefinedSpecifiedValueType::Most => "MOST",
            UndefinedSpecifiedValueType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for UndefinedSpecifiedValueType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
