...
impl ::std::convert::From<&str> for CustomContentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomContentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomContentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomContentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomContentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
