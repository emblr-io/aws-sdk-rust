...
impl ::std::convert::From<&str> for LineChartMarkerShape {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LineChartMarkerShape::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LineChartMarkerShape {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LineChartMarkerShape::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LineChartMarkerShape {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
