...
impl ::std::convert::From<&str> for SheetControlSliderType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SheetControlSliderType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SheetControlSliderType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SheetControlSliderType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SheetControlSliderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
