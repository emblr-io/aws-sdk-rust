...
impl ::std::convert::From<&str> for PrimaryValueDisplayType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PrimaryValueDisplayType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PrimaryValueDisplayType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PrimaryValueDisplayType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PrimaryValueDisplayType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
