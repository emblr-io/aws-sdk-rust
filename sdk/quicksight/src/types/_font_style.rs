...
impl ::std::convert::From<&str> for FontStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FontStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FontStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FontStyle::from(s))
    }
}
impl FontStyle {
...
impl ::std::convert::AsRef<str> for FontStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
