...
impl ::std::convert::From<&str> for BoxPlotFillStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BoxPlotFillStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BoxPlotFillStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BoxPlotFillStyle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BoxPlotFillStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
