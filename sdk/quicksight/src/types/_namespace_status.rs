...
impl ::std::convert::From<&str> for NamespaceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NamespaceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NamespaceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NamespaceStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NamespaceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
