...
impl ::std::convert::From<&str> for PivotTableMetricPlacement {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PivotTableMetricPlacement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PivotTableMetricPlacement {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PivotTableMetricPlacement::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PivotTableMetricPlacement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
