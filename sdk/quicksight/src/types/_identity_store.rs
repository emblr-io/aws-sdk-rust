...
impl ::std::convert::From<&str> for IdentityStore {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IdentityStore::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IdentityStore {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IdentityStore::from(s))
    }
}
impl IdentityStore {
...
impl ::std::convert::AsRef<str> for IdentityStore {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for IdentityStore {
