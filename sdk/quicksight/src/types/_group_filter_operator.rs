...
impl ::std::convert::From<&str> for GroupFilterOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupFilterOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupFilterOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupFilterOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GroupFilterOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for GroupFilterOperator {
