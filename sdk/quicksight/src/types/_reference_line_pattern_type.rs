...
impl ::std::convert::From<&str> for ReferenceLinePatternType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReferenceLinePatternType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceLinePatternType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceLinePatternType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReferenceLinePatternType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
