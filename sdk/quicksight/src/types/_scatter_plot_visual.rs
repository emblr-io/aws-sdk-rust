...
pub struct ScatterPlotVisual {
    ...
    pub chart_configuration: ::std::option::Option<crate::types::ScatterPlotConfiguration>,
...
impl ScatterPlotVisual {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn chart_configuration(&self) -> ::std::option::Option<&crate::types::ScatterPlotConfiguration> {
...
impl ScatterPlotVisual {
    ...
    pub fn builder() -> crate::types::builders::ScatterPlotVisualBuilder {
        crate::types::builders::ScatterPlotVisualBuilder::default()
    }
}

/// A builder for [`ScatterPlotVisual`](crate::types::ScatterPlotVisual).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ScatterPlotVisualBuilder {
...
impl ScatterPlotVisualBuilder {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn chart_configuration(mut self, input: crate::types::ScatterPlotConfiguration) -> Self {
        self.chart_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration settings of the visual.</p>
    pub fn set_chart_configuration(mut self, input: ::std::option::Option<crate::types::ScatterPlotConfiguration>) -> Self {
        self.chart_configuration = input;
        self
    }
    /// <p>The configuration settings of the visual.</p>
    pub fn get_chart_configuration(&self) -> &::std::option::Option<crate::types::ScatterPlotConfiguration> {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ScatterPlotVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ScatterPlotVisual {
            visual_id: self.visual_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "visual_id",
                    "visual_id was not specified but it is required when building ScatterPlotVisual",
                )
            })?,
            title: self.title,
