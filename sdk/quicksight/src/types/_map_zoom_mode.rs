...
impl ::std::convert::From<&str> for MapZoomMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MapZoomMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MapZoomMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MapZoomMode::from(s))
    }
}
impl MapZoomMode {
...
impl ::std::convert::AsRef<str> for MapZoomMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
