...
impl ::std::convert::From<&str> for ForecastComputationSeasonality {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ForecastComputationSeasonality::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ForecastComputationSeasonality {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ForecastComputationSeasonality::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ForecastComputationSeasonality {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
