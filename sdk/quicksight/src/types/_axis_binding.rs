...
impl ::std::convert::From<&str> for AxisBinding {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AxisBinding::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AxisBinding {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AxisBinding::from(s))
    }
}
impl AxisBinding {
...
impl ::std::convert::AsRef<str> for AxisBinding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
