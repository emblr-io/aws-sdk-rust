...
pub struct MissingDataConfiguration {
    ...
    /// <ul>
    /// <li>
    /// <p><code>INTERPOLATE</code>: Interpolate missing values between the prior and the next known value.</p></li>
    /// <li>
    /// <p><code>SHOW_AS_ZERO</code>: Show missing values as the value <code>0</code>.</p></li>
    /// <li>
