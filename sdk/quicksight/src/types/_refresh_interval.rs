...
impl ::std::convert::From<&str> for RefreshInterval {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RefreshInterval::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RefreshInterval {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RefreshInterval::from(s))
    }
}
impl RefreshInterval {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RefreshInterval::Hourly => "HOURLY",
            RefreshInterval::Minute15 => "MINUTE15",
            RefreshInterval::Minute30 => "MINUTE30",
            RefreshInterval::Monthly => "MONTHLY",
            RefreshInterval::Weekly => "WEEKLY",
            RefreshInterval::Unknown(value) => value.as_str(),
        }
    }
