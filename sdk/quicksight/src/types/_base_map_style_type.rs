...
impl ::std::convert::From<&str> for BaseMapStyleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BaseMapStyleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BaseMapStyleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BaseMapStyleType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BaseMapStyleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
