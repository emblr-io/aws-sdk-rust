...
impl ::std::convert::From<&str> for TextWrap {
    fn from(s: &str) -> Self {
        match s {
            "NONE" => TextWrap::None,
            "WRAP" => TextWrap::Wrap,
            other => TextWrap::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TextWrap {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TextWrap::from(s))
    }
}
impl TextWrap {
...
impl ::std::convert::AsRef<str> for TextWrap {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
