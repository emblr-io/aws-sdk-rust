...
impl ::std::convert::From<&str> for ThemeErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThemeErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThemeErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThemeErrorType::from(s))
    }
}
impl ThemeErrorType {
...
impl ::std::convert::AsRef<str> for ThemeErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
