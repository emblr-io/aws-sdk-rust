...
impl ::std::convert::From<&str> for ReferenceLineLabelHorizontalPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReferenceLineLabelHorizontalPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceLineLabelHorizontalPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceLineLabelHorizontalPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReferenceLineLabelHorizontalPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
