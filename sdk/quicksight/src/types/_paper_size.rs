...
impl ::std::convert::From<&str> for PaperSize {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PaperSize::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PaperSize {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PaperSize::from(s))
    }
}
impl PaperSize {
...
impl ::std::convert::AsRef<str> for PaperSize {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
