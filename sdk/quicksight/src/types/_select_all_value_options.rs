...
impl ::std::convert::From<&str> for SelectAllValueOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SelectAllValueOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SelectAllValueOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SelectAllValueOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SelectAllValueOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SelectAllValueOptions {
