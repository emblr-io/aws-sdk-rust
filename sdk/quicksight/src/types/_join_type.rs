...
impl ::std::convert::From<&str> for JoinType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JoinType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JoinType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JoinType::from(s))
    }
}
impl JoinType {
...
impl ::std::convert::AsRef<str> for JoinType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
