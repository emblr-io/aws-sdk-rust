...
impl ::std::convert::From<&str> for WordCloudCloudLayout {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WordCloudCloudLayout::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WordCloudCloudLayout {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WordCloudCloudLayout::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WordCloudCloudLayout {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
