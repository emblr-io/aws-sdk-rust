...
impl ::std::convert::From<&str> for TopBottomComputationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TopBottomComputationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TopBottomComputationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TopBottomComputationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TopBottomComputationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
