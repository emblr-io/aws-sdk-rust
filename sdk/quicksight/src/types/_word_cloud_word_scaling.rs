...
impl ::std::convert::From<&str> for WordCloudWordScaling {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WordCloudWordScaling::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WordCloudWordScaling {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WordCloudWordScaling::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WordCloudWordScaling {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
