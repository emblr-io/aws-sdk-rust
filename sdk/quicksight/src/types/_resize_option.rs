...
impl ::std::convert::From<&str> for ResizeOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResizeOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResizeOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResizeOption::from(s))
    }
}
impl ResizeOption {
...
impl ::std::convert::AsRef<str> for ResizeOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
