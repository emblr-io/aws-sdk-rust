...
impl ::std::convert::From<&str> for DataSourceFilterAttribute {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataSourceFilterAttribute::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataSourceFilterAttribute {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataSourceFilterAttribute::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DataSourceFilterAttribute {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
