...
impl ::std::convert::From<&str> for NamespaceErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NamespaceErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NamespaceErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NamespaceErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NamespaceErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
