...
impl ::std::convert::From<&str> for TableBorderStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableBorderStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableBorderStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableBorderStyle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TableBorderStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TableBorderStyle {
