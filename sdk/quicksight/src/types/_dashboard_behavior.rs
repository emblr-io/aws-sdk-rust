...
impl ::std::convert::From<&str> for DashboardBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DashboardBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DashboardBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DashboardBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DashboardBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
