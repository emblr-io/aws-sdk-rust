...
impl ::std::convert::From<&str> for CategoryFilterMatchOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CategoryFilterMatchOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CategoryFilterMatchOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CategoryFilterMatchOperator::from(s))
    }
}
