...
impl ::std::convert::From<&str> for PivotTableSubtotalLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PivotTableSubtotalLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PivotTableSubtotalLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PivotTableSubtotalLevel::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PivotTableSubtotalLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
