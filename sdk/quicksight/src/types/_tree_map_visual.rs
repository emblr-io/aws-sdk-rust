...
pub struct TreeMapVisual {
    ...
    pub chart_configuration: ::std::option::Option<crate::types::TreeMapConfiguration>,
...
impl TreeMapVisual {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn chart_configuration(&self) -> ::std::option::Option<&crate::types::TreeMapConfiguration> {
...
impl TreeMapVisual {
    /// Creates a new builder-style object to manufacture [`TreeMapVisual`](crate::types::TreeMapVisual).
    pub fn builder() -> crate::types::builders::TreeMapVisualBuilder {
        crate::types::builders::TreeMapVisualBuilder::default()
    }
}

/// A builder for [`TreeMapVisual`](crate::types::TreeMapVisual).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TreeMapVisualBuilder {
    ...
    pub(crate) chart_configuration: ::std::option::Option<crate::types::TreeMapConfiguration>,
...
impl TreeMapVisualBuilder {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn chart_configuration(mut self, input: crate::types::TreeMapConfiguration) -> Self {
        self.chart_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration settings of the visual.</p>
    pub fn set_chart_configuration(mut self, input: ::std::option::Option<crate::types::TreeMapConfiguration>) -> Self {
        self.chart_configuration = input;
        self
    }
    /// <p>The configuration settings of the visual.</p>
    pub fn get_chart_configuration(&self) -> &::std::option::Option<crate::types::TreeMapConfiguration> {
