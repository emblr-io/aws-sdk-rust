...
impl ::std::convert::From<&str> for RelativeFontSize {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RelativeFontSize::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RelativeFontSize {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RelativeFontSize::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RelativeFontSize {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
