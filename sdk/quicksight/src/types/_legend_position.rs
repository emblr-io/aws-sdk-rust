...
impl ::std::convert::From<&str> for LegendPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LegendPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LegendPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LegendPosition::from(s))
    }
}
impl LegendPosition {
...
impl ::std::convert::AsRef<str> for LegendPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
