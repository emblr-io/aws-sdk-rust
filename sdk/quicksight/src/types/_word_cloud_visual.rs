...
impl WordCloudVisualBuilder {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn get_chart_configuration(&self) -> &::std::option::Option<crate::types::WordCloudChartConfiguration> {
    ...
    /// - [`visual_id`](crate::types::builders::WordCloudVisualBuilder::visual_id)
    pub fn build(self) -> ::std::result::Result<crate::types::WordCloudVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::WordCloudVisual {
            visual_id: self.visual_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "visual_id",
                    "visual_id was not specified but it is required when building WordCloudVisual",
                )
            })?,
            title: self.title,
