...
impl BodySectionDynamicCategoryDimensionConfiguration {
    /// <p>A column of a data set.</p>
...
impl BodySectionDynamicCategoryDimensionConfiguration {
    /// Creates a new builder-style object to manufacture [`BodySectionDynamicCategoryDimensionConfiguration`](crate::types::BodySectionDynamicCategoryDimensionConfiguration).
    pub fn builder() -> crate::types::builders::BodySectionDynamicCategoryDimensionConfigurationBuilder {
        crate::types::builders::BodySectionDynamicCategoryDimensionConfigurationBuilder::default()
    }
}

/// A builder for [`BodySectionDynamicCategoryDimensionConfiguration`](crate::types::BodySectionDynamicCategoryDimensionConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BodySectionDynamicCategoryDimensionConfigurationBuilder {
...
impl BodySectionDynamicCategoryDimensionConfigurationBuilder {
    /// <p>A column of a data set.</p>
    ...
    /// Consumes the builder and constructs a [`BodySectionDynamicCategoryDimensionConfiguration`](crate::types::BodySectionDynamicCategoryDimensionConfiguration).
    pub fn build(self) -> crate::types::BodySectionDynamicCategoryDimensionConfiguration {
        crate::types::BodySectionDynamicCategoryDimensionConfiguration {
            column: self.column,
            limit: self.limit,
