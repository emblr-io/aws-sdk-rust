...
impl ::std::convert::From<&str> for ExceptionResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExceptionResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExceptionResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExceptionResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExceptionResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
