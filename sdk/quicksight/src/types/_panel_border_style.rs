...
impl ::std::convert::From<&str> for PanelBorderStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PanelBorderStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PanelBorderStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PanelBorderStyle::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PanelBorderStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
