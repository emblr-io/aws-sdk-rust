...
impl ::std::convert::From<&str> for SelectedFieldOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SelectedFieldOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SelectedFieldOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SelectedFieldOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SelectedFieldOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
