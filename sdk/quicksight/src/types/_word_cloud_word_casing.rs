...
impl ::std::convert::From<&str> for WordCloudWordCasing {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WordCloudWordCasing::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WordCloudWordCasing {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WordCloudWordCasing::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WordCloudWordCasing {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
