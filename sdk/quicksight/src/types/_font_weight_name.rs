...
impl ::std::convert::From<&str> for FontWeightName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FontWeightName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FontWeightName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FontWeightName::from(s))
    }
}
impl FontWeightName {
...
impl ::std::convert::AsRef<str> for FontWeightName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
