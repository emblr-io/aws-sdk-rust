...
impl ::std::convert::From<&str> for GeospatialSelectedPointStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GeospatialSelectedPointStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GeospatialSelectedPointStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GeospatialSelectedPointStyle::from(s))
    }
}
