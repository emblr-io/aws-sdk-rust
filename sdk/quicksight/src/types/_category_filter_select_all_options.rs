...
impl ::std::convert::From<&str> for CategoryFilterSelectAllOptions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CategoryFilterSelectAllOptions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CategoryFilterSelectAllOptions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CategoryFilterSelectAllOptions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CategoryFilterSelectAllOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CategoryFilterSelectAllOptions {
