...
impl ::std::convert::From<&str> for AnchorOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnchorOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnchorOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnchorOption::from(s))
    }
}
impl AnchorOption {
...
impl ::std::convert::AsRef<str> for AnchorOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
