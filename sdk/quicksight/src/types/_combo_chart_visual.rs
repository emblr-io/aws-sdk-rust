...
pub struct ComboChartVisual {
    ...
    pub chart_configuration: ::std::option::Option<crate::types::ComboChartConfiguration>,
...
impl ComboChartVisual {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn chart_configuration(&self) -> ::std::option::Option<&crate::types::ComboChartConfiguration> {
...
impl ComboChartVisual {
    /// Creates a new builder-style object to manufacture [`ComboChartVisual`](crate::types::ComboChartVisual).
    pub fn builder() -> crate::types::builders::ComboChartVisualBuilder {
        crate::types::builders::ComboChartVisualBuilder::default()
    }
}

/// A builder for [`ComboChartVisual`](crate::types::ComboChartVisual).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ComboChartVisualBuilder {
    ...
    pub(crate) chart_configuration: ::std::option::Option<crate::types::ComboChartConfiguration>,
...
impl ComboChartVisualBuilder {
    ...
    /// <p>The configuration settings of the visual.</p>
    pub fn chart_configuration(mut self, input: crate::types::ComboChartConfiguration) -> Self {
        self.chart_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration settings of the visual.</p>
    pub fn set_chart_configuration(mut self, input: ::std::option::Option<crate::types::ComboChartConfiguration>) -> Self {
        self.chart_configuration = input;
        self
    }
    /// <p>The configuration settings of the visual.</p>
    pub fn get_chart_configuration(&self) -> &::std::option::Option<crate::types::ComboChartConfiguration> {
    ...
    /// Consumes the builder and constructs a [`ComboChartVisual`](crate::types::ComboChartVisual).
    /// This method will fail if any of the following fields are not set:
    /// - [`visual_id`](crate::types::builders::ComboChartVisualBuilder::visual_id)
    pub fn build(self) -> ::std::result::Result<crate::types::ComboChartVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ComboChartVisual {
            visual_id: self.visual_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "visual_id",
                    "visual_id was not specified but it is required when building ComboChartVisual",
                )
            })?,
            title: self.title,
