...
pub struct LineChartVisual {
    ...
    pub chart_configuration: ::std::option::Option<crate::types::LineChartConfiguration>,
...
impl LineChartVisual {
    /// Creates a new builder-style object to manufacture [`LineChartVisual`](crate::types::LineChartVisual).
    pub fn builder() -> crate::types::builders::LineChartVisualBuilder {
        crate::types::builders::LineChartVisualBuilder::default()
    }
}
...
impl LineChartVisualBuilder {
    ...
    /// <p>The configuration of a line chart.</p>
    pub fn chart_configuration(mut self, input: crate::types::LineChartConfiguration) -> Self {
    ...
    /// - [`visual_id`](crate::types::builders::LineChartVisualBuilder::visual_id)
    pub fn build(self) -> ::std::result::Result<crate::types::LineChartVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::LineChartVisual {
            visual_id: self.visual_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "visual_id",
                    "visual_id was not specified but it is required when building LineChartVisual",
                )
            })?,
            title: self.title,
