...
impl ::std::convert::From<&str> for MaximumMinimumComputationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MaximumMinimumComputationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MaximumMinimumComputationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MaximumMinimumComputationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MaximumMinimumComputationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
