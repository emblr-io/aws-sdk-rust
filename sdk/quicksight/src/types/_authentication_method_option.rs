...
impl ::std::convert::From<&str> for AuthenticationMethodOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthenticationMethodOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthenticationMethodOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthenticationMethodOption::from(s))
    }
}
