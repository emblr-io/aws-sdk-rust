...
impl ::std::convert::From<&str> for ColorFillType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ColorFillType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ColorFillType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ColorFillType::from(s))
    }
}
impl ColorFillType {
...
impl ::std::convert::AsRef<str> for ColorFillType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
