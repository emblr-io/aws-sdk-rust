...
pub enum ReferenceLineSeriesType {
    #[allow(missing_docs)] // documentation missing in model
    Bar,
    #[allow(missing_docs)] // documentation missing in model
    Line,
...
impl ::std::convert::From<&str> for ReferenceLineSeriesType {
    fn from(s: &str) -> Self {
        match s {
            "BAR" => ReferenceLineSeriesType::Bar,
            "LINE" => ReferenceLineSeriesType::Line,
            other => ReferenceLineSeriesType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReferenceLineSeriesType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReferenceLineSeriesType::from(s))
    }
}
impl ReferenceLineSeriesType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ReferenceLineSeriesType::Bar => "BAR",
            ReferenceLineSeriesType::Line => "LINE",
            ReferenceLineSeriesType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ReferenceLineSeriesType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
