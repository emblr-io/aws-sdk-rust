...
impl ::std::convert::From<&str> for TableTotalsScrollStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableTotalsScrollStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableTotalsScrollStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableTotalsScrollStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TableTotalsScrollStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
