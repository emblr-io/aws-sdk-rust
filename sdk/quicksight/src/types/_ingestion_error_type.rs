...
impl ::std::convert::From<&str> for IngestionErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IngestionErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IngestionErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IngestionErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IngestionErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for IngestionErrorType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            IngestionErrorType::AccountCapacityLimitExceeded => write!(f, "ACCOUNT_CAPACITY_LIMIT_EXCEEDED"),
            IngestionErrorType::ConnectionFailure => write!(f, "CONNECTION_FAILURE"),
            IngestionErrorType::CursorNotEnabled => write!(f, "CURSOR_NOT_ENABLED"),
            IngestionErrorType::CustomerError => write!(f, "CUSTOMER_ERROR"),
            IngestionErrorType::DataSetDeleted => write!(f, "DATA_SET_DELETED"),
            IngestionErrorType::DataSetNotSpice => write!(f, "DATA_SET_NOT_SPICE"),
            IngestionErrorType::DataSetSizeLimitExceeded => write!(f, "DATA_SET_SIZE_LIMIT_EXCEEDED"),
            IngestionErrorType::DataSourceAuthFailed => write!(f, "DATA_SOURCE_AUTH_FAILED"),
            IngestionErrorType::DataSourceConnectionFailed => write!(f, "DATA_SOURCE_CONNECTION_FAILED"),
            IngestionErrorType::DataSourceNotFound => write!(f, "DATA_SOURCE_NOT_FOUND"),
            IngestionErrorType::DataToleranceException => write!(f, "DATA_TOLERANCE_EXCEPTION"),
            IngestionErrorType::DuplicateColumnNamesFound => write!(f, "DUPLICATE_COLUMN_NAMES_FOUND"),
            IngestionErrorType::ElasticsearchCursorNotEnabled => write!(f, "ELASTICSEARCH_CURSOR_NOT_ENABLED"),
            IngestionErrorType::FailureToAssumeRole => write!(f, "FAILURE_TO_ASSUME_ROLE"),
            IngestionErrorType::FailureToProcessJsonFile => write!(f, "FAILURE_TO_PROCESS_JSON_FILE"),
            IngestionErrorType::IamRoleNotAvailable => write!(f, "IAM_ROLE_NOT_AVAILABLE"),
            IngestionErrorType::IngestionCanceled => write!(f, "INGESTION_CANCELED"),
            IngestionErrorType::IngestionSuperseded => write!(f, "INGESTION_SUPERSEDED"),
            IngestionErrorType::InternalServiceError => write!(f, "INTERNAL_SERVICE_ERROR"),
            IngestionErrorType::InvalidDataprepSyntax => write!(f, "INVALID_DATAPREP_SYNTAX"),
            IngestionErrorType::InvalidDataSourceConfig => write!(f, "INVALID_DATA_SOURCE_CONFIG"),
            IngestionErrorType::InvalidDateFormat => write!(f, "INVALID_DATE_FORMAT"),
            IngestionErrorType::IotDataSetFileEmpty => write!(f, "IOT_DATA_SET_FILE_EMPTY"),
            IngestionErrorType::IotFileNotFound => write!(f, "IOT_FILE_NOT_FOUND"),
            IngestionErrorType::OauthTokenFailure => write!(f, "OAUTH_TOKEN_FAILURE"),
            IngestionErrorType::PasswordAuthenticationFailure => write!(f, "PASSWORD_AUTHENTICATION_FAILURE"),
            IngestionErrorType::PermissionDenied => write!(f, "PERMISSION_DENIED"),
            IngestionErrorType::PermissionNotFound => write!(f, "PERMISSION_NOT_FOUND"),
            IngestionErrorType::QueryTimeout => write!(f, "QUERY_TIMEOUT"),
            IngestionErrorType::RefreshSuppressedByEdit => write!(f, "REFRESH_SUPPRESSED_BY_EDIT"),
            IngestionErrorType::RowSizeLimitExceeded => write!(f, "ROW_SIZE_LIMIT_EXCEEDED"),
            IngestionErrorType::S3FileInaccessible => write!(f, "S3_FILE_INACCESSIBLE"),
            IngestionErrorType::S3ManifestError => write!(f, "S3_MANIFEST_ERROR"),
            IngestionErrorType::S3UploadedFileDeleted => write!(f, "S3_UPLOADED_FILE_DELETED"),
            IngestionErrorType::SourceApiLimitExceededFailure => write!(f, "SOURCE_API_LIMIT_EXCEEDED_FAILURE"),
            IngestionErrorType::SourceResourceLimitExceeded => write!(f, "SOURCE_RESOURCE_LIMIT_EXCEEDED"),
            IngestionErrorType::SpiceTableNotFound => write!(f, "SPICE_TABLE_NOT_FOUND"),
            IngestionErrorType::SqlException => write!(f, "SQL_EXCEPTION"),
            IngestionErrorType::SqlInvalidParameterValue => write!(f, "SQL_INVALID_PARAMETER_VALUE"),
            IngestionErrorType::SqlNumericOverflow => write!(f, "SQL_NUMERIC_OVERFLOW"),
            IngestionErrorType::SqlSchemaMismatchError => write!(f, "SQL_SCHEMA_MISMATCH_ERROR"),
            IngestionErrorType::SqlTableNotFound => write!(f, "SQL_TABLE_NOT_FOUND"),
