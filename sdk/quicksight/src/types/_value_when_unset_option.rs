...
impl ::std::convert::From<&str> for ValueWhenUnsetOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ValueWhenUnsetOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValueWhenUnsetOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValueWhenUnsetOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ValueWhenUnsetOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
