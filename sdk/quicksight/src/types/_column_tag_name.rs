...
impl ::std::convert::From<&str> for ColumnTagName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ColumnTagName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ColumnTagName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ColumnTagName::from(s))
    }
}
impl ColumnTagName {
...
impl ::std::convert::AsRef<str> for ColumnTagName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
