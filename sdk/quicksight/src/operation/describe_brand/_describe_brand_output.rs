...
pub struct DescribeBrandOutput {
...
impl ::aws_types::request_id::RequestId for DescribeBrandOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeBrandOutput {
    /// Creates a new builder-style object to manufacture [`DescribeBrandOutput`](crate::operation::describe_brand::DescribeBrandOutput).
    pub fn builder() -> crate::operation::describe_brand::builders::DescribeBrandOutputBuilder {
        crate::operation::describe_brand::builders::DescribeBrandOutputBuilder::default()
    }
}

/// A builder for [`DescribeBrandOutput`](crate::operation::describe_brand::DescribeBrandOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeBrandOutputBuilder {
...
impl DescribeBrandOutputBuilder {
    /// <p>The Amazon Web Services request ID for this operation.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeBrandOutput`](crate::operation::describe_brand::DescribeBrandOutput).
    pub fn build(self) -> crate::operation::describe_brand::DescribeBrandOutput {
        crate::operation::describe_brand::DescribeBrandOutput {
