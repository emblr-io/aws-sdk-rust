...
pub struct UpdateTopicRefreshScheduleOutput {
...
impl ::aws_types::request_id::RequestId for UpdateTopicRefreshScheduleOutput {
...
impl UpdateTopicRefreshScheduleOutputBuilder {
    /// <p>The ID of the topic that you want to modify. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
