...
impl ListDashboardVersionsOutput {
    ...
    pub fn dashboard_version_summary_list(&self) -> &[crate::types::DashboardVersionSummary] {
        self.dashboard_version_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>The token for the next set of results, or null if there are no more results.</p>
...
impl ListDashboardVersionsOutputBuilder {
    ...
    pub fn set_dashboard_version_summary_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::DashboardVersionSummary>>,
    ) -> Self {
