...
impl SearchDataSetsOutput {
    ...
    pub fn data_set_summaries(&self) -> &[crate::types::DataSetSummary] {
        self.data_set_summaries.as_deref().unwrap_or_default()
    }
    /// <p>A pagination token that can be used in a subsequent request.</p>
...
impl ::aws_types::request_id::RequestId for SearchDataSetsOutput {
...
impl SearchDataSetsOutput {
    ...
    pub fn builder() -> crate::operation::search_data_sets::builders::SearchDataSetsOutputBuilder {
        crate::operation::search_data_sets::builders::SearchDataSetsOutputBuilder::default()
    }
}
...
impl SearchDataSetsOutputBuilder {
    ...
    pub fn data_set_summaries(mut self, input: crate::types::DataSetSummary) -> Self {
        ...
        v.push(input);
        self.data_set_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>A <code>DataSetSummaries</code> object that returns a summary of a dataset.</p>
