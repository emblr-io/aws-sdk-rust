...
impl ::aws_types::request_id::RequestId for DescribeIngestionOutput {
...
impl DescribeIngestionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeIngestionOutput`](crate::operation::describe_ingestion::DescribeIngestionOutput).
