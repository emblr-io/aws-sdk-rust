...
impl ListThemesOutput {
    /// <p>Information about the themes in the list.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.theme_summary_list.is_none()`.
    pub fn theme_summary_list(&self) -> &[crate::types::ThemeSummary] {
        self.theme_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>The token for the next set of results, or null if there are no more results.</p>
...
impl ::aws_types::request_id::RequestId for ListThemesOutput {
...
impl ListThemesOutputBuilder {
    ...
    pub fn theme_summary_list(mut self, input: crate::types::ThemeSummary) -> Self {
        ...
        v.push(input);
        self.theme_summary_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>Information about the themes in the list.</p>
