...
impl ::aws_types::request_id::RequestId for CreateThemeAliasOutput {
...
impl CreateThemeAliasOutputBuilder {
    /// <p>Information about the theme alias.</p>
    pub fn theme_alias(mut self, input: crate::types::ThemeAlias) -> Self {
        self.theme_alias = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the theme alias.</p>
    ...
    /// Consumes the builder and constructs a [`CreateThemeAliasOutput`](crate::operation::create_theme_alias::CreateThemeAliasOutput).
    pub fn build(self) -> crate::operation::create_theme_alias::CreateThemeAliasOutput {
