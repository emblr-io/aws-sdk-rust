...
impl ListUsersOutput {
    /// <p>The list of users.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.user_list.is_none()`.
    pub fn user_list(&self) -> &[crate::types::User] {
        self.user_list.as_deref().unwrap_or_default()
    }
    /// <p>A pagination token that can be used in a subsequent request.</p>
...
impl ListUsersOutputBuilder {
    ...
    pub fn user_list(mut self, input: crate::types::User) -> Self {
        ...
        v.push(input);
        self.user_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>The list of users.</p>
    ...
    /// <p>The list of users.</p>
    pub fn get_user_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::User>> {
        &self.user_list
    }
    /// <p>A pagination token that can be used in a subsequent request.</p>
