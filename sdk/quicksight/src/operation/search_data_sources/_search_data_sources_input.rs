...
impl SearchDataSourcesInput {
    ...
    pub fn filters(&self) -> &[crate::types::DataSourceSearchFilter] {
...
impl SearchDataSourcesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::search_data_sources::SearchDataSourcesInput, ::aws_smithy_types::error::operation::BuildError> {
