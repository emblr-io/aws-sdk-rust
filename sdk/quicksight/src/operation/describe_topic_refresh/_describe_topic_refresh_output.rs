...
impl DescribeTopicRefreshOutputBuilder {
    /// <p>Details of the refresh, which is performed when the topic is created or updated.</p>
    pub fn refresh_details(mut self, input: crate::types::TopicRefreshDetails) -> Self {
        self.refresh_details = ::std::option::Option::Some(input);
        self
    }
    /// <p>Details of the refresh, which is performed when the topic is created or updated.</p>
