...
impl ListRoleMembershipsOutput {
    ...
    pub fn builder() -> crate::operation::list_role_memberships::builders::ListRoleMembershipsOutputBuilder {
        crate::operation::list_role_memberships::builders::ListRoleMembershipsOutputBuilder::default()
    }
}
...
impl ListRoleMembershipsOutputBuilder {
    /// Appends an item to `members_list`.
    ///
    /// To override the contents of this collection use [`set_members_list`](Self::set_members_list).
    ///
    /// <p>The list of groups associated with a role</p>
