...
impl SearchFoldersInput {
    /// Creates a new builder-style object to manufacture [`SearchFoldersInput`](crate::operation::search_folders::SearchFoldersInput).
    pub fn builder() -> crate::operation::search_folders::builders::SearchFoldersInputBuilder {
        crate::operation::search_folders::builders::SearchFoldersInputBuilder::default()
    }
}
