...
impl ::std::convert::From<&str> for ContactListImportAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContactListImportAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContactListImportAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContactListImportAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContactListImportAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
