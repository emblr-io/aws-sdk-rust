...
impl ::std::convert::From<&str> for ScalingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScalingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScalingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScalingMode::from(s))
    }
}
impl ScalingMode {
...
impl ::std::convert::AsRef<str> for ScalingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
