...
impl ::std::convert::From<&str> for ListRecommendationsFilterKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListRecommendationsFilterKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListRecommendationsFilterKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListRecommendationsFilterKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListRecommendationsFilterKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
