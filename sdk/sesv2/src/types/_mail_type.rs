...
impl ::std::convert::From<&str> for MailType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MailType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MailType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MailType::from(s))
    }
}
impl MailType {
...
impl ::std::convert::AsRef<str> for MailType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
