...
impl ::std::convert::From<&str> for SuppressionListImportAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SuppressionListImportAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SuppressionListImportAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SuppressionListImportAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SuppressionListImportAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
