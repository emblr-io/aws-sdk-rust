...
impl ::std::convert::From<&str> for SuppressionListReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SuppressionListReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SuppressionListReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SuppressionListReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SuppressionListReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
