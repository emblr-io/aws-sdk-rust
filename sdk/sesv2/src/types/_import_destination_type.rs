...
impl ::std::convert::From<&str> for ImportDestinationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ImportDestinationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ImportDestinationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImportDestinationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ImportDestinationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
