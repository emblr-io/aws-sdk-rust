...
impl ::std::convert::From<&str> for BounceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "UNDETERMINED" => BounceType::Undetermined,
            other => BounceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BounceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BounceType::from(s))
    }
}
impl BounceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            BounceType::Permanent => "PERMANENT",
...
impl ::std::convert::AsRef<str> for BounceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
