...
//! offered by Amazon DocumentDB with MongoDB compatibility. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon DocumentDB with MongoDB compatibility.
...
/// For example, the [`AddSourceIdentifierToSubscription`](crate::operation::add_source_identifier_to_subscription) operation has
/// a [`Client::add_source_identifier_to_subscription`], function which returns a builder for that operation.
...
/// Configuration for Amazon DocumentDB with MongoDB compatibility.
pub mod config;
