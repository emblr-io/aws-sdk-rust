...
//! offered by AWS IoT Data Plane. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT Data Plane.
...
/// Configuration for AWS IoT Data Plane.
pub mod config;
