...
impl ::std::convert::From<&str> for PayloadFormatIndicator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PayloadFormatIndicator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PayloadFormatIndicator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PayloadFormatIndicator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PayloadFormatIndicator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
