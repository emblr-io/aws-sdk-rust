...
//! offered by Amazon Kinesis Video Streams Media. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Kinesis Video Streams Media.
...
/// let config = aws_sdk_kinesisvideomedia::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`GetMedia`](crate::operation::get_media) operation has
/// a [`Client::get_media`], function which returns a builder for that operation.
...
/// Configuration for Amazon Kinesis Video Streams Media.
pub mod config;
