...
impl ::std::convert::From<&str> for StartSelectorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StartSelectorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StartSelectorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StartSelectorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StartSelectorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
