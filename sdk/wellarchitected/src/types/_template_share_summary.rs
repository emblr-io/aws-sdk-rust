...
pub struct TemplateShareSummary {
...
impl TemplateShareSummary {
    /// Creates a new builder-style object to manufacture [`TemplateShareSummary`](crate::types::TemplateShareSummary).
    pub fn builder() -> crate::types::builders::TemplateShareSummaryBuilder {
        crate::types::builders::TemplateShareSummaryBuilder::default()
    }
}

/// A builder for [`TemplateShareSummary`](crate::types::TemplateShareSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TemplateShareSummaryBuilder {
...
impl TemplateShareSummaryBuilder {
    /// <p>The ID associated with the share.</p>
    ...
    /// Consumes the builder and constructs a [`TemplateShareSummary`](crate::types::TemplateShareSummary).
    pub fn build(self) -> crate::types::TemplateShareSummary {
        crate::types::TemplateShareSummary {
