...
impl ::std::convert::From<&str> for CheckStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CheckStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CheckStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CheckStatus::from(s))
    }
}
impl CheckStatus {
...
impl ::std::convert::AsRef<str> for CheckStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
