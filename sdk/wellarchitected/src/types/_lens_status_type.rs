...
impl ::std::convert::From<&str> for LensStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LensStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LensStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LensStatusType::from(s))
    }
}
impl LensStatusType {
...
impl ::std::convert::AsRef<str> for LensStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
