...
impl ::std::convert::From<&str> for ShareInvitationAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ShareInvitationAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShareInvitationAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShareInvitationAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ShareInvitationAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
