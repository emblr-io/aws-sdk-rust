...
impl ::std::convert::From<&str> for CheckFailureReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CheckFailureReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CheckFailureReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CheckFailureReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CheckFailureReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
