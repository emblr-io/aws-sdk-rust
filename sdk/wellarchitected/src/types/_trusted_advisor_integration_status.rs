...
impl ::std::convert::From<&str> for TrustedAdvisorIntegrationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrustedAdvisorIntegrationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrustedAdvisorIntegrationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrustedAdvisorIntegrationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TrustedAdvisorIntegrationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
