...
impl ::std::convert::From<&str> for OrganizationSharingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrganizationSharingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrganizationSharingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrganizationSharingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrganizationSharingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
