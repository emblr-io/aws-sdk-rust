...
impl ::std::convert::From<&str> for LensStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LensStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LensStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LensStatus::from(s))
    }
}
impl LensStatus {
...
impl ::std::convert::AsRef<str> for LensStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
