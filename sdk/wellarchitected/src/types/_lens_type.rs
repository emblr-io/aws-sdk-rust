...
impl ::std::convert::From<&str> for LensType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LensType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LensType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LensType::from(s))
    }
}
impl LensType {
...
impl ::std::convert::AsRef<str> for LensType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
