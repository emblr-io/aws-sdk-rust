...
impl ::std::convert::From<&str> for AdditionalResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AdditionalResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AdditionalResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AdditionalResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AdditionalResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AdditionalResourceType {
