...
impl ProfileChoice {
    /// Creates a new builder-style object to manufacture [`ProfileChoice`](crate::types::ProfileChoice).
    pub fn builder() -> crate::types::builders::ProfileChoiceBuilder {
        crate::types::builders::ProfileChoiceBuilder::default()
    }
}
