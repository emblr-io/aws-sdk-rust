...
impl DeleteWorkloadInput {
    /// Creates a new builder-style object to manufacture [`DeleteWorkloadInput`](crate::operation::delete_workload::DeleteWorkloadInput).
    pub fn builder() -> crate::operation::delete_workload::builders::DeleteWorkloadInputBuilder {
        crate::operation::delete_workload::builders::DeleteWorkloadInputBuilder::default()
    }
}

/// A builder for [`DeleteWorkloadInput`](crate::operation::delete_workload::DeleteWorkloadInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteWorkloadInputBuilder {
    pub(crate) workload_id: ::std::option::Option<::std::string::String>,
    pub(crate) client_request_token: ::std::option::Option<::std::string::String>,
}
impl DeleteWorkloadInputBuilder {
    /// <p>The ID assigned to the workload. This ID is unique within an Amazon Web Services Region.</p>
