...
impl ::aws_types::request_id::RequestId for ExportLensOutput {
...
impl ExportLensOutputBuilder {
    /// <p>The JSON representation of a lens.</p>
    pub fn lens_json(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.lens_json = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The JSON representation of a lens.</p>
