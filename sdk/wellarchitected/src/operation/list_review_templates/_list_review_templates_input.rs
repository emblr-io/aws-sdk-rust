...
pub struct ListReviewTemplatesInput {
    /// <p>The token to use to retrieve the next set of results.</p>
    pub next_token: ::std::option::Option<::std::string::String>,
    /// <p>The maximum number of results to return for this request.</p>
    pub max_results: ::std::option::Option<i32>,
}
impl ListReviewTemplatesInput {
    /// <p>The token to use to retrieve the next set of results.</p>
...
impl ListReviewTemplatesInput {
    /// Creates a new builder-style object to manufacture [`ListReviewTemplatesInput`](crate::operation::list_review_templates::ListReviewTemplatesInput).
    pub fn builder() -> crate::operation::list_review_templates::builders::ListReviewTemplatesInputBuilder {
        crate::operation::list_review_templates::builders::ListReviewTemplatesInputBuilder::default()
    }
}
...
impl ListReviewTemplatesInputBuilder {
    /// <p>The token to use to retrieve the next set of results.</p>
