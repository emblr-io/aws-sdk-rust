...
impl ::aws_types::request_id::RequestId for UpdateGlobalSettingsOutput {
...
impl UpdateGlobalSettingsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateGlobalSettingsOutput`](crate::operation::update_global_settings::UpdateGlobalSettingsOutput).
    pub fn build(self) -> crate::operation::update_global_settings::UpdateGlobalSettingsOutput {
