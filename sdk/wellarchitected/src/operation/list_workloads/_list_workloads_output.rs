...
impl ListWorkloadsOutput {
    /// <p>A list of workload summaries.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.workload_summaries.is_none()`.
    pub fn workload_summaries(&self) -> &[crate::types::WorkloadSummary] {
        self.workload_summaries.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next set of results.</p>
