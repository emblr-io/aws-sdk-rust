...
impl ::aws_types::request_id::RequestId for CreateRecoveryGroupOutput {
...
impl CreateRecoveryGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateRecoveryGroupOutput`](crate::operation::create_recovery_group::CreateRecoveryGroupOutput).
    pub fn build(self) -> crate::operation::create_recovery_group::CreateRecoveryGroupOutput {
