...
impl ::aws_types::request_id::RequestId for DeleteRecoveryGroupOutput {
...
impl DeleteRecoveryGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteRecoveryGroupOutput`](crate::operation::delete_recovery_group::DeleteRecoveryGroupOutput).
    pub fn build(self) -> crate::operation::delete_recovery_group::DeleteRecoveryGroupOutput {
        crate::operation::delete_recovery_group::DeleteRecoveryGroupOutput {
