...
impl ::aws_types::request_id::RequestId for CreateReadinessCheckOutput {
...
impl CreateReadinessCheckOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateReadinessCheckOutput`](crate::operation::create_readiness_check::CreateReadinessCheckOutput).
    pub fn build(self) -> crate::operation::create_readiness_check::CreateReadinessCheckOutput {
