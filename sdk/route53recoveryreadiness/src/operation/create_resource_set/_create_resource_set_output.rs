...
impl CreateResourceSetOutput {
    /// Creates a new builder-style object to manufacture [`CreateResourceSetOutput`](crate::operation::create_resource_set::CreateResourceSetOutput).
    pub fn builder() -> crate::operation::create_resource_set::builders::CreateResourceSetOutputBuilder {
        crate::operation::create_resource_set::builders::CreateResourceSetOutputBuilder::default()
    }
}

/// A builder for [`CreateResourceSetOutput`](crate::operation::create_resource_set::CreateResourceSetOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateResourceSetOutputBuilder {
...
impl CreateResourceSetOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) for the resource set.</p>
    ...
    /// Consumes the builder and constructs a [`CreateResourceSetOutput`](crate::operation::create_resource_set::CreateResourceSetOutput).
    pub fn build(self) -> crate::operation::create_resource_set::CreateResourceSetOutput {
