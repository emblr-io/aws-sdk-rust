...
impl ::aws_types::request_id::RequestId for DeleteReadinessCheckOutput {
...
impl DeleteReadinessCheckOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteReadinessCheckOutput`](crate::operation::delete_readiness_check::DeleteReadinessCheckOutput).
    pub fn build(self) -> crate::operation::delete_readiness_check::DeleteReadinessCheckOutput {
