...
impl CreateCellOutput {
    /// Creates a new builder-style object to manufacture [`CreateCellOutput`](crate::operation::create_cell::CreateCellOutput).
    pub fn builder() -> crate::operation::create_cell::builders::CreateCellOutputBuilder {
        crate::operation::create_cell::builders::CreateCellOutputBuilder::default()
    }
}
...
impl CreateCellOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateCellOutput`](crate::operation::create_cell::CreateCellOutput).
    pub fn build(self) -> crate::operation::create_cell::CreateCellOutput {
