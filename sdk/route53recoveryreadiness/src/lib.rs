...
//! aws-sdk-route53recoveryreadiness = "0.0.0-local"
...
//! offered by AWS Route53 Recovery Readiness. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Route53 Recovery Readiness.
...
/// let config = aws_sdk_route53recoveryreadiness::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`CreateCell`](crate::operation::create_cell) operation has
/// a [`Client::create_cell`], function which returns a builder for that operation.
...
/// Configuration for AWS Route53 Recovery Readiness.
pub mod config;
