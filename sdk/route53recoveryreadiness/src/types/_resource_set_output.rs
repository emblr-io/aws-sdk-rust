...
impl ResourceSetOutput {
    /// Creates a new builder-style object to manufacture [`ResourceSetOutput`](crate::types::ResourceSetOutput).
    pub fn builder() -> crate::types::builders::ResourceSetOutputBuilder {
        crate::types::builders::ResourceSetOutputBuilder::default()
    }
}
...
impl ResourceSetOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ResourceSetOutput`](crate::types::ResourceSetOutput).
    pub fn build(self) -> crate::types::ResourceSetOutput {
        crate::types::ResourceSetOutput {
