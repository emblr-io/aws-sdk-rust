...
impl ::std::convert::From<&str> for SyncMetadataStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncMetadataStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncMetadataStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncMetadataStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SyncMetadataStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
