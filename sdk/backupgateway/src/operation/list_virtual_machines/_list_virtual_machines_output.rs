...
impl ::aws_types::request_id::RequestId for ListVirtualMachinesOutput {
...
impl ListVirtualMachinesOutputBuilder {
    ...
    pub fn virtual_machines(mut self, input: crate::types::VirtualMachine) -> Self {
        ...
        v.push(input);
        self.virtual_machines = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of your <code>VirtualMachine</code> objects, ordered by their Amazon Resource Names (ARNs).</p>
    ...
    /// <p>A list of your <code>VirtualMachine</code> objects, ordered by their Amazon Resource Names (ARNs).</p>
    pub fn get_virtual_machines(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::VirtualMachine>> {
