...
//! offered by Amazon Voice ID. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Voice ID.
...
/// Configuration for Amazon Voice ID.
pub mod config;
