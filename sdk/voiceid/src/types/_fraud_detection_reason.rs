...
impl ::std::convert::From<&str> for FraudDetectionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FraudDetectionReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FraudDetectionReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FraudDetectionReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FraudDetectionReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
