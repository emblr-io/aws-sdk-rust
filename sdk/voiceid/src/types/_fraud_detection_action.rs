...
impl ::std::convert::From<&str> for FraudDetectionAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FraudDetectionAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FraudDetectionAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FraudDetectionAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FraudDetectionAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
