...
impl ::std::convert::From<&str> for ServerSideEncryptionUpdateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServerSideEncryptionUpdateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServerSideEncryptionUpdateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServerSideEncryptionUpdateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServerSideEncryptionUpdateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
