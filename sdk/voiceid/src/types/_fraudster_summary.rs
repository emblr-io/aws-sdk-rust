...
impl FraudsterSummary {
    /// Creates a new builder-style object to manufacture [`FraudsterSummary`](crate::types::FraudsterSummary).
    pub fn builder() -> crate::types::builders::FraudsterSummaryBuilder {
        crate::types::builders::FraudsterSummaryBuilder::default()
    }
}
...
impl FraudsterSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`FraudsterSummary`](crate::types::FraudsterSummary).
    pub fn build(self) -> crate::types::FraudsterSummary {
        crate::types::FraudsterSummary {
