...
impl ::std::convert::From<&str> for SpeakerStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpeakerStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpeakerStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpeakerStatus::from(s))
    }
}
impl SpeakerStatus {
...
impl ::std::convert::AsRef<str> for SpeakerStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
