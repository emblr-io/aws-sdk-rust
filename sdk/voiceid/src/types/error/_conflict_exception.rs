...
pub struct ConflictException {
    ...
    /// <ul>
    /// <li>
    /// <p><code>DOMAIN_NOT_ACTIVE</code>: The domain is not active.</p></li>
    /// <li>
    /// <p><code>CANNOT_CHANGE_SPEAKER_AFTER_ENROLLMENT</code>: You cannot change the speaker ID after an enrollment has been requested.</p></li>
    /// <li>
    /// <p><code>ENROLLMENT_ALREADY_EXISTS</code>: There is already an enrollment for this session.</p></li>
    /// <li>
    /// <p><code>SPEAKER_NOT_SET</code>: You must set the speaker ID before requesting an enrollment.</p></li>
    /// <li>
    /// <p><code>SPEAKER_OPTED_OUT</code>: You cannot request an enrollment for an opted out speaker.</p></li>
    /// <li>
    /// <p><code>CONCURRENT_CHANGES</code>: The request could not be processed as the resource was modified by another request during execution.</p></li>
    /// </ul>
