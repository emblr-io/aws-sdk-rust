...
/// A builder for [`AssociateFraudsterInput`](crate::operation::associate_fraudster::AssociateFraudsterInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct AssociateFraudsterInputBuilder {
...
impl ::std::fmt::Debug for AssociateFraudsterInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("AssociateFraudsterInputBuilder");
        formatter.field("domain_id", &self.domain_id);
        formatter.field("watchlist_id", &self.watchlist_id);
        formatter.field("fraudster_id", &"*** Sensitive Data Redacted ***");
        formatter.finish()
