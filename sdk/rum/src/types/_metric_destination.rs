...
impl ::std::convert::From<&str> for MetricDestination {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MetricDestination::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MetricDestination {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MetricDestination::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MetricDestination {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
