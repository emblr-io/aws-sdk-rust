...
impl ::std::convert::From<&str> for CustomEventsStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomEventsStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomEventsStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomEventsStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomEventsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
