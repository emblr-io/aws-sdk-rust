...
impl ::std::convert::From<&str> for StateEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StateEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StateEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StateEnum::from(s))
    }
}
impl StateEnum {
...
impl ::std::convert::AsRef<str> for StateEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
