...
///     RecommendationType::InfraOnly => { /* ... */ },
///     RecommendationType::WorkloadOnly => { /* ... */ },
...
impl ::std::convert::From<&str> for RecommendationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "INFRA_ONLY" => RecommendationType::InfraOnly,
            "WORKLOAD_ONLY" => RecommendationType::WorkloadOnly,
...
impl RecommendationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RecommendationType::All => "ALL",
            RecommendationType::InfraOnly => "INFRA_ONLY",
            RecommendationType::WorkloadOnly => "WORKLOAD_ONLY",
            RecommendationType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ALL", "INFRA_ONLY", "WORKLOAD_ONLY"]
    }
}
