...
impl ::std::convert::From<&str> for FeedbackKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeedbackKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeedbackKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeedbackKey::from(s))
    }
}
impl FeedbackKey {
...
impl ::std::convert::AsRef<str> for FeedbackKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FeedbackKey {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FeedbackKey::InsightsFeedback => write!(f, "INSIGHTS_FEEDBACK"),
            FeedbackKey::Unknown(value) => write!(f, "{}", value),
        }
    }
}
