...
impl ::std::convert::From<&str> for LogFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            "INFO" => LogFilter::Info,
            "WARN" => LogFilter::Warn,
            other => LogFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogFilter::from(s))
    }
}
impl LogFilter {
...
impl ::std::convert::AsRef<str> for LogFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
