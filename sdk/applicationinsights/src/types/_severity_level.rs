...
impl ::std::convert::From<&str> for SeverityLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SeverityLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SeverityLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SeverityLevel::from(s))
    }
}
impl SeverityLevel {
...
impl ::std::convert::AsRef<str> for SeverityLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SeverityLevel {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            SeverityLevel::Informative => write!(f, "Informative"),
            SeverityLevel::Low => write!(f, "Low"),
            SeverityLevel::Medium => write!(f, "Medium"),
            SeverityLevel::Unknown(value) => write!(f, "{}", value),
        }
    }
}
