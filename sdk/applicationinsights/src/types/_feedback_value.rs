...
impl ::std::convert::From<&str> for FeedbackValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeedbackValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeedbackValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeedbackValue::from(s))
    }
}
impl FeedbackValue {
...
impl ::std::convert::AsRef<str> for FeedbackValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FeedbackValue {
