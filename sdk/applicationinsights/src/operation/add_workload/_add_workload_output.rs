...
impl ::aws_types::request_id::RequestId for AddWorkloadOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl AddWorkloadOutput {
    /// Creates a new builder-style object to manufacture [`AddWorkloadOutput`](crate::operation::add_workload::AddWorkloadOutput).
    pub fn builder() -> crate::operation::add_workload::builders::AddWorkloadOutputBuilder {
        crate::operation::add_workload::builders::AddWorkloadOutputBuilder::default()
    }
}

/// A builder for [`AddWorkloadOutput`](crate::operation::add_workload::AddWorkloadOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AddWorkloadOutputBuilder {
...
impl AddWorkloadOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`AddWorkloadOutput`](crate::operation::add_workload::AddWorkloadOutput).
    pub fn build(self) -> crate::operation::add_workload::AddWorkloadOutput {
