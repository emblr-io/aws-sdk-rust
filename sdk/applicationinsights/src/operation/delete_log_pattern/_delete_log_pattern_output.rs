...
impl ::aws_types::request_id::RequestId for DeleteLogPatternOutput {
...
impl DeleteLogPatternOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteLogPatternOutput`](crate::operation::delete_log_pattern::DeleteLogPatternOutput).
    pub fn build(self) -> crate::operation::delete_log_pattern::DeleteLogPatternOutput {
