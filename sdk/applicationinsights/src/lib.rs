...
//! aws-sdk-applicationinsights = "0.0.0-local"
...
//! offered by Amazon CloudWatch Application Insights. The return value of each of these methods is a "fluent builder",
