...
impl ListFindingsV2Input {
    /// Creates a new builder-style object to manufacture [`ListFindingsV2Input`](crate::operation::list_findings_v2::ListFindingsV2Input).
    pub fn builder() -> crate::operation::list_findings_v2::builders::ListFindingsV2InputBuilder {
        crate::operation::list_findings_v2::builders::ListFindingsV2InputBuilder::default()
    }
}

/// A builder for [`ListFindingsV2Input`](crate::operation::list_findings_v2::ListFindingsV2Input).
