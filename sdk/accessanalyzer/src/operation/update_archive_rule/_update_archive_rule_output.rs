...
impl ::aws_types::request_id::RequestId for UpdateArchiveRuleOutput {
...
impl UpdateArchiveRuleOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateArchiveRuleOutput`](crate::operation::update_archive_rule::UpdateArchiveRuleOutput).
    pub fn build(self) -> crate::operation::update_archive_rule::UpdateArchiveRuleOutput {
