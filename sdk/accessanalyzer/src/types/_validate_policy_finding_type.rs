...
/// }
/// ```
/// The above code demonstrates that when `validatepolicyfindingtype` represents
...
/// version of SDK where the variant `ValidatePolicyFindingType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ValidatePolicyFindingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ValidatePolicyFindingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValidatePolicyFindingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValidatePolicyFindingType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ValidatePolicyFindingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
