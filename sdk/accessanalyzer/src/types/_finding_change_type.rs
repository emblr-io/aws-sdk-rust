...
/// }
/// ```
/// The above code demonstrates that when `findingchangetype` represents
...
/// version of SDK where the variant `FindingChangeType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for FindingChangeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FindingChangeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FindingChangeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FindingChangeType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FindingChangeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
