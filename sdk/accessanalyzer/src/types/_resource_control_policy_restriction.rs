...
/// When writing a match expression against `ResourceControlPolicyRestriction`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `resourcecontrolpolicyrestriction` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ResourceControlPolicyRestriction::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ResourceControlPolicyRestriction::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ResourceControlPolicyRestriction::NewFeature` is defined.
/// Specifically, when `resourcecontrolpolicyrestriction` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ResourceControlPolicyRestriction::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ResourceControlPolicyRestriction {
    #[allow(missing_docs)] // documentation missing in model
    Applicable,
    #[allow(missing_docs)] // documentation missing in model
    Applied,
...
impl ::std::convert::From<&str> for ResourceControlPolicyRestriction {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ResourceControlPolicyRestriction {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceControlPolicyRestriction::from(s))
    }
}
impl ResourceControlPolicyRestriction {
...
impl ::std::fmt::Display for ResourceControlPolicyRestriction {
