...
impl ::std::fmt::Debug for TeamsChannelConfiguration {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("TeamsChannelConfiguration");
...
impl ::std::fmt::Debug for TeamsChannelConfigurationBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("TeamsChannelConfigurationBuilder");
        formatter.field("channel_id", &self.channel_id);
        formatter.field("channel_name", &"*** Sensitive Data Redacted ***");
        formatter.field("team_id", &self.team_id);
        formatter.field("team_name", &"*** Sensitive Data Redacted ***");
