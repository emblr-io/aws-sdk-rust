...
//! offered by AWS Price List Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Price List Service.
...
/// Configuration for AWS Price List Service.
pub mod config;
