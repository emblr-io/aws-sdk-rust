...
impl ::std::convert::From<&str> for SkipUnavailableStatus {
    fn from(s: &str) -> Self {
        match s {
            "DISABLED" => SkipUnavailableStatus::Disabled,
            "ENABLED" => SkipUnavailableStatus::Enabled,
            other => SkipUnavailableStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SkipUnavailableStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SkipUnavailableStatus::from(s))
    }
}
impl SkipUnavailableStatus {
    /// Returns the `&str` value of the enum member.
    pub fn as_str(&self) -> &str {
        match self {
            SkipUnavailableStatus::Disabled => "DISABLED",
            SkipUnavailableStatus::Enabled => "ENABLED",
            SkipUnavailableStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for SkipUnavailableStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
