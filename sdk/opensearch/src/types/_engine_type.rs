...
impl ::std::convert::From<&str> for EngineType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EngineType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EngineType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EngineType::from(s))
    }
}
impl EngineType {
...
impl ::std::convert::AsRef<str> for EngineType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
