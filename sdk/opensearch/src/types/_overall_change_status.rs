...
impl ::std::convert::From<&str> for OverallChangeStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OverallChangeStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OverallChangeStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OverallChangeStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OverallChangeStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
