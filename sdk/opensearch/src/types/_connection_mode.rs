...
///
/// <p>The connection mode for the cross-cluster connection.</p>
/// <ul>
/// <li>
/// <p>
...
impl ::std::convert::From<&str> for ConnectionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "VPC_ENDPOINT" => ConnectionMode::VpcEndpoint,
            other => ConnectionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectionMode::from(s))
    }
}
impl ConnectionMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ConnectionMode::VpcEndpoint => "VPC_ENDPOINT",
...
impl ::std::convert::AsRef<str> for ConnectionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
