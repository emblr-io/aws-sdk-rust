...
pub struct ModifyingProperties {
    ...
    /// <ul>
    /// <li>
    /// <p><code>PLAIN_TEXT</code>: Contain direct values such as "1", "True", or "c5.large.search".</p></li>
    /// <li>
    /// <p><code>STRINGIFIED_JSON</code>: Contain content in JSON format, such as {"Enabled":"True"}".</p></li>
    /// </ul>
