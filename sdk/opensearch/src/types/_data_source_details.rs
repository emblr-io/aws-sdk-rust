...
impl DataSourceDetails {
    /// Creates a new builder-style object to manufacture [`DataSourceDetails`](crate::types::DataSourceDetails).
    pub fn builder() -> crate::types::builders::DataSourceDetailsBuilder {
        crate::types::builders::DataSourceDetailsBuilder::default()
    }
}

/// A builder for [`DataSourceDetails`](crate::types::DataSourceDetails).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DataSourceDetailsBuilder {
