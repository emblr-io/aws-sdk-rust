...
impl ::std::convert::From<&str> for DryRunMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DryRunMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DryRunMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DryRunMode::from(s))
    }
}
impl DryRunMode {
...
impl ::std::convert::AsRef<str> for DryRunMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
