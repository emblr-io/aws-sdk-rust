...
/// match actiontype {
///     ActionType::JvmHeapSizeTuning => { /* ... */ },
///     ActionType::JvmYoungGenTuning => { /* ... */ },
///     ActionType::ServiceSoftwareUpdate => { /* ... */ },
...
impl ::std::convert::From<&str> for ActionType {
    fn from(s: &str) -> Self {
        match s {
            "JVM_HEAP_SIZE_TUNING" => ActionType::JvmHeapSizeTuning,
            "JVM_YOUNG_GEN_TUNING" => ActionType::JvmYoungGenTuning,
            "SERVICE_SOFTWARE_UPDATE" => ActionType::ServiceSoftwareUpdate,
...
impl ActionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ActionType::JvmHeapSizeTuning => "JVM_HEAP_SIZE_TUNING",
            ActionType::JvmYoungGenTuning => "JVM_YOUNG_GEN_TUNING",
            ActionType::ServiceSoftwareUpdate => "SERVICE_SOFTWARE_UPDATE",
