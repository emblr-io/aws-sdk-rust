...
impl ::std::convert::From<&str> for UpgradeStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpgradeStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpgradeStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpgradeStatus::from(s))
    }
}
impl UpgradeStatus {
...
impl ::std::convert::AsRef<str> for UpgradeStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
