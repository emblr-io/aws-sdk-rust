...
impl ::std::convert::From<&str> for DomainPackageStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DomainPackageStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DomainPackageStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DomainPackageStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DomainPackageStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
