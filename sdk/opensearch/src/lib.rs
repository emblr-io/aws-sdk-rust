...
//! aws-sdk-opensearch = "0.0.0-local"
...
//! offered by Amazon OpenSearch Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon OpenSearch Service.
...
/// For example, the [`AcceptInboundConnection`](crate::operation::accept_inbound_connection) operation has
