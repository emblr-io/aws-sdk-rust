...
impl ::std::convert::From<&str> for Algorithm {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Algorithm::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Algorithm {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Algorithm::from(s))
    }
}
impl Algorithm {
...
impl ::std::convert::AsRef<str> for Algorithm {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
