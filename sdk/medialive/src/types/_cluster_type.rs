...
impl ::std::convert::From<&str> for ClusterType {
    fn from(s: &str) -> Self {
        match s {
            "ON_PREMISES" => ClusterType::OnPremises,
            other => ClusterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClusterType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClusterType::from(s))
    }
}
impl ClusterType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ClusterType::OnPremises => "ON_PREMISES",
...
impl ::std::convert::AsRef<str> for ClusterType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
