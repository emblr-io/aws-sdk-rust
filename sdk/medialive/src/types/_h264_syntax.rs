...
impl ::std::convert::From<&str> for H264Syntax {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => H264Syntax::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for H264Syntax {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(H264Syntax::from(s))
    }
}
impl H264Syntax {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            H264Syntax::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for H264Syntax {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
