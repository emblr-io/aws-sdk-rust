...
impl ::std::convert::From<&str> for UdpTimedMetadataId3Frame {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UdpTimedMetadataId3Frame::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UdpTimedMetadataId3Frame {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UdpTimedMetadataId3Frame::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UdpTimedMetadataId3Frame {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
