...
impl ::std::convert::From<&str> for TemporalFilterStrength {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TemporalFilterStrength::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TemporalFilterStrength {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TemporalFilterStrength::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TemporalFilterStrength {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
