...
impl ::std::convert::From<&str> for HlsProgramDateTimeClock {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HlsProgramDateTimeClock::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HlsProgramDateTimeClock {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HlsProgramDateTimeClock::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HlsProgramDateTimeClock {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
