...
impl HlsSettingsBuilder {
    ...
    pub fn audio_only_hls_settings(mut self, input: crate::types::AudioOnlyHlsSettings) -> Self {
        self.audio_only_hls_settings = ::std::option::Option::Some(input);
        self
    }
    /// Audio Only Hls Settings
    ...
    pub fn fmp4_hls_settings(mut self, input: crate::types::Fmp4HlsSettings) -> Self {
        self.fmp4_hls_settings = ::std::option::Option::Some(input);
        self
    }
    /// Fmp4 Hls Settings
    ...
    pub fn frame_capture_hls_settings(mut self, input: crate::types::FrameCaptureHlsSettings) -> Self {
        self.frame_capture_hls_settings = ::std::option::Option::Some(input);
        self
    }
    /// Frame Capture Hls Settings
    ...
    pub fn standard_hls_settings(mut self, input: crate::types::StandardHlsSettings) -> Self {
        self.standard_hls_settings = ::std::option::Option::Some(input);
        self
    }
    /// Standard Hls Settings
