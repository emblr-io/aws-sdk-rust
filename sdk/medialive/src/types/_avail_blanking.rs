...
impl AvailBlankingBuilder {
    ...
    pub fn avail_blanking_image(mut self, input: crate::types::InputLocation) -> Self {
        self.avail_blanking_image = ::std::option::Option::Some(input);
        self
    }
    /// Blanking image to be used. Leave empty for solid black. Only bmp and png images are supported.
    ...
    /// Blanking image to be used. Leave empty for solid black. Only bmp and png images are supported.
    pub fn get_avail_blanking_image(&self) -> &::std::option::Option<crate::types::InputLocation> {
    ...
    /// When set to enabled, causes video, audio and captions to be blanked when insertion metadata is added.
    pub fn get_state(&self) -> &::std::option::Option<crate::types::AvailBlankingState> {
        &self.state
    }
