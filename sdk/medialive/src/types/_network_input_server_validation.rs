...
impl ::std::convert::From<&str> for NetworkInputServerValidation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkInputServerValidation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkInputServerValidation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkInputServerValidation::from(s))
    }
}
