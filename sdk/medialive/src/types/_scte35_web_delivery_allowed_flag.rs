...
impl ::std::convert::From<&str> for Scte35WebDeliveryAllowedFlag {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Scte35WebDeliveryAllowedFlag::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Scte35WebDeliveryAllowedFlag {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Scte35WebDeliveryAllowedFlag::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Scte35WebDeliveryAllowedFlag {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
