...
impl ::std::convert::From<&str> for SmoothGroupEventIdMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SmoothGroupEventIdMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SmoothGroupEventIdMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SmoothGroupEventIdMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SmoothGroupEventIdMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SmoothGroupEventIdMode {
