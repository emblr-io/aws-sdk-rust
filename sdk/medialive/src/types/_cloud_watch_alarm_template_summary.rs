...
impl CloudWatchAlarmTemplateSummary {
    /// A cloudwatch alarm template's ARN (Amazon Resource Name)
...
impl CloudWatchAlarmTemplateSummary {
    /// Creates a new builder-style object to manufacture [`CloudWatchAlarmTemplateSummary`](crate::types::CloudWatchAlarmTemplateSummary).
    pub fn builder() -> crate::types::builders::CloudWatchAlarmTemplateSummaryBuilder {
        crate::types::builders::CloudWatchAlarmTemplateSummaryBuilder::default()
    }
}
...
impl CloudWatchAlarmTemplateSummaryBuilder {
    /// A cloudwatch alarm template's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`CloudWatchAlarmTemplateSummary`](crate::types::CloudWatchAlarmTemplateSummary).
    pub fn build(self) -> crate::types::CloudWatchAlarmTemplateSummary {
        crate::types::CloudWatchAlarmTemplateSummary {
            arn: self.arn,
