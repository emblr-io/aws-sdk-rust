...
impl ::std::convert::From<&str> for AudioType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioType::from(s))
    }
}
impl AudioType {
...
impl ::std::convert::AsRef<str> for AudioType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
