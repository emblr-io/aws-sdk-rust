...
/// }
/// ```
/// The above code demonstrates that when `timecodeconfigsource` represents
...
/// version of SDK where the variant `TimecodeConfigSource::NewFeature` is defined.
/// Specifically, when `timecodeconfigsource` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `TimecodeConfigSource::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for TimecodeConfigSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TimecodeConfigSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TimecodeConfigSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TimecodeConfigSource::from(s))
    }
}
impl TimecodeConfigSource {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TimecodeConfigSource::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for TimecodeConfigSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TimecodeConfigSource {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TimecodeConfigSource::Embedded => write!(f, "EMBEDDED"),
            TimecodeConfigSource::Systemclock => write!(f, "SYSTEMCLOCK"),
            TimecodeConfigSource::Zerobased => write!(f, "ZEROBASED"),
            TimecodeConfigSource::Unknown(value) => write!(f, "{}", value),
        }
    }
}
