...
impl AnywhereSettings {
    /// Creates a new builder-style object to manufacture [`AnywhereSettings`](crate::types::AnywhereSettings).
    pub fn builder() -> crate::types::builders::AnywhereSettingsBuilder {
        crate::types::builders::AnywhereSettingsBuilder::default()
    }
}

/// A builder for [`AnywhereSettings`](crate::types::AnywhereSettings).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AnywhereSettingsBuilder {
    pub(crate) channel_placement_group_id: ::std::option::Option<::std::string::String>,
    pub(crate) cluster_id: ::std::option::Option<::std::string::String>,
}
impl AnywhereSettingsBuilder {
    /// The ID of the channel placement group for the channel.
    ...
    /// Consumes the builder and constructs a [`AnywhereSettings`](crate::types::AnywhereSettings).
    pub fn build(self) -> crate::types::AnywhereSettings {
        crate::types::AnywhereSettings {
