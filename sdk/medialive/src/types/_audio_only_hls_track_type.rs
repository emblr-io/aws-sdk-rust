...
impl ::std::convert::From<&str> for AudioOnlyHlsTrackType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AudioOnlyHlsTrackType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AudioOnlyHlsTrackType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AudioOnlyHlsTrackType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AudioOnlyHlsTrackType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
