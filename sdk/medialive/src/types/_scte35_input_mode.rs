...
impl ::std::convert::From<&str> for Scte35InputMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Scte35InputMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Scte35InputMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Scte35InputMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Scte35InputMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
