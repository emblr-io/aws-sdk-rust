...
impl ::std::convert::From<&str> for InputSecurityGroupState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InputSecurityGroupState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InputSecurityGroupState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InputSecurityGroupState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InputSecurityGroupState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
