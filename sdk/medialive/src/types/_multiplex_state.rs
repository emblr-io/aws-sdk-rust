...
impl ::std::convert::From<&str> for MultiplexState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MultiplexState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MultiplexState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MultiplexState::from(s))
    }
}
impl MultiplexState {
...
impl ::std::convert::AsRef<str> for MultiplexState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
