...
pub struct UpdateChannelPlacementGroupOutput {
...
impl UpdateChannelPlacementGroupOutput {
    /// The ARN of this ChannelPlacementGroup. It is automatically assigned when the ChannelPlacementGroup is created.
...
impl ::aws_types::request_id::RequestId for UpdateChannelPlacementGroupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateChannelPlacementGroupOutput {
    /// Creates a new builder-style object to manufacture [`UpdateChannelPlacementGroupOutput`](crate::operation::update_channel_placement_group::UpdateChannelPlacementGroupOutput).
    pub fn builder() -> crate::operation::update_channel_placement_group::builders::UpdateChannelPlacementGroupOutputBuilder {
        crate::operation::update_channel_placement_group::builders::UpdateChannelPlacementGroupOutputBuilder::default()
    }
}

/// A builder for [`UpdateChannelPlacementGroupOutput`](crate::operation::update_channel_placement_group::UpdateChannelPlacementGroupOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateChannelPlacementGroupOutputBuilder {
...
impl UpdateChannelPlacementGroupOutputBuilder {
    /// The ARN of this ChannelPlacementGroup. It is automatically assigned when the ChannelPlacementGroup is created.
    ...
    /// Consumes the builder and constructs a [`UpdateChannelPlacementGroupOutput`](crate::operation::update_channel_placement_group::UpdateChannelPlacementGroupOutput).
    pub fn build(self) -> crate::operation::update_channel_placement_group::UpdateChannelPlacementGroupOutput {
