...
pub struct DeleteChannelPlacementGroupOutput {
...
impl DeleteChannelPlacementGroupOutput {
    /// The ARN of this ChannelPlacementGroup. It is automatically assigned when the ChannelPlacementGroup is created.
...
impl ::aws_types::request_id::RequestId for DeleteChannelPlacementGroupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteChannelPlacementGroupOutput {
    /// Creates a new builder-style object to manufacture [`DeleteChannelPlacementGroupOutput`](crate::operation::delete_channel_placement_group::DeleteChannelPlacementGroupOutput).
    pub fn builder() -> crate::operation::delete_channel_placement_group::builders::DeleteChannelPlacementGroupOutputBuilder {
        crate::operation::delete_channel_placement_group::builders::DeleteChannelPlacementGroupOutputBuilder::default()
    }
}

/// A builder for [`DeleteChannelPlacementGroupOutput`](crate::operation::delete_channel_placement_group::DeleteChannelPlacementGroupOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteChannelPlacementGroupOutputBuilder {
...
impl DeleteChannelPlacementGroupOutputBuilder {
    /// The ARN of this ChannelPlacementGroup. It is automatically assigned when the ChannelPlacementGroup is created.
    ...
    /// Consumes the builder and constructs a [`DeleteChannelPlacementGroupOutput`](crate::operation::delete_channel_placement_group::DeleteChannelPlacementGroupOutput).
    pub fn build(self) -> crate::operation::delete_channel_placement_group::DeleteChannelPlacementGroupOutput {
        crate::operation::delete_channel_placement_group::DeleteChannelPlacementGroupOutput {
            arn: self.arn,
