...
impl ::aws_types::request_id::RequestId for GetSignalMapOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetSignalMapOutput {
    /// Creates a new builder-style object to manufacture [`GetSignalMapOutput`](crate::operation::get_signal_map::GetSignalMapOutput).
    pub fn builder() -> crate::operation::get_signal_map::builders::GetSignalMapOutputBuilder {
        crate::operation::get_signal_map::builders::GetSignalMapOutputBuilder::default()
    }
}
...
impl GetSignalMapOutputBuilder {
    /// A signal map's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`GetSignalMapOutput`](crate::operation::get_signal_map::GetSignalMapOutput).
    pub fn build(self) -> crate::operation::get_signal_map::GetSignalMapOutput {
