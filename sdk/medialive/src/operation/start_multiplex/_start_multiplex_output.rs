...
impl ::aws_types::request_id::RequestId for StartMultiplexOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartMultiplexOutput {
    /// Creates a new builder-style object to manufacture [`StartMultiplexOutput`](crate::operation::start_multiplex::StartMultiplexOutput).
    pub fn builder() -> crate::operation::start_multiplex::builders::StartMultiplexOutputBuilder {
        crate::operation::start_multiplex::builders::StartMultiplexOutputBuilder::default()
    }
}
...
impl StartMultiplexOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartMultiplexOutput`](crate::operation::start_multiplex::StartMultiplexOutput).
    pub fn build(self) -> crate::operation::start_multiplex::StartMultiplexOutput {
