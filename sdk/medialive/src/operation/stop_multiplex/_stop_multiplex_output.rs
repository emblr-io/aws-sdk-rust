...
impl ::aws_types::request_id::RequestId for StopMultiplexOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StopMultiplexOutput {
    /// Creates a new builder-style object to manufacture [`StopMultiplexOutput`](crate::operation::stop_multiplex::StopMultiplexOutput).
    pub fn builder() -> crate::operation::stop_multiplex::builders::StopMultiplexOutputBuilder {
        crate::operation::stop_multiplex::builders::StopMultiplexOutputBuilder::default()
    }
}
...
impl StopMultiplexOutputBuilder {
    /// The unique arn of the multiplex.
    ...
    /// Consumes the builder and constructs a [`StopMultiplexOutput`](crate::operation::stop_multiplex::StopMultiplexOutput).
    pub fn build(self) -> crate::operation::stop_multiplex::StopMultiplexOutput {
