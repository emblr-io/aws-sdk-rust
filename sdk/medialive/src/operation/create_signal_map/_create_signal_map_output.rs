...
pub struct CreateSignalMapOutput {
...
impl ::aws_types::request_id::RequestId for CreateSignalMapOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateSignalMapOutput {
    /// Creates a new builder-style object to manufacture [`CreateSignalMapOutput`](crate::operation::create_signal_map::CreateSignalMapOutput).
    pub fn builder() -> crate::operation::create_signal_map::builders::CreateSignalMapOutputBuilder {
        crate::operation::create_signal_map::builders::CreateSignalMapOutputBuilder::default()
    }
}

/// A builder for [`CreateSignalMapOutput`](crate::operation::create_signal_map::CreateSignalMapOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateSignalMapOutputBuilder {
...
impl CreateSignalMapOutputBuilder {
    /// A signal map's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`CreateSignalMapOutput`](crate::operation::create_signal_map::CreateSignalMapOutput).
    pub fn build(self) -> crate::operation::create_signal_map::CreateSignalMapOutput {
