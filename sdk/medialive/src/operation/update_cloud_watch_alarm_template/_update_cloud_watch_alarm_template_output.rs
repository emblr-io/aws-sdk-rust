...
pub struct UpdateCloudWatchAlarmTemplateOutput {
...
impl UpdateCloudWatchAlarmTemplateOutput {
    /// A cloudwatch alarm template's ARN (Amazon Resource Name)
...
impl ::aws_types::request_id::RequestId for UpdateCloudWatchAlarmTemplateOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateCloudWatchAlarmTemplateOutput {
    /// Creates a new builder-style object to manufacture [`UpdateCloudWatchAlarmTemplateOutput`](crate::operation::update_cloud_watch_alarm_template::UpdateCloudWatchAlarmTemplateOutput).
    pub fn builder() -> crate::operation::update_cloud_watch_alarm_template::builders::UpdateCloudWatchAlarmTemplateOutputBuilder {
        crate::operation::update_cloud_watch_alarm_template::builders::UpdateCloudWatchAlarmTemplateOutputBuilder::default()
    }
}

/// A builder for [`UpdateCloudWatchAlarmTemplateOutput`](crate::operation::update_cloud_watch_alarm_template::UpdateCloudWatchAlarmTemplateOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateCloudWatchAlarmTemplateOutputBuilder {
...
impl UpdateCloudWatchAlarmTemplateOutputBuilder {
    /// A cloudwatch alarm template's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`UpdateCloudWatchAlarmTemplateOutput`](crate::operation::update_cloud_watch_alarm_template::UpdateCloudWatchAlarmTemplateOutput).
    pub fn build(self) -> crate::operation::update_cloud_watch_alarm_template::UpdateCloudWatchAlarmTemplateOutput {
