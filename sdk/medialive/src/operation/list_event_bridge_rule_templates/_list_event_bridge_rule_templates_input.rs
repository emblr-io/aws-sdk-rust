...
pub struct ListEventBridgeRuleTemplatesInput {
...
impl ListEventBridgeRuleTemplatesInput {
    /// An eventbridge rule template group's identifier. Can be either be its id or current name.
...
impl ListEventBridgeRuleTemplatesInput {
    /// Creates a new builder-style object to manufacture [`ListEventBridgeRuleTemplatesInput`](crate::operation::list_event_bridge_rule_templates::ListEventBridgeRuleTemplatesInput).
    pub fn builder() -> crate::operation::list_event_bridge_rule_templates::builders::ListEventBridgeRuleTemplatesInputBuilder {
        crate::operation::list_event_bridge_rule_templates::builders::ListEventBridgeRuleTemplatesInputBuilder::default()
    }
}

/// A builder for [`ListEventBridgeRuleTemplatesInput`](crate::operation::list_event_bridge_rule_templates::ListEventBridgeRuleTemplatesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListEventBridgeRuleTemplatesInputBuilder {
...
impl ListEventBridgeRuleTemplatesInputBuilder {
    /// An eventbridge rule template group's identifier. Can be either be its id or current name.
    ...
    /// Consumes the builder and constructs a [`ListEventBridgeRuleTemplatesInput`](crate::operation::list_event_bridge_rule_templates::ListEventBridgeRuleTemplatesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::list_event_bridge_rule_templates::ListEventBridgeRuleTemplatesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::list_event_bridge_rule_templates::ListEventBridgeRuleTemplatesInput {
