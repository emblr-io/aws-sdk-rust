...
pub struct DescribeNetworkOutput {
...
impl ::aws_types::request_id::RequestId for DescribeNetworkOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeNetworkOutput {
    /// Creates a new builder-style object to manufacture [`DescribeNetworkOutput`](crate::operation::describe_network::DescribeNetworkOutput).
    pub fn builder() -> crate::operation::describe_network::builders::DescribeNetworkOutputBuilder {
        crate::operation::describe_network::builders::DescribeNetworkOutputBuilder::default()
    }
}

/// A builder for [`DescribeNetworkOutput`](crate::operation::describe_network::DescribeNetworkOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeNetworkOutputBuilder {
...
impl DescribeNetworkOutputBuilder {
    /// The ARN of this Network. It is automatically assigned when the Network is created.
    ...
    /// Consumes the builder and constructs a [`DescribeNetworkOutput`](crate::operation::describe_network::DescribeNetworkOutput).
    pub fn build(self) -> crate::operation::describe_network::DescribeNetworkOutput {
