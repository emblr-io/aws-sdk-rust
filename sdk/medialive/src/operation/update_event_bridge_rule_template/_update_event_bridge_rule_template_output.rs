...
pub struct UpdateEventBridgeRuleTemplateOutput {
...
impl UpdateEventBridgeRuleTemplateOutput {
    /// An eventbridge rule template's ARN (Amazon Resource Name)
...
impl ::aws_types::request_id::RequestId for UpdateEventBridgeRuleTemplateOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateEventBridgeRuleTemplateOutput {
    /// Creates a new builder-style object to manufacture [`UpdateEventBridgeRuleTemplateOutput`](crate::operation::update_event_bridge_rule_template::UpdateEventBridgeRuleTemplateOutput).
    pub fn builder() -> crate::operation::update_event_bridge_rule_template::builders::UpdateEventBridgeRuleTemplateOutputBuilder {
        crate::operation::update_event_bridge_rule_template::builders::UpdateEventBridgeRuleTemplateOutputBuilder::default()
    }
}

/// A builder for [`UpdateEventBridgeRuleTemplateOutput`](crate::operation::update_event_bridge_rule_template::UpdateEventBridgeRuleTemplateOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateEventBridgeRuleTemplateOutputBuilder {
...
impl UpdateEventBridgeRuleTemplateOutputBuilder {
    /// An eventbridge rule template's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`UpdateEventBridgeRuleTemplateOutput`](crate::operation::update_event_bridge_rule_template::UpdateEventBridgeRuleTemplateOutput).
    pub fn build(self) -> crate::operation::update_event_bridge_rule_template::UpdateEventBridgeRuleTemplateOutput {
