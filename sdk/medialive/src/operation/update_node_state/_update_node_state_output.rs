...
pub struct UpdateNodeStateOutput {
...
impl ::aws_types::request_id::RequestId for UpdateNodeStateOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateNodeStateOutput {
    /// Creates a new builder-style object to manufacture [`UpdateNodeStateOutput`](crate::operation::update_node_state::UpdateNodeStateOutput).
    pub fn builder() -> crate::operation::update_node_state::builders::UpdateNodeStateOutputBuilder {
        crate::operation::update_node_state::builders::UpdateNodeStateOutputBuilder::default()
    }
}

/// A builder for [`UpdateNodeStateOutput`](crate::operation::update_node_state::UpdateNodeStateOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateNodeStateOutputBuilder {
...
impl UpdateNodeStateOutputBuilder {
    /// The ARN of the Node. It is automatically assigned when the Node is created.
    ...
    /// Consumes the builder and constructs a [`UpdateNodeStateOutput`](crate::operation::update_node_state::UpdateNodeStateOutput).
    pub fn build(self) -> crate::operation::update_node_state::UpdateNodeStateOutput {
