...
pub struct CreateCloudWatchAlarmTemplateOutput {
...
impl CreateCloudWatchAlarmTemplateOutput {
    /// A cloudwatch alarm template's ARN (Amazon Resource Name)
...
impl ::aws_types::request_id::RequestId for CreateCloudWatchAlarmTemplateOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateCloudWatchAlarmTemplateOutput {
    /// Creates a new builder-style object to manufacture [`CreateCloudWatchAlarmTemplateOutput`](crate::operation::create_cloud_watch_alarm_template::CreateCloudWatchAlarmTemplateOutput).
    pub fn builder() -> crate::operation::create_cloud_watch_alarm_template::builders::CreateCloudWatchAlarmTemplateOutputBuilder {
        crate::operation::create_cloud_watch_alarm_template::builders::CreateCloudWatchAlarmTemplateOutputBuilder::default()
    }
}
...
impl CreateCloudWatchAlarmTemplateOutputBuilder {
    /// A cloudwatch alarm template's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`CreateCloudWatchAlarmTemplateOutput`](crate::operation::create_cloud_watch_alarm_template::CreateCloudWatchAlarmTemplateOutput).
    pub fn build(self) -> crate::operation::create_cloud_watch_alarm_template::CreateCloudWatchAlarmTemplateOutput {
