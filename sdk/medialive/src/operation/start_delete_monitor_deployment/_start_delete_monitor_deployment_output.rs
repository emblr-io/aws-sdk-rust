...
impl StartDeleteMonitorDeploymentOutput {
    /// A signal map's ARN (Amazon Resource Name)
...
impl ::aws_types::request_id::RequestId for StartDeleteMonitorDeploymentOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartDeleteMonitorDeploymentOutput {
    /// Creates a new builder-style object to manufacture [`StartDeleteMonitorDeploymentOutput`](crate::operation::start_delete_monitor_deployment::StartDeleteMonitorDeploymentOutput).
    pub fn builder() -> crate::operation::start_delete_monitor_deployment::builders::StartDeleteMonitorDeploymentOutputBuilder {
        crate::operation::start_delete_monitor_deployment::builders::StartDeleteMonitorDeploymentOutputBuilder::default()
    }
}

/// A builder for [`StartDeleteMonitorDeploymentOutput`](crate::operation::start_delete_monitor_deployment::StartDeleteMonitorDeploymentOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartDeleteMonitorDeploymentOutputBuilder {
...
impl StartDeleteMonitorDeploymentOutputBuilder {
    /// A signal map's ARN (Amazon Resource Name)
    ...
    /// Consumes the builder and constructs a [`StartDeleteMonitorDeploymentOutput`](crate::operation::start_delete_monitor_deployment::StartDeleteMonitorDeploymentOutput).
    pub fn build(self) -> crate::operation::start_delete_monitor_deployment::StartDeleteMonitorDeploymentOutput {
