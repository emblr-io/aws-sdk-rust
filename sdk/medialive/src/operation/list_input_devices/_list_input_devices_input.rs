...
impl ListInputDevicesInputBuilder {
    /// Placeholder documentation for MaxResults
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_input_devices::ListInputDevicesInput, ::aws_smithy_types::error::operation::BuildError> {
