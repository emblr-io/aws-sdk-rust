...
pub struct CreateChannelPlacementGroupOutput {
...
impl CreateChannelPlacementGroupOutput {
    /// The ARN of this ChannelPlacementGroup. It is automatically assigned when the ChannelPlacementGroup is created.
...
impl ::aws_types::request_id::RequestId for CreateChannelPlacementGroupOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateChannelPlacementGroupOutput {
    /// Creates a new builder-style object to manufacture [`CreateChannelPlacementGroupOutput`](crate::operation::create_channel_placement_group::CreateChannelPlacementGroupOutput).
    pub fn builder() -> crate::operation::create_channel_placement_group::builders::CreateChannelPlacementGroupOutputBuilder {
        crate::operation::create_channel_placement_group::builders::CreateChannelPlacementGroupOutputBuilder::default()
    }
}

/// A builder for [`CreateChannelPlacementGroupOutput`](crate::operation::create_channel_placement_group::CreateChannelPlacementGroupOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateChannelPlacementGroupOutputBuilder {
...
impl CreateChannelPlacementGroupOutputBuilder {
    /// The ARN of this ChannelPlacementGroup. It is automatically assigned when the ChannelPlacementGroup is created.
    ...
    /// Consumes the builder and constructs a [`CreateChannelPlacementGroupOutput`](crate::operation::create_channel_placement_group::CreateChannelPlacementGroupOutput).
    pub fn build(self) -> crate::operation::create_channel_placement_group::CreateChannelPlacementGroupOutput {
