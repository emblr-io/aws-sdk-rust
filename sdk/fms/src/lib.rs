...
//! offered by Firewall Management Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Firewall Management Service.
...
/// For example, the [`AssociateAdminAccount`](crate::operation::associate_admin_account) operation has
/// a [`Client::associate_admin_account`], function which returns a builder for that operation.
...
/// Configuration for Firewall Management Service.
pub mod config;
