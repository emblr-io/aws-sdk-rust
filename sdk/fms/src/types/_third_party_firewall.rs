...
impl ::std::convert::From<&str> for ThirdPartyFirewall {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThirdPartyFirewall::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThirdPartyFirewall {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThirdPartyFirewall::from(s))
    }
}
...
impl ::std::fmt::Display for ThirdPartyFirewall {
