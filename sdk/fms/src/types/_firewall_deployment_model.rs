...
impl ::std::convert::From<&str> for FirewallDeploymentModel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FirewallDeploymentModel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FirewallDeploymentModel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FirewallDeploymentModel::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FirewallDeploymentModel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
