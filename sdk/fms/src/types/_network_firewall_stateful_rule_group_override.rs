...
impl NetworkFirewallStatefulRuleGroupOverride {
    /// Creates a new builder-style object to manufacture [`NetworkFirewallStatefulRuleGroupOverride`](crate::types::NetworkFirewallStatefulRuleGroupOverride).
    pub fn builder() -> crate::types::builders::NetworkFirewallStatefulRuleGroupOverrideBuilder {
