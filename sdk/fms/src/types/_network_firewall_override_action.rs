...
impl ::std::convert::From<&str> for NetworkFirewallOverrideAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NetworkFirewallOverrideAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NetworkFirewallOverrideAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NetworkFirewallOverrideAction::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NetworkFirewallOverrideAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
