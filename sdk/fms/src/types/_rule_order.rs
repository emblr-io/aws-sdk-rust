...
impl ::std::convert::From<&str> for RuleOrder {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RuleOrder::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RuleOrder {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RuleOrder::from(s))
    }
}
impl RuleOrder {
...
impl ::std::convert::AsRef<str> for RuleOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
