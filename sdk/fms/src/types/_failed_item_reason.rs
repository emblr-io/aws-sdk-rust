...
impl ::std::convert::From<&str> for FailedItemReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailedItemReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailedItemReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailedItemReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FailedItemReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
