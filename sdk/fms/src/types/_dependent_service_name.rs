...
impl ::std::convert::From<&str> for DependentServiceName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DependentServiceName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DependentServiceName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DependentServiceName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DependentServiceName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
