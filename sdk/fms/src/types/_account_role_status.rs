...
impl ::std::convert::From<&str> for AccountRoleStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccountRoleStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccountRoleStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccountRoleStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccountRoleStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
