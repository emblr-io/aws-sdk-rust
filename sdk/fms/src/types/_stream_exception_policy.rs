...
///     StreamExceptionPolicy::FmsIgnore => { /* ... */ },
...
impl ::std::convert::From<&str> for StreamExceptionPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            "FMS_IGNORE" => StreamExceptionPolicy::FmsIgnore,
            "REJECT" => StreamExceptionPolicy::Reject,
            other => StreamExceptionPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamExceptionPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamExceptionPolicy::from(s))
    }
}
impl StreamExceptionPolicy {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            StreamExceptionPolicy::FmsIgnore => "FMS_IGNORE",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CONTINUE", "DROP", "FMS_IGNORE", "REJECT"]
    }
}
impl ::std::convert::AsRef<str> for StreamExceptionPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
