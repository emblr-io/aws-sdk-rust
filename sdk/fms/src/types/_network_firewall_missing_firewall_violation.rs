...
impl NetworkFirewallMissingFirewallViolation {
    /// Creates a new builder-style object to manufacture [`NetworkFirewallMissingFirewallViolation`](crate::types::NetworkFirewallMissingFirewallViolation).
    pub fn builder() -> crate::types::builders::NetworkFirewallMissingFirewallViolationBuilder {
        crate::types::builders::NetworkFirewallMissingFirewallViolationBuilder::default()
    }
}
