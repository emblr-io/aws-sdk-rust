...
impl ResourceViolationBuilder {
    ...
    pub fn aws_vpc_security_group_violation(mut self, input: crate::types::AwsVpcSecurityGroupViolation) -> Self {
        self.aws_vpc_security_group_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for security groups.</p>
    ...
    /// <p>Violation detail for security groups.</p>
    pub fn get_aws_vpc_security_group_violation(&self) -> &::std::option::Option<crate::types::AwsVpcSecurityGroupViolation> {
    ...
    pub fn aws_ec2_network_interface_violation(mut self, input: crate::types::AwsEc2NetworkInterfaceViolation) -> Self {
        self.aws_ec2_network_interface_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for a network interface.</p>
    ...
    /// <p>Violation detail for a network interface.</p>
    pub fn get_aws_ec2_network_interface_violation(&self) -> &::std::option::Option<crate::types::AwsEc2NetworkInterfaceViolation> {
    ...
    pub fn aws_ec2_instance_violation(mut self, input: crate::types::AwsEc2InstanceViolation) -> Self {
        self.aws_ec2_instance_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for an EC2 instance.</p>
    ...
    pub fn network_firewall_missing_subnet_violation(mut self, input: crate::types::NetworkFirewallMissingSubnetViolation) -> Self {
        self.network_firewall_missing_subnet_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for an Network Firewall policy that indicates that an Availability Zone is missing the expected Firewall Manager managed subnet.</p>
    ...
    pub fn network_firewall_policy_modified_violation(mut self, input: crate::types::NetworkFirewallPolicyModifiedViolation) -> Self {
        self.network_firewall_policy_modified_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for an Network Firewall policy that indicates that a firewall policy in an individual account has been modified in a way that makes it noncompliant. For example, the individual account owner might have deleted a rule group, changed the priority of a stateless rule group, or changed a policy default action.</p>
    ...
    /// <p>Violation detail for an Network Firewall policy that indicates that a firewall policy in an individual account has been modified in a way that makes it noncompliant. For example, the individual account owner might have deleted a rule group, changed the priority of a stateless rule group, or changed a policy default action.</p>
    pub fn get_network_firewall_policy_modified_violation(&self) -> &::std::option::Option<crate::types::NetworkFirewallPolicyModifiedViolation> {
    ...
    pub fn network_firewall_internet_traffic_not_inspected_violation(
        ...
        self.network_firewall_internet_traffic_not_inspected_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for the subnet for which internet traffic hasn't been inspected.</p>
    pub fn set_network_firewall_internet_traffic_not_inspected_violation(
        mut self,
        input: ::std::option::Option<crate::types::NetworkFirewallInternetTrafficNotInspectedViolation>,
    ) -> Self {
    ...
    pub fn network_firewall_invalid_route_configuration_violation(
        ...
        self.network_firewall_invalid_route_configuration_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The route configuration is invalid.</p>
    ...
    pub fn network_firewall_black_hole_route_detected_violation(
        ...
        self.network_firewall_black_hole_route_detected_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Violation detail for an internet gateway route with an inactive state in the customer subnet route table or Network Firewall subnet route table.</p>
    ...
    pub fn network_firewall_unexpected_firewall_routes_violation(
        ...
        self.network_firewall_unexpected_firewall_routes_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>There's an unexpected firewall route.</p>
    ...
    pub fn network_firewall_unexpected_gateway_routes_violation(
        ...
        self.network_firewall_unexpected_gateway_routes_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>There's an unexpected gateway route.</p>
    ...
    pub fn network_firewall_missing_expected_routes_violation(mut self, input: crate::types::NetworkFirewallMissingExpectedRoutesViolation) -> Self {
        self.network_firewall_missing_expected_routes_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Expected routes are missing from Network Firewall.</p>
    ...
    /// <p>Contains details about the firewall subnet that violates the policy scope.</p>
    pub fn get_firewall_subnet_is_out_of_scope_violation(&self) -> &::std::option::Option<crate::types::FirewallSubnetIsOutOfScopeViolation> {
    ...
    pub fn route_has_out_of_scope_endpoint_violation(mut self, input: crate::types::RouteHasOutOfScopeEndpointViolation) -> Self {
        self.route_has_out_of_scope_endpoint_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>Contains details about the route endpoint that violates the policy scope.</p>
    ...
    /// <p>Contains details about the route endpoint that violates the policy scope.</p>
    pub fn get_route_has_out_of_scope_endpoint_violation(&self) -> &::std::option::Option<crate::types::RouteHasOutOfScopeEndpointViolation> {
    ...
    pub fn third_party_firewall_missing_firewall_violation(mut self, input: crate::types::ThirdPartyFirewallMissingFirewallViolation) -> Self {
        self.third_party_firewall_missing_firewall_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The violation details for a third-party firewall that's been deleted.</p>
    ...
    pub fn third_party_firewall_missing_subnet_violation(mut self, input: crate::types::ThirdPartyFirewallMissingSubnetViolation) -> Self {
        self.third_party_firewall_missing_subnet_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The violation details for a third-party firewall's subnet that's been deleted.</p>
    ...
    pub fn third_party_firewall_missing_expected_route_table_violation(
        ...
        self.third_party_firewall_missing_expected_route_table_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The violation details for a third-party firewall that has the Firewall Manager managed route table that was associated with the third-party firewall has been deleted.</p>
    pub fn set_third_party_firewall_missing_expected_route_table_violation(
        mut self,
        input: ::std::option::Option<crate::types::ThirdPartyFirewallMissingExpectedRouteTableViolation>,
    ) -> Self {
    ...
    pub fn firewall_subnet_missing_vpc_endpoint_violation(mut self, input: crate::types::FirewallSubnetMissingVpcEndpointViolation) -> Self {
        self.firewall_subnet_missing_vpc_endpoint_violation = ::std::option::Option::Some(input);
        self
    }
    /// <p>The violation details for a third-party firewall's VPC endpoint subnet that was deleted.</p>
