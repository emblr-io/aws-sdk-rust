...
impl ::std::convert::From<&str> for OrderByTime {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrderByTime::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrderByTime {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrderByTime::from(s))
    }
}
impl OrderByTime {
...
impl ::std::convert::AsRef<str> for OrderByTime {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OrderByTime {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OrderByTime::Ascending => write!(f, "ASCENDING"),
            OrderByTime::Descending => write!(f, "DESCENDING"),
            OrderByTime::Unknown(value) => write!(f, "{}", value),
        }
    }
}
