...
impl ::std::convert::From<&str> for SyncResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncResourceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncResourceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SyncResourceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
