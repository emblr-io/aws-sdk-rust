...
impl ::std::convert::From<&str> for SyncJobState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncJobState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncJobState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncJobState::from(s))
    }
}
impl SyncJobState {
...
impl ::std::convert::AsRef<str> for SyncJobState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
