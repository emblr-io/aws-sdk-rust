...
impl ::std::convert::From<&str> for PricingTier {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PricingTier::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PricingTier {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PricingTier::from(s))
    }
}
impl PricingTier {
...
impl ::std::convert::AsRef<str> for PricingTier {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
