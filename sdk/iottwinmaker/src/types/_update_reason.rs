...
impl ::std::convert::From<&str> for UpdateReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpdateReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpdateReason::from(s))
    }
}
impl UpdateReason {
...
impl ::std::convert::AsRef<str> for UpdateReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
