...
impl ::std::convert::From<&str> for SyncResourceState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncResourceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncResourceState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncResourceState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SyncResourceState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
