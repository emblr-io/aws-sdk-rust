...
impl ::std::convert::From<&str> for PropertyGroupUpdateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PropertyGroupUpdateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PropertyGroupUpdateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PropertyGroupUpdateType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PropertyGroupUpdateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
