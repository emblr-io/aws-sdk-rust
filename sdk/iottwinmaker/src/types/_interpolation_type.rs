...
impl ::std::convert::From<&str> for InterpolationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InterpolationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InterpolationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InterpolationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InterpolationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
