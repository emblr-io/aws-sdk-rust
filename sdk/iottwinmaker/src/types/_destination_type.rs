...
impl ::std::convert::From<&str> for DestinationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DestinationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DestinationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DestinationType::from(s))
    }
}
impl DestinationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DestinationType::Iotsitewise => "iotsitewise",
            DestinationType::Iottwinmaker => "iottwinmaker",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["iotsitewise", "iottwinmaker", "s3"]
    }
}
impl ::std::convert::AsRef<str> for DestinationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
