...
impl ::std::convert::From<&str> for SceneErrorCode {
    fn from(s: &str) -> Self {
        match s {
            "MATTERPORT_ERROR" => SceneErrorCode::MatterportError,
            other => SceneErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SceneErrorCode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SceneErrorCode::from(s))
    }
}
impl SceneErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SceneErrorCode::MatterportError => "MATTERPORT_ERROR",
            SceneErrorCode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for SceneErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SceneErrorCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SceneErrorCode::MatterportError => write!(f, "MATTERPORT_ERROR"),
            SceneErrorCode::Unknown(value) => write!(f, "{}", value),
        }
    }
}
