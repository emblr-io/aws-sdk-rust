...
impl ::std::convert::From<&str> for PricingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PricingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PricingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PricingMode::from(s))
    }
}
impl PricingMode {
...
impl ::std::convert::AsRef<str> for PricingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
