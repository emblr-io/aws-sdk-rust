...
//! offered by AWS IoT TwinMaker. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT TwinMaker.
...
/// For example, the [`BatchPutPropertyValues`](crate::operation::batch_put_property_values) operation has
