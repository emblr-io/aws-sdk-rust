...
//! offered by Amazon DynamoDB Accelerator (DAX). The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon DynamoDB Accelerator (DAX).
...
/// Configuration for Amazon DynamoDB Accelerator (DAX).
pub mod config;
