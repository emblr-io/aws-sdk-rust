...
impl ::std::convert::From<&str> for ClusterEndpointEncryptionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClusterEndpointEncryptionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClusterEndpointEncryptionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClusterEndpointEncryptionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClusterEndpointEncryptionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
