...
impl ::std::convert::From<&str> for IsModifiable {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IsModifiable::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IsModifiable {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IsModifiable::from(s))
    }
}
impl IsModifiable {
...
impl ::std::convert::AsRef<str> for IsModifiable {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
