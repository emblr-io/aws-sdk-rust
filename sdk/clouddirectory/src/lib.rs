...
//! aws-sdk-clouddirectory = "0.0.0-local"
...
//! offered by Amazon CloudDirectory. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudDirectory.
...
/// let config = aws_sdk_clouddirectory::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`AddFacetToObject`](crate::operation::add_facet_to_object) operation has
/// a [`Client::add_facet_to_object`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.add_facet_to_object()
///     .directory_arn("example")
///     .send()
///     .await;
/// ```
///
...
/// Configuration for Amazon CloudDirectory.
pub mod config;
