...
impl ::aws_types::request_id::RequestId for DetachFromIndexOutput {
...
impl DetachFromIndexOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DetachFromIndexOutput`](crate::operation::detach_from_index::DetachFromIndexOutput).
    pub fn build(self) -> crate::operation::detach_from_index::DetachFromIndexOutput {
