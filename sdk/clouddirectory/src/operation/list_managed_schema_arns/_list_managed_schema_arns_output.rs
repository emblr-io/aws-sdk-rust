...
impl ListManagedSchemaArnsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListManagedSchemaArnsOutput`](crate::operation::list_managed_schema_arns::ListManagedSchemaArnsOutput).
    pub fn build(self) -> crate::operation::list_managed_schema_arns::ListManagedSchemaArnsOutput {
