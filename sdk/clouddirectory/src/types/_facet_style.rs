...
impl ::std::convert::From<&str> for FacetStyle {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FacetStyle::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FacetStyle {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FacetStyle::from(s))
    }
}
impl FacetStyle {
...
impl ::std::convert::AsRef<str> for FacetStyle {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
