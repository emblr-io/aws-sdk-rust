...
impl ::std::convert::From<&str> for RequiredAttributeBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RequiredAttributeBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RequiredAttributeBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RequiredAttributeBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RequiredAttributeBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
