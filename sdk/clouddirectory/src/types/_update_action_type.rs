...
impl ::std::convert::From<&str> for UpdateActionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpdateActionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpdateActionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpdateActionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for UpdateActionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
