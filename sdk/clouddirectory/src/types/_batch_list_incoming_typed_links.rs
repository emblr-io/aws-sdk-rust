...
impl BatchListIncomingTypedLinks {
    /// Creates a new builder-style object to manufacture [`BatchListIncomingTypedLinks`](crate::types::BatchListIncomingTypedLinks).
    pub fn builder() -> crate::types::builders::BatchListIncomingTypedLinksBuilder {
        crate::types::builders::BatchListIncomingTypedLinksBuilder::default()
    }
}
...
impl BatchListIncomingTypedLinksBuilder {
    ...
    pub fn build(self) -> crate::types::BatchListIncomingTypedLinks {
        crate::types::BatchListIncomingTypedLinks {
