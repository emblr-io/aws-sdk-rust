...
impl ::std::convert::From<&str> for ConsistencyLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConsistencyLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConsistencyLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConsistencyLevel::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConsistencyLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
