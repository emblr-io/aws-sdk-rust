...
impl ::std::convert::From<&str> for RangeMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RangeMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RangeMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RangeMode::from(s))
    }
}
impl RangeMode {
...
impl ::std::convert::AsRef<str> for RangeMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
