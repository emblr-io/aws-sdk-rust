...
pub struct GetInternetEventOutput {
...
impl ::aws_types::request_id::RequestId for GetInternetEventOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetInternetEventOutput {
    /// Creates a new builder-style object to manufacture [`GetInternetEventOutput`](crate::operation::get_internet_event::GetInternetEventOutput).
    pub fn builder() -> crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder {
        crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder::default()
    }
}

/// A builder for [`GetInternetEventOutput`](crate::operation::get_internet_event::GetInternetEventOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetInternetEventOutputBuilder {
...
impl GetInternetEventOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetInternetEventOutput`](crate::operation::get_internet_event::GetInternetEventOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`event_id`](crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder::event_id)
    /// - [`event_arn`](crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder::event_arn)
    /// - [`started_at`](crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder::started_at)
    /// - [`event_type`](crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder::event_type)
    /// - [`event_status`](crate::operation::get_internet_event::builders::GetInternetEventOutputBuilder::event_status)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_internet_event::GetInternetEventOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_internet_event::GetInternetEventOutput {
            event_id: self.event_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "event_id",
                    "event_id was not specified but it is required when building GetInternetEventOutput",
                )
            })?,
            event_arn: self.event_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "event_arn",
                    "event_arn was not specified but it is required when building GetInternetEventOutput",
                )
            })?,
            started_at: self.started_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "started_at",
                    "started_at was not specified but it is required when building GetInternetEventOutput",
                )
            })?,
            ...
            event_type: self.event_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "event_type",
                    "event_type was not specified but it is required when building GetInternetEventOutput",
                )
            })?,
            event_status: self.event_status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "event_status",
                    "event_status was not specified but it is required when building GetInternetEventOutput",
                )
            })?,
