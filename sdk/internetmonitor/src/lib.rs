...
//! offered by Amazon CloudWatch Internet Monitor. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudWatch Internet Monitor.
...
/// Configuration for Amazon CloudWatch Internet Monitor.
pub mod config;
