...
impl ProbeInput {
    /// Creates a new builder-style object to manufacture [`ProbeInput`](crate::types::ProbeInput).
    pub fn builder() -> crate::types::builders::ProbeInputBuilder {
        crate::types::builders::ProbeInputBuilder::default()
    }
}

/// A builder for [`ProbeInput`](crate::types::ProbeInput).
...
impl ProbeInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ProbeInput`](crate::types::ProbeInput).
    /// This method will fail if any of the following fields are not set:
    /// - [`source_arn`](crate::types::builders::ProbeInputBuilder::source_arn)
    /// - [`destination`](crate::types::builders::ProbeInputBuilder::destination)
    /// - [`protocol`](crate::types::builders::ProbeInputBuilder::protocol)
    pub fn build(self) -> ::std::result::Result<crate::types::ProbeInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ProbeInput {
            source_arn: self.source_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "source_arn",
                    "source_arn was not specified but it is required when building ProbeInput",
                )
            })?,
            destination: self.destination.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "destination",
                    "destination was not specified but it is required when building ProbeInput",
                )
            })?,
            ...
            protocol: self.protocol.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "protocol",
                    "protocol was not specified but it is required when building ProbeInput",
                )
            })?,
