...
impl Probe {
    /// Creates a new builder-style object to manufacture [`Probe`](crate::types::Probe).
    pub fn builder() -> crate::types::builders::ProbeBuilder {
        crate::types::builders::ProbeBuilder::default()
    }
}
...
impl ProbeBuilder {
    ...
    /// - [`source_arn`](crate::types::builders::ProbeBuilder::source_arn)
