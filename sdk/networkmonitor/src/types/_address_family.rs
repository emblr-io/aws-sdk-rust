...
impl ::std::convert::From<&str> for AddressFamily {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AddressFamily::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AddressFamily {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AddressFamily::from(s))
    }
}
impl AddressFamily {
...
impl ::std::convert::AsRef<str> for AddressFamily {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
