...
impl ::aws_types::request_id::RequestId for GetProbeOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetProbeOutput {
    /// Creates a new builder-style object to manufacture [`GetProbeOutput`](crate::operation::get_probe::GetProbeOutput).
    pub fn builder() -> crate::operation::get_probe::builders::GetProbeOutputBuilder {
        crate::operation::get_probe::builders::GetProbeOutputBuilder::default()
    }
}

/// A builder for [`GetProbeOutput`](crate::operation::get_probe::GetProbeOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetProbeOutputBuilder {
...
impl GetProbeOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetProbeOutput`](crate::operation::get_probe::GetProbeOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`source_arn`](crate::operation::get_probe::builders::GetProbeOutputBuilder::source_arn)
    /// - [`destination`](crate::operation::get_probe::builders::GetProbeOutputBuilder::destination)
    /// - [`protocol`](crate::operation::get_probe::builders::GetProbeOutputBuilder::protocol)
    pub fn build(self) -> ::std::result::Result<crate::operation::get_probe::GetProbeOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_probe::GetProbeOutput {
            probe_id: self.probe_id,
            probe_arn: self.probe_arn,
            source_arn: self.source_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "source_arn",
                    "source_arn was not specified but it is required when building GetProbeOutput",
                )
            })?,
            destination: self.destination.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "destination",
                    "destination was not specified but it is required when building GetProbeOutput",
                )
            })?,
            ...
            protocol: self.protocol.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "protocol",
                    "protocol was not specified but it is required when building GetProbeOutput",
                )
            })?,
