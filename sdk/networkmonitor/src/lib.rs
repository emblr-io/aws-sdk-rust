...
//! aws-sdk-networkmonitor = "0.0.0-local"
...
//! offered by Amazon CloudWatch Network Monitor. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudWatch Network Monitor.
...
/// For example, the [`CreateMonitor`](crate::operation::create_monitor) operation has
/// a [`Client::create_monitor`], function which returns a builder for that operation.
...
/// Configuration for Amazon CloudWatch Network Monitor.
pub mod config;
