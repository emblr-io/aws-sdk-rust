...
//! offered by AWS X-Ray. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`BatchGetTraces`](crate::operation::batch_get_traces) operation has
