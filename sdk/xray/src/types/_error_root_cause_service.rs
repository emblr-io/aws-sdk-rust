...
impl ErrorRootCauseService {
    ...
    pub fn entity_path(&self) -> &[crate::types::ErrorRootCauseEntity] {
...
impl ErrorRootCauseService {
    /// Creates a new builder-style object to manufacture [`ErrorRootCauseService`](crate::types::ErrorRootCauseService).
    pub fn builder() -> crate::types::builders::ErrorRootCauseServiceBuilder {
        crate::types::builders::ErrorRootCauseServiceBuilder::default()
    }
}
...
impl ErrorRootCauseServiceBuilder {
    ...
    /// Consumes the builder and constructs a [`ErrorRootCauseService`](crate::types::ErrorRootCauseService).
    pub fn build(self) -> crate::types::ErrorRootCauseService {
        crate::types::ErrorRootCauseService {
            name: self.name,
            names: self.names,
            r#type: self.r#type,
