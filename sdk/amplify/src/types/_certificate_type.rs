...
///     CertificateType::AmplifyManaged => { /* ... */ },
...
impl ::std::convert::From<&str> for CertificateType {
    fn from(s: &str) -> Self {
        match s {
            "AMPLIFY_MANAGED" => CertificateType::AmplifyManaged,
            "CUSTOM" => CertificateType::Custom,
            other => CertificateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CertificateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CertificateType::from(s))
    }
}
impl CertificateType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CertificateType::AmplifyManaged => "AMPLIFY_MANAGED",
...
impl ::std::convert::AsRef<str> for CertificateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
