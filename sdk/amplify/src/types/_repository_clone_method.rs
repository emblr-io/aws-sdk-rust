...
impl ::std::convert::From<&str> for RepositoryCloneMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RepositoryCloneMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RepositoryCloneMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RepositoryCloneMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RepositoryCloneMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
