...
//! offered by Amazon Keyspaces Streams. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`GetRecords`](crate::operation::get_records) operation has
/// a [`Client::get_records`], function which returns a builder for that operation.
