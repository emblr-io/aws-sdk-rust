...
impl ::std::convert::From<&str> for OriginType {
    fn from(s: &str) -> Self {
        match s {
            "REPLICATION" => OriginType::Replication,
            "TTL" => OriginType::Ttl,
            "USER" => OriginType::User,
            other => OriginType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl OriginType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            OriginType::Replication => "REPLICATION",
            OriginType::Ttl => "TTL",
