...
impl UpdateZonalShiftOutputBuilder {
    ...
    /// - [`resource_identifier`](crate::operation::update_zonal_shift::builders::UpdateZonalShiftOutputBuilder::resource_identifier)
    /// - [`away_from`](crate::operation::update_zonal_shift::builders::UpdateZonalShiftOutputBuilder::away_from)
    /// - [`expiry_time`](crate::operation::update_zonal_shift::builders::UpdateZonalShiftOutputBuilder::expiry_time)
