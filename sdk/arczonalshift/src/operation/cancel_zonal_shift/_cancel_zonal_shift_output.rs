...
impl CancelZonalShiftOutput {
    /// Creates a new builder-style object to manufacture [`CancelZonalShiftOutput`](crate::operation::cancel_zonal_shift::CancelZonalShiftOutput).
    pub fn builder() -> crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder {
...
impl CancelZonalShiftOutputBuilder {
    /// <p>The identifier of a zonal shift.</p>
    ...
    /// Consumes the builder and constructs a [`CancelZonalShiftOutput`](crate::operation::cancel_zonal_shift::CancelZonalShiftOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`zonal_shift_id`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::zonal_shift_id)
    /// - [`resource_identifier`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::resource_identifier)
    /// - [`away_from`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::away_from)
    /// - [`expiry_time`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::expiry_time)
    /// - [`start_time`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::start_time)
    /// - [`status`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::status)
    /// - [`comment`](crate::operation::cancel_zonal_shift::builders::CancelZonalShiftOutputBuilder::comment)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::cancel_zonal_shift::CancelZonalShiftOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::cancel_zonal_shift::CancelZonalShiftOutput {
            zonal_shift_id: self.zonal_shift_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "zonal_shift_id",
                    "zonal_shift_id was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
            resource_identifier: self.resource_identifier.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "resource_identifier",
                    "resource_identifier was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
            away_from: self.away_from.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "away_from",
                    "away_from was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
            expiry_time: self.expiry_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "expiry_time",
                    "expiry_time was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
            start_time: self.start_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "start_time",
                    "start_time was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
            comment: self.comment.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "comment",
                    "comment was not specified but it is required when building CancelZonalShiftOutput",
                )
            })?,
