...
pub struct StartPracticeRunOutput {
...
impl ::aws_types::request_id::RequestId for StartPracticeRunOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartPracticeRunOutput {
    /// Creates a new builder-style object to manufacture [`StartPracticeRunOutput`](crate::operation::start_practice_run::StartPracticeRunOutput).
    pub fn builder() -> crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder {
        crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::default()
    }
}

/// A builder for [`StartPracticeRunOutput`](crate::operation::start_practice_run::StartPracticeRunOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartPracticeRunOutputBuilder {
...
impl StartPracticeRunOutputBuilder {
    /// <p>The identifier of a practice run zonal shift.</p>
    ...
    /// Consumes the builder and constructs a [`StartPracticeRunOutput`](crate::operation::start_practice_run::StartPracticeRunOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`zonal_shift_id`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::zonal_shift_id)
    /// - [`resource_identifier`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::resource_identifier)
    /// - [`away_from`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::away_from)
    /// - [`expiry_time`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::expiry_time)
    /// - [`start_time`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::start_time)
    /// - [`status`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::status)
    /// - [`comment`](crate::operation::start_practice_run::builders::StartPracticeRunOutputBuilder::comment)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::start_practice_run::StartPracticeRunOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::start_practice_run::StartPracticeRunOutput {
            zonal_shift_id: self.zonal_shift_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "zonal_shift_id",
                    "zonal_shift_id was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
            resource_identifier: self.resource_identifier.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "resource_identifier",
                    "resource_identifier was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
            away_from: self.away_from.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "away_from",
                    "away_from was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
            expiry_time: self.expiry_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "expiry_time",
                    "expiry_time was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
            start_time: self.start_time.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "start_time",
                    "start_time was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
            comment: self.comment.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "comment",
                    "comment was not specified but it is required when building StartPracticeRunOutput",
                )
            })?,
