...
impl ::std::convert::From<&str> for AppliedStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppliedStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppliedStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppliedStatus::from(s))
    }
}
impl AppliedStatus {
...
impl ::std::convert::AsRef<str> for AppliedStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
