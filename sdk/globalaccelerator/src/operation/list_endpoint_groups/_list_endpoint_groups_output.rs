...
impl ListEndpointGroupsOutput {
    ...
    pub fn endpoint_groups(&self) -> &[crate::types::EndpointGroup] {
...
impl ::aws_types::request_id::RequestId for ListEndpointGroupsOutput {
...
impl ListEndpointGroupsOutputBuilder {
    ...
    pub fn endpoint_groups(mut self, input: crate::types::EndpointGroup) -> Self {
        ...
        v.push(input);
        self.endpoint_groups = ::std::option::Option::Some(v);
        self
    }
    /// <p>The list of the endpoint groups associated with a listener.</p>
