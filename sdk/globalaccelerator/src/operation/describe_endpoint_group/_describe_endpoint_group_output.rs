...
impl ::aws_types::request_id::RequestId for DescribeEndpointGroupOutput {
...
impl DescribeEndpointGroupOutputBuilder {
    ...
    pub fn endpoint_group(mut self, input: crate::types::EndpointGroup) -> Self {
        self.endpoint_group = ::std::option::Option::Some(input);
        self
    }
    /// <p>The description of an endpoint group.</p>
    ...
    /// <p>The description of an endpoint group.</p>
    pub fn get_endpoint_group(&self) -> &::std::option::Option<crate::types::EndpointGroup> {
        &self.endpoint_group
    }
