...
impl ::std::convert::From<&str> for SelectiveAuth {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SelectiveAuth::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SelectiveAuth {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SelectiveAuth::from(s))
    }
}
impl SelectiveAuth {
...
impl ::std::convert::AsRef<str> for SelectiveAuth {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
