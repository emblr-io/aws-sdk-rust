...
impl ::std::convert::From<&str> for TrustType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrustType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrustType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrustType::from(s))
    }
}
impl TrustType {
...
impl ::std::convert::AsRef<str> for TrustType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
