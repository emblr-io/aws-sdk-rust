...
impl ::std::convert::From<&str> for DirectoryEdition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectoryEdition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectoryEdition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectoryEdition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DirectoryEdition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
