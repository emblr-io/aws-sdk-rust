...
impl ::std::convert::From<&str> for RadiusStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RadiusStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RadiusStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RadiusStatus::from(s))
    }
}
impl RadiusStatus {
...
impl ::std::convert::AsRef<str> for RadiusStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
