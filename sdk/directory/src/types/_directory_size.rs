...
impl ::std::convert::From<&str> for DirectorySize {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DirectorySize::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DirectorySize {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DirectorySize::from(s))
    }
}
impl DirectorySize {
...
impl ::std::convert::AsRef<str> for DirectorySize {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
