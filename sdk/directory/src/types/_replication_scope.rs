...
impl ::std::convert::From<&str> for ReplicationScope {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicationScope::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationScope {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationScope::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReplicationScope {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ReplicationScope {
