...
impl ::std::convert::From<&str> for OsVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OsVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OsVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OsVersion::from(s))
    }
}
impl OsVersion {
...
impl ::std::convert::AsRef<str> for OsVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
