...
impl ::std::convert::From<&str> for ShareMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ShareMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ShareMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ShareMethod::from(s))
    }
}
impl ShareMethod {
...
impl ::std::convert::AsRef<str> for ShareMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
