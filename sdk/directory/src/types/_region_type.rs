...
impl ::std::convert::From<&str> for RegionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RegionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RegionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RegionType::from(s))
    }
}
impl RegionType {
...
impl ::std::convert::AsRef<str> for RegionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
