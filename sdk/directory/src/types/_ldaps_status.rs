...
impl ::std::convert::From<&str> for LdapsStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LdapsStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LdapsStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LdapsStatus::from(s))
    }
}
impl LdapsStatus {
...
impl ::std::convert::AsRef<str> for LdapsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
