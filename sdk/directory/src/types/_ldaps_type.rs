...
impl ::std::convert::From<&str> for LdapsType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LdapsType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LdapsType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LdapsType::from(s))
    }
}
impl LdapsType {
...
impl ::std::convert::AsRef<str> for LdapsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
