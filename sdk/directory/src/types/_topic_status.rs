...
impl ::std::convert::From<&str> for TopicStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TopicStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TopicStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TopicStatus::from(s))
    }
}
impl TopicStatus {
...
impl ::std::convert::AsRef<str> for TopicStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
