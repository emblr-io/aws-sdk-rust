...
impl ::std::convert::From<&str> for SchemaExtensionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SchemaExtensionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SchemaExtensionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SchemaExtensionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SchemaExtensionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
