...
impl ::aws_types::request_id::RequestId for CancelSchemaExtensionOutput {
...
impl CancelSchemaExtensionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CancelSchemaExtensionOutput`](crate::operation::cancel_schema_extension::CancelSchemaExtensionOutput).
    pub fn build(self) -> crate::operation::cancel_schema_extension::CancelSchemaExtensionOutput {
