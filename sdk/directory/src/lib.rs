...
//! offered by AWS Directory Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Directory Service.
...
/// For example, the [`AcceptSharedDirectory`](crate::operation::accept_shared_directory) operation has
/// a [`Client::accept_shared_directory`], function which returns a builder for that operation.
...
/// Configuration for AWS Directory Service.
pub mod config;
