...
impl ::std::convert::From<&str> for BrokerState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BrokerState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BrokerState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BrokerState::from(s))
    }
}
impl BrokerState {
...
impl ::std::convert::AsRef<str> for BrokerState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
