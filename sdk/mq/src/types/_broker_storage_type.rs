...
impl ::std::convert::From<&str> for BrokerStorageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BrokerStorageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BrokerStorageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BrokerStorageType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BrokerStorageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
