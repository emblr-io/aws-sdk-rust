...
impl LdapServerMetadataOutput {
    /// Creates a new builder-style object to manufacture [`LdapServerMetadataOutput`](crate::types::LdapServerMetadataOutput).
    pub fn builder() -> crate::types::builders::LdapServerMetadataOutputBuilder {
        crate::types::builders::LdapServerMetadataOutputBuilder::default()
    }
}
...
impl LdapServerMetadataOutputBuilder {
    ...
    pub fn build(self) -> crate::types::LdapServerMetadataOutput {
        crate::types::LdapServerMetadataOutput {
            hosts: self.hosts,
