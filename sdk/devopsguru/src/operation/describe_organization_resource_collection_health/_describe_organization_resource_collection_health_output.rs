...
/// A builder for [`DescribeOrganizationResourceCollectionHealthOutput`](crate::operation::describe_organization_resource_collection_health::DescribeOrganizationResourceCollectionHealthOutput).
