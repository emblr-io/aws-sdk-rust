...
impl ::std::convert::From<&str> for LogAnomalyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LogAnomalyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogAnomalyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogAnomalyType::from(s))
    }
}
impl LogAnomalyType {
...
impl ::std::convert::AsRef<str> for LogAnomalyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
