...
impl ::std::convert::From<&str> for AnomalyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnomalyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnomalyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnomalyType::from(s))
    }
}
impl AnomalyType {
...
impl ::std::convert::AsRef<str> for AnomalyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
