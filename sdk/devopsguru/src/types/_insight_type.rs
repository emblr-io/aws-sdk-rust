...
impl ::std::convert::From<&str> for InsightType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InsightType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InsightType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InsightType::from(s))
    }
}
impl InsightType {
...
impl ::std::convert::AsRef<str> for InsightType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
