...
impl ::std::convert::From<&str> for ResourcePermission {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourcePermission::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourcePermission {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourcePermission::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourcePermission {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
