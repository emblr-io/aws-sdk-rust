...
impl ::std::convert::From<&str> for EventSourceOptInStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventSourceOptInStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventSourceOptInStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventSourceOptInStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventSourceOptInStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
