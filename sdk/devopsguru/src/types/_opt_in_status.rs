...
impl ::std::convert::From<&str> for OptInStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OptInStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OptInStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OptInStatus::from(s))
    }
}
impl OptInStatus {
...
impl ::std::convert::AsRef<str> for OptInStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
