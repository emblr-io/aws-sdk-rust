...
impl ::std::convert::From<&str> for AnomalyStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AnomalyStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AnomalyStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnomalyStatus::from(s))
    }
}
impl AnomalyStatus {
...
impl ::std::convert::AsRef<str> for AnomalyStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
