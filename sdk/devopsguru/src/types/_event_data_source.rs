...
impl ::std::convert::From<&str> for EventDataSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EventDataSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EventDataSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EventDataSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EventDataSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
