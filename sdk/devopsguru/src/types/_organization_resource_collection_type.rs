...
impl ::std::convert::From<&str> for OrganizationResourceCollectionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrganizationResourceCollectionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrganizationResourceCollectionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrganizationResourceCollectionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrganizationResourceCollectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
