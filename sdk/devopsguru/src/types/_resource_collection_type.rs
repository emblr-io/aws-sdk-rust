...
impl ::std::convert::From<&str> for ResourceCollectionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceCollectionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceCollectionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceCollectionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceCollectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ResourceCollectionType {
