...
impl ::std::convert::From<&str> for InsightStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InsightStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InsightStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InsightStatus::from(s))
    }
}
impl InsightStatus {
...
impl ::std::convert::AsRef<str> for InsightStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
