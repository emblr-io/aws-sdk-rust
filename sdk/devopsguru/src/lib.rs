...
//! offered by Amazon DevOps Guru. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon DevOps Guru.
...
/// For example, the [`DeleteInsight`](crate::operation::delete_insight) operation has
