...
//! aws-sdk-repostspace = "0.0.0-local"
...
//! offered by AWS re:Post Private. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS re:Post Private.
