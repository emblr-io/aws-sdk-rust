...
//! aws-sdk-costoptimizationhub = "0.0.0-local"
...
//! offered by Cost Optimization Hub. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Cost Optimization Hub.
...
/// For example, the [`GetRecommendation`](crate::operation::get_recommendation) operation has
...
/// Configuration for Cost Optimization Hub.
pub mod config;
