...
pub struct ListRecommendationsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::Recommendation>>,
...
impl ListRecommendationsOutput {
    ...
    pub fn items(&self) -> &[crate::types::Recommendation] {
...
pub struct ListRecommendationsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::Recommendation>>,
...
impl ListRecommendationsOutputBuilder {
    ...
    ///
    /// <p>List of all savings recommendations.</p>
    pub fn items(mut self, input: crate::types::Recommendation) -> Self {
    ...
    /// <p>List of all savings recommendations.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Recommendation>>) -> Self {
        self.items = input;
        self
    }
    /// <p>List of all savings recommendations.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Recommendation>> {
        &self.items
    }
    /// <p>The token to retrieve the next set of results.</p>
