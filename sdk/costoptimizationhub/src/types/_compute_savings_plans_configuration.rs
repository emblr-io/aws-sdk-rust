...
impl ComputeSavingsPlansConfiguration {
    /// Creates a new builder-style object to manufacture [`ComputeSavingsPlansConfiguration`](crate::types::ComputeSavingsPlansConfiguration).
    pub fn builder() -> crate::types::builders::ComputeSavingsPlansConfigurationBuilder {
        crate::types::builders::ComputeSavingsPlansConfigurationBuilder::default()
    }
}
...
impl ComputeSavingsPlansConfigurationBuilder {
    /// <p>The account scope for which you want recommendations. Amazon Web Services calculates recommendations including the management account and member accounts if the value is set to <code>PAYER</code>. If the value is <code>LINKED</code>, recommendations are calculated for individual member accounts only.</p>
