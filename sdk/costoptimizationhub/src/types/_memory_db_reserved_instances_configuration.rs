...
/// <p>The MemoryDB reserved instances configuration used for recommendations.</p><note>
...
impl MemoryDbReservedInstancesConfiguration {
    /// <p>The account scope for which you want recommendations.</p>
...
impl MemoryDbReservedInstancesConfiguration {
    /// Creates a new builder-style object to manufacture [`MemoryDbReservedInstancesConfiguration`](crate::types::MemoryDbReservedInstancesConfiguration).
    pub fn builder() -> crate::types::builders::MemoryDbReservedInstancesConfigurationBuilder {
        crate::types::builders::MemoryDbReservedInstancesConfigurationBuilder::default()
    }
}

/// A builder for [`MemoryDbReservedInstancesConfiguration`](crate::types::MemoryDbReservedInstancesConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct MemoryDbReservedInstancesConfigurationBuilder {
...
impl MemoryDbReservedInstancesConfigurationBuilder {
    /// <p>The account scope for which you want recommendations.</p>
    ...
    /// Consumes the builder and constructs a [`MemoryDbReservedInstancesConfiguration`](crate::types::MemoryDbReservedInstancesConfiguration).
    pub fn build(self) -> crate::types::MemoryDbReservedInstancesConfiguration {
        crate::types::MemoryDbReservedInstancesConfiguration {
