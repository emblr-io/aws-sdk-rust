...
impl ::std::convert::From<&str> for EnrollmentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EnrollmentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EnrollmentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EnrollmentStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EnrollmentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
