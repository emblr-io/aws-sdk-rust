...
pub struct DynamoDbReservedCapacityConfiguration {
    ...
    pub number_of_capacity_units_to_purchase: ::std::option::Option<::std::string::String>,
...
impl DynamoDbReservedCapacityConfiguration {
    ...
    /// <p>The number of reserved capacity units that Amazon Web Services recommends that you purchase.</p>
    pub fn number_of_capacity_units_to_purchase(&self) -> ::std::option::Option<&str> {
        self.number_of_capacity_units_to_purchase.as_deref()
    }
    /// <p>The capacity unit of the recommended reservation.</p>
...
impl DynamoDbReservedCapacityConfiguration {
    /// Creates a new builder-style object to manufacture [`DynamoDbReservedCapacityConfiguration`](crate::types::DynamoDbReservedCapacityConfiguration).
    pub fn builder() -> crate::types::builders::DynamoDbReservedCapacityConfigurationBuilder {
        crate::types::builders::DynamoDbReservedCapacityConfigurationBuilder::default()
    }
}

/// A builder for [`DynamoDbReservedCapacityConfiguration`](crate::types::DynamoDbReservedCapacityConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DynamoDbReservedCapacityConfigurationBuilder {
    ...
    pub(crate) number_of_capacity_units_to_purchase: ::std::option::Option<::std::string::String>,
    pub(crate) capacity_units: ::std::option::Option<::std::string::String>,
}
impl DynamoDbReservedCapacityConfigurationBuilder {
    /// <p>The account scope for which you want recommendations.</p>
    ...
    /// <p>The number of reserved capacity units that Amazon Web Services recommends that you purchase.</p>
    pub fn number_of_capacity_units_to_purchase(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.number_of_capacity_units_to_purchase = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The number of reserved capacity units that Amazon Web Services recommends that you purchase.</p>
    pub fn set_number_of_capacity_units_to_purchase(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.number_of_capacity_units_to_purchase = input;
        self
    }
    /// <p>The number of reserved capacity units that Amazon Web Services recommends that you purchase.</p>
    pub fn get_number_of_capacity_units_to_purchase(&self) -> &::std::option::Option<::std::string::String> {
        &self.number_of_capacity_units_to_purchase
    }
    /// <p>The capacity unit of the recommended reservation.</p>
    ...
    /// Consumes the builder and constructs a [`DynamoDbReservedCapacityConfiguration`](crate::types::DynamoDbReservedCapacityConfiguration).
    pub fn build(self) -> crate::types::DynamoDbReservedCapacityConfiguration {
        crate::types::DynamoDbReservedCapacityConfiguration {
            ...
            number_of_capacity_units_to_purchase: self.number_of_capacity_units_to_purchase,
