...
pub struct RedshiftReservedInstancesConfiguration {
...
impl RedshiftReservedInstancesConfiguration {
    /// <p>The account scope for which you want recommendations.</p>
...
impl RedshiftReservedInstancesConfiguration {
    /// Creates a new builder-style object to manufacture [`RedshiftReservedInstancesConfiguration`](crate::types::RedshiftReservedInstancesConfiguration).
    pub fn builder() -> crate::types::builders::RedshiftReservedInstancesConfigurationBuilder {
        crate::types::builders::RedshiftReservedInstancesConfigurationBuilder::default()
    }
}

/// A builder for [`RedshiftReservedInstancesConfiguration`](crate::types::RedshiftReservedInstancesConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RedshiftReservedInstancesConfigurationBuilder {
...
impl RedshiftReservedInstancesConfigurationBuilder {
    /// <p>The account scope for which you want recommendations.</p>
    ...
    /// Consumes the builder and constructs a [`RedshiftReservedInstancesConfiguration`](crate::types::RedshiftReservedInstancesConfiguration).
    pub fn build(self) -> crate::types::RedshiftReservedInstancesConfiguration {
        crate::types::RedshiftReservedInstancesConfiguration {
