...
//! offered by Timestream InfluxDB. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Timestream InfluxDB.
...
/// Configuration for Timestream InfluxDB.
pub mod config;
