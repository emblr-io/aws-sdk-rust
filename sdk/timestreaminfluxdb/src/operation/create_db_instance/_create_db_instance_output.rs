...
impl CreateDbInstanceOutputBuilder {
    ...
    /// - [`id`](crate::operation::create_db_instance::builders::CreateDbInstanceOutputBuilder::id)
    /// - [`name`](crate::operation::create_db_instance::builders::CreateDbInstanceOutputBuilder::name)
    /// - [`arn`](crate::operation::create_db_instance::builders::CreateDbInstanceOutputBuilder::arn)
    /// - [`vpc_subnet_ids`](crate::operation::create_db_instance::builders::CreateDbInstanceOutputBuilder::vpc_subnet_ids)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_db_instance::CreateDbInstanceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_db_instance::CreateDbInstanceOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateDbInstanceOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreateDbInstanceOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building CreateDbInstanceOutput",
                )
            })?,
            status: self.status,
            ...
            vpc_subnet_ids: self.vpc_subnet_ids.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "vpc_subnet_ids",
                    "vpc_subnet_ids was not specified but it is required when building CreateDbInstanceOutput",
                )
            })?,
