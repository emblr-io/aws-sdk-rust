...
///     DeploymentType::WithMultiazStandby => { /* ... */ },
...
impl ::std::convert::From<&str> for DeploymentType {
    fn from(s: &str) -> Self {
        match s {
            "SINGLE_AZ" => DeploymentType::SingleAz,
            "WITH_MULTIAZ_STANDBY" => DeploymentType::WithMultiazStandby,
...
impl DeploymentType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DeploymentType::SingleAz => "SINGLE_AZ",
            DeploymentType::WithMultiazStandby => "WITH_MULTIAZ_STANDBY",
