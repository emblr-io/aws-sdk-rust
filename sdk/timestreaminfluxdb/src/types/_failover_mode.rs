...
impl ::std::convert::From<&str> for FailoverMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NO_FAILOVER" => FailoverMode::NoFailover,
...
impl FailoverMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            FailoverMode::NoFailover => "NO_FAILOVER",
...
impl ::std::fmt::Display for FailoverMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FailoverMode::Automatic => write!(f, "AUTOMATIC"),
            FailoverMode::NoFailover => write!(f, "NO_FAILOVER"),
