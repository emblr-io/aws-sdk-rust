...
//! offered by Amazon Kinesis Analytics. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Kinesis Analytics.
...
/// For example, the [`AddApplicationCloudWatchLoggingOption`](crate::operation::add_application_cloud_watch_logging_option) operation has
/// a [`Client::add_application_cloud_watch_logging_option`], function which returns a builder for that operation.
