...
//! offered by AWS Backup Search. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Backup Search.
...
/// Configuration for AWS Backup Search.
pub mod config;
