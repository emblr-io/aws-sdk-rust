...
//! offered by Amazon Augmented AI Runtime. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Augmented AI Runtime.
...
/// For example, the [`DeleteHumanLoop`](crate::operation::delete_human_loop) operation has
