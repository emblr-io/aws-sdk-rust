...
pub struct CaptionFormat {
    ...
    /// <ul>
    /// <li>
    /// <p><b>for FLAC</b>: None</p></li>
    /// <li>
    /// <p><b>For MP3</b>: None</p></li>
    /// <li>
    /// <p><b>For MP4</b>: mov-text</p></li>
    /// <li>
    /// <p><b>For MPEG-TS</b>: None</p></li>
    /// <li>
    /// <p><b>For ogg</b>: None</p></li>
    /// <li>
    /// <p><b>For webm</b>: None</p></li>
    /// </ul></li>
    /// <li>
    /// <p><b>Valid Sidecar Caption Formats:</b> Elastic Transcoder supports dfxp (first div element only), scc, srt, and webvtt. If you want ttml or smpte-tt compatible captions, specify dfxp as your output format.</p>
    /// <ul>
    /// <li>
    /// <p><b>For FMP4</b>: dfxp</p></li>
    /// <li>
    /// <p><b>Non-FMP4 outputs</b>: All sidecar types</p></li>
    /// </ul>
    ...
    /// <ul>
    /// <li>
    /// <p><i>description</i> is a description of the video.</p></li>
    /// <li>
    /// <p><code>{language}</code> is a literal value that Elastic Transcoder replaces with the two- or three-letter code for the language of the caption in the output file names.</p></li>
    /// </ul>
