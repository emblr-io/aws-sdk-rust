...
/// For example, the [`CalculateIsolines`](crate::operation::calculate_isolines) operation has
/// a [`Client::calculate_isolines`], function which returns a builder for that operation.
