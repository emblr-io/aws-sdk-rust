...
/// When writing a match expression against `RoutePedestrianNoticeCode`, it is important to ensure
...
///
/// ```text
/// # let routepedestriannoticecode = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `routepedestriannoticecode` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `RoutePedestrianNoticeCode::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `RoutePedestrianNoticeCode::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `RoutePedestrianNoticeCode::NewFeature` is defined.
/// Specifically, when `routepedestriannoticecode` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RoutePedestrianNoticeCode::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum RoutePedestrianNoticeCode {
    #[allow(missing_docs)] // documentation missing in model
...
impl ::std::convert::From<&str> for RoutePedestrianNoticeCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RoutePedestrianNoticeCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RoutePedestrianNoticeCode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RoutePedestrianNoticeCode::from(s))
    }
}
impl RoutePedestrianNoticeCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RoutePedestrianNoticeCode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for RoutePedestrianNoticeCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RoutePedestrianNoticeCode {
