...
pub struct RouteRampStepDetails {
...
impl RouteRampStepDetails {
    /// Creates a new builder-style object to manufacture [`RouteRampStepDetails`](crate::types::RouteRampStepDetails).
    pub fn builder() -> crate::types::builders::RouteRampStepDetailsBuilder {
        crate::types::builders::RouteRampStepDetailsBuilder::default()
    }
}

/// A builder for [`RouteRampStepDetails`](crate::types::RouteRampStepDetails).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RouteRampStepDetailsBuilder {
...
impl RouteRampStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteRampStepDetails`](crate::types::RouteRampStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteRampStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteRampStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteRampStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteRampStepDetails",
                )
            })?,
