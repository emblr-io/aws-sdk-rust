...
impl RouteKeepStepDetails {
    ...
    pub fn builder() -> crate::types::builders::RouteKeepStepDetailsBuilder {
        crate::types::builders::RouteKeepStepDetailsBuilder::default()
    }
}
...
impl RouteKeepStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteKeepStepDetails`](crate::types::RouteKeepStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteKeepStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteKeepStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteKeepStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteKeepStepDetails",
                )
            })?,
