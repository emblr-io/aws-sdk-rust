...
pub struct RouteRoundaboutPassStepDetails {
...
impl RouteRoundaboutPassStepDetails {
    /// <p>Name of the intersection, if applicable to the step.</p>
...
impl RouteRoundaboutPassStepDetails {
    /// Creates a new builder-style object to manufacture [`RouteRoundaboutPassStepDetails`](crate::types::RouteRoundaboutPassStepDetails).
    pub fn builder() -> crate::types::builders::RouteRoundaboutPassStepDetailsBuilder {
        crate::types::builders::RouteRoundaboutPassStepDetailsBuilder::default()
    }
}

/// A builder for [`RouteRoundaboutPassStepDetails`](crate::types::RouteRoundaboutPassStepDetails).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RouteRoundaboutPassStepDetailsBuilder {
...
impl RouteRoundaboutPassStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteRoundaboutPassStepDetails`](crate::types::RouteRoundaboutPassStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteRoundaboutPassStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteRoundaboutPassStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteRoundaboutPassStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteRoundaboutPassStepDetails",
                )
            })?,
