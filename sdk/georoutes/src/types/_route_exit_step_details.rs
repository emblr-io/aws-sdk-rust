...
impl RouteExitStepDetails {
    ...
    pub fn builder() -> crate::types::builders::RouteExitStepDetailsBuilder {
        crate::types::builders::RouteExitStepDetailsBuilder::default()
    }
}
...
impl RouteExitStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteExitStepDetails`](crate::types::RouteExitStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteExitStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteExitStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteExitStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteExitStepDetails",
                )
            })?,
