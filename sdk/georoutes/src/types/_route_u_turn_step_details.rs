...
impl RouteUTurnStepDetails {
    ...
    pub fn builder() -> crate::types::builders::RouteUTurnStepDetailsBuilder {
        crate::types::builders::RouteUTurnStepDetailsBuilder::default()
    }
}
...
impl RouteUTurnStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteUTurnStepDetails`](crate::types::RouteUTurnStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteUTurnStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteUTurnStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteUTurnStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteUTurnStepDetails",
                )
            })?,
