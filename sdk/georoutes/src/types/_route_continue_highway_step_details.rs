...
pub struct RouteContinueHighwayStepDetails {
...
impl RouteContinueHighwayStepDetails {
    /// <p>Name of the intersection, if applicable to the step.</p>
...
impl RouteContinueHighwayStepDetails {
    /// Creates a new builder-style object to manufacture [`RouteContinueHighwayStepDetails`](crate::types::RouteContinueHighwayStepDetails).
    pub fn builder() -> crate::types::builders::RouteContinueHighwayStepDetailsBuilder {
        crate::types::builders::RouteContinueHighwayStepDetailsBuilder::default()
    }
}

/// A builder for [`RouteContinueHighwayStepDetails`](crate::types::RouteContinueHighwayStepDetails).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RouteContinueHighwayStepDetailsBuilder {
...
impl RouteContinueHighwayStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteContinueHighwayStepDetails`](crate::types::RouteContinueHighwayStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteContinueHighwayStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteContinueHighwayStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteContinueHighwayStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteContinueHighwayStepDetails",
                )
            })?,
