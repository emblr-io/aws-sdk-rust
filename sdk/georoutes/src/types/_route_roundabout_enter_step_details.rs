...
impl RouteRoundaboutEnterStepDetails {
    ...
    pub fn builder() -> crate::types::builders::RouteRoundaboutEnterStepDetailsBuilder {
        crate::types::builders::RouteRoundaboutEnterStepDetailsBuilder::default()
    }
}
...
impl RouteRoundaboutEnterStepDetailsBuilder {
    ...
    /// Consumes the builder and constructs a [`RouteRoundaboutEnterStepDetails`](crate::types::RouteRoundaboutEnterStepDetails).
    /// This method will fail if any of the following fields are not set:
    /// - [`intersection`](crate::types::builders::RouteRoundaboutEnterStepDetailsBuilder::intersection)
    pub fn build(self) -> ::std::result::Result<crate::types::RouteRoundaboutEnterStepDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::RouteRoundaboutEnterStepDetails {
            intersection: self.intersection.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "intersection",
                    "intersection was not specified but it is required when building RouteRoundaboutEnterStepDetails",
                )
            })?,
