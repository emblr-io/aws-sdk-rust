...
//! offered by Amazon Aurora DSQL. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Aurora DSQL.
...
/// Configuration for Amazon Aurora DSQL.
pub mod config;
