...
///     ValidationExceptionReason::DeletionProtectionEnabled => { /* ... */ },
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ValidationExceptionReason::DeletionProtectionEnabled => "deletionProtectionEnabled",
...
impl ::std::fmt::Display for ValidationExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ValidationExceptionReason::DeletionProtectionEnabled => write!(f, "deletionProtectionEnabled"),
