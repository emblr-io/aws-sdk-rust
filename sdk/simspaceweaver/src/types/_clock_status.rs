...
impl ::std::convert::From<&str> for ClockStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClockStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClockStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClockStatus::from(s))
    }
}
impl ClockStatus {
...
impl ::std::convert::AsRef<str> for ClockStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
