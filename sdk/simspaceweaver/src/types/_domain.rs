...
pub struct Domain {
    ...
    /// <ul>
    /// <li>
    /// <p><code>PerWorker</code> – Managed: SimSpace Weaver starts one app on each worker.</p></li>
    /// <li>
    /// <p><code>BySpatialSubdivision</code> – Managed: SimSpace Weaver starts one app for each spatial partition.</p></li>
    /// <li>
