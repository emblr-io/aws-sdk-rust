...
impl ::std::convert::From<&str> for SimulationAppStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SimulationAppStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SimulationAppStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SimulationAppStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SimulationAppStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
