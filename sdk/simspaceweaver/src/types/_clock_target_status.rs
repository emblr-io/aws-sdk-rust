...
impl ::std::convert::From<&str> for ClockTargetStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClockTargetStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClockTargetStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClockTargetStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClockTargetStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
