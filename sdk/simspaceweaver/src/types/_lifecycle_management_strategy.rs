...
impl ::std::convert::From<&str> for LifecycleManagementStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LifecycleManagementStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LifecycleManagementStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LifecycleManagementStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LifecycleManagementStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
