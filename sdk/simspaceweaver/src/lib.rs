...
//! offered by AWS SimSpace Weaver. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS SimSpace Weaver.
...
/// For example, the [`CreateSnapshot`](crate::operation::create_snapshot) operation has
/// a [`Client::create_snapshot`], function which returns a builder for that operation.
...
/// Configuration for AWS SimSpace Weaver.
pub mod config;
