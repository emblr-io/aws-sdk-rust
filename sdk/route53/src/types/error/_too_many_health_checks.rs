...
impl TooManyHealthChecks {
    /// Creates a new builder-style object to manufacture [`TooManyHealthChecks`](crate::types::error::TooManyHealthChecks).
    pub fn builder() -> crate::types::error::builders::TooManyHealthChecksBuilder {
        crate::types::error::builders::TooManyHealthChecksBuilder::default()
    }
}

/// A builder for [`TooManyHealthChecks`](crate::types::error::TooManyHealthChecks).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TooManyHealthChecksBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl TooManyHealthChecksBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`TooManyHealthChecks`](crate::types::error::TooManyHealthChecks).
    pub fn build(self) -> crate::types::error::TooManyHealthChecks {
        crate::types::error::TooManyHealthChecks {
