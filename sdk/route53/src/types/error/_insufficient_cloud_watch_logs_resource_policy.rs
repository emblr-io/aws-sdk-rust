...
impl ::std::fmt::Display for InsufficientCloudWatchLogsResourcePolicy {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InsufficientCloudWatchLogsResourcePolicy")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InsufficientCloudWatchLogsResourcePolicy {
