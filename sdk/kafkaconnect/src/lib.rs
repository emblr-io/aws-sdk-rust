...
//! aws-sdk-kafkaconnect = "0.0.0-local"
...
//! offered by Managed Streaming for Kafka Connect. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Managed Streaming for Kafka Connect.
...
/// For example, the [`CreateConnector`](crate::operation::create_connector) operation has
...
/// Configuration for Managed Streaming for Kafka Connect.
pub mod config;
