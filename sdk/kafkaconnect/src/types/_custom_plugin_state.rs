...
///
/// ```text
/// # let custompluginstate = unimplemented!();
/// match custompluginstate {
///     CustomPluginState::Active => { /* ... */ },
///     CustomPluginState::CreateFailed => { /* ... */ },
///     CustomPluginState::Creating => { /* ... */ },
///     CustomPluginState::Deleting => { /* ... */ },
///     CustomPluginState::UpdateFailed => { /* ... */ },
///     CustomPluginState::Updating => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `custompluginstate` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `CustomPluginState::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `CustomPluginState::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `CustomPluginState::NewFeature` is defined.
/// Specifically, when `custompluginstate` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `CustomPluginState::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for CustomPluginState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomPluginState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomPluginState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomPluginState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomPluginState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
