...
/// When writing a match expression against `ConnectorOperationType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `connectoroperationtype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ConnectorOperationType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ConnectorOperationType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ConnectorOperationType::NewFeature` is defined.
/// Specifically, when `connectoroperationtype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ConnectorOperationType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ConnectorOperationType {
    #[allow(missing_docs)] // documentation missing in model
    IsolateConnector,
    #[allow(missing_docs)] // documentation missing in model
    RestoreConnector,
...
impl ::std::convert::From<&str> for ConnectorOperationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectorOperationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectorOperationType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectorOperationType::from(s))
    }
}
impl ConnectorOperationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ConnectorOperationType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ConnectorOperationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ConnectorOperationType {
