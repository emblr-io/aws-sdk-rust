...
//! offered by Amazon Translate. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Translate.
...
/// For example, the [`CreateParallelData`](crate::operation::create_parallel_data) operation has
