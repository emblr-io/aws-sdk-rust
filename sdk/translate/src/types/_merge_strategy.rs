...
impl ::std::convert::From<&str> for MergeStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MergeStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MergeStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MergeStrategy::from(s))
    }
}
impl MergeStrategy {
...
impl ::std::convert::AsRef<str> for MergeStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
