...
/// When writing a match expression against `ParallelDataStatus`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `paralleldatastatus` represents
...
/// version of SDK where the variant `ParallelDataStatus::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ParallelDataStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ParallelDataStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParallelDataStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParallelDataStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ParallelDataStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
