...
impl ::std::convert::From<&str> for Directionality {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Directionality::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Directionality {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Directionality::from(s))
    }
}
impl Directionality {
...
impl ::std::convert::AsRef<str> for Directionality {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
