...
/// When writing a match expression against `TerminologyDataFormat`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `terminologydataformat` represents
...
/// version of SDK where the variant `TerminologyDataFormat::NewFeature` is defined.
...
impl ::std::convert::From<&str> for TerminologyDataFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TerminologyDataFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
