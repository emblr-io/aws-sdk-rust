...
impl ListTextTranslationJobsOutput {
    /// <p>A list containing the properties of each job that is returned.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.text_translation_job_properties_list.is_none()`.
    pub fn text_translation_job_properties_list(&self) -> &[crate::types::TextTranslationJobProperties] {
        self.text_translation_job_properties_list.as_deref().unwrap_or_default()
    }
    /// <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ::aws_types::request_id::RequestId for ListTextTranslationJobsOutput {
...
impl ListTextTranslationJobsOutputBuilder {
    ...
    pub fn set_text_translation_job_properties_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::TextTranslationJobProperties>>,
    ) -> Self {
