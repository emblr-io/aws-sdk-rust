...
//! offered by Amazon Athena. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Athena.
...
/// Configuration for Amazon Athena.
pub mod config;
