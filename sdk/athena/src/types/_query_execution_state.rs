...
impl ::std::convert::From<&str> for QueryExecutionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => QueryExecutionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for QueryExecutionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(QueryExecutionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for QueryExecutionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
