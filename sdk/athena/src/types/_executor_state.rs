...
impl ::std::convert::From<&str> for ExecutorState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExecutorState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExecutorState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExecutorState::from(s))
    }
}
impl ExecutorState {
...
impl ::std::convert::AsRef<str> for ExecutorState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
