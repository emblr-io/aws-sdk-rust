...
impl ::std::convert::From<&str> for ExecutorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExecutorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExecutorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExecutorType::from(s))
    }
}
impl ExecutorType {
...
impl ::std::convert::AsRef<str> for ExecutorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
