...
impl ::std::convert::From<&str> for NotebookType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotebookType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotebookType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotebookType::from(s))
    }
}
impl NotebookType {
...
impl ::std::convert::AsRef<str> for NotebookType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
