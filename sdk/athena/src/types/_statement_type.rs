...
impl ::std::convert::From<&str> for StatementType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatementType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatementType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatementType::from(s))
    }
}
impl StatementType {
...
impl ::std::convert::AsRef<str> for StatementType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
