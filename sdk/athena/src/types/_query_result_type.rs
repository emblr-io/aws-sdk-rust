...
///     QueryResultType::DataManifest => { /* ... */ },
///     QueryResultType::DataRows => { /* ... */ },
...
impl ::std::convert::From<&str> for QueryResultType {
    fn from(s: &str) -> Self {
        match s {
            "DATA_MANIFEST" => QueryResultType::DataManifest,
            "DATA_ROWS" => QueryResultType::DataRows,
...
impl QueryResultType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            QueryResultType::DataManifest => "DATA_MANIFEST",
            QueryResultType::DataRows => "DATA_ROWS",
