...
impl ::std::convert::From<&str> for WorkGroupState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkGroupState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkGroupState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkGroupState::from(s))
    }
}
impl WorkGroupState {
...
impl ::std::convert::AsRef<str> for WorkGroupState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
