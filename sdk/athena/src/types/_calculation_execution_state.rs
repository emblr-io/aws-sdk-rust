...
impl ::std::convert::From<&str> for CalculationExecutionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CalculationExecutionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CalculationExecutionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CalculationExecutionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CalculationExecutionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
