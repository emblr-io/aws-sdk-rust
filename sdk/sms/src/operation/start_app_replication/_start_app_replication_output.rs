...
impl ::aws_types::request_id::RequestId for StartAppReplicationOutput {
...
impl StartAppReplicationOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartAppReplicationOutput`](crate::operation::start_app_replication::StartAppReplicationOutput).
    pub fn build(self) -> crate::operation::start_app_replication::StartAppReplicationOutput {
