...
impl ::std::convert::From<&str> for ConnectorCapability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectorCapability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectorCapability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectorCapability::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectorCapability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
