...
impl ::std::convert::From<&str> for LicenseType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LicenseType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LicenseType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LicenseType::from(s))
    }
}
impl LicenseType {
...
impl ::std::convert::AsRef<str> for LicenseType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LicenseType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            LicenseType::Aws => write!(f, "AWS"),
            LicenseType::Byol => write!(f, "BYOL"),
