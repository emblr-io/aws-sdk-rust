...
impl ::std::convert::From<&str> for ServerValidationStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServerValidationStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServerValidationStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServerValidationStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServerValidationStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
