...
impl ::std::convert::From<&str> for ServerCatalogStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServerCatalogStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServerCatalogStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServerCatalogStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServerCatalogStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
