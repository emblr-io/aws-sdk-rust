...
impl ::std::convert::From<&str> for AppReplicationConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppReplicationConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppReplicationConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppReplicationConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AppReplicationConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
