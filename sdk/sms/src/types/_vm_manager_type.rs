...
impl ::std::convert::From<&str> for VmManagerType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VmManagerType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VmManagerType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VmManagerType::from(s))
    }
}
impl VmManagerType {
...
impl ::std::convert::AsRef<str> for VmManagerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
