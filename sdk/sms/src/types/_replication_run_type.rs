...
impl ::std::convert::From<&str> for ReplicationRunType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicationRunType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationRunType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationRunType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReplicationRunType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
