...
impl ::std::convert::From<&str> for ReplicationRunState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReplicationRunState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationRunState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationRunState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReplicationRunState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
