...
///     ConflictExceptionReason::ConflictException => { /* ... */ },
///     ConflictExceptionReason::ResourceAlreadyExists => { /* ... */ },
///     ConflictExceptionReason::ResourceInUse => { /* ... */ },
///     ConflictExceptionReason::StatusConflict => { /* ... */ },
...
impl ::std::convert::From<&str> for ConflictExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            "CONFLICT_EXCEPTION" => ConflictExceptionReason::ConflictException,
            "RESOURCE_ALREADY_EXISTS" => ConflictExceptionReason::ResourceAlreadyExists,
            "RESOURCE_IN_USE" => ConflictExceptionReason::ResourceInUse,
            "STATUS_CONFLICT" => ConflictExceptionReason::StatusConflict,
...
impl ConflictExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ConflictExceptionReason::ConflictException => "CONFLICT_EXCEPTION",
            ConflictExceptionReason::ResourceAlreadyExists => "RESOURCE_ALREADY_EXISTS",
            ConflictExceptionReason::ResourceInUse => "RESOURCE_IN_USE",
            ConflictExceptionReason::StatusConflict => "STATUS_CONFLICT",
...
impl ::std::fmt::Display for ConflictExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ConflictExceptionReason::ConflictException => write!(f, "CONFLICT_EXCEPTION"),
