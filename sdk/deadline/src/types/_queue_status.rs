...
/// match queuestatus {
///     QueueStatus::Idle => { /* ... */ },
///     QueueStatus::Scheduling => { /* ... */ },
///     QueueStatus::SchedulingBlocked => { /* ... */ },
...
impl ::std::convert::From<&str> for QueueStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "SCHEDULING_BLOCKED" => QueueStatus::SchedulingBlocked,
...
impl ::std::str::FromStr for QueueStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(QueueStatus::from(s))
    }
}
impl QueueStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            QueueStatus::SchedulingBlocked => "SCHEDULING_BLOCKED",
...
impl ::std::convert::AsRef<str> for QueueStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
