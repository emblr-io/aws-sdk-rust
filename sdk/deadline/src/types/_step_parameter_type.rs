...
impl ::std::convert::From<&str> for StepParameterType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StepParameterType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StepParameterType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StepParameterType::from(s))
    }
}
impl StepParameterType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            StepParameterType::String => "STRING",
            StepParameterType::Unknown(value) => value.as_str(),
        }
    }
