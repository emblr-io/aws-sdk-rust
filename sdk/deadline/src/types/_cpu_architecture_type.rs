...
impl ::std::convert::From<&str> for CpuArchitectureType {
    fn from(s: &str) -> Self {
        match s {
            "arm64" => CpuArchitectureType::Arm64,
            "x86_64" => CpuArchitectureType::X8664,
            other => CpuArchitectureType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CpuArchitectureType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CpuArchitectureType::from(s))
    }
}
impl CpuArchitectureType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CpuArchitectureType::Arm64 => "arm64",
            CpuArchitectureType::X8664 => "x86_64",
            CpuArchitectureType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for CpuArchitectureType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CpuArchitectureType {
