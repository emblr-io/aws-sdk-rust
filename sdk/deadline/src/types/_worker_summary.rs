...
impl WorkerSummary {
    /// Creates a new builder-style object to manufacture [`WorkerSummary`](crate::types::WorkerSummary).
    pub fn builder() -> crate::types::builders::WorkerSummaryBuilder {
        crate::types::builders::WorkerSummaryBuilder::default()
    }
}
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::WorkerSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::WorkerSummary {
            ...
            farm_id: self.farm_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "farm_id",
                    "farm_id was not specified but it is required when building WorkerSummary",
                )
            })?,
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building WorkerSummary",
                )
            })?,
            created_by: self.created_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_by",
                    "created_by was not specified but it is required when building WorkerSummary",
                )
            })?,
