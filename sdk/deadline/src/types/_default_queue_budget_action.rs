...
pub enum DefaultQueueBudgetAction {
    #[allow(missing_docs)] // documentation missing in model
    None,
    #[allow(missing_docs)] // documentation missing in model
...
impl ::std::convert::From<&str> for DefaultQueueBudgetAction {
    fn from(s: &str) -> Self {
        match s {
            "NONE" => DefaultQueueBudgetAction::None,
            "STOP_SCHEDULING_AND_CANCEL_TASKS" => DefaultQueueBudgetAction::StopSchedulingAndCancelTasks,
            "STOP_SCHEDULING_AND_COMPLETE_TASKS" => DefaultQueueBudgetAction::StopSchedulingAndCompleteTasks,
            other => DefaultQueueBudgetAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DefaultQueueBudgetAction {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DefaultQueueBudgetAction::from(s))
    }
}
impl DefaultQueueBudgetAction {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DefaultQueueBudgetAction::None => "NONE",
            DefaultQueueBudgetAction::StopSchedulingAndCancelTasks => "STOP_SCHEDULING_AND_CANCEL_TASKS",
            DefaultQueueBudgetAction::StopSchedulingAndCompleteTasks => "STOP_SCHEDULING_AND_COMPLETE_TASKS",
            DefaultQueueBudgetAction::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for DefaultQueueBudgetAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DefaultQueueBudgetAction {
