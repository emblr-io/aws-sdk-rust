...
impl ::std::fmt::Debug for GetTaskOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetTaskOutput");
...
impl GetTaskOutput {
    /// Creates a new builder-style object to manufacture [`GetTaskOutput`](crate::operation::get_task::GetTaskOutput).
...
impl GetTaskOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetTaskOutput`](crate::operation::get_task::GetTaskOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`task_id`](crate::operation::get_task::builders::GetTaskOutputBuilder::task_id)
    /// - [`created_at`](crate::operation::get_task::builders::GetTaskOutputBuilder::created_at)
    /// - [`created_by`](crate::operation::get_task::builders::GetTaskOutputBuilder::created_by)
    /// - [`run_status`](crate::operation::get_task::builders::GetTaskOutputBuilder::run_status)
    pub fn build(self) -> ::std::result::Result<crate::operation::get_task::GetTaskOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_task::GetTaskOutput {
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building GetTaskOutput",
                )
            })?,
            created_by: self.created_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_by",
                    "created_by was not specified but it is required when building GetTaskOutput",
                )
            })?,
            run_status: self.run_status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "run_status",
                    "run_status was not specified but it is required when building GetTaskOutput",
                )
            })?,
...
impl ::std::fmt::Debug for GetTaskOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetTaskOutputBuilder");
        formatter.field("task_id", &self.task_id);
        formatter.field("created_at", &self.created_at);
        formatter.field("created_by", &self.created_by);
        formatter.field("run_status", &self.run_status);
