...
//! aws-sdk-comprehend = "0.0.0-local"
...
//! offered by Amazon Comprehend. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Comprehend.
...
/// Configuration for Amazon Comprehend.
pub mod config;
