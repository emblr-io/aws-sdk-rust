...
impl EventsDetectionJobFilter {
    /// Creates a new builder-style object to manufacture [`EventsDetectionJobFilter`](crate::types::EventsDetectionJobFilter).
    pub fn builder() -> crate::types::builders::EventsDetectionJobFilterBuilder {
        crate::types::builders::EventsDetectionJobFilterBuilder::default()
    }
}

/// A builder for [`EventsDetectionJobFilter`](crate::types::EventsDetectionJobFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct EventsDetectionJobFilterBuilder {
...
impl EventsDetectionJobFilterBuilder {
    /// <p>Filters on the name of the events detection job.</p>
    ...
    /// Consumes the builder and constructs a [`EventsDetectionJobFilter`](crate::types::EventsDetectionJobFilter).
    pub fn build(self) -> crate::types::EventsDetectionJobFilter {
        crate::types::EventsDetectionJobFilter {
