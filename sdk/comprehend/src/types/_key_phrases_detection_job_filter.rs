...
impl KeyPhrasesDetectionJobFilter {
    /// Creates a new builder-style object to manufacture [`KeyPhrasesDetectionJobFilter`](crate::types::KeyPhrasesDetectionJobFilter).
    pub fn builder() -> crate::types::builders::KeyPhrasesDetectionJobFilterBuilder {
        crate::types::builders::KeyPhrasesDetectionJobFilterBuilder::default()
    }
}
...
impl KeyPhrasesDetectionJobFilterBuilder {
    /// <p>Filters on the name of the job.</p>
    ...
    /// Consumes the builder and constructs a [`KeyPhrasesDetectionJobFilter`](crate::types::KeyPhrasesDetectionJobFilter).
    pub fn build(self) -> crate::types::KeyPhrasesDetectionJobFilter {
        crate::types::KeyPhrasesDetectionJobFilter {
