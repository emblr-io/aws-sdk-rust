...
impl EntitiesDetectionJobProperties {
    /// Creates a new builder-style object to manufacture [`EntitiesDetectionJobProperties`](crate::types::EntitiesDetectionJobProperties).
    pub fn builder() -> crate::types::builders::EntitiesDetectionJobPropertiesBuilder {
...
impl EntitiesDetectionJobPropertiesBuilder {
    /// <p>The identifier assigned to the entities detection job.</p>
