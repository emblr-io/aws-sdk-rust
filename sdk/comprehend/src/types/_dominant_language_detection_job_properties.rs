...
impl DominantLanguageDetectionJobProperties {
    /// Creates a new builder-style object to manufacture [`DominantLanguageDetectionJobProperties`](crate::types::DominantLanguageDetectionJobProperties).
    pub fn builder() -> crate::types::builders::DominantLanguageDetectionJobPropertiesBuilder {
        crate::types::builders::DominantLanguageDetectionJobPropertiesBuilder::default()
    }
}
...
impl DominantLanguageDetectionJobPropertiesBuilder {
    /// <p>The identifier assigned to the dominant language detection job.</p>
    ...
    /// Consumes the builder and constructs a [`DominantLanguageDetectionJobProperties`](crate::types::DominantLanguageDetectionJobProperties).
    pub fn build(self) -> crate::types::DominantLanguageDetectionJobProperties {
        crate::types::DominantLanguageDetectionJobProperties {
            job_id: self.job_id,
