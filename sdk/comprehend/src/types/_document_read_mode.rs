...
impl ::std::convert::From<&str> for DocumentReadMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DocumentReadMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DocumentReadMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DocumentReadMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DocumentReadMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
