...
impl ::std::convert::From<&str> for PageBasedErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PageBasedErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PageBasedErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PageBasedErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PageBasedErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
