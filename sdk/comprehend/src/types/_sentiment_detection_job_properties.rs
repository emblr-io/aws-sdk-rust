...
impl SentimentDetectionJobProperties {
    /// Creates a new builder-style object to manufacture [`SentimentDetectionJobProperties`](crate::types::SentimentDetectionJobProperties).
    pub fn builder() -> crate::types::builders::SentimentDetectionJobPropertiesBuilder {
        crate::types::builders::SentimentDetectionJobPropertiesBuilder::default()
    }
}
...
impl SentimentDetectionJobPropertiesBuilder {
    /// <p>The identifier assigned to the sentiment detection job.</p>
    ...
    /// Consumes the builder and constructs a [`SentimentDetectionJobProperties`](crate::types::SentimentDetectionJobProperties).
    pub fn build(self) -> crate::types::SentimentDetectionJobProperties {
        crate::types::SentimentDetectionJobProperties {
            job_id: self.job_id,
