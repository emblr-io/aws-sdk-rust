...
impl TopicsDetectionJobFilter {
    /// Creates a new builder-style object to manufacture [`TopicsDetectionJobFilter`](crate::types::TopicsDetectionJobFilter).
    pub fn builder() -> crate::types::builders::TopicsDetectionJobFilterBuilder {
        crate::types::builders::TopicsDetectionJobFilterBuilder::default()
    }
}

/// A builder for [`TopicsDetectionJobFilter`](crate::types::TopicsDetectionJobFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TopicsDetectionJobFilterBuilder {
...
impl TopicsDetectionJobFilterBuilder {
    /// <p></p>
    ...
    /// Consumes the builder and constructs a [`TopicsDetectionJobFilter`](crate::types::TopicsDetectionJobFilter).
    pub fn build(self) -> crate::types::TopicsDetectionJobFilter {
        crate::types::TopicsDetectionJobFilter {
