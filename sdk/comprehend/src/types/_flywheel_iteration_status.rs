...
/// When writing a match expression against `FlywheelIterationStatus`, it is important to ensure
...
///
/// ```text
/// # let flywheeliterationstatus = unimplemented!();
/// match flywheeliterationstatus {
///     FlywheelIterationStatus::Completed => { /* ... */ },
///     FlywheelIterationStatus::Evaluating => { /* ... */ },
///     FlywheelIterationStatus::Failed => { /* ... */ },
///     FlywheelIterationStatus::Stopped => { /* ... */ },
///     FlywheelIterationStatus::StopRequested => { /* ... */ },
///     FlywheelIterationStatus::Training => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `flywheeliterationstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `FlywheelIterationStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `FlywheelIterationStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `FlywheelIterationStatus::NewFeature` is defined.
/// Specifically, when `flywheeliterationstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `FlywheelIterationStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for FlywheelIterationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "STOP_REQUESTED" => FlywheelIterationStatus::StopRequested,
            "TRAINING" => FlywheelIterationStatus::Training,
            other => FlywheelIterationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl FlywheelIterationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            FlywheelIterationStatus::StopRequested => "STOP_REQUESTED",
            FlywheelIterationStatus::Training => "TRAINING",
            FlywheelIterationStatus::Unknown(value) => value.as_str(),
        }
    }
