...
impl SentimentDetectionJobFilter {
    /// Creates a new builder-style object to manufacture [`SentimentDetectionJobFilter`](crate::types::SentimentDetectionJobFilter).
    pub fn builder() -> crate::types::builders::SentimentDetectionJobFilterBuilder {
        crate::types::builders::SentimentDetectionJobFilterBuilder::default()
    }
}

/// A builder for [`SentimentDetectionJobFilter`](crate::types::SentimentDetectionJobFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SentimentDetectionJobFilterBuilder {
...
impl SentimentDetectionJobFilterBuilder {
    /// <p>Filters on the name of the job.</p>
    ...
    /// Consumes the builder and constructs a [`SentimentDetectionJobFilter`](crate::types::SentimentDetectionJobFilter).
    pub fn build(self) -> crate::types::SentimentDetectionJobFilter {
        crate::types::SentimentDetectionJobFilter {
