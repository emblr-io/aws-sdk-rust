...
impl ::std::convert::From<&str> for InvalidRequestDetailReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InvalidRequestDetailReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InvalidRequestDetailReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InvalidRequestDetailReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InvalidRequestDetailReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
