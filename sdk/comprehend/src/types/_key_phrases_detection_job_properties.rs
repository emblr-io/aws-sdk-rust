...
pub struct KeyPhrasesDetectionJobProperties {
    ...
    /// <p>The Amazon Resource Name (ARN) of the key phrases detection job. It is a unique, fully qualified identifier for the job. It includes the Amazon Web Services account, Amazon Web Services Region, and the job ID. The format of the ARN is as follows:</p>
...
impl KeyPhrasesDetectionJobProperties {
    /// Creates a new builder-style object to manufacture [`KeyPhrasesDetectionJobProperties`](crate::types::KeyPhrasesDetectionJobProperties).
    pub fn builder() -> crate::types::builders::KeyPhrasesDetectionJobPropertiesBuilder {
        crate::types::builders::KeyPhrasesDetectionJobPropertiesBuilder::default()
    }
}
...
impl KeyPhrasesDetectionJobPropertiesBuilder {
    /// <p>The identifier assigned to the key phrases detection job.</p>
    ...
    /// Consumes the builder and constructs a [`KeyPhrasesDetectionJobProperties`](crate::types::KeyPhrasesDetectionJobProperties).
    pub fn build(self) -> crate::types::KeyPhrasesDetectionJobProperties {
        crate::types::KeyPhrasesDetectionJobProperties {
            job_id: self.job_id,
