...
impl DocumentClassificationJobFilter {
    /// Creates a new builder-style object to manufacture [`DocumentClassificationJobFilter`](crate::types::DocumentClassificationJobFilter).
    pub fn builder() -> crate::types::builders::DocumentClassificationJobFilterBuilder {
        crate::types::builders::DocumentClassificationJobFilterBuilder::default()
    }
}

/// A builder for [`DocumentClassificationJobFilter`](crate::types::DocumentClassificationJobFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DocumentClassificationJobFilterBuilder {
...
impl DocumentClassificationJobFilterBuilder {
    /// <p>Filters on the name of the job.</p>
    ...
    /// Consumes the builder and constructs a [`DocumentClassificationJobFilter`](crate::types::DocumentClassificationJobFilter).
    pub fn build(self) -> crate::types::DocumentClassificationJobFilter {
        crate::types::DocumentClassificationJobFilter {
