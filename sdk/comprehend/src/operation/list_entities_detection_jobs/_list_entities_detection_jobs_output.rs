...
impl ListEntitiesDetectionJobsOutput {
    /// <p>A list containing the properties of each job that is returned.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.entities_detection_job_properties_list.is_none()`.
    pub fn entities_detection_job_properties_list(&self) -> &[crate::types::EntitiesDetectionJobProperties] {
        self.entities_detection_job_properties_list.as_deref().unwrap_or_default()
    }
    /// <p>Identifies the next page of results to return.</p>
...
impl ListEntitiesDetectionJobsOutputBuilder {
    ...
    pub fn set_entities_detection_job_properties_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::EntitiesDetectionJobProperties>>,
    ) -> Self {
        self.entities_detection_job_properties_list = input;
        self
    }
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn get_entities_detection_job_properties_list(
        &self,
