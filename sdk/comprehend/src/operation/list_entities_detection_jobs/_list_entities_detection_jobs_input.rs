...
pub struct ListEntitiesDetectionJobsInput {
    ...
    pub filter: ::std::option::Option<crate::types::EntitiesDetectionJobFilter>,
...
impl ListEntitiesDetectionJobsInput {
    /// <p>Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.</p>
    pub fn filter(&self) -> ::std::option::Option<&crate::types::EntitiesDetectionJobFilter> {
        self.filter.as_ref()
    }
    /// <p>Identifies the next page of results to return.</p>
...
impl ListEntitiesDetectionJobsInputBuilder {
    /// <p>Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.</p>
    ...
    /// <p>Filters the jobs that are returned. You can filter jobs on their name, status, or the date and time that they were submitted. You can only set one filter at a time.</p>
    pub fn get_filter(&self) -> &::std::option::Option<crate::types::EntitiesDetectionJobFilter> {
        &self.filter
    }
    /// <p>Identifies the next page of results to return.</p>
    ...
    /// Consumes the builder and constructs a [`ListEntitiesDetectionJobsInput`](crate::operation::list_entities_detection_jobs::ListEntitiesDetectionJobsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
