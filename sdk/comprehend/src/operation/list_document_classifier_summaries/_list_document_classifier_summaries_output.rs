...
impl ListDocumentClassifierSummariesOutput {
    /// <p>The list of summaries of document classifiers.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.document_classifier_summaries_list.is_none()`.
    pub fn document_classifier_summaries_list(&self) -> &[crate::types::DocumentClassifierSummary] {
        self.document_classifier_summaries_list.as_deref().unwrap_or_default()
    }
    /// <p>Identifies the next page of results to return.</p>
...
impl ::aws_types::request_id::RequestId for ListDocumentClassifierSummariesOutput {
...
impl ListDocumentClassifierSummariesOutputBuilder {
    ...
    pub fn set_document_classifier_summaries_list(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::DocumentClassifierSummary>>,
    ) -> Self {
