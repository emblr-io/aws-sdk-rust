...
pub struct BatchDetectDominantLanguageOutput {
    ...
    pub result_list: ::std::vec::Vec<crate::types::BatchDetectDominantLanguageItemResult>,
...
impl BatchDetectDominantLanguageOutput {
    /// <p>A list of objects containing the results of the operation. The results are sorted in ascending order by the <code>Index</code> field and match the order of the documents in the input list. If all of the documents contain an error, the <code>ResultList</code> is empty.</p>
    pub fn result_list(&self) -> &[crate::types::BatchDetectDominantLanguageItemResult] {
        use std::ops::Deref;
...
impl BatchDetectDominantLanguageOutputBuilder {
    ...
    /// - [`result_list`](crate::operation::batch_detect_dominant_language::builders::BatchDetectDominantLanguageOutputBuilder::result_list)
    /// - [`error_list`](crate::operation::batch_detect_dominant_language::builders::BatchDetectDominantLanguageOutputBuilder::error_list)
    pub fn build(
        self,
    ) -> ::std::result::Result<
