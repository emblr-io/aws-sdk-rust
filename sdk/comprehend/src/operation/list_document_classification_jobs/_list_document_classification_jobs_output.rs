...
impl ListDocumentClassificationJobsOutput {
    /// <p>A list containing the properties of each job returned.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.document_classification_job_properties_list.is_none()`.
    pub fn document_classification_job_properties_list(&self) -> &[crate::types::DocumentClassificationJobProperties] {
        self.document_classification_job_properties_list.as_deref().unwrap_or_default()
    }
    /// <p>Identifies the next page of results to return.</p>
...
impl ::aws_types::request_id::RequestId for ListDocumentClassificationJobsOutput {
...
impl ListDocumentClassificationJobsOutputBuilder {
