...
impl ListEventsDetectionJobsOutput {
    /// <p>A list containing the properties of each job that is returned.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.events_detection_job_properties_list.is_none()`.
    pub fn events_detection_job_properties_list(&self) -> &[crate::types::EventsDetectionJobProperties] {
        self.events_detection_job_properties_list.as_deref().unwrap_or_default()
    }
    /// <p>Identifies the next page of results to return.</p>
...
impl ::aws_types::request_id::RequestId for ListEventsDetectionJobsOutput {
...
impl ListEventsDetectionJobsOutputBuilder {
    ...
    pub fn events_detection_job_properties_list(mut self, input: crate::types::EventsDetectionJobProperties) -> Self {
        ...
        v.push(input);
        self.events_detection_job_properties_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list containing the properties of each job that is returned.</p>
    ...
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn get_events_detection_job_properties_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::EventsDetectionJobProperties>> {
