...
impl ::aws_types::request_id::RequestId for DescribeDominantLanguageDetectionJobOutput {
...
impl DescribeDominantLanguageDetectionJobOutputBuilder {
    ...
    pub fn set_dominant_language_detection_job_properties(
        mut self,
        input: ::std::option::Option<crate::types::DominantLanguageDetectionJobProperties>,
    ) -> Self {
