...
impl ListKeyPhrasesDetectionJobsOutput {
    /// <p>A list containing the properties of each job that is returned.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.key_phrases_detection_job_properties_list.is_none()`.
    pub fn key_phrases_detection_job_properties_list(&self) -> &[crate::types::KeyPhrasesDetectionJobProperties] {
        self.key_phrases_detection_job_properties_list.as_deref().unwrap_or_default()
    }
    /// <p>Identifies the next page of results to return.</p>
...
impl ListKeyPhrasesDetectionJobsOutputBuilder {
    ...
    pub fn key_phrases_detection_job_properties_list(mut self, input: crate::types::KeyPhrasesDetectionJobProperties) -> Self {
        ...
        v.push(input);
        self.key_phrases_detection_job_properties_list = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list containing the properties of each job that is returned.</p>
    ...
    /// <p>A list containing the properties of each job that is returned.</p>
    pub fn get_key_phrases_detection_job_properties_list(
        &self,
