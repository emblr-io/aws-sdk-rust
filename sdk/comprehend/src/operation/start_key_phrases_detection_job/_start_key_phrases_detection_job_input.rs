...
impl StartKeyPhrasesDetectionJobInput {
    /// Creates a new builder-style object to manufacture [`StartKeyPhrasesDetectionJobInput`](crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput).
    pub fn builder() -> crate::operation::start_key_phrases_detection_job::builders::StartKeyPhrasesDetectionJobInputBuilder {
        crate::operation::start_key_phrases_detection_job::builders::StartKeyPhrasesDetectionJobInputBuilder::default()
    }
}

/// A builder for [`StartKeyPhrasesDetectionJobInput`](crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartKeyPhrasesDetectionJobInputBuilder {
...
impl StartKeyPhrasesDetectionJobInputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartKeyPhrasesDetectionJobInput`](crate::operation::start_key_phrases_detection_job::StartKeyPhrasesDetectionJobInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
