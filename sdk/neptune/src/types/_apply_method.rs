...
impl ::std::convert::From<&str> for ApplyMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplyMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplyMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplyMethod::from(s))
    }
}
impl ApplyMethod {
...
impl ::std::convert::AsRef<str> for ApplyMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
