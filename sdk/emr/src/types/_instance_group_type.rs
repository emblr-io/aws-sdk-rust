...
/// }
/// ```
/// The above code demonstrates that when `instancegrouptype` represents
...
/// version of SDK where the variant `InstanceGroupType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for InstanceGroupType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceGroupType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceGroupType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceGroupType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceGroupType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
