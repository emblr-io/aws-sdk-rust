...
pub struct StepConfig {
    ...
    /// <ul>
    /// <li>
    /// <p><code>TERMINATE_CLUSTER</code> - Shuts down the cluster.</p></li>
    /// <li>
    /// <p><code>CANCEL_AND_WAIT</code> - Cancels any pending steps and returns the cluster to the <code>WAITING</code> state.</p></li>
    /// <li>
    /// <p><code>CONTINUE</code> - Continues to the next step in the queue.</p></li>
    /// <li>
    /// <p><code>TERMINATE_JOB_FLOW</code> - Shuts down the cluster. <code>TERMINATE_JOB_FLOW</code> is provided for backward compatibility. We recommend using <code>TERMINATE_CLUSTER</code> instead.</p></li>
    /// </ul>
