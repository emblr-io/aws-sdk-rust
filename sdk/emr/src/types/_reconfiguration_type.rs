...
impl ::std::convert::From<&str> for ReconfigurationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReconfigurationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReconfigurationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReconfigurationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReconfigurationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
