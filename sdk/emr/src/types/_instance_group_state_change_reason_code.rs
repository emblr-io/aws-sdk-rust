...
impl ::std::convert::From<&str> for InstanceGroupStateChangeReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceGroupStateChangeReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceGroupStateChangeReasonCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceGroupStateChangeReasonCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceGroupStateChangeReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
