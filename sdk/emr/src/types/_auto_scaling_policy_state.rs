...
impl ::std::convert::From<&str> for AutoScalingPolicyState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoScalingPolicyState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoScalingPolicyState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoScalingPolicyState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoScalingPolicyState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
