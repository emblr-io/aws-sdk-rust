...
impl ::std::convert::From<&str> for ActionOnFailure {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActionOnFailure::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActionOnFailure {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActionOnFailure::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActionOnFailure {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
