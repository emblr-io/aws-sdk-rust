...
pub struct InstanceFleetStatus {
    ...
    /// <ul>
    /// <li>
    /// <p><code>PROVISIONING</code>—The instance fleet is provisioning Amazon EC2 resources and is not yet ready to run jobs.</p></li>
    /// <li>
    /// <p><code>BOOTSTRAPPING</code>—Amazon EC2 instances and other resources have been provisioned and the bootstrap actions specified for the instances are underway.</p></li>
    /// <li>
    /// <p><code>RUNNING</code>—Amazon EC2 instances and other resources are running. They are either executing jobs or waiting to execute jobs.</p></li>
    /// <li>
    /// <p><code>RESIZING</code>—A resize operation is underway. Amazon EC2 instances are either being added or removed.</p></li>
    /// <li>
    /// <p><code>SUSPENDED</code>—A resize operation could not complete. Existing Amazon EC2 instances are running, but instances can't be added or removed.</p></li>
    /// <li>
    /// <p><code>TERMINATING</code>—The instance fleet is terminating Amazon EC2 instances.</p></li>
    /// <li>
    /// <p><code>TERMINATED</code>—The instance fleet is no longer active, and all Amazon EC2 instances have been terminated.</p></li>
    /// </ul>
