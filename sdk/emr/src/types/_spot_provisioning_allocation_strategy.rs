...
/// When writing a match expression against `SpotProvisioningAllocationStrategy`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `spotprovisioningallocationstrategy` represents
...
/// version of SDK where the variant `SpotProvisioningAllocationStrategy::NewFeature` is defined.
...
impl ::std::convert::From<&str> for SpotProvisioningAllocationStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpotProvisioningAllocationStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpotProvisioningAllocationStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpotProvisioningAllocationStrategy::from(s))
    }
}
