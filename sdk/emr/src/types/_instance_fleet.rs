...
/// <p>Describes an instance fleet, which is a group of Amazon EC2 instances that host a particular node type (master, core, or task) in an Amazon EMR cluster. Instance fleets can consist of a mix of instance types and On-Demand and Spot Instances, which are provisioned to meet a defined target capacity.</p><note>
...
impl InstanceFleet {
    ...
    pub fn instance_type_specifications(&self) -> &[crate::types::InstanceTypeSpecification] {
...
impl InstanceFleetBuilder {
    ...
    /// <p>An array of specifications for the instance types that comprise an instance fleet.</p>
    pub fn get_instance_type_specifications(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::InstanceTypeSpecification>> {
