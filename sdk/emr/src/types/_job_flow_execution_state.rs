...
impl ::std::convert::From<&str> for JobFlowExecutionState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobFlowExecutionState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobFlowExecutionState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobFlowExecutionState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JobFlowExecutionState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
