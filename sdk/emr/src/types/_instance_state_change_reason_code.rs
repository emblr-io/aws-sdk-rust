...
impl ::std::convert::From<&str> for InstanceStateChangeReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceStateChangeReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceStateChangeReasonCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceStateChangeReasonCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceStateChangeReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
