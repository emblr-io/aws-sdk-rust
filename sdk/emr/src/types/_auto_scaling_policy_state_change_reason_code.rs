...
/// When writing a match expression against `AutoScalingPolicyStateChangeReasonCode`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `autoscalingpolicystatechangereasoncode` represents
...
/// version of SDK where the variant `AutoScalingPolicyStateChangeReasonCode::NewFeature` is defined.
...
impl ::std::convert::From<&str> for AutoScalingPolicyStateChangeReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutoScalingPolicyStateChangeReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutoScalingPolicyStateChangeReasonCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutoScalingPolicyStateChangeReasonCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutoScalingPolicyStateChangeReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
