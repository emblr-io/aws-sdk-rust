...
/// <p>The launch specification for On-Demand and Spot Instances in the fleet.</p><note>
/// <p>The instance fleet configuration is available only in Amazon EMR releases 4.8.0 and later, excluding 5.0.x versions. On-Demand and Spot instance allocation strategies are available in Amazon EMR releases 5.12.1 and later.</p>
/// </note>
#[non_exhaustive]
...
pub struct InstanceFleetProvisioningSpecifications {
    ...
    /// <p>The launch specification for On-Demand Instances in the instance fleet, which determines the allocation strategy and capacity reservation options.</p><note>
