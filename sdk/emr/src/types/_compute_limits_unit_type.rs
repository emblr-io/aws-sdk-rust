...
impl ::std::convert::From<&str> for ComputeLimitsUnitType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ComputeLimitsUnitType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ComputeLimitsUnitType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ComputeLimitsUnitType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ComputeLimitsUnitType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
