...
impl ::std::convert::From<&str> for StepStateChangeReasonCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StepStateChangeReasonCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StepStateChangeReasonCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StepStateChangeReasonCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StepStateChangeReasonCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
