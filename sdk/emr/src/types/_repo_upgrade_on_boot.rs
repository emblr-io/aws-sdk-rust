...
impl ::std::convert::From<&str> for RepoUpgradeOnBoot {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RepoUpgradeOnBoot::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RepoUpgradeOnBoot {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RepoUpgradeOnBoot::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RepoUpgradeOnBoot {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
