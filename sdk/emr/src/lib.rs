...
//! offered by Amazon EMR. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`AddInstanceFleet`](crate::operation::add_instance_fleet) operation has
/// a [`Client::add_instance_fleet`], function which returns a builder for that operation.
