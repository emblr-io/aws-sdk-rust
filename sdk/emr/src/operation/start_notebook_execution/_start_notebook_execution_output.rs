...
impl ::aws_types::request_id::RequestId for StartNotebookExecutionOutput {
...
impl StartNotebookExecutionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartNotebookExecutionOutput`](crate::operation::start_notebook_execution::StartNotebookExecutionOutput).
    pub fn build(self) -> crate::operation::start_notebook_execution::StartNotebookExecutionOutput {
