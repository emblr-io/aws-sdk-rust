...
//! aws-sdk-controlcatalog = "0.0.0-local"
...
/// For example, the [`GetControl`](crate::operation::get_control) operation has
/// a [`Client::get_control`], function which returns a builder for that operation.
