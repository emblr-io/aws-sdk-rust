...
pub struct UpdateMatchmakingConfigurationInput {
    ...
    /// <p>Indicates whether this matchmaking configuration is being used with Amazon GameLift Servers hosting or as a standalone matchmaking solution.</p>
    /// <ul>
    /// <li>
...
impl UpdateMatchmakingConfigurationInput {
    /// Creates a new builder-style object to manufacture [`UpdateMatchmakingConfigurationInput`](crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationInput).
    pub fn builder() -> crate::operation::update_matchmaking_configuration::builders::UpdateMatchmakingConfigurationInputBuilder {
        crate::operation::update_matchmaking_configuration::builders::UpdateMatchmakingConfigurationInputBuilder::default()
    }
}

/// A builder for [`UpdateMatchmakingConfigurationInput`](crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateMatchmakingConfigurationInputBuilder {
...
impl UpdateMatchmakingConfigurationInputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateMatchmakingConfigurationInput`](crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationInput {
            name: self.name,
