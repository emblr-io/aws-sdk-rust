...
impl ::aws_types::request_id::RequestId for DescribeGameSessionsOutput {
...
/// A builder for [`DescribeGameSessionsOutput`](crate::operation::describe_game_sessions::DescribeGameSessionsOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeGameSessionsOutputBuilder {
    pub(crate) game_sessions: ::std::option::Option<::std::vec::Vec<crate::types::GameSession>>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl DescribeGameSessionsOutputBuilder {
