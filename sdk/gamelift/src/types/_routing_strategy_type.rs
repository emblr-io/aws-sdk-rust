...
impl ::std::convert::From<&str> for RoutingStrategyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RoutingStrategyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RoutingStrategyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RoutingStrategyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RoutingStrategyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
