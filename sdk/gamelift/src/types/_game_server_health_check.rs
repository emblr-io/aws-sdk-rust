...
impl ::std::convert::From<&str> for GameServerHealthCheck {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameServerHealthCheck::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameServerHealthCheck {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameServerHealthCheck::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameServerHealthCheck {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
