...
impl ::std::convert::From<&str> for PlayerSessionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlayerSessionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlayerSessionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlayerSessionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PlayerSessionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for PlayerSessionStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            PlayerSessionStatus::Active => write!(f, "ACTIVE"),
