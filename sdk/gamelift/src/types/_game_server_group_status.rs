...
impl ::std::convert::From<&str> for GameServerGroupStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameServerGroupStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameServerGroupStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameServerGroupStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameServerGroupStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
