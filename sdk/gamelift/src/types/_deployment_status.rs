...
///     DeploymentStatus::Impaired => { /* ... */ },
///     DeploymentStatus::InProgress => { /* ... */ },
///     DeploymentStatus::Pending => { /* ... */ },
///     DeploymentStatus::RollbackComplete => { /* ... */ },
///     DeploymentStatus::RollbackInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for DeploymentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "ROLLBACK_COMPLETE" => DeploymentStatus::RollbackComplete,
            "ROLLBACK_IN_PROGRESS" => DeploymentStatus::RollbackInProgress,
...
impl DeploymentStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DeploymentStatus::Impaired => "IMPAIRED",
...
impl ::std::fmt::Display for DeploymentStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            DeploymentStatus::Impaired => write!(f, "IMPAIRED"),
