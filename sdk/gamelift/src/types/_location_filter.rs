...
impl ::std::convert::From<&str> for LocationFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocationFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocationFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocationFilter::from(s))
    }
}
impl LocationFilter {
...
impl ::std::convert::AsRef<str> for LocationFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
