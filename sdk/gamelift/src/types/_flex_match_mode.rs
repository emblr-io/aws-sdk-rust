...
impl ::std::convert::From<&str> for FlexMatchMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FlexMatchMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FlexMatchMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FlexMatchMode::from(s))
    }
}
impl FlexMatchMode {
...
impl ::std::convert::AsRef<str> for FlexMatchMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
