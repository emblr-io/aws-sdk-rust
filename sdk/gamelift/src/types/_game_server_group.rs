...
pub struct GameServerGroup {
    ...
    /// <ul>
    /// <li>
    /// <p><code>NEW</code> - Amazon GameLift Servers FleetIQ has validated the <code>CreateGameServerGroup()</code> request.</p></li>
    /// <li>
    /// <p><code>ACTIVATING</code> - Amazon GameLift Servers FleetIQ is setting up a game server group, which includes creating an Auto Scaling group in your Amazon Web Services account.</p></li>
    /// <li>
    ...
    /// <li>
    /// <p><code>DELETING</code> - Amazon GameLift Servers FleetIQ has received a valid <code>DeleteGameServerGroup()</code> request and is processing it. Amazon GameLift Servers FleetIQ must first complete and release hosts before it deletes the Auto Scaling group and the game server group.</p></li>
    /// <li>
