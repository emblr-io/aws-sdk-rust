...
/// <p>Current resource capacity settings for managed EC2 fleets and managed container fleets. For multi-location fleets, location values might refer to a fleet's remote location or its home Region.</p>
...
impl FleetCapacityBuilder {
    ...
    pub fn instance_counts(mut self, input: crate::types::Ec2InstanceCounts) -> Self {
        self.instance_counts = ::std::option::Option::Some(input);
        self
    }
    /// <p>The current number of instances in the fleet, listed by instance status. Counts for pending and terminating instances might be non-zero if the fleet is adjusting to a scaling event or if access to resources is temporarily affected.</p>
    ...
    /// <p>The number and status of game server container groups deployed in a container fleet.</p>
    pub fn game_server_container_group_counts(mut self, input: crate::types::GameServerContainerGroupCounts) -> Self {
        self.game_server_container_group_counts = ::std::option::Option::Some(input);
        self
    }
    /// <p>The number and status of game server container groups deployed in a container fleet.</p>
    pub fn set_game_server_container_group_counts(mut self, input: ::std::option::Option<crate::types::GameServerContainerGroupCounts>) -> Self {
        self.game_server_container_group_counts = input;
        self
    }
    /// <p>The number and status of game server container groups deployed in a container fleet.</p>
