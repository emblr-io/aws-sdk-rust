...
impl ::std::convert::From<&str> for GameServerProtectionPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameServerProtectionPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameServerProtectionPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameServerProtectionPolicy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameServerProtectionPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
