...
impl ::std::convert::From<&str> for PlayerSessionCreationPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlayerSessionCreationPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlayerSessionCreationPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlayerSessionCreationPolicy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PlayerSessionCreationPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
