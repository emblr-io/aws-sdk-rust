...
impl ::std::convert::From<&str> for GameSessionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameSessionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameSessionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameSessionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameSessionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
