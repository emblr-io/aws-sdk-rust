...
pub struct GameSessionPlacement {
    ...
    /// <li>
    /// <p><b>FAILED</b> -- Amazon GameLift Servers is not able to complete the process of placing the game session. Common reasons are the game session terminated before the placement process was completed, or an unexpected internal error.</p></li>
    /// </ul>
...
pub struct GameSessionPlacementBuilder {
    ...
    pub(crate) priority_configuration_override: ::std::option::Option<crate::types::PriorityConfigurationOverride>,
}
impl GameSessionPlacementBuilder {
    ...
    pub fn build(self) -> crate::types::GameSessionPlacement {
        crate::types::GameSessionPlacement {
            ...
            priority_configuration_override: self.priority_configuration_override,
        }
    }
}
