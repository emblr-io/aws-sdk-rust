...
impl ::std::convert::From<&str> for GameServerClaimStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameServerClaimStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameServerClaimStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameServerClaimStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameServerClaimStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
