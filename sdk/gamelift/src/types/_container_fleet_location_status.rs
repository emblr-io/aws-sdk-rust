...
/// When writing a match expression against `ContainerFleetLocationStatus`, it is important to ensure
...
///
/// ```text
/// # let containerfleetlocationstatus = unimplemented!();
/// match containerfleetlocationstatus {
///     ContainerFleetLocationStatus::Activating => { /* ... */ },
///     ContainerFleetLocationStatus::Active => { /* ... */ },
...
/// }
/// ```
/// The above code demonstrates that when `containerfleetlocationstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ContainerFleetLocationStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ContainerFleetLocationStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ContainerFleetLocationStatus::NewFeature` is defined.
/// Specifically, when `containerfleetlocationstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ContainerFleetLocationStatus::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ContainerFleetLocationStatus {
    #[allow(missing_docs)] // documentation missing in model
    Activating,
    #[allow(missing_docs)] // documentation missing in model
    Active,
...
impl ::std::convert::From<&str> for ContainerFleetLocationStatus {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ContainerFleetLocationStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContainerFleetLocationStatus::from(s))
    }
}
impl ContainerFleetLocationStatus {
    /// Returns the `&str` value of the enum member.
    pub fn as_str(&self) -> &str {
        match self {
            ContainerFleetLocationStatus::Activating => "ACTIVATING",
            ContainerFleetLocationStatus::Active => "ACTIVE",
...
impl ::std::fmt::Display for ContainerFleetLocationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ContainerFleetLocationStatus::Activating => write!(f, "ACTIVATING"),
            ContainerFleetLocationStatus::Active => write!(f, "ACTIVE"),
