...
impl ::std::convert::From<&str> for IpProtocol {
    fn from(s: &str) -> Self {
        match s {
            "TCP" => IpProtocol::Tcp,
            "UDP" => IpProtocol::Udp,
            other => IpProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpProtocol::from(s))
    }
}
impl IpProtocol {
...
impl ::std::convert::AsRef<str> for IpProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
