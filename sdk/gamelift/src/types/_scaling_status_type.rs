...
impl ::std::convert::From<&str> for ScalingStatusType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScalingStatusType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScalingStatusType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScalingStatusType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScalingStatusType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
