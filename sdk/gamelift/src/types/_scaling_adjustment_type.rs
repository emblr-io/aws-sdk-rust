...
impl ::std::convert::From<&str> for ScalingAdjustmentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScalingAdjustmentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScalingAdjustmentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScalingAdjustmentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScalingAdjustmentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
