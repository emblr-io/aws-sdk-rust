...
pub enum InstanceRoleCredentialsProvider {
    #[allow(missing_docs)] // documentation missing in model
...
impl ::std::convert::From<&str> for InstanceRoleCredentialsProvider {
    fn from(s: &str) -> Self {
        match s {
            "SHARED_CREDENTIAL_FILE" => InstanceRoleCredentialsProvider::SharedCredentialFile,
            other => InstanceRoleCredentialsProvider::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceRoleCredentialsProvider {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceRoleCredentialsProvider::from(s))
    }
}
impl InstanceRoleCredentialsProvider {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            InstanceRoleCredentialsProvider::SharedCredentialFile => "SHARED_CREDENTIAL_FILE",
            InstanceRoleCredentialsProvider::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for InstanceRoleCredentialsProvider {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
