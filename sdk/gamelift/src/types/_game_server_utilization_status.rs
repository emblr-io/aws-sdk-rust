...
impl ::std::convert::From<&str> for GameServerUtilizationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameServerUtilizationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameServerUtilizationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameServerUtilizationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameServerUtilizationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
