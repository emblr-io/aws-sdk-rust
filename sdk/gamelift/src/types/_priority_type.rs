...
impl ::std::convert::From<&str> for PriorityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PriorityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PriorityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PriorityType::from(s))
    }
}
impl PriorityType {
...
impl ::std::convert::AsRef<str> for PriorityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
