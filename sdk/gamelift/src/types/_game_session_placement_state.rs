...
impl ::std::convert::From<&str> for GameSessionPlacementState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameSessionPlacementState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameSessionPlacementState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameSessionPlacementState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameSessionPlacementState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
