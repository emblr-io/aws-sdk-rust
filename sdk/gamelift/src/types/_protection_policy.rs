...
impl ::std::convert::From<&str> for ProtectionPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProtectionPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProtectionPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProtectionPolicy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProtectionPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
