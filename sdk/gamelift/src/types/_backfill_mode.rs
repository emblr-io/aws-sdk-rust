...
impl ::std::convert::From<&str> for BackfillMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BackfillMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BackfillMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BackfillMode::from(s))
    }
}
impl BackfillMode {
...
impl ::std::convert::AsRef<str> for BackfillMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
