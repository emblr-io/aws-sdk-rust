...
impl ::std::convert::From<&str> for FleetAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetAction::from(s))
    }
}
impl FleetAction {
...
impl ::std::convert::AsRef<str> for FleetAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
