...
impl ::std::convert::From<&str> for GameServerGroupDeleteOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GameServerGroupDeleteOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GameServerGroupDeleteOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GameServerGroupDeleteOption::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GameServerGroupDeleteOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
