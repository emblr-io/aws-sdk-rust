...
impl ::std::convert::From<&str> for LocationUpdateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocationUpdateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocationUpdateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocationUpdateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocationUpdateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for LocationUpdateStatus {
