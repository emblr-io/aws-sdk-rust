...
impl ::aws_types::request_id::RequestId for RejectGrantOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl RejectGrantOutput {
    /// Creates a new builder-style object to manufacture [`RejectGrantOutput`](crate::operation::reject_grant::RejectGrantOutput).
    pub fn builder() -> crate::operation::reject_grant::builders::RejectGrantOutputBuilder {
        crate::operation::reject_grant::builders::RejectGrantOutputBuilder::default()
    }
}

/// A builder for [`RejectGrantOutput`](crate::operation::reject_grant::RejectGrantOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RejectGrantOutputBuilder {
...
impl RejectGrantOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`RejectGrantOutput`](crate::operation::reject_grant::RejectGrantOutput).
    pub fn build(self) -> crate::operation::reject_grant::RejectGrantOutput {
