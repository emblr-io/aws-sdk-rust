...
impl ListLicensesInput {
    /// Creates a new builder-style object to manufacture [`ListLicensesInput`](crate::operation::list_licenses::ListLicensesInput).
    pub fn builder() -> crate::operation::list_licenses::builders::ListLicensesInputBuilder {
        crate::operation::list_licenses::builders::ListLicensesInputBuilder::default()
    }
}
