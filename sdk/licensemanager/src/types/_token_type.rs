...
impl ::std::convert::From<&str> for TokenType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TokenType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TokenType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TokenType::from(s))
    }
}
impl TokenType {
...
impl ::std::convert::AsRef<str> for TokenType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TokenType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            TokenType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
