...
impl ::std::convert::From<&str> for LicenseConversionTaskStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LicenseConversionTaskStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LicenseConversionTaskStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LicenseConversionTaskStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LicenseConversionTaskStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
