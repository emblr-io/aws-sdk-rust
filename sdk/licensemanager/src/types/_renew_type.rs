...
impl ::std::convert::From<&str> for RenewType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RenewType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RenewType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RenewType::from(s))
    }
}
impl RenewType {
...
impl ::std::convert::AsRef<str> for RenewType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
