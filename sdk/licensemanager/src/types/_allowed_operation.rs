...
impl ::std::convert::From<&str> for AllowedOperation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AllowedOperation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AllowedOperation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllowedOperation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AllowedOperation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
