...
impl ::std::convert::From<&str> for LicenseStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LicenseStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LicenseStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LicenseStatus::from(s))
    }
}
impl LicenseStatus {
...
impl ::std::convert::AsRef<str> for LicenseStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
