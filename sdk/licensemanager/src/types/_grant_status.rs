...
impl ::std::convert::From<&str> for GrantStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GrantStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GrantStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GrantStatus::from(s))
    }
}
impl GrantStatus {
...
impl ::std::convert::AsRef<str> for GrantStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
