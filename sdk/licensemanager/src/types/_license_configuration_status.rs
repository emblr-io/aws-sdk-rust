...
impl ::std::convert::From<&str> for LicenseConfigurationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LicenseConfigurationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LicenseConfigurationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LicenseConfigurationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LicenseConfigurationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
