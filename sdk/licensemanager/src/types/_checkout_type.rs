...
impl ::std::convert::From<&str> for CheckoutType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CheckoutType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CheckoutType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CheckoutType::from(s))
    }
}
impl CheckoutType {
...
impl ::std::convert::AsRef<str> for CheckoutType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
