...
impl ::std::convert::From<&str> for DigitalSignatureMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DigitalSignatureMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DigitalSignatureMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DigitalSignatureMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DigitalSignatureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DigitalSignatureMethod {
