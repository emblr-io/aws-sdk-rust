...
impl ::std::convert::From<&str> for LicenseDeletionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LicenseDeletionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LicenseDeletionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LicenseDeletionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LicenseDeletionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
