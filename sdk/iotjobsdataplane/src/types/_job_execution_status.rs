...
impl ::std::convert::From<&str> for JobExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobExecutionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JobExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
