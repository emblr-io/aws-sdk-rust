...
pub struct BandwidthRateLimitInterval {
    ...
    /// <p>This field is required for S3 File Gateway, and the minimum value is <code>104857600</code>.</p>
    /// </note>
    pub average_upload_rate_limit_in_bits_per_sec: ::std::option::Option<i64>,
    /// <p>The average download rate limit component of the bandwidth rate limit interval, in bits per second. This field does not appear in the response if the download rate limit is not set.</p><note>
