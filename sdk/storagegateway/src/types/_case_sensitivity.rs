...
impl ::std::convert::From<&str> for CaseSensitivity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CaseSensitivity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CaseSensitivity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CaseSensitivity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CaseSensitivity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
