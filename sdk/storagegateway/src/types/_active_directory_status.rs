...
impl ::std::convert::From<&str> for ActiveDirectoryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ActiveDirectoryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ActiveDirectoryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ActiveDirectoryStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ActiveDirectoryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
