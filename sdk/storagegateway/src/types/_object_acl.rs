...
impl ::std::convert::From<&str> for ObjectAcl {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ObjectAcl::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ObjectAcl {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ObjectAcl::from(s))
    }
}
impl ObjectAcl {
...
impl ::std::convert::AsRef<str> for ObjectAcl {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
