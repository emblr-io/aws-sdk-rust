...
impl ::std::convert::From<&str> for EncryptionType {
    fn from(s: &str) -> Self {
        match s {
            "DsseKms" => EncryptionType::DsseKms,
            "SseKms" => EncryptionType::SseKms,
            "SseS3" => EncryptionType::SseS3,
...
impl EncryptionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EncryptionType::DsseKms => "DsseKms",
            EncryptionType::SseKms => "SseKms",
            EncryptionType::SseS3 => "SseS3",
            EncryptionType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["DsseKms", "SseKms", "SseS3"]
    }
}
