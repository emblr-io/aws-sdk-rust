...
impl ::std::convert::From<&str> for RetentionLockType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RetentionLockType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RetentionLockType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RetentionLockType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RetentionLockType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
