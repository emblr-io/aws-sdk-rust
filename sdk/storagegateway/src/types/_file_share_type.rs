...
impl ::std::convert::From<&str> for FileShareType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FileShareType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FileShareType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FileShareType::from(s))
    }
}
impl FileShareType {
...
impl ::std::convert::AsRef<str> for FileShareType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
