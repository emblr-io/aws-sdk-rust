...
impl ::std::convert::From<&str> for GatewayCapacity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GatewayCapacity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GatewayCapacity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GatewayCapacity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GatewayCapacity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
