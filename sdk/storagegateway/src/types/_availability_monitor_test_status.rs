...
impl ::std::convert::From<&str> for AvailabilityMonitorTestStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AvailabilityMonitorTestStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AvailabilityMonitorTestStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AvailabilityMonitorTestStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AvailabilityMonitorTestStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
