...
impl ::aws_types::request_id::RequestId for UpdateSmbLocalGroupsOutput {
...
impl UpdateSmbLocalGroupsOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the gateway. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateSmbLocalGroupsOutput`](crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsOutput).
    pub fn build(self) -> crate::operation::update_smb_local_groups::UpdateSmbLocalGroupsOutput {
