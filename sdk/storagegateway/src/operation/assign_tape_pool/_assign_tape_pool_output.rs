...
impl ::aws_types::request_id::RequestId for AssignTapePoolOutput {
...
impl AssignTapePoolOutput {
    ...
    pub fn builder() -> crate::operation::assign_tape_pool::builders::AssignTapePoolOutputBuilder {
        crate::operation::assign_tape_pool::builders::AssignTapePoolOutputBuilder::default()
    }
}

/// A builder for [`AssignTapePoolOutput`](crate::operation::assign_tape_pool::AssignTapePoolOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AssignTapePoolOutputBuilder {
    pub(crate) tape_arn: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl AssignTapePoolOutputBuilder {
    /// <p>The unique Amazon Resource Names (ARN) of the virtual tape that was added to the tape pool.</p>
