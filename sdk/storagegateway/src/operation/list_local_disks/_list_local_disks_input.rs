...
impl ListLocalDisksInput {
    /// Creates a new builder-style object to manufacture [`ListLocalDisksInput`](crate::operation::list_local_disks::ListLocalDisksInput).
    pub fn builder() -> crate::operation::list_local_disks::builders::ListLocalDisksInputBuilder {
        crate::operation::list_local_disks::builders::ListLocalDisksInputBuilder::default()
    }
}
...
impl ListLocalDisksInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_local_disks::ListLocalDisksInput, ::aws_smithy_types::error::operation::BuildError> {
