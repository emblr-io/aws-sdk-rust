...
pub struct DescribeChapCredentialsOutput {
    ...
    /// <ul>
    /// <li>
    /// <p><b>InitiatorName</b>: The iSCSI initiator that connects to the target.</p></li>
    /// <li>
    /// <p><b>SecretToAuthenticateInitiator</b>: The secret key that the initiator (for example, the Windows client) must provide to participate in mutual CHAP with the target.</p></li>
    /// <li>
    /// <p><b>SecretToAuthenticateTarget</b>: The secret key that the target must provide to participate in mutual CHAP with the initiator (e.g. Windows client).</p></li>
    /// <li>
