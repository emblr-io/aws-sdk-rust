...
impl ::std::convert::From<&str> for NotificationSeverityLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NotificationSeverityLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NotificationSeverityLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NotificationSeverityLevel::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NotificationSeverityLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
