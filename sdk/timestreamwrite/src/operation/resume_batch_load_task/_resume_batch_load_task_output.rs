...
impl ResumeBatchLoadTaskOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ResumeBatchLoadTaskOutput`](crate::operation::resume_batch_load_task::ResumeBatchLoadTaskOutput).
    pub fn build(self) -> crate::operation::resume_batch_load_task::ResumeBatchLoadTaskOutput {
