...
impl ::aws_types::request_id::RequestId for ListDatabasesOutput {
...
pub struct ListDatabasesOutputBuilder {
    pub(crate) databases: ::std::option::Option<::std::vec::Vec<crate::types::Database>>,
...
impl ListDatabasesOutputBuilder {
    ...
    ///
    /// <p>A list of database names.</p>
    pub fn databases(mut self, input: crate::types::Database) -> Self {
    ...
    /// <p>A list of database names.</p>
    pub fn set_databases(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Database>>) -> Self {
        self.databases = input;
        self
    }
    /// <p>A list of database names.</p>
    pub fn get_databases(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Database>> {
        &self.databases
    }
    /// <p>The pagination token. This parameter is returned when the response is truncated.</p>
