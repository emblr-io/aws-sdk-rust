...
impl ::std::convert::From<&str> for SupportDataSetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SupportDataSetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SupportDataSetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SupportDataSetType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SupportDataSetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
