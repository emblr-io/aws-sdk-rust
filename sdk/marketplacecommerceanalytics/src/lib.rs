...
//! offered by AWS Marketplace Commerce Analytics. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Marketplace Commerce Analytics.
...
/// For example, the [`GenerateDataSet`](crate::operation::generate_data_set) operation has
/// a [`Client::generate_data_set`], function which returns a builder for that operation.
...
/// Configuration for AWS Marketplace Commerce Analytics.
pub mod config;
