...
impl ::aws_types::request_id::RequestId for GetExperimentTemplateOutput {
...
impl GetExperimentTemplateOutputBuilder {
    /// <p>Information about the experiment template.</p>
    ...
    /// Consumes the builder and constructs a [`GetExperimentTemplateOutput`](crate::operation::get_experiment_template::GetExperimentTemplateOutput).
    pub fn build(self) -> crate::operation::get_experiment_template::GetExperimentTemplateOutput {
