...
impl DeleteTargetAccountConfigurationInput {
    /// Creates a new builder-style object to manufacture [`DeleteTargetAccountConfigurationInput`](crate::operation::delete_target_account_configuration::DeleteTargetAccountConfigurationInput).
    pub fn builder() -> crate::operation::delete_target_account_configuration::builders::DeleteTargetAccountConfigurationInputBuilder {
        crate::operation::delete_target_account_configuration::builders::DeleteTargetAccountConfigurationInputBuilder::default()
    }
}

/// A builder for [`DeleteTargetAccountConfigurationInput`](crate::operation::delete_target_account_configuration::DeleteTargetAccountConfigurationInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteTargetAccountConfigurationInputBuilder {
