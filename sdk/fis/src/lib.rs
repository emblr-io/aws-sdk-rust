...
//! offered by AWS Fault Injection Simulator. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Fault Injection Simulator.
...
/// For example, the [`CreateExperimentTemplate`](crate::operation::create_experiment_template) operation has
...
/// Configuration for AWS Fault Injection Simulator.
pub mod config;
