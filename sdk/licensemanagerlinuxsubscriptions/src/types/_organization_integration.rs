...
impl ::std::convert::From<&str> for OrganizationIntegration {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OrganizationIntegration::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OrganizationIntegration {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OrganizationIntegration::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OrganizationIntegration {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
