...
//! aws-sdk-ssmguiconnect = "0.0.0-local"
...
//! offered by AWS SSM-GUIConnect. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS SSM-GUIConnect.
...
/// let config = aws_sdk_ssmguiconnect::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`DeleteConnectionRecordingPreferences`](crate::operation::delete_connection_recording_preferences) operation has
/// a [`Client::delete_connection_recording_preferences`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.delete_connection_recording_preferences()
...
/// Configuration for AWS SSM-GUIConnect.
pub mod config;
