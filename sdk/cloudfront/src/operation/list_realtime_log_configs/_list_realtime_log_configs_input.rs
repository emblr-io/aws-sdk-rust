...
/// A builder for [`ListRealtimeLogConfigsInput`](crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListRealtimeLogConfigsInputBuilder {
    pub(crate) max_items: ::std::option::Option<i32>,
    pub(crate) marker: ::std::option::Option<::std::string::String>,
}
impl ListRealtimeLogConfigsInputBuilder {
    /// <p>The maximum number of real-time log configurations that you want in the response.</p>
    ...
    > {
        ::std::result::Result::Ok(crate::operation::list_realtime_log_configs::ListRealtimeLogConfigsInput {
