...
impl ::std::convert::From<&str> for ResponseHeadersPolicyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResponseHeadersPolicyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResponseHeadersPolicyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResponseHeadersPolicyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResponseHeadersPolicyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
