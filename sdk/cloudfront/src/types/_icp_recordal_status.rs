...
impl ::std::convert::From<&str> for IcpRecordalStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IcpRecordalStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IcpRecordalStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IcpRecordalStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IcpRecordalStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
