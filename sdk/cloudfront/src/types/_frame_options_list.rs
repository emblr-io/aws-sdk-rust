...
impl ::std::convert::From<&str> for FrameOptionsList {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FrameOptionsList::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FrameOptionsList {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FrameOptionsList::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FrameOptionsList {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
