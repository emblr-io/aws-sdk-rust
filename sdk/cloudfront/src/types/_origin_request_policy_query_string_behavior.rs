...
impl ::std::convert::From<&str> for OriginRequestPolicyQueryStringBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OriginRequestPolicyQueryStringBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OriginRequestPolicyQueryStringBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OriginRequestPolicyQueryStringBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OriginRequestPolicyQueryStringBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
