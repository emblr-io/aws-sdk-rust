...
impl ::std::convert::From<&str> for GeoRestrictionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GeoRestrictionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GeoRestrictionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GeoRestrictionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for GeoRestrictionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
