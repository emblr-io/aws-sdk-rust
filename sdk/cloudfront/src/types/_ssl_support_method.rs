...
impl ::std::convert::From<&str> for SslSupportMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SslSupportMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SslSupportMethod {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SslSupportMethod::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SslSupportMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
