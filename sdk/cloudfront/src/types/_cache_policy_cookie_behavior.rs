...
impl ::std::convert::From<&str> for CachePolicyCookieBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CachePolicyCookieBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CachePolicyCookieBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CachePolicyCookieBehavior::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CachePolicyCookieBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
