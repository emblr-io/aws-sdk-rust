...
impl ::std::convert::From<&str> for CertificateTransparencyLoggingPreference {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CertificateTransparencyLoggingPreference::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CertificateTransparencyLoggingPreference {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CertificateTransparencyLoggingPreference::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CertificateTransparencyLoggingPreference {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
