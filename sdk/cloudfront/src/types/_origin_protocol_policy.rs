...
impl ::std::convert::From<&str> for OriginProtocolPolicy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OriginProtocolPolicy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OriginProtocolPolicy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OriginProtocolPolicy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OriginProtocolPolicy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
