...
impl ::std::convert::From<&str> for CachePolicyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CachePolicyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CachePolicyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CachePolicyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CachePolicyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
