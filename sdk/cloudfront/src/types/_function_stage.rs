...
impl ::std::convert::From<&str> for FunctionStage {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FunctionStage::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FunctionStage {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FunctionStage::from(s))
    }
}
impl FunctionStage {
...
impl ::std::convert::AsRef<str> for FunctionStage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
