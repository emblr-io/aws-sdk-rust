...
impl ::std::convert::From<&str> for CertificateSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CertificateSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CertificateSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CertificateSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CertificateSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
