...
impl ::std::convert::From<&str> for SslProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SslProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SslProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SslProtocol::from(s))
    }
}
impl SslProtocol {
...
impl ::std::convert::AsRef<str> for SslProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
