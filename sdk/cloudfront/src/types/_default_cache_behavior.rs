...
impl DefaultCacheBehavior {
    /// Creates a new builder-style object to manufacture [`DefaultCacheBehavior`](crate::types::DefaultCacheBehavior).
    pub fn builder() -> crate::types::builders::DefaultCacheBehaviorBuilder {
        crate::types::builders::DefaultCacheBehaviorBuilder::default()
    }
}
