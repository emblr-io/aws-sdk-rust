...
impl ::std::convert::From<&str> for RealtimeMetricsSubscriptionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RealtimeMetricsSubscriptionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RealtimeMetricsSubscriptionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RealtimeMetricsSubscriptionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RealtimeMetricsSubscriptionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
