...
pub struct ParametersInCacheKeyAndForwardedToOrigin {
    ...
    /// <ul>
    /// <li>
    /// <p>Normalizes the value of the viewer's <code>Accept-Encoding</code> header</p></li>
    /// <li>
    /// <p>Includes the normalized header in the cache key</p></li>
    /// <li>
    /// <p>Includes the normalized header in the request to the origin, if a request is necessary</p></li>
    /// </ul>
