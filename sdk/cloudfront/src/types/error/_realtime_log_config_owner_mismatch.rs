...
impl ::std::fmt::Display for RealtimeLogConfigOwnerMismatch {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "RealtimeLogConfigOwnerMismatch")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::RealtimeLogConfigOwnerMismatch {
...
impl RealtimeLogConfigOwnerMismatch {
    ...
    pub fn builder() -> crate::types::error::builders::RealtimeLogConfigOwnerMismatchBuilder {
        crate::types::error::builders::RealtimeLogConfigOwnerMismatchBuilder::default()
    }
}

/// A builder for [`RealtimeLogConfigOwnerMismatch`](crate::types::error::RealtimeLogConfigOwnerMismatch).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RealtimeLogConfigOwnerMismatchBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl RealtimeLogConfigOwnerMismatchBuilder {
    #[allow(missing_docs)] // documentation missing in model
