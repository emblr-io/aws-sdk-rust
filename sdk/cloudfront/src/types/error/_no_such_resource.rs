...
impl ::aws_types::request_id::RequestId for crate::types::error::NoSuchResource {
...
impl NoSuchResourceBuilder {
    ...
    pub fn build(self) -> crate::types::error::NoSuchResource {
        crate::types::error::NoSuchResource {
