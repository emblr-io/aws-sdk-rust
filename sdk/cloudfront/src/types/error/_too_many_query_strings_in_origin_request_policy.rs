...
impl ::std::fmt::Display for TooManyQueryStringsInOriginRequestPolicy {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "TooManyQueryStringsInOriginRequestPolicy")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::TooManyQueryStringsInOriginRequestPolicy {
