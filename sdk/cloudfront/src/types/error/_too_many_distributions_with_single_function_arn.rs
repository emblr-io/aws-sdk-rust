...
impl ::aws_types::request_id::RequestId for crate::types::error::TooManyDistributionsWithSingleFunctionArn {
...
impl TooManyDistributionsWithSingleFunctionArnBuilder {
    ...
    /// Consumes the builder and constructs a [`TooManyDistributionsWithSingleFunctionArn`](crate::types::error::TooManyDistributionsWithSingleFunctionArn).
    pub fn build(self) -> crate::types::error::TooManyDistributionsWithSingleFunctionArn {
