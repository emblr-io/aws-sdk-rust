...
impl ::std::fmt::Display for TooManyRemoveHeadersInResponseHeadersPolicy {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "TooManyRemoveHeadersInResponseHeadersPolicy")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::TooManyRemoveHeadersInResponseHeadersPolicy {
