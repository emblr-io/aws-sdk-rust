...
impl ::std::fmt::Display for InvalidDomainNameForOriginAccessControl {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "InvalidDomainNameForOriginAccessControl")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidDomainNameForOriginAccessControl {
...
impl InvalidDomainNameForOriginAccessControlBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`InvalidDomainNameForOriginAccessControl`](crate::types::error::InvalidDomainNameForOriginAccessControl).
    pub fn build(self) -> crate::types::error::InvalidDomainNameForOriginAccessControl {
