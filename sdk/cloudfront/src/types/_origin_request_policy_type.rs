...
impl ::std::convert::From<&str> for OriginRequestPolicyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OriginRequestPolicyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OriginRequestPolicyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OriginRequestPolicyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OriginRequestPolicyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
