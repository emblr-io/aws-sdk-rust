...
impl ::std::convert::From<&str> for ItemSelection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ItemSelection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ItemSelection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ItemSelection::from(s))
    }
}
impl ItemSelection {
...
impl ::std::convert::AsRef<str> for ItemSelection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
