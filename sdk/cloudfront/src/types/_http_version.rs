...
impl ::std::convert::From<&str> for HttpVersion {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HttpVersion::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HttpVersion {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HttpVersion::from(s))
    }
}
impl HttpVersion {
...
impl ::std::convert::AsRef<str> for HttpVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
