...
///     IngestionJobStatus::Stopped => { /* ... */ },
///     IngestionJobStatus::Stopping => { /* ... */ },
...
impl ::std::convert::From<&str> for IngestionJobStatus {
    fn from(s: &str) -> Self {
        match s {
            "COMPLETE" => IngestionJobStatus::Complete,
            "FAILED" => IngestionJobStatus::Failed,
            "IN_PROGRESS" => IngestionJobStatus::InProgress,
            "STARTING" => IngestionJobStatus::Starting,
            "STOPPED" => IngestionJobStatus::Stopped,
            "STOPPING" => IngestionJobStatus::Stopping,
            other => IngestionJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IngestionJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IngestionJobStatus::from(s))
    }
}
impl IngestionJobStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            IngestionJobStatus::Stopped => "STOPPED",
            IngestionJobStatus::Stopping => "STOPPING",
...
impl ::std::convert::AsRef<str> for IngestionJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
