...
impl MongoDbAtlasFieldMapping {
    /// Creates a new builder-style object to manufacture [`MongoDbAtlasFieldMapping`](crate::types::MongoDbAtlasFieldMapping).
    pub fn builder() -> crate::types::builders::MongoDbAtlasFieldMappingBuilder {
        crate::types::builders::MongoDbAtlasFieldMappingBuilder::default()
    }
}
...
impl MongoDbAtlasFieldMappingBuilder {
    /// <p>The name of the field in which Amazon Bedrock stores the vector embeddings for your data sources.</p>
    ...
    /// Consumes the builder and constructs a [`MongoDbAtlasFieldMapping`](crate::types::MongoDbAtlasFieldMapping).
    /// This method will fail if any of the following fields are not set:
    /// - [`vector_field`](crate::types::builders::MongoDbAtlasFieldMappingBuilder::vector_field)
    /// - [`text_field`](crate::types::builders::MongoDbAtlasFieldMappingBuilder::text_field)
    /// - [`metadata_field`](crate::types::builders::MongoDbAtlasFieldMappingBuilder::metadata_field)
    pub fn build(self) -> ::std::result::Result<crate::types::MongoDbAtlasFieldMapping, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::MongoDbAtlasFieldMapping {
            vector_field: self.vector_field.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "vector_field",
                    "vector_field was not specified but it is required when building MongoDbAtlasFieldMapping",
                )
            })?,
            text_field: self.text_field.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "text_field",
                    "text_field was not specified but it is required when building MongoDbAtlasFieldMapping",
                )
            })?,
            metadata_field: self.metadata_field.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "metadata_field",
                    "metadata_field was not specified but it is required when building MongoDbAtlasFieldMapping",
                )
            })?,
        })
    }
