...
/// When writing a match expression against `AgentAliasStatus`, it is important to ensure
...
///
/// ```text
/// # let agentaliasstatus = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `agentaliasstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `AgentAliasStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `AgentAliasStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `AgentAliasStatus::NewFeature` is defined.
/// Specifically, when `agentaliasstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AgentAliasStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AgentAliasStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AgentAliasStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AgentAliasStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AgentAliasStatus::from(s))
    }
}
impl AgentAliasStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AgentAliasStatus::Unknown(value) => value.as_str(),
        }
    }
