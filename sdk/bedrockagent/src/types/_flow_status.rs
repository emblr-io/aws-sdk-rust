...
impl ::std::convert::From<&str> for FlowStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "NotPrepared" => FlowStatus::NotPrepared,
            "Prepared" => FlowStatus::Prepared,
            "Preparing" => FlowStatus::Preparing,
            other => FlowStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FlowStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FlowStatus::from(s))
    }
}
impl FlowStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            FlowStatus::NotPrepared => "NotPrepared",
            FlowStatus::Prepared => "Prepared",
            FlowStatus::Preparing => "Preparing",
            FlowStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["Failed", "NotPrepared", "Prepared", "Preparing"]
    }
}
impl ::std::convert::AsRef<str> for FlowStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
