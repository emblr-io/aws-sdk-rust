...
//! offered by Agents for Amazon Bedrock. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Agents for Amazon Bedrock.
...
/// Configuration for Agents for Amazon Bedrock.
pub mod config;
