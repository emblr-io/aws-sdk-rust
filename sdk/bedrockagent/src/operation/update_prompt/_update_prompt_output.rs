...
impl ::std::fmt::Debug for UpdatePromptOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdatePromptOutput");
...
impl UpdatePromptOutputBuilder {
    ...
    /// - [`name`](crate::operation::update_prompt::builders::UpdatePromptOutputBuilder::name)
    /// - [`id`](crate::operation::update_prompt::builders::UpdatePromptOutputBuilder::id)
    /// - [`arn`](crate::operation::update_prompt::builders::UpdatePromptOutputBuilder::arn)
    /// - [`version`](crate::operation::update_prompt::builders::UpdatePromptOutputBuilder::version)
    /// - [`created_at`](crate::operation::update_prompt::builders::UpdatePromptOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::update_prompt::builders::UpdatePromptOutputBuilder::updated_at)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_prompt::UpdatePromptOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_prompt::UpdatePromptOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdatePromptOutput",
                )
            })?,
            ...
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building UpdatePromptOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building UpdatePromptOutput",
                )
            })?,
            version: self.version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version",
                    "version was not specified but it is required when building UpdatePromptOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building UpdatePromptOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building UpdatePromptOutput",
                )
            })?,
...
impl ::std::fmt::Debug for UpdatePromptOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdatePromptOutputBuilder");
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
        formatter.field("customer_encryption_key_arn", &self.customer_encryption_key_arn);
        formatter.field("default_variant", &self.default_variant);
