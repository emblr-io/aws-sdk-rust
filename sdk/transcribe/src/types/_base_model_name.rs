...
impl ::std::convert::From<&str> for BaseModelName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BaseModelName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BaseModelName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BaseModelName::from(s))
    }
}
impl BaseModelName {
...
impl ::std::convert::AsRef<str> for BaseModelName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
