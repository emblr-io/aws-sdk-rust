...
impl ::std::convert::From<&str> for SubtitleFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SubtitleFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubtitleFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubtitleFormat::from(s))
    }
}
impl SubtitleFormat {
...
impl ::std::convert::AsRef<str> for SubtitleFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
