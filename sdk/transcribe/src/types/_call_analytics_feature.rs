...
impl ::std::convert::From<&str> for CallAnalyticsFeature {
    fn from(s: &str) -> Self {
        match s {
            "GENERATIVE_SUMMARIZATION" => CallAnalyticsFeature::GenerativeSummarization,
            other => CallAnalyticsFeature::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CallAnalyticsFeature {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CallAnalyticsFeature::from(s))
    }
}
impl CallAnalyticsFeature {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CallAnalyticsFeature::GenerativeSummarization => "GENERATIVE_SUMMARIZATION",
            CallAnalyticsFeature::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for CallAnalyticsFeature {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for CallAnalyticsFeature {
