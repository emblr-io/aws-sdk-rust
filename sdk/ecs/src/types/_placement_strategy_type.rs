...
impl ::std::convert::From<&str> for PlacementStrategyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlacementStrategyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlacementStrategyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlacementStrategyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PlacementStrategyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
