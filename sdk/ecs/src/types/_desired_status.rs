...
impl ::std::convert::From<&str> for DesiredStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DesiredStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DesiredStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DesiredStatus::from(s))
    }
}
impl DesiredStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DesiredStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for DesiredStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
