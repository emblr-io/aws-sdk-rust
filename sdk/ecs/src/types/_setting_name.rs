...
impl ::std::convert::From<&str> for SettingName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SettingName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SettingName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SettingName::from(s))
    }
}
impl SettingName {
...
impl ::std::convert::AsRef<str> for SettingName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
