...
#[non_exhaustive]
pub struct ServiceManagedEbsVolumeConfigurationBuilder {
...
impl ServiceManagedEbsVolumeConfigurationBuilder {
    /// <p>Indicates whether the volume should be encrypted. If you turn on Region-level Amazon EBS encryption by default but set this value as <code>false</code>, the setting is overridden and the volume is encrypted with the KMS key specified for Amazon EBS encryption by default. This parameter maps 1:1 with the <code>Encrypted</code> parameter of the <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html">CreateVolume API</a> in the <i>Amazon EC2 API Reference</i>.</p>
    ...
    /// Consumes the builder and constructs a [`ServiceManagedEbsVolumeConfiguration`](crate::types::ServiceManagedEbsVolumeConfiguration).
    /// This method will fail if any of the following fields are not set:
    /// - [`role_arn`](crate::types::builders::ServiceManagedEbsVolumeConfigurationBuilder::role_arn)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::ServiceManagedEbsVolumeConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ServiceManagedEbsVolumeConfiguration {
            ...
            role_arn: self.role_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "role_arn",
                    "role_arn was not specified but it is required when building ServiceManagedEbsVolumeConfiguration",
                )
            })?,
