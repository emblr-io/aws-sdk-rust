...
impl ::std::convert::From<&str> for TransportProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TransportProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TransportProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TransportProtocol::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TransportProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
