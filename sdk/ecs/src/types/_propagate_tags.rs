...
impl ::std::convert::From<&str> for PropagateTags {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PropagateTags::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PropagateTags {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PropagateTags::from(s))
    }
}
impl PropagateTags {
...
impl ::std::convert::AsRef<str> for PropagateTags {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
