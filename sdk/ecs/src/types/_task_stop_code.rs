...
impl ::std::convert::From<&str> for TaskStopCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TaskStopCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TaskStopCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TaskStopCode::from(s))
    }
}
impl TaskStopCode {
...
impl ::std::convert::AsRef<str> for TaskStopCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
