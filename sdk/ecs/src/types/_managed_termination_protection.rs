...
impl ::std::convert::From<&str> for ManagedTerminationProtection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ManagedTerminationProtection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ManagedTerminationProtection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ManagedTerminationProtection::from(s))
    }
}
impl ManagedTerminationProtection {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ManagedTerminationProtection::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ManagedTerminationProtection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
