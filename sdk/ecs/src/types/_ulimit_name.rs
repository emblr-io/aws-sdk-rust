...
impl ::std::convert::From<&str> for UlimitName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UlimitName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UlimitName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UlimitName::from(s))
    }
}
impl UlimitName {
...
impl ::std::convert::AsRef<str> for UlimitName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
