...
impl ListTaskDefinitionsOutput {
    /// <p>The list of task definition Amazon Resource Name (ARN) entries for the <code>ListTaskDefinitions</code> request.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.task_definition_arns.is_none()`.
    pub fn task_definition_arns(&self) -> &[::std::string::String] {
        self.task_definition_arns.as_deref().unwrap_or_default()
    }
    /// <p>The <code>nextToken</code> value to include in a future <code>ListTaskDefinitions</code> request. When the results of a <code>ListTaskDefinitions</code> request exceed <code>maxResults</code>, this value can be used to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
...
impl ListTaskDefinitionsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListTaskDefinitionsOutput`](crate::operation::list_task_definitions::ListTaskDefinitionsOutput).
    pub fn build(self) -> crate::operation::list_task_definitions::ListTaskDefinitionsOutput {
