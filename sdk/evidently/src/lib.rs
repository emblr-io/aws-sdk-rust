...
//! offered by Amazon CloudWatch Evidently. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon CloudWatch Evidently.
...
/// Configuration for Amazon CloudWatch Evidently.
pub mod config;
