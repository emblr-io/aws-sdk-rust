...
impl ::std::convert::From<&str> for ExperimentResultResponseType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExperimentResultResponseType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExperimentResultResponseType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExperimentResultResponseType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExperimentResultResponseType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
