...
impl ::std::convert::From<&str> for FeatureStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeatureStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeatureStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeatureStatus::from(s))
    }
}
impl FeatureStatus {
...
impl ::std::convert::AsRef<str> for FeatureStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FeatureStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FeatureStatus::Available => write!(f, "AVAILABLE"),
            FeatureStatus::Updating => write!(f, "UPDATING"),
