...
impl ::std::convert::From<&str> for ExperimentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExperimentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExperimentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExperimentStatus::from(s))
    }
}
