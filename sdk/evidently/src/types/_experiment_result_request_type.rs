...
impl ::std::convert::From<&str> for ExperimentResultRequestType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExperimentResultRequestType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExperimentResultRequestType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExperimentResultRequestType::from(s))
    }
}
