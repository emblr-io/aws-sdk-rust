...
impl ::std::convert::From<&str> for ChangeDirectionEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChangeDirectionEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChangeDirectionEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChangeDirectionEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChangeDirectionEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
