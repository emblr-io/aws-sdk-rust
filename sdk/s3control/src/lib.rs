...
//! offered by AWS S3 Control. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS S3 Control.
...
/// Configuration for AWS S3 Control.
pub mod config;
