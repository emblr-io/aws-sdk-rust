...
impl ::std::convert::From<&str> for AsyncOperationName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AsyncOperationName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AsyncOperationName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AsyncOperationName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AsyncOperationName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
