...
pub struct DeleteAccessPointScopeInput {
...
/// A builder for [`DeleteAccessPointScopeInput`](crate::operation::delete_access_point_scope::DeleteAccessPointScopeInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteAccessPointScopeInputBuilder {
    pub(crate) account_id: ::std::option::Option<::std::string::String>,
    pub(crate) name: ::std::option::Option<::std::string::String>,
}
impl DeleteAccessPointScopeInputBuilder {
    /// <p>The Amazon Web Services account ID that owns the access point with the scope that you want to delete.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteAccessPointScopeInput`](crate::operation::delete_access_point_scope::DeleteAccessPointScopeInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::delete_access_point_scope::DeleteAccessPointScopeInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::delete_access_point_scope::DeleteAccessPointScopeInput {
