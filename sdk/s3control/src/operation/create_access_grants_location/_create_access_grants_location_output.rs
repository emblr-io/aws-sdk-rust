...
impl CreateAccessGrantsLocationOutput {
    ...
    pub fn builder() -> crate::operation::create_access_grants_location::builders::CreateAccessGrantsLocationOutputBuilder {
        crate::operation::create_access_grants_location::builders::CreateAccessGrantsLocationOutputBuilder::default()
    }
}

/// A builder for [`CreateAccessGrantsLocationOutput`](crate::operation::create_access_grants_location::CreateAccessGrantsLocationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateAccessGrantsLocationOutputBuilder {
