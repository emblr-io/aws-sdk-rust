...
impl DeleteStorageLensGroupOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteStorageLensGroupOutput`](crate::operation::delete_storage_lens_group::DeleteStorageLensGroupOutput).
    pub fn build(self) -> crate::operation::delete_storage_lens_group::DeleteStorageLensGroupOutput {
