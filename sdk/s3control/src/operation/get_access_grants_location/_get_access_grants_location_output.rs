...
pub struct GetAccessGrantsLocationOutput {
...
impl ::aws_types::request_id::RequestId for GetAccessGrantsLocationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetAccessGrantsLocationOutput {
    /// Creates a new builder-style object to manufacture [`GetAccessGrantsLocationOutput`](crate::operation::get_access_grants_location::GetAccessGrantsLocationOutput).
    pub fn builder() -> crate::operation::get_access_grants_location::builders::GetAccessGrantsLocationOutputBuilder {
        crate::operation::get_access_grants_location::builders::GetAccessGrantsLocationOutputBuilder::default()
    }
}

/// A builder for [`GetAccessGrantsLocationOutput`](crate::operation::get_access_grants_location::GetAccessGrantsLocationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetAccessGrantsLocationOutputBuilder {
...
impl GetAccessGrantsLocationOutputBuilder {
    /// <p>The date and time when you registered the location.</p>
    ...
    /// Consumes the builder and constructs a [`GetAccessGrantsLocationOutput`](crate::operation::get_access_grants_location::GetAccessGrantsLocationOutput).
    pub fn build(self) -> crate::operation::get_access_grants_location::GetAccessGrantsLocationOutput {
