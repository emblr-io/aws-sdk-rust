...
impl CreateTestCaseOutputBuilder {
    ...
    /// - [`test_case_id`](crate::operation::create_test_case::builders::CreateTestCaseOutputBuilder::test_case_id)
    /// - [`test_case_version`](crate::operation::create_test_case::builders::CreateTestCaseOutputBuilder::test_case_version)
    pub fn build(
        self,
