...
pub struct ListTestRunStepsInput {
...
impl ListTestRunStepsInput {
    /// Creates a new builder-style object to manufacture [`ListTestRunStepsInput`](crate::operation::list_test_run_steps::ListTestRunStepsInput).
    pub fn builder() -> crate::operation::list_test_run_steps::builders::ListTestRunStepsInputBuilder {
        crate::operation::list_test_run_steps::builders::ListTestRunStepsInputBuilder::default()
    }
}
...
impl ListTestRunStepsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListTestRunStepsInput`](crate::operation::list_test_run_steps::ListTestRunStepsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_test_run_steps::ListTestRunStepsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_test_run_steps::ListTestRunStepsInput {
