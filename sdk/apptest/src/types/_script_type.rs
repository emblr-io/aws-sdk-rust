...
impl ::std::convert::From<&str> for ScriptType {
    fn from(s: &str) -> Self {
        match s {
            "Selenium" => ScriptType::Selenium,
            other => ScriptType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScriptType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScriptType::from(s))
    }
}
impl ScriptType {
...
impl ::std::convert::AsRef<str> for ScriptType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ScriptType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ScriptType::Selenium => write!(f, "Selenium"),
