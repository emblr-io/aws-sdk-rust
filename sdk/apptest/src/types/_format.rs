...
impl ::std::convert::From<&str> for Format {
    fn from(s: &str) -> Self {
        match s {
            "FIXED" => Format::Fixed,
            "LINE_SEQUENTIAL" => Format::LineSequential,
...
impl Format {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Format::Fixed => "FIXED",
            Format::LineSequential => "LINE_SEQUENTIAL",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["FIXED", "LINE_SEQUENTIAL", "VARIABLE"]
    }
}
...
impl ::std::fmt::Display for Format {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Format::Fixed => write!(f, "FIXED"),
            Format::LineSequential => write!(f, "LINE_SEQUENTIAL"),
            Format::Variable => write!(f, "VARIABLE"),
