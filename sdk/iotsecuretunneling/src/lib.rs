...
//! aws-sdk-iotsecuretunneling = "0.0.0-local"
...
//! offered by AWS IoT Secure Tunneling. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS IoT Secure Tunneling.
...
/// For example, the [`CloseTunnel`](crate::operation::close_tunnel) operation has
...
/// Configuration for AWS IoT Secure Tunneling.
pub mod config;
