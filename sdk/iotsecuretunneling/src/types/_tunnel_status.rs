...
impl ::std::convert::From<&str> for TunnelStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TunnelStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TunnelStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TunnelStatus::from(s))
    }
}
impl TunnelStatus {
...
impl ::std::convert::AsRef<str> for TunnelStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
