...
impl ::std::convert::From<&str> for ClientMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientMode::from(s))
    }
}
impl ClientMode {
...
impl ::std::convert::AsRef<str> for ClientMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
