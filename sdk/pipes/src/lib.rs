...
//! offered by Amazon EventBridge Pipes. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon EventBridge Pipes.
...
/// Configuration for Amazon EventBridge Pipes.
pub mod config;
