...
impl ::std::convert::From<&str> for OnPartialBatchItemFailureStreams {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OnPartialBatchItemFailureStreams::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OnPartialBatchItemFailureStreams {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OnPartialBatchItemFailureStreams::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OnPartialBatchItemFailureStreams {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for OnPartialBatchItemFailureStreams {
