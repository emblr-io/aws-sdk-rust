...
impl ::std::convert::From<&str> for PipeTargetInvocationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PipeTargetInvocationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PipeTargetInvocationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PipeTargetInvocationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PipeTargetInvocationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
