...
impl ::std::convert::From<&str> for BatchResourceRequirementType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchResourceRequirementType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchResourceRequirementType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchResourceRequirementType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchResourceRequirementType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
