...
impl EcsEnvironmentFile {
    /// Creates a new builder-style object to manufacture [`EcsEnvironmentFile`](crate::types::EcsEnvironmentFile).
    pub fn builder() -> crate::types::builders::EcsEnvironmentFileBuilder {
        crate::types::builders::EcsEnvironmentFileBuilder::default()
    }
}
