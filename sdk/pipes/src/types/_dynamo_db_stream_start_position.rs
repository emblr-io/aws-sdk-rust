...
impl ::std::convert::From<&str> for DynamoDbStreamStartPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DynamoDbStreamStartPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DynamoDbStreamStartPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DynamoDbStreamStartPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DynamoDbStreamStartPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
