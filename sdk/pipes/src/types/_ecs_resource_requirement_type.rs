...
impl ::std::convert::From<&str> for EcsResourceRequirementType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EcsResourceRequirementType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EcsResourceRequirementType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EcsResourceRequirementType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EcsResourceRequirementType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
