...
impl ::std::convert::From<&str> for MskStartPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MskStartPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MskStartPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MskStartPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MskStartPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
