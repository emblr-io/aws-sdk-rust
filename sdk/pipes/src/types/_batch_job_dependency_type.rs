...
impl ::std::convert::From<&str> for BatchJobDependencyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchJobDependencyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchJobDependencyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchJobDependencyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchJobDependencyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
