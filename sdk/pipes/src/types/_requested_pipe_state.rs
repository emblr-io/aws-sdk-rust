...
impl ::std::convert::From<&str> for RequestedPipeState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RequestedPipeState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RequestedPipeState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RequestedPipeState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RequestedPipeState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RequestedPipeState {
