...
impl S3LogDestinationParameters {
    /// Creates a new builder-style object to manufacture [`S3LogDestinationParameters`](crate::types::S3LogDestinationParameters).
    pub fn builder() -> crate::types::builders::S3LogDestinationParametersBuilder {
        crate::types::builders::S3LogDestinationParametersBuilder::default()
    }
}
...
impl S3LogDestinationParametersBuilder {
    ...
    /// Consumes the builder and constructs a [`S3LogDestinationParameters`](crate::types::S3LogDestinationParameters).
