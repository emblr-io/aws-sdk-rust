...
impl ::std::convert::From<&str> for EcsEnvironmentFileType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EcsEnvironmentFileType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EcsEnvironmentFileType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EcsEnvironmentFileType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EcsEnvironmentFileType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EcsEnvironmentFileType {
