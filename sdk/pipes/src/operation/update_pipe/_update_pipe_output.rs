...
impl ::aws_types::request_id::RequestId for UpdatePipeOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdatePipeOutput {
    /// Creates a new builder-style object to manufacture [`UpdatePipeOutput`](crate::operation::update_pipe::UpdatePipeOutput).
    pub fn builder() -> crate::operation::update_pipe::builders::UpdatePipeOutputBuilder {
        crate::operation::update_pipe::builders::UpdatePipeOutputBuilder::default()
    }
}

/// A builder for [`UpdatePipeOutput`](crate::operation::update_pipe::UpdatePipeOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdatePipeOutputBuilder {
...
impl UpdatePipeOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdatePipeOutput`](crate::operation::update_pipe::UpdatePipeOutput).
    pub fn build(self) -> crate::operation::update_pipe::UpdatePipeOutput {
