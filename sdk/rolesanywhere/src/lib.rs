...
//! offered by IAM Roles Anywhere. The return value of each of these methods is a "fluent builder",
...
/// For example, the [`CreateProfile`](crate::operation::create_profile) operation has
/// a [`Client::create_profile`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.create_profile()
///     .name("example")
///     .send()
///     .await;
/// ```
