...
impl ::std::convert::From<&str> for ClientDeviceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientDeviceType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientDeviceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientDeviceType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientDeviceType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
