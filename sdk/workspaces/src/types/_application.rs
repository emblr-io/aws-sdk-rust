...
impl ::std::convert::From<&str> for Application {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Application::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Application {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Application::from(s))
    }
}
impl Application {
...
impl ::std::convert::AsRef<str> for Application {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
