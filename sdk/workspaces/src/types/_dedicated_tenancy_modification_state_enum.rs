...
impl ::std::convert::From<&str> for DedicatedTenancyModificationStateEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DedicatedTenancyModificationStateEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DedicatedTenancyModificationStateEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DedicatedTenancyModificationStateEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DedicatedTenancyModificationStateEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
