...
impl ::std::convert::From<&str> for AccessPropertyValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessPropertyValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccessPropertyValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccessPropertyValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccessPropertyValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
