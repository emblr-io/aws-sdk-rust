...
impl ::std::convert::From<&str> for TargetWorkspaceState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetWorkspaceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetWorkspaceState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetWorkspaceState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TargetWorkspaceState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
