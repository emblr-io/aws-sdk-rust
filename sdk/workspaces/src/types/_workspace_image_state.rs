...
impl ::std::convert::From<&str> for WorkspaceImageState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkspaceImageState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkspaceImageState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkspaceImageState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkspaceImageState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
