...
impl ::std::convert::From<&str> for DedicatedTenancySupportEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DedicatedTenancySupportEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DedicatedTenancySupportEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DedicatedTenancySupportEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DedicatedTenancySupportEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DedicatedTenancySupportEnum {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DedicatedTenancySupportEnum::Enabled => write!(f, "ENABLED"),
            DedicatedTenancySupportEnum::Unknown(value) => write!(f, "{}", value),
        }
    }
}
