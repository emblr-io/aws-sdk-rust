...
impl ::std::convert::From<&str> for BundleType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BundleType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BundleType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BundleType::from(s))
    }
}
impl BundleType {
...
impl ::std::convert::AsRef<str> for BundleType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
