...
impl ::std::convert::From<&str> for ReconnectEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReconnectEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReconnectEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReconnectEnum::from(s))
    }
}
impl ReconnectEnum {
...
impl ::std::convert::AsRef<str> for ReconnectEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
