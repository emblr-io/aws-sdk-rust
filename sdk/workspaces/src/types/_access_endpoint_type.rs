...
///     AccessEndpointType::StreamingWsp => { /* ... */ },
...
impl ::std::convert::From<&str> for AccessEndpointType {
    fn from(s: &str) -> Self {
        match s {
            "STREAMING_WSP" => AccessEndpointType::StreamingWsp,
            other => AccessEndpointType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccessEndpointType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccessEndpointType::from(s))
    }
}
impl AccessEndpointType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AccessEndpointType::StreamingWsp => "STREAMING_WSP",
...
impl ::std::convert::AsRef<str> for AccessEndpointType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AccessEndpointType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AccessEndpointType::StreamingWsp => write!(f, "STREAMING_WSP"),
