...
impl ::std::convert::From<&str> for DedicatedTenancySupportResultEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DedicatedTenancySupportResultEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DedicatedTenancySupportResultEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DedicatedTenancySupportResultEnum::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DedicatedTenancySupportResultEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
