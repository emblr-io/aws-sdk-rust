...
impl ::std::convert::From<&str> for StandbyWorkspaceRelationshipType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StandbyWorkspaceRelationshipType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StandbyWorkspaceRelationshipType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StandbyWorkspaceRelationshipType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StandbyWorkspaceRelationshipType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
