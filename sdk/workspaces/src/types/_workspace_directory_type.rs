...
///     WorkspaceDirectoryType::AwsIamIdentityCenter => { /* ... */ },
...
impl ::std::convert::From<&str> for WorkspaceDirectoryType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "AWS_IAM_IDENTITY_CENTER" => WorkspaceDirectoryType::AwsIamIdentityCenter,
...
impl ::std::str::FromStr for WorkspaceDirectoryType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkspaceDirectoryType::from(s))
    }
}
impl WorkspaceDirectoryType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            WorkspaceDirectoryType::AwsIamIdentityCenter => "AWS_IAM_IDENTITY_CENTER",
