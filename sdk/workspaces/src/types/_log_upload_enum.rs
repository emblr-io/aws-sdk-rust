...
impl ::std::convert::From<&str> for LogUploadEnum {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LogUploadEnum::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogUploadEnum {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogUploadEnum::from(s))
    }
}
impl LogUploadEnum {
...
impl ::std::convert::AsRef<str> for LogUploadEnum {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
