...
impl ::std::convert::From<&str> for WorkspaceBundleState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkspaceBundleState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkspaceBundleState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkspaceBundleState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkspaceBundleState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
