...
impl ::std::convert::From<&str> for WorkspaceImageRequiredTenancy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkspaceImageRequiredTenancy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkspaceImageRequiredTenancy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkspaceImageRequiredTenancy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkspaceImageRequiredTenancy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
