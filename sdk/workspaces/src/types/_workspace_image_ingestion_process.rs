...
impl ::std::convert::From<&str> for WorkspaceImageIngestionProcess {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkspaceImageIngestionProcess::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkspaceImageIngestionProcess {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkspaceImageIngestionProcess::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkspaceImageIngestionProcess {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
