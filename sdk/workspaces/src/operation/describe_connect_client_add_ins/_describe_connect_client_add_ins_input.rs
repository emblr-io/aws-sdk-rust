...
impl DescribeConnectClientAddInsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeConnectClientAddInsInput`](crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
