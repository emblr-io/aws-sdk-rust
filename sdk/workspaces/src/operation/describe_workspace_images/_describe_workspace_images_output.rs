...
impl DescribeWorkspaceImagesOutput {
    ...
    pub fn images(&self) -> &[crate::types::WorkspaceImage] {
...
impl ::aws_types::request_id::RequestId for DescribeWorkspaceImagesOutput {
...
impl DescribeWorkspaceImagesOutputBuilder {
    ...
    /// <p>Information about the images.</p>
    pub fn get_images(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::WorkspaceImage>> {
        &self.images
    }
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return.</p>
