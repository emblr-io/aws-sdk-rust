...
impl ::std::convert::From<&str> for SpeechMarkType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SpeechMarkType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SpeechMarkType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpeechMarkType::from(s))
    }
}
impl SpeechMarkType {
...
impl ::std::convert::AsRef<str> for SpeechMarkType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
