...
//! offered by Amazon Pinpoint. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Pinpoint.
...
/// Configuration for Amazon Pinpoint.
pub mod config;
