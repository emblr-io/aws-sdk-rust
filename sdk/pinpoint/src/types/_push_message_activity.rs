...
pub struct PushMessageActivity {
    ...
    pub message_config: ::std::option::Option<crate::types::JourneyPushMessage>,
...
impl PushMessageActivity {
    /// <p>Specifies the time to live (TTL) value for push notifications that are sent to participants in a journey.</p>
    pub fn message_config(&self) -> ::std::option::Option<&crate::types::JourneyPushMessage> {
...
impl PushMessageActivity {
    /// Creates a new builder-style object to manufacture [`PushMessageActivity`](crate::types::PushMessageActivity).
    pub fn builder() -> crate::types::builders::PushMessageActivityBuilder {
        crate::types::builders::PushMessageActivityBuilder::default()
    }
}

/// A builder for [`PushMessageActivity`](crate::types::PushMessageActivity).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PushMessageActivityBuilder {
    pub(crate) message_config: ::std::option::Option<crate::types::JourneyPushMessage>,
...
impl PushMessageActivityBuilder {
    /// <p>Specifies the time to live (TTL) value for push notifications that are sent to participants in a journey.</p>
    pub fn message_config(mut self, input: crate::types::JourneyPushMessage) -> Self {
        self.message_config = ::std::option::Option::Some(input);
        self
    }
    /// <p>Specifies the time to live (TTL) value for push notifications that are sent to participants in a journey.</p>
    pub fn set_message_config(mut self, input: ::std::option::Option<crate::types::JourneyPushMessage>) -> Self {
    ...
    pub fn build(self) -> crate::types::PushMessageActivity {
        crate::types::PushMessageActivity {
