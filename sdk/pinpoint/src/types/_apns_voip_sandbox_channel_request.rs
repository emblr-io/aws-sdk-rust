...
impl ApnsVoipSandboxChannelRequest {
    /// Creates a new builder-style object to manufacture [`ApnsVoipSandboxChannelRequest`](crate::types::ApnsVoipSandboxChannelRequest).
    pub fn builder() -> crate::types::builders::ApnsVoipSandboxChannelRequestBuilder {
        crate::types::builders::ApnsVoipSandboxChannelRequestBuilder::default()
    }
}
...
impl ApnsVoipSandboxChannelRequestBuilder {
    /// <p>The bundle identifier that's assigned to your iOS app. This identifier is used for APNs tokens.</p>
    ...
    pub fn token_key(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.token_key = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The authentication key to use for APNs tokens.</p>
    ...
    pub fn token_key_id(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.token_key_id = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The key identifier that's assigned to your APNs signing key, if you want Amazon Pinpoint to communicate with the APNs sandbox environment by using APNs tokens.</p>
    ...
    /// Consumes the builder and constructs a [`ApnsVoipSandboxChannelRequest`](crate::types::ApnsVoipSandboxChannelRequest).
    pub fn build(self) -> crate::types::ApnsVoipSandboxChannelRequest {
        crate::types::ApnsVoipSandboxChannelRequest {
