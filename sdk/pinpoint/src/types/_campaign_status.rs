...
impl ::std::convert::From<&str> for CampaignStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CampaignStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CampaignStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CampaignStatus::from(s))
    }
}
impl CampaignStatus {
...
impl ::std::convert::AsRef<str> for CampaignStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
