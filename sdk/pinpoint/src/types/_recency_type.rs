...
impl ::std::convert::From<&str> for RecencyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecencyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecencyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecencyType::from(s))
    }
}
impl RecencyType {
...
impl ::std::convert::AsRef<str> for RecencyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
