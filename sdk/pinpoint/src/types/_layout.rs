...
impl ::std::convert::From<&str> for Layout {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Layout::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Layout {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Layout::from(s))
    }
}
impl Layout {
...
impl ::std::convert::AsRef<str> for Layout {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
