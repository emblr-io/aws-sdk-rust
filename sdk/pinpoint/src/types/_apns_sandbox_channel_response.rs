...
impl ApnsSandboxChannelResponse {
    /// Creates a new builder-style object to manufacture [`ApnsSandboxChannelResponse`](crate::types::ApnsSandboxChannelResponse).
    pub fn builder() -> crate::types::builders::ApnsSandboxChannelResponseBuilder {
        crate::types::builders::ApnsSandboxChannelResponseBuilder::default()
    }
}
...
impl ApnsSandboxChannelResponseBuilder {
    /// <p>The unique identifier for the application that the APNs sandbox channel applies to.</p>
    ...
    /// Consumes the builder and constructs a [`ApnsSandboxChannelResponse`](crate::types::ApnsSandboxChannelResponse).
    pub fn build(self) -> crate::types::ApnsSandboxChannelResponse {
        crate::types::ApnsSandboxChannelResponse {
