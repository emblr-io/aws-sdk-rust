...
impl ::std::convert::From<&str> for Alignment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Alignment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Alignment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Alignment::from(s))
    }
}
impl Alignment {
...
impl ::std::convert::AsRef<str> for Alignment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
