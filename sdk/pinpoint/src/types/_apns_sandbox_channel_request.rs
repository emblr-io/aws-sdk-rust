...
impl ApnsSandboxChannelRequest {
    /// Creates a new builder-style object to manufacture [`ApnsSandboxChannelRequest`](crate::types::ApnsSandboxChannelRequest).
    pub fn builder() -> crate::types::builders::ApnsSandboxChannelRequestBuilder {
        crate::types::builders::ApnsSandboxChannelRequestBuilder::default()
    }
}
...
impl ApnsSandboxChannelRequestBuilder {
    /// <p>The bundle identifier that's assigned to your iOS app. This identifier is used for APNs tokens.</p>
