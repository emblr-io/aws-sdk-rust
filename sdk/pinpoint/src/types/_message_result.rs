...
pub struct MessageResult {
    ...
    /// <li>
    /// <p>OPT_OUT - The user who's associated with the endpoint address has opted out of receiving messages from you. Amazon Pinpoint won't attempt to send the message again.</p></li>
    /// <li>
    /// <p>PERMANENT_FAILURE - An error occurred when delivering the message to the endpoint address. Amazon Pinpoint won't attempt to send the message again.</p></li>
    /// <li>
    /// <p>SUCCESSFUL - The message was successfully delivered to the endpoint address.</p></li>
    /// <li>
