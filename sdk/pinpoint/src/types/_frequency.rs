...
impl ::std::convert::From<&str> for Frequency {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Frequency::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Frequency {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Frequency::from(s))
    }
}
impl Frequency {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["DAILY", "EVENT", "HOURLY", "IN_APP_EVENT", "MONTHLY", "ONCE", "WEEKLY"]
    }
}
impl ::std::convert::AsRef<str> for Frequency {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
