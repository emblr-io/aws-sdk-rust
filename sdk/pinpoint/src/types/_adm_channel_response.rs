...
impl AdmChannelResponse {
    /// Creates a new builder-style object to manufacture [`AdmChannelResponse`](crate::types::AdmChannelResponse).
    pub fn builder() -> crate::types::builders::AdmChannelResponseBuilder {
        crate::types::builders::AdmChannelResponseBuilder::default()
    }
}

/// A builder for [`AdmChannelResponse`](crate::types::AdmChannelResponse).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AdmChannelResponseBuilder {
...
impl AdmChannelResponseBuilder {
    /// <p>The unique identifier for the application that the ADM channel applies to.</p>
