...
impl CreateRecommenderConfigurationShape {
    /// Creates a new builder-style object to manufacture [`CreateRecommenderConfigurationShape`](crate::types::CreateRecommenderConfigurationShape).
    pub fn builder() -> crate::types::builders::CreateRecommenderConfigurationShapeBuilder {
        crate::types::builders::CreateRecommenderConfigurationShapeBuilder::default()
    }
}

/// A builder for [`CreateRecommenderConfigurationShape`](crate::types::CreateRecommenderConfigurationShape).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateRecommenderConfigurationShapeBuilder {
...
impl CreateRecommenderConfigurationShapeBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateRecommenderConfigurationShape`](crate::types::CreateRecommenderConfigurationShape).
    pub fn build(self) -> crate::types::CreateRecommenderConfigurationShape {
        crate::types::CreateRecommenderConfigurationShape {
