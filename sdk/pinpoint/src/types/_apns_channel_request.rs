...
impl ApnsChannelRequest {
    /// Creates a new builder-style object to manufacture [`ApnsChannelRequest`](crate::types::ApnsChannelRequest).
    pub fn builder() -> crate::types::builders::ApnsChannelRequestBuilder {
        crate::types::builders::ApnsChannelRequestBuilder::default()
    }
}
...
impl ApnsChannelRequestBuilder {
    /// <p>The bundle identifier that's assigned to your iOS app. This identifier is used for APNs tokens.</p>
    ...
    /// Consumes the builder and constructs a [`ApnsChannelRequest`](crate::types::ApnsChannelRequest).
    pub fn build(self) -> crate::types::ApnsChannelRequest {
        crate::types::ApnsChannelRequest {
