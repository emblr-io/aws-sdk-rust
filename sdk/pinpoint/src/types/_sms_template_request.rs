...
impl SmsTemplateRequest {
    /// Creates a new builder-style object to manufacture [`SmsTemplateRequest`](crate::types::SmsTemplateRequest).
    pub fn builder() -> crate::types::builders::SmsTemplateRequestBuilder {
        crate::types::builders::SmsTemplateRequestBuilder::default()
    }
}

/// A builder for [`SmsTemplateRequest`](crate::types::SmsTemplateRequest).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SmsTemplateRequestBuilder {
