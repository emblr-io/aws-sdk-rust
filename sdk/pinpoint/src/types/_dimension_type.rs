...
impl ::std::convert::From<&str> for DimensionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DimensionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DimensionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DimensionType::from(s))
    }
}
impl DimensionType {
...
impl ::std::convert::AsRef<str> for DimensionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
