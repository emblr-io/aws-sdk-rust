...
impl ::std::convert::From<&str> for ButtonAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ButtonAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ButtonAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ButtonAction::from(s))
    }
}
impl ButtonAction {
...
impl ::std::convert::AsRef<str> for ButtonAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
