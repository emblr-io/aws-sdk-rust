...
impl EndpointMessageResult {
    /// Creates a new builder-style object to manufacture [`EndpointMessageResult`](crate::types::EndpointMessageResult).
    pub fn builder() -> crate::types::builders::EndpointMessageResultBuilder {
        crate::types::builders::EndpointMessageResultBuilder::default()
    }
}
