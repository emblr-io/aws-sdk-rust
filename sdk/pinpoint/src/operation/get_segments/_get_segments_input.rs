...
impl GetSegmentsInput {
    /// Creates a new builder-style object to manufacture [`GetSegmentsInput`](crate::operation::get_segments::GetSegmentsInput).
    pub fn builder() -> crate::operation::get_segments::builders::GetSegmentsInputBuilder {
        crate::operation::get_segments::builders::GetSegmentsInputBuilder::default()
    }
}

/// A builder for [`GetSegmentsInput`](crate::operation::get_segments::GetSegmentsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetSegmentsInputBuilder {
