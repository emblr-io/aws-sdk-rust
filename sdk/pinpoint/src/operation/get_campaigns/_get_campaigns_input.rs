...
impl GetCampaignsInput {
    /// Creates a new builder-style object to manufacture [`GetCampaignsInput`](crate::operation::get_campaigns::GetCampaignsInput).
    pub fn builder() -> crate::operation::get_campaigns::builders::GetCampaignsInputBuilder {
        crate::operation::get_campaigns::builders::GetCampaignsInputBuilder::default()
    }
}

/// A builder for [`GetCampaignsInput`](crate::operation::get_campaigns::GetCampaignsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetCampaignsInputBuilder {
