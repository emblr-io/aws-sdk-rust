...
impl GetVoiceTemplateInput {
    /// Creates a new builder-style object to manufacture [`GetVoiceTemplateInput`](crate::operation::get_voice_template::GetVoiceTemplateInput).
    pub fn builder() -> crate::operation::get_voice_template::builders::GetVoiceTemplateInputBuilder {
        crate::operation::get_voice_template::builders::GetVoiceTemplateInputBuilder::default()
    }
}

/// A builder for [`GetVoiceTemplateInput`](crate::operation::get_voice_template::GetVoiceTemplateInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetVoiceTemplateInputBuilder {
    pub(crate) template_name: ::std::option::Option<::std::string::String>,
    pub(crate) version: ::std::option::Option<::std::string::String>,
}
impl GetVoiceTemplateInputBuilder {
    /// <p>The name of the message template. A template name must start with an alphanumeric character and can contain a maximum of 128 characters. The characters can be alphanumeric characters, underscores (_), or hyphens (-). Template names are case sensitive.</p>
