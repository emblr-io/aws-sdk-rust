...
impl GetSmsTemplateInput {
    /// Creates a new builder-style object to manufacture [`GetSmsTemplateInput`](crate::operation::get_sms_template::GetSmsTemplateInput).
    pub fn builder() -> crate::operation::get_sms_template::builders::GetSmsTemplateInputBuilder {
        crate::operation::get_sms_template::builders::GetSmsTemplateInputBuilder::default()
    }
}
