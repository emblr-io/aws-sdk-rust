...
impl DeleteAdmChannelInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::delete_adm_channel::DeleteAdmChannelInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::delete_adm_channel::DeleteAdmChannelInput {
