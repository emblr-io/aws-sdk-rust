...
impl ListJourneysInput {
    /// Creates a new builder-style object to manufacture [`ListJourneysInput`](crate::operation::list_journeys::ListJourneysInput).
    pub fn builder() -> crate::operation::list_journeys::builders::ListJourneysInputBuilder {
        crate::operation::list_journeys::builders::ListJourneysInputBuilder::default()
    }
}
