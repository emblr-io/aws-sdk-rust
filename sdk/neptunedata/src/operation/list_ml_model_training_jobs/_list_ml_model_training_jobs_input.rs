...
impl ListMlModelTrainingJobsInput {
    /// Creates a new builder-style object to manufacture [`ListMlModelTrainingJobsInput`](crate::operation::list_ml_model_training_jobs::ListMlModelTrainingJobsInput).
    pub fn builder() -> crate::operation::list_ml_model_training_jobs::builders::ListMlModelTrainingJobsInputBuilder {
        crate::operation::list_ml_model_training_jobs::builders::ListMlModelTrainingJobsInputBuilder::default()
    }
}
