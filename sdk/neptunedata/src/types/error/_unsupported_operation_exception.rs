...
impl ::std::fmt::Display for UnsupportedOperationException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "UnsupportedOperationException")?;
...
/// A builder for [`UnsupportedOperationException`](crate::types::error::UnsupportedOperationException).
...
impl UnsupportedOperationExceptionBuilder {
    ...
    /// - [`detailed_message`](crate::types::error::builders::UnsupportedOperationExceptionBuilder::detailed_message)
    /// - [`request_id`](crate::types::error::builders::UnsupportedOperationExceptionBuilder::request_id)
    /// - [`code`](crate::types::error::builders::UnsupportedOperationExceptionBuilder::code)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::error::UnsupportedOperationException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::error::UnsupportedOperationException {
            detailed_message: self.detailed_message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "detailed_message",
                    "detailed_message was not specified but it is required when building UnsupportedOperationException",
                )
            })?,
            request_id: self.request_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "request_id",
                    "request_id was not specified but it is required when building UnsupportedOperationException",
                )
            })?,
            code: self.code.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "code",
                    "code was not specified but it is required when building UnsupportedOperationException",
                )
            })?,
