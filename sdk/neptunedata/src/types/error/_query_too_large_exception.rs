...
impl QueryTooLargeException {
    ...
    pub fn builder() -> crate::types::error::builders::QueryTooLargeExceptionBuilder {
        crate::types::error::builders::QueryTooLargeExceptionBuilder::default()
    }
}

/// A builder for [`QueryTooLargeException`](crate::types::error::QueryTooLargeException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct QueryTooLargeExceptionBuilder {
...
impl QueryTooLargeExceptionBuilder {
    /// <p>A detailed message describing the problem.</p>
