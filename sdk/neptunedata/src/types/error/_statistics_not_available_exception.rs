...
impl StatisticsNotAvailableException {
    /// <p>A detailed message describing the problem.</p>
...
impl ::std::fmt::Display for StatisticsNotAvailableException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "StatisticsNotAvailableException")?;
...
impl ::std::error::Error for StatisticsNotAvailableException {}
impl ::aws_types::request_id::RequestId for crate::types::error::StatisticsNotAvailableException {
    fn request_id(&self) -> Option<&str> {
        use ::aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
}
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StatisticsNotAvailableException {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        &self.meta
    }
}
impl StatisticsNotAvailableException {
    /// Creates a new builder-style object to manufacture [`StatisticsNotAvailableException`](crate::types::error::StatisticsNotAvailableException).
    pub fn builder() -> crate::types::error::builders::StatisticsNotAvailableExceptionBuilder {
        crate::types::error::builders::StatisticsNotAvailableExceptionBuilder::default()
    }
}

/// A builder for [`StatisticsNotAvailableException`](crate::types::error::StatisticsNotAvailableException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StatisticsNotAvailableExceptionBuilder {
...
impl StatisticsNotAvailableExceptionBuilder {
    /// <p>A detailed message describing the problem.</p>
    ...
    /// Consumes the builder and constructs a [`StatisticsNotAvailableException`](crate::types::error::StatisticsNotAvailableException).
    /// This method will fail if any of the following fields are not set:
    /// - [`detailed_message`](crate::types::error::builders::StatisticsNotAvailableExceptionBuilder::detailed_message)
    /// - [`request_id`](crate::types::error::builders::StatisticsNotAvailableExceptionBuilder::request_id)
