...
impl ::std::error::Error for BulkLoadIdNotFoundException {}
impl ::aws_types::request_id::RequestId for crate::types::error::BulkLoadIdNotFoundException {
...
impl BulkLoadIdNotFoundException {
    ...
    pub fn builder() -> crate::types::error::builders::BulkLoadIdNotFoundExceptionBuilder {
        crate::types::error::builders::BulkLoadIdNotFoundExceptionBuilder::default()
    }
}

/// A builder for [`BulkLoadIdNotFoundException`](crate::types::error::BulkLoadIdNotFoundException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BulkLoadIdNotFoundExceptionBuilder {
...
impl BulkLoadIdNotFoundExceptionBuilder {
    /// <p>A detailed message describing the problem.</p>
