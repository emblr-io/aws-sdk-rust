...
impl ::std::convert::From<&str> for Action {
    fn from(s: &str) -> Self {
        match s {
            "initiateDatabaseReset" => Action::InitializeReset,
            "performDatabaseReset" => Action::PerformReset,
...
impl Action {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Action::InitializeReset => "initiateDatabaseReset",
            Action::PerformReset => "performDatabaseReset",
