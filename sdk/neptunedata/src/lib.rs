...
//! offered by Amazon NeptuneData. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon NeptuneData.
...
/// For example, the [`CancelGremlinQuery`](crate::operation::cancel_gremlin_query) operation has
/// a [`Client::cancel_gremlin_query`], function which returns a builder for that operation.
...
/// Configuration for Amazon NeptuneData.
pub mod config;
