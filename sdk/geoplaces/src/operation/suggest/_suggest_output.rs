...
impl SuggestOutput {
    ...
    pub fn query_refinements(&self) -> &[crate::types::QueryRefinement] {
        self.query_refinements.as_deref().unwrap_or_default()
    }
}
...
pub struct SuggestOutputBuilder {
    ...
    pub(crate) result_items: ::std::option::Option<::std::vec::Vec<crate::types::SuggestResultItem>>,
    pub(crate) query_refinements: ::std::option::Option<::std::vec::Vec<crate::types::QueryRefinement>>,
    _request_id: Option<String>,
}
impl SuggestOutputBuilder {
    ...
    ///
    /// <p>List of places or results returned for a query.</p>
    pub fn result_items(mut self, input: crate::types::SuggestResultItem) -> Self {
    ...
    /// <p>List of places or results returned for a query.</p>
    pub fn set_result_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::SuggestResultItem>>) -> Self {
        self.result_items = input;
        self
    }
    /// <p>List of places or results returned for a query.</p>
    pub fn get_result_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::SuggestResultItem>> {
        &self.result_items
    }
    /// Appends an item to `query_refinements`.
    ///
    ...
    /// - [`pricing_bucket`](crate::operation::suggest::builders::SuggestOutputBuilder::pricing_bucket)
    pub fn build(self) -> ::std::result::Result<crate::operation::suggest::SuggestOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::suggest::SuggestOutput {
            pricing_bucket: self.pricing_bucket.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "pricing_bucket",
                    "pricing_bucket was not specified but it is required when building SuggestOutput",
                )
            })?,
