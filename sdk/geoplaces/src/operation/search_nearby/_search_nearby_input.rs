...
impl SearchNearbyInput {
    ...
    pub fn additional_features(&self) -> &[crate::types::SearchNearbyAdditionalFeature] {
...
impl ::std::fmt::Debug for SearchNearbyInput {
...
impl SearchNearbyInput {
    /// Creates a new builder-style object to manufacture [`SearchNearbyInput`](crate::operation::search_nearby::SearchNearbyInput).
    pub fn builder() -> crate::operation::search_nearby::builders::SearchNearbyInputBuilder {
        crate::operation::search_nearby::builders::SearchNearbyInputBuilder::default()
    }
}

/// A builder for [`SearchNearbyInput`](crate::operation::search_nearby::SearchNearbyInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct SearchNearbyInputBuilder {
    pub(crate) query_position: ::std::option::Option<::std::vec::Vec<f64>>,
    pub(crate) query_radius: ::std::option::Option<i64>,
    pub(crate) max_results: ::std::option::Option<i32>,
    pub(crate) filter: ::std::option::Option<crate::types::SearchNearbyFilter>,
    pub(crate) additional_features: ::std::option::Option<::std::vec::Vec<crate::types::SearchNearbyAdditionalFeature>>,
    pub(crate) language: ::std::option::Option<::std::string::String>,
    pub(crate) political_view: ::std::option::Option<::std::string::String>,
    pub(crate) intended_use: ::std::option::Option<crate::types::SearchNearbyIntendedUse>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    pub(crate) key: ::std::option::Option<::std::string::String>,
}
impl SearchNearbyInputBuilder {
    ...
    /// Consumes the builder and constructs a [`SearchNearbyInput`](crate::operation::search_nearby::SearchNearbyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::search_nearby::SearchNearbyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::search_nearby::SearchNearbyInput {
...
impl ::std::fmt::Debug for SearchNearbyInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
