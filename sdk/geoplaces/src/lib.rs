...
//! offered by Amazon Location Service Places V2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Location Service Places V2.
...
/// For example, the [`Autocomplete`](crate::operation::autocomplete) operation has
/// a [`Client::autocomplete`], function which returns a builder for that operation.
...
/// Configuration for Amazon Location Service Places V2.
pub mod config;
