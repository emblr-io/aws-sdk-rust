...
/// When writing a match expression against `GetPlaceAdditionalFeature`, it is important to ensure
...
///
/// ```text
/// # let getplaceadditionalfeature = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `getplaceadditionalfeature` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `GetPlaceAdditionalFeature::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `GetPlaceAdditionalFeature::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `GetPlaceAdditionalFeature::NewFeature` is defined.
/// Specifically, when `getplaceadditionalfeature` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `GetPlaceAdditionalFeature::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum GetPlaceAdditionalFeature {
    #[allow(missing_docs)] // documentation missing in model
    Access,
    #[allow(missing_docs)] // documentation missing in model
    Contact,
...
impl ::std::convert::From<&str> for GetPlaceAdditionalFeature {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for GetPlaceAdditionalFeature {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GetPlaceAdditionalFeature::from(s))
    }
}
impl GetPlaceAdditionalFeature {
...
impl ::std::fmt::Display for GetPlaceAdditionalFeature {
