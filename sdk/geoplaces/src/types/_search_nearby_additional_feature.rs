...
/// When writing a match expression against `SearchNearbyAdditionalFeature`, it is important to ensure
...
///
/// ```text
/// # let searchnearbyadditionalfeature = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `searchnearbyadditionalfeature` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SearchNearbyAdditionalFeature::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SearchNearbyAdditionalFeature::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SearchNearbyAdditionalFeature::NewFeature` is defined.
/// Specifically, when `searchnearbyadditionalfeature` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SearchNearbyAdditionalFeature::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum SearchNearbyAdditionalFeature {
    #[allow(missing_docs)] // documentation missing in model
    Access,
    #[allow(missing_docs)] // documentation missing in model
    Contact,
...
impl ::std::convert::From<&str> for SearchNearbyAdditionalFeature {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for SearchNearbyAdditionalFeature {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchNearbyAdditionalFeature::from(s))
    }
}
impl SearchNearbyAdditionalFeature {
...
impl ::std::fmt::Display for SearchNearbyAdditionalFeature {
