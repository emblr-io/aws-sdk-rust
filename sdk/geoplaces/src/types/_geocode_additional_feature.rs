...
/// When writing a match expression against `GeocodeAdditionalFeature`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `geocodeadditionalfeature` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `GeocodeAdditionalFeature::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `GeocodeAdditionalFeature::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `GeocodeAdditionalFeature::NewFeature` is defined.
/// Specifically, when `geocodeadditionalfeature` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `GeocodeAdditionalFeature::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum GeocodeAdditionalFeature {
    #[allow(missing_docs)] // documentation missing in model
    Access,
    #[allow(missing_docs)] // documentation missing in model
    Intersections,
...
impl ::std::convert::From<&str> for GeocodeAdditionalFeature {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for GeocodeAdditionalFeature {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GeocodeAdditionalFeature::from(s))
    }
}
impl GeocodeAdditionalFeature {
...
impl ::std::fmt::Display for GeocodeAdditionalFeature {
