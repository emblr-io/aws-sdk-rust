...
pub struct SuggestPlaceResult {
    ...
    pub place_type: ::std::option::Option<crate::types::PlaceType>,
...
impl SuggestPlaceResult {
    ...
    /// <p>A <code>PlaceType</code> is a category that the result place must belong to.</p>
    pub fn place_type(&self) -> ::std::option::Option<&crate::types::PlaceType> {
        self.place_type.as_ref()
    }
    /// <p>The place's address.</p>
...
impl SuggestPlaceResult {
    /// Creates a new builder-style object to manufacture [`SuggestPlaceResult`](crate::types::SuggestPlaceResult).
    pub fn builder() -> crate::types::builders::SuggestPlaceResultBuilder {
        crate::types::builders::SuggestPlaceResultBuilder::default()
    }
}

/// A builder for [`SuggestPlaceResult`](crate::types::SuggestPlaceResult).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct SuggestPlaceResultBuilder {
...
impl SuggestPlaceResultBuilder {
    /// <p>The <code>PlaceId</code> of the place you wish to receive the information for.</p>
    ...
    /// Consumes the builder and constructs a [`SuggestPlaceResult`](crate::types::SuggestPlaceResult).
    pub fn build(self) -> crate::types::SuggestPlaceResult {
        crate::types::SuggestPlaceResult {
