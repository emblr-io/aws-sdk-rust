...
pub struct AutocompleteFilter {
    ...
    pub include_place_types: ::std::option::Option<::std::vec::Vec<crate::types::AutocompleteFilterPlaceType>>,
}
impl AutocompleteFilter {
    ...
    pub fn include_place_types(&self) -> &[crate::types::AutocompleteFilterPlaceType] {
        self.include_place_types.as_deref().unwrap_or_default()
    }
}
impl ::std::fmt::Debug for AutocompleteFilter {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("AutocompleteFilter");
        ...
        formatter.field("include_place_types", &self.include_place_types);
        formatter.finish()
    }
}
impl AutocompleteFilter {
    /// Creates a new builder-style object to manufacture [`AutocompleteFilter`](crate::types::AutocompleteFilter).
    pub fn builder() -> crate::types::builders::AutocompleteFilterBuilder {
        crate::types::builders::AutocompleteFilterBuilder::default()
    }
}

/// A builder for [`AutocompleteFilter`](crate::types::AutocompleteFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct AutocompleteFilterBuilder {
    ...
    pub(crate) include_place_types: ::std::option::Option<::std::vec::Vec<crate::types::AutocompleteFilterPlaceType>>,
}
impl AutocompleteFilterBuilder {
    ...
    ///
    /// <p>The included place types.</p>
    pub fn include_place_types(mut self, input: crate::types::AutocompleteFilterPlaceType) -> Self {
    ...
    /// <p>The included place types.</p>
    pub fn set_include_place_types(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::AutocompleteFilterPlaceType>>) -> Self {
        self.include_place_types = input;
        self
    }
    /// <p>The included place types.</p>
    pub fn get_include_place_types(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::AutocompleteFilterPlaceType>> {
        &self.include_place_types
    }
    /// Consumes the builder and constructs a [`AutocompleteFilter`](crate::types::AutocompleteFilter).
    pub fn build(self) -> crate::types::AutocompleteFilter {
        crate::types::AutocompleteFilter {
...
impl ::std::fmt::Debug for AutocompleteFilterBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("AutocompleteFilterBuilder");
        formatter.field("bounding_box", &"*** Sensitive Data Redacted ***");
        formatter.field("circle", &"*** Sensitive Data Redacted ***");
        formatter.field("include_countries", &"*** Sensitive Data Redacted ***");
        formatter.field("include_place_types", &self.include_place_types);
