...
/// When writing a match expression against `SuggestAdditionalFeature`, it is important to ensure
...
///
/// ```text
/// # let suggestadditionalfeature = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `suggestadditionalfeature` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SuggestAdditionalFeature::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SuggestAdditionalFeature::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SuggestAdditionalFeature::NewFeature` is defined.
/// Specifically, when `suggestadditionalfeature` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SuggestAdditionalFeature::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum SuggestAdditionalFeature {
    #[allow(missing_docs)] // documentation missing in model
    Access,
    #[allow(missing_docs)] // documentation missing in model
    Core,
...
impl ::std::convert::From<&str> for SuggestAdditionalFeature {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for SuggestAdditionalFeature {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SuggestAdditionalFeature::from(s))
    }
}
impl SuggestAdditionalFeature {
...
impl ::std::fmt::Display for SuggestAdditionalFeature {
