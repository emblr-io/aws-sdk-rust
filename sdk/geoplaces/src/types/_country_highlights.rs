...
impl CountryHighlights {
    /// Creates a new builder-style object to manufacture [`CountryHighlights`](crate::types::CountryHighlights).
    pub fn builder() -> crate::types::builders::CountryHighlightsBuilder {
        crate::types::builders::CountryHighlightsBuilder::default()
    }
}

/// A builder for [`CountryHighlights`](crate::types::CountryHighlights).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CountryHighlightsBuilder {
...
impl CountryHighlightsBuilder {
    ...
    /// Consumes the builder and constructs a [`CountryHighlights`](crate::types::CountryHighlights).
    pub fn build(self) -> crate::types::CountryHighlights {
        crate::types::CountryHighlights {
            code: self.code,
            name: self.name,
        }
    }
