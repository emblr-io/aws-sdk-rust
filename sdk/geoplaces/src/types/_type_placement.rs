...
impl ::std::convert::From<&str> for TypePlacement {
    fn from(s: &str) -> Self {
        match s {
            "AfterBaseName" => TypePlacement::AfterBaseName,
            "BeforeBaseName" => TypePlacement::BeforeBaseName,
            other => TypePlacement::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TypePlacement {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TypePlacement::from(s))
    }
}
impl TypePlacement {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            TypePlacement::AfterBaseName => "AfterBaseName",
            TypePlacement::BeforeBaseName => "BeforeBaseName",
            TypePlacement::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["AfterBaseName", "BeforeBaseName"]
    }
}
impl ::std::convert::AsRef<str> for TypePlacement {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for TypePlacement {
