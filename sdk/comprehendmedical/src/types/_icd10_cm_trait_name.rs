...
impl ::std::convert::From<&str> for Icd10CmTraitName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Icd10CmTraitName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Icd10CmTraitName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Icd10CmTraitName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for Icd10CmTraitName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
