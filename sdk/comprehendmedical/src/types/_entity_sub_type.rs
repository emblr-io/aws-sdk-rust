...
impl ::std::convert::From<&str> for EntitySubType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EntitySubType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EntitySubType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EntitySubType::from(s))
    }
}
impl EntitySubType {
...
impl ::std::convert::AsRef<str> for EntitySubType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for EntitySubType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EntitySubType::Acuity => write!(f, "ACUITY"),
            EntitySubType::Address => write!(f, "ADDRESS"),
            EntitySubType::Age => write!(f, "AGE"),
            EntitySubType::AlcoholConsumption => write!(f, "ALCOHOL_CONSUMPTION"),
            EntitySubType::Allergies => write!(f, "ALLERGIES"),
            EntitySubType::Amount => write!(f, "AMOUNT"),
            EntitySubType::BrandName => write!(f, "BRAND_NAME"),
            EntitySubType::ContactPoint => write!(f, "CONTACT_POINT"),
            EntitySubType::Date => write!(f, "DATE"),
            EntitySubType::Direction => write!(f, "DIRECTION"),
            EntitySubType::Dosage => write!(f, "DOSAGE"),
            EntitySubType::Duration => write!(f, "DURATION"),
            EntitySubType::DxName => write!(f, "DX_NAME"),
            EntitySubType::Email => write!(f, "EMAIL"),
            EntitySubType::Form => write!(f, "FORM"),
            EntitySubType::Frequency => write!(f, "FREQUENCY"),
            EntitySubType::Gender => write!(f, "GENDER"),
            EntitySubType::GenericName => write!(f, "GENERIC_NAME"),
            EntitySubType::Id => write!(f, "ID"),
            EntitySubType::Identifier => write!(f, "IDENTIFIER"),
            EntitySubType::Name => write!(f, "NAME"),
            EntitySubType::PhoneOrFax => write!(f, "PHONE_OR_FAX"),
            EntitySubType::ProcedureName => write!(f, "PROCEDURE_NAME"),
            EntitySubType::Profession => write!(f, "PROFESSION"),
            EntitySubType::Quality => write!(f, "QUALITY"),
            EntitySubType::Quantity => write!(f, "QUANTITY"),
            EntitySubType::RaceEthnicity => write!(f, "RACE_ETHNICITY"),
            EntitySubType::Rate => write!(f, "RATE"),
            EntitySubType::RecDrugUse => write!(f, "REC_DRUG_USE"),
            EntitySubType::RouteOrMode => write!(f, "ROUTE_OR_MODE"),
            EntitySubType::Strength => write!(f, "STRENGTH"),
            EntitySubType::SystemOrganSite => write!(f, "SYSTEM_ORGAN_SITE"),
            EntitySubType::TestName => write!(f, "TEST_NAME"),
            EntitySubType::TestUnit => write!(f, "TEST_UNIT"),
            EntitySubType::TestUnits => write!(f, "TEST_UNITS"),
            EntitySubType::TestValue => write!(f, "TEST_VALUE"),
            EntitySubType::TimeExpression => write!(f, "TIME_EXPRESSION"),
            EntitySubType::TimeToDxName => write!(f, "TIME_TO_DX_NAME"),
            EntitySubType::TimeToMedicationName => write!(f, "TIME_TO_MEDICATION_NAME"),
            EntitySubType::TimeToProcedureName => write!(f, "TIME_TO_PROCEDURE_NAME"),
            EntitySubType::TimeToTestName => write!(f, "TIME_TO_TEST_NAME"),
            EntitySubType::TimeToTreatmentName => write!(f, "TIME_TO_TREATMENT_NAME"),
