...
impl ::std::convert::From<&str> for AttributeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AttributeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttributeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttributeName::from(s))
    }
}
impl AttributeName {
...
impl ::std::convert::AsRef<str> for AttributeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
