...
///
/// ```text
/// # let snomedctattributetype = unimplemented!();
/// match snomedctattributetype {
///     SnomedctAttributeType::Acuity => { /* ... */ },
///     SnomedctAttributeType::Direction => { /* ... */ },
///     SnomedctAttributeType::Quality => { /* ... */ },
///     SnomedctAttributeType::SystemOrganSite => { /* ... */ },
///     SnomedctAttributeType::TestUnit => { /* ... */ },
///     SnomedctAttributeType::TestValue => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `snomedctattributetype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SnomedctAttributeType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SnomedctAttributeType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SnomedctAttributeType::NewFeature` is defined.
/// Specifically, when `snomedctattributetype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SnomedctAttributeType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for SnomedctAttributeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnomedctAttributeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnomedctAttributeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnomedctAttributeType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SnomedctAttributeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
