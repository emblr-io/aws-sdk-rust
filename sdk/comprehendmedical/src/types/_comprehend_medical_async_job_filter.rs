...
impl ComprehendMedicalAsyncJobFilter {
    /// Creates a new builder-style object to manufacture [`ComprehendMedicalAsyncJobFilter`](crate::types::ComprehendMedicalAsyncJobFilter).
    pub fn builder() -> crate::types::builders::ComprehendMedicalAsyncJobFilterBuilder {
        crate::types::builders::ComprehendMedicalAsyncJobFilterBuilder::default()
    }
}

/// A builder for [`ComprehendMedicalAsyncJobFilter`](crate::types::ComprehendMedicalAsyncJobFilter).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ComprehendMedicalAsyncJobFilterBuilder {
...
impl ComprehendMedicalAsyncJobFilterBuilder {
    /// <p>Filters on the name of the job.</p>
    ...
    /// Consumes the builder and constructs a [`ComprehendMedicalAsyncJobFilter`](crate::types::ComprehendMedicalAsyncJobFilter).
    pub fn build(self) -> crate::types::ComprehendMedicalAsyncJobFilter {
        crate::types::ComprehendMedicalAsyncJobFilter {
