...
impl ::std::convert::From<&str> for SnomedctEntityType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnomedctEntityType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnomedctEntityType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnomedctEntityType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SnomedctEntityType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
