...
impl ::std::convert::From<&str> for SnomedctEntityCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SnomedctEntityCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SnomedctEntityCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SnomedctEntityCategory::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SnomedctEntityCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
