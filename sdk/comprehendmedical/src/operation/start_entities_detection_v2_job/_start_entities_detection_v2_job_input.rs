...
impl StartEntitiesDetectionV2JobInputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartEntitiesDetectionV2JobInput`](crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
