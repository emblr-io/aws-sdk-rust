...
impl ::aws_types::request_id::RequestId for ListSnomedctInferenceJobsOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ListSnomedctInferenceJobsOutput {
    /// Creates a new builder-style object to manufacture [`ListSnomedctInferenceJobsOutput`](crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsOutput).
    pub fn builder() -> crate::operation::list_snomedct_inference_jobs::builders::ListSnomedctInferenceJobsOutputBuilder {
        crate::operation::list_snomedct_inference_jobs::builders::ListSnomedctInferenceJobsOutputBuilder::default()
    }
}
...
impl ListSnomedctInferenceJobsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListSnomedctInferenceJobsOutput`](crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsOutput).
    pub fn build(self) -> crate::operation::list_snomedct_inference_jobs::ListSnomedctInferenceJobsOutput {
