...
impl ListPhiDetectionJobsInputBuilder {
    /// <p>Filters the jobs that are returned. You can filter jobs based on their names, status, or the date and time that they were submitted. You can only set one filter at a time.</p>
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_phi_detection_jobs::ListPhiDetectionJobsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_phi_detection_jobs::ListPhiDetectionJobsInput {
            filter: self.filter,
