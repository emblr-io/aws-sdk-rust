...
impl StartRxNormInferenceJobInput {
    /// Creates a new builder-style object to manufacture [`StartRxNormInferenceJobInput`](crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput).
    pub fn builder() -> crate::operation::start_rx_norm_inference_job::builders::StartRxNormInferenceJobInputBuilder {
        crate::operation::start_rx_norm_inference_job::builders::StartRxNormInferenceJobInputBuilder::default()
    }
}

/// A builder for [`StartRxNormInferenceJobInput`](crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartRxNormInferenceJobInputBuilder {
...
impl StartRxNormInferenceJobInputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartRxNormInferenceJobInput`](crate::operation::start_rx_norm_inference_job::StartRxNormInferenceJobInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
