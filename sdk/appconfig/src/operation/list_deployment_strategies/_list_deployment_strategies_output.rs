...
pub struct ListDeploymentStrategiesOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentStrategy>>,
...
impl ListDeploymentStrategiesOutput {
    ...
    pub fn items(&self) -> &[crate::types::DeploymentStrategy] {
...
impl ::aws_types::request_id::RequestId for ListDeploymentStrategiesOutput {
...
impl ListDeploymentStrategiesOutputBuilder {
    /// Appends an item to `items`.
    ///
    /// To override the contents of this collection use [`set_items`](Self::set_items).
    ///
    /// <p>The elements from this collection.</p>
    pub fn items(mut self, input: crate::types::DeploymentStrategy) -> Self {
