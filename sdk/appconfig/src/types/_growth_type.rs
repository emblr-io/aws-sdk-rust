...
impl ::std::convert::From<&str> for GrowthType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GrowthType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GrowthType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GrowthType::from(s))
    }
}
impl GrowthType {
...
impl ::std::convert::AsRef<str> for GrowthType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
