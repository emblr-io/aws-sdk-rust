...
impl ::std::convert::From<&str> for BytesMeasure {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BytesMeasure::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BytesMeasure {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BytesMeasure::from(s))
    }
}
impl BytesMeasure {
...
impl ::std::convert::AsRef<str> for BytesMeasure {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for BytesMeasure {
