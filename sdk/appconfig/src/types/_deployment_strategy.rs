...
impl DeploymentStrategy {
    /// Creates a new builder-style object to manufacture [`DeploymentStrategy`](crate::types::DeploymentStrategy).
    pub fn builder() -> crate::types::builders::DeploymentStrategyBuilder {
        crate::types::builders::DeploymentStrategyBuilder::default()
    }
}
