...
impl ::std::convert::From<&str> for ValidatorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ValidatorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValidatorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValidatorType::from(s))
    }
}
impl ValidatorType {
...
impl ::std::convert::AsRef<str> for ValidatorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
