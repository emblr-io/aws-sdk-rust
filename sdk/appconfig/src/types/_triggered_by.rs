...
impl ::std::convert::From<&str> for TriggeredBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TriggeredBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TriggeredBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TriggeredBy::from(s))
    }
}
impl TriggeredBy {
...
impl ::std::convert::AsRef<str> for TriggeredBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
