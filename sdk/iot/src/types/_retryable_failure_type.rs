...
impl ::std::convert::From<&str> for RetryableFailureType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RetryableFailureType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RetryableFailureType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RetryableFailureType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RetryableFailureType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
