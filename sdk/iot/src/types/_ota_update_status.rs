...
///     OtaUpdateStatus::DeleteFailed => { /* ... */ },
///     OtaUpdateStatus::DeleteInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for OtaUpdateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "DELETE_FAILED" => OtaUpdateStatus::DeleteFailed,
            "DELETE_IN_PROGRESS" => OtaUpdateStatus::DeleteInProgress,
            other => OtaUpdateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OtaUpdateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OtaUpdateStatus::from(s))
    }
}
impl OtaUpdateStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OtaUpdateStatus::DeleteFailed => "DELETE_FAILED",
            OtaUpdateStatus::DeleteInProgress => "DELETE_IN_PROGRESS",
...
impl ::std::convert::AsRef<str> for OtaUpdateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
