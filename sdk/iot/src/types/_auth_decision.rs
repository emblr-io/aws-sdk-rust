...
impl ::std::convert::From<&str> for AuthDecision {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthDecision::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthDecision {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthDecision::from(s))
    }
}
impl AuthDecision {
...
impl ::std::convert::AsRef<str> for AuthDecision {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
