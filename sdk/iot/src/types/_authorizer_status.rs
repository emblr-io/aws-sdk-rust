...
impl ::std::convert::From<&str> for AuthorizerStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuthorizerStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuthorizerStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthorizerStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuthorizerStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
