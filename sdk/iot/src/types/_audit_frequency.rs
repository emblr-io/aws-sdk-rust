...
impl ::std::convert::From<&str> for AuditFrequency {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditFrequency::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditFrequency {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditFrequency::from(s))
    }
}
impl AuditFrequency {
...
impl ::std::convert::AsRef<str> for AuditFrequency {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
