...
impl ::std::convert::From<&str> for AuditMitigationActionsExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditMitigationActionsExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditMitigationActionsExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditMitigationActionsExecutionStatus::from(s))
    }
}
...
impl ::std::fmt::Display for AuditMitigationActionsExecutionStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AuditMitigationActionsExecutionStatus::Canceled => write!(f, "CANCELED"),
            AuditMitigationActionsExecutionStatus::Completed => write!(f, "COMPLETED"),
            AuditMitigationActionsExecutionStatus::Failed => write!(f, "FAILED"),
