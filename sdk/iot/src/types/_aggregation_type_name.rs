...
impl ::std::convert::From<&str> for AggregationTypeName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AggregationTypeName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AggregationTypeName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AggregationTypeName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AggregationTypeName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
