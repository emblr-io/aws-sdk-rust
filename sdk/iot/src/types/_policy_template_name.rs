...
impl ::std::convert::From<&str> for PolicyTemplateName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PolicyTemplateName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PolicyTemplateName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PolicyTemplateName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PolicyTemplateName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
