...
///     AuthenticationType::AwsX509 => { /* ... */ },
///     AuthenticationType::CustomAuth => { /* ... */ },
///     AuthenticationType::CustomAuthX509 => { /* ... */ },
...
impl ::std::convert::From<&str> for AuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_SIGV4" => AuthenticationType::AwsSigv4,
            "AWS_X509" => AuthenticationType::AwsX509,
            "CUSTOM_AUTH" => AuthenticationType::CustomAuth,
            "CUSTOM_AUTH_X509" => AuthenticationType::CustomAuthX509,
...
impl ::std::str::FromStr for AuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuthenticationType::from(s))
    }
}
impl AuthenticationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AuthenticationType::AwsSigv4 => "AWS_SIGV4",
            AuthenticationType::AwsX509 => "AWS_X509",
            AuthenticationType::CustomAuth => "CUSTOM_AUTH",
            AuthenticationType::CustomAuthX509 => "CUSTOM_AUTH_X509",
...
impl ::std::fmt::Display for AuthenticationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AuthenticationType::AwsSigv4 => write!(f, "AWS_SIGV4"),
            AuthenticationType::AwsX509 => write!(f, "AWS_X509"),
