...
impl ::std::convert::From<&str> for AuditNotificationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditNotificationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditNotificationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditNotificationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuditNotificationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AuditNotificationType {
