...
impl ::std::convert::From<&str> for CaCertificateStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CaCertificateStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CaCertificateStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CaCertificateStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CaCertificateStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
