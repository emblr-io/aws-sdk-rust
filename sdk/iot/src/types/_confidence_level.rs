...
impl ::std::convert::From<&str> for ConfidenceLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConfidenceLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConfidenceLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConfidenceLevel::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConfidenceLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
