...
impl ::std::convert::From<&str> for TargetSelection {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TargetSelection::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TargetSelection {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TargetSelection::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TargetSelection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
