...
impl ::std::convert::From<&str> for AuditTaskType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditTaskType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditTaskType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditTaskType::from(s))
    }
}
impl AuditTaskType {
...
impl ::std::convert::AsRef<str> for AuditTaskType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
