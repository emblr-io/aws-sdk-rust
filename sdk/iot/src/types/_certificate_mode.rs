...
impl ::std::convert::From<&str> for CertificateMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CertificateMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CertificateMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CertificateMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CertificateMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
