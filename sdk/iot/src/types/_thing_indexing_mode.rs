...
impl ::std::convert::From<&str> for ThingIndexingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThingIndexingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThingIndexingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThingIndexingMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ThingIndexingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
