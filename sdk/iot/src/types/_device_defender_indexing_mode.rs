...
impl ::std::convert::From<&str> for DeviceDefenderIndexingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeviceDefenderIndexingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeviceDefenderIndexingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeviceDefenderIndexingMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeviceDefenderIndexingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
