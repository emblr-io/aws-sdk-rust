...
impl ::std::convert::From<&str> for JobEndBehavior {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobEndBehavior::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobEndBehavior {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobEndBehavior::from(s))
    }
}
impl JobEndBehavior {
...
impl ::std::convert::AsRef<str> for JobEndBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
