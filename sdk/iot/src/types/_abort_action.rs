...
impl ::std::convert::From<&str> for AbortAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AbortAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AbortAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AbortAction::from(s))
    }
}
impl AbortAction {
...
impl ::std::convert::AsRef<str> for AbortAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AbortAction {
