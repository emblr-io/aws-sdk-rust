...
impl ::std::convert::From<&str> for AuditTaskStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AuditTaskStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AuditTaskStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AuditTaskStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AuditTaskStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AuditTaskStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AuditTaskStatus::Canceled => write!(f, "CANCELED"),
            AuditTaskStatus::Completed => write!(f, "COMPLETED"),
            AuditTaskStatus::Failed => write!(f, "FAILED"),
            AuditTaskStatus::InProgress => write!(f, "IN_PROGRESS"),
            AuditTaskStatus::Unknown(value) => write!(f, "{}", value),
        }
    }
}
