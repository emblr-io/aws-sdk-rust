...
///     ApplicationProtocol::MqttWss => { /* ... */ },
///     ApplicationProtocol::SecureMqtt => { /* ... */ },
...
impl ::std::convert::From<&str> for ApplicationProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MQTT_WSS" => ApplicationProtocol::MqttWss,
            "SECURE_MQTT" => ApplicationProtocol::SecureMqtt,
            other => ApplicationProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationProtocol::from(s))
    }
}
impl ApplicationProtocol {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ApplicationProtocol::Default => "DEFAULT",
            ApplicationProtocol::Https => "HTTPS",
            ApplicationProtocol::MqttWss => "MQTT_WSS",
            ApplicationProtocol::SecureMqtt => "SECURE_MQTT",
            ApplicationProtocol::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["DEFAULT", "HTTPS", "MQTT_WSS", "SECURE_MQTT"]
    }
}
impl ::std::convert::AsRef<str> for ApplicationProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ApplicationProtocol {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ApplicationProtocol::Default => write!(f, "DEFAULT"),
