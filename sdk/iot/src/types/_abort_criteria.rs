...
pub struct AbortCriteria {
    ...
    pub action: crate::types::AbortAction,
...
impl AbortCriteriaBuilder {
    ...
    /// - [`failure_type`](crate::types::builders::AbortCriteriaBuilder::failure_type)
    /// - [`action`](crate::types::builders::AbortCriteriaBuilder::action)
