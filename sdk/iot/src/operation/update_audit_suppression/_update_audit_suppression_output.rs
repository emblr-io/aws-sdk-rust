...
impl ::aws_types::request_id::RequestId for UpdateAuditSuppressionOutput {
...
impl UpdateAuditSuppressionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateAuditSuppressionOutput`](crate::operation::update_audit_suppression::UpdateAuditSuppressionOutput).
    pub fn build(self) -> crate::operation::update_audit_suppression::UpdateAuditSuppressionOutput {
