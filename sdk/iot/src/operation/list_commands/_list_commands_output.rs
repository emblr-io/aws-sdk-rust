...
pub struct ListCommandsOutput {
    ...
    pub commands: ::std::option::Option<::std::vec::Vec<crate::types::CommandSummary>>,
...
impl ListCommandsOutput {
    ...
    pub fn commands(&self) -> &[crate::types::CommandSummary] {
...
pub struct ListCommandsOutputBuilder {
    pub(crate) commands: ::std::option::Option<::std::vec::Vec<crate::types::CommandSummary>>,
...
impl ListCommandsOutputBuilder {
    ...
    ///
    /// <p>The list of commands.</p>
    pub fn commands(mut self, input: crate::types::CommandSummary) -> Self {
    ...
    /// <p>The list of commands.</p>
    pub fn set_commands(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::CommandSummary>>) -> Self {
        self.commands = input;
        self
    }
    /// <p>The list of commands.</p>
    pub fn get_commands(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::CommandSummary>> {
        &self.commands
    }
    /// <p>The token to use to get the next set of results, or <code>null</code> if there are no additional results.</p>
