...
pub struct ListBillingGroupsOutput {
    ...
    pub billing_groups: ::std::option::Option<::std::vec::Vec<crate::types::GroupNameAndArn>>,
...
impl ::aws_types::request_id::RequestId for ListBillingGroupsOutput {
...
impl ListBillingGroupsOutputBuilder {
    ...
    ///
    /// <p>The list of billing groups.</p>
    pub fn billing_groups(mut self, input: crate::types::GroupNameAndArn) -> Self {
