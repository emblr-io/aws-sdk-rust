...
impl ::aws_types::request_id::RequestId for DeleteRoleAliasOutput {
...
impl DeleteRoleAliasOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteRoleAliasOutput`](crate::operation::delete_role_alias::DeleteRoleAliasOutput).
    pub fn build(self) -> crate::operation::delete_role_alias::DeleteRoleAliasOutput {
