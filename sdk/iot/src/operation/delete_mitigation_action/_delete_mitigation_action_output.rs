...
impl ::aws_types::request_id::RequestId for DeleteMitigationActionOutput {
...
impl DeleteMitigationActionOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteMitigationActionOutput`](crate::operation::delete_mitigation_action::DeleteMitigationActionOutput).
    pub fn build(self) -> crate::operation::delete_mitigation_action::DeleteMitigationActionOutput {
