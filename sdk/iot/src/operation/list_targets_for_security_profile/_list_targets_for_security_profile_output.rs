...
impl ListTargetsForSecurityProfileOutput {
    ...
    pub fn security_profile_targets(&self) -> &[crate::types::SecurityProfileTarget] {
        self.security_profile_targets.as_deref().unwrap_or_default()
    }
    /// <p>A token that can be used to retrieve the next set of results, or <code>null</code> if there are no additional results.</p>
...
impl ::aws_types::request_id::RequestId for ListTargetsForSecurityProfileOutput {
...
impl ListTargetsForSecurityProfileOutputBuilder {
    ...
    pub fn security_profile_targets(mut self, input: crate::types::SecurityProfileTarget) -> Self {
        ...
        v.push(input);
        self.security_profile_targets = ::std::option::Option::Some(v);
        self
    }
    /// <p>The thing groups to which the security profile is attached.</p>
