...
//! aws-sdk-servicecatalog = "0.0.0-local"
...
//! offered by AWS Service Catalog. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Service Catalog.
...
/// Configuration for AWS Service Catalog.
pub mod config;
