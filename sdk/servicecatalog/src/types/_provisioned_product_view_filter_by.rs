...
impl ::std::convert::From<&str> for ProvisionedProductViewFilterBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisionedProductViewFilterBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisionedProductViewFilterBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisionedProductViewFilterBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProvisionedProductViewFilterBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ProvisionedProductViewFilterBy {
