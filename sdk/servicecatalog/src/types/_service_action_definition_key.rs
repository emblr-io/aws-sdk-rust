...
impl ::std::convert::From<&str> for ServiceActionDefinitionKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServiceActionDefinitionKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServiceActionDefinitionKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServiceActionDefinitionKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServiceActionDefinitionKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
