...
impl ::std::convert::From<&str> for CopyOption {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CopyOption::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CopyOption {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CopyOption::from(s))
    }
}
impl CopyOption {
...
impl ::std::convert::AsRef<str> for CopyOption {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
