...
impl ::std::convert::From<&str> for PropertyKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PropertyKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PropertyKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PropertyKey::from(s))
    }
}
impl PropertyKey {
...
impl ::std::convert::AsRef<str> for PropertyKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
