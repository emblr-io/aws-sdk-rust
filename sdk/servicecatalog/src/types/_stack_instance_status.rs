...
impl ::std::convert::From<&str> for StackInstanceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackInstanceStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackInstanceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackInstanceStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StackInstanceStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
