...
impl ::std::convert::From<&str> for ProductViewSortBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProductViewSortBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProductViewSortBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProductViewSortBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProductViewSortBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
