...
impl ::std::convert::From<&str> for RecordStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordStatus::from(s))
    }
}
impl RecordStatus {
...
impl ::std::convert::AsRef<str> for RecordStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
