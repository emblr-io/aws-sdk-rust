...
impl ::std::convert::From<&str> for DescribePortfolioShareType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DescribePortfolioShareType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DescribePortfolioShareType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DescribePortfolioShareType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DescribePortfolioShareType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
