...
impl ::std::convert::From<&str> for LastSyncStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LastSyncStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LastSyncStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LastSyncStatus::from(s))
    }
}
impl LastSyncStatus {
...
impl ::std::convert::AsRef<str> for LastSyncStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
