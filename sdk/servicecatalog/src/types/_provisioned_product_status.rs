...
impl ::std::convert::From<&str> for ProvisionedProductStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisionedProductStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisionedProductStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisionedProductStatus::from(s))
    }
}
