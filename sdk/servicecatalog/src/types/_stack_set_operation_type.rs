...
impl ::std::convert::From<&str> for StackSetOperationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StackSetOperationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StackSetOperationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StackSetOperationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StackSetOperationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
