...
impl ::std::convert::From<&str> for ServiceActionDefinitionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServiceActionDefinitionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServiceActionDefinitionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServiceActionDefinitionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ServiceActionDefinitionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
