...
impl ::std::convert::From<&str> for ProductViewFilterBy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProductViewFilterBy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProductViewFilterBy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProductViewFilterBy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProductViewFilterBy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
