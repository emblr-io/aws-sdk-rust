...
impl ::std::convert::From<&str> for ProvisioningArtifactGuidance {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisioningArtifactGuidance::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisioningArtifactGuidance {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisioningArtifactGuidance::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProvisioningArtifactGuidance {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
