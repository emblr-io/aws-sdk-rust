...
impl ::std::convert::From<&str> for ProvisionedProductPlanStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisionedProductPlanStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisionedProductPlanStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisionedProductPlanStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ProvisionedProductPlanStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
