...
impl ::std::convert::From<&str> for RequiresRecreation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RequiresRecreation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RequiresRecreation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RequiresRecreation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RequiresRecreation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
