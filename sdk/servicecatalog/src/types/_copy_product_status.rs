...
impl ::std::convert::From<&str> for CopyProductStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CopyProductStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CopyProductStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CopyProductStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CopyProductStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
