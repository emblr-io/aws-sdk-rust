...
impl ::std::convert::From<&str> for ProductSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProductSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProductSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProductSource::from(s))
    }
}
impl ProductSource {
...
impl ::std::convert::AsRef<str> for ProductSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
