...
impl ::std::convert::From<&str> for AccessLevelFilterKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessLevelFilterKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccessLevelFilterKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccessLevelFilterKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccessLevelFilterKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
