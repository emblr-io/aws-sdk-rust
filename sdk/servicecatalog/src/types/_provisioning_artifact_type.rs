...
impl ::std::convert::From<&str> for ProvisioningArtifactType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ProvisioningArtifactType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ProvisioningArtifactType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ProvisioningArtifactType::from(s))
    }
}
