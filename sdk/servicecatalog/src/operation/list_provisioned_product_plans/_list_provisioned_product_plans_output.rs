...
impl ::aws_types::request_id::RequestId for ListProvisionedProductPlansOutput {
...
impl ListProvisionedProductPlansOutputBuilder {
    ...
    pub fn set_provisioned_product_plans(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::ProvisionedProductPlanSummary>>,
    ) -> Self {
