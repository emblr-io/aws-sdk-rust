...
impl DescribeRecordInput {
    /// Creates a new builder-style object to manufacture [`DescribeRecordInput`](crate::operation::describe_record::DescribeRecordInput).
    pub fn builder() -> crate::operation::describe_record::builders::DescribeRecordInputBuilder {
        crate::operation::describe_record::builders::DescribeRecordInputBuilder::default()
    }
}

/// A builder for [`DescribeRecordInput`](crate::operation::describe_record::DescribeRecordInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeRecordInputBuilder {
