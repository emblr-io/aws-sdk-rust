...
impl ListLaunchPathsInput {
    /// Creates a new builder-style object to manufacture [`ListLaunchPathsInput`](crate::operation::list_launch_paths::ListLaunchPathsInput).
    pub fn builder() -> crate::operation::list_launch_paths::builders::ListLaunchPathsInputBuilder {
        crate::operation::list_launch_paths::builders::ListLaunchPathsInputBuilder::default()
    }
}
