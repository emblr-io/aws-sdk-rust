...
impl ::aws_types::request_id::RequestId for DescribeConstraintOutput {
...
/// A builder for [`DescribeConstraintOutput`](crate::operation::describe_constraint::DescribeConstraintOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeConstraintOutputBuilder {
...
impl DescribeConstraintOutputBuilder {
    /// <p>Information about the constraint.</p>
    pub fn constraint_detail(mut self, input: crate::types::ConstraintDetail) -> Self {
        self.constraint_detail = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information about the constraint.</p>
