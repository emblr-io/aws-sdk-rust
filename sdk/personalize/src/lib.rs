...
//! aws-sdk-personalize = "0.0.0-local"
...
//! offered by Amazon Personalize. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Personalize.
...
/// For example, the [`CreateBatchInferenceJob`](crate::operation::create_batch_inference_job) operation has
...
/// Configuration for Amazon Personalize.
pub mod config;
