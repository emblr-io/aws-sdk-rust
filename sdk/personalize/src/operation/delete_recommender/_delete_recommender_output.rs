...
impl ::aws_types::request_id::RequestId for DeleteRecommenderOutput {
...
impl DeleteRecommenderOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteRecommenderOutput`](crate::operation::delete_recommender::DeleteRecommenderOutput).
    pub fn build(self) -> crate::operation::delete_recommender::DeleteRecommenderOutput {
