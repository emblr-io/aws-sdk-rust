...
impl ::aws_types::request_id::RequestId for DescribeBatchSegmentJobOutput {
...
impl DescribeBatchSegmentJobOutputBuilder {
    ...
    pub fn batch_segment_job(mut self, input: crate::types::BatchSegmentJob) -> Self {
        self.batch_segment_job = ::std::option::Option::Some(input);
        self
    }
    /// <p>Information on the specified batch segment job.</p>
    ...
    /// <p>Information on the specified batch segment job.</p>
    pub fn get_batch_segment_job(&self) -> &::std::option::Option<crate::types::BatchSegmentJob> {
        &self.batch_segment_job
    }
