...
impl ::aws_types::request_id::RequestId for DeleteEventTrackerOutput {
...
impl DeleteEventTrackerOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteEventTrackerOutput`](crate::operation::delete_event_tracker::DeleteEventTrackerOutput).
    pub fn build(self) -> crate::operation::delete_event_tracker::DeleteEventTrackerOutput {
