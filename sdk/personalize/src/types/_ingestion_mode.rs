...
impl ::std::convert::From<&str> for IngestionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IngestionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IngestionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IngestionMode::from(s))
    }
}
impl IngestionMode {
...
impl ::std::convert::AsRef<str> for IngestionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
