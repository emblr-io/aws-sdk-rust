...
impl ::std::convert::From<&str> for Domain {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Domain::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Domain {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Domain::from(s))
    }
}
impl Domain {
...
impl ::std::convert::AsRef<str> for Domain {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Domain {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Domain::Ecommerce => write!(f, "ECOMMERCE"),
            Domain::VideoOnDemand => write!(f, "VIDEO_ON_DEMAND"),
