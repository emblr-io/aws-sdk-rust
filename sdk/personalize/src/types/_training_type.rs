...
impl ::std::convert::From<&str> for TrainingType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TrainingType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TrainingType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TrainingType::from(s))
    }
}
impl TrainingType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TrainingType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for TrainingType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
