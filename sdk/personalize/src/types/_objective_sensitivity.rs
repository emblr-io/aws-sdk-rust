...
impl ::std::convert::From<&str> for ObjectiveSensitivity {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ObjectiveSensitivity::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ObjectiveSensitivity {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ObjectiveSensitivity::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ObjectiveSensitivity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
