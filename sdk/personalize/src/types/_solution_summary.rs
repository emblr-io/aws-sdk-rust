...
impl SolutionSummary {
    /// Creates a new builder-style object to manufacture [`SolutionSummary`](crate::types::SolutionSummary).
    pub fn builder() -> crate::types::builders::SolutionSummaryBuilder {
        crate::types::builders::SolutionSummaryBuilder::default()
    }
}

/// A builder for [`SolutionSummary`](crate::types::SolutionSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SolutionSummaryBuilder {
