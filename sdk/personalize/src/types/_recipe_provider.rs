...
impl ::std::convert::From<&str> for RecipeProvider {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecipeProvider::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecipeProvider {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecipeProvider::from(s))
    }
}
impl RecipeProvider {
...
impl ::std::convert::AsRef<str> for RecipeProvider {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
