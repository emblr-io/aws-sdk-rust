...
//! aws-sdk-connectcontactlens = "0.0.0-local"
...
//! offered by Amazon Connect Contact Lens. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Connect Contact Lens.
...
/// For example, the [`ListRealtimeContactAnalysisSegments`](crate::operation::list_realtime_contact_analysis_segments) operation has
/// a [`Client::list_realtime_contact_analysis_segments`], function which returns a builder for that operation.
...
/// Configuration for Amazon Connect Contact Lens.
pub mod config;
