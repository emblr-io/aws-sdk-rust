...
impl ::std::convert::From<&str> for RecordingMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordingMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordingMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordingMode::from(s))
    }
}
impl RecordingMode {
...
impl ::std::convert::AsRef<str> for RecordingMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
