...
impl PlaybackRestrictionPolicySummary {
    /// <p>Playback-restriction-policy ARN</p>
    pub fn arn(&self) -> &str {
        use std::ops::Deref;
        self.arn.deref()
...
impl PlaybackRestrictionPolicySummary {
    /// Creates a new builder-style object to manufacture [`PlaybackRestrictionPolicySummary`](crate::types::PlaybackRestrictionPolicySummary).
    pub fn builder() -> crate::types::builders::PlaybackRestrictionPolicySummaryBuilder {
        crate::types::builders::PlaybackRestrictionPolicySummaryBuilder::default()
    }
}
...
impl PlaybackRestrictionPolicySummaryBuilder {
    /// <p>Playback-restriction-policy ARN</p>
    ...
    /// Consumes the builder and constructs a [`PlaybackRestrictionPolicySummary`](crate::types::PlaybackRestrictionPolicySummary).
    /// This method will fail if any of the following fields are not set:
    /// - [`arn`](crate::types::builders::PlaybackRestrictionPolicySummaryBuilder::arn)
    /// - [`allowed_countries`](crate::types::builders::PlaybackRestrictionPolicySummaryBuilder::allowed_countries)
    /// - [`allowed_origins`](crate::types::builders::PlaybackRestrictionPolicySummaryBuilder::allowed_origins)
    pub fn build(self) -> ::std::result::Result<crate::types::PlaybackRestrictionPolicySummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::PlaybackRestrictionPolicySummary {
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building PlaybackRestrictionPolicySummary",
                )
            })?,
            allowed_countries: self.allowed_countries.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "allowed_countries",
                    "allowed_countries was not specified but it is required when building PlaybackRestrictionPolicySummary",
                )
            })?,
            allowed_origins: self.allowed_origins.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "allowed_origins",
                    "allowed_origins was not specified but it is required when building PlaybackRestrictionPolicySummary",
                )
            })?,
