...
impl ::std::convert::From<&str> for RecordingConfigurationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordingConfigurationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordingConfigurationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordingConfigurationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RecordingConfigurationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
