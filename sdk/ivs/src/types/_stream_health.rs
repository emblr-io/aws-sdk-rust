...
impl ::std::convert::From<&str> for StreamHealth {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StreamHealth::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamHealth {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamHealth::from(s))
    }
}
impl StreamHealth {
...
impl ::std::convert::AsRef<str> for StreamHealth {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
