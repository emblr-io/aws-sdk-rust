...
impl ::std::convert::From<&str> for StreamState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StreamState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamState::from(s))
    }
}
impl StreamState {
...
impl ::std::convert::AsRef<str> for StreamState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
