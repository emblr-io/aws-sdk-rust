...
impl PlaybackRestrictionPolicy {
    /// Creates a new builder-style object to manufacture [`PlaybackRestrictionPolicy`](crate::types::PlaybackRestrictionPolicy).
    pub fn builder() -> crate::types::builders::PlaybackRestrictionPolicyBuilder {
        crate::types::builders::PlaybackRestrictionPolicyBuilder::default()
    }
}

/// A builder for [`PlaybackRestrictionPolicy`](crate::types::PlaybackRestrictionPolicy).
...
impl PlaybackRestrictionPolicyBuilder {
    ...
    /// - [`arn`](crate::types::builders::PlaybackRestrictionPolicyBuilder::arn)
