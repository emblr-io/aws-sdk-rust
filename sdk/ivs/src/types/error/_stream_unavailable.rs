...
impl ::aws_types::request_id::RequestId for crate::types::error::StreamUnavailable {
...
impl StreamUnavailable {
    /// Creates a new builder-style object to manufacture [`StreamUnavailable`](crate::types::error::StreamUnavailable).
    pub fn builder() -> crate::types::error::builders::StreamUnavailableBuilder {
        crate::types::error::builders::StreamUnavailableBuilder::default()
    }
}
...
impl StreamUnavailableBuilder {
    ...
    /// Consumes the builder and constructs a [`StreamUnavailable`](crate::types::error::StreamUnavailable).
    pub fn build(self) -> crate::types::error::StreamUnavailable {
        crate::types::error::StreamUnavailable {
