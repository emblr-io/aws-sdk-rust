...
impl ::aws_types::request_id::RequestId for DeletePlaybackKeyPairOutput {
...
impl DeletePlaybackKeyPairOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeletePlaybackKeyPairOutput`](crate::operation::delete_playback_key_pair::DeletePlaybackKeyPairOutput).
    pub fn build(self) -> crate::operation::delete_playback_key_pair::DeletePlaybackKeyPairOutput {
