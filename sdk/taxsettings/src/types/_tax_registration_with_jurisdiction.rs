...
pub struct TaxRegistrationWithJurisdiction {
    ...
    pub jurisdiction: ::std::option::Option<crate::types::Jurisdiction>,
}
impl TaxRegistrationWithJurisdiction {
    /// <p>Your tax registration unique identifier.</p>
    ...
    /// <p>The jurisdiction associated with your TRN information.</p>
    pub fn jurisdiction(&self) -> ::std::option::Option<&crate::types::Jurisdiction> {
        self.jurisdiction.as_ref()
    }
}
impl ::std::fmt::Debug for TaxRegistrationWithJurisdiction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("TaxRegistrationWithJurisdiction");
        ...
        formatter.field("jurisdiction", &"*** Sensitive Data Redacted ***");
        formatter.finish()
    }
}
impl TaxRegistrationWithJurisdiction {
    /// Creates a new builder-style object to manufacture [`TaxRegistrationWithJurisdiction`](crate::types::TaxRegistrationWithJurisdiction).
    pub fn builder() -> crate::types::builders::TaxRegistrationWithJurisdictionBuilder {
        crate::types::builders::TaxRegistrationWithJurisdictionBuilder::default()
    }
}
...
pub struct TaxRegistrationWithJurisdictionBuilder {
    ...
    pub(crate) jurisdiction: ::std::option::Option<crate::types::Jurisdiction>,
}
impl TaxRegistrationWithJurisdictionBuilder {
    /// <p>Your tax registration unique identifier.</p>
    ...
    /// <p>The jurisdiction associated with your TRN information.</p>
    /// This field is required.
    pub fn jurisdiction(mut self, input: crate::types::Jurisdiction) -> Self {
        self.jurisdiction = ::std::option::Option::Some(input);
        self
    }
    /// <p>The jurisdiction associated with your TRN information.</p>
    pub fn set_jurisdiction(mut self, input: ::std::option::Option<crate::types::Jurisdiction>) -> Self {
        self.jurisdiction = input;
        self
    }
    /// <p>The jurisdiction associated with your TRN information.</p>
    pub fn get_jurisdiction(&self) -> &::std::option::Option<crate::types::Jurisdiction> {
        &self.jurisdiction
    }
    /// Consumes the builder and constructs a [`TaxRegistrationWithJurisdiction`](crate::types::TaxRegistrationWithJurisdiction).
    /// This method will fail if any of the following fields are not set:
    /// - [`registration_id`](crate::types::builders::TaxRegistrationWithJurisdictionBuilder::registration_id)
    /// - [`registration_type`](crate::types::builders::TaxRegistrationWithJurisdictionBuilder::registration_type)
    /// - [`legal_name`](crate::types::builders::TaxRegistrationWithJurisdictionBuilder::legal_name)
    /// - [`status`](crate::types::builders::TaxRegistrationWithJurisdictionBuilder::status)
    pub fn build(self) -> ::std::result::Result<crate::types::TaxRegistrationWithJurisdiction, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::TaxRegistrationWithJurisdiction {
            registration_id: self.registration_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "registration_id",
                    "registration_id was not specified but it is required when building TaxRegistrationWithJurisdiction",
                )
            })?,
            registration_type: self.registration_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "registration_type",
                    "registration_type was not specified but it is required when building TaxRegistrationWithJurisdiction",
                )
            })?,
            legal_name: self.legal_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "legal_name",
                    "legal_name was not specified but it is required when building TaxRegistrationWithJurisdiction",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building TaxRegistrationWithJurisdiction",
                )
            })?,
            sector: self.sector,
...
impl ::std::fmt::Debug for TaxRegistrationWithJurisdictionBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("TaxRegistrationWithJurisdictionBuilder");
        formatter.field("registration_id", &"*** Sensitive Data Redacted ***");
        formatter.field("registration_type", &"*** Sensitive Data Redacted ***");
        formatter.field("legal_name", &"*** Sensitive Data Redacted ***");
        formatter.field("status", &"*** Sensitive Data Redacted ***");
