...
impl ::std::convert::From<&str> for RuleIpOperator {
    fn from(s: &str) -> Self {
        match s {
            "CIDR_MATCHES" => RuleIpOperator::CidrMatches,
            "NOT_CIDR_MATCHES" => RuleIpOperator::NotCidrMatches,
            other => RuleIpOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RuleIpOperator {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RuleIpOperator::from(s))
    }
}
impl RuleIpOperator {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RuleIpOperator::CidrMatches => "CIDR_MATCHES",
            RuleIpOperator::NotCidrMatches => "NOT_CIDR_MATCHES",
            RuleIpOperator::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for RuleIpOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for RuleIpOperator {
