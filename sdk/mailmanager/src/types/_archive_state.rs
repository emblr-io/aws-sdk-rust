...
impl ::std::convert::From<&str> for ArchiveState {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PENDING_DELETION" => ArchiveState::PendingDeletion,
            other => ArchiveState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ArchiveState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ArchiveState::PendingDeletion => "PENDING_DELETION",
