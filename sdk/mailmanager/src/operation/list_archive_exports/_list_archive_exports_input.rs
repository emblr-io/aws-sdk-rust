...
pub struct ListArchiveExportsInput {
...
impl ListArchiveExportsInput {
    /// Creates a new builder-style object to manufacture [`ListArchiveExportsInput`](crate::operation::list_archive_exports::ListArchiveExportsInput).
    pub fn builder() -> crate::operation::list_archive_exports::builders::ListArchiveExportsInputBuilder {
        crate::operation::list_archive_exports::builders::ListArchiveExportsInputBuilder::default()
    }
}
...
impl ListArchiveExportsInputBuilder {
    /// <p>The identifier of the archive.</p>
    ...
    /// Consumes the builder and constructs a [`ListArchiveExportsInput`](crate::operation::list_archive_exports::ListArchiveExportsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_archive_exports::ListArchiveExportsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_archive_exports::ListArchiveExportsInput {
