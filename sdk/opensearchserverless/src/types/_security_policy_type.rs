...
impl ::std::convert::From<&str> for SecurityPolicyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SecurityPolicyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SecurityPolicyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SecurityPolicyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SecurityPolicyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
