...
impl VpcEndpointDetail {
    ...
    pub fn builder() -> crate::types::builders::VpcEndpointDetailBuilder {
        crate::types::builders::VpcEndpointDetailBuilder::default()
    }
}

/// A builder for [`VpcEndpointDetail`](crate::types::VpcEndpointDetail).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct VpcEndpointDetailBuilder {
