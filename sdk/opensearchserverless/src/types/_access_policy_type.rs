...
impl ::std::convert::From<&str> for AccessPolicyType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AccessPolicyType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AccessPolicyType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AccessPolicyType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AccessPolicyType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AccessPolicyType {
