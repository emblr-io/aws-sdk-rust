...
//! offered by OpenSearch Service Serverless. The return value of each of these methods is a "fluent builder",
...
/// Client for calling OpenSearch Service Serverless.
...
/// Configuration for OpenSearch Service Serverless.
pub mod config;
