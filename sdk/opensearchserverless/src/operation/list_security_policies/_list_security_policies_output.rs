...
impl ListSecurityPoliciesOutput {
    ...
    pub fn security_policy_summaries(&self) -> &[crate::types::SecurityPolicySummary] {
        self.security_policy_summaries.as_deref().unwrap_or_default()
    }
    /// <p>When <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page.</p>
...
impl ListSecurityPoliciesOutputBuilder {
    ...
    pub fn security_policy_summaries(mut self, input: crate::types::SecurityPolicySummary) -> Self {
        ...
        v.push(input);
        self.security_policy_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>Details about the security policies in your account.</p>
    ...
    /// <p>Details about the security policies in your account.</p>
    pub fn get_security_policy_summaries(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::SecurityPolicySummary>> {
        &self.security_policy_summaries
    }
    /// <p>When <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page.</p>
