...
//! aws-sdk-workmailmessageflow = "0.0.0-local"
...
//! offered by Amazon WorkMail Message Flow. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon WorkMail Message Flow.
...
/// For example, the [`GetRawMessageContent`](crate::operation::get_raw_message_content) operation has
...
/// Configuration for Amazon WorkMail Message Flow.
pub mod config;
