...
impl ::aws_types::request_id::RequestId for DeleteLoadBalancerOutput {
...
impl DeleteLoadBalancerOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteLoadBalancerOutput`](crate::operation::delete_load_balancer::DeleteLoadBalancerOutput).
    pub fn build(self) -> crate::operation::delete_load_balancer::DeleteLoadBalancerOutput {
