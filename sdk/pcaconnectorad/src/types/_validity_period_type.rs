...
impl ::std::convert::From<&str> for ValidityPeriodType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "HOURS" => ValidityPeriodType::Hours,
            "MONTHS" => ValidityPeriodType::Months,
            "WEEKS" => ValidityPeriodType::Weeks,
            "YEARS" => ValidityPeriodType::Years,
            other => ValidityPeriodType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValidityPeriodType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValidityPeriodType::from(s))
    }
}
impl ValidityPeriodType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ValidityPeriodType::Hours => "HOURS",
            ValidityPeriodType::Months => "MONTHS",
            ValidityPeriodType::Weeks => "WEEKS",
...
impl ::std::convert::AsRef<str> for ValidityPeriodType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ValidityPeriodType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ValidityPeriodType::Days => write!(f, "DAYS"),
            ValidityPeriodType::Hours => write!(f, "HOURS"),
