...
impl EnrollmentFlagsV4 {
    /// Creates a new builder-style object to manufacture [`EnrollmentFlagsV4`](crate::types::EnrollmentFlagsV4).
    pub fn builder() -> crate::types::builders::EnrollmentFlagsV4Builder {
        crate::types::builders::EnrollmentFlagsV4Builder::default()
    }
}

/// A builder for [`EnrollmentFlagsV4`](crate::types::EnrollmentFlagsV4).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct EnrollmentFlagsV4Builder {
...
impl EnrollmentFlagsV4Builder {
    ...
    /// Consumes the builder and constructs a [`EnrollmentFlagsV4`](crate::types::EnrollmentFlagsV4).
    pub fn build(self) -> crate::types::EnrollmentFlagsV4 {
        crate::types::EnrollmentFlagsV4 {
