...
/// <p>General flags for v4 template schema that defines if the template is for a machine or a user and if the template can be issued using autoenrollment.</p>
#[non_exhaustive]
...
impl GeneralFlagsV4 {
    /// Creates a new builder-style object to manufacture [`GeneralFlagsV4`](crate::types::GeneralFlagsV4).
    pub fn builder() -> crate::types::builders::GeneralFlagsV4Builder {
        crate::types::builders::GeneralFlagsV4Builder::default()
    }
}

/// A builder for [`GeneralFlagsV4`](crate::types::GeneralFlagsV4).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GeneralFlagsV4Builder {
    pub(crate) auto_enrollment: ::std::option::Option<bool>,
    pub(crate) machine_type: ::std::option::Option<bool>,
}
impl GeneralFlagsV4Builder {
    /// <p>Allows certificate issuance using autoenrollment. Set to TRUE to allow autoenrollment.</p>
    ...
    /// Consumes the builder and constructs a [`GeneralFlagsV4`](crate::types::GeneralFlagsV4).
    pub fn build(self) -> crate::types::GeneralFlagsV4 {
        crate::types::GeneralFlagsV4 {
