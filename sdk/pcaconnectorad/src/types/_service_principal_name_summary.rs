...
impl ServicePrincipalNameSummary {
    /// Creates a new builder-style object to manufacture [`ServicePrincipalNameSummary`](crate::types::ServicePrincipalNameSummary).
    pub fn builder() -> crate::types::builders::ServicePrincipalNameSummaryBuilder {
        crate::types::builders::ServicePrincipalNameSummaryBuilder::default()
    }
}
...
impl ServicePrincipalNameSummaryBuilder {
    /// <p>The Amazon Resource Name (ARN) that was returned when you called <a href="https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateDirectoryRegistration.html">CreateDirectoryRegistration</a>.</p>
