...
/// When writing a match expression against `ClientCompatibilityV4`, it is important to ensure
...
///     ClientCompatibilityV4::WindowsServer2012 => { /* ... */ },
///     ClientCompatibilityV4::WindowsServer2012R2 => { /* ... */ },
///     ClientCompatibilityV4::WindowsServer2016 => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `clientcompatibilityv4` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ClientCompatibilityV4::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ClientCompatibilityV4::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ClientCompatibilityV4::NewFeature` is defined.
