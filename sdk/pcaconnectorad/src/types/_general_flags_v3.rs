...
impl GeneralFlagsV3 {
    /// Creates a new builder-style object to manufacture [`GeneralFlagsV3`](crate::types::GeneralFlagsV3).
    pub fn builder() -> crate::types::builders::GeneralFlagsV3Builder {
        crate::types::builders::GeneralFlagsV3Builder::default()
    }
}

/// A builder for [`GeneralFlagsV3`](crate::types::GeneralFlagsV3).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GeneralFlagsV3Builder {
    pub(crate) auto_enrollment: ::std::option::Option<bool>,
    pub(crate) machine_type: ::std::option::Option<bool>,
}
impl GeneralFlagsV3Builder {
    /// <p>Allows certificate issuance using autoenrollment. Set to TRUE to allow autoenrollment.</p>
    ...
    /// Consumes the builder and constructs a [`GeneralFlagsV3`](crate::types::GeneralFlagsV3).
    pub fn build(self) -> crate::types::GeneralFlagsV3 {
        crate::types::GeneralFlagsV3 {
