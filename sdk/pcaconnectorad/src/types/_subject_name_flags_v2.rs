...
impl SubjectNameFlagsV2 {
    /// Creates a new builder-style object to manufacture [`SubjectNameFlagsV2`](crate::types::SubjectNameFlagsV2).
    pub fn builder() -> crate::types::builders::SubjectNameFlagsV2Builder {
        crate::types::builders::SubjectNameFlagsV2Builder::default()
    }
}
...
impl SubjectNameFlagsV2Builder {
    /// <p>Include the domain DNS in the subject alternate name.</p>
    ...
    /// Consumes the builder and constructs a [`SubjectNameFlagsV2`](crate::types::SubjectNameFlagsV2).
    pub fn build(self) -> crate::types::SubjectNameFlagsV2 {
        crate::types::SubjectNameFlagsV2 {
