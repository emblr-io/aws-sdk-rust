...
impl SubjectNameFlagsV3 {
    /// Creates a new builder-style object to manufacture [`SubjectNameFlagsV3`](crate::types::SubjectNameFlagsV3).
    pub fn builder() -> crate::types::builders::SubjectNameFlagsV3Builder {
        crate::types::builders::SubjectNameFlagsV3Builder::default()
    }
}

/// A builder for [`SubjectNameFlagsV3`](crate::types::SubjectNameFlagsV3).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SubjectNameFlagsV3Builder {
...
impl SubjectNameFlagsV3Builder {
    /// <p>Include the domain DNS in the subject alternate name.</p>
    ...
    /// Consumes the builder and constructs a [`SubjectNameFlagsV3`](crate::types::SubjectNameFlagsV3).
    pub fn build(self) -> crate::types::SubjectNameFlagsV3 {
        crate::types::SubjectNameFlagsV3 {
