...
impl ::aws_types::request_id::RequestId for SendTaskSuccessOutput {
...
impl SendTaskSuccessOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`SendTaskSuccessOutput`](crate::operation::send_task_success::SendTaskSuccessOutput).
    pub fn build(self) -> crate::operation::send_task_success::SendTaskSuccessOutput {
