...
impl ::std::convert::From<&str> for MapRunStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MapRunStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MapRunStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MapRunStatus::from(s))
    }
}
impl MapRunStatus {
...
impl ::std::convert::AsRef<str> for MapRunStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
