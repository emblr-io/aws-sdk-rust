...
impl ::std::convert::From<&str> for StateMachineStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StateMachineStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StateMachineStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StateMachineStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StateMachineStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
