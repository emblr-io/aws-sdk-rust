...
impl ::std::convert::From<&str> for HistoryEventType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HistoryEventType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HistoryEventType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HistoryEventType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HistoryEventType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for HistoryEventType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            HistoryEventType::ActivityFailed => write!(f, "ActivityFailed"),
            HistoryEventType::ActivityScheduleFailed => write!(f, "ActivityScheduleFailed"),
            HistoryEventType::ActivityScheduled => write!(f, "ActivityScheduled"),
            HistoryEventType::ActivityStarted => write!(f, "ActivityStarted"),
            HistoryEventType::ActivitySucceeded => write!(f, "ActivitySucceeded"),
            ...
            HistoryEventType::ExecutionStarted => write!(f, "ExecutionStarted"),
            HistoryEventType::ExecutionSucceeded => write!(f, "ExecutionSucceeded"),
            HistoryEventType::ExecutionTimedOut => write!(f, "ExecutionTimedOut"),
            HistoryEventType::FailStateEntered => write!(f, "FailStateEntered"),
            HistoryEventType::LambdaFunctionFailed => write!(f, "LambdaFunctionFailed"),
            HistoryEventType::LambdaFunctionScheduleFailed => write!(f, "LambdaFunctionScheduleFailed"),
            HistoryEventType::LambdaFunctionScheduled => write!(f, "LambdaFunctionScheduled"),
            HistoryEventType::LambdaFunctionStartFailed => write!(f, "LambdaFunctionStartFailed"),
            HistoryEventType::LambdaFunctionStarted => write!(f, "LambdaFunctionStarted"),
            HistoryEventType::LambdaFunctionSucceeded => write!(f, "LambdaFunctionSucceeded"),
            HistoryEventType::LambdaFunctionTimedOut => write!(f, "LambdaFunctionTimedOut"),
            HistoryEventType::MapIterationAborted => write!(f, "MapIterationAborted"),
            HistoryEventType::MapIterationFailed => write!(f, "MapIterationFailed"),
            HistoryEventType::MapIterationStarted => write!(f, "MapIterationStarted"),
            HistoryEventType::MapIterationSucceeded => write!(f, "MapIterationSucceeded"),
            HistoryEventType::MapRunAborted => write!(f, "MapRunAborted"),
            HistoryEventType::MapRunFailed => write!(f, "MapRunFailed"),
            HistoryEventType::MapRunRedriven => write!(f, "MapRunRedriven"),
            HistoryEventType::MapRunStarted => write!(f, "MapRunStarted"),
            HistoryEventType::MapRunSucceeded => write!(f, "MapRunSucceeded"),
            HistoryEventType::MapStateAborted => write!(f, "MapStateAborted"),
            HistoryEventType::MapStateEntered => write!(f, "MapStateEntered"),
            HistoryEventType::MapStateExited => write!(f, "MapStateExited"),
            HistoryEventType::MapStateFailed => write!(f, "MapStateFailed"),
            HistoryEventType::MapStateStarted => write!(f, "MapStateStarted"),
            HistoryEventType::MapStateSucceeded => write!(f, "MapStateSucceeded"),
            HistoryEventType::ParallelStateAborted => write!(f, "ParallelStateAborted"),
            HistoryEventType::ParallelStateEntered => write!(f, "ParallelStateEntered"),
            HistoryEventType::ParallelStateExited => write!(f, "ParallelStateExited"),
            HistoryEventType::ParallelStateFailed => write!(f, "ParallelStateFailed"),
            HistoryEventType::ParallelStateStarted => write!(f, "ParallelStateStarted"),
            HistoryEventType::ParallelStateSucceeded => write!(f, "ParallelStateSucceeded"),
            HistoryEventType::PassStateEntered => write!(f, "PassStateEntered"),
            HistoryEventType::PassStateExited => write!(f, "PassStateExited"),
            HistoryEventType::SucceedStateEntered => write!(f, "SucceedStateEntered"),
            HistoryEventType::SucceedStateExited => write!(f, "SucceedStateExited"),
            HistoryEventType::TaskFailed => write!(f, "TaskFailed"),
            HistoryEventType::TaskScheduled => write!(f, "TaskScheduled"),
            HistoryEventType::TaskStartFailed => write!(f, "TaskStartFailed"),
            HistoryEventType::TaskStarted => write!(f, "TaskStarted"),
            HistoryEventType::TaskStateAborted => write!(f, "TaskStateAborted"),
            HistoryEventType::TaskStateEntered => write!(f, "TaskStateEntered"),
            HistoryEventType::TaskStateExited => write!(f, "TaskStateExited"),
            HistoryEventType::TaskSubmitFailed => write!(f, "TaskSubmitFailed"),
            HistoryEventType::TaskSubmitted => write!(f, "TaskSubmitted"),
            HistoryEventType::TaskSucceeded => write!(f, "TaskSucceeded"),
            HistoryEventType::TaskTimedOut => write!(f, "TaskTimedOut"),
