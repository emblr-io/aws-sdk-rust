...
impl ::std::convert::From<&str> for StateMachineType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StateMachineType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StateMachineType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StateMachineType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StateMachineType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
