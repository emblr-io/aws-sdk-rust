...
impl ::std::convert::From<&str> for InspectionLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InspectionLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InspectionLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InspectionLevel::from(s))
    }
}
impl InspectionLevel {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            InspectionLevel::Debug => "DEBUG",
            InspectionLevel::Info => "INFO",
            InspectionLevel::Trace => "TRACE",
...
impl ::std::convert::AsRef<str> for InspectionLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
