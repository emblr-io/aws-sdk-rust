...
pub enum ValidateStateMachineDefinitionResultCode {
    #[allow(missing_docs)] // documentation missing in model
    Fail,
    #[allow(missing_docs)] // documentation missing in model
    Ok,
...
impl ::std::convert::From<&str> for ValidateStateMachineDefinitionResultCode {
    fn from(s: &str) -> Self {
        match s {
            "FAIL" => ValidateStateMachineDefinitionResultCode::Fail,
            "OK" => ValidateStateMachineDefinitionResultCode::Ok,
            other => ValidateStateMachineDefinitionResultCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ValidateStateMachineDefinitionResultCode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ValidateStateMachineDefinitionResultCode::from(s))
    }
}
impl ValidateStateMachineDefinitionResultCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ValidateStateMachineDefinitionResultCode::Fail => "FAIL",
            ValidateStateMachineDefinitionResultCode::Ok => "OK",
            ValidateStateMachineDefinitionResultCode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ValidateStateMachineDefinitionResultCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ValidateStateMachineDefinitionResultCode {
