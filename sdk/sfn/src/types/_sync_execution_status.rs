...
impl ::std::convert::From<&str> for SyncExecutionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SyncExecutionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SyncExecutionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SyncExecutionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SyncExecutionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
