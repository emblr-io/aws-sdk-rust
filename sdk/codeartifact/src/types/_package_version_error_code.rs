...
/// When writing a match expression against `PackageVersionErrorCode`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `packageversionerrorcode` represents
...
/// version of SDK where the variant `PackageVersionErrorCode::NewFeature` is defined.
...
impl ::std::convert::From<&str> for PackageVersionErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PackageVersionErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PackageVersionErrorCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PackageVersionErrorCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PackageVersionErrorCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
