...
impl CopyPackageVersionsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CopyPackageVersionsOutput`](crate::operation::copy_package_versions::CopyPackageVersionsOutput).
    pub fn build(self) -> crate::operation::copy_package_versions::CopyPackageVersionsOutput {
