...
impl ::std::fmt::Debug for GetAuthorizationTokenOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("authorization_token", &"*** Sensitive Data Redacted ***");
...
impl ::std::fmt::Debug for GetAuthorizationTokenOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetAuthorizationTokenOutputBuilder");
        formatter.field("authorization_token", &"*** Sensitive Data Redacted ***");
        formatter.field("expiration", &"*** Sensitive Data Redacted ***");
        formatter.field("_request_id", &self._request_id);
        formatter.finish()
