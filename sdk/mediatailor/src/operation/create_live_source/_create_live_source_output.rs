...
impl ::aws_types::request_id::RequestId for CreateLiveSourceOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateLiveSourceOutput {
    /// Creates a new builder-style object to manufacture [`CreateLiveSourceOutput`](crate::operation::create_live_source::CreateLiveSourceOutput).
    pub fn builder() -> crate::operation::create_live_source::builders::CreateLiveSourceOutputBuilder {
        crate::operation::create_live_source::builders::CreateLiveSourceOutputBuilder::default()
    }
}
...
impl CreateLiveSourceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateLiveSourceOutput`](crate::operation::create_live_source::CreateLiveSourceOutput).
    pub fn build(self) -> crate::operation::create_live_source::CreateLiveSourceOutput {
