...
impl ListVodSourcesInput {
    /// Creates a new builder-style object to manufacture [`ListVodSourcesInput`](crate::operation::list_vod_sources::ListVodSourcesInput).
    pub fn builder() -> crate::operation::list_vod_sources::builders::ListVodSourcesInputBuilder {
        crate::operation::list_vod_sources::builders::ListVodSourcesInputBuilder::default()
    }
}
...
impl ListVodSourcesInputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_vod_sources::ListVodSourcesInput, ::aws_smithy_types::error::operation::BuildError> {
