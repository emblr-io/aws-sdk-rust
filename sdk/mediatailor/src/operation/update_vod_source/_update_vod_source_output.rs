...
impl ::aws_types::request_id::RequestId for UpdateVodSourceOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateVodSourceOutput {
    /// Creates a new builder-style object to manufacture [`UpdateVodSourceOutput`](crate::operation::update_vod_source::UpdateVodSourceOutput).
    pub fn builder() -> crate::operation::update_vod_source::builders::UpdateVodSourceOutputBuilder {
        crate::operation::update_vod_source::builders::UpdateVodSourceOutputBuilder::default()
    }
}

/// A builder for [`UpdateVodSourceOutput`](crate::operation::update_vod_source::UpdateVodSourceOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateVodSourceOutputBuilder {
...
impl UpdateVodSourceOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) associated with the VOD source.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateVodSourceOutput`](crate::operation::update_vod_source::UpdateVodSourceOutput).
    pub fn build(self) -> crate::operation::update_vod_source::UpdateVodSourceOutput {
