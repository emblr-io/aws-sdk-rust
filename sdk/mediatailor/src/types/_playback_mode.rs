...
impl ::std::convert::From<&str> for PlaybackMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlaybackMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlaybackMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlaybackMode::from(s))
    }
}
impl PlaybackMode {
...
impl ::std::convert::AsRef<str> for PlaybackMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
