...
impl SourceLocation {
    /// Creates a new builder-style object to manufacture [`SourceLocation`](crate::types::SourceLocation).
    pub fn builder() -> crate::types::builders::SourceLocationBuilder {
        crate::types::builders::SourceLocationBuilder::default()
    }
}
