...
pub struct DescribeMetadataModelConversionsInput {
...
impl DescribeMetadataModelConversionsInput {
    /// Creates a new builder-style object to manufacture [`DescribeMetadataModelConversionsInput`](crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsInput).
    pub fn builder() -> crate::operation::describe_metadata_model_conversions::builders::DescribeMetadataModelConversionsInputBuilder {
        crate::operation::describe_metadata_model_conversions::builders::DescribeMetadataModelConversionsInputBuilder::default()
    }
}

/// A builder for [`DescribeMetadataModelConversionsInput`](crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeMetadataModelConversionsInputBuilder {
...
impl DescribeMetadataModelConversionsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeMetadataModelConversionsInput`](crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsInput,
