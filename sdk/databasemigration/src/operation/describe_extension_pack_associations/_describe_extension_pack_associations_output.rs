...
pub struct DescribeExtensionPackAssociationsOutput {
...
impl ::aws_types::request_id::RequestId for DescribeExtensionPackAssociationsOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeExtensionPackAssociationsOutput {
    /// Creates a new builder-style object to manufacture [`DescribeExtensionPackAssociationsOutput`](crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsOutput).
    pub fn builder() -> crate::operation::describe_extension_pack_associations::builders::DescribeExtensionPackAssociationsOutputBuilder {
        crate::operation::describe_extension_pack_associations::builders::DescribeExtensionPackAssociationsOutputBuilder::default()
    }
}

/// A builder for [`DescribeExtensionPackAssociationsOutput`](crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeExtensionPackAssociationsOutputBuilder {
    pub(crate) marker: ::std::option::Option<::std::string::String>,
    pub(crate) requests: ::std::option::Option<::std::vec::Vec<crate::types::SchemaConversionRequest>>,
    _request_id: Option<String>,
}
impl DescribeExtensionPackAssociationsOutputBuilder {
    /// <p>Specifies the unique pagination token that makes it possible to display the next page of results. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>
    /// <p>If <code>Marker</code> is returned by a previous response, there are more results available. The value of <code>Marker</code> is a unique pagination token for each page. To retrieve the next page, make the call again using the returned token and keeping all other arguments unchanged.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeExtensionPackAssociationsOutput`](crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsOutput).
    pub fn build(self) -> crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsOutput {
