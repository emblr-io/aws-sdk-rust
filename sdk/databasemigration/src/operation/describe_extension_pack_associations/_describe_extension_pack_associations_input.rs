...
impl DescribeExtensionPackAssociationsInput {
    /// Creates a new builder-style object to manufacture [`DescribeExtensionPackAssociationsInput`](crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsInput).
    pub fn builder() -> crate::operation::describe_extension_pack_associations::builders::DescribeExtensionPackAssociationsInputBuilder {
        crate::operation::describe_extension_pack_associations::builders::DescribeExtensionPackAssociationsInputBuilder::default()
    }
}
...
impl DescribeExtensionPackAssociationsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeExtensionPackAssociationsInput`](crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
