...
pub struct DescribeReplicationConfigsInput {
...
impl DescribeReplicationConfigsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeReplicationConfigsInput`](crate::operation::describe_replication_configs::DescribeReplicationConfigsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
