...
pub struct DescribeMetadataModelAssessmentsInput {
...
impl DescribeMetadataModelAssessmentsInput {
    /// <p>The name or Amazon Resource Name (ARN) of the migration project.</p>
...
impl DescribeMetadataModelAssessmentsInput {
    /// Creates a new builder-style object to manufacture [`DescribeMetadataModelAssessmentsInput`](crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsInput).
    pub fn builder() -> crate::operation::describe_metadata_model_assessments::builders::DescribeMetadataModelAssessmentsInputBuilder {
        crate::operation::describe_metadata_model_assessments::builders::DescribeMetadataModelAssessmentsInputBuilder::default()
    }
}

/// A builder for [`DescribeMetadataModelAssessmentsInput`](crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeMetadataModelAssessmentsInputBuilder {
...
impl DescribeMetadataModelAssessmentsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeMetadataModelAssessmentsInput`](crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsInput,
