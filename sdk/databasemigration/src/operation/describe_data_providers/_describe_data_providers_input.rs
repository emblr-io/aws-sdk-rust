...
impl DescribeDataProvidersInput {
    /// Creates a new builder-style object to manufacture [`DescribeDataProvidersInput`](crate::operation::describe_data_providers::DescribeDataProvidersInput).
    pub fn builder() -> crate::operation::describe_data_providers::builders::DescribeDataProvidersInputBuilder {
        crate::operation::describe_data_providers::builders::DescribeDataProvidersInputBuilder::default()
    }
}

/// A builder for [`DescribeDataProvidersInput`](crate::operation::describe_data_providers::DescribeDataProvidersInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeDataProvidersInputBuilder {
