...
impl DescribeInstanceProfilesInput {
    /// Creates a new builder-style object to manufacture [`DescribeInstanceProfilesInput`](crate::operation::describe_instance_profiles::DescribeInstanceProfilesInput).
    pub fn builder() -> crate::operation::describe_instance_profiles::builders::DescribeInstanceProfilesInputBuilder {
        crate::operation::describe_instance_profiles::builders::DescribeInstanceProfilesInputBuilder::default()
    }
}
...
impl DescribeInstanceProfilesInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeInstanceProfilesInput`](crate::operation::describe_instance_profiles::DescribeInstanceProfilesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_instance_profiles::DescribeInstanceProfilesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::describe_instance_profiles::DescribeInstanceProfilesInput {
