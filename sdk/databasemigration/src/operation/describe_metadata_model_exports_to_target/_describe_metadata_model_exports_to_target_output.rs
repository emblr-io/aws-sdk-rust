...
pub struct DescribeMetadataModelExportsToTargetOutput {
...
impl DescribeMetadataModelExportsToTargetOutput {
    /// <p>Specifies the unique pagination token that makes it possible to display the next page of results. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>
    /// <p>If <code>Marker</code> is returned by a previous response, there are more results available. The value of <code>Marker</code> is a unique pagination token for each page. To retrieve the next page, make the call again using the returned token and keeping all other arguments unchanged.</p>
...
impl ::aws_types::request_id::RequestId for DescribeMetadataModelExportsToTargetOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeMetadataModelExportsToTargetOutput {
    /// Creates a new builder-style object to manufacture [`DescribeMetadataModelExportsToTargetOutput`](crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetOutput).
    pub fn builder() -> crate::operation::describe_metadata_model_exports_to_target::builders::DescribeMetadataModelExportsToTargetOutputBuilder {
        crate::operation::describe_metadata_model_exports_to_target::builders::DescribeMetadataModelExportsToTargetOutputBuilder::default()
    }
}

/// A builder for [`DescribeMetadataModelExportsToTargetOutput`](crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeMetadataModelExportsToTargetOutputBuilder {
    pub(crate) marker: ::std::option::Option<::std::string::String>,
    pub(crate) requests: ::std::option::Option<::std::vec::Vec<crate::types::SchemaConversionRequest>>,
    _request_id: Option<String>,
}
impl DescribeMetadataModelExportsToTargetOutputBuilder {
    /// <p>Specifies the unique pagination token that makes it possible to display the next page of results. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>
    /// <p>If <code>Marker</code> is returned by a previous response, there are more results available. The value of <code>Marker</code> is a unique pagination token for each page. To retrieve the next page, make the call again using the returned token and keeping all other arguments unchanged.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeMetadataModelExportsToTargetOutput`](crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetOutput).
    pub fn build(self) -> crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetOutput {
