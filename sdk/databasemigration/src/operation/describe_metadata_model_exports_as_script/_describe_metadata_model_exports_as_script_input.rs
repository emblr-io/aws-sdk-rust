...
pub struct DescribeMetadataModelExportsAsScriptInput {
...
impl DescribeMetadataModelExportsAsScriptInput {
    /// <p>The migration project name or Amazon Resource Name (ARN).</p>
...
impl DescribeMetadataModelExportsAsScriptInput {
    /// Creates a new builder-style object to manufacture [`DescribeMetadataModelExportsAsScriptInput`](crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptInput).
    pub fn builder() -> crate::operation::describe_metadata_model_exports_as_script::builders::DescribeMetadataModelExportsAsScriptInputBuilder {
        crate::operation::describe_metadata_model_exports_as_script::builders::DescribeMetadataModelExportsAsScriptInputBuilder::default()
    }
}

/// A builder for [`DescribeMetadataModelExportsAsScriptInput`](crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeMetadataModelExportsAsScriptInputBuilder {
...
impl DescribeMetadataModelExportsAsScriptInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeMetadataModelExportsAsScriptInput`](crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
