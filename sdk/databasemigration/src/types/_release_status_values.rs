...
impl ::std::convert::From<&str> for ReleaseStatusValues {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReleaseStatusValues::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReleaseStatusValues {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReleaseStatusValues::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReleaseStatusValues {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
