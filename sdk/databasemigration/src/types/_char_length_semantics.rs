...
impl ::std::convert::From<&str> for CharLengthSemantics {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CharLengthSemantics::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CharLengthSemantics {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CharLengthSemantics::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CharLengthSemantics {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
