...
impl ::std::convert::From<&str> for PluginNameValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PluginNameValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PluginNameValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PluginNameValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PluginNameValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
