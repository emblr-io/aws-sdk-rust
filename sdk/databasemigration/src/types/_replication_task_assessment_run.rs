...
impl ReplicationTaskAssessmentRunBuilder {
    ...
    pub fn replication_task_assessment_run_creation_date(mut self, input: ::aws_smithy_types::DateTime) -> Self {
        self.replication_task_assessment_run_creation_date = ::std::option::Option::Some(input);
        self
    }
    /// <p>Date on which the assessment run was created using the <code>StartReplicationTaskAssessmentRun</code> operation.</p>
    ...
    /// <p>Date on which the assessment run was created using the <code>StartReplicationTaskAssessmentRun</code> operation.</p>
    pub fn get_replication_task_assessment_run_creation_date(&self) -> &::std::option::Option<::aws_smithy_types::DateTime> {
