...
impl IbmDb2LuwDataProviderSettings {
    /// <p>The name of the DB2 LUW server.</p>
...
impl IbmDb2LuwDataProviderSettings {
    /// Creates a new builder-style object to manufacture [`IbmDb2LuwDataProviderSettings`](crate::types::IbmDb2LuwDataProviderSettings).
    pub fn builder() -> crate::types::builders::IbmDb2LuwDataProviderSettingsBuilder {
        crate::types::builders::IbmDb2LuwDataProviderSettingsBuilder::default()
    }
}

/// A builder for [`IbmDb2LuwDataProviderSettings`](crate::types::IbmDb2LuwDataProviderSettings).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct IbmDb2LuwDataProviderSettingsBuilder {
...
impl IbmDb2LuwDataProviderSettingsBuilder {
    /// <p>The name of the DB2 LUW server.</p>
    ...
    /// Consumes the builder and constructs a [`IbmDb2LuwDataProviderSettings`](crate::types::IbmDb2LuwDataProviderSettings).
    pub fn build(self) -> crate::types::IbmDb2LuwDataProviderSettings {
        crate::types::IbmDb2LuwDataProviderSettings {
