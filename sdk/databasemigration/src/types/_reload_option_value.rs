...
impl ::std::convert::From<&str> for ReloadOptionValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReloadOptionValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReloadOptionValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReloadOptionValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ReloadOptionValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
