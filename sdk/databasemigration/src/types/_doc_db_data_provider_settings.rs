...
impl DocDbDataProviderSettings {
    /// <p>The name of the source DocumentDB server.</p>
...
impl DocDbDataProviderSettings {
    /// Creates a new builder-style object to manufacture [`DocDbDataProviderSettings`](crate::types::DocDbDataProviderSettings).
    pub fn builder() -> crate::types::builders::DocDbDataProviderSettingsBuilder {
        crate::types::builders::DocDbDataProviderSettingsBuilder::default()
    }
}

/// A builder for [`DocDbDataProviderSettings`](crate::types::DocDbDataProviderSettings).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DocDbDataProviderSettingsBuilder {
...
impl DocDbDataProviderSettingsBuilder {
    /// <p>The name of the source DocumentDB server.</p>
    ...
    /// Consumes the builder and constructs a [`DocDbDataProviderSettings`](crate::types::DocDbDataProviderSettings).
    pub fn build(self) -> crate::types::DocDbDataProviderSettings {
        crate::types::DocDbDataProviderSettings {
