...
impl ::std::convert::From<&str> for CollectorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CollectorStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CollectorStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CollectorStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CollectorStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
