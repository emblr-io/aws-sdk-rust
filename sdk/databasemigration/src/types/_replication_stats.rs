...
impl ReplicationStats {
    /// Creates a new builder-style object to manufacture [`ReplicationStats`](crate::types::ReplicationStats).
    pub fn builder() -> crate::types::builders::ReplicationStatsBuilder {
        crate::types::builders::ReplicationStatsBuilder::default()
    }
}

/// A builder for [`ReplicationStats`](crate::types::ReplicationStats).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ReplicationStatsBuilder {
