...
impl ::std::convert::From<&str> for DatePartitionDelimiterValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatePartitionDelimiterValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatePartitionDelimiterValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatePartitionDelimiterValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatePartitionDelimiterValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
