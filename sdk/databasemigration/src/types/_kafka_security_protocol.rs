...
impl ::std::convert::From<&str> for KafkaSecurityProtocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => KafkaSecurityProtocol::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for KafkaSecurityProtocol {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KafkaSecurityProtocol::from(s))
    }
}
impl KafkaSecurityProtocol {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["plaintext", "sasl-ssl", "ssl-authentication", "ssl-encryption"]
    }
}
impl ::std::convert::AsRef<str> for KafkaSecurityProtocol {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
