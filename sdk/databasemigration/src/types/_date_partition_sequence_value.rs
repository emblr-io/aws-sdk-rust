...
impl ::std::convert::From<&str> for DatePartitionSequenceValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatePartitionSequenceValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatePartitionSequenceValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatePartitionSequenceValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatePartitionSequenceValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
