...
impl ::std::convert::From<&str> for RefreshSchemasStatusTypeValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RefreshSchemasStatusTypeValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RefreshSchemasStatusTypeValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RefreshSchemasStatusTypeValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RefreshSchemasStatusTypeValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
