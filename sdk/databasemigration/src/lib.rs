...
//! aws-sdk-databasemigration = "0.0.0-local"
...
//! offered by AWS Database Migration Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Database Migration Service.
...
/// Configuration for AWS Database Migration Service.
pub mod config;
