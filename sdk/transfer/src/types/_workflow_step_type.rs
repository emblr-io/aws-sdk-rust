...
impl ::std::convert::From<&str> for WorkflowStepType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkflowStepType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkflowStepType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkflowStepType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for WorkflowStepType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
