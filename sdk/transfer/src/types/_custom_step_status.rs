...
impl ::std::convert::From<&str> for CustomStepStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CustomStepStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomStepStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomStepStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CustomStepStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
