...
impl ::std::convert::From<&str> for OverwriteExisting {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OverwriteExisting::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OverwriteExisting {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OverwriteExisting::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for OverwriteExisting {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
