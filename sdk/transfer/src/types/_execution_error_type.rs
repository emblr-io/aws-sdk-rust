...
impl ::std::convert::From<&str> for ExecutionErrorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ExecutionErrorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ExecutionErrorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ExecutionErrorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ExecutionErrorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
