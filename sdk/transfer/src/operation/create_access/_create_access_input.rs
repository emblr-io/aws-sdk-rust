...
impl CreateAccessInput {
    /// Creates a new builder-style object to manufacture [`CreateAccessInput`](crate::operation::create_access::CreateAccessInput).
    pub fn builder() -> crate::operation::create_access::builders::CreateAccessInputBuilder {
        crate::operation::create_access::builders::CreateAccessInputBuilder::default()
    }
}
...
impl CreateAccessInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateAccessInput`](crate::operation::create_access::CreateAccessInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_access::CreateAccessInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_access::CreateAccessInput {
