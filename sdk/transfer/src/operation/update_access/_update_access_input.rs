...
impl UpdateAccessInput {
    /// Creates a new builder-style object to manufacture [`UpdateAccessInput`](crate::operation::update_access::UpdateAccessInput).
    pub fn builder() -> crate::operation::update_access::builders::UpdateAccessInputBuilder {
        crate::operation::update_access::builders::UpdateAccessInputBuilder::default()
    }
}

/// A builder for [`UpdateAccessInput`](crate::operation::update_access::UpdateAccessInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateAccessInputBuilder {
