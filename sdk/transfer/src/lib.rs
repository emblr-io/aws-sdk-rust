...
//! offered by AWS Transfer Family. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Transfer Family.
...
/// For example, the [`CreateAccess`](crate::operation::create_access) operation has
/// a [`Client::create_access`], function which returns a builder for that operation.
...
/// Configuration for AWS Transfer Family.
pub mod config;
