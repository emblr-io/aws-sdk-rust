...
//! aws-sdk-partnercentralselling = "0.0.0-local"
...
/// For example, the [`AcceptEngagementInvitation`](crate::operation::accept_engagement_invitation) operation has
/// a [`Client::accept_engagement_invitation`], function which returns a builder for that operation.
