...
///     ValidationExceptionReason::BusinessValidationFailed => { /* ... */ },
///     ValidationExceptionReason::RequestValidationFailed => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "BUSINESS_VALIDATION_FAILED" => ValidationExceptionReason::BusinessValidationFailed,
            "REQUEST_VALIDATION_FAILED" => ValidationExceptionReason::RequestValidationFailed,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ValidationExceptionReason::BusinessValidationFailed => "BUSINESS_VALIDATION_FAILED",
            ValidationExceptionReason::RequestValidationFailed => "REQUEST_VALIDATION_FAILED",
            ValidationExceptionReason::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["BUSINESS_VALIDATION_FAILED", "REQUEST_VALIDATION_FAILED"]
    }
}
...
impl ::std::fmt::Display for ValidationExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ValidationExceptionReason::BusinessValidationFailed => write!(f, "BUSINESS_VALIDATION_FAILED"),
            ValidationExceptionReason::RequestValidationFailed => write!(f, "REQUEST_VALIDATION_FAILED"),
