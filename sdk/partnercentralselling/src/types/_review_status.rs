...
/// match reviewstatus {
///     ReviewStatus::ActionRequired => { /* ... */ },
///     ReviewStatus::Approved => { /* ... */ },
///     ReviewStatus::InReview => { /* ... */ },
///     ReviewStatus::PendingSubmission => { /* ... */ },
...
impl ::std::convert::From<&str> for ReviewStatus {
    fn from(s: &str) -> Self {
        match s {
            "Action Required" => ReviewStatus::ActionRequired,
            "Approved" => ReviewStatus::Approved,
            "In review" => ReviewStatus::InReview,
            "Pending Submission" => ReviewStatus::PendingSubmission,
            "Rejected" => ReviewStatus::Rejected,
            "Submitted" => ReviewStatus::Submitted,
            other => ReviewStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReviewStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReviewStatus::from(s))
    }
}
impl ReviewStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ReviewStatus::ActionRequired => "Action Required",
            ReviewStatus::Approved => "Approved",
            ReviewStatus::InReview => "In review",
            ReviewStatus::PendingSubmission => "Pending Submission",
...
impl ::std::convert::AsRef<str> for ReviewStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ReviewStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ReviewStatus::ActionRequired => write!(f, "Action Required"),
            ReviewStatus::Approved => write!(f, "Approved"),
            ReviewStatus::InReview => write!(f, "In review"),
            ReviewStatus::PendingSubmission => write!(f, "Pending Submission"),
