...
impl ::aws_types::request_id::RequestId for ListMatchingJobsOutput {
...
impl ListMatchingJobsOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListMatchingJobsOutput`](crate::operation::list_matching_jobs::ListMatchingJobsOutput).
    pub fn build(self) -> crate::operation::list_matching_jobs::ListMatchingJobsOutput {
