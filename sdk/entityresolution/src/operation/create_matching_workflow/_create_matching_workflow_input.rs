...
impl CreateMatchingWorkflowInput {
    /// Creates a new builder-style object to manufacture [`CreateMatchingWorkflowInput`](crate::operation::create_matching_workflow::CreateMatchingWorkflowInput).
    pub fn builder() -> crate::operation::create_matching_workflow::builders::CreateMatchingWorkflowInputBuilder {
        crate::operation::create_matching_workflow::builders::CreateMatchingWorkflowInputBuilder::default()
    }
}

/// A builder for [`CreateMatchingWorkflowInput`](crate::operation::create_matching_workflow::CreateMatchingWorkflowInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateMatchingWorkflowInputBuilder {
