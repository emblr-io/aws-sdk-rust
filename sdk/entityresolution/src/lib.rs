...
//! aws-sdk-entityresolution = "0.0.0-local"
...
//! offered by AWS EntityResolution. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS EntityResolution.
...
/// Configuration for AWS EntityResolution.
pub mod config;
