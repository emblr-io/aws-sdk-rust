...
pub struct IdMappingTechniques {
    ...
    pub rule_based_properties: ::std::option::Option<crate::types::IdMappingRuleBasedProperties>,
...
impl IdMappingTechniques {
    ...
    /// <p>An object which defines any additional configurations required by rule-based matching.</p>
    pub fn rule_based_properties(&self) -> ::std::option::Option<&crate::types::IdMappingRuleBasedProperties> {
...
pub struct IdMappingTechniquesBuilder {
    ...
    pub(crate) rule_based_properties: ::std::option::Option<crate::types::IdMappingRuleBasedProperties>,
...
impl IdMappingTechniquesBuilder {
    ...
    /// <p>An object which defines any additional configurations required by rule-based matching.</p>
    pub fn rule_based_properties(mut self, input: crate::types::IdMappingRuleBasedProperties) -> Self {
        self.rule_based_properties = ::std::option::Option::Some(input);
        self
    }
    /// <p>An object which defines any additional configurations required by rule-based matching.</p>
    pub fn set_rule_based_properties(mut self, input: ::std::option::Option<crate::types::IdMappingRuleBasedProperties>) -> Self {
        self.rule_based_properties = input;
        self
    }
    /// <p>An object which defines any additional configurations required by rule-based matching.</p>
    pub fn get_rule_based_properties(&self) -> &::std::option::Option<crate::types::IdMappingRuleBasedProperties> {
