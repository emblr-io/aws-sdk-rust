...
impl ::std::convert::From<&str> for MatchPurpose {
    fn from(s: &str) -> Self {
        match s {
            "IDENTIFIER_GENERATION" => MatchPurpose::IdentifierGeneration,
            "INDEXING" => MatchPurpose::Indexing,
            other => MatchPurpose::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MatchPurpose {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MatchPurpose::from(s))
    }
}
impl MatchPurpose {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MatchPurpose::IdentifierGeneration => "IDENTIFIER_GENERATION",
            MatchPurpose::Indexing => "INDEXING",
            MatchPurpose::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for MatchPurpose {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for MatchPurpose {
