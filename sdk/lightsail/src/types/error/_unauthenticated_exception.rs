...
impl ::std::fmt::Display for UnauthenticatedException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "UnauthenticatedException")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::UnauthenticatedException {
...
impl UnauthenticatedException {
    ...
    pub fn builder() -> crate::types::error::builders::UnauthenticatedExceptionBuilder {
...
impl UnauthenticatedExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
