...
pub struct ContainerServiceDeployment {
    ...
    /// <ul>
    /// <li>
    /// <p><code>ACTIVATING</code> - The deployment is being created.</p></li>
    /// <li>
    /// <p><code>ACTIVE</code> - The deployment was successfully created, and it's currently running on the container service. The container service can have only one deployment in an active state at a time.</p></li>
    /// <li>
    /// <p><code>INACTIVE</code> - The deployment was previously successfully created, but it is not currently running on the container service.</p></li>
    /// <li>
