...
impl ::std::convert::From<&str> for HttpProtocolIpv6 {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HttpProtocolIpv6::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HttpProtocolIpv6 {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HttpProtocolIpv6::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HttpProtocolIpv6 {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
