...
impl ::std::convert::From<&str> for LoadBalancerTlsCertificateRenewalStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoadBalancerTlsCertificateRenewalStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LoadBalancerTlsCertificateRenewalStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LoadBalancerTlsCertificateRenewalStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LoadBalancerTlsCertificateRenewalStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
