...
impl ::std::convert::From<&str> for InstanceMetricName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceMetricName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceMetricName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceMetricName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceMetricName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
