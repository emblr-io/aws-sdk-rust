...
impl ::std::convert::From<&str> for InstanceHealthReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceHealthReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceHealthReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceHealthReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceHealthReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
