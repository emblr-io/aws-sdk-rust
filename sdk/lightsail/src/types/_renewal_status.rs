...
impl ::std::convert::From<&str> for RenewalStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RenewalStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RenewalStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RenewalStatus::from(s))
    }
}
impl RenewalStatus {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["Failed", "PendingAutoRenewal", "PendingValidation", "Success"]
    }
}
impl ::std::convert::AsRef<str> for RenewalStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
