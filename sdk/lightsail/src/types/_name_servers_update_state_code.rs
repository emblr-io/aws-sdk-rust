...
impl ::std::convert::From<&str> for NameServersUpdateStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NameServersUpdateStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NameServersUpdateStateCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NameServersUpdateStateCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NameServersUpdateStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
