...
/// }
/// ```
/// The above code demonstrates that when `blueprinttype` represents
...
/// version of SDK where the variant `BlueprintType::NewFeature` is defined.
/// Specifically, when `blueprinttype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `BlueprintType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for BlueprintType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "os" => BlueprintType::Os,
            other => BlueprintType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BlueprintType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BlueprintType::from(s))
    }
}
impl BlueprintType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            BlueprintType::Os => "os",
            BlueprintType::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for BlueprintType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
