...
impl ::std::fmt::Display for OperationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OperationType::AllocateStaticIp => write!(f, "AllocateStaticIp"),
            OperationType::AttachCertificateToDistribution => write!(f, "AttachCertificateToDistribution"),
            OperationType::AttachDisk => write!(f, "AttachDisk"),
            OperationType::AttachInstancesToLoadBalancer => write!(f, "AttachInstancesToLoadBalancer"),
            OperationType::AttachLoadBalancerTlsCertificate => write!(f, "AttachLoadBalancerTlsCertificate"),
            OperationType::AttachStaticIp => write!(f, "AttachStaticIp"),
            OperationType::CloseInstancePublicPorts => write!(f, "CloseInstancePublicPorts"),
            OperationType::CreateBucket => write!(f, "CreateBucket"),
            OperationType::CreateBucketAccessKey => write!(f, "CreateBucketAccessKey"),
            OperationType::CreateCertificate => write!(f, "CreateCertificate"),
            OperationType::CreateContactMethod => write!(f, "CreateContactMethod"),
            OperationType::CreateContainerService => write!(f, "CreateContainerService"),
            OperationType::CreateContainerServiceDeployment => write!(f, "CreateContainerServiceDeployment"),
            OperationType::CreateContainerServiceRegistryLogin => write!(f, "CreateContainerServiceRegistryLogin"),
            OperationType::CreateDisk => write!(f, "CreateDisk"),
            OperationType::CreateDiskFromSnapshot => write!(f, "CreateDiskFromSnapshot"),
            OperationType::CreateDiskSnapshot => write!(f, "CreateDiskSnapshot"),
            OperationType::CreateDistribution => write!(f, "CreateDistribution"),
            OperationType::CreateDomain => write!(f, "CreateDomain"),
            OperationType::CreateInstance => write!(f, "CreateInstance"),
            OperationType::CreateInstanceSnapshot => write!(f, "CreateInstanceSnapshot"),
            OperationType::CreateInstancesFromSnapshot => write!(f, "CreateInstancesFromSnapshot"),
            OperationType::CreateLoadBalancer => write!(f, "CreateLoadBalancer"),
            OperationType::CreateLoadBalancerTlsCertificate => write!(f, "CreateLoadBalancerTlsCertificate"),
            OperationType::CreateRelationalDatabase => write!(f, "CreateRelationalDatabase"),
            OperationType::CreateRelationalDatabaseFromSnapshot => write!(f, "CreateRelationalDatabaseFromSnapshot"),
            OperationType::CreateRelationalDatabaseSnapshot => write!(f, "CreateRelationalDatabaseSnapshot"),
            OperationType::DeleteAlarm => write!(f, "DeleteAlarm"),
            OperationType::DeleteBucket => write!(f, "DeleteBucket"),
            OperationType::DeleteBucketAccessKey => write!(f, "DeleteBucketAccessKey"),
            OperationType::DeleteCertificate => write!(f, "DeleteCertificate"),
            OperationType::DeleteContactMethod => write!(f, "DeleteContactMethod"),
            OperationType::DeleteContainerImage => write!(f, "DeleteContainerImage"),
            OperationType::DeleteContainerService => write!(f, "DeleteContainerService"),
            OperationType::DeleteDisk => write!(f, "DeleteDisk"),
            OperationType::DeleteDiskSnapshot => write!(f, "DeleteDiskSnapshot"),
            OperationType::DeleteDistribution => write!(f, "DeleteDistribution"),
            OperationType::DeleteDomain => write!(f, "DeleteDomain"),
            OperationType::DeleteDomainEntry => write!(f, "DeleteDomainEntry"),
            OperationType::DeleteInstance => write!(f, "DeleteInstance"),
            OperationType::DeleteInstanceSnapshot => write!(f, "DeleteInstanceSnapshot"),
            OperationType::DeleteKnownHostKeys => write!(f, "DeleteKnownHostKeys"),
            OperationType::DeleteLoadBalancer => write!(f, "DeleteLoadBalancer"),
            OperationType::DeleteLoadBalancerTlsCertificate => write!(f, "DeleteLoadBalancerTlsCertificate"),
            OperationType::DeleteRelationalDatabase => write!(f, "DeleteRelationalDatabase"),
            OperationType::DeleteRelationalDatabaseSnapshot => write!(f, "DeleteRelationalDatabaseSnapshot"),
            OperationType::DetachCertificateFromDistribution => write!(f, "DetachCertificateFromDistribution"),
            OperationType::DetachDisk => write!(f, "DetachDisk"),
            OperationType::DetachInstancesFromLoadBalancer => write!(f, "DetachInstancesFromLoadBalancer"),
            OperationType::DetachStaticIp => write!(f, "DetachStaticIp"),
            OperationType::DisableAddOn => write!(f, "DisableAddOn"),
            ...
            OperationType::RebootInstance => write!(f, "RebootInstance"),
            OperationType::RebootRelationalDatabase => write!(f, "RebootRelationalDatabase"),
            OperationType::RegisterContainerImage => write!(f, "RegisterContainerImage"),
            OperationType::ReleaseStaticIp => write!(f, "ReleaseStaticIp"),
            OperationType::ResetDistributionCache => write!(f, "ResetDistributionCache"),
            OperationType::SendContactMethodVerification => write!(f, "SendContactMethodVerification"),
            OperationType::SetIpAddressType => write!(f, "SetIpAddressType"),
            OperationType::SetResourceAccessForBucket => write!(f, "SetResourceAccessForBucket"),
            OperationType::SetupInstanceHttps => write!(f, "SetupInstanceHttps"),
            OperationType::StartGuiSession => write!(f, "StartGUISession"),
            OperationType::StartInstance => write!(f, "StartInstance"),
            OperationType::StartRelationalDatabase => write!(f, "StartRelationalDatabase"),
            OperationType::StopGuiSession => write!(f, "StopGUISession"),
            OperationType::StopInstance => write!(f, "StopInstance"),
            OperationType::StopRelationalDatabase => write!(f, "StopRelationalDatabase"),
            OperationType::TestAlarm => write!(f, "TestAlarm"),
            OperationType::UpdateBucket => write!(f, "UpdateBucket"),
            OperationType::UpdateBucketBundle => write!(f, "UpdateBucketBundle"),
            OperationType::UpdateContainerService => write!(f, "UpdateContainerService"),
            OperationType::UpdateDistribution => write!(f, "UpdateDistribution"),
            OperationType::UpdateDistributionBundle => write!(f, "UpdateDistributionBundle"),
            OperationType::UpdateDomainEntry => write!(f, "UpdateDomainEntry"),
            OperationType::UpdateInstanceMetadataOptions => write!(f, "UpdateInstanceMetadataOptions"),
