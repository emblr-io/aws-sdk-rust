...
impl HeaderObject {
    ...
    /// <p>The specific headers to forward to your distribution's origin.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.headers_allow_list.is_none()`.
    pub fn headers_allow_list(&self) -> &[crate::types::HeaderEnum] {
        self.headers_allow_list.as_deref().unwrap_or_default()
    }
}
impl HeaderObject {
