...
impl ::std::convert::From<&str> for LoadBalancerTlsCertificateDnsRecordCreationStateCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LoadBalancerTlsCertificateDnsRecordCreationStateCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl ::std::convert::AsRef<str> for LoadBalancerTlsCertificateDnsRecordCreationStateCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
