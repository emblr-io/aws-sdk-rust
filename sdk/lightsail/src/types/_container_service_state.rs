...
impl ::std::convert::From<&str> for ContainerServiceState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ContainerServiceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ContainerServiceState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ContainerServiceState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ContainerServiceState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
