...
/// }
/// ```
/// The above code demonstrates that when `recordstate` represents
...
/// version of SDK where the variant `RecordState::NewFeature` is defined.
/// Specifically, when `recordstate` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RecordState::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for RecordState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RecordState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RecordState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RecordState::from(s))
    }
}
impl RecordState {
...
impl ::std::convert::AsRef<str> for RecordState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
