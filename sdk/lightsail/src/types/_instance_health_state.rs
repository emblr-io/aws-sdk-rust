...
impl ::std::convert::From<&str> for InstanceHealthState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceHealthState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceHealthState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceHealthState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceHealthState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
