...
impl ::std::convert::From<&str> for DiskSnapshotState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DiskSnapshotState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DiskSnapshotState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DiskSnapshotState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DiskSnapshotState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
