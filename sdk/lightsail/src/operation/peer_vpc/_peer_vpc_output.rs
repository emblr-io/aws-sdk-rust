...
impl ::aws_types::request_id::RequestId for PeerVpcOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PeerVpcOutput {
    /// Creates a new builder-style object to manufacture [`PeerVpcOutput`](crate::operation::peer_vpc::PeerVpcOutput).
    pub fn builder() -> crate::operation::peer_vpc::builders::PeerVpcOutputBuilder {
        crate::operation::peer_vpc::builders::PeerVpcOutputBuilder::default()
    }
}
...
impl PeerVpcOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PeerVpcOutput`](crate::operation::peer_vpc::PeerVpcOutput).
    pub fn build(self) -> crate::operation::peer_vpc::PeerVpcOutput {
