...
impl ::aws_types::request_id::RequestId for AttachDiskOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl AttachDiskOutput {
    /// Creates a new builder-style object to manufacture [`AttachDiskOutput`](crate::operation::attach_disk::AttachDiskOutput).
    pub fn builder() -> crate::operation::attach_disk::builders::AttachDiskOutputBuilder {
        crate::operation::attach_disk::builders::AttachDiskOutputBuilder::default()
    }
}

/// A builder for [`AttachDiskOutput`](crate::operation::attach_disk::AttachDiskOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AttachDiskOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl AttachDiskOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`AttachDiskOutput`](crate::operation::attach_disk::AttachDiskOutput).
    pub fn build(self) -> crate::operation::attach_disk::AttachDiskOutput {
