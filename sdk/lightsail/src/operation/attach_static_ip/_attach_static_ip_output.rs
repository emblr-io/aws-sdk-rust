...
impl ::aws_types::request_id::RequestId for AttachStaticIpOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl AttachStaticIpOutput {
    /// Creates a new builder-style object to manufacture [`AttachStaticIpOutput`](crate::operation::attach_static_ip::AttachStaticIpOutput).
    pub fn builder() -> crate::operation::attach_static_ip::builders::AttachStaticIpOutputBuilder {
        crate::operation::attach_static_ip::builders::AttachStaticIpOutputBuilder::default()
    }
}

/// A builder for [`AttachStaticIpOutput`](crate::operation::attach_static_ip::AttachStaticIpOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AttachStaticIpOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl AttachStaticIpOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`AttachStaticIpOutput`](crate::operation::attach_static_ip::AttachStaticIpOutput).
    pub fn build(self) -> crate::operation::attach_static_ip::AttachStaticIpOutput {
