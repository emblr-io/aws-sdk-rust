...
impl ::aws_types::request_id::RequestId for CreateInstancesOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateInstancesOutput {
    /// Creates a new builder-style object to manufacture [`CreateInstancesOutput`](crate::operation::create_instances::CreateInstancesOutput).
    pub fn builder() -> crate::operation::create_instances::builders::CreateInstancesOutputBuilder {
        crate::operation::create_instances::builders::CreateInstancesOutputBuilder::default()
    }
}

/// A builder for [`CreateInstancesOutput`](crate::operation::create_instances::CreateInstancesOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateInstancesOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl CreateInstancesOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInstancesOutput`](crate::operation::create_instances::CreateInstancesOutput).
    pub fn build(self) -> crate::operation::create_instances::CreateInstancesOutput {
