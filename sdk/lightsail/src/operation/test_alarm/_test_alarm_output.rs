...
impl TestAlarmOutput {
    /// Creates a new builder-style object to manufacture [`TestAlarmOutput`](crate::operation::test_alarm::TestAlarmOutput).
    pub fn builder() -> crate::operation::test_alarm::builders::TestAlarmOutputBuilder {
        crate::operation::test_alarm::builders::TestAlarmOutputBuilder::default()
    }
}

/// A builder for [`TestAlarmOutput`](crate::operation::test_alarm::TestAlarmOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct TestAlarmOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl TestAlarmOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`TestAlarmOutput`](crate::operation::test_alarm::TestAlarmOutput).
    pub fn build(self) -> crate::operation::test_alarm::TestAlarmOutput {
