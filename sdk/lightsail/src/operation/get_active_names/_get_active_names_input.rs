...
impl GetActiveNamesInput {
    /// Creates a new builder-style object to manufacture [`GetActiveNamesInput`](crate::operation::get_active_names::GetActiveNamesInput).
    pub fn builder() -> crate::operation::get_active_names::builders::GetActiveNamesInputBuilder {
        crate::operation::get_active_names::builders::GetActiveNamesInputBuilder::default()
    }
}
