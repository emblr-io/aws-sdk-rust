...
impl ::aws_types::request_id::RequestId for DeleteDiskOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteDiskOutput {
    /// Creates a new builder-style object to manufacture [`DeleteDiskOutput`](crate::operation::delete_disk::DeleteDiskOutput).
    pub fn builder() -> crate::operation::delete_disk::builders::DeleteDiskOutputBuilder {
        crate::operation::delete_disk::builders::DeleteDiskOutputBuilder::default()
    }
}

/// A builder for [`DeleteDiskOutput`](crate::operation::delete_disk::DeleteDiskOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteDiskOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl DeleteDiskOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteDiskOutput`](crate::operation::delete_disk::DeleteDiskOutput).
    pub fn build(self) -> crate::operation::delete_disk::DeleteDiskOutput {
