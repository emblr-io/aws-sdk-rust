...
impl ::aws_types::request_id::RequestId for StartInstanceOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartInstanceOutput {
    /// Creates a new builder-style object to manufacture [`StartInstanceOutput`](crate::operation::start_instance::StartInstanceOutput).
    pub fn builder() -> crate::operation::start_instance::builders::StartInstanceOutputBuilder {
        crate::operation::start_instance::builders::StartInstanceOutputBuilder::default()
    }
}
...
impl StartInstanceOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartInstanceOutput`](crate::operation::start_instance::StartInstanceOutput).
    pub fn build(self) -> crate::operation::start_instance::StartInstanceOutput {
