...
impl ::aws_types::request_id::RequestId for DeleteAutoSnapshotOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteAutoSnapshotOutput {
    /// Creates a new builder-style object to manufacture [`DeleteAutoSnapshotOutput`](crate::operation::delete_auto_snapshot::DeleteAutoSnapshotOutput).
    pub fn builder() -> crate::operation::delete_auto_snapshot::builders::DeleteAutoSnapshotOutputBuilder {
        crate::operation::delete_auto_snapshot::builders::DeleteAutoSnapshotOutputBuilder::default()
    }
}
...
impl DeleteAutoSnapshotOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteAutoSnapshotOutput`](crate::operation::delete_auto_snapshot::DeleteAutoSnapshotOutput).
    pub fn build(self) -> crate::operation::delete_auto_snapshot::DeleteAutoSnapshotOutput {
