...
impl GetCloudFormationStackRecordsOutput {
    /// <p>A list of objects describing the CloudFormation stack records.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.cloud_formation_stack_records.is_none()`.
    pub fn cloud_formation_stack_records(&self) -> &[crate::types::CloudFormationStackRecord] {
        self.cloud_formation_stack_records.as_deref().unwrap_or_default()
    }
    /// <p>The token to advance to the next page of results from your request.</p>
    /// <p>A next page token is not returned if there are no more results to display.</p>
    /// <p>To get the next page of results, perform another <code>GetCloudFormationStackRecords</code> request and specify the next page token using the <code>pageToken</code> parameter.</p>
...
impl ::aws_types::request_id::RequestId for GetCloudFormationStackRecordsOutput {
...
impl GetCloudFormationStackRecordsOutputBuilder {
    ...
    pub fn set_cloud_formation_stack_records(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::CloudFormationStackRecord>>,
    ) -> Self {
