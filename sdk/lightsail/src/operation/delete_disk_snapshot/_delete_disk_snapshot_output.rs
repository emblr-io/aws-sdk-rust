...
impl ::aws_types::request_id::RequestId for DeleteDiskSnapshotOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteDiskSnapshotOutput {
    /// Creates a new builder-style object to manufacture [`DeleteDiskSnapshotOutput`](crate::operation::delete_disk_snapshot::DeleteDiskSnapshotOutput).
    pub fn builder() -> crate::operation::delete_disk_snapshot::builders::DeleteDiskSnapshotOutputBuilder {
        crate::operation::delete_disk_snapshot::builders::DeleteDiskSnapshotOutputBuilder::default()
    }
}
...
impl DeleteDiskSnapshotOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteDiskSnapshotOutput`](crate::operation::delete_disk_snapshot::DeleteDiskSnapshotOutput).
    pub fn build(self) -> crate::operation::delete_disk_snapshot::DeleteDiskSnapshotOutput {
