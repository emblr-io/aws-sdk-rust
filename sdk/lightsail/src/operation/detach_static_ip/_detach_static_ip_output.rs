...
impl DetachStaticIpOutput {
    /// Creates a new builder-style object to manufacture [`DetachStaticIpOutput`](crate::operation::detach_static_ip::DetachStaticIpOutput).
    pub fn builder() -> crate::operation::detach_static_ip::builders::DetachStaticIpOutputBuilder {
        crate::operation::detach_static_ip::builders::DetachStaticIpOutputBuilder::default()
    }
}
...
impl DetachStaticIpOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DetachStaticIpOutput`](crate::operation::detach_static_ip::DetachStaticIpOutput).
    pub fn build(self) -> crate::operation::detach_static_ip::DetachStaticIpOutput {
        crate::operation::detach_static_ip::DetachStaticIpOutput {
