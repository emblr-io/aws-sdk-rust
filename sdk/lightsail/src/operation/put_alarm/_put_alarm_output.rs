...
impl ::aws_types::request_id::RequestId for PutAlarmOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PutAlarmOutput {
    /// Creates a new builder-style object to manufacture [`PutAlarmOutput`](crate::operation::put_alarm::PutAlarmOutput).
    pub fn builder() -> crate::operation::put_alarm::builders::PutAlarmOutputBuilder {
        crate::operation::put_alarm::builders::PutAlarmOutputBuilder::default()
    }
}

/// A builder for [`PutAlarmOutput`](crate::operation::put_alarm::PutAlarmOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutAlarmOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl PutAlarmOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutAlarmOutput`](crate::operation::put_alarm::PutAlarmOutput).
    pub fn build(self) -> crate::operation::put_alarm::PutAlarmOutput {
