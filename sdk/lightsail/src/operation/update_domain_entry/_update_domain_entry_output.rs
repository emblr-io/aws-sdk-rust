...
impl ::aws_types::request_id::RequestId for UpdateDomainEntryOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateDomainEntryOutput {
    /// Creates a new builder-style object to manufacture [`UpdateDomainEntryOutput`](crate::operation::update_domain_entry::UpdateDomainEntryOutput).
    pub fn builder() -> crate::operation::update_domain_entry::builders::UpdateDomainEntryOutputBuilder {
        crate::operation::update_domain_entry::builders::UpdateDomainEntryOutputBuilder::default()
    }
}
...
impl UpdateDomainEntryOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateDomainEntryOutput`](crate::operation::update_domain_entry::UpdateDomainEntryOutput).
    pub fn build(self) -> crate::operation::update_domain_entry::UpdateDomainEntryOutput {
