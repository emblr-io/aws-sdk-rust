...
impl DisableAddOnOutput {
    /// Creates a new builder-style object to manufacture [`DisableAddOnOutput`](crate::operation::disable_add_on::DisableAddOnOutput).
    pub fn builder() -> crate::operation::disable_add_on::builders::DisableAddOnOutputBuilder {
        crate::operation::disable_add_on::builders::DisableAddOnOutputBuilder::default()
    }
}

/// A builder for [`DisableAddOnOutput`](crate::operation::disable_add_on::DisableAddOnOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DisableAddOnOutputBuilder {
    pub(crate) operations: ::std::option::Option<::std::vec::Vec<crate::types::Operation>>,
    _request_id: Option<String>,
}
impl DisableAddOnOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DisableAddOnOutput`](crate::operation::disable_add_on::DisableAddOnOutput).
    pub fn build(self) -> crate::operation::disable_add_on::DisableAddOnOutput {
