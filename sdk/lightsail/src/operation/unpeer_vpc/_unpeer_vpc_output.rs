...
impl ::aws_types::request_id::RequestId for UnpeerVpcOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UnpeerVpcOutput {
    /// Creates a new builder-style object to manufacture [`UnpeerVpcOutput`](crate::operation::unpeer_vpc::UnpeerVpcOutput).
    pub fn builder() -> crate::operation::unpeer_vpc::builders::UnpeerVpcOutputBuilder {
        crate::operation::unpeer_vpc::builders::UnpeerVpcOutputBuilder::default()
    }
}
...
impl UnpeerVpcOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UnpeerVpcOutput`](crate::operation::unpeer_vpc::UnpeerVpcOutput).
    pub fn build(self) -> crate::operation::unpeer_vpc::UnpeerVpcOutput {
