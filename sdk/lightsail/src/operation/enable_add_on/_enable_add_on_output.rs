...
impl ::aws_types::request_id::RequestId for EnableAddOnOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl EnableAddOnOutput {
    /// Creates a new builder-style object to manufacture [`EnableAddOnOutput`](crate::operation::enable_add_on::EnableAddOnOutput).
    pub fn builder() -> crate::operation::enable_add_on::builders::EnableAddOnOutputBuilder {
        crate::operation::enable_add_on::builders::EnableAddOnOutputBuilder::default()
    }
}
...
impl EnableAddOnOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`EnableAddOnOutput`](crate::operation::enable_add_on::EnableAddOnOutput).
    pub fn build(self) -> crate::operation::enable_add_on::EnableAddOnOutput {
