...
impl ::aws_types::request_id::RequestId for StartRelationalDatabaseOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl StartRelationalDatabaseOutput {
    /// Creates a new builder-style object to manufacture [`StartRelationalDatabaseOutput`](crate::operation::start_relational_database::StartRelationalDatabaseOutput).
    pub fn builder() -> crate::operation::start_relational_database::builders::StartRelationalDatabaseOutputBuilder {
        crate::operation::start_relational_database::builders::StartRelationalDatabaseOutputBuilder::default()
    }
}
...
impl StartRelationalDatabaseOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`StartRelationalDatabaseOutput`](crate::operation::start_relational_database::StartRelationalDatabaseOutput).
    pub fn build(self) -> crate::operation::start_relational_database::StartRelationalDatabaseOutput {
