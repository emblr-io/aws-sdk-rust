...
impl ::aws_types::request_id::RequestId for ReleaseStaticIpOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ReleaseStaticIpOutput {
    /// Creates a new builder-style object to manufacture [`ReleaseStaticIpOutput`](crate::operation::release_static_ip::ReleaseStaticIpOutput).
    pub fn builder() -> crate::operation::release_static_ip::builders::ReleaseStaticIpOutputBuilder {
...
impl ReleaseStaticIpOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ReleaseStaticIpOutput`](crate::operation::release_static_ip::ReleaseStaticIpOutput).
    pub fn build(self) -> crate::operation::release_static_ip::ReleaseStaticIpOutput {
