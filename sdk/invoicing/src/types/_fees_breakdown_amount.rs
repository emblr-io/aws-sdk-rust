...
pub struct FeesBreakdownAmount {
...
impl FeesBreakdownAmount {
    /// Creates a new builder-style object to manufacture [`FeesBreakdownAmount`](crate::types::FeesBreakdownAmount).
    pub fn builder() -> crate::types::builders::FeesBreakdownAmountBuilder {
        crate::types::builders::FeesBreakdownAmountBuilder::default()
    }
}

/// A builder for [`FeesBreakdownAmount`](crate::types::FeesBreakdownAmount).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct FeesBreakdownAmountBuilder {
    pub(crate) description: ::std::option::Option<::std::string::String>,
    pub(crate) amount: ::std::option::Option<::std::string::String>,
    pub(crate) rate: ::std::option::Option<::std::string::String>,
}
impl FeesBreakdownAmountBuilder {
    /// <p>The list of fees information.</p>
    ...
    /// Consumes the builder and constructs a [`FeesBreakdownAmount`](crate::types::FeesBreakdownAmount).
    pub fn build(self) -> crate::types::FeesBreakdownAmount {
        crate::types::FeesBreakdownAmount {
