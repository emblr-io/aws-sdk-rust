...
//! offered by AWS Invoicing. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Invoicing.
...
/// For example, the [`CreateInvoiceUnit`](crate::operation::create_invoice_unit) operation has
...
/// Configuration for AWS Invoicing.
pub mod config;
