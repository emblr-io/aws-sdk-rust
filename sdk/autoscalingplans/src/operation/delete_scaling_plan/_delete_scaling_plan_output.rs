...
impl ::aws_types::request_id::RequestId for DeleteScalingPlanOutput {
...
impl DeleteScalingPlanOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteScalingPlanOutput`](crate::operation::delete_scaling_plan::DeleteScalingPlanOutput).
    pub fn build(self) -> crate::operation::delete_scaling_plan::DeleteScalingPlanOutput {
