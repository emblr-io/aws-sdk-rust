...
impl PredefinedLoadMetricSpecification {
    /// Creates a new builder-style object to manufacture [`PredefinedLoadMetricSpecification`](crate::types::PredefinedLoadMetricSpecification).
    pub fn builder() -> crate::types::builders::PredefinedLoadMetricSpecificationBuilder {
        crate::types::builders::PredefinedLoadMetricSpecificationBuilder::default()
    }
}
