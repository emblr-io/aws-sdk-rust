...
//! aws-sdk-launchwizard = "0.0.0-local"
...
//! offered by AWS Launch Wizard. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Launch Wizard.
...
/// For example, the [`CreateDeployment`](crate::operation::create_deployment) operation has
/// a [`Client::create_deployment`], function which returns a builder for that operation.
...
/// Configuration for AWS Launch Wizard.
pub mod config;
