...
pub struct ListDeploymentsOutput {
    ...
    pub deployments: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentDataSummary>>,
...
impl ListDeploymentsOutput {
    ...
    pub fn deployments(&self) -> &[crate::types::DeploymentDataSummary] {
...
pub struct ListDeploymentsOutputBuilder {
    pub(crate) deployments: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentDataSummary>>,
...
impl ListDeploymentsOutputBuilder {
    ...
    ///
    /// <p>Lists the deployments.</p>
    pub fn deployments(mut self, input: crate::types::DeploymentDataSummary) -> Self {
    ...
    /// <p>Lists the deployments.</p>
    pub fn set_deployments(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::DeploymentDataSummary>>) -> Self {
        self.deployments = input;
        self
    }
    /// <p>Lists the deployments.</p>
    pub fn get_deployments(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::DeploymentDataSummary>> {
        &self.deployments
    }
    /// <p>The token to include in another request to get the next page of items. This value is <code>null</code> when there are no more items to return.</p>
