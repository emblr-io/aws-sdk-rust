...
impl ::std::convert::From<&str> for DestinationState {
    fn from(s: &str) -> Self {
        match s {
            "ACTIVE" => DestinationState::Active,
            "FAILED" => DestinationState::Failed,
            "RECONNECTING" => DestinationState::Reconnecting,
            "STARTING" => DestinationState::Starting,
            "STOPPED" => DestinationState::Stopped,
            "STOPPING" => DestinationState::Stopping,
            other => DestinationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DestinationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DestinationState::from(s))
    }
}
impl DestinationState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DestinationState::Active => "ACTIVE",
            DestinationState::Failed => "FAILED",
            DestinationState::Reconnecting => "RECONNECTING",
            DestinationState::Starting => "STARTING",
            DestinationState::Stopped => "STOPPED",
            DestinationState::Stopping => "STOPPING",
...
impl ::std::convert::AsRef<str> for DestinationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
