...
impl ::std::convert::From<&str> for ReplicationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "SOURCE" => ReplicationType::Source,
            other => ReplicationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationType::from(s))
    }
}
impl ReplicationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ReplicationType::Replica => "REPLICA",
            ReplicationType::Source => "SOURCE",
...
impl ::std::convert::AsRef<str> for ReplicationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
