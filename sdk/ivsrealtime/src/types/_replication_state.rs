...
impl ::std::convert::From<&str> for ReplicationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            "STOPPED" => ReplicationState::Stopped,
            other => ReplicationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReplicationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReplicationState::from(s))
    }
}
impl ReplicationState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ReplicationState::Active => "ACTIVE",
            ReplicationState::Stopped => "STOPPED",
...
impl ::std::convert::AsRef<str> for ReplicationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ReplicationState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ReplicationState::Active => write!(f, "ACTIVE"),
            ReplicationState::Stopped => write!(f, "STOPPED"),
