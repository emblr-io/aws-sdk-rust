...
pub enum ParticipantTokenCapability {
    #[allow(missing_docs)] // documentation missing in model
    Publish,
    #[allow(missing_docs)] // documentation missing in model
    Subscribe,
...
impl ::std::convert::From<&str> for ParticipantTokenCapability {
    fn from(s: &str) -> Self {
        match s {
            "PUBLISH" => ParticipantTokenCapability::Publish,
            "SUBSCRIBE" => ParticipantTokenCapability::Subscribe,
            other => ParticipantTokenCapability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ParticipantTokenCapability {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ParticipantTokenCapability::from(s))
    }
}
impl ParticipantTokenCapability {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ParticipantTokenCapability::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for ParticipantTokenCapability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
