...
impl ::std::convert::From<&str> for OperatorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OperatorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OperatorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OperatorType::from(s))
    }
}
impl OperatorType {
...
impl ::std::convert::AsRef<str> for OperatorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
