...
impl CollectorBuilder {
    /// <p>The ID of the collector.</p>
    pub fn collector_id(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.collector_id = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The ID of the collector.</p>
    ...
    pub fn collector_health(mut self, input: crate::types::CollectorHealth) -> Self {
        self.collector_health = ::std::option::Option::Some(input);
        self
    }
    /// <p>Indicates the health of a collector.</p>
