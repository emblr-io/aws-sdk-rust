...
impl ::std::convert::From<&str> for GroupName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GroupName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GroupName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GroupName::from(s))
    }
}
impl GroupName {
...
impl ::std::convert::AsRef<str> for GroupName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
