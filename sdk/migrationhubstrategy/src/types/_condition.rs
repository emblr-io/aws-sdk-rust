...
impl ::std::convert::From<&str> for Condition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Condition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Condition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Condition::from(s))
    }
}
impl Condition {
...
impl ::std::convert::AsRef<str> for Condition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Condition {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Condition::Contains => write!(f, "CONTAINS"),
