...
impl ::std::convert::From<&str> for VersionControlType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VersionControlType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VersionControlType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VersionControlType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VersionControlType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for VersionControlType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            VersionControlType::AzureDevopsGit => write!(f, "AZURE_DEVOPS_GIT"),
            VersionControlType::Github => write!(f, "GITHUB"),
            VersionControlType::GithubEnterprise => write!(f, "GITHUB_ENTERPRISE"),
            VersionControlType::Unknown(value) => write!(f, "{}", value),
        }
    }
}
