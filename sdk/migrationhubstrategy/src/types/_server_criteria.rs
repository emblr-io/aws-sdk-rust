...
impl ::std::convert::From<&str> for ServerCriteria {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ServerCriteria::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ServerCriteria {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ServerCriteria::from(s))
    }
}
impl ServerCriteria {
...
impl ::std::convert::AsRef<str> for ServerCriteria {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
