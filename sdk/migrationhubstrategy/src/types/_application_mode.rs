...
impl ::std::convert::From<&str> for ApplicationMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ApplicationMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ApplicationMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ApplicationMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ApplicationMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
