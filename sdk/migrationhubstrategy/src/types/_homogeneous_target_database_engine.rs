...
impl ::std::convert::From<&str> for HomogeneousTargetDatabaseEngine {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HomogeneousTargetDatabaseEngine::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HomogeneousTargetDatabaseEngine {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HomogeneousTargetDatabaseEngine::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HomogeneousTargetDatabaseEngine {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for HomogeneousTargetDatabaseEngine {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            HomogeneousTargetDatabaseEngine::NoneSpecified => write!(f, "None specified"),
            HomogeneousTargetDatabaseEngine::Unknown(value) => write!(f, "{}", value),
        }
    }
}
