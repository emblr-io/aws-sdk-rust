...
impl ::std::convert::From<&str> for StrategyRecommendation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StrategyRecommendation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StrategyRecommendation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StrategyRecommendation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StrategyRecommendation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
