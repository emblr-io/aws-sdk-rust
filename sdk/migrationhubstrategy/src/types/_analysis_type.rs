...
/// When writing a match expression against `AnalysisType`, it is important to ensure
...
/// match analysistype {
///     AnalysisType::BinaryAnalysis => { /* ... */ },
///     AnalysisType::DatabaseAnalysis => { /* ... */ },
///     AnalysisType::RuntimeAnalysis => { /* ... */ },
///     AnalysisType::SourceCodeAnalysis => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `analysistype` represents
...
/// version of SDK where the variant `AnalysisType::NewFeature` is defined.
/// Specifically, when `analysistype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AnalysisType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AnalysisType {
    fn from(s: &str) -> Self {
        match s {
            "BINARY_ANALYSIS" => AnalysisType::BinaryAnalysis,
...
impl ::std::str::FromStr for AnalysisType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AnalysisType::from(s))
    }
}
impl AnalysisType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AnalysisType::BinaryAnalysis => "BINARY_ANALYSIS",
            AnalysisType::DatabaseAnalysis => "DATABASE_ANALYSIS",
            AnalysisType::RuntimeAnalysis => "RUNTIME_ANALYSIS",
            AnalysisType::SourceCodeAnalysis => "SOURCE_CODE_ANALYSIS",
