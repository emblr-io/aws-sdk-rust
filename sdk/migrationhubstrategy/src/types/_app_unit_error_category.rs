...
impl ::std::convert::From<&str> for AppUnitErrorCategory {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppUnitErrorCategory::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppUnitErrorCategory {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppUnitErrorCategory::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AppUnitErrorCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
