...
impl ::std::convert::From<&str> for RuntimeAnalysisStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => RuntimeAnalysisStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for RuntimeAnalysisStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RuntimeAnalysisStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for RuntimeAnalysisStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
