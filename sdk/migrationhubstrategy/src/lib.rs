...
//! aws-sdk-migrationhubstrategy = "0.0.0-local"
...
//! offered by Migration Hub Strategy Recommendations. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Migration Hub Strategy Recommendations.
...
/// For example, the [`GetApplicationComponentDetails`](crate::operation::get_application_component_details) operation has
