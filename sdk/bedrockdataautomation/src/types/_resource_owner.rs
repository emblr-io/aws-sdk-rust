...
impl ::std::convert::From<&str> for ResourceOwner {
    fn from(s: &str) -> Self {
        match s {
            "ACCOUNT" => ResourceOwner::Account,
            "SERVICE" => ResourceOwner::Service,
            other => ResourceOwner::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceOwner {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceOwner::from(s))
    }
}
impl ResourceOwner {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceOwner::Account => "ACCOUNT",
            ResourceOwner::Service => "SERVICE",
...
impl ::std::convert::AsRef<str> for ResourceOwner {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
