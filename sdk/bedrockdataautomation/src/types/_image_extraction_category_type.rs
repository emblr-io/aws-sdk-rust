...
/// When writing a match expression against `ImageExtractionCategoryType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `imageextractioncategorytype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ImageExtractionCategoryType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ImageExtractionCategoryType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ImageExtractionCategoryType::NewFeature` is defined.
/// Specifically, when `imageextractioncategorytype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ImageExtractionCategoryType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ImageExtractionCategoryType {
    #[allow(missing_docs)] // documentation missing in model
    ContentModeration,
    #[allow(missing_docs)] // documentation missing in model
    Logos,
...
impl ::std::convert::From<&str> for ImageExtractionCategoryType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ImageExtractionCategoryType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ImageExtractionCategoryType::from(s))
    }
}
impl ImageExtractionCategoryType {
...
impl ::std::fmt::Display for ImageExtractionCategoryType {
