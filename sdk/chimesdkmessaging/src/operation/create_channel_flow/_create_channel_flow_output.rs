...
impl ::aws_types::request_id::RequestId for CreateChannelFlowOutput {
...
impl CreateChannelFlowOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateChannelFlowOutput`](crate::operation::create_channel_flow::CreateChannelFlowOutput).
    pub fn build(self) -> crate::operation::create_channel_flow::CreateChannelFlowOutput {
