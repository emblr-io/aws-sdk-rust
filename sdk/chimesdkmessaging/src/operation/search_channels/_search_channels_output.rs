...
impl SearchChannelsOutput {
    ...
    pub fn builder() -> crate::operation::search_channels::builders::SearchChannelsOutputBuilder {
        crate::operation::search_channels::builders::SearchChannelsOutputBuilder::default()
    }
}
...
impl SearchChannelsOutputBuilder {
...
impl ::std::fmt::Debug for SearchChannelsOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("SearchChannelsOutputBuilder");
        formatter.field("channels", &self.channels);
        formatter.field("next_token", &"*** Sensitive Data Redacted ***");
        formatter.field("_request_id", &self._request_id);
        formatter.finish()
