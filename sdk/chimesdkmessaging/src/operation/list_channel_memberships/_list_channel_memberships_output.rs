...
impl ListChannelMembershipsOutput {
    ...
    pub fn channel_memberships(&self) -> &[crate::types::ChannelMembershipSummary] {
...
impl ::aws_types::request_id::RequestId for ListChannelMembershipsOutput {
...
impl ListChannelMembershipsOutputBuilder {
    ...
    /// <p>The information for the requested channel memberships.</p>
    pub fn get_channel_memberships(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ChannelMembershipSummary>> {
