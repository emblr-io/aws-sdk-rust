...
impl ::std::convert::From<&str> for ChannelMessageType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelMessageType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelMessageType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelMessageType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChannelMessageType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
