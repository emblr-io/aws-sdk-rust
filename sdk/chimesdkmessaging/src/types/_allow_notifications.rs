...
impl ::std::convert::From<&str> for AllowNotifications {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AllowNotifications::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AllowNotifications {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllowNotifications::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AllowNotifications {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
