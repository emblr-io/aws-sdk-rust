...
impl ::std::convert::From<&str> for SearchFieldOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SearchFieldOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SearchFieldOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchFieldOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SearchFieldOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
