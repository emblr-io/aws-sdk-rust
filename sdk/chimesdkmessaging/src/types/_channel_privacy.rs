...
impl ::std::convert::From<&str> for ChannelPrivacy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelPrivacy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelPrivacy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelPrivacy::from(s))
    }
}
impl ChannelPrivacy {
...
impl ::std::convert::AsRef<str> for ChannelPrivacy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
