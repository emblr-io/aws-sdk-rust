...
impl ::std::convert::From<&str> for ChannelMessageStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelMessageStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelMessageStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelMessageStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ChannelMessageStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
