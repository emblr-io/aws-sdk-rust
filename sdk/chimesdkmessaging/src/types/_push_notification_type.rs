...
impl ::std::convert::From<&str> for PushNotificationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PushNotificationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PushNotificationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PushNotificationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PushNotificationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
