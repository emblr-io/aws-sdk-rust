...
impl ::std::convert::From<&str> for FallbackAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FallbackAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FallbackAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FallbackAction::from(s))
    }
}
impl FallbackAction {
...
impl ::std::convert::AsRef<str> for FallbackAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
