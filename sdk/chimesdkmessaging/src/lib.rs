...
//! aws-sdk-chimesdkmessaging = "0.0.0-local"
...
//! offered by Amazon Chime SDK Messaging. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Chime SDK Messaging.
