...
pub struct GetBillScenarioOutput {
...
impl ::aws_types::request_id::RequestId for GetBillScenarioOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetBillScenarioOutput {
    /// Creates a new builder-style object to manufacture [`GetBillScenarioOutput`](crate::operation::get_bill_scenario::GetBillScenarioOutput).
    pub fn builder() -> crate::operation::get_bill_scenario::builders::GetBillScenarioOutputBuilder {
        crate::operation::get_bill_scenario::builders::GetBillScenarioOutputBuilder::default()
    }
}

/// A builder for [`GetBillScenarioOutput`](crate::operation::get_bill_scenario::GetBillScenarioOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetBillScenarioOutputBuilder {
...
impl GetBillScenarioOutputBuilder {
    /// <p>The unique identifier of the retrieved bill scenario.</p>
    ...
    /// Consumes the builder and constructs a [`GetBillScenarioOutput`](crate::operation::get_bill_scenario::GetBillScenarioOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::get_bill_scenario::builders::GetBillScenarioOutputBuilder::id)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_bill_scenario::GetBillScenarioOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_bill_scenario::GetBillScenarioOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetBillScenarioOutput",
                )
            })?,
            name: self.name,
