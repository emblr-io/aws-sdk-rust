...
pub struct CreateWorkloadEstimateOutput {
...
impl CreateWorkloadEstimateOutput {
    /// <p>The unique identifier for the created workload estimate.</p>
    pub fn id(&self) -> &str {
        use std::ops::Deref;
        self.id.deref()
...
impl ::aws_types::request_id::RequestId for CreateWorkloadEstimateOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateWorkloadEstimateOutput {
    /// Creates a new builder-style object to manufacture [`CreateWorkloadEstimateOutput`](crate::operation::create_workload_estimate::CreateWorkloadEstimateOutput).
    pub fn builder() -> crate::operation::create_workload_estimate::builders::CreateWorkloadEstimateOutputBuilder {
        crate::operation::create_workload_estimate::builders::CreateWorkloadEstimateOutputBuilder::default()
    }
}

/// A builder for [`CreateWorkloadEstimateOutput`](crate::operation::create_workload_estimate::CreateWorkloadEstimateOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateWorkloadEstimateOutputBuilder {
...
impl CreateWorkloadEstimateOutputBuilder {
    /// <p>The unique identifier for the created workload estimate.</p>
    ...
    /// Consumes the builder and constructs a [`CreateWorkloadEstimateOutput`](crate::operation::create_workload_estimate::CreateWorkloadEstimateOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::create_workload_estimate::builders::CreateWorkloadEstimateOutputBuilder::id)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_workload_estimate::CreateWorkloadEstimateOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateWorkloadEstimateOutput",
                )
            })?,
            name: self.name,
