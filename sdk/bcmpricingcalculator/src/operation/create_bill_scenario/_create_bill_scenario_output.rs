...
pub struct CreateBillScenarioOutput {
...
impl ::aws_types::request_id::RequestId for CreateBillScenarioOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateBillScenarioOutput {
    /// Creates a new builder-style object to manufacture [`CreateBillScenarioOutput`](crate::operation::create_bill_scenario::CreateBillScenarioOutput).
    pub fn builder() -> crate::operation::create_bill_scenario::builders::CreateBillScenarioOutputBuilder {
        crate::operation::create_bill_scenario::builders::CreateBillScenarioOutputBuilder::default()
    }
}

/// A builder for [`CreateBillScenarioOutput`](crate::operation::create_bill_scenario::CreateBillScenarioOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateBillScenarioOutputBuilder {
...
impl CreateBillScenarioOutputBuilder {
    /// <p>The unique identifier for the created bill scenario.</p>
    ...
    /// Consumes the builder and constructs a [`CreateBillScenarioOutput`](crate::operation::create_bill_scenario::CreateBillScenarioOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::create_bill_scenario::builders::CreateBillScenarioOutputBuilder::id)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_bill_scenario::CreateBillScenarioOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::create_bill_scenario::CreateBillScenarioOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateBillScenarioOutput",
                )
            })?,
            name: self.name,
