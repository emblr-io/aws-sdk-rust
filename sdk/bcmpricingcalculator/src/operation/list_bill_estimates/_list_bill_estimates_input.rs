...
impl ListBillEstimatesInput {
    /// Creates a new builder-style object to manufacture [`ListBillEstimatesInput`](crate::operation::list_bill_estimates::ListBillEstimatesInput).
    pub fn builder() -> crate::operation::list_bill_estimates::builders::ListBillEstimatesInputBuilder {
        crate::operation::list_bill_estimates::builders::ListBillEstimatesInputBuilder::default()
    }
}

/// A builder for [`ListBillEstimatesInput`](crate::operation::list_bill_estimates::ListBillEstimatesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListBillEstimatesInputBuilder {
    pub(crate) filters: ::std::option::Option<::std::vec::Vec<crate::types::ListBillEstimatesFilter>>,
...
impl ListBillEstimatesInputBuilder {
    ...
    /// Consumes the builder and constructs a [`ListBillEstimatesInput`](crate::operation::list_bill_estimates::ListBillEstimatesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_bill_estimates::ListBillEstimatesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_bill_estimates::ListBillEstimatesInput {
