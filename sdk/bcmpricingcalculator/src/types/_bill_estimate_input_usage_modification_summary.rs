...
pub struct BillEstimateInputUsageModificationSummary {
...
impl BillEstimateInputUsageModificationSummary {
    /// <p>The Amazon Web Services service code for this usage modification.</p>
...
impl BillEstimateInputUsageModificationSummary {
    /// Creates a new builder-style object to manufacture [`BillEstimateInputUsageModificationSummary`](crate::types::BillEstimateInputUsageModificationSummary).
    pub fn builder() -> crate::types::builders::BillEstimateInputUsageModificationSummaryBuilder {
        crate::types::builders::BillEstimateInputUsageModificationSummaryBuilder::default()
    }
}

/// A builder for [`BillEstimateInputUsageModificationSummary`](crate::types::BillEstimateInputUsageModificationSummary).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BillEstimateInputUsageModificationSummaryBuilder {
...
impl BillEstimateInputUsageModificationSummaryBuilder {
    /// <p>The Amazon Web Services service code for this usage modification.</p>
    ...
    /// Consumes the builder and constructs a [`BillEstimateInputUsageModificationSummary`](crate::types::BillEstimateInputUsageModificationSummary).
    /// This method will fail if any of the following fields are not set:
    /// - [`service_code`](crate::types::builders::BillEstimateInputUsageModificationSummaryBuilder::service_code)
    /// - [`usage_type`](crate::types::builders::BillEstimateInputUsageModificationSummaryBuilder::usage_type)
    /// - [`operation`](crate::types::builders::BillEstimateInputUsageModificationSummaryBuilder::operation)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::BillEstimateInputUsageModificationSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::BillEstimateInputUsageModificationSummary {
            service_code: self.service_code.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "service_code",
                    "service_code was not specified but it is required when building BillEstimateInputUsageModificationSummary",
                )
            })?,
            usage_type: self.usage_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "usage_type",
                    "usage_type was not specified but it is required when building BillEstimateInputUsageModificationSummary",
                )
            })?,
            operation: self.operation.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "operation",
                    "operation was not specified but it is required when building BillEstimateInputUsageModificationSummary",
                )
            })?,
