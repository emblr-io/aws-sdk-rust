...
//! offered by AWS Billing and Cost Management Pricing Calculator. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Billing and Cost Management Pricing Calculator.
...
/// Configuration for AWS Billing and Cost Management Pricing Calculator.
pub mod config;
