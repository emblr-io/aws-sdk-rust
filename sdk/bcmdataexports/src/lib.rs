...
//! aws-sdk-bcmdataexports = "0.0.0-local"
...
//! offered by AWS Billing and Cost Management Data Exports. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Billing and Cost Management Data Exports.
...
/// For example, the [`DeleteExport`](crate::operation::delete_export) operation has
...
/// Configuration for AWS Billing and Cost Management Data Exports.
pub mod config;
