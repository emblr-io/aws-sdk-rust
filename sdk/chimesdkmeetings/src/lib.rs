...
//! aws-sdk-chimesdkmeetings = "0.0.0-local"
...
//! offered by Amazon Chime SDK Meetings. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon Chime SDK Meetings.
...
/// Configuration for Amazon Chime SDK Meetings.
pub mod config;
