...
pub enum AttachmentsControlMode {
    #[allow(missing_docs)] // documentation missing in model
    Disabled,
    #[allow(missing_docs)] // documentation missing in model
    Enabled,
...
impl ::std::convert::From<&str> for AttachmentsControlMode {
    fn from(s: &str) -> Self {
        match s {
            "DISABLED" => AttachmentsControlMode::Disabled,
            "ENABLED" => AttachmentsControlMode::Enabled,
            other => AttachmentsControlMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttachmentsControlMode {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttachmentsControlMode::from(s))
    }
}
impl AttachmentsControlMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AttachmentsControlMode::Disabled => "DISABLED",
            AttachmentsControlMode::Enabled => "ENABLED",
            AttachmentsControlMode::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AttachmentsControlMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
