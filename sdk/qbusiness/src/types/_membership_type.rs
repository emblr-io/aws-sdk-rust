...
impl ::std::convert::From<&str> for MembershipType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MembershipType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MembershipType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MembershipType::from(s))
    }
}
impl MembershipType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MembershipType::Datasource => "DATASOURCE",
            MembershipType::Index => "INDEX",
...
impl ::std::convert::AsRef<str> for MembershipType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
