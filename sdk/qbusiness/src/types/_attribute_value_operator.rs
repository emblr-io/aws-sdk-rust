...
pub enum AttributeValueOperator {
    #[allow(missing_docs)] // documentation missing in model
    Delete,
...
impl ::std::convert::From<&str> for AttributeValueOperator {
    fn from(s: &str) -> Self {
        match s {
            "DELETE" => AttributeValueOperator::Delete,
            other => AttributeValueOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AttributeValueOperator {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AttributeValueOperator::from(s))
    }
}
impl AttributeValueOperator {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AttributeValueOperator::Delete => "DELETE",
            AttributeValueOperator::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for AttributeValueOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for AttributeValueOperator {
