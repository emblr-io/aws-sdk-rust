...
pub enum DocumentContentOperator {
    #[allow(missing_docs)] // documentation missing in model
    Delete,
...
impl ::std::convert::From<&str> for DocumentContentOperator {
    fn from(s: &str) -> Self {
        match s {
            "DELETE" => DocumentContentOperator::Delete,
            other => DocumentContentOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DocumentContentOperator {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DocumentContentOperator::from(s))
    }
}
impl DocumentContentOperator {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DocumentContentOperator::Delete => "DELETE",
            DocumentContentOperator::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for DocumentContentOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DocumentContentOperator {
