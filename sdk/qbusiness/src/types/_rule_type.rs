...
impl ::std::convert::From<&str> for RuleType {
    fn from(s: &str) -> Self {
        match s {
            "CONTENT_BLOCKER_RULE" => RuleType::ContentBlockerRule,
            "CONTENT_RETRIEVAL_RULE" => RuleType::ContentRetrievalRule,
...
impl RuleType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RuleType::ContentBlockerRule => "CONTENT_BLOCKER_RULE",
            RuleType::ContentRetrievalRule => "CONTENT_RETRIEVAL_RULE",
            RuleType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["CONTENT_BLOCKER_RULE", "CONTENT_RETRIEVAL_RULE"]
    }
}
