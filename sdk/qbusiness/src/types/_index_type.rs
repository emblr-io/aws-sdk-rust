...
impl ::std::convert::From<&str> for IndexType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IndexType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IndexType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IndexType::from(s))
    }
}
impl IndexType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            IndexType::Enterprise => "ENTERPRISE",
            IndexType::Starter => "STARTER",
...
impl ::std::convert::AsRef<str> for IndexType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
