...
impl ::std::convert::From<&str> for ReadAccessType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ReadAccessType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ReadAccessType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ReadAccessType::from(s))
    }
}
impl ReadAccessType {
...
impl ::std::convert::AsRef<str> for ReadAccessType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
