...
/// When writing a match expression against `DocumentAttributeBoostingLevel`, it is important to ensure
...
///
/// ```text
/// # let documentattributeboostinglevel = unimplemented!();
/// match documentattributeboostinglevel {
///     DocumentAttributeBoostingLevel::High => { /* ... */ },
...
/// }
/// ```
/// The above code demonstrates that when `documentattributeboostinglevel` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `DocumentAttributeBoostingLevel::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `DocumentAttributeBoostingLevel::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `DocumentAttributeBoostingLevel::NewFeature` is defined.
/// Specifically, when `documentattributeboostinglevel` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `DocumentAttributeBoostingLevel::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum DocumentAttributeBoostingLevel {
    #[allow(missing_docs)] // documentation missing in model
    High,
    #[allow(missing_docs)] // documentation missing in model
    Low,
...
impl ::std::convert::From<&str> for DocumentAttributeBoostingLevel {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for DocumentAttributeBoostingLevel {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DocumentAttributeBoostingLevel::from(s))
    }
}
impl DocumentAttributeBoostingLevel {
    /// Returns the `&str` value of the enum member.
    pub fn as_str(&self) -> &str {
        match self {
            DocumentAttributeBoostingLevel::High => "HIGH",
