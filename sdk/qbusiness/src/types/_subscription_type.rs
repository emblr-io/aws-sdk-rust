...
///     SubscriptionType::QBusiness => { /* ... */ },
///     SubscriptionType::QLite => { /* ... */ },
...
impl ::std::convert::From<&str> for SubscriptionType {
    fn from(s: &str) -> Self {
        match s {
            "Q_BUSINESS" => SubscriptionType::QBusiness,
            "Q_LITE" => SubscriptionType::QLite,
            other => SubscriptionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SubscriptionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SubscriptionType::from(s))
    }
}
impl SubscriptionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SubscriptionType::QBusiness => "Q_BUSINESS",
            SubscriptionType::QLite => "Q_LITE",
...
impl ::std::convert::AsRef<str> for SubscriptionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
