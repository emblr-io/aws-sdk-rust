...
//! offered by AWSServerlessApplicationRepository. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWSServerlessApplicationRepository.
