...
///     Capability::CapabilityResourcePolicy => { /* ... */ },
...
impl ::std::convert::From<&str> for Capability {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Capability::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Capability {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Capability::from(s))
    }
}
impl Capability {
...
impl ::std::convert::AsRef<str> for Capability {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
