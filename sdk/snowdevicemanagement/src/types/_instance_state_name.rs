...
impl ::std::convert::From<&str> for InstanceStateName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceStateName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceStateName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceStateName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceStateName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for InstanceStateName {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            InstanceStateName::ShuttingDown => write!(f, "SHUTTING_DOWN"),
