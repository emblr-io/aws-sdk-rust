...
//! aws-sdk-snowdevicemanagement = "0.0.0-local"
...
//! offered by AWS Snow Device Management. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Snow Device Management.
...
/// For example, the [`CancelTask`](crate::operation::cancel_task) operation has
/// a [`Client::cancel_task`], function which returns a builder for that operation.
...
/// Configuration for AWS Snow Device Management.
pub mod config;
