...
impl ListGraphsInput {
    /// Creates a new builder-style object to manufacture [`ListGraphsInput`](crate::operation::list_graphs::ListGraphsInput).
    pub fn builder() -> crate::operation::list_graphs::builders::ListGraphsInputBuilder {
        crate::operation::list_graphs::builders::ListGraphsInputBuilder::default()
    }
}

/// A builder for [`ListGraphsInput`](crate::operation::list_graphs::ListGraphsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListGraphsInputBuilder {
