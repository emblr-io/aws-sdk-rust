...
impl ::std::convert::From<&str> for InvitationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InvitationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InvitationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InvitationType::from(s))
    }
}
impl InvitationType {
...
impl ::std::convert::AsRef<str> for InvitationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
