...
impl ::std::convert::From<&str> for DatasourcePackage {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DatasourcePackage::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DatasourcePackage {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DatasourcePackage::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DatasourcePackage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
