...
impl ::std::convert::From<&str> for MemberDisabledReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MemberDisabledReason::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MemberDisabledReason {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MemberDisabledReason::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MemberDisabledReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
