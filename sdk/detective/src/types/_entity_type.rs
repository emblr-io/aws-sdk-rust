...
impl ::std::convert::From<&str> for EntityType {
    fn from(s: &str) -> Self {
        match s {
            "IAM_ROLE" => EntityType::IamRole,
            "IAM_USER" => EntityType::IamUser,
...
impl EntityType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EntityType::IamRole => "IAM_ROLE",
            EntityType::IamUser => "IAM_USER",
...
impl ::std::fmt::Display for EntityType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EntityType::IamRole => write!(f, "IAM_ROLE"),
            EntityType::IamUser => write!(f, "IAM_USER"),
