...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidGrantException {
...
impl InvalidGrantException {
    /// Creates a new builder-style object to manufacture [`InvalidGrantException`](crate::types::error::InvalidGrantException).
    pub fn builder() -> crate::types::error::builders::InvalidGrantExceptionBuilder {
        crate::types::error::builders::InvalidGrantExceptionBuilder::default()
    }
}
...
impl InvalidGrantExceptionBuilder {
    /// <p>Single error code. For this exception the value will be <code>invalid_grant</code>.</p>
    ...
    /// Consumes the builder and constructs a [`InvalidGrantException`](crate::types::error::InvalidGrantException).
    pub fn build(self) -> crate::types::error::InvalidGrantException {
        crate::types::error::InvalidGrantException {
            error: self.error,
