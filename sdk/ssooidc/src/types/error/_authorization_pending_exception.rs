...
impl ::aws_types::request_id::RequestId for crate::types::error::AuthorizationPendingException {
...
impl AuthorizationPendingException {
    /// Creates a new builder-style object to manufacture [`AuthorizationPendingException`](crate::types::error::AuthorizationPendingException).
    pub fn builder() -> crate::types::error::builders::AuthorizationPendingExceptionBuilder {
        crate::types::error::builders::AuthorizationPendingExceptionBuilder::default()
    }
}

/// A builder for [`AuthorizationPendingException`](crate::types::error::AuthorizationPendingException).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AuthorizationPendingExceptionBuilder {
    pub(crate) error: ::std::option::Option<::std::string::String>,
    pub(crate) error_description: ::std::option::Option<::std::string::String>,
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl AuthorizationPendingExceptionBuilder {
    /// <p>Single error code. For this exception the value will be <code>authorization_pending</code>.</p>
    ...
    /// Consumes the builder and constructs a [`AuthorizationPendingException`](crate::types::error::AuthorizationPendingException).
    pub fn build(self) -> crate::types::error::AuthorizationPendingException {
        crate::types::error::AuthorizationPendingException {
            error: self.error,
