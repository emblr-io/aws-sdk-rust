...
impl ::aws_types::request_id::RequestId for crate::types::error::InvalidClientMetadataException {
...
impl InvalidClientMetadataException {
    /// Creates a new builder-style object to manufacture [`InvalidClientMetadataException`](crate::types::error::InvalidClientMetadataException).
    pub fn builder() -> crate::types::error::builders::InvalidClientMetadataExceptionBuilder {
        crate::types::error::builders::InvalidClientMetadataExceptionBuilder::default()
    }
}
...
impl InvalidClientMetadataExceptionBuilder {
    ...
    /// Consumes the builder and constructs a [`InvalidClientMetadataException`](crate::types::error::InvalidClientMetadataException).
    pub fn build(self) -> crate::types::error::InvalidClientMetadataException {
        crate::types::error::InvalidClientMetadataException {
            error: self.error,
