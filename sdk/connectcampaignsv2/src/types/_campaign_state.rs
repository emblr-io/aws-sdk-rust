...
impl ::std::convert::From<&str> for CampaignState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CampaignState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl CampaignState {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["Completed", "Failed", "Initialized", "Paused", "Running", "Stopped"]
    }
}
