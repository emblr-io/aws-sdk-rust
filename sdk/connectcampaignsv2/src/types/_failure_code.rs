...
impl ::std::convert::From<&str> for FailureCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailureCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailureCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailureCode::from(s))
    }
}
impl FailureCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            FailureCode::BufferLimitExceeded => "BufferLimitExceeded",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["BufferLimitExceeded", "InvalidInput", "RequestThrottled", "UnknownError"]
    }
}
impl ::std::convert::AsRef<str> for FailureCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FailureCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FailureCode::BufferLimitExceeded => write!(f, "BufferLimitExceeded"),
