...
impl ::std::convert::From<&str> for InstanceOnboardingJobStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceOnboardingJobStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceOnboardingJobStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceOnboardingJobStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceOnboardingJobStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
