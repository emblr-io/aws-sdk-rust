...
//! offered by AmazonConnectCampaignServiceV2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AmazonConnectCampaignServiceV2.
...
/// let config = aws_sdk_connectcampaignsv2::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for AmazonConnectCampaignServiceV2.
pub mod config;
