...
impl Ec2InstanceStateInvalidException {
    /// Creates a new builder-style object to manufacture [`Ec2InstanceStateInvalidException`](crate::types::error::Ec2InstanceStateInvalidException).
    pub fn builder() -> crate::types::error::builders::Ec2InstanceStateInvalidExceptionBuilder {
        crate::types::error::builders::Ec2InstanceStateInvalidExceptionBuilder::default()
    }
}
...
impl Ec2InstanceStateInvalidExceptionBuilder {
    #[allow(missing_docs)] // documentation missing in model
    ...
    /// Consumes the builder and constructs a [`Ec2InstanceStateInvalidException`](crate::types::error::Ec2InstanceStateInvalidException).
    pub fn build(self) -> crate::types::error::Ec2InstanceStateInvalidException {
        crate::types::error::Ec2InstanceStateInvalidException {
