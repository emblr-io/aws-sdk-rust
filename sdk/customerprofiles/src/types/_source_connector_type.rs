...
impl ::std::convert::From<&str> for SourceConnectorType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SourceConnectorType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SourceConnectorType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SourceConnectorType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SourceConnectorType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
