...
impl ::std::convert::From<&str> for DataPullMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataPullMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataPullMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataPullMode::from(s))
    }
}
impl DataPullMode {
...
impl ::std::convert::AsRef<str> for DataPullMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
