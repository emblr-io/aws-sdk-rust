...
impl ::std::convert::From<&str> for IdentityResolutionJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IdentityResolutionJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IdentityResolutionJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IdentityResolutionJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IdentityResolutionJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
