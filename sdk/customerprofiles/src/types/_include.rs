...
impl ::std::convert::From<&str> for Include {
    fn from(s: &str) -> Self {
        match s {
            ...
            "ANY" => Include::Any,
            "NONE" => Include::None,
            other => Include::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Include {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Include::from(s))
    }
}
impl Include {
...
impl ::std::convert::AsRef<str> for Include {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
