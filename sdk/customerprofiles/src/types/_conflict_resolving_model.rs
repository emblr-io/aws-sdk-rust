...
impl ::std::convert::From<&str> for ConflictResolvingModel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConflictResolvingModel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConflictResolvingModel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConflictResolvingModel::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConflictResolvingModel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
