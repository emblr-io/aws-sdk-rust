...
impl ListCalculatedAttributesForProfileOutput {
    ...
    pub fn items(&self) -> &[crate::types::ListCalculatedAttributeForProfileItem] {
...
impl ::aws_types::request_id::RequestId for ListCalculatedAttributesForProfileOutput {
...
impl ListCalculatedAttributesForProfileOutputBuilder {
    /// Appends an item to `items`.
    ///
    /// To override the contents of this collection use [`set_items`](Self::set_items).
    ///
    /// <p>The list of calculated attributes.</p>
    pub fn items(mut self, input: crate::types::ListCalculatedAttributeForProfileItem) -> Self {
