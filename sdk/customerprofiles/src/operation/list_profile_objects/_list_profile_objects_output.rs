...
pub struct ListProfileObjectsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::ListProfileObjectsItem>>,
...
impl ListProfileObjectsOutput {
    ...
    pub fn items(&self) -> &[crate::types::ListProfileObjectsItem] {
...
impl ::aws_types::request_id::RequestId for ListProfileObjectsOutput {
...
impl ListProfileObjectsOutputBuilder {
    /// Appends an item to `items`.
    ///
    /// To override the contents of this collection use [`set_items`](Self::set_items).
    ///
    /// <p>The list of ListProfileObject instances.</p>
    pub fn items(mut self, input: crate::types::ListProfileObjectsItem) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListProfileObjectsOutput`](crate::operation::list_profile_objects::ListProfileObjectsOutput).
    pub fn build(self) -> crate::operation::list_profile_objects::ListProfileObjectsOutput {
