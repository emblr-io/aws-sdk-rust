...
pub struct UpdateEventTriggerOutput {
...
impl ::std::fmt::Debug for UpdateEventTriggerOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateEventTriggerOutput");
...
impl ::aws_types::request_id::RequestId for UpdateEventTriggerOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateEventTriggerOutput {
    /// Creates a new builder-style object to manufacture [`UpdateEventTriggerOutput`](crate::operation::update_event_trigger::UpdateEventTriggerOutput).
    pub fn builder() -> crate::operation::update_event_trigger::builders::UpdateEventTriggerOutputBuilder {
        crate::operation::update_event_trigger::builders::UpdateEventTriggerOutputBuilder::default()
    }
}

/// A builder for [`UpdateEventTriggerOutput`](crate::operation::update_event_trigger::UpdateEventTriggerOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct UpdateEventTriggerOutputBuilder {
...
impl UpdateEventTriggerOutputBuilder {
    /// <p>The unique name of the event trigger.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateEventTriggerOutput`](crate::operation::update_event_trigger::UpdateEventTriggerOutput).
    pub fn build(self) -> crate::operation::update_event_trigger::UpdateEventTriggerOutput {
...
impl ::std::fmt::Debug for UpdateEventTriggerOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateEventTriggerOutputBuilder");
        formatter.field("event_trigger_name", &self.event_trigger_name);
        formatter.field("object_type_name", &self.object_type_name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("event_trigger_conditions", &"*** Sensitive Data Redacted ***");
