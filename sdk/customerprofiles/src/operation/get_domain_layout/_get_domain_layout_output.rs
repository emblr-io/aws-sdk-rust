...
pub struct GetDomainLayoutOutput {
...
impl ::std::fmt::Debug for GetDomainLayoutOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetDomainLayoutOutput");
...
impl ::aws_types::request_id::RequestId for GetDomainLayoutOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetDomainLayoutOutput {
    /// Creates a new builder-style object to manufacture [`GetDomainLayoutOutput`](crate::operation::get_domain_layout::GetDomainLayoutOutput).
    pub fn builder() -> crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder {
        crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::default()
    }
}

/// A builder for [`GetDomainLayoutOutput`](crate::operation::get_domain_layout::GetDomainLayoutOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct GetDomainLayoutOutputBuilder {
...
impl GetDomainLayoutOutputBuilder {
    /// <p>The unique name of the layout.</p>
    ...
    /// Consumes the builder and constructs a [`GetDomainLayoutOutput`](crate::operation::get_domain_layout::GetDomainLayoutOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`layout_definition_name`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::layout_definition_name)
    /// - [`description`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::description)
    /// - [`display_name`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::display_name)
    /// - [`layout_type`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::layout_type)
    /// - [`layout`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::layout)
    /// - [`version`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::version)
    /// - [`created_at`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::created_at)
    /// - [`last_updated_at`](crate::operation::get_domain_layout::builders::GetDomainLayoutOutputBuilder::last_updated_at)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_domain_layout::GetDomainLayoutOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_domain_layout::GetDomainLayoutOutput {
            layout_definition_name: self.layout_definition_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "layout_definition_name",
                    "layout_definition_name was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            description: self.description.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "description",
                    "description was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            display_name: self.display_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "display_name",
                    "display_name was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            ...
            layout_type: self.layout_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "layout_type",
                    "layout_type was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            layout: self.layout.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "layout",
                    "layout was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            version: self.version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version",
                    "version was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            last_updated_at: self.last_updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "last_updated_at",
                    "last_updated_at was not specified but it is required when building GetDomainLayoutOutput",
                )
            })?,
            tags: self.tags,
...
impl ::std::fmt::Debug for GetDomainLayoutOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetDomainLayoutOutputBuilder");
        formatter.field("layout_definition_name", &self.layout_definition_name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("display_name", &self.display_name);
        formatter.field("is_default", &self.is_default);
