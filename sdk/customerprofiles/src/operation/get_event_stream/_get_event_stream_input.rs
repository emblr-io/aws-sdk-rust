...
impl GetEventStreamInput {
    /// Creates a new builder-style object to manufacture [`GetEventStreamInput`](crate::operation::get_event_stream::GetEventStreamInput).
    pub fn builder() -> crate::operation::get_event_stream::builders::GetEventStreamInputBuilder {
        crate::operation::get_event_stream::builders::GetEventStreamInputBuilder::default()
    }
}
