...
impl ::std::convert::From<&str> for PublishingStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PublishingStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PublishingStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PublishingStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PublishingStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
