...
impl ::std::convert::From<&str> for IpSetFormat {
    fn from(s: &str) -> Self {
        match s {
            ...
            "TXT" => IpSetFormat::Txt,
            other => IpSetFormat::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpSetFormat {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpSetFormat::from(s))
    }
}
impl IpSetFormat {
...
impl ::std::convert::AsRef<str> for IpSetFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
