...
impl ::std::convert::From<&str> for ThreatIntelSetStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ThreatIntelSetStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ThreatIntelSetStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ThreatIntelSetStatus::from(s))
    }
}
