...
impl ::std::convert::From<&str> for FindingStatisticType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FindingStatisticType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FindingStatisticType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FindingStatisticType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FindingStatisticType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FindingStatisticType {
