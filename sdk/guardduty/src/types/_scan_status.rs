...
impl ::std::convert::From<&str> for ScanStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScanStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScanStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScanStatus::from(s))
    }
}
impl ScanStatus {
...
impl ::std::convert::AsRef<str> for ScanStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
