...
impl ::std::convert::From<&str> for Feedback {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Feedback::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Feedback {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Feedback::from(s))
    }
}
impl Feedback {
...
impl ::std::convert::AsRef<str> for Feedback {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
