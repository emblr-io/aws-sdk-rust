...
/// When writing a match expression against `ScanType`, it is important to ensure
...
/// match scantype {
///     ScanType::GuarddutyInitiated => { /* ... */ },
///     ScanType::OnDemand => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `scantype` represents
...
/// version of SDK where the variant `ScanType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for ScanType {
    fn from(s: &str) -> Self {
        match s {
            "GUARDDUTY_INITIATED" => ScanType::GuarddutyInitiated,
            "ON_DEMAND" => ScanType::OnDemand,
            other => ScanType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScanType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScanType::from(s))
    }
}
impl ScanType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ScanType::GuarddutyInitiated => "GUARDDUTY_INITIATED",
            ScanType::OnDemand => "ON_DEMAND",
