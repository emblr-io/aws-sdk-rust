...
impl ::std::convert::From<&str> for EbsSnapshotPreservation {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EbsSnapshotPreservation::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EbsSnapshotPreservation {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EbsSnapshotPreservation::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EbsSnapshotPreservation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
