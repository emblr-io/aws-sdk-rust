...
///
/// <p>An enum value representing possible resource properties to match with given scan
/// condition.</p>
#[non_exhaustive]
...
impl ::std::convert::From<&str> for ScanCriterionKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScanCriterionKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScanCriterionKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScanCriterionKey::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ScanCriterionKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
