...
impl ::std::convert::From<&str> for DataSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DataSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DataSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataSource::from(s))
    }
}
impl DataSource {
...
impl ::std::convert::AsRef<str> for DataSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
