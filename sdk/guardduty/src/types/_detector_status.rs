...
impl ::std::convert::From<&str> for DetectorStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DetectorStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DetectorStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DetectorStatus::from(s))
    }
}
impl DetectorStatus {
...
impl ::std::convert::AsRef<str> for DetectorStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
