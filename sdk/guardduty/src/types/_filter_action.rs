...
impl ::std::convert::From<&str> for FilterAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterAction::from(s))
    }
}
impl FilterAction {
...
impl ::std::convert::AsRef<str> for FilterAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FilterAction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FilterAction::Archive => write!(f, "ARCHIVE"),
            FilterAction::Noop => write!(f, "NOOP"),
