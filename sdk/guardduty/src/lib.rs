...
//! offered by Amazon GuardDuty. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon GuardDuty.
...
/// Configuration for Amazon GuardDuty.
pub mod config;
