...
//! offered by Amazon DataZone. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon DataZone.
...
/// Configuration for Amazon DataZone.
pub mod config;
