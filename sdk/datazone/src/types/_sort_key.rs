...
impl ::std::convert::From<&str> for SortKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SortKey::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SortKey {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SortKey::from(s))
    }
}
impl SortKey {
...
impl ::std::convert::AsRef<str> for SortKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
