...
/// match protocol {
///     Protocol::Athena => { /* ... */ },
///     Protocol::GlueInteractiveSession => { /* ... */ },
///     Protocol::Https => { /* ... */ },
///     Protocol::Jdbc => { /* ... */ },
///     Protocol::Livy => { /* ... */ },
///     Protocol::Odbc => { /* ... */ },
...
impl ::std::convert::From<&str> for Protocol {
    fn from(s: &str) -> Self {
        match s {
            ...
            "GLUE_INTERACTIVE_SESSION" => Protocol::GlueInteractiveSession,
...
impl Protocol {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Protocol::Athena => "ATHENA",
            Protocol::GlueInteractiveSession => "GLUE_INTERACTIVE_SESSION",
            Protocol::Https => "HTTPS",
            Protocol::Jdbc => "JDBC",
            Protocol::Livy => "LIVY",
            Protocol::Odbc => "ODBC",
            Protocol::Prism => "PRISM",
...
impl ::std::fmt::Display for Protocol {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Protocol::Athena => write!(f, "ATHENA"),
            Protocol::GlueInteractiveSession => write!(f, "GLUE_INTERACTIVE_SESSION"),
            Protocol::Https => write!(f, "HTTPS"),
            Protocol::Jdbc => write!(f, "JDBC"),
