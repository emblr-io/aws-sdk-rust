...
///     DataSourceStatus::FailedCreation => { /* ... */ },
///     DataSourceStatus::FailedDeletion => { /* ... */ },
///     DataSourceStatus::FailedUpdate => { /* ... */ },
...
impl ::std::convert::From<&str> for DataSourceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "FAILED_CREATION" => DataSourceStatus::FailedCreation,
            "FAILED_DELETION" => DataSourceStatus::FailedDeletion,
            "FAILED_UPDATE" => DataSourceStatus::FailedUpdate,
...
impl DataSourceStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DataSourceStatus::FailedCreation => "FAILED_CREATION",
            DataSourceStatus::FailedDeletion => "FAILED_DELETION",
            DataSourceStatus::FailedUpdate => "FAILED_UPDATE",
