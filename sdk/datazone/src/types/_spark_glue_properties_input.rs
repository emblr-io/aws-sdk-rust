...
impl SparkGluePropertiesInput {
    /// Creates a new builder-style object to manufacture [`SparkGluePropertiesInput`](crate::types::SparkGluePropertiesInput).
    pub fn builder() -> crate::types::builders::SparkGluePropertiesInputBuilder {
        crate::types::builders::SparkGluePropertiesInputBuilder::default()
    }
}

/// A builder for [`SparkGluePropertiesInput`](crate::types::SparkGluePropertiesInput).
...
impl SparkGluePropertiesInputBuilder {
    /// <p>The additional args in the Spark Amazon Web Services Glue properties.</p>
    ...
    /// Consumes the builder and constructs a [`SparkGluePropertiesInput`](crate::types::SparkGluePropertiesInput).
    pub fn build(self) -> crate::types::SparkGluePropertiesInput {
