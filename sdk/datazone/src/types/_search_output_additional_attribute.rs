...
/// When writing a match expression against `SearchOutputAdditionalAttribute`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `searchoutputadditionalattribute` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SearchOutputAdditionalAttribute::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SearchOutputAdditionalAttribute::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SearchOutputAdditionalAttribute::NewFeature` is defined.
/// Specifically, when `searchoutputadditionalattribute` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SearchOutputAdditionalAttribute::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum SearchOutputAdditionalAttribute {
    #[allow(missing_docs)] // documentation missing in model
    Forms,
    #[allow(missing_docs)] // documentation missing in model
...
impl ::std::convert::From<&str> for SearchOutputAdditionalAttribute {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for SearchOutputAdditionalAttribute {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SearchOutputAdditionalAttribute::from(s))
    }
}
impl SearchOutputAdditionalAttribute {
