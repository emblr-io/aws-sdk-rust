...
///     DeploymentMode::OnCreate => { /* ... */ },
///     DeploymentMode::OnDemand => { /* ... */ },
...
impl ::std::convert::From<&str> for DeploymentMode {
    fn from(s: &str) -> Self {
        match s {
            "ON_CREATE" => DeploymentMode::OnCreate,
            "ON_DEMAND" => DeploymentMode::OnDemand,
...
impl DeploymentMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DeploymentMode::OnCreate => "ON_CREATE",
            DeploymentMode::OnDemand => "ON_DEMAND",
