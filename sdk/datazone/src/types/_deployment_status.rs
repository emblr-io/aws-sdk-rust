...
impl ::std::convert::From<&str> for DeploymentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PENDING_DEPLOYMENT" => DeploymentStatus::PendingDeployment,
...
impl DeploymentStatus {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["FAILED", "IN_PROGRESS", "PENDING_DEPLOYMENT", "SUCCESSFUL"]
    }
}
...
impl ::std::fmt::Display for DeploymentStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            DeploymentStatus::PendingDeployment => write!(f, "PENDING_DEPLOYMENT"),
