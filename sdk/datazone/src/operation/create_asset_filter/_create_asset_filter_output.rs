...
pub struct CreateAssetFilterOutput {
...
impl ::std::fmt::Debug for CreateAssetFilterOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateAssetFilterOutput");
...
impl ::aws_types::request_id::RequestId for CreateAssetFilterOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateAssetFilterOutput {
    /// Creates a new builder-style object to manufacture [`CreateAssetFilterOutput`](crate::operation::create_asset_filter::CreateAssetFilterOutput).
    pub fn builder() -> crate::operation::create_asset_filter::builders::CreateAssetFilterOutputBuilder {
        crate::operation::create_asset_filter::builders::CreateAssetFilterOutputBuilder::default()
    }
}

/// A builder for [`CreateAssetFilterOutput`](crate::operation::create_asset_filter::CreateAssetFilterOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct CreateAssetFilterOutputBuilder {
...
impl CreateAssetFilterOutputBuilder {
    /// <p>The ID of the asset filter.</p>
    ...
    /// Consumes the builder and constructs a [`CreateAssetFilterOutput`](crate::operation::create_asset_filter::CreateAssetFilterOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::create_asset_filter::builders::CreateAssetFilterOutputBuilder::id)
    /// - [`domain_id`](crate::operation::create_asset_filter::builders::CreateAssetFilterOutputBuilder::domain_id)
    /// - [`asset_id`](crate::operation::create_asset_filter::builders::CreateAssetFilterOutputBuilder::asset_id)
    /// - [`name`](crate::operation::create_asset_filter::builders::CreateAssetFilterOutputBuilder::name)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_asset_filter::CreateAssetFilterOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_asset_filter::CreateAssetFilterOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateAssetFilterOutput",
                )
            })?,
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building CreateAssetFilterOutput",
                )
            })?,
            asset_id: self.asset_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "asset_id",
                    "asset_id was not specified but it is required when building CreateAssetFilterOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreateAssetFilterOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreateAssetFilterOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateAssetFilterOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("domain_id", &self.domain_id);
        formatter.field("asset_id", &self.asset_id);
        formatter.field("name", &"*** Sensitive Data Redacted ***");
