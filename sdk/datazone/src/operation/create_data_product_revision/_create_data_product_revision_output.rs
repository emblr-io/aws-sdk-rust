...
pub struct CreateDataProductRevisionOutput {
...
impl ::std::fmt::Debug for CreateDataProductRevisionOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateDataProductRevisionOutput");
...
impl ::aws_types::request_id::RequestId for CreateDataProductRevisionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateDataProductRevisionOutput {
    /// Creates a new builder-style object to manufacture [`CreateDataProductRevisionOutput`](crate::operation::create_data_product_revision::CreateDataProductRevisionOutput).
    pub fn builder() -> crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder {
        crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder::default()
    }
}

/// A builder for [`CreateDataProductRevisionOutput`](crate::operation::create_data_product_revision::CreateDataProductRevisionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct CreateDataProductRevisionOutputBuilder {
...
impl CreateDataProductRevisionOutputBuilder {
    /// <p>The ID of the domain where data product revision is created.</p>
    ...
    /// Consumes the builder and constructs a [`CreateDataProductRevisionOutput`](crate::operation::create_data_product_revision::CreateDataProductRevisionOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`domain_id`](crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder::domain_id)
    /// - [`id`](crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder::id)
    /// - [`revision`](crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder::revision)
    /// - [`owning_project_id`](crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder::owning_project_id)
    /// - [`name`](crate::operation::create_data_product_revision::builders::CreateDataProductRevisionOutputBuilder::name)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_data_product_revision::CreateDataProductRevisionOutput {
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building CreateDataProductRevisionOutput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateDataProductRevisionOutput",
                )
            })?,
            revision: self.revision.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "revision",
                    "revision was not specified but it is required when building CreateDataProductRevisionOutput",
                )
            })?,
            owning_project_id: self.owning_project_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "owning_project_id",
                    "owning_project_id was not specified but it is required when building CreateDataProductRevisionOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreateDataProductRevisionOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreateDataProductRevisionOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateDataProductRevisionOutputBuilder");
        formatter.field("domain_id", &self.domain_id);
        formatter.field("id", &self.id);
        formatter.field("revision", &self.revision);
        formatter.field("owning_project_id", &self.owning_project_id);
