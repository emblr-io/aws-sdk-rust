...
impl ::aws_types::request_id::RequestId for ListEnvironmentProfilesOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl ListEnvironmentProfilesOutput {
    /// Creates a new builder-style object to manufacture [`ListEnvironmentProfilesOutput`](crate::operation::list_environment_profiles::ListEnvironmentProfilesOutput).
    pub fn builder() -> crate::operation::list_environment_profiles::builders::ListEnvironmentProfilesOutputBuilder {
        crate::operation::list_environment_profiles::builders::ListEnvironmentProfilesOutputBuilder::default()
    }
}

/// A builder for [`ListEnvironmentProfilesOutput`](crate::operation::list_environment_profiles::ListEnvironmentProfilesOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListEnvironmentProfilesOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::EnvironmentProfileSummary>>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
    _request_id: Option<String>,
}
impl ListEnvironmentProfilesOutputBuilder {
    /// Appends an item to `items`.
    ///
    /// To override the contents of this collection use [`set_items`](Self::set_items).
    ///
    /// <p>The results of the <code>ListEnvironmentProfiles</code> action.</p>
    pub fn items(mut self, input: crate::types::EnvironmentProfileSummary) -> Self {
    ...
    /// <p>The results of the <code>ListEnvironmentProfiles</code> action.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::EnvironmentProfileSummary>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The results of the <code>ListEnvironmentProfiles</code> action.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::EnvironmentProfileSummary>> {
        &self.items
    }
    /// <p>When the number of environment profiles is greater than the default value for the <code>MaxResults</code> parameter, or if you explicitly specify a value for <code>MaxResults</code> that is less than the number of environment profiles, the response includes a pagination token named <code>NextToken</code>. You can specify this <code>NextToken</code> value in a subsequent call to <code>ListEnvironmentProfiles</code> to list the next set of environment profiles.</p>
