...
pub struct GetAssetFilterOutput {
...
impl ::std::fmt::Debug for GetAssetFilterOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetAssetFilterOutput");
...
impl ::aws_types::request_id::RequestId for GetAssetFilterOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetAssetFilterOutput {
    /// Creates a new builder-style object to manufacture [`GetAssetFilterOutput`](crate::operation::get_asset_filter::GetAssetFilterOutput).
    pub fn builder() -> crate::operation::get_asset_filter::builders::GetAssetFilterOutputBuilder {
        crate::operation::get_asset_filter::builders::GetAssetFilterOutputBuilder::default()
    }
}

/// A builder for [`GetAssetFilterOutput`](crate::operation::get_asset_filter::GetAssetFilterOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct GetAssetFilterOutputBuilder {
...
impl GetAssetFilterOutputBuilder {
    /// <p>The ID of the asset filter.</p>
    ...
    /// Consumes the builder and constructs a [`GetAssetFilterOutput`](crate::operation::get_asset_filter::GetAssetFilterOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::get_asset_filter::builders::GetAssetFilterOutputBuilder::id)
    /// - [`domain_id`](crate::operation::get_asset_filter::builders::GetAssetFilterOutputBuilder::domain_id)
    /// - [`asset_id`](crate::operation::get_asset_filter::builders::GetAssetFilterOutputBuilder::asset_id)
    /// - [`name`](crate::operation::get_asset_filter::builders::GetAssetFilterOutputBuilder::name)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_asset_filter::GetAssetFilterOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_asset_filter::GetAssetFilterOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetAssetFilterOutput",
                )
            })?,
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building GetAssetFilterOutput",
                )
            })?,
            asset_id: self.asset_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "asset_id",
                    "asset_id was not specified but it is required when building GetAssetFilterOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building GetAssetFilterOutput",
                )
            })?,
...
impl ::std::fmt::Debug for GetAssetFilterOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetAssetFilterOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("domain_id", &self.domain_id);
        formatter.field("asset_id", &self.asset_id);
        formatter.field("name", &"*** Sensitive Data Redacted ***");
