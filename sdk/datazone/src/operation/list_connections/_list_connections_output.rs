...
pub struct ListConnectionsOutput {
    ...
    pub items: ::std::vec::Vec<crate::types::ConnectionSummary>,
...
impl ListConnectionsOutput {
    /// <p>The results of the ListConnections action.</p>
    pub fn items(&self) -> &[crate::types::ConnectionSummary] {
        use std::ops::Deref;
        self.items.deref()
    }
    /// <p>When the number of connections is greater than the default value for the MaxResults parameter, or if you explicitly specify a value for MaxResults that is less than the number of connections, the response includes a pagination token named NextToken. You can specify this NextToken value in a subsequent call to ListConnections to list the next set of connections.</p>
...
pub struct ListConnectionsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::ConnectionSummary>>,
...
impl ListConnectionsOutputBuilder {
    ...
    ///
    /// <p>The results of the ListConnections action.</p>
    pub fn items(mut self, input: crate::types::ConnectionSummary) -> Self {
    ...
    /// <p>The results of the ListConnections action.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ConnectionSummary>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The results of the ListConnections action.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ConnectionSummary>> {
        &self.items
    }
    /// <p>When the number of connections is greater than the default value for the MaxResults parameter, or if you explicitly specify a value for MaxResults that is less than the number of connections, the response includes a pagination token named NextToken. You can specify this NextToken value in a subsequent call to ListConnections to list the next set of connections.</p>
    ...
    /// - [`items`](crate::operation::list_connections::builders::ListConnectionsOutputBuilder::items)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_connections::ListConnectionsOutput {
            items: self.items.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "items",
                    "items was not specified but it is required when building ListConnectionsOutput",
                )
            })?,
