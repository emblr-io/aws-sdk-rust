...
impl ::aws_types::request_id::RequestId for GetSubscriptionGrantOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetSubscriptionGrantOutput {
    /// Creates a new builder-style object to manufacture [`GetSubscriptionGrantOutput`](crate::operation::get_subscription_grant::GetSubscriptionGrantOutput).
    pub fn builder() -> crate::operation::get_subscription_grant::builders::GetSubscriptionGrantOutputBuilder {
        crate::operation::get_subscription_grant::builders::GetSubscriptionGrantOutputBuilder::default()
    }
}

/// A builder for [`GetSubscriptionGrantOutput`](crate::operation::get_subscription_grant::GetSubscriptionGrantOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetSubscriptionGrantOutputBuilder {
...
impl GetSubscriptionGrantOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_subscription_grant::GetSubscriptionGrantOutput, ::aws_smithy_types::error::operation::BuildError>
    {
