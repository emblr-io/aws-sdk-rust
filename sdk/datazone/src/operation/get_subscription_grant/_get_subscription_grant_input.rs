...
impl GetSubscriptionGrantInput {
    /// Creates a new builder-style object to manufacture [`GetSubscriptionGrantInput`](crate::operation::get_subscription_grant::GetSubscriptionGrantInput).
    pub fn builder() -> crate::operation::get_subscription_grant::builders::GetSubscriptionGrantInputBuilder {
        crate::operation::get_subscription_grant::builders::GetSubscriptionGrantInputBuilder::default()
    }
}
