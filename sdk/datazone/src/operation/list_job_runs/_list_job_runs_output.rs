...
pub struct ListJobRunsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::JobRunSummary>>,
...
impl ListJobRunsOutput {
    ...
    pub fn items(&self) -> &[crate::types::JobRunSummary] {
...
pub struct ListJobRunsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::JobRunSummary>>,
...
impl ListJobRunsOutputBuilder {
    ...
    ///
    /// <p>The results of the ListJobRuns action.</p>
    pub fn items(mut self, input: crate::types::JobRunSummary) -> Self {
    ...
    /// <p>The results of the ListJobRuns action.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::JobRunSummary>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The results of the ListJobRuns action.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::JobRunSummary>> {
        &self.items
    }
    /// <p>When the number of job runs is greater than the default value for the MaxResults parameter, or if you explicitly specify a value for MaxResults that is less than the number of job runs, the response includes a pagination token named NextToken. You can specify this NextToken value in a subsequent call to ListJobRuns to list the next set of job runs.</p>
