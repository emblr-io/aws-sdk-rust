...
pub struct UpdateAssetFilterOutput {
...
impl ::std::fmt::Debug for UpdateAssetFilterOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateAssetFilterOutput");
...
impl ::aws_types::request_id::RequestId for UpdateAssetFilterOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateAssetFilterOutput {
    /// Creates a new builder-style object to manufacture [`UpdateAssetFilterOutput`](crate::operation::update_asset_filter::UpdateAssetFilterOutput).
    pub fn builder() -> crate::operation::update_asset_filter::builders::UpdateAssetFilterOutputBuilder {
        crate::operation::update_asset_filter::builders::UpdateAssetFilterOutputBuilder::default()
    }
}

/// A builder for [`UpdateAssetFilterOutput`](crate::operation::update_asset_filter::UpdateAssetFilterOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct UpdateAssetFilterOutputBuilder {
...
impl UpdateAssetFilterOutputBuilder {
    /// <p>The ID of the asset filter.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateAssetFilterOutput`](crate::operation::update_asset_filter::UpdateAssetFilterOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::update_asset_filter::builders::UpdateAssetFilterOutputBuilder::id)
    /// - [`domain_id`](crate::operation::update_asset_filter::builders::UpdateAssetFilterOutputBuilder::domain_id)
    /// - [`asset_id`](crate::operation::update_asset_filter::builders::UpdateAssetFilterOutputBuilder::asset_id)
    /// - [`name`](crate::operation::update_asset_filter::builders::UpdateAssetFilterOutputBuilder::name)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_asset_filter::UpdateAssetFilterOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_asset_filter::UpdateAssetFilterOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building UpdateAssetFilterOutput",
                )
            })?,
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building UpdateAssetFilterOutput",
                )
            })?,
            asset_id: self.asset_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "asset_id",
                    "asset_id was not specified but it is required when building UpdateAssetFilterOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateAssetFilterOutput",
                )
            })?,
...
impl ::std::fmt::Debug for UpdateAssetFilterOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateAssetFilterOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("domain_id", &self.domain_id);
        formatter.field("asset_id", &self.asset_id);
        formatter.field("name", &"*** Sensitive Data Redacted ***");
