...
impl CreateGroupProfileOutput {
    ...
    pub fn builder() -> crate::operation::create_group_profile::builders::CreateGroupProfileOutputBuilder {
        crate::operation::create_group_profile::builders::CreateGroupProfileOutputBuilder::default()
    }
}

/// A builder for [`CreateGroupProfileOutput`](crate::operation::create_group_profile::CreateGroupProfileOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct CreateGroupProfileOutputBuilder {
...
impl ::std::fmt::Debug for CreateGroupProfileOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateGroupProfileOutputBuilder");
        formatter.field("domain_id", &self.domain_id);
        formatter.field("id", &self.id);
        formatter.field("status", &self.status);
        formatter.field("group_name", &"*** Sensitive Data Redacted ***");
