...
impl UpdateConnectionOutputBuilder {
    ...
    /// - [`connection_id`](crate::operation::update_connection::builders::UpdateConnectionOutputBuilder::connection_id)
    /// - [`domain_id`](crate::operation::update_connection::builders::UpdateConnectionOutputBuilder::domain_id)
    /// - [`domain_unit_id`](crate::operation::update_connection::builders::UpdateConnectionOutputBuilder::domain_unit_id)
    /// - [`name`](crate::operation::update_connection::builders::UpdateConnectionOutputBuilder::name)
    /// - [`physical_endpoints`](crate::operation::update_connection::builders::UpdateConnectionOutputBuilder::physical_endpoints)
    /// - [`r#type`](crate::operation::update_connection::builders::UpdateConnectionOutputBuilder::type)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::update_connection::UpdateConnectionOutput {
            connection_id: self.connection_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "connection_id",
                    "connection_id was not specified but it is required when building UpdateConnectionOutput",
                )
            })?,
            ...
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building UpdateConnectionOutput",
                )
            })?,
            domain_unit_id: self.domain_unit_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_unit_id",
                    "domain_unit_id was not specified but it is required when building UpdateConnectionOutput",
                )
            })?,
            ...
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateConnectionOutput",
                )
            })?,
            physical_endpoints: self.physical_endpoints.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "physical_endpoints",
                    "physical_endpoints was not specified but it is required when building UpdateConnectionOutput",
                )
            })?,
            ...
            r#type: self.r#type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "r#type",
                    "r#type was not specified but it is required when building UpdateConnectionOutput",
                )
            })?,
